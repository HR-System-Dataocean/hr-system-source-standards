...
#Region "Protected Sub"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            ClsHmsCommissionCategories.GetDropDownList(DdlCommissionCat, True, "IsLineCommission =0")
    ...
    Public Sub GetData()
        Try
            ...
            If CommissionCatID = 0 Then
                ...
                Return
            End If
            Dim StrSelectCommand As String = "set dateformat dmy  exec sp_Call_rptCustom_NAHADADoctorIncomeTotalCommision '','" & ClsHmsCommissionCategories.Code & "','" & FromDate.ToString("yyyyMMdd") & "','" & ToDate.ToString("yyyyMMdd") & "' ,'" & ClsFiscalPerid.EngName & "',1"
                    ...
                    Try
                        ...
                        For intIndex = 0 To UWGEmployeesCommission.Rows.Count - 1
                            ...
                            If row.Cells.FromKey("selected").Value Then
                                ...
                                End If
                                DueAmount = row.Cells.FromKey("NetAmount").Value
                                ...
                                If DueAmount > 0 And Employeeid > 0 And FiscalPerisId > 0 Then
                                    ...
                                    clsCommissionTransfer.Amount = row.Cells.FromKey("NetAmount").Value
                                    clsCommissionTransfer.Deduction2 = row.Cells.FromKey("Deduction2").Value
                                    clsCommissionTransfer.NetAmount = row.Cells.FromKey("NetAmount").Value
                                    clsCommissionTransfer.DueAmount = row.Cells.FromKey("DueAmount").Value
