...
#Region "Protected Sub"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If ClsObjects.Find(" Code='" & ClsCountries.Table.Trim & "'") Then
            ...
            If Not IsPostBack Then
                Page.Session.Add("ConnectionString", ClsCountries.ConnectionString)
                ClsCountries.AddOnChangeEventToControls("frmCountries", Page, UltraWebTab1)
            ...
            If (txtCode.Text <> "") Then
                ClsCountries.Find(" Code='" & txtCode.Text & "'")
                IntrecordID = ClsCountries.ID
        ...
        Catch ex As Exception
            ...
            mErrorHandler.RecordExceptions_DataBase("", ex, Err.Number, ClsCountries.RegUserID, Venus.Shared.ErrorsHandler.eRecordingType.System_DataBase)
    ...
    Protected Sub ImageButton_Command(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.CommandEventArgs) Handles ImageButton_Save.Command, ImageButton_SaveN.Command, LinkButton_SaveN.Command, ImageButton_New.Command, ImageButton_Print.Command, ImageButton_Properties.Command, LinkButton_Properties.Command, ImageButton_Remarks.Command, LinkButton_Remarks.Command, ImageButton_Last.Command, ImageButton_Next.Command, ImageButton_Back.Command, ImageButton_First.Command, ImageButton_Delete.Command
        ...
        Dim ObjNavigationHandler As New Venus.Shared.Web.NavigationHandler(ClsCountries.ConnectionString)
        Select Case e.CommandArgument
            ...
            Case "New"
                AfterOperation()
            Case "Delete"
                ClsCountries.Delete("Code='" & txtCode.Text & "'")
                AfterOperation()
            Case "Property"
                ClsCountries.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmPropertyScreen.aspx?ID=" & ClsCountries.ID & "&TableName=" & ClsCountries.Table, 477, 313, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Property", False)
            Case "Remarks"
                ClsCountries.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmRemarks.aspx?ID=" & ClsCountries.ID & "&TableName=" & ClsCountries.Table, 410, 210, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Remarks", False)
            Case "Print"
            ...
            Case "First"
                ClsCountries.Find("Code='" & txtCode.Text & "'")
                ClsCountries.FirstRecord()
                GetValues(ClsCountries)
            Case "Previous"
                ClsCountries.Find("Code='" & txtCode.Text & "'")
                If Not ClsCountries.previousRecord() Then
                    ClsCountries.Find("Code='" & txtCode.Text & "'")
            ...
            Case "Next"
                ClsCountries.Find("Code='" & txtCode.Text & "'")
                If Not ClsCountries.NextRecord() Then
                    ClsCountries.Find("Code='" & txtCode.Text & "'")
...
#Region "Private Functions"
    Private Function SavePart() As Boolean
        ...
        Try
            ...
            If ClsCountries.ID > 0 Then
                If Not AssignValue(ClsCountries) Then
                    Exit Function
                End If
                ClsCountries.Update("Code='" & txtCode.Text & "'")
            ...
            clsMainOtherFields.CollectDataAndSave(value.Text, ClsCountries.Table, ClsCountries.ID)
            value.Text = ""
            Return True
        Catch ex As Exception
            Return False
        End Try
    End Function
    Private Function AssignValue(ByRef ClsCountries As Clssys_Countries) As Boolean
        Try
            With ClsCountries
                .Code = txtCode.Text
                ...
                .PhoneKey = txtPhoneKey.Text
                .IsMainCountries = ChkMainCountry.Checked
            End With
        ...
        End Try
    End Function
    Private Function GetValues(ByVal ClsCountries As Clssys_Countries) As Boolean
        ...
        Try
            ...
            With ClsCountries
                ...
                txtPhoneKey.Text = .PhoneKey
                ChkMainCountry.Checked = .IsMainCountries

                If Not ClsCountries.RegUserID = Nothing Then
                    ClsUser.Find("ID=" & ClsCountries.RegUserID)
                End If
                ...
                ClsNationality.GetDropDownList(ddlNationality, False)
                ...
                If ClsCurrencies.ID > 0 Then
                    ...
                    item.Text = ObjNavigationHandler.SetLanguage(Page, ClsCurrencies.EngName & "/" & ClsCurrencies.ArbName)

                    If (item.Text.Trim = "") Then
                        item.Text = ObjNavigationHandler.SetLanguage(Page, ClsCurrencies.ArbName & "/" & ClsCurrencies.EngName)
                ...
                If ClsNationality.ID > 0 Then
                    ...
                    item.Text = ObjNavigationHandler.SetLanguage(Page, ClsNationality.EngName & "/" & ClsNationality.ArbName)

                    If (item.Text.Trim = "") Then
                        item.Text = ObjNavigationHandler.SetLanguage(Page, ClsNationality.ArbName & "/" & ClsNationality.EngName)
                ...
                If Page.IsPostBack Then
                    CreateOtherFields(ClsCountries.ID)
                End If
            End With
            Return True
        Catch ex As Exception
    ...
    Private Function CheckCode() As Boolean
        ...
        Try
            ClsCountries.Find("Code='" & txtCode.Text & "'")
            IntId = ClsCountries.ID
            txtEngName.Focus()
            If ClsCountries.ID > 0 Then
                GetValues(ClsCountries)
                StrMode = "E"
            Else
                If ClsCountries.CheckRecordExistance(" Code='" & txtCode.Text & "'") Then
                    txtCode.Text = ""
                    txtCode.Focus()
                End If
            ...
            End If
            SetToolBarDefaults()
            SetToolBarPermission(Me, ClsCountries.ConnectionString, ClsCountries.DataBaseUserRelatedID, ClsCountries.GroupID, StrMode)
            SetToolBarRecordPermission(Me, ClsCountries.ConnectionString, ClsCountries.DataBaseUserRelatedID, ClsCountries.GroupID, ClsCountries.Table, IntId)
    ...
    Private Function Clear() As Boolean
        ...
        txtPhoneKey.Text = String.Empty
        ChkMainCountry.Checked = False
        ImageButton_Delete.Enabled = False
        lblRegDateValue.Text = ""
        lblRegDateValue.Text = ""
        lblCancelDateValue.Text = ""
    ...
    Private Sub LoadDataUpdateSchedules(ByVal formName As String)
        ...
        ClsCountries = New Clssys_Countries(Me.Page)
        ClsCountries.Find(" code = '" & txtCode.Text & "'")
        Dim recordID As Integer = ClsCountries.ID
        If (recordID > 0) Then
    ...
    Private Function CreateOtherFields(ByVal IntRecordID As Integer)
        ...
        If clsMainOtherFields.CheckOtherFieldsButton(Me.Page, ClsCountries.Table) = True Then
            Dim StrTablename As String
            ClsCountries = New Clssys_Countries(Me)
            StrTablename = ClsCountries.Table
