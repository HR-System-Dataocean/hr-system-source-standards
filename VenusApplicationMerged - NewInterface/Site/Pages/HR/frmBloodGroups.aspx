<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmBloodGroups.aspx.vb"
    Inherits="frmBloodGroups" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
...
<head runat="server">
    <title>* Venus Payroll * ~Blood Groups</title>
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmBloodGroups" runat="server">
