<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmTicketsClasses.aspx.vb"
    Inherits="frmTicketsClasses" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
...
<head runat="server">
    <title>* Venus Payroll * ~TicketsClasses</title>
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmTicketsClasses" runat="server">
                                                ...
                                                <table style="width: 100%; height: 30px; vertical-align: bottom; border-bottom: 1px solid black"
                                                    ...
                                                    <tr>
                                                        <td style="vertical-align: bottom">
                                                            <asp:Label ID="Label_Title1" runat="server" Text="برجاء إدخال الأسعار الإفتراضية لمسارات السفر"
                                        ...
                                        <tr>
                                            <td style="height: 100%; vertical-align: top" colspan="3">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        <td>
                                                            <igtbl:UltraWebGrid   Browser="UpLevel"  ID="uwgRoutesPrices" runat="server" EnableAppStyling="False"
                                                                ...
                                                                <DisplayLayout AllowColSizingDefault="Free" AllowColumnMovingDefault="OnServer" AllowDeleteDefault="Yes"
                                                                    ...
                                                                    <RowSelectorStyleDefault Font-Bold="True" Font-Size="7pt" Width="40px">
                                                                ...
                                                                <Bands>
                                                                    <igtbl:UltraGridBand meta:resourcekey="UltraGridBandResource1">
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <igtbl:UltraGridColumn AllowResize="Fixed" BaseColumnName="RouteName" Key="RouteName"
                                                                                AllowUpdate="No" meta:resourcekey="UltraGridColumnResource3" Width="70%">
                                                                                <CellStyle HorizontalAlign="Center">
                                                                                </CellStyle>
                                                                                <Header Caption="Route Name">
                                                                            ...
                                                                            <igtbl:UltraGridColumn DataType="System.Double" Format="###,###,###.##" AllowResize="Fixed"
                                                                                BaseColumnName="Amount" Key="Amount" AllowUpdate="Yes" meta:resourcekey="UltraGridColumnResource4"
                                                                                Width="70%">
                                                                                <CellStyle HorizontalAlign="Center">
                                                                                </CellStyle>
                                                                                <Header Caption="Route Cost">
                                                                                    <RowLayoutColumnInfo OriginX="2" />
                                                                                </Header>
                                                                                <Footer>
                                                                                    <RowLayoutColumnInfo OriginX="2" />
