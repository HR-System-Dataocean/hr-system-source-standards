<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmEmployeesLoansRewards.aspx.vb"
    Inherits="frmEmployeesLoansRewards" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmEmployeesLoansRewards" runat="server">
    ...
    <asp:LinkButton ID="LBMaxCode" runat="server" CommandArgument="Import" Style="font-family: Tahoma; font-size: 8pt; font-weight: Normal;"
        ...
        OnClientClick="OpenModal12('frmEmployeesLoansRewardsInquiries.aspx?FrmID=1',560,850); return false;"></asp:LinkButton>
</td>
                            <td style="width: 5%">
                            </td>
                        </tr>
