<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmAttendTemplate.aspx.vb"
    Inherits="frmAttendTemplate" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmAttendTemplate" runat="server">
                                        ...
                                        <tr>
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="Label_IsRotation" runat="server" Text="يسمح بتناوب دوامات" SkinID="Label_DefaultNormal"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:CheckBox ID="CheckBox_IsRotation" runat="server" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        <td class="LabelArea">
                                                            <asp:Label ID="Label_Occurance" runat="server" Text="التكرار كل" SkinID="Label_DefaultNormal"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <igtxt:WebNumericEdit ID="txtOccurance" runat="server" DataMode="Int" MinValue="0"
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        <td class="LabelArea">
                                                            <asp:Label ID="Label_Identifier" runat="server" Text="المعيار" SkinID="Label_DefaultNormal"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="ddlIdentifier" runat="server" SkinID="DropDownList_LargNormal">
                                                                <asp:ListItem Value="D">يوم</asp:ListItem>
                                                                <asp:ListItem Selected="True" Value="W">أسبوع</asp:ListItem>
                                                                <asp:ListItem Value="M">شهر</asp:ListItem>
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td class="SeparArea">
                                                        </td>
                                                ...
                                                <table style="width: 100%; height: 30px; vertical-align: bottom; border-bottom: 1px solid black"
                                                    ...
                                                    <tr>
                                                        <td style="vertical-align: bottom" class="style1">
                                                            <asp:Label ID="Label_Title1" runat="server" Text="برجاء الاشارة الى دوامات المطلوبة"
                                                                ...
                                                                <Bands>
                                                                    <igtbl:UltraGridBand meta:resourcekey="UltraGridBandResource1" AllowAdd="Yes">
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <igtbl:UltraGridColumn BaseColumnName="AttendTemplateID" Hidden="True" Key="AttendTemplateID">
                                                                                <Header>
                                                                            ...
                                                                            <igtbl:UltraGridColumn BaseColumnName="AttendShiftID" Key="AttendShiftID" DataType="System.Int32"
                                                                                Type="DropDownList" Width="85%" AllowUpdate="No">
                                                                            ...
                                                                            <igtbl:UltraGridColumn BaseColumnName="IsSelect" DataType="System.Boolean" Key="IsSelect"
                                                                            ...
                                                                            <igtbl:UltraGridColumn CellButtonDisplay="Always" Type="Button" Width="80px">
                                                                                <Header Caption="الجدولة">
