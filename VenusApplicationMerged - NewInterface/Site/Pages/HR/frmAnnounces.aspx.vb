...
Partial Class frmAnnounces
    Inherits MainPage
#Region "Public Decleration"
    Private ClsAnnounces As Clssys_Announces
...
#Region "Protected Sub"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ClsAnnounces = New Clssys_Announces(Me.Page)
        Dim ClsObjects As New Clssys_Objects(Page)
        Dim ClsSearchs As New Clssys_Searchs(Page)
        Dim SearchID As Integer = 0
        Try
            Dim clsSearchsColumns As New Clssys_SearchsColumns(Page)
            If ClsObjects.Find(" Code='" & ClsAnnounces.Table.Trim & "'") Then
            ...
            If Not IsPostBack Then
                Page.Session.Add("ConnectionString", ClsAnnounces.ConnectionString)
                ClsAnnounces.AddOnChangeEventToControls("frmAnnounces", Page, UltraWebTab1)
            ...
            If (txtCode.Text <> "") Then
                ClsAnnounces.Find(" Code='" & txtCode.Text & "'")
                IntrecordID = ClsAnnounces.ID
        ...
        Catch ex As Exception
            ...
            mErrorHandler.RecordExceptions_DataBase("", ex, Err.Number, ClsAnnounces.RegUserID, Venus.Shared.ErrorsHandler.eRecordingType.System_DataBase)
    ...
    Protected Sub ImageButton_Command(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.CommandEventArgs) Handles ImageButton_Save.Command, ImageButton_SaveN.Command, LinkButton_SaveN.Command, ImageButton_New.Command, ImageButton_Print.Command, ImageButton_Properties.Command, LinkButton_Properties.Command, ImageButton_Remarks.Command, LinkButton_Remarks.Command, ImageButton_Last.Command, ImageButton_Next.Command, ImageButton_Back.Command, ImageButton_First.Command, ImageButton_Delete.Command
        ...
        Dim ObjNavigationHandler As New Venus.Shared.Web.NavigationHandler(ClsAnnounces.ConnectionString)
        Select Case e.CommandArgument
            ...
            Case "New"
                AfterOperation()
            Case "Delete"
                ClsAnnounces.Delete("Code='" & txtCode.Text & "'")
                AfterOperation()
            Case "Property"
                ClsAnnounces.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmPropertyScreen.aspx?ID=" & ClsAnnounces.ID & "&TableName=" & ClsAnnounces.Table, 477, 313, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Property", False)
            Case "Remarks"
                ClsAnnounces.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmRemarks.aspx?ID=" & ClsAnnounces.ID & "&TableName=" & ClsAnnounces.Table, 410, 210, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Remarks", False)
            Case "Print"
            ...
            Case "First"
                ClsAnnounces.Find("Code='" & txtCode.Text & "'")
                ClsAnnounces.FirstRecord()
                GetValues(ClsAnnounces)
            Case "Previous"
                ClsAnnounces.Find("Code='" & txtCode.Text & "'")
                If Not ClsAnnounces.previousRecord() Then
                    ClsAnnounces.Find("Code='" & txtCode.Text & "'")
            ...
            Case "Next"
                ClsAnnounces.Find("Code='" & txtCode.Text & "'")
                If Not ClsAnnounces.NextRecord() Then
                    ClsAnnounces.Find("Code='" & txtCode.Text & "'")
...
#Region "Private Functions"
    Private Function SavePart() As Boolean
        Dim StrMode As String = Request.QueryString.Item("Mode")
        ClsAnnounces = New Clssys_Announces(Page)

        Try
            ClsAnnounces.Find("Code='" & txtCode.Text & "'")

            If ClsAnnounces.ID > 0 Then
                If Not AssignValue(ClsAnnounces) Then
                    Exit Function
                End If
                ClsAnnounces.Update("Code='" & txtCode.Text & "'")
            ...
            clsMainOtherFields.CollectDataAndSave(value.Text, ClsAnnounces.Table, ClsAnnounces.ID)
            value.Text = ""
            Return True
        Catch ex As Exception
            Return False
        End Try
    End Function
    Private Function AssignValue(ByRef ClsAnnounces As Clssys_Announces) As Boolean
        Try
            With ClsAnnounces
                .Code = txtCode.Text
        ...
        End Try
    End Function
    Private Function GetValues(ByVal ClsAnnounces As Clssys_Announces) As Boolean
        ...
        Try
            ...
            With ClsAnnounces
                ...
                If Page.IsPostBack Then
                    CreateOtherFields(ClsAnnounces.ID)
                End If
            End With
            Return True
        Catch ex As Exception
    ...
    Private Function CheckCode() As Boolean
        ...
        Try
            ClsAnnounces.Find("Code='" & txtCode.Text & "'")
            IntId = ClsAnnounces.ID
            txtEngName.Focus()
            If ClsAnnounces.ID > 0 Then
                GetValues(ClsAnnounces)
                StrMode = "E"
            Else
                If ClsAnnounces.CheckRecordExistance(" Code='" & txtCode.Text & "'") Then
                    txtCode.Text = ""
                    txtCode.Focus()
                End If
            ...
            End If
            SetToolBarDefaults()
            SetToolBarPermission(Me, ClsAnnounces.ConnectionString, ClsAnnounces.DataBaseUserRelatedID, ClsAnnounces.GroupID, StrMode)
            SetToolBarRecordPermission(Me, ClsAnnounces.ConnectionString, ClsAnnounces.DataBaseUserRelatedID, ClsAnnounces.GroupID, ClsAnnounces.Table, IntId)
    ...
    Private Sub LoadDataUpdateSchedules(ByVal formName As String)
        ...
        ClsAnnounces = New Clssys_Announces(Me.Page)
        ClsAnnounces.Find(" code = '" & txtCode.Text & "'")
        Dim recordID As Integer = ClsAnnounces.ID
        If (recordID > 0) Then
    ...
    Private Function CreateOtherFields(ByVal IntRecordID As Integer)
        ...
        If clsMainOtherFields.CheckOtherFieldsButton(Me.Page, ClsAnnounces.Table) = True Then
            Dim StrTablename As String
            ClsAnnounces = New Clssys_Announces(Me)
            StrTablename = ClsAnnounces.Table
