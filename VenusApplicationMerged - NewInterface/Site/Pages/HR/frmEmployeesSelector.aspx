...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
        * { box-sizing: border-box; }
        ...
        .form-card-body select { padding-inline-end: 24px; }
        ...
        .alert-banner .alert-title { font-weight: bold; margin-bottom: 2px; }
        .alert-banner .alert-sub { color: #8a6a20; font-size: 11px; }
        .btn-review {
            flex-shrink: 0;
            background: #1a4a7a;
            color: #fff !important;
        ...
        /* Hide UltraWebTab chrome; keep control for server/JS */
        ...
        <div class="page-header">
            ...
            <div class="page-header-main">
                ...
                <p class="page-header-sub">
                    <asp:Label ID="Label_HeaderSub" runat="server" Text=""></asp:Label>
                </p>
            </div>
            <div class="period-badge">
                <span class="meta-label"><asp:Label ID="lblCurrentPeriod" runat="server" Text="Current Period:"></asp:Label></span>
                            ...
                            <div class="es-tab-content">
                                ...
                                <div class="form-card">
                                    <div class="form-card-header">
                                        <asp:Label ID="lblMainInfo" runat="server" Text="Main Info." meta:resourcekey="TabResource1"></asp:Label>
                                    </div>
                                    <div class="form-card-body">
                                        <div class="filter-grid">
                                            <div class="filter-col">
                                                ...
                                                <div class="field-item" id="fltr_Row1" runat="server">
                                                    <span class="field-label">
                                                        <asp:Label ID="Label_Project" runat="server" Text="Employee Scope"></asp:Label>
                                                    </span>
                                                    <div class="field-control">
                                        ...
                                        <div class="search-actions">
                                            <div class="btn-search">
                                                <igtxt:WebImageButton ID="btnFind" runat="server" Height="28px" meta:resourcekey="btnFindRes"
                                                    Overflow="NoWordWrap" Style="font-family: Tahoma; font-size: 12pt; font-weight: bold;
                                                    color: Black" Text=" Search " UseBrowserDefaults="False" Width="110px">
                                ...
                                <asp:Panel ID="pnlPeriodAlert" runat="server" CssClass="alert-banner" Visible="false">
                                    ...
                                    <div class="alert-body">
                                        <div class="alert-title">
                                            <asp:Label ID="lblPeriodAlertTitle" runat="server" Text=""></asp:Label>
                                        </div>
                                        <div class="alert-sub">
                                            <asp:Label ID="lblPeriodAlertSub" runat="server" Text=""></asp:Label>
                                        </div>
                                    </div>
                                    <asp:LinkButton ID="lnkReviewNow" runat="server" CssClass="btn-review" Text="Review Now"
                                        OnClick="lnkReviewNow_Click"></asp:LinkButton>
                                </asp:Panel>
                                ...
                                <div class="form-card">
                                    <div class="form-card-body">
                                        ...
                                        <div class="grid-note">
                                            <asp:Label ID="lblGridNote" runat="server" Text=""></asp:Label>
                                        </div>
                                    </div>
                                </div>
