...
Partial Class frmEvalWPoints
    Inherits MainPage
#Region "Public Decleration"
    Private ClsWPointsList As ClsEval_WPointsList
...
#Region "Protected Sub"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ClsWPointsList = New ClsEval_WPointsList(Me.Page)
        Dim ClsObjects As New Clssys_Objects(Page)
        Dim ClsSearchs As New Clssys_Searchs(Page)
        Dim SearchID As Integer = 0
        Try
            Dim clsSearchsColumns As New Clssys_SearchsColumns(Page)
            If ClsObjects.Find(" Code='" & ClsWPointsList.Table.Trim & "'") Then
            ...
            If Not IsPostBack Then
                Page.Session.Add("ConnectionString", ClsWPointsList.ConnectionString)
                ClsWPointsList.AddOnChangeEventToControls("frmEvalWPoints", Page, UltraWebTab1)
            ...
            If (txtCode.Text <> "") Then
                ClsWPointsList.Find(" Code='" & txtCode.Text & "'")
                IntrecordID = ClsWPointsList.ID
        ...
        Catch ex As Exception
            ...
            mErrorHandler.RecordExceptions_DataBase("", ex, Err.Number, ClsWPointsList.RegUserID, Venus.Shared.ErrorsHandler.eRecordingType.System_DataBase)
    ...
    Protected Sub ImageButton_Command(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.CommandEventArgs) Handles ImageButton_Save.Command, ImageButton_SaveN.Command, LinkButton_SaveN.Command, ImageButton_New.Command, ImageButton_Print.Command, ImageButton_Properties.Command, LinkButton_Properties.Command, ImageButton_Remarks.Command, LinkButton_Remarks.Command, ImageButton_Last.Command, ImageButton_Next.Command, ImageButton_Back.Command, ImageButton_First.Command, ImageButton_Delete.Command
        ...
        Dim ObjNavigationHandler As New Venus.Shared.Web.NavigationHandler(ClsWPointsList.ConnectionString)
        Select Case e.CommandArgument
            ...
            Case "New"
                AfterOperation()
            Case "Delete"
                ClsWPointsList.Delete("Code='" & txtCode.Text & "'")
                AfterOperation()
            Case "Property"
                ClsWPointsList.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmPropertyScreen.aspx?ID=" & ClsWPointsList.ID & "&TableName=" & ClsWPointsList.Table, 477, 313, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Property", False)
            Case "Remarks"
                ClsWPointsList.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmRemarks.aspx?ID=" & ClsWPointsList.ID & "&TableName=" & ClsWPointsList.Table, 410, 210, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Remarks", False)
            Case "Print"
            ...
            Case "First"
                ClsWPointsList.Find("Code='" & txtCode.Text & "'")
                ClsWPointsList.FirstRecord()
                GetValues(ClsWPointsList)
            Case "Previous"
                ClsWPointsList.Find("Code='" & txtCode.Text & "'")
                If Not ClsWPointsList.previousRecord() Then
                    ClsWPointsList.Find("Code='" & txtCode.Text & "'")
            ...
            Case "Next"
                ClsWPointsList.Find("Code='" & txtCode.Text & "'")
                If Not ClsWPointsList.NextRecord() Then
                    ClsWPointsList.Find("Code='" & txtCode.Text & "'")
...
#Region "Private Functions"
    Private Function SavePart() As Boolean
        Dim StrMode As String = Request.QueryString.Item("Mode")
        ClsWPointsList = New ClsEval_WPointsList(Page)

        Try
            ClsWPointsList.Find("Code='" & txtCode.Text & "'")

            If ClsWPointsList.ID > 0 Then
                If Not AssignValue(ClsWPointsList) Then
                    Exit Function
                End If
                ClsWPointsList.Update("Code='" & txtCode.Text & "'")
            ...
            clsMainOtherFields.CollectDataAndSave(value.Text, ClsWPointsList.Table, ClsWPointsList.ID)
            value.Text = ""
            Return True
        Catch ex As Exception
            Return False
        End Try
    End Function
    Private Function AssignValue(ByRef ClsWPointsList As ClsEval_WPointsList) As Boolean
        Try
            With ClsWPointsList
                .Code = txtCode.Text
        ...
        End Try
    End Function
    Private Function GetValues(ByVal ClsWPointsList As ClsEval_WPointsList) As Boolean
        ...
        Try
            ...
            With ClsWPointsList
                ...
                If Page.IsPostBack Then
                    CreateOtherFields(ClsWPointsList.ID)
                End If
            End With
            Return True
        Catch ex As Exception
    ...
    Private Function CheckCode() As Boolean
        ...
        Try
            ClsWPointsList.Find("Code='" & txtCode.Text & "'")
            IntId = ClsWPointsList.ID
            txtEngName.Focus()
            If ClsWPointsList.ID > 0 Then
                GetValues(ClsWPointsList)
                StrMode = "E"
            Else
                If ClsWPointsList.CheckRecordExistance(" Code='" & txtCode.Text & "'") Then
                    txtCode.Text = ""
                    txtCode.Focus()
                End If
            ...
            End If
            SetToolBarDefaults()
            SetToolBarPermission(Me, ClsWPointsList.ConnectionString, ClsWPointsList.DataBaseUserRelatedID, ClsWPointsList.GroupID, StrMode)
            SetToolBarRecordPermission(Me, ClsWPointsList.ConnectionString, ClsWPointsList.DataBaseUserRelatedID, ClsWPointsList.GroupID, ClsWPointsList.Table, IntId)
    ...
    Private Sub LoadDataUpdateSchedules(ByVal formName As String)
        ...
        ClsWPointsList = New ClsEval_WPointsList(Me.Page)
        ClsWPointsList.Find(" code = '" & txtCode.Text & "'")
        Dim recordID As Integer = ClsWPointsList.ID
        If (recordID > 0) Then
    ...
    Private Function CreateOtherFields(ByVal IntRecordID As Integer)
        ...
        If clsMainOtherFields.CheckOtherFieldsButton(Me.Page, ClsWPointsList.Table) = True Then
            Dim StrTablename As String
            ClsWPointsList = New ClsEval_WPointsList(Me)
            StrTablename = ClsWPointsList.Table
