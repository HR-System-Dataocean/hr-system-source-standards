<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmSetCompanyRoles.aspx.vb"
    Inherits="frmSetCompanyRoles" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
...
<head runat="server">
    <title>* Venus Payroll * ~ Set Company Roles</title>
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmSetCompanyRoles" runat="server">
    <div style="display: none">
        ...
        <asp:Label ID="TargetControl" runat="server" ForeColor="White" TabIndex="-1" Width="99px"
            meta:resourcekey="TargetControlResource2"></asp:Label>
    </div>
                ...
                <td style="width: 100%; height: 60px; vertical-align: top" colspan="3">
                    <table style="width: 100%; height: 18px; vertical-align: top; border-bottom: 1px solid silver">
                        <tr>
                            ...
                            <td style="width: 30%">
                                <asp:LinkButton ID="LinkButton_ImportIncrease" runat="server" Text="Import Roles Sheet"
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblParentBranch" runat="server" SkinID="Label_DefaultNormal" Text="الإجراء الرئيسى"
                                                                meta:resourcekey="lblParentBranchResource2"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="ddl_MainLevel" runat="server" SkinID="DropDownList_LargNormal"
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="Label1" runat="server" SkinID="Label_DefaultNormal" Text="النموذج المرتبط"
                                                                meta:resourcekey="Label1Resource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="DropDownList_RelForms" runat="server" SkinID="DropDownList_LargNormal"
                                                                meta:resourcekey="ddlRelFormsResource1">
                                                                <asp:ListItem Value="0" meta:resourcekey="ListItemResource9">General Role</asp:ListItem>
                                                                <asp:ListItem Value="1" meta:resourcekey="ListItemResource10">Employee Registration</asp:ListItem>
                                                                <asp:ListItem Value="2" meta:resourcekey="ListItemResource11">Vacation Process</asp:ListItem>
                                                                <asp:ListItem Value="3" meta:resourcekey="ListItemResource12">Loans &amp; Rewards Process</asp:ListItem>
                                                                <asp:ListItem Value="4" meta:resourcekey="ListItemResource13">End Of Services Process</asp:ListItem>
                                                                <asp:ListItem Value="5" meta:resourcekey="ListItemResource14">Attendance Process</asp:ListItem>
                                                                <asp:ListItem Value="6" meta:resourcekey="ListItemResource15">Salaries Process</asp:ListItem>
                                                                <asp:ListItem Value="7" meta:resourcekey="ListItemResource16">Salary Increases</asp:ListItem>
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                </table>
