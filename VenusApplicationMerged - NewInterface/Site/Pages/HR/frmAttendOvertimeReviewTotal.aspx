<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmAttendOvertimeReviewTotal.aspx.vb"
    Inherits="frmAttendOvertimeReview" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
        ...
        function uwg_AfterCellUpdateHandler(gridName, cellId) {
            ...
            if (IsEdit == true) {
                ...
                if (cell.Column.Index == 2) {
                    ...
                    var cellCode = Row.getCellFromKey("EmployeeCode")
        ...
        function OnSucceeded(result, userContext, methodName) {
            ...
            if (methodName == 'GetEmpName') {
                if (result != '') {
                    ...
                    */
                    var cellNext = Row.getCellFromKey("TransDate");
                    cellNext.activate();
                }
                else {
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    ...
    <div style="display: none">
     <asp:ScriptManager ID="ScriptManager1" runat="server" EnablePageMethods="True">
        ...
        <asp:Label ID="lblovertimedetailsid" runat="server" meta:resourcekey="lblLageResource1"></asp:Label>
    </div>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                        <asp:Label ID="Label6" runat="server" Text="تحميل الملف" meta:resourcekey="lblFileUpload1Recource" SkinID="Label_DefaultNormal"
                                                                ></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                           <asp:FileUpload meta:resourcekey="FileUpload1Recourcekey" ID="FileUpload1" runat="server"
                                                            Style="z-index: 1; 
                                                            direction: rtl" Enabled=false />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblArbName" runat="server" Text="التوصيف عربى" meta:resourcekey="lblArbNameResource1" SkinID="Label_DefaultNormal"
                                                               ></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="Label1" runat="server" Text="كود الموظف" SkinID="Label_DefaultNormal" meta:resourcekey="lblEmpCodeResource1"
                                                                ></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="txtEmpCode" runat="server" SkinID="TextBox_LargeNormalrtl" MaxLength="255"
                                                                meta:resourcekey="txtArbNameResource1" AutoPostBack="True" Enabled="False"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="Label2" runat="server" Text="اسم الموظف" meta:resourcekey="lblEmpNameResource1" SkinID="Label_DefaultNormal"
                                                                ></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="txtEmpname" runat="server" SkinID="TextBox_LargeNormalrtl" MaxLength="255"
                                                                meta:resourcekey="txtArbNameResource1" Enabled="False"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="Label3" runat="server" Text="من تاريخ" meta:resourcekey="lblFromDateResource1" SkinID="Label_DefaultNormal"
                                                               ></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <igsch:WebDateChooser ID="WebDateChooserFromdate" runat="server" 
                                                                ...
                                                                Width="130px" EnableAppStyling="True" Value="" Enabled="False">
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="Label5" runat="server" Text="ساعات الوقت الاضافى " SkinID="Label_DefaultNormal"
                                                                meta:resourcekey="lblAddTimeResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="txtovertimeHours" runat="server" 
                                                                SkinID="TextBox_LargeNormalrtl" MaxLength="255"
                                                                meta:resourcekey="txtArbNameResource1" Enabled="False"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
                                                ...
                                                <table style="width: 100%; height: 30px; vertical-align: bottom; border-bottom: 1px solid black"
                                                    ...
                                                    <tr>
                                                        <td style="vertical-align: bottom" class="style1">
                                                            <asp:Label ID="Label_Title1" runat="server" Text="الرجاء ادخال  قيم إضافي الموظفين الواردة في النشرة"
                                                ...
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <igtbl:UltraWebGrid  Browser="UpLevel"   ID="uwgOvertimeReview" runat="server" EnableAppStyling="True"
                                                                ...
                                                                <DisplayLayout AllowColSizingDefault="Free" AllowColumnMovingDefault="OnServer" AllowSortingDefault="OnClient"
                                                                    ...
                                                                    HeaderClickActionDefault="NotSet" Name="uwgAttendShiftsDays" RowHeightDefault="18px"
                                                                    ...
                                                                    <ClientSideEvents AfterCellUpdateHandler="uwg_AfterCellUpdateHandler" 
                                                                        AfterEnterEditModeHandler="uwgEnterCellEdit" />
                                                                ...
                                                                <Bands>
                                                                    <igtbl:UltraGridBand  AllowColSizing="Fixed" AllowColumnMoving="None"  AllowSorting="No" >
                                                                        <AddNewRow View="NotSet">
                                                                        </AddNewRow>
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <igtbl:UltraGridColumn BaseColumnName="OvertimeReviewID" Hidden="True" Key="AttendShiftID">
                                                                                <Header>
                                                                            ...
                                                                            <igtbl:UltraGridColumn BaseColumnName="EmployeeCode" Key="EmployeeCode" Width="15%" >
                                                                                ...
                                                                                <ValueList>
                                                                                    <ValueListItems>
                                                                                        <igtbl:ValueListItem DataValue="1" DisplayText="السبت" Key="1" />
                                                                                        <igtbl:ValueListItem DataValue="2" DisplayText="الأحد" Key="2" />
                                                                                        <igtbl:ValueListItem DataValue="3" DisplayText="الإثنين" Key="3" />
                                                                                        <igtbl:ValueListItem DataValue="4" DisplayText="الثلاثاء" Key="4" />
                                                                                        <igtbl:ValueListItem DataValue="5" DisplayText="الأربعاء" Key="5" />
                                                                                        <igtbl:ValueListItem DataValue="6" DisplayText="الخميس" Key="6" />
                                                                                        <igtbl:ValueListItem DataValue="7" DisplayText="الجمعة" Key="7" />
                                                                                    </ValueListItems>
                                                                                </ValueList>
                                                                             ...
                                                                             <igtbl:UltraGridColumn AllowUpdate="No" BaseColumnName="FullName" Key="FullName"
                                                                                meta:resourcekey="UltraGridColumnResource6" Width="40%">
                                                                    ...
                                                                    <igtbl:UltraGridColumn BaseColumnName="TransDate" Key="TransDate" Width="27%"
                                                                     Format="dd/MM/yyyy hh:mm tt"  meta:resourcekey="UltraGridColumnResource5">
                                                                    ...
                                                                    <Footer>
                                                                        ...
                                                                        <RowLayoutColumnInfo OriginX="3" />
                                                                            ...
                                                                            <igtbl:UltraGridColumn Width="15%" BaseColumnName="Overtime" Key="Overtime" EditorControlID=""
                                                                                Type="Custom" DataType="System.UInt32">
                                                                                <Header Caption="عدد ساعات الإضافي">
                                                                                    <RowLayoutColumnInfo OriginX="4" />
                                                                                    <RowLayoutColumnInfo OriginX="4" />
                                                                                    <RowLayoutColumnInfo OriginX="4" />
                                                                                </Header>
                                                                              ...
                                                                              <igtbl:UltraGridColumn Key="btnDel" Width="3%" Type="Button" CellButtonDisplay="Always"
