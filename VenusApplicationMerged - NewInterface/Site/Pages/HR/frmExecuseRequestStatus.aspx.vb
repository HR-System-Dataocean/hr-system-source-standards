...
#Region "Protected Sub"
    ...
    Protected Sub ImageButton_Command(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.CommandEventArgs) Handles ImageButton_Save.Command
        ...
        Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "../../Interfaces/frmReportsGridViewer.aspx?Language=false&Criteria=RequestSerial&preview=1&ReportCode=CF_120&sq0=''&v=" & Session("RequestSerial"), 700, 490, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "wWindO", False, True, False, False, False, False, False, False, False)
...
#Region "Private Functions"
    ...
    Private Sub FillEmployeeVacations(ByVal EmployeeID As Integer, Optional ByVal showFirstRecord As Boolean = False)
        ...
        If Type = 2 Then
            Try
                ...
                Dim str1 As String
                'str1 = "select " & EmpName & " as EmployeeName,( case when SS_UserActions.ActionAraName is not null then SS_UserActions.ActionAraName else 'Pending ...' end) As Action ,convert(varchar, ActionDate,101) as ActionDate,ActionRemarks  from SS_ExecuseRequest join SS_RequestActions on SS_ExecuseRequest.ID=SS_RequestActions.RequestSerial and SS_ExecuseRequest.EmployeeID=SS_RequestActions.EmployeeID join hrs_Employees on hrs_Employees.ID= SS_RequestActions.SS_EmployeeID left join SS_UserActions on SS_RequestActions.ActionID=SS_UserActions.ID where RequestSerial=" & RequestSerial & " And SS_RequestActions.FormCode='" & FormCode & "' and ( SS_RequestActions.IsHidden is null or SS_RequestActions.IsHidden=0 ) and SS_ExecuseRequest.EmployeeID=" & ClsEmployees.ID & " "
                str1 = "select " & EmpName & " as EmployeeName,( case when " & ActionName & " is not null then " & ActionName & " else 'Pending ...' end) As Action ,convert(varchar, ActionDate,101) as ActionDate,ActionRemarks ,SS_RequestActions.ConfirmedNoOfdays  from SS_ExecuseRequest join SS_RequestActions on SS_ExecuseRequest.ID=SS_RequestActions.RequestSerial and SS_ExecuseRequest.EmployeeID=SS_RequestActions.EmployeeID join hrs_Employees on hrs_Employees.ID= SS_RequestActions.SS_EmployeeID left join SS_UserActions on SS_RequestActions.ActionID=SS_UserActions.ID where RequestSerial=" & RequestSerial & " And SS_RequestActions.FormCode='" & FormCode & "' and ( SS_RequestActions.IsHidden is null or SS_RequestActions.IsHidden=0 )  "
                ...
                strselect = "select SS_ExecuseRequest.Code as RequestSerial ,Convert(date,RequestDate) as RequestDate,ExecuseDate,ExecuseType,ExecuseReason,ExecuseTime,Case when ExecuseShift=1 then '" & firstshifName & "' else  '" & secondshifName & "' End as ExecuseShift,ExecuseRemarks from SS_ExecuseRequest  where  SS_ExecuseRequest.ID=" & RequestSerial & ""
                ...
                If DS2.Tables(0).Rows.Count > 0 Then
                    ...
                    TxtExecuseRemarks.Text = DS2.Tables(0).Rows(0)("ExecuseRemarks").ToString()
        ...
        Else
            Try
                ...
                Dim str1 As String
                'str1 = "select " & EmpName & " as EmployeeName,( case when SS_UserActions.ActionAraName is not null then SS_UserActions.ActionAraName else 'Pending ...' end) As Action ,convert(varchar, ActionDate,101) as ActionDate,ActionRemarks  from SS_ExecuseRequest join SS_RequestActions on SS_ExecuseRequest.ID=SS_RequestActions.RequestSerial and SS_ExecuseRequest.EmployeeID=SS_RequestActions.EmployeeID join hrs_Employees on hrs_Employees.ID= SS_RequestActions.SS_EmployeeID left join SS_UserActions on SS_RequestActions.ActionID=SS_UserActions.ID where RequestSerial=" & RequestSerial & " And SS_RequestActions.FormCode='" & FormCode & "' and ( SS_RequestActions.IsHidden is null or SS_RequestActions.IsHidden=0 ) and SS_ExecuseRequest.EmployeeID=" & ClsEmployees.ID & " "
                str1 = "select " & EmpName & " as EmployeeName,( case when " & ActionName & " is not null then " & ActionName & " else 'Pending ...' end) As Action ,convert(varchar, ActionDate,101) as ActionDate,ActionRemarks  from SS_ExecuseRequest join SS_RequestActions on SS_ExecuseRequest.ID=SS_RequestActions.RequestSerial and SS_ExecuseRequest.EmployeeID=SS_RequestActions.EmployeeID join hrs_Employees on hrs_Employees.ID= SS_RequestActions.SS_EmployeeID left join SS_UserActions on SS_RequestActions.ActionID=SS_UserActions.ID where RequestSerial=" & RequestSerial & " And SS_RequestActions.FormCode='" & FormCode & "' and ( SS_RequestActions.IsHidden is null or SS_RequestActions.IsHidden=0 ) "
    ...
    Private Sub CancelRequest(FormCode As String, RequestSerial As String)
        ...
        If CanbeCanceled Then
            ...
            End Try
            Try
                Dim ClsEmployeesExcuses1 As New Clshrs_EmployeesExcuses(Page)
                If ClsEmployeesExcuses1.Find("SRC='SS_0014' and RequestID='" & RequestSerial & "'") Then

                    If ClsEmployeesExcuses1.ExcuseDate <= DateTime.Now Then
                        Venus.Shared.Web.ClientSideActions.MsgBoxBasic(Page, ObjNavigationHandler.SetLanguage(Page, " Sorry you can't Cancel this request after Excuse Date./عفوا لايمكن الغاء الطلب بعد تاريخ الاذن "))
                        Exit Sub
            ...
            '5- Cancel Excuse Transaction if exist
            Dim ClsEmployeesExcuses As New Clshrs_EmployeesExcuses(Page)
            If ClsEmployeesExcuses.Find("SRC='SS_0014' and RequestID='" & RequestSerial & "'") Then
                Dim CancelTransaction As String
                CancelTransaction = "update hrs_EmployeesExcuses set  CancelDate=GETDATE() where SRC='SS_0014' and RequestID='" & RequestSerial & "'"
                SqlCommand = New SqlClient.SqlCommand
                SqlCommand.Connection = New SqlClient.SqlConnection(ConnStr)
                SqlCommand.CommandType = CommandType.Text
                SqlCommand.CommandText = CancelTransaction
                SqlCommand.Connection.Open()
                SqlCommand.ExecuteNonQuery()
                SqlCommand.Connection.Close()
