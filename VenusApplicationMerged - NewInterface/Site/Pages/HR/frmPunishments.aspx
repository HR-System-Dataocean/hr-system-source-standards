<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmPunishments.aspx.vb"
...
<head runat="server">
    ...
    <script language="javascript" src="Scripts/App_JScript_frmTransactionsTypes.js" type="text/javascript"></script>
            ...
            <tr>
                <td class="Details">
                    <igtab:UltraWebTab ID="UltraWebTab1" runat="server" EnableAppStyling="True" SkinID="Default"
                        meta:resourcekey="UltraWebTab1Resource1" style="margin-top: 0px"  >
                        <Tabs>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="Label2" runat="server" Text="التوصيف الإنجليزى" SkinID="Label_DefaultNormal"
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblShortEngName" runat="server" SkinID="Label_DefaultNormal" Text="التوصيف العربى"
                                                            meta:resourcekey="lblShortEngNameResource1"></asp:Label>
                                                           
                                                        </td>
                                                        <td class="DataAreawithsearch">
                                                            <asp:TextBox ID="txtArbName" runat="server" MaxLength="255" SkinID="TextBox_LargeNormalltr"
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="DataAreawithsearch">
                                                            <asp:TextBox ID="txtFormula" runat="server" MaxLength="255" meta:resourcekey="txtFormulaResource1" SkinID="TextBox_LargeNormalltr"></asp:TextBox>
                                                        </td>
                                                        <td class="search">
