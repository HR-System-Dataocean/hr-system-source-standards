<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmVisaRequest.aspx.vb"
...
<head runat="server">
    <title>* Venus Payroll * ~ Visa Request</title>
    ...
    <script type="text/javascript" id="igClientScript">
        ...
        function OpenPrintedScreen(v) {
            ...
            var win = window.open("../../Interfaces/frmReportsGridViewer.aspx?Language=false&Criteria=RequestSerial&preview=1&ReportCode=CF_148&sq0=''&v=" + v, "_NEW", "height=" + hight + ",width=" + width + ",resizable=0,menubar=0,toolbar=0,location=0,directories=0,scrollbars=0,status=0,center=0");
            win.focus();
        }
    </script>
    <style type="text/css">
...
<body style="margin: 0; padding: 0;">
            ...
            <tr>
                <td class="Details">
                    <igtab:UltraWebTab ID="UltraWebTab1" runat="server" EnableAppStyling="True" SkinID="Default"
                        ...
                        <Tabs>
                            <igtab:Tab Text="Family or Visit Visa Request" meta:resourcekey="TabResource1">
                                <ContentTemplate>
    ...
    <td class="LabelArea">
            <asp:Label ID="lblVisaType" runat="server" Width="50px" SkinID="Label_DefaultNormal"
        Text="نوع التأشيرة" meta:resourcekey="lblVisaTypeResource1"></asp:Label>
</td>
   <td class="DataArea">
    <asp:DropDownList ID="DdlVisaType" Width="200px" runat="server" SkinID="DropDownList_smallNormal"
        meta:resourcekey="DdlVisaTypeResource1" TabIndex="3">
    </asp:DropDownList>
</td>
</tr>
                                                    <tr>
