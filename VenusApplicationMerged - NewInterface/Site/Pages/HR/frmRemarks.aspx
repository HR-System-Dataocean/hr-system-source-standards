    ...
    <div>
        <div align="left" style="border-right: 1px outset; border-top: 1px outset; z-index: 102;
            ...
            <asp:Label ID="lblRecordID" runat="server" Height="19px" Style="z-index: 106; left: 171px;
                position: absolute; top: 14px" Width="100px" 
                meta:resourcekey="lblRecordIDResource1"></asp:Label>
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
            <asp:TextBox ID="txtRemarks" runat="server" BorderColor="White"
                BorderStyle="Solid" BorderWidth="1px" Height="120px" Style="z-index: 102; left: 34px;
                position: absolute; top: 40px; right: 107px;" TextMode="MultiLine" 
                Width="335px" meta:resourcekey="txtRemarksResource1"></asp:TextBox>
            &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;
            ...
            <asp:Label ID="lbFrom" runat="server" Style="z-index: 105; position: absolute;
                top: 14px" Text="Form :" Width="45px" Height="19px" 
                meta:resourcekey="lbFromResource1"></asp:Label>
        </div>
