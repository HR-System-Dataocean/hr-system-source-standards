<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmExecuseRequestStatus.aspx.vb"
               ...
               AutoPostBack="True" meta:resourcekey="txtRequestTypeResource1" ReadOnly="true">
                                                    ...
                                                    <tr>
                                                      ...
                                                      <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="LblStartDate" runat="server" Width="90px" SkinID="Label_DefaultNormal"
                                                                Text=" تاريخ الاذن" meta:resourcekey="LblExecuseDateResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="TxtExecuseDate" runat="server" SkinID="TextBox_SmalltNormalc" meta:resourcekey="lbRemainValResource1"
                                                                TabIndex="1" ReadOnly="True"></asp:TextBox>
                                                        </td>
                                                           <td class="SeparArea">
                                                        </td>
                                                        <td class="LabelArea">
                                                            <asp:Label ID="LblPeriod" runat="server" Width="90px" SkinID="Label_DefaultNormal"
                                                                Text=" مدة الاذن" meta:resourcekey="LblPeriodlResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                      ...
                                                      <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="LblType" runat="server" Width="90px" SkinID="Label_DefaultNormal"
                                                                Text=" نوع الاذن" meta:resourcekey="LblTypeResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="LblReason" runat="server" Width="90px" SkinID="Label_DefaultNormal"
                                                                Text="سبب الاذن" meta:resourcekey="LblReasonResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="TxtExecuseReason" runat="server" SkinID="TextBox_SmalltNormalc" meta:resourcekey="lbRemainValResource1"
                                                                TabIndex="1" ReadOnly="True"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                     ...
                                                     <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="LblShift" runat="server" Width="90px" SkinID="Label_DefaultNormal"
                                                                Text=" الوردية" meta:resourcekey="LblShiftResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="TxtExecuseShift" runat="server" SkinID="TextBox_SmalltNormalc" meta:resourcekey="lbRemainValResource1"
                                                                TabIndex="1" ReadOnly="True"></asp:TextBox>
                                                        </td>
                                                           <td class="SeparArea">
                                                        </td>
                                                        <td class="LabelArea">
                                                            <asp:Label ID="LblRemarks" runat="server" Width="90px" SkinID="Label_DefaultNormal"
                                                                Text="سبب العذر" meta:resourcekey="LblRemarksResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="TxtExecuseRemarks" runat="server" width="170px" meta:resourcekey="lbRemainValResource1"
                                                                TabIndex="1" ReadOnly="True"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
