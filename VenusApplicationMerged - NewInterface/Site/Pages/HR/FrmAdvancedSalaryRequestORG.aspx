<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmAdvancedSalaryRequestORG.aspx.vb"
...
<head runat="server">
    <title>* Venus Payroll * ~ Advance Housing Request</title>
    ...
    <asp:Label ID="label3" Width="100px" runat="server" Text="Employee Name"
        SkinID="Label_DefaultNormal" meta:resourcekey="labelDescEnglishNameResource1"></asp:Label>
                                         ...
                                         <%-- <td class="SeparArea">
                                                    ...
                                                    <td class="DataArea">
    <asp:TextBox ID="lblDescEnglishName" Width="150" runat="server" SkinID="TextBox_SmalltNormalc"
    ...
    <asp:Label ID="label5" Width="150px" runat="server" Text="Nationality"
        SkinID="Label_DefaultNormal" meta:resourcekey="labelNationalityResource1"></asp:Label>
                                         ...
                                         <%-- <td class="SeparArea">
                                                    ...
                                                    <td class="DataArea">
    <asp:TextBox ID="txtNationality" Width="150" runat="server" SkinID="TextBox_SmalltNormalc"
        ReadOnly="True" MaxLength="255" meta:resourcekey="lblDescEnglishNameResource1"
        TabIndex="1"></asp:TextBox>
</td>
