    ...
    Private Sub FillEmployeeVacations()
        Try
            ...
            If DdlRequestType.SelectedValue > 0 Then
                ...
                Dim StrGetRwquestCode As String
                StrGetRwquestCode = "select RequestCode  from SS_RequestTypes where RequestID= " & DdlRequestType.SelectedValue & " "
                RequestCode = Microsoft.ApplicationBlocks.Data.SqlHelper.ExecuteScalar(CType(HttpContext.Current.Session("ConnectionString"), String), Data.CommandType.Text, StrGetRwquestCode)
                Criteria += " and FormCode='" & RequestCode & "'"
            End If
            If DdlYear.SelectedValue > 0 And DdlMonth.SelectedValue = 0 Then
                Criteria += " and year( RequestDate)=" & DdlYear.SelectedValue & " "
            End If
            If DdlYear.SelectedValue > 0 And DdlMonth.SelectedValue > 0 Then
                Criteria += " and year( RequestDate)=" & DdlYear.SelectedValue & "And Month( RequestDate)=" & DdlMonth.SelectedValue & " "
            End If
            If DdlYear.SelectedValue = 0 And DdlMonth.SelectedValue > 0 Then
            ...
            If str1 <> "" Then
                ...
                Criteria += " Order By  RequestDate desc "
