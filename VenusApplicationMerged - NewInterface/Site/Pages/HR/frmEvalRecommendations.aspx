<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmEvalRecommendations.aspx.vb"
    Inherits="frmEvalRecommendations" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
...
<head runat="server">
    <title>* Venus Payroll * ~Evaluation Recommendations</title>
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmEvalRecommendations" runat="server">
                        ...
                        <tr>
                            ...
                            <td style="width: 24px">
                                <asp:ImageButton ID="ImageButton_Save" Width="16px" Height="16px" runat="server"
                                    ...
                                    OnClientClick="SaveOtherFieldsData();" TabIndex="-1" />
                            </td>
                            <td style="width: 120px">
                                ...
                                <asp:LinkButton ID="LinkButton_SaveN" runat="server" Text="حفظ مع جديد" meta:resourcekey="LinkButton_SaveNResource1"
                                    CommandArgument="SaveNew" OnClientClick="SaveOtherFieldsData();" TabIndex="-1"></asp:LinkButton>
                            </td>
                            <td style="width: 24px">
                                <asp:ImageButton ID="ImageButton_New" Width="16px" Height="16px" runat="server" SkinID="HrNew_Command"
                                    meta:resourcekey="ImageButton_NewResource1" CommandArgument="New" TabIndex="-1" />
                            </td>
                            <td style="width: 24px">
                            ...
                            <td style="width: 80px">
                                ...
                                <asp:LinkButton ID="LinkButton_Remarks" runat="server" Text="ملاحظات" meta:resourcekey="LinkButton_RemarksResource1"
                                    CommandArgument="Remarks" TabIndex="-1"></asp:LinkButton>
                            </td>
                            <td style="width: 40px">
