<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmExecuseRequest.aspx.vb"
...
<head runat="server">
    ...
    <script type="text/javascript" id="igClientScript">
        ...
        function OpenPrintedScreen(v) {
            ...
            var win = window.open("../../Interfaces/frmReportsGridViewer.aspx?Language=false&Criteria=RequestSerial&preview=1&ReportCode=CF_120&sq0=''&v=" + v, "_NEW", "height=" + hight + ",width=" + width + ",resizable=0,menubar=0,toolbar=0,location=0,directories=0,scrollbars=0,status=0,center=0");
            win.focus();
        }
    </script>
    <style type="text/css">
            ...
            <tr>
                <td class="Details">
                    <igtab:UltraWebTab ID="UltraWebTab1" runat="server" EnableAppStyling="True" SkinID="Default"
                        ...
                        <Tabs>
                            <igtab:Tab Text="طلب استئذان" meta:resourcekey="TabResource1">
                                <ContentTemplate>
                                            ...
                                            <td style="width: 6%; height: 16px; vertical-align: top">
                                                <table style="width: 47%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblExecuseType" runat="server" Width="100px" SkinID="Label_DefaultNormal"
                                                                Text="نوع الاستئذان" meta:resourcekey="lblExecuseResource1"></asp:Label>
                                                        </td>
                                                        <td class="SeparArea">
                                                        </td>
                                                        <td class="SeparArea">
                                                        ...
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="DdlExecuseType" Width="200px" runat="server" SkinID="DropDownList_smallNormal"
                                                                ...
                                                                <asp:ListItem meta:resourcekey="lblSelectResource1" Value="0">حدد الخيار</asp:ListItem>
                                                                                    ...
                                                                                    <asp:ListItem meta:resourcekey="lblFullResource1" Value="Full">كامل الدوام</asp:ListItem>
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                     <td style="width: 6%; height: 16px; vertical-align: top">
                                                     ...
                                                     <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="LblExecuseReason" runat="server" Width="120px" SkinID="Label_DefaultNormal"
                                                                Text="سبب الاستئذان" meta:resourcekey="LblExecuseReasonResource1"></asp:Label>
                                                        </td>
                                                        <td class="SeparArea">
                                                        </td>
                                                        <td class="SeparArea">
                                                        ...
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="DdlExecuseReason" Width="200px" runat="server" SkinID="DropDownList_smallNormal"
                                                                meta:resourcekey="DdlExecuseReasonResource1" TabIndex="3">
                                                                 <asp:ListItem meta:resourcekey="lblSelectResource1" Value="0">حدد الخيار</asp:ListItem>
                                                                                    <asp:ListItem meta:resourcekey="lblMedicalResource1" Value="Sick">عذر مرضي</asp:ListItem>
                                                                                    <asp:ListItem meta:resourcekey="lblWorkResource1" Value="Business">عذر عمل</asp:ListItem>
                                                    ...
                                                    <td class="SeparArea">
                                                         ...
                                                         <td class="LabelArea">
                                                            <asp:Label ID="lblWebDateChooser1" runat="server" Width="120px" meta:resourcekey="lblExecuseDateResource1"
                                                                SkinID="Label_DefaultNormal" Text="تاريخ الاستئذان"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                        ...
                                        <tr>
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 47%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="labelRemainVal" runat="server" Width="120px" SkinID="Label_DefaultNormal"
                                                                Text="مدة الاستئذان" meta:resourcekey="labelExecuseDurationResource1"></asp:Label>
                                                        </td>
                                                       
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="TxtExecuseTime" runat="server" SkinID="TextBox_SmalltNormalc" meta:resourcekey="lbRemainValResource1"
                                                             autopostback="true" placeholder="00:00"    TabIndex  ="5" ReadOnly="false"></asp:TextBox>
                                         ...
                                         <td style="width: 6%; height: 16px; vertical-align: top">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="LblShift" runat="server" Width="50px" SkinID="Label_DefaultNormal"
                                                                Text="الوردية" meta:resourcekey="LblShiftResource1"></asp:Label>
                                                        </td>
                                                        
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="DdlShift" Width="200px" runat="server" SkinID="DropDownList_smallNormal"
                                                                meta:resourcekey="DdlShiftResource1" TabIndex="3">
                                                                <asp:ListItem meta:resourcekey="lblSelectResource1" Value="0">حدد الخيار</asp:ListItem>
                                                                    ...
                                                                    <asp:ListItem meta:resourcekey="lblSingleshiftDutyResource" Value="3">دوام كامل</asp:ListItem>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 50%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblRemarks" Width="120px" runat="server" Text="تفاصيل العذر"
                                                        ...
                                                        <td class="DataArea">
                                                           ...
                                                           TextMode="MultiLine"   ReadOnly="False" MaxLength="500" meta:resourcekey="lblDescEnglishNameResource1"
                                                                TabIndex="1"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
