<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmBankAccountUpdateStatus.aspx.vb"
...
<body style="margin: 0; padding: 0;">
    ...
    <Appearance>
     ...
     Text="Bank" meta:resourcekey="lblBankResource1"></asp:Label>
                 ...
                 <td class="DataArea">
                     <asp:DropDownList ID="ddlOldBank" Enabled="false" runat="server" SkinID="DropDownList_LargNormal" meta:resourcekey="ddlBankResource1">
 </asp:DropDownList>
                 </td>
             </tr>
         </table>
    ...
    Width="80px" meta:resourcekey="lblBankAccountResource1"></asp:Label>
                 ...
                 <td class="DataArea">
                     <asp:TextBox ID="txtOldBankAccount" runat="server" Enabled="false" SkinID="TextBox_LargeNormalC" meta:resourcekey="txtBankAccountResource1"></asp:TextBox>
                 </td>
             </tr>
         </table>
     </td>
     ...
     Text="Bank" meta:resourcekey="lblBankResource1"></asp:Label>
                 ...
                 <td class="DataArea">
                     <asp:DropDownList ID="ddlBank" runat="server" Enabled="false" SkinID="DropDownList_LargNormal" meta:resourcekey="ddlBankResource1">
 </asp:DropDownList>
                 </td>
             </tr>
         </table>
    ...
    Width="80px" meta:resourcekey="lblBankAccountResource1"></asp:Label>
                 ...
                 <td class="DataArea">
                     <asp:TextBox ID="txtBankAccount" runat="server" Enabled="false" SkinID="TextBox_LargeNormalC" meta:resourcekey="txtBankAccountResource1"></asp:TextBox>
                 </td>
             </tr>
         </table>
     </td>
