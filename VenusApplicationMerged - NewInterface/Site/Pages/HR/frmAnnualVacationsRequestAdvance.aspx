<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmAnnualVacationsRequestAdvance.aspx.vb"
    Inherits="frmAnnualVacationsRequestAdvance" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
...
<body style="margin: 0; padding: 0;">
    <form id="frmAnnualVacationsRequestAdvance" runat="server" defaultbutton="Button1">
            ...
            <tr>
                <td class="Details">
                    <igtab:UltraWebTab ID="UltraWebTab1" runat="server" EnableAppStyling="True" SkinID="Default"
                        ...
                        <Tabs>
                            <igtab:Tab Text="طلب اجازة سنوي اداري" meta:resourcekey="TabResource1">
                                <ContentTemplate>
                                    <table style="width: 100%; height: 100%; min-height: 350px; vertical-align: top"
                                        ...
                                        <tr>
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 60%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 50%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="DdlVacationType" Width="200px" runat="server" SkinID="DropDownList_smallNormal"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="labelTotalVal" runat="server" Width="90px" SkinID="Label_DefaultNormal"
                                                                Text="الرصيد الحالي" meta:resourcekey="labelCurrentBalanceResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                         ...
                                                         &nbsp;&nbsp;&nbsp;&nbsp;
                                                            ...
                                                            <asp:Label ID="lblRemainT" runat="server" SkinID="Label_CopyRightsNormal"
                                                                Text="مرحل" meta:resourcekey="lblRemainTResource1"></asp:Label>
                                                            ...
                                                            <asp:Label ID="lblCompLbl" runat="server" SkinID="Label_CopyRightsNormal"
                                                                Text="تعويض" meta:resourcekey="lblCompLblResource1"></asp:Label>
                                                            ...
                                                            <asp:Label ID="lblCompConsumedLbl" runat="server" SkinID="Label_CopyRightsNormal"
                                                                Text="تعويض" meta:resourcekey="lblCompConsumedLblResource1">></asp:Label>
                                                            ...
                                                            <asp:Label ID="lblCompRemainLbl" runat="server" SkinID="Label_CopyRightsNormal"
                                                                Text="تعويض" meta:resourcekey="lblCompRemainLblResource1"></asp:Label>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="labelRemainVal" runat="server" Width="90px" SkinID="Label_DefaultNormal"
                                                                Text="ايام الاجازة" meta:resourcekey="labelNoOfDaysResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                         ...
                                                         <td class="SeparArea">
                                                             ...
                                                             <td class="LabelArea">
                                                            <asp:Label ID="lblWebDateChooser2" runat="server" Width="90px" meta:resourcekey="lblReturnDateResource1"
