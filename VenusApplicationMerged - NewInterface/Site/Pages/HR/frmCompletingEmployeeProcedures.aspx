<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmCompletingEmployeeProcedures.aspx.vb"
    Inherits="frmCompletingEmployeeProcedures" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
 ...
 <asp:TextBox ID="TxtEmpName" Width="160px" runat="server"  MaxLength="100"
                                                        ...
                                                        <Bands>
                                                            <igtbl:UltraGridBand meta:resourcekey="UltraGridBandResource1">
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <igtbl:UltraGridColumn BaseColumnName="ID" Width="10%" DataType="System.Int32" Hidden="False"
                                                                    ...
                                                                    <igtbl:UltraGridColumn BaseColumnName="JoinDate" Width="15%" DataType="System.Date"
                                                                        Format="dd/MM/yyyy" Hidden="False" Key="JoinDate" meta:resourcekey="RequestDateResource2">
                                                                        
                                                                        <Header Caption="تاريخ التقديم">
                                                                    ...
                                                                    <igtbl:UltraGridColumn BaseColumnName="E_Mail" Width="15%" DataType="System.string"
                                                                          Hidden="False" Key="E_Mail" meta:resourcekey="RequestTypeResource3">
                                                                        
                                                                        <Header Caption="الايميل ">
                                                                    ...
                                                                    <igtbl:UltraGridColumn BaseColumnName="Mobile" Width="15%" DataType="System.string"
      Hidden="False" Key="Mobile" meta:resourcekey="MobileResource1">
    
    <Header Caption="الموبايل">
        <RowLayoutColumnInfo OriginX="2" />
    </Header>
    <CellStyle HorizontalAlign="Center">
</CellStyle>
    <Footer>
        <RowLayoutColumnInfo OriginX="2" />
                                                                    ...
                                                                    <Header Caption="استكمال البيانات">
                                                                    ...
                                                                    meta:resourcekey="CancelResource16">
                                                                    <Header Caption="الغاء">
                                                                        <RowLayoutColumnInfo OriginX="5" />
                                                                    </Header>
                                                                    <CellStyle HorizontalAlign="Center">
                                                                    </CellStyle>
    ...
    <script type="text/javascript" id="igClientScript">
        ...
        function uwgEmployeeVacations_ClickCellButtonHandler(gridName, cellId) {
            ...
            if (columnIndex === 7) {
                ...
                OpenModal1(
                    "frmEmployeeWizard.aspx?ID=" + requestSerial + "&FormCode=" + formCode,
                    560,
                    800,
                    false,
                    ""
            ...
            if (columnIndex == 8) {
                ...
                var formCode = row.getCellFromKey("FormCode").getValue();
                var confirmed = confirm("Are you sure you want to Cancel this new Employee?");
                if (!confirmed) {
                    return; // ❌ Cancel if user clicks "Cancel"
                }
                // Send to server
                setTimeout(function () {
                    __doPostBack('<%= Me.UniqueID %>', id + '|' + formCode);
                }, 0);
