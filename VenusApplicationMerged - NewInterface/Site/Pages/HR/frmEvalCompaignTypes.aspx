<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmEvalCompaignTypes.aspx.vb"
    Inherits="frmEvalCompaignTypes" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
...
<head runat="server">
    <title>* Venus Payroll * ~Eval Compaign Types</title>
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmEvalCompaignTypes" runat="server">
    <div style="display: none">
        ...
        <asp:CheckBox ID="CheckBox_ExternalLevel0" runat="server" meta:resourcekey="CheckBox_ExternalLevelRecourcekey" Text="External Level" />
                                                            <asp:CheckBox ID="CheckBox_DownLevel" runat="server" 
                                                                meta:resourcekey="CheckBox_DownLevelRecourcekey" Text="Down Level" />
                                                            <asp:CheckBox ID="CheckBox_AllLevel" runat="server" 
                                                                meta:resourcekey="CheckBox_AllLevelRecourcekey" Text="All Level" />
                                                            <asp:CheckBox ID="CheckBox_UpLevel" runat="server" 
                                                                meta:resourcekey="CheckBox_UpLevelRecourcekey" Text="Up Level" Width="92px" />
                                                            <asp:CheckBox ID="CheckBox_SameLevel" runat="server" 
                                                                meta:resourcekey="CheckBox_SameLevelRecourcekey" Text="Same Level" />
     <asp:CheckBox ID="CheckBox_ExternalLevel" runat="server" 
                                                    meta:resourcekey="CheckBox_ExternalLevelRecourcekey" Text="External Level" />
    </div>
                                    ...
                                    <table style="width: 100%; height: 100%; min-height: 350px; vertical-align: top"
                                                ...
                                                <table style="width: 100%; height: 30px; vertical-align: bottom; border-bottom: 1px solid black"
                                                    ...
                                                    <tr>
                                                        <td style="vertical-align: bottom">
                                                            <asp:Label ID="Label_Title1" runat="server" Text="Select Type Of Evaluation Compaign"
                                        ...
                                        <tr>
                                            <td style="height: 16px; vertical-align: top" colspan="3">
                                                <table style="width: 100%; vertical-align: top; text-align: center;" cellspacing="0">
                                                    <tr>
                                                        <td style="width:5px;"></td>
                                                        <td>
                                                            <asp:ImageButton ID="ImageButton_DownLevel" runat="server" BorderStyle="None" 
                                                                BorderWidth="2px" CausesValidation="False" Height="100px" ImageAlign="Middle" 
                                                                ImageUrl="~/Pages/HR/Img/Down.png" 
                                                                meta:resourcekey="ImageButton_DownLevelResource1" />
                                                        </td>
                                                        <td style="width:5px;"></td>
                                                        <td>
                                                            <asp:ImageButton ID="ImageButton_UpLevel" runat="server" BorderStyle="None" 
                                                                BorderWidth="2px" CausesValidation="False" Height="100px" ImageAlign="Middle" 
                                                                ImageUrl="~/Pages/HR/Img/Up.png" Width="100px" 
                                                                meta:resourcekey="ImageButton_UpLevelResource1"/>
                                                        </td>
                                                        <td style="width:5px;"></td>
                                                        <td>
                                                            <asp:ImageButton ID="ImageButton_SameLevel" runat="server" BorderStyle="None" 
                                                                BorderWidth="2px" CausesValidation="False" Height="100px" ImageAlign="Middle" 
                                                                ImageUrl="~/Pages/HR/Img/Same.png" Width="100px" 
                                                                meta:resourcekey="ImageButton_SameLevelResource1"/>
                                                        </td>
                                                        <td style="width:5px;"></td>
                                                        <td>
                                                            <asp:ImageButton ID="ImageButton_AllLevel" runat="server" BorderStyle="None" 
                                                                BorderWidth="2px" CausesValidation="False" Height="100px" ImageAlign="Middle" 
                                                                ImageUrl="~/Pages/HR/Img/All.png" Width="100px" 
                                                                meta:resourcekey="ImageButton_AllLevelResource1" />
                                                        </td>
                                                        <td style="width:5px;"></td>
                                                        <td>
                                                            <asp:ImageButton ID="ImageButton_ExternalLevel" runat="server" 
                                                                BorderStyle="None" BorderWidth="2px" CausesValidation="False" Height="100px" 
                                                                ImageAlign="Middle" ImageUrl="~/Pages/HR/Img/External.png" Width="100px" 
                                                                meta:resourcekey="ImageButton_ExternalLevelResource1" />
                                                        </td>
                                                        <td style="width:5px;"></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Label ID="lbl0" runat="server" 
                                                                ...
                                                                Text="Down Level Evaluation" meta:resourcekey="lbl0Resource1"></asp:Label>
                                                        </td>
                                                        <td style="width:5px;"></td>
                                                        <td>
                                                            <asp:Label ID="lbl1" runat="server" SkinID="Label_DefaultNormal" 
                                                                Text="Upper Level Evaluation" meta:resourcekey="lbl1Resource1"></asp:Label>
                                                        </td>
                                                        <td style="width:5px;"></td>
                                                        <td>
                                                            <asp:Label ID="lbl2" runat="server" SkinID="Label_DefaultNormal" 
                                                                Text="Same Level Evaluation" meta:resourcekey="lbl2Resource1"></asp:Label>
                                                        </td>
                                                        <td style="width:5px;"></td>
                                                        <td>
                                                            <asp:Label ID="lbl3" runat="server" SkinID="Label_DefaultNormal" 
                                                                Text="Random Level Evaluation" meta:resourcekey="lbl3Resource1"></asp:Label>
                                                        </td>
                                                        <td style="width:5px;"></td>
                                                        <td>
                                                            <asp:Label ID="lbl4" runat="server" SkinID="Label_DefaultNormal" 
                                                                Text="External Level Evaluation" meta:resourcekey="lbl4Resource1"></asp:Label>
                                                        </td>
                                                        <td style="width:5px;"></td>
                                                    </tr>
                                                </table>
