<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmEvalSPoints.aspx.vb"
    Inherits="frmEvalSPoints" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
...
<head runat="server">
    <title>* Venus Payroll * ~Evaluation Strgnth Points</title>
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmEvalSPoints" runat="server">
