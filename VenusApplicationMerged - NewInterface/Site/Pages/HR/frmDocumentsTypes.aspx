<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmDocumentsTypes.aspx.vb"
    Inherits="frmDocumentsTypes" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
                                                ...
                                                <td style="width: 47%; height: 16px; vertical-align: top">
                                                    <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                        <tr>
                                                            <td class="SeparArea"></td>
                                                            <td>
     <asp:Label ID="lblDocumentTypesGroup" runat="server"  Width="80px" SkinID="Label_DefaultNormal"
         Text="DocumentTypesGroup" meta:resourcekey="lblDocumentTypesGroupResource1"></asp:Label>
 </td>
 <td style="width: 75%">
     <asp:DropDownList ID="ddlDocumentTypesGroup"  runat="server" SkinID="DropDownList_LargNormal" meta:resourcekey="ddlDocumentTypesGroupResource1">
     </asp:DropDownList>
 </td>
                                                        </tr>
                                                    </table>
                                                ...
                                                <td style="width: 47%; height: 16px; vertical-align: top">
                                                    <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                        <tr>
                                                            <td class="SeparArea"></td>
                                                            <td class="LabelArea">
                                                                <asp:Label ID="lblWarning" runat="server" SkinID="Label_DefaultNormal" Text="Waning Period"
                                                                    meta:resourcekey="lblWarningResource1"></asp:Label>

                                                            </td>
                                                            <td class="DataArea">
                                                                <igtxt:WebNumericEdit ID="txtWarning" runat="server" MaxValue="1000" MinValue="0"
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 47%; vertical-align: top;">
                                                    <table style="width: 100%; height: 30px; vertical-align: bottom; border-bottom: 1px solid black"
                                                        ...
                                                        <tr>
                                                            <td style="vertical-align: bottom">
                                                                <asp:Label ID="Label_Title2" runat="server" Text="برجاء تحديد المهن المرتبطة" SkinID="Label_DefaultBold"
                                            ...
                                            <tr>
                                                <td style="width: 47%; height: 100%; vertical-align: top">
                                                    <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                        <tr>
                                                            <td>
                                                                <igtbl:UltraWebGrid  Browser="UpLevel"   ID="uwgForNationality" runat="server" EnableAppStyling="False"
                                                                    Height="100%" Width="325px" SkinID="Default" meta:resourcekey="uwgForNationalityResource1">
                                                                    ...
                                                                    <Bands>
                                                                        <igtbl:UltraGridBand meta:resourcekey="UltraGridBandResource1">
                                                                            <Columns>
                                                                                ...
                                                                                <igtbl:UltraGridColumn BaseColumnName="EngName" CellButtonDisplay="Always" FooterTotal="Count"
                                                                                    AllowUpdate="No" Width="80%" meta:resourcekey="UltraGridColumnResource2">
                                                                                    <Header Caption="Nationalities">
                                                                                ...
                                                                                <igtbl:UltraGridColumn BaseColumnName="speciallyFor" DataType="System.Int16" FooterText=""
                                                                                    Format="" NullText="0" Type="CheckBox" Width="20%" meta:resourcekey="UltraGridColumnResource3">
                                                                                    <HeaderStyle HorizontalAlign="Center" />
                                                                                    <Header Caption="Excluded">
                                                ...
                                                <td style="width: 6%; height: 100%; vertical-align: top"></td>
                                                <td style="width: 47%; height: 100%; vertical-align: top">
                                                    <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                        <tr>
                                                            <td>
                                                                <igtbl:UltraWebGrid  Browser="UpLevel"   ID="uwgOnlyForProfession" runat="server" EnableAppStyling="False"
                                                                    Height="100%" Width="325px" SkinID="Default" meta:resourcekey="uwgOnlyForProfessionResource1">
                                                                    <DisplayLayout AllowColSizingDefault="Free" AllowColumnMovingDefault="OnServer" AllowDeleteDefault="Yes"
                                                                        AllowSortingDefault="OnClient" AllowUpdateDefault="Yes" BorderCollapseDefault="Separate"
                                                                        ...
                                                                        <ClientSideEvents CellChangeHandler="frmDocument_NextGridLostFocus" />
                                                                    </DisplayLayout>
                                                                    <Bands>
                                                                        <igtbl:UltraGridBand meta:resourcekey="UltraGridBandResource2">
                                                                            <Columns>
                                                                                <igtbl:UltraGridColumn BaseColumnName="ID" Hidden="True" meta:resourcekey="UltraGridColumnResource4">
                                                                                </igtbl:UltraGridColumn>
                                                                                <igtbl:UltraGridColumn BaseColumnName="EngName" CellButtonDisplay="Always" FooterTotal="Count"
                                                                                    Width="80%" AllowUpdate="No" meta:resourcekey="UltraGridColumnResource5">
                                                                                    <Header Caption="Only For Profession">
                                                                                        <RowLayoutColumnInfo OriginX="1" />
                                                                                    </Header>
                                                                                    <Footer Total="Count">
                                                                                        <RowLayoutColumnInfo OriginX="1" />
                                                                                ...
                                                                                <igtbl:UltraGridColumn BaseColumnName="speciallyFor" DataType="System.Int16" FooterText=""
                                                                                    Format="" NullText="0" Type="CheckBox" Width="20%" meta:resourcekey="UltraGridColumnResource6">
                                                                                    <Header Caption="Excluded">
                                                                                        <RowLayoutColumnInfo OriginX="2" />
                                                                                    </Header>
                                                                                    <Footer Caption="">
