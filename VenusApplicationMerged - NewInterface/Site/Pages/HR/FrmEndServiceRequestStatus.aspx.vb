    ...
    Private Sub FillEmployeeVacations(ByVal EmployeeID As Integer, Optional ByVal showFirstRecord As Boolean = False)
        ...
        If Type = 2 Then
            Try
                ...
                strselect = "select SS_EndOfServiceRequest.Code as RequestSerial ,Convert(date,RequestDate) as RequestDate,EOSDate,EOSTypeID,EOSReasons,EOSRemarks,ServiceYears,SerciveMonths,ServiceDays from SS_EndOfServiceRequest  where  SS_EndOfServiceRequest.ID=" & RequestSerial & ""
                ...
                If DS2.Tables(0).Rows.Count > 0 Then
                    ...
                    TxtEOSDateDate.Text = DS2.Tables(0).Rows(0)("EOSDate")
