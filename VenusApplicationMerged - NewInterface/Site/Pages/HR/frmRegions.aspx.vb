...
#Region "Public Decleration"
    Dim ClsRegions As Clssys_Regions
...
#Region "Protected Sub"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ClsRegions = New Clssys_Regions(Me, "sys_Regions")
        ...
        Try
            ...
            If ClsObjects.Find(" Code='" & ClsRegions.Table.Trim & "'") Then
            ...
            If Not IsPostBack Then
                Page.Session.Add("ConnectionString", ClsRegions.ConnectionString)
                ClsRegions.AddOnChangeEventToControls("frmRegions", Page, UltraWebTab1)
                '================================= Exit & Navigation Notification [ End ]
                ClsCountries.GetDropDownList(ddlCountry, True)
            ...
            If (txtCode.Text <> "") Then
                ClsRegions.Find(" Code='" & txtCode.Text & "'")
                IntrecordID = ClsRegions.ID
        ...
        Catch ex As Exception
            ...
            mErrorHandler.RecordExceptions_DataBase("", ex, Err.Number, ClsRegions.RegUserID, Venus.Shared.ErrorsHandler.eRecordingType.System_DataBase)
    ...
    Protected Sub ImageButton_Command(sender As Object, e As System.Web.UI.WebControls.CommandEventArgs) Handles ImageButton_Save.Command, ImageButton_SaveN.Command, LinkButton_SaveN.Command, ImageButton_New.Command, ImageButton_Print.Command, ImageButton_Properties.Command, LinkButton_Properties.Command, ImageButton_Remarks.Command, LinkButton_Remarks.Command, ImageButton_Last.Command, ImageButton_Next.Command, ImageButton_Back.Command, ImageButton_First.Command, ImageButton_Delete.Command
        ...
        Dim ObjNavigationHandler As New Venus.Shared.Web.NavigationHandler(ClsRegions.ConnectionString)
        Select Case e.CommandArgument
            Case "SaveNew"
                ...
                End If
                ClsRegions.Find("Code='" & txtCode.Text & "'")
                If Not ddlCountry.SelectedValue = "0" Then
                    If Not AssignValues() Then
                        Exit Sub
                    End If
                    If ClsRegions.ID > 0 Then
                        ClsRegions.Update("code='" & txtCode.Text & "'")
                    Else
                        ClsRegions.Save()
                    End If
                    ClsRegions.Find("Code='" & txtCode.Text & "'")
                    clsMainOtherFields = New clsSys_MainOtherFields(Me.Page)
                    clsMainOtherFields.CollectDataAndSave(value.Text, ClsRegions.Table, ClsRegions.ID)
                    value.Text = ""
                    AfterOperation()
                Else
                    Venus.Shared.Web.ClientSideActions.MsgBoxBasic(Page, ObjNavigationHandler.SetLanguage(Page, " Please Choose Country /برجاء إختيار الدولة"))
                End If
            Case "Save"
                If txtCode.Text = "" Then
                    Venus.Shared.Web.ClientSideActions.MsgBoxBasic(Page, ObjNavigationHandler.SetLanguage(Page, " Please Enter Code /برجاء إدخال الكود"))
            ...
            Case "New"
                AfterOperation()
            Case "Delete"
                ClsRegions.Delete("Code='" & txtCode.Text & "'")
                AfterOperation()
            Case "Property"
                ClsRegions.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmPropertyScreen.aspx?ID=" & ClsRegions.ID & "&TableName=" & ClsRegions.Table, 477, 313, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Property", False)
            Case "Remarks"
                ClsRegions.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmRemarks.aspx?ID=" & ClsRegions.ID & "&TableName=" & ClsRegions.Table, 410, 210, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Remarks", False)
            Case "Print"
                Venus.Shared.Web.ClientSideActions.PrintWindow(Me)
            Case "Other Fields"
                Dim clsObjOtherFields As New ClsSys_OtherFields(Page)
                Dim clsSysObjects As New Clssys_Objects(Page)
                Dim tablename As String = ClsRegions.Table
                ClsRegions.Find(" code = '" & txtCode.Text & "'")
                Dim recordID As Integer = ClsRegions.ID
                ...
                With clsObjOtherFields
                    If .Find(" sys_OtherFields.ObjectID = " & clsSysObjects.ID) = True Then
                        ...
                        Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmOtherFieldsDynamic.aspx?tableName=" & tablename & "&ObjectId=" & .ObjectID & "&RecordId=" & ClsRegions.ID, 602, 306, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "OtherFields", False)
                    End If
                End With
            Case "Exit"
                ClsRegions.Find(" Code= '" & txtCode.Text & "'")
                If ClsRegions.ID > 0 Then
                    Dim Ds As Data.DataSet = ClsRegions.DataSet
                    If Not AssignValues() Then
                        Exit Sub
                    End If
                    If ClsRegions.CheckDiff(ClsRegions, Ds, "") Then
                ...
                End If
            Case "First"
                ClsRegions.FirstRecord()
                GetValues()
            Case "Previous"
                ClsRegions.Find("Code='" & txtCode.Text & "'")
                If Not ClsRegions.previousRecord() Then
                    ClsRegions.Find("Code='" & txtCode.Text & "'")
            ...
            Case "Next"
                ClsRegions.Find("Code='" & txtCode.Text & "'")
                If Not ClsRegions.NextRecord() Then
                    ClsRegions.Find("Code='" & txtCode.Text & "'")
                    Venus.Shared.Web.ClientSideActions.MsgBoxBasic(Page, ObjNavigationHandler.SetLanguage(Page, " This is the last page /هذه أخر صفحة"))
                End If
                GetValues()
            Case "Last"
                ClsRegions.LastRecord()
                GetValues()
        End Select
    End Sub
...
#Region "Private Functions"
    ...
    Private Function GetValues() As Boolean
        ...
        Try
            SetToolBarDefaults()
            txtCode.Text = ClsRegions.Code
            txtEngName.Text = ClsRegions.EngName
            txtArbName.Text = ClsRegions.ArbName
            If Not ClsRegions.RegUserID = Nothing Then
                ClsUser.Find("ID=" & ClsRegions.RegUserID)
            End If
            ...
            End If
            If Convert.ToDateTime(ClsRegions.RegDate).Date = Nothing Then
                lblRegDateValue.Text = ""
            Else
                lblRegDateValue.Text = Convert.ToDateTime(ClsRegions.RegDate).Date
            End If
            If ClsRegions.CancelDate = Nothing Then
                lblCancelDateValue.Text = ""
            Else
                lblCancelDateValue.Text = Convert.ToDateTime(ClsRegions.CancelDate).Date
            End If
            If Not ClsRegions.CancelDate = Nothing Then
            ...
            ClsCountries.GetDropDownList(ddlCountry, True)
            Dim ObjNavigationHandler As New Venus.Shared.Web.NavigationHandler(ClsRegions.ConnectionString)
            ClsCountries.Find(" ID= " & IIf(IsNothing(ClsRegions.CountryID), 0, ClsRegions.CountryID))
            If ClsCountries.ID > 0 Then
                item.Value = ClsRegions.CountryID
                item.Text = ObjNavigationHandler.SetLanguage(Page, ClsCountries.EngName & "/" & ClsCountries.ArbName)
                If (item.Text.Trim = "") Then
                    item.Text = ObjNavigationHandler.SetLanguage(Page, ClsCountries.ArbName & "/" & ClsCountries.EngName)
                End If
                If Not ddlCountry.Items.Contains(item) Then
                    ddlCountry.Items.Add(item)
                    ddlCountry.SelectedValue = item.Value
                Else
                    ddlCountry.SelectedValue = ClsRegions.CountryID
                End If
            End If
            If (ClsRegions.ID > 0) Then
                StrMode = "E"
            Else
                StrMode = "N"
            End If
            SetToolBarPermission(Me, ClsRegions.ConnectionString, ClsRegions.DataBaseUserRelatedID, ClsRegions.GroupID, StrMode)
            SetToolBarRecordPermission(Me, ClsRegions.ConnectionString, ClsRegions.DataBaseUserRelatedID, ClsRegions.GroupID, ClsRegions.Table, ClsRegions.ID)
            If Not ClsRegions.CancelDate = Nothing Then
                ImageButton_Delete.Enabled = False
            End If
            If Page.IsPostBack Then
                CreateOtherFields(ClsRegions.ID)
            End If
            Return True
        Catch ex As Exception
        End Try
    ...
    Private Function CheckCode() As Boolean
        ...
        Try
            ...
            If ClsRegions.ID > 0 Then
                ...
                StrMode = "E"
            Else
                If ClsRegions.CheckRecordExistance(" Code='" & txtCode.Text & "'") Then
                    txtCode.Text = ""
                    txtCode.Focus()
                End If
                ClsCountries.GetDropDownList(ddlCountry, True)
            ...
            SetToolBarDefaults()
            SetToolBarPermission(Me, ClsRegions.ConnectionString, ClsRegions.DataBaseUserRelatedID, ClsRegions.GroupID, StrMode)
            SetToolBarRecordPermission(Me, ClsRegions.ConnectionString, ClsRegions.DataBaseUserRelatedID, ClsRegions.GroupID, ClsRegions.Table, IntId)
    ...
    Private Sub LoadDataUpdateSchedules(ByVal formName As String)
        ...
        ClsRegions = New Clssys_Regions(Page, "sys_Regions")
        ClsRegions.Find(" code = '" & txtCode.Text & "'")
        Dim recordID As Integer = ClsRegions.ID
        If (recordID > 0) Then
    ...
    Private Function CreateOtherFields(ByVal IntRecordID As Integer)
        ...
        clsMainOtherFields = New clsSys_MainOtherFields(Me.Page)
        If clsMainOtherFields.CheckOtherFieldsButton(Me.Page, ClsRegions.Table) = True Then
            Dim StrTablename As String
            ClsRegions = New Clssys_Regions(Me, "sys_Regions")
            StrTablename = ClsRegions.Table
