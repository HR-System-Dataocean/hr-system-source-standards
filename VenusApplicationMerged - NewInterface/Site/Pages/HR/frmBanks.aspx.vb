...
#Region "Public Decleration"
    Private ClsBanks As Clssys_Banks
...
#Region "Protected Sub"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ClsBanks = New Clssys_Banks(Me.Page)
        Dim ClsObjects As New Clssys_Objects(Page)
        Dim ClsSearchs As New Clssys_Searchs(Page)
        Dim SearchID As Integer = 0
        Try
            Dim clsSearchsColumns As New Clssys_SearchsColumns(Page)
            If ClsObjects.Find(" Code='" & ClsBanks.Table.Trim & "'") Then
            ...
            If Not IsPostBack Then
                Page.Session.Add("ConnectionString", ClsBanks.ConnectionString)
                ClsBanks.AddOnChangeEventToControls("frmBanks", Page, UltraWebTab1)
            ...
            If (txtCode.Text <> "") Then
                ClsBanks.Find(" Code='" & txtCode.Text & "'")
                IntrecordID = ClsBanks.ID
        ...
        Catch ex As Exception
            ...
            mErrorHandler.RecordExceptions_DataBase("", ex, Err.Number, ClsBanks.RegUserID, Venus.Shared.ErrorsHandler.eRecordingType.System_DataBase)
    ...
    Protected Sub ImageButton_Command(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.CommandEventArgs) Handles ImageButton_Save.Command, ImageButton_SaveN.Command, LinkButton_SaveN.Command, ImageButton_New.Command, ImageButton_Print.Command, ImageButton_Properties.Command, LinkButton_Properties.Command, ImageButton_Remarks.Command, LinkButton_Remarks.Command, ImageButton_Last.Command, ImageButton_Next.Command, ImageButton_Back.Command, ImageButton_First.Command, ImageButton_Delete.Command
        ...
        Dim ObjNavigationHandler As New Venus.Shared.Web.NavigationHandler(ClsBanks.ConnectionString)
        Select Case e.CommandArgument
            ...
            Case "Delete"
                ...
                ClsBanks.Delete("Code='" & txtCode.Text & "'")
                AfterOperation()
            Case "Property"
                ClsBanks.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmPropertyScreen.aspx?ID=" & ClsBanks.ID & "&TableName=" & ClsBanks.Table, 477, 313, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Property", False)
            Case "Remarks"
                ClsBanks.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmRemarks.aspx?ID=" & ClsBanks.ID & "&TableName=" & ClsBanks.Table, 410, 210, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Remarks", False)
            Case "Print"
            ...
            Case "First"
                ClsBanks.Find("Code='" & txtCode.Text & "'")
                ClsBanks.FirstRecord()
                GetValues(ClsBanks)
            Case "Previous"
                ClsBanks.Find("Code='" & txtCode.Text & "'")
                If Not ClsBanks.previousRecord() Then
                    ClsBanks.Find("Code='" & txtCode.Text & "'")
            ...
            Case "Next"
                ClsBanks.Find("Code='" & txtCode.Text & "'")
                If Not ClsBanks.NextRecord() Then
                    ClsBanks.Find("Code='" & txtCode.Text & "'")
...
#Region "Private Functions"
    Private Function SavePart() As Boolean
        Dim StrMode As String = Request.QueryString.Item("Mode")
        ClsBanks = New Clssys_Banks(Page)

        Try
            ClsBanks.Find("Code='" & txtCode.Text & "'")

            If ClsBanks.ID > 0 Then
                If Not AssignValue(ClsBanks) Then
                    Exit Function
                End If
                ClsBanks.Update("Code='" & txtCode.Text & "'")
            ...
            clsMainOtherFields.CollectDataAndSave(value.Text, ClsBanks.Table, ClsBanks.ID)
            value.Text = ""
            Return True
        Catch ex As Exception
            Return False
        End Try
    End Function
    Private Function AssignValue(ByRef ClsBanks As Clssys_Banks) As Boolean
        Try
            With ClsBanks
                .Code = txtCode.Text
        ...
        End Try
    End Function
    Private Function GetValues(ByVal ClsBanks As Clssys_Banks) As Boolean
    ...
    Private Function CheckCode() As Boolean
        ...
        Try
            ...
            If ClsBanks.ID > 0 Then
                ...
                StrMode = "E"
            Else
                If ClsBanks.CheckRecordExistance(" Code='" & txtCode.Text & "'") Then
                    txtCode.Text = ""
                    txtCode.Focus()
                End If
            ...
            End If
            SetToolBarDefaults()
            SetToolBarPermission(Me, ClsBanks.ConnectionString, ClsBanks.DataBaseUserRelatedID, ClsBanks.GroupID, StrMode)
            SetToolBarRecordPermission(Me, ClsBanks.ConnectionString, ClsBanks.DataBaseUserRelatedID, ClsBanks.GroupID, ClsBanks.Table, IntId)
    ...
    Private Sub LoadDataUpdateSchedules(ByVal formName As String)
        ...
        ClsBanks = New Clssys_Banks(Me.Page)
        ClsBanks.Find(" code = '" & txtCode.Text & "'")
        Dim recordID As Integer = ClsBanks.ID
        If (recordID > 0) Then
    ...
    Private Function CreateOtherFields(ByVal IntRecordID As Integer)
        ...
        If clsMainOtherFields.CheckOtherFieldsButton(Me.Page, ClsBanks.Table) = True Then
            Dim StrTablename As String
            ClsBanks = New Clssys_Banks(Me)
            StrTablename = ClsBanks.Table
