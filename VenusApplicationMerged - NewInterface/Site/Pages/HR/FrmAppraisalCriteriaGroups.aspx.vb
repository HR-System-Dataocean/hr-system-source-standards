...
#Region "Protected Sub"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If ClsObjects.Find(" Code='" & ClsAppraisalCriteriaGroups.Table.Trim & "'") Then
            ...
            If Not IsPostBack Then
                Page.Session.Add("ConnectionString", ClsAppraisalCriteriaGroups.ConnectionString)
                ClsAppraisalCriteriaGroups.AddOnChangeEventToControls("frmProfession", Page, UltraWebTab1)
            ...
            If (txtCode.Text <> "") Then
                ClsAppraisalCriteriaGroups.Find(" Code='" & txtCode.Text & "' And CancelDate is null")
                IntrecordID = ClsAppraisalCriteriaGroups.ID
        ...
        Catch ex As Exception
            ...
            mErrorHandler.RecordExceptions_DataBase("", ex, Err.Number, ClsAppraisalCriteriaGroups.RegUserID, Venus.Shared.ErrorsHandler.eRecordingType.System_DataBase)
    ...
    Protected Sub ImageButton_Command(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.CommandEventArgs) Handles ImageButton_Save.Command, ImageButton_SaveN.Command, LinkButton_SaveN.Command, ImageButton_New.Command, ImageButton_Print.Command, ImageButton_Properties.Command, LinkButton_Properties.Command, ImageButton_Remarks.Command, LinkButton_Remarks.Command, ImageButton_Last.Command, ImageButton_Next.Command, ImageButton_Back.Command, ImageButton_First.Command, ImageButton_Delete.Command
        ...
        Dim ObjNavigationHandler As New Venus.Shared.Web.NavigationHandler(ClsAppraisalCriteriaGroups.ConnectionString)
        Select Case e.CommandArgument
            ...
            Case "New"
                AfterOperation()
            Case "Delete"
                ClsAppraisalCriteriaGroups.Delete("Code='" & txtCode.Text & "'")
                AfterOperation()
            Case "Property"
                ClsAppraisalCriteriaGroups.Find("Code='" & txtCode.Text & "' And CancelDate is null")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmPropertyScreen.aspx?ID=" & ClsAppraisalCriteriaGroups.ID & "&TableName=" & ClsAppraisalCriteriaGroups.Table, 477, 313, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Property", False)
            Case "Remarks"
                ClsAppraisalCriteriaGroups.Find("Code='" & txtCode.Text & "' And CancelDate is null")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmRemarks.aspx?ID=" & ClsAppraisalCriteriaGroups.ID & "&TableName=" & ClsAppraisalCriteriaGroups.Table, 410, 210, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Remarks", False)
            Case "Print"
            ...
            Case "First"
                ClsAppraisalCriteriaGroups.Find("Code='" & txtCode.Text & "' And CancelDate is null")
                ClsAppraisalCriteriaGroups.FirstRecord()
                GetValues(ClsAppraisalCriteriaGroups)
            Case "Previous"
                ClsAppraisalCriteriaGroups.Find("Code='" & txtCode.Text & "' And CancelDate is null")
                If Not ClsAppraisalCriteriaGroups.previousRecord() Then
                    ClsAppraisalCriteriaGroups.Find("Code='" & txtCode.Text & "' And CancelDate is null")
            ...
            Case "Next"
                ClsAppraisalCriteriaGroups.Find("Code='" & txtCode.Text & "' And CancelDate is null")
                If Not ClsAppraisalCriteriaGroups.NextRecord() Then
                    ClsAppraisalCriteriaGroups.Find("Code='" & txtCode.Text & "' And CancelDate is null")
            ...
            Case "Last"
                ClsAppraisalCriteriaGroups.Find("Code='" & txtCode.Text & "' And CancelDate is null")
                ClsAppraisalCriteriaGroups.LastRecord()
                GetValues(ClsAppraisalCriteriaGroups)
        End Select
    End Sub
...
#Region "Private Functions"
    Private Function SavePart() As Boolean
        Dim StrMode As String = Request.QueryString.Item("Mode")
        ClsAppraisalCriteriaGroups = New Clshrs_AppraisalCriteriaGroups(Page)

        Try
            ClsAppraisalCriteriaGroups.Find("Code='" & txtCode.Text & "' And CancelDate is null")

            If ClsAppraisalCriteriaGroups.ID > 0 Then
                If Not AssignValue(ClsAppraisalCriteriaGroups) Then
                    Exit Function
                End If
                ClsAppraisalCriteriaGroups.Update("Code='" & txtCode.Text & "'")

            Else
                If Not AssignValue(ClsAppraisalCriteriaGroups) Then
                    Exit Function
                End If
                ClsAppraisalCriteriaGroups.Save()

            End If

            ClsAppraisalCriteriaGroups.Find("Code='" & txtCode.Text & "' And CancelDate is null")

            clsMainOtherFields.CollectDataAndSave(value.Text, ClsAppraisalCriteriaGroups.Table, ClsAppraisalCriteriaGroups.ID)
            value.Text = ""
            Return True
        Catch ex As Exception
            Return False
        End Try
    End Function
    Private Function AssignValue(ByRef ClsAppraisalCriteriaGroups As Clshrs_AppraisalCriteriaGroups) As Boolean
        Try
            With ClsAppraisalCriteriaGroups
                .Code = txtCode.Text
        ...
        End Try
    End Function
    Private Function GetValues(ByVal ClsAppraisalCriteriaGroups As Clshrs_AppraisalCriteriaGroups) As Boolean
        ...
        Try
            ...
            With ClsAppraisalCriteriaGroups
                ...
                If Page.IsPostBack Then
                    CreateOtherFields(ClsAppraisalCriteriaGroups.ID)
                End If
            End With
            Return True
        Catch ex As Exception
    ...
    Private Function SetToolbarSetting(ByVal ptrType As String, ByVal ClsClass As Object, ByVal intID As Integer) As Boolean
        Try
            Select Case ptrType
                ...
                Case "D"
                    ClsAppraisalCriteriaGroups.Find("ID=" & intID)
                    GetValues(ClsAppraisalCriteriaGroups)
    ...
    Private Function CheckCode() As Boolean
        ...
        Try
            ClsAppraisalCriteriaGroups.Find("Code='" & txtCode.Text & "' And CancelDate is null")
            IntId = ClsAppraisalCriteriaGroups.ID
            txtEngName.Focus()
            If ClsAppraisalCriteriaGroups.ID > 0 Then
                GetValues(ClsAppraisalCriteriaGroups)
                StrMode = "E"
            Else
                If ClsAppraisalCriteriaGroups.CheckRecordExistance(" Code='" & txtCode.Text & "'") Then
                    txtCode.Text = ""
                    txtCode.Focus()
                End If
            ...
            End If
            SetToolBarDefaults()
            SetToolBarPermission(Me, ClsAppraisalCriteriaGroups.ConnectionString, ClsAppraisalCriteriaGroups.DataBaseUserRelatedID, ClsAppraisalCriteriaGroups.GroupID, StrMode)
            SetToolBarRecordPermission(Me, ClsAppraisalCriteriaGroups.ConnectionString, ClsAppraisalCriteriaGroups.DataBaseUserRelatedID, ClsAppraisalCriteriaGroups.GroupID, ClsAppraisalCriteriaGroups.Table, IntId)
            ...
            If ClsAppraisalCriteriaGroups.ID > 0 Then
                Dim str As String = "select " & ClsAppraisalCriteriaGroups.ID & " As CriteriaGroupID,ID as CriteriaID,Code," & CriteriaName & " As CriteriaName from[dbo].[App_Criteria] where CriteriaGroupID= " & ClsAppraisalCriteriaGroups.ID & ""
                ds = SqlHelper.ExecuteDataset(connectionString, CommandType.Text, str)
                If ds.Tables(0).Rows.Count > 0 Then
                    uwgGroupCriterias.DataSource = ds.Tables(0)
                    uwgGroupCriterias.DataBind()
                Else
                    uwgGroupCriterias.DataSource = Nothing
                    uwgGroupCriterias.DataBind()
    ...
    Private Function AfterOperation() As Boolean
        ClsAppraisalCriteriaGroups.Clear()
        GetValues(ClsAppraisalCriteriaGroups)
        ImageButton_Delete.Enabled = False
    ...
    Private Function Clear() As Boolean
        ...
        ddlCriteriaGroupType.SelectedValue = 0
        ImageButton_Delete.Enabled = False
        lblRegDateValue.Text = ""
        lblRegDateValue.Text = ""
        lblCancelDateValue.Text = ""
    ...
    Private Sub LoadDataUpdateSchedules(ByVal formName As String)
        ...
        ClsAppraisalCriteriaGroups = New Clshrs_AppraisalCriteriaGroups(Me.Page)
        ClsAppraisalCriteriaGroups.Find(" code = '" & txtCode.Text & "' And CancelDate is null")
        Dim recordID As Integer = ClsAppraisalCriteriaGroups.ID
        If (recordID > 0) Then
    ...
    Private Function CreateOtherFields(ByVal IntRecordID As Integer)
        ...
        If clsMainOtherFields.CheckOtherFieldsButton(Me.Page, ClsAppraisalCriteriaGroups.Table) = True Then
            Dim StrTablename As String
            ClsAppraisalCriteriaGroups = New Clshrs_AppraisalCriteriaGroups(Me)
            StrTablename = ClsAppraisalCriteriaGroups.Table
