...
Partial Class frmOtherFieldsGroups
    Inherits MainPage
...
#Region "Protected Sub"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ClsOtherFieldsGroups = New ClsSys_OtherFieldsGroups(Me.Page)
        Dim ClsObjects As New Clssys_Objects(Page)
        Dim ClsSearchs As New Clssys_Searchs(Page)
        Dim SearchID As Integer = 0
        Try
            Dim clsSearchsColumns As New Clssys_SearchsColumns(Page)
            If ClsObjects.Find(" Code='" & ClsOtherFieldsGroups.Table.Trim & "'") Then
            ...
            If Not IsPostBack Then
                Page.Session.Add("ConnectionString", ClsOtherFieldsGroups.ConnectionString)
                ClsOtherFieldsGroups.AddOnChangeEventToControls("frmOtherFieldsGroups", Page, UltraWebTab1)
            ...
            If (txtCode.Text <> "") Then
                ClsOtherFieldsGroups.Find(" Code='" & txtCode.Text & "'")
                IntrecordID = ClsOtherFieldsGroups.ID
        ...
        Catch ex As Exception
            ...
            mErrorHandler.RecordExceptions_DataBase("", ex, Err.Number, ClsOtherFieldsGroups.RegUserID, Venus.Shared.ErrorsHandler.eRecordingType.System_DataBase)
    ...
    Protected Sub ImageButton_Command(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.CommandEventArgs) Handles ImageButton_Save.Command, ImageButton_SaveN.Command, LinkButton_SaveN.Command, ImageButton_New.Command, ImageButton_Print.Command, ImageButton_Properties.Command, LinkButton_Properties.Command, ImageButton_Remarks.Command, LinkButton_Remarks.Command, ImageButton_Last.Command, ImageButton_Next.Command, ImageButton_Back.Command, ImageButton_First.Command, ImageButton_Delete.Command
        ...
        Dim ObjNavigationHandler As New Venus.Shared.Web.NavigationHandler(ClsOtherFieldsGroups.ConnectionString)
        Select Case e.CommandArgument
            ...
            Case "New"
                AfterOperation()
            Case "Delete"
                ClsOtherFieldsGroups.Delete("Code='" & txtCode.Text & "'")
                AfterOperation()
            Case "Property"
                ClsOtherFieldsGroups.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmPropertyScreen.aspx?ID=" & ClsOtherFieldsGroups.ID & "&TableName=" & ClsOtherFieldsGroups.Table, 477, 313, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Property", False)
            Case "Remarks"
                ClsOtherFieldsGroups.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmRemarks.aspx?ID=" & ClsOtherFieldsGroups.ID & "&TableName=" & ClsOtherFieldsGroups.Table, 410, 210, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Remarks", False)
            Case "Print"
            ...
            Case "First"
                ClsOtherFieldsGroups.Find("Code='" & txtCode.Text & "'")
                ClsOtherFieldsGroups.FirstRecord()
                GetValues(ClsOtherFieldsGroups)
            Case "Previous"
                ClsOtherFieldsGroups.Find("Code='" & txtCode.Text & "'")
                If Not ClsOtherFieldsGroups.previousRecord() Then
                    ClsOtherFieldsGroups.Find("Code='" & txtCode.Text & "'")
            ...
            Case "Next"
                ClsOtherFieldsGroups.Find("Code='" & txtCode.Text & "'")
                If Not ClsOtherFieldsGroups.NextRecord() Then
                    ClsOtherFieldsGroups.Find("Code='" & txtCode.Text & "'")
            ...
            Case "Last"
                ClsOtherFieldsGroups.Find("Code='" & txtCode.Text & "'")
                ClsOtherFieldsGroups.LastRecord()
                GetValues(ClsOtherFieldsGroups)
        End Select
    End Sub
...
#Region "Private Functions"
    Private Function SavePart() As Boolean
        Dim StrMode As String = Request.QueryString.Item("Mode")
        ClsOtherFieldsGroups = New ClsSys_OtherFieldsGroups(Page)

        Try
            ClsOtherFieldsGroups.Find("Code='" & txtCode.Text & "'")

            If ClsOtherFieldsGroups.ID > 0 Then
                If Not AssignValue(ClsOtherFieldsGroups) Then
                    Exit Function
                End If
                ClsOtherFieldsGroups.Update("Code='" & txtCode.Text & "'")

            Else
                If Not AssignValue(ClsOtherFieldsGroups) Then
                    Exit Function
                End If
                ClsOtherFieldsGroups.Save()

            End If

            ClsOtherFieldsGroups.Find("Code='" & txtCode.Text & "'")

            clsMainOtherFields.CollectDataAndSave(value.Text, ClsOtherFieldsGroups.Table, ClsOtherFieldsGroups.ID)
            value.Text = ""
            Return True
        Catch ex As Exception
            Return False
        End Try
    End Function
    Private Function AssignValue(ByRef ClsOtherFieldsGroups As ClsSys_OtherFieldsGroups) As Boolean
        Try
            With ClsOtherFieldsGroups
                .Code = txtCode.Text
        ...
        End Try
    End Function
    Private Function GetValues(ByVal ClsOtherFieldsGroups As ClsSys_OtherFieldsGroups) As Boolean
        ...
        Try
            ...
            With ClsOtherFieldsGroups
                ...
                If Page.IsPostBack Then
                    CreateOtherFields(ClsOtherFieldsGroups.ID)
                End If
            End With
            Return True
        Catch ex As Exception
    ...
    Private Function SetToolbarSetting(ByVal ptrType As String, ByVal ClsClass As Object, ByVal intID As Integer) As Boolean
        Try
            Select Case ptrType
                ...
                Case "D"
                    ClsOtherFieldsGroups.Find("ID=" & intID)
                    GetValues(ClsOtherFieldsGroups)
    ...
    Private Function CheckCode() As Boolean
        ...
        Try
            ClsOtherFieldsGroups.Find("Code='" & txtCode.Text & "'")
            IntId = ClsOtherFieldsGroups.ID
            txtEngName.Focus()
            If ClsOtherFieldsGroups.ID > 0 Then
                GetValues(ClsOtherFieldsGroups)
                StrMode = "E"
            Else
                If ClsOtherFieldsGroups.CheckRecordExistance(" Code='" & txtCode.Text & "'") Then
                    txtCode.Text = ""
                    txtCode.Focus()
                End If
            ...
            End If
            SetToolBarDefaults()
            SetToolBarPermission(Me, ClsOtherFieldsGroups.ConnectionString, ClsOtherFieldsGroups.DataBaseUserRelatedID, ClsOtherFieldsGroups.GroupID, StrMode)
            SetToolBarRecordPermission(Me, ClsOtherFieldsGroups.ConnectionString, ClsOtherFieldsGroups.DataBaseUserRelatedID, ClsOtherFieldsGroups.GroupID, ClsOtherFieldsGroups.Table, IntId)
    ...
    Private Sub LoadDataUpdateSchedules(ByVal formName As String)
        ...
        ClsOtherFieldsGroups = New ClsSys_OtherFieldsGroups(Me.Page)
        ClsOtherFieldsGroups.Find(" code = '" & txtCode.Text & "'")
        Dim recordID As Integer = ClsOtherFieldsGroups.ID
        If (recordID > 0) Then
    ...
    Private Function CreateOtherFields(ByVal IntRecordID As Integer)
        ...
        If clsMainOtherFields.CheckOtherFieldsButton(Me.Page, ClsOtherFieldsGroups.Table) = True Then
            Dim StrTablename As String
            ClsOtherFieldsGroups = New ClsSys_OtherFieldsGroups(Me)
            StrTablename = ClsOtherFieldsGroups.Table
