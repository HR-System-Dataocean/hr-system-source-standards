<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmEducations.aspx.vb" Inherits="frmEducations"
...
<head runat="server">
    <title>* Venus Payroll * ~Eductions</title>
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmEducations" runat="server">
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblRank" runat="server" SkinID="Label_DefaultNormal" Text="ترتيب المرحلة"
                                                                meta:resourcekey="lblRankResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <igtxt:WebNumericEdit ID="txtRank" runat="server" MinValue="0" Nullable="False" SkinID="WebNumericEdit_Fix"
                                                                ValueText="0">
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="Label_RequiredYears" runat="server" SkinID="Label_DefaultNormal" Text="عدد السنوات"
                                                                meta:resourcekey="lblRequiredYearsResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <igtxt:WebNumericEdit ID="WebNumericEdit_RequiredYears" runat="server" MinValue="0"
                                                                Nullable="False" SkinID="WebNumericEdit_Fix" ValueText="0">
                                                            </igtxt:WebNumericEdit>
                                                        </td>
                                                    </tr>
                                                </table>
