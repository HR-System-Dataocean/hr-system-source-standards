<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmReportsGroups.aspx.vb"
    Inherits="frmReportsGroups" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
...
<head runat="server">
    <title>* Venus Payroll * ~ReportsGroups</title>
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmReportsGroups" runat="server">
                                                    ...
                                                    <tr>
                                                        <td style="vertical-align: bottom">
                                                            <asp:Label ID="Label_Title1" runat="server" meta:resourcekey="Label_Title1Resource1"
                                                                SkinID="Label_DefaultBold" Text="الاعدادات"></asp:Label>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblParentGroup" runat="server" SkinID="Label_DefaultNormal" Text="المجموعة الرئيسية"
                                                                meta:resourcekey="lblParentGroupResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="DdlParentGroup" runat="server" SkinID="DropDownList_LargNormal"
                                                                meta:resourcekey="DdlParentGroupResource1">
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                </table>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblModule" runat="server" SkinID="Label_DefaultNormal" Text="البرنامج"
