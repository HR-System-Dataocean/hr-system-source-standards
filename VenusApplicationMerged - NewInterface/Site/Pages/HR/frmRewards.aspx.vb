...
#Region "Public Decleration"
    Dim clshrsRewards As Clshrs_Rewards
...
#Region "Protected Sub"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        clshrsRewards = New Clshrs_Rewards(Me)
        Dim ClsObjects As New Clssys_Objects(Page)
        Dim ClsSearchs As New Clssys_Searchs(Page)
        Dim SearchID As Integer = 0
        Try
            Dim clsSearchsColumns As New Clssys_SearchsColumns(Page)
            If ClsObjects.Find(" Code='" & clshrsRewards.Table.Trim & "'") Then
            ...
            If Not IsPostBack Then
                Page.Session.Add("ConnectionString", clshrsRewards.ConnectionString)
                clshrsRewards.AddOnChangeEventToControls("Rewards", Page, UltraWebTab1)
            ...
            If (txtCode.Text <> "") Then
                clshrsRewards.Find(" Code='" & txtCode.Text & "'")
                IntrecordID = clshrsRewards.ID
        ...
        Catch ex As Exception
            ...
            mErrorHandler.RecordExceptions_DataBase("", ex, Err.Number, clshrsRewards.RegUserID, Venus.Shared.ErrorsHandler.eRecordingType.System_DataBase)
    ...
    Protected Sub ImageButton_Command(sender As Object, e As System.Web.UI.WebControls.CommandEventArgs) Handles ImageButton_Save.Command, ImageButton_SaveN.Command, LinkButton_SaveN.Command, ImageButton_New.Command, ImageButton_Print.Command, ImageButton_Properties.Command, LinkButton_Properties.Command, ImageButton_Remarks.Command, LinkButton_Remarks.Command, ImageButton_Last.Command, ImageButton_Next.Command, ImageButton_Back.Command, ImageButton_First.Command, ImageButton_Delete.Command
        ...
        Dim ObjNavigationHandler As New Venus.Shared.Web.NavigationHandler(clshrsRewards.ConnectionString)
        Select Case e.CommandArgument
            Case "SaveNew"
                ...
                If Not AssignValues() Then
                    Exit Sub
                End If
                If clshrsRewards.ID > 0 Then
                    clshrsRewards.Update("code='" & txtCode.Text & "'")
                Else
                    clshrsRewards.Save()
                End If
                clshrsRewards.Find("Code='" & txtCode.Text & "'")
                clsMainOtherFields = New clsSys_MainOtherFields(Me.Page)
                clsMainOtherFields.CollectDataAndSave(value.Text, clshrsRewards.Table, clshrsRewards.ID)
                value.Text = ""
                AfterOperation()
            Case "Save"
                If txtCode.Text = "" Then
            ...
            Case "New"
                AfterOperation()
            Case "Delete"
                clshrsRewards.Delete("Code='" & txtCode.Text & "'")
                AfterOperation()
            Case "Property"
                clshrsRewards.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmPropertyScreen.aspx?ID=" & clshrsRewards.ID & "&TableName=" & clshrsRewards.Table, 477, 313, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Property", False)
            Case "Remarks"
                clshrsRewards.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmRemarks.aspx?ID=" & clshrsRewards.ID & "&TableName=" & clshrsRewards.Table, 410, 210, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Remarks", False)
            Case "Print"
                Venus.Shared.Web.ClientSideActions.PrintWindow(Me)
            Case "Other Fields"
                Dim clsObjOtherFields As New ClsSys_OtherFields(Page)
                Dim clsSysObjects As New Clssys_Objects(Page)
                Dim tablename As String = clshrsRewards.Table
                clshrsRewards.Find(" code = '" & txtCode.Text & "'")
                Dim recordID As Integer = clshrsRewards.ID
                ...
                With clsObjOtherFields
                    If .Find(" sys_OtherFields.ObjectID = " & clsSysObjects.ID) = True Then
                        ...
                        Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmOtherFieldsDynamic.aspx?tableName=" & tablename & "&ObjectId=" & .ObjectID & "&RecordId=" & clshrsRewards.ID, 602, 306, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "OtherFields", False)
                    End If
                End With
            Case "Exit"
                clshrsRewards.Find(" Code= '" & txtCode.Text & "'")
                If clshrsRewards.ID > 0 Then
                    Dim Ds As Data.DataSet = clshrsRewards.DataSet
                    If Not AssignValues() Then
                        Exit Sub
                    End If
                    If clshrsRewards.CheckDiff(clshrsRewards, Ds, "") Then
                ...
                End If
            Case "First"
                clshrsRewards.FirstRecord()
                GetValues()
            Case "Previous"
                clshrsRewards.Find("Code='" & txtCode.Text & "'")
                If Not clshrsRewards.previousRecord() Then
                    clshrsRewards.Find("Code='" & txtCode.Text & "'")
            ...
            Case "Next"
                clshrsRewards.Find("Code='" & txtCode.Text & "'")
                If Not clshrsRewards.NextRecord() Then
                    clshrsRewards.Find("Code='" & txtCode.Text & "'")
                    Venus.Shared.Web.ClientSideActions.MsgBoxBasic(Page, ObjNavigationHandler.SetLanguage(Page, " This is the last page /هذه أخر صفحة"))
                End If
                GetValues()
            Case "Last"
                clshrsRewards.LastRecord()
                GetValues()
        End Select
    End Sub
...
#Region "Private Functions"
    ...
    Private Function GetValues() As Boolean
        ...
        Try
            SetToolBarDefaults()
            txtCode.Text = clshrsRewards.Code
            txtEngName.Text = clshrsRewards.EngName
            txtArbName.Text = clshrsRewards.ArbName
            ddlTransactionType.SelectedValue = clshrsRewards.TransactionTypeID

            If Not clshrsRewards.RegUserID = Nothing Then
                ClsUser.Find("ID=" & clshrsRewards.RegUserID)
            End If
            ...
            End If
            If Convert.ToDateTime(clshrsRewards.RegDate).Date = Nothing Then
                lblRegDateValue.Text = ""
            Else
                lblRegDateValue.Text = Convert.ToDateTime(clshrsRewards.RegDate).Date
            End If
            If clshrsRewards.CancelDate = Nothing Then
                lblCancelDateValue.Text = ""
            Else
                lblCancelDateValue.Text = Convert.ToDateTime(clshrsRewards.CancelDate).Date
            End If
            If Not clshrsRewards.CancelDate = Nothing Then
            ...
            Else
                StrMode = "N"
            End If
            SetToolBarPermission(Me, clshrsRewards.ConnectionString, clshrsRewards.DataBaseUserRelatedID, clshrsRewards.GroupID, StrMode)
            SetToolBarRecordPermission(Me, clshrsRewards.ConnectionString, clshrsRewards.DataBaseUserRelatedID, clshrsRewards.GroupID, clshrsRewards.Table, clshrsRewards.ID)
            If Not clshrsRewards.CancelDate = Nothing Then
                ImageButton_Delete.Enabled = False
            End If
            If Page.IsPostBack Then
                CreateOtherFields(clshrsRewards.ID)
            End If
            Return True
        Catch ex As Exception
        End Try
    ...
    Private Function CheckCode() As Boolean
        ...
        Try
            clshrsRewards.Find("Code='" & txtCode.Text & "'")
            IntId = clshrsRewards.ID
            txtEngName.Focus()
            If clshrsRewards.ID > 0 Then
                GetValues()
                StrMode = "E"
            Else
                If clshrsRewards.CheckRecordExistance(" Code='" & txtCode.Text & "'") Then
                    txtCode.Text = ""
                    txtCode.Focus()
                End If
                Clear()
            ...
            SetToolBarDefaults()
            SetToolBarPermission(Me, clshrsRewards.ConnectionString, clshrsRewards.DataBaseUserRelatedID, clshrsRewards.GroupID, StrMode)
            SetToolBarRecordPermission(Me, clshrsRewards.ConnectionString, clshrsRewards.DataBaseUserRelatedID, clshrsRewards.GroupID, clshrsRewards.Table, IntId)
    ...
    Private Sub LoadDataUpdateSchedules(ByVal formName As String)
        ...
        clshrsRewards = New Clshrs_Rewards(Page)
        clshrsRewards.Find(" code = '" & txtCode.Text & "'")
        Dim recordID As Integer = clshrsRewards.ID
        If (recordID > 0) Then
    ...
    Private Function CreateOtherFields(ByVal IntRecordID As Integer)
        ...
        clsMainOtherFields = New clsSys_MainOtherFields(Me.Page)
        If clsMainOtherFields.CheckOtherFieldsButton(Me.Page, clshrsRewards.Table) = True Then
            Dim StrTablename As String
            clshrsRewards = New Clshrs_Rewards(Me)
            StrTablename = clshrsRewards.Table
