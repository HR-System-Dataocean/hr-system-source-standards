...
#Region "Protected Methods"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            ClsFisicalYearsPeriods.GetDropDownList(DdlPeriodsForSalary, IntModuleId, True, "")
            ...
            If Request.QueryString.Item("TrnsID") <> 0 Then
                ...
                wdtPaymentDate.Enabled = False
                wdtHPaymentDate.Enabled = False
            ...
            Else
                ...
                DdlPeriodsForSalary.SelectedValue = fiscID
                wdtPaymentDate.Enabled = True
                wdtHPaymentDate.Enabled = True
    ...
    Protected Sub uwgVacationHistory_SelectedRowsChange(ByVal sender As Object, ByVal e As Infragistics.WebUI.UltraWebGrid.SelectedRowsEventArgs) Handles uwgVacationHistory.SelectedRowsChange
        ...
        If (Not IsNothing(e.SelectedRows(0).Cells.FromKey("ID")) AndAlso Val(e.SelectedRows(0).Cells.FromKey("ID").Value) > 0) Then
            If ClsEmployeesTransactions.Find("ID=" & Val(e.SelectedRows(0).Cells.FromKey("ID").Value)) Then
                ...
                SetData2(ClsEmployeesTransactions.EmployeeID, ClsEmployeesTransactions.ID)
    ...
    Protected Sub btnSave_Command(sender As Object, e As System.Web.UI.WebControls.CommandEventArgs) Handles btnSave.Command, btnDelete.Command
        ...
        If chkWithSalary.Checked Then
            ...
            If DdlPeriodsForSalary.SelectedValue = 0 Then
                ...
                Exit Sub
            End If
            If DteVacationDate > DateTime.Now And Request.QueryString.Item("TrnsID") = 0 Then
                Venus.Shared.Web.ClientSideActions.MsgBoxBasic(Page, ObjNavigationHandler.SetLanguage(Page, " Sorry... Vacation entitlements cannot be paid for a future period. / عفوا... لا يمكن صرف مستحقات الاجازة لفترة لاحقة "))
                Exit Sub
        ...
        If dsLastVac.Tables(0).Rows.Count > 0 Then
            If Not PaymentDateValidation(Convert.ToDateTime(dsLastVac.Tables(0).Rows(0)("PaidDate").ToString())) Then
...
#Region "Private Methods"
    ...
    Private Sub SetData22(Optional ByVal EmployeeID As Integer = 0, Optional ByVal intEmpTransID As Integer = 0, Optional ByVal EmpVacationID As Integer = 0)
    ...
    'Private Sub SetData2(Optional ByVal EmployeeID As Integer = 0, Optional ByVal intEmpTransID As Integer = 0)
    Private Sub SetData2(Optional ByVal EmployeeID As Integer = 0, Optional ByVal intEmpTransID As Integer = 0, Optional ByVal EmpVacationID As Integer = 0)
        ...
        If ClsContracts.ID > 0 Then
            ...
            End If
            'Rabie 18-01-2026
            'dblVacationDays = ClsContract.GET_EMPLOYEE_VACATION_BALANCE_TO_DATE(ClsEmployees.Code, DteVacationStartDate)
            dblVacationDays = Math.Round(dblVacationDays, 2, MidpointRounding.AwayFromZero)
