...
<head runat="server">
    <title>* Venus Payroll * ~Documents</title>
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    ...
    <script type="text/javascript">
        function ShowDesignMode() {
            var ID = 0;
            if (document.getElementById('<%=HiddenField_DocumentID.ClientID%>').value != "") {
            
                ID = document.getElementById('<%=HiddenField_DocumentID.ClientID%>').value
              
               // window.showModalDialog("../DocumentWF/DocumentDesign.aspx?DocumentID=" + ID, "", "dialogWidth:1200px;dialogHeight:600px;center: Yes;resizable: No;");
                window.open("../DocumentWF/DocumentDesign.aspx?DocumentID=" + ID, "", "dialogWidth:1200px;dialogHeight:600px;center: Yes;resizable: No;");
              
            }
        }
        function ShowViewMode() {
            var ID = 0;
            if (document.getElementmnsById('<%=HiddenField_DocumentID.ClientID%>').value != "") {
                ID = document.getElementById('<%=HiddenField_DocumentID.ClientID%>').value
               // window.showModalDialog("../DocumentWF/DocumentView.aspx?DocumentID=" + ID, "", "dialogWidth:800px;dialogHeight:600px;center: Yes;resizable: No;");
                window.open("../DocumentWF/DocumentView.aspx?DocumentID=" + ID, "", "dialogWidth:800px;dialogHeight:600px;center: Yes;resizable: No;");
            }
        }
        function ShowStageDesign() {
            var ID = 0;
            if (document.getElementById('<%=HiddenField_DocumentID.ClientID%>').value != "") {
                ID = document.getElementById('<%=HiddenField_DocumentID.ClientID%>').value
               // window.showModalDialog("../DocumentWF/StagesDesign.aspx?DocumentID=" + ID, "", "dialogWidth:1200px;dialogHeight:600px;center: Yes;resizable: No;");
                window.open("../DocumentWF/StagesDesign.aspx?DocumentID=" + ID, "", "dialogWidth:1200px;dialogHeight:600px;center: Yes;resizable: No;");
            }
        }
        function ShowSearchSetting() {
            var hight = 556;
            var width = 800;
            window.open("frmSearchSetting.aspx", "", "height=" + hight + ",width=" + width + ",resizable=0,menubar=0,toolbar=0,location=0,directories=0,scrollbars=0,status=0,center=0");
        }
    </script>
    <div style="display: none">
        ...
        <asp:HiddenField ID="HiddenField_DocumentID" runat="server" />
    </div>
                            ...
                            <igtab:Tab Text="عام" meta:resourcekey="TabResource1">
                                <ContentTemplate>
                                    <table style="width: 100%; height: 100%; min-height: 350px; vertical-align: top"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="DataArea">
                                                            ...
                                                            <igtxt:WebImageButton ID="btnSearchCode" runat="server" AutoSubmit="False" Height="18px"
                                                                ...
                                                                <Appearance>
                                                                    <Image Url="../HR/Img/forum_search.gif" />
                                                                </Appearance>
                                            ...
                                            <td style="width: 47%">
                                                <table style="width: 100%; height: 100%">
                                                    <tr>
                                                        ...
                                                        <td style="width: 90px;">
                                                            <asp:Label ID="Label_DocTypeID" runat="server" Text="نوع المستند" SkinID="Label_DefaultNormal"
                                                                meta:resourcekey="Label_DocTypeIDResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="DropDownList_DocTypeID" runat="server" SkinID="DropDownList_LargNormal"
                                                                meta:resourcekey="DropDownList_DocTypeIDResource1">
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                </table>
                                            ...
                                            <td style="width: 47%">
                                                <table style="width: 100%; height: 100%">
                                                    <tr>
                                                        ...
                                                        <td style="width: 90px;">
                                                            <asp:Label ID="Label_ReportID" runat="server" Text="مصدر التقرير" SkinID="Label_DefaultNormal"
                                                                meta:resourcekey="Label_ReportIDResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="DropDownList_ReportID" runat="server" SkinID="DropDownList_LargNormal"
                                                                meta:resourcekey="DropDownList_ReportIDResource1">
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                </table>
                                            ...
                                            <td style="width: 47%">
                                                <table style="width: 100%; height: 100%">
                                                    <tr>
                                                        ...
                                                        <td style="width: 90px;">
                                                            <asp:Label ID="Label_ParentMenu" runat="server" Text="القائمة الرئيسية" SkinID="Label_DefaultNormal"
                                                                meta:resourcekey="Label_ParentMenuResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="DropDownList_ParentMenu" runat="server" SkinID="DropDownList_LargNormal"
                                                                meta:resourcekey="DropDownList_ParentMenuResource1">
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                </table>
                                            ...
                                            <td style="width: 47%">
                                                <table style="width: 100%; height: 100%">
                                                    <tr>
                                                        ...
                                                        <td style="width: 90px;">
                                                            <asp:Label ID="Label_AllowWorkFlow" runat="server" Text="تطبيق تدفق البيانات" SkinID="Label_DefaultNormal"
                                                                meta:resourcekey="Label_AllowWorkFlowResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:CheckBox ID="CheckBox_AllowWorkFlow" runat="server" meta:resourcekey="CheckBox_AllowWorkFlowResource1" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                        ...
                                        <tr>
                                            <td style="width: 100%; height: 100px; vertical-align: bottom" colspan="3">
                                                <table style="width: 100%; height: 50%">
                                                    <tr>
                                                        <td style="width: 15%; vertical-align: bottom; text-align: center">
                                                        </td>
                                                        <td style="width: 22%; vertical-align: bottom; text-align: center">
                                                            <asp:ImageButton ID="ImageButton_Design" runat="server" ImageUrl="~/Common/Images/Paper-pencil.png"
                                                                CausesValidation="False" OnClientClick="ShowDesignMode();return false" meta:resourcekey="ImageButton_DesignResource1" />
                                                        </td>
                                                        <td style="width: 22%; vertical-align: bottom; text-align: center">
                                                            <asp:ImageButton ID="ImageButton_View" runat="server" ImageUrl="~/Common/Images/Paper.png"
                                                                CausesValidation="False" OnClientClick="ShowViewMode();return false" meta:resourcekey="ImageButton_ViewResource1" />
                                                        </td>
                                                        <td style="width: 24%; vertical-align: bottom; text-align: center">
                                                            <asp:ImageButton ID="ImageButton_Stages" runat="server" ImageUrl="~/Common/Images/StagesDes.png"
                                                                CausesValidation="False" OnClientClick="ShowStageDesign();return false" meta:resourcekey="ImageButton_StagesResource1" />
                                                        </td>
                                                        <td style="width: 15%; vertical-align: bottom; text-align: center">
                                                        </td>
                                                    </tr>
                                        ...
                                        <tr>
                                            <td style="width: 100%; height: 30px; vertical-align: middle" colspan="3">
                                                <table style="width: 100%; height: 50%">
                                                    <tr>
                                                        <td style="width: 15%; vertical-align: middle; text-align: center">
                                                        </td>
                                                        <td style="width: 22%; vertical-align: middle; text-align: center">
                                                            <asp:Label ID="Label_Design" runat="server" SkinID="Label_DefaultNormal" Text="تصميم المستند"
                                                                meta:resourcekey="Label_DesignResource1"></asp:Label>
                                                        </td>
                                                        <td style="width: 22%; vertical-align: middle; text-align: center">
                                                            <asp:Label ID="Label_View" runat="server" SkinID="Label_DefaultNormal" Text="عرض المستند"
                                                                meta:resourcekey="Label_ViewResource1"></asp:Label>
                                                        </td>
                                                        <td style="width: 24%; vertical-align: middle; text-align: center">
                                                            <asp:Label ID="Label_Sateges" runat="server" SkinID="Label_DefaultNormal" Text="تصميم المراحل"
                                                                meta:resourcekey="Label_SategesResource1"></asp:Label>
                                                        </td>
                                                        <td style="width: 15%; vertical-align: middle; text-align: center">
                                                        </td>
                                                    </tr>
                                            ...
                                            <td style="width: 100%; height: 20px; vertical-align: middle" colspan="3">
                                                <table style="width: 100%; height: 100%">
                                                    <tr>
                                                        ...
                                                        <td style="width: 70%; vertical-align: middle; text-align: inherit">
                                                            <asp:LinkButton ID="LinkButton_CreateObject" runat="server" SkinID="LinkButton_DefaultBold"
                                                                meta:resourcekey="LinkButton_CreateObjectResource1" Text="تكوين كائن للمستند الحالى فى قواعد البيانات"></asp:LinkButton>
                                                        </td>
                                                        <td style="width: 15%; vertical-align: middle; text-align: center">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td style="width: 70%; vertical-align: middle; text-align: inherit">
                                                            <asp:LinkButton ID="LinkButton_SearchSetting" runat="server" SkinID="LinkButton_DefaultBold"
                                                                meta:resourcekey="LinkButton_SearchSettingResource1" Text="ضبط نموذج البحث" OnClientClick="ShowSearchSetting(); return false;"></asp:LinkButton>
                                                        </td>
                                                        <td style="width: 15%; vertical-align: middle; text-align: center">
                                                        </td>
                                                    </tr>
