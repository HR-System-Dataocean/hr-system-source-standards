<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmExtendTransfereLeaveBalance.aspx.vb"
...
<head runat="server">
    <title>* Venus Payroll * ~ Loan Letter Request</title>
    ...
    <script type="text/javascript" id="igClientScript">
        ...
        function OpenPrintedScreen(v) {
            ...
            var win = window.open("../../Interfaces/frmReportsGridViewer.aspx?Language=false&Criteria=RequestSerial&preview=1&ReportCode=CF_121&sq0=''&v=" + v, "_NEW", "height=" + hight + ",width=" + width + ",resizable=0,menubar=0,toolbar=0,location=0,directories=0,scrollbars=0,status=0,center=0");
            win.focus();
        }
    </script>
    <style type="text/css">
...
<body style="margin: 0; padding: 0; font-family: Tahoma; font-size: 11px;">
            ...
            <tr>
                <td class="Details">
                    <igtab:UltraWebTab ID="UltraWebTab1" runat="server" EnableAppStyling="True" SkinID="Default"
                        ...
                        <Tabs>
                            <igtab:Tab Text="Loan Letter Request" meta:resourcekey="TabResource1">
                                <ContentTemplate>
                                        ...
                                        <tr>
                                            <td style="width: 40%; height: 16px; vertical-align: top">
                                                <table class="compact-table">
                                                    <!-- Extend Date -->
                                                    <tr>
                                                        <td class="label-compact">
                                                            <asp:Label ID="lblExtendDate" runat="server" Text="Extend Date"
                                                                SkinID="Label_DefaultNormal" meta:resourcekey="lblExtendDateResource1"></asp:Label>
                                                        </td>
                                                        <td>
                                                            <igsch:WebDateChooser ID="ddlRequestDate" runat="server" BorderColor="#CCCCCC" BorderStyle="Solid"
                                                                BorderWidth="1px" Height="24px" NullDateLabel="" Style="font-family: Tahoma;
                                                                font-size: 10pt; color: Black; border: solid 1px #CCCCCC; width: 120px;"
                                                                Width="120px" CssClass="date-compact">
                                                            ...
                                                            <table style="width: 100%; border-collapse: collapse; padding: 0; margin: 0;">
                                                                <tr>
                                                                    <td style="padding: 0; margin: 0;">
                                                                        <asp:TextBox ID="txtEmployee" runat="server" CssClass="field-compact" MaxLength="30"
                                                                            AutoPostBack="True" meta:resourcekey="txtEmployeeResource1">
                                                                        </asp:TextBox>
                                                                    </td>
                                                                    <td style="padding: 0 0 0 3px; margin: 0;">
                                                                        <igtxt:WebImageButton ID="btnSearchCode" runat="server" Height="24px" AutoSubmit="False"
                                                                            meta:resourcekey="btnSearchCodeResource1" Overflow="NoWordWrap" UseBrowserDefaults="False"
                                                                            Width="26px" CssClass="search-button">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtDepartment" runat="server" CssClass="field-compact" MaxLength="30"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtPosition" runat="server" CssClass="field-compact" MaxLength="30"
                                                    ...
                                                    <tr>
                                                        <td class="label-compact">
                                                            <asp:Label ID="lblCurrentYearBalance" runat="server" Text="Current Year Balance" SkinID="Label_DefaultNormal"
                                                                meta:resourcekey="lblCurrentYearBalanceResource1"></asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="TxtCurrentYearBalance" runat="server" CssClass="field-compact" MaxLength="30"
                                                                AutoPostBack="False" ReadOnly="False" meta:resourcekey="txtEmployeeResource1">
                                                            </asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td class="label-compact">
                                                            <asp:Label ID="LblCurrentYearBalanceExpireDate" runat="server" Text="Expire Date" SkinID="Label_DefaultNormal"
                                                                meta:resourcekey="LblCurrentYearBalanceExpireDateResource1"></asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="TxtCurrentYearBalanceExpireDate" runat="server" CssClass="field-compact" MaxLength="30"
                                                                AutoPostBack="False" ReadOnly="False" meta:resourcekey="txtEmployeeResource1">
                                                            </asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td class="label-compact">
                                                            <asp:Label ID="LblTranferedBalance" runat="server" Text="Tranfered Balance" SkinID="Label_DefaultNormal"
                                                                meta:resourcekey="TranferedBalanceResource1"></asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="TxttranferedBalance" runat="server" CssClass="field-compact" MaxLength="30"
                                                                AutoPostBack="False" ReadOnly="False" meta:resourcekey="txtEmployeeResource1">
                                                            </asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td class="label-compact">
                                                            <asp:Label ID="LblExpireDate" runat="server" Text="Expire Date" SkinID="Label_DefaultNormal"
                                                                meta:resourcekey="TranferedBalanceExpiryResource1"></asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="TxtExpireDate" runat="server" CssClass="field-compact" MaxLength="30"
                                                                AutoPostBack="False" ReadOnly="False" meta:resourcekey="txtEmployeeResource1">
                                                            </asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td class="label-compact">
                                                            <asp:Label ID="LblNewExpireDate" runat="server" Text="New Expire Date" SkinID="Label_DefaultNormal"
                                                                meta:resourcekey="NewExpireDateResource1"></asp:Label>
                                                        </td>
                                                        <td>
                                                            <igsch:WebDateChooser ID="TxtNewExpireDate" runat="server" BorderColor="#CCCCCC" BorderStyle="Solid"
                                                                BorderWidth="1px" Height="24px" NullDateLabel="" Style="font-family: Tahoma;
                                                                font-size: 10pt; color: Black; border: solid 1px #CCCCCC; width: 120px;"
                                                                Width="120px" CssClass="date-compact">
                                                                <AutoPostBack ValueChanged="" />
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table class="compact-table">
                                                    <!-- Hidden field for Requester User -->
                                                    <tr style="display: none;">
                                                        <td>
                                                            <asp:TextBox ID="txtRequesterUser" runat="server" Visible="false" CssClass="field-compact" MaxLength="30"
                                                                AutoPostBack="False" meta:resourcekey="txtEmployeeResource1">
                                                            </asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="lblDescEnglishName" runat="server" CssClass="field-large"
                                                    ...
                                                    <tr>
                                                        <td class="label-compact">
                                                            <asp:Label ID="label5" runat="server" Text="Nationality"
                                                                SkinID="Label_DefaultNormal" meta:resourcekey="labelNationalityResource1"></asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtNationality" runat="server" CssClass="field-medium"
                                                                ReadOnly="True" MaxLength="255" meta:resourcekey="lblDescEnglishNameResource1"
                                                                TabIndex="1"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    
                                                    <!-- Spacer rows for better alignment -->
