<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmPunishmentSetting.aspx.vb"
    Inherits="frmDepartments" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
...
<head runat="server">
    <title>* Venus Payroll * ~Departments</title>
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmDepartments" runat="server">
                                        ...
                                        <table style="width: 100%; height: 100%; min-height: 350px; vertical-align: top"
                                                ...
                                                <td style="width: 47%; height: 16px; vertical-align: top">
                                                    <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                        <tr>
                                                            <td class="SeparArea"></td>
                                                            <td class="LabelArea">
                                                                <asp:Label ID="lblParentBranch" runat="server" meta:resourcekey="lblParentBranchResource1"
                                                                    SkinID="Label_DefaultNormal" Text=" تصنيف المخالفة "></asp:Label>
                                                            </td>
                                                            <td class="DataArea">
                                                                <asp:DropDownList ID="ddl_MainDepartment" runat="server" SkinID="DropDownList_LargNormal"
                                                                    meta:resourcekey="ddl_MainDepartmentResource1">
                                                                </asp:DropDownList>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                ...
                                                <td style="width: 47%; height: 16px; vertical-align: top">
                                                    <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                        <tr>
                                                            <td class="SeparArea"></td>
                                                            <td class="LabelArea">
                                                                <asp:Label ID="Label1" runat="server" meta:resourcekey="lblParentBranchResource1"
                                                                    SkinID="Label_DefaultNormal" Text=" تاريخ تطبيق المخالفة "></asp:Label>
                                                            </td>
                                                            <td class="DataArea">
                                                ...
                                                <td style="width: 47%; height: 16px; vertical-align: top">
                                                    <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                        <tr>
                                                            <td class="SeparArea"></td>
                                                            <td class="LabelArea">
                                                                <asp:Label ID="Label2" runat="server" meta:resourcekey="lblParentBranchResource1"
                                                                    SkinID="Label_DefaultNormal" Text=" مدة التطبيق بالاشهر "></asp:Label>
                                                            </td>
                                                            <td class="DataArea">
                                                                <asp:TextBox ID="txtmonthesNumber" runat="server" SkinID="TextBox_LargeNormalC" meta:resourcekey="txtBankAccountResource1"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                        ...
                                                        <tr>
                                                            <td style="vertical-align: bottom">
                                                                <asp:Label ID="Label_Title1" runat="server" meta:resourcekey="Label_Title1Resource1"
                                                                    SkinID="Label_DefaultBold" Text="برجاء تحديد فئات الموظفين التى سوف تتطبق عليهم المخالفة"></asp:Label>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            ...
                                            <tr>
                                                <td style="height: 100%" colspan="3">
                                                    <igtbl:UltraWebGrid   Browser="UpLevel"  ID="uwgBranches" runat="server" EnableAppStyling="False" Height="280px"
                                                        Width="325px" SkinID="Default" meta:resourcekey="uwgBranchesResource1">
                                                        <DisplayLayout AllowColSizingDefault="Free" AllowColumnMovingDefault="OnServer" AllowDeleteDefault="Yes"
                                                            AllowSortingDefault="OnClient" AllowUpdateDefault="Yes" BorderCollapseDefault="Separate"
                                                            HeaderClickActionDefault="SortSingle" Name="uwgBranches" RowHeightDefault="18px"
                                                        ...
                                                        <Bands>
                                                            <igtbl:UltraGridBand meta:resourcekey="UltraGridBandResource1">
                                                                <Columns>
                                                                    <igtbl:UltraGridColumn meta:resourcekey="IDRecourcekey" BaseColumnName="ID" Hidden="True"
                                                                        Key="ID">
                                                                    </igtbl:UltraGridColumn>
                                                                    <igtbl:UltraGridColumn AllowUpdate="No" BaseColumnName="EngName" Key="EngName" 
                                                                        Width="45%">
                                                                        <Header Caption="الفئة انجليزى">
                                                                    ...
                                                                    <igtbl:UltraGridColumn AllowUpdate="No" BaseColumnName="ArbName" Key="ArbName" 
                                                                        Width="45%">
                                                                        <Header Caption="الفئة عربى">
                                                                    ...
                                                                    <igtbl:UltraGridColumn BaseColumnName="Checked" DataType="System.Boolean" Key="Checked"
                                                                        meta:resourcekey="GridChecked" Type="CheckBox" Width="10%">
                                                                    ...
                                                                    <igtbl:UltraGridColumn meta:resourcekey="BranchIDRecourcekey" BaseColumnName="BranchID"
                                                                        DataType="System.Int64" Hidden="True" Key="BranchID">
                                                                        <Header>
