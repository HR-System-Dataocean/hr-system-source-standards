...
Partial Class frmBloodGroups
    Inherits MainPage
#Region "Public Decleration"
    Private ClsBloodGroup As Clshrs_BloodGroups
...
#Region "Protected Sub"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ClsBloodGroup = New Clshrs_BloodGroups(Me.Page)
        Dim ClsObjects As New Clssys_Objects(Page)
        Dim ClsSearchs As New Clssys_Searchs(Page)
        Dim SearchID As Integer = 0
        Try
            Dim clsSearchsColumns As New Clssys_SearchsColumns(Page)
            If ClsObjects.Find(" Code='" & ClsBloodGroup.Table.Trim & "'") Then
            ...
            If Not IsPostBack Then
                Page.Session.Add("ConnectionString", ClsBloodGroup.ConnectionString)
                ClsBloodGroup.AddOnChangeEventToControls("frmBloodGroups", Page, UltraWebTab1)
            ...
            If (txtCode.Text <> "") Then
                ClsBloodGroup.Find(" Code='" & txtCode.Text & "'")
                IntrecordID = ClsBloodGroup.ID
        ...
        Catch ex As Exception
            ...
            mErrorHandler.RecordExceptions_DataBase("", ex, Err.Number, ClsBloodGroup.RegUserID, Venus.Shared.ErrorsHandler.eRecordingType.System_DataBase)
    ...
    Protected Sub ImageButton_Command(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.CommandEventArgs) Handles ImageButton_Save.Command, ImageButton_SaveN.Command, LinkButton_SaveN.Command, ImageButton_New.Command, ImageButton_Print.Command, ImageButton_Properties.Command, LinkButton_Properties.Command, ImageButton_Remarks.Command, LinkButton_Remarks.Command, ImageButton_Last.Command, ImageButton_Next.Command, ImageButton_Back.Command, ImageButton_First.Command, ImageButton_Delete.Command
        ...
        Dim ObjNavigationHandler As New Venus.Shared.Web.NavigationHandler(ClsBloodGroup.ConnectionString)
        Select Case e.CommandArgument
            ...
            Case "New"
                AfterOperation()
            Case "Delete"
                ClsBloodGroup.Delete("Code='" & txtCode.Text & "'")
                AfterOperation()
            Case "Property"
                ClsBloodGroup.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmPropertyScreen.aspx?ID=" & ClsBloodGroup.ID & "&TableName=" & ClsBloodGroup.Table, 477, 313, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Property", False)
            Case "Remarks"
                ClsBloodGroup.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmRemarks.aspx?ID=" & ClsBloodGroup.ID & "&TableName=" & ClsBloodGroup.Table, 410, 210, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Remarks", False)
            Case "Print"
            ...
            Case "First"
                ClsBloodGroup.Find("Code='" & txtCode.Text & "'")
                ClsBloodGroup.FirstRecord()
                GetValues(ClsBloodGroup)
            Case "Previous"
                ClsBloodGroup.Find("Code='" & txtCode.Text & "'")
                If Not ClsBloodGroup.previousRecord() Then
                    ClsBloodGroup.Find("Code='" & txtCode.Text & "'")
            ...
            Case "Next"
                ClsBloodGroup.Find("Code='" & txtCode.Text & "'")
                If Not ClsBloodGroup.NextRecord() Then
                    ClsBloodGroup.Find("Code='" & txtCode.Text & "'")
...
#Region "Private Functions"
    Private Function SavePart() As Boolean
        Dim StrMode As String = Request.QueryString.Item("Mode")
        ClsBloodGroup = New Clshrs_BloodGroups(Page)

        Try
            ClsBloodGroup.Find("Code='" & txtCode.Text & "'")

            If ClsBloodGroup.ID > 0 Then
                If Not AssignValue(ClsBloodGroup) Then
                    Exit Function
                End If
                ClsBloodGroup.Update("Code='" & txtCode.Text & "'")
            ...
            clsMainOtherFields.CollectDataAndSave(value.Text, ClsBloodGroup.Table, ClsBloodGroup.ID)
            value.Text = ""
            Return True
        Catch ex As Exception
            Return False
        End Try
    End Function
    Private Function AssignValue(ByRef ClsBloodGroup As Clshrs_BloodGroups) As Boolean
        Try
            With ClsBloodGroup
                .Code = txtCode.Text
        ...
        End Try
    End Function
    Private Function GetValues(ByVal ClsBloodGroup As Clshrs_BloodGroups) As Boolean
        ...
        Try
            ...
            With ClsBloodGroup
                ...
                If Page.IsPostBack Then
                    CreateOtherFields(ClsBloodGroup.ID)
                End If
            End With
            Return True
        Catch ex As Exception
    ...
    Private Function CheckCode() As Boolean
        ...
        Try
            ClsBloodGroup.Find("Code='" & txtCode.Text & "'")
            IntId = ClsBloodGroup.ID
            txtEngName.Focus()
            If ClsBloodGroup.ID > 0 Then
                GetValues(ClsBloodGroup)
                StrMode = "E"
            Else
                If ClsBloodGroup.CheckRecordExistance(" Code='" & txtCode.Text & "'") Then
                    txtCode.Text = ""
                    txtCode.Focus()
                End If
            ...
            End If
            SetToolBarDefaults()
            SetToolBarPermission(Me, ClsBloodGroup.ConnectionString, ClsBloodGroup.DataBaseUserRelatedID, ClsBloodGroup.GroupID, StrMode)
            SetToolBarRecordPermission(Me, ClsBloodGroup.ConnectionString, ClsBloodGroup.DataBaseUserRelatedID, ClsBloodGroup.GroupID, ClsBloodGroup.Table, IntId)
    ...
    Private Sub LoadDataUpdateSchedules(ByVal formName As String)
        ...
        ClsBloodGroup = New Clshrs_BloodGroups(Me.Page)
        ClsBloodGroup.Find(" code = '" & txtCode.Text & "'")
        Dim recordID As Integer = ClsBloodGroup.ID
        If (recordID > 0) Then
    ...
    Private Function CreateOtherFields(ByVal IntRecordID As Integer)
        ...
        If clsMainOtherFields.CheckOtherFieldsButton(Me.Page, ClsBloodGroup.Table) = True Then
            Dim StrTablename As String
            ClsBloodGroup = New Clshrs_BloodGroups(Me)
            StrTablename = ClsBloodGroup.Table
