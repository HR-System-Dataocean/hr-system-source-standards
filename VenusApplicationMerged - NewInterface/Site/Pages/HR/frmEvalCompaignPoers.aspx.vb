...
Partial Class frmEvalCompaignPoers
    Inherits MainPage
...
#Region "Protected Sub"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        End If
    End Sub
    Protected Sub ImageButton_Command(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.CommandEventArgs) Handles ImageButton_Print.Command
    ...
    Protected Sub ddlCompaign_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlCompaign.SelectedIndexChanged
        ...
        If ddlCompaign.SelectedValue <> 0 Then
            ...
            Dim Str1 As String = "select distinct B.Evaluated_ID,A.Evaluator_ID,A.EngName,A.ArbName,B.RegComputerID from Eval_EvaluationCompaignDetail1 A left outer join Eval_EvaluationCompaignDetail2 B on A.EvalCompaign_ID = B.EvalCompaign_ID and A.Evaluator_ID = B.Evaluator_ID" & _
