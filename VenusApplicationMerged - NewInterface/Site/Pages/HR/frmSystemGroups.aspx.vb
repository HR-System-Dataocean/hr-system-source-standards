...
#Region "Protected Sub"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If ClsObjects.Find(" Code='" & ObjClssys_Groups.Table.Trim.Replace(" ", "") & "'") Then
            ...
            If Not IsPostBack Then
                ...
                ObjClssys_Groups.AddOnChangeEventToControls("frmSystemGroups", Page, UltraWebTab1)
            ...
            If (txtCode.Text <> "") Then
                ObjClssys_Groups.Find(" Code='" & txtCode.Text & "'")
                IntrecordID = ObjClssys_Groups.ID
    ...
    Protected Sub ImageButton_Command(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.CommandEventArgs) Handles ImageButton_Save.Command, ImageButton_SaveN.Command, LinkButton_SaveN.Command, ImageButton_New.Command, ImageButton_Print.Command, ImageButton_Properties.Command, LinkButton_Properties.Command, ImageButton_Remarks.Command, LinkButton_Remarks.Command, ImageButton_Last.Command, ImageButton_Next.Command, ImageButton_Back.Command, ImageButton_First.Command, ImageButton_Delete.Command
        ...
        Dim ObjNavigationHandler As New Venus.Shared.Web.NavigationHandler(ObjClssys_Groups.ConnectionString)
        Select Case e.CommandArgument
            Case "SaveNew"
                ...
                If Not AssignValues() Then
                    Exit Sub
                End If
                If ObjClssys_Groups.ID > 0 Then
                    ObjClssys_Groups.Update("code='" & txtCode.Text & "'")
                Else
                    ObjClssys_Groups.Save()
                End If
                ObjClssys_Groups.Find("Code='" & txtCode.Text & "'")
                clsMainOtherFields = New clsSys_MainOtherFields(Me.Page)
                clsMainOtherFields.CollectDataAndSave(value.Text, ObjClssys_Groups.Table, ObjClssys_Groups.ID)
                value.Text = ""
                AfterOperation()
            Case "Save"
                If txtCode.Text = "" Then
            ...
            Case "New"
                AfterOperation()
            Case "Delete"
                ObjClssys_Groups.Delete("Code='" & txtCode.Text & "'")
                AfterOperation()
            Case "Property"
                ObjClssys_Groups.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmPropertyScreen.aspx?ID=" & ObjClssys_Groups.ID & "&TableName=" & ObjClssys_Groups.Table, 477, 313, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Property", False)
            Case "Remarks"
                ObjClssys_Groups.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmRemarks.aspx?ID=" & ObjClssys_Groups.ID & "&TableName=" & ObjClssys_Groups.Table, 410, 210, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Remarks", False)
            Case "Print"
                Venus.Shared.Web.ClientSideActions.PrintWindow(Me)
            Case "Other Fields"
                Dim clsObjOtherFields As New ClsSys_OtherFields(Page)
                Dim clsSysObjects As New Clssys_Objects(Page)
                Dim tablename As String = ObjClssys_Groups.Table
                ObjClssys_Groups.Find(" code = '" & txtCode.Text & "'")
                Dim recordID As Integer = ObjClssys_Groups.ID
                ...
                With clsObjOtherFields
                    If .Find(" sys_OtherFields.ObjectID = " & clsSysObjects.ID) = True Then
                        ...
                        Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmOtherFieldsDynamic.aspx?tableName=" & tablename & "&ObjectId=" & .ObjectID & "&RecordId=" & ObjClssys_Groups.ID, 602, 306, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "OtherFields", False)
                    End If
                End With
            Case "Exit"
                ObjClssys_Groups.Find(" Code= '" & txtCode.Text & "'")
                If ObjClssys_Groups.ID > 0 Then
                    Dim Ds As Data.DataSet = ObjClssys_Groups.DataSet
                    If Not AssignValues() Then
                        Exit Sub
                    End If
                    If ObjClssys_Groups.CheckDiff(ObjClssys_Groups, Ds, "") Then
                ...
                End If
            Case "First"
                ObjClssys_Groups.FirstRecord()
                GetValues()
            Case "Previous"
                ObjClssys_Groups.Find("Code='" & txtCode.Text & "'")
                If Not ObjClssys_Groups.previousRecord() Then
                    ObjClssys_Groups.Find("Code='" & txtCode.Text & "'")
            ...
            Case "Next"
                ObjClssys_Groups.Find("Code='" & txtCode.Text & "'")
                If Not ObjClssys_Groups.NextRecord() Then
                    ObjClssys_Groups.Find("Code='" & txtCode.Text & "'")
                    Venus.Shared.Web.ClientSideActions.MsgBoxBasic(Page, ObjNavigationHandler.SetLanguage(Page, " This is the last page /هذه أخر صفحة"))
                End If
                GetValues()
            Case "Last"
                ObjClssys_Groups.LastRecord()
                GetValues()
        End Select
    End Sub
...
#Region "Private Functions"
    ...
    Private Function GetValues() As Boolean
        ...
        Try
            SetToolBarDefaults()
            txtCode.Text = ObjClssys_Groups.Code
            txtEngName.Text = ObjClssys_Groups.EngName
            txtArbName.Text = ObjClssys_Groups.ArbName

            If Not ObjClssys_Groups.RegUserID = Nothing Then
                ClsUser.Find("ID=" & ObjClssys_Groups.RegUserID)
            End If
            ...
            End If
            If Convert.ToDateTime(ObjClssys_Groups.RegDate).Date = Nothing Then
                lblRegDateValue.Text = ""
            Else
                lblRegDateValue.Text = Convert.ToDateTime(ObjClssys_Groups.RegDate).Date
            End If
            If ObjClssys_Groups.CancelDate = Nothing Then
                lblCancelDateValue.Text = ""
            Else
                lblCancelDateValue.Text = Convert.ToDateTime(ObjClssys_Groups.CancelDate).Date
            End If
            If Not ObjClssys_Groups.CancelDate = Nothing Then
            ...
            Else
                StrMode = "N"
            End If
            SetToolBarPermission(Me, ObjClssys_Groups.ConnectionString, ObjClssys_Groups.DataBaseUserRelatedID, ObjClssys_Groups.GroupID, StrMode)
            SetToolBarRecordPermission(Me, ObjClssys_Groups.ConnectionString, ObjClssys_Groups.DataBaseUserRelatedID, ObjClssys_Groups.GroupID, ObjClssys_Groups.Table, ObjClssys_Groups.ID)
            If Not ObjClssys_Groups.CancelDate = Nothing Then
                ImageButton_Delete.Enabled = False
            End If
            If Page.IsPostBack Then
                CreateOtherFields(ObjClssys_Groups.ID)
            End If
            Return True
        Catch ex As Exception
        End Try
    ...
    Private Function SetToolbarSetting(ByVal ptrType As String, ByVal ClsClass As Object, ByVal intID As Integer) As Boolean
        Try
            Select Case ptrType
                ...
                Case "D"
                    ObjClssys_Groups.Find("ID=" & intID)
                    GetValues()
    ...
    Private Function CheckCode() As Boolean
        ...
        Try
            ObjClssys_Groups.Find("Code='" & txtCode.Text & "'")
            IntId = ObjClssys_Groups.ID
            txtEngName.Focus()
            If ObjClssys_Groups.ID > 0 Then
                GetValues()
                StrMode = "E"
            Else
                If ObjClssys_Groups.CheckRecordExistance(" Code='" & txtCode.Text & "'") Then
                    txtCode.Text = ""
                    txtCode.Focus()
                End If
                Clear()
            ...
            SetToolBarDefaults()
            SetToolBarPermission(Me, ObjClssys_Groups.ConnectionString, ObjClssys_Groups.DataBaseUserRelatedID, ObjClssys_Groups.GroupID, StrMode)
            SetToolBarRecordPermission(Me, ObjClssys_Groups.ConnectionString, ObjClssys_Groups.DataBaseUserRelatedID, ObjClssys_Groups.GroupID, ObjClssys_Groups.Table, IntId)
    ...
    Private Sub LoadDataUpdateSchedules(ByVal formName As String)
        ...
        ObjClssys_Groups = New Clssys_Groups(Page)
        ObjClssys_Groups.Find(" code = '" & txtCode.Text & "'")
        Dim recordID As Integer = ObjClssys_Groups.ID
        If (recordID > 0) Then
    ...
    Private Function CreateOtherFields(ByVal IntRecordID As Integer)
        ...
        clsMainOtherFields = New clsSys_MainOtherFields(Me.Page)
        If clsMainOtherFields.CheckOtherFieldsButton(Me.Page, ObjClssys_Groups.Table) = True Then
            Dim StrTablename As String
            ObjClssys_Groups = New Clssys_Groups(Me)
            StrTablename = ObjClssys_Groups.Table
