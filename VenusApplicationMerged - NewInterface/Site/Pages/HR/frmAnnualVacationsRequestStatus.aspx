<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmAnnualVacationsRequestStatus.aspx.vb"
               ...
               AutoPostBack="True" meta:resourcekey="txtRequestTypeResource1" ReadOnly="true">
                                                    ...
                                                    <tr>
                                                      ...
                                                      <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="LblStartDate" runat="server" Width="90px" SkinID="Label_DefaultNormal"
                                                                Text=" تاريخ البداية" meta:resourcekey="LblStartDateResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="TxtStartDate" runat="server" SkinID="TextBox_SmalltNormalc" meta:resourcekey="lbRemainValResource1"
                                                                TabIndex="1" ReadOnly="True"></asp:TextBox>
                                                        </td>
                                                           <td class="SeparArea">
                                                        </td>
                                                        <td class="LabelArea">
                                                            <asp:Label ID="LblEndDate" runat="server" Width="90px" SkinID="Label_DefaultNormal"
                                                                Text="تاريخ العودة" meta:resourcekey="LblEndDateResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="TxtEndDate" runat="server" SkinID="TextBox_SmalltNormalc" meta:resourcekey="lbRemainValResource1"
                                                                TabIndex="1" ReadOnly="True"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                      ...
                                                      <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="LblNoOfDays" runat="server" Width="90px" SkinID="Label_DefaultNormal"
                                                                Text=" عدد الايام" meta:resourcekey="LblNoOfDaysResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="TxtNoOfDays" runat="server" SkinID="TextBox_SmalltNormalc" meta:resourcekey="lbRemainValResource1"
                                                                TabIndex="1" ReadOnly="True"></asp:TextBox>
                                                        </td>
                                                           <td class="SeparArea">
                                                        </td>
                                                        <td class="LabelArea">
                                                            <asp:Label ID="LblBalance" runat="server" Width="90px" SkinID="Label_DefaultNormal"
                                                                Text="الرصيد" meta:resourcekey="LblBalanceResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="TxtBalance" runat="server" SkinID="TextBox_SmalltNormalc" meta:resourcekey="lbRemainValResource1"
                                                                TabIndex="1" ReadOnly="True"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                     ...
                                                     <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="LblContactNo" runat="server" Width="90px" SkinID="Label_DefaultNormal"
                                                                Text=" رقم التواصل" meta:resourcekey="LblContactNoResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="TxtContactNo" runat="server" SkinID="TextBox_SmalltNormalc" meta:resourcekey="lbRemainValResource1"
                                                                TabIndex="1" ReadOnly="True"></asp:TextBox>
                                                        </td>
                                                           <td class="SeparArea">
                                                        </td>
                                                        <td class="LabelArea">
                                                            <asp:Label ID="LblAlternative" runat="server" Width="90px" SkinID="Label_DefaultNormal"
                                                                Text="الموظف البديل" meta:resourcekey="LblAlternativeResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="TxtAlternative" runat="server" width="170px" meta:resourcekey="lbRemainValResource1"
                                                                TabIndex="1" ReadOnly="True"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
