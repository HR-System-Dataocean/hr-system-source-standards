<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmEmployeesClassesWeeklySetCustomize.aspx.vb"
    Inherits="frmEmployeesClassesWeeklySetCustomize" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
                                                ...
                                                <td style="width: 47%; height: 16px; vertical-align: top">
                                                    <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                        <tr>
                                                            <td class="SeparArea"></td>
                                                            <td class="LabelArea">
                                                                <asp:Label ID="Label_FromDate" runat="server" SkinID="Label_DefaultNormal" Text="من تاريخ" meta:resourcekey="FromDateResource1"></asp:Label>
                                                            </td>
                                                            <td class="DataArea">
                                                                <igsch:WebDateChooser ID="StartDate" runat="server" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" EnableTheming="True" Height="18px" meta:resourcekey="txtBirthDateResource1" NullDateLabel="" Style="font-family: Tahoma; font-size: 8pt; font-weight: Normal; color: Black; border: solid 1px #CCCCCC; text-align: right;"
                                                                    Value="" Width="150px">
                                                ...
                                                <td style="width: 47%; height: 16px; vertical-align: top">
                                                    <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                        <tr>
                                                            <td class="SeparArea"></td>
                                                            <td class="LabelArea">
                                                                <asp:Label ID="Label3" runat="server" SkinID="Label_DefaultNormal" Text="الى تاريخ" meta:resourcekey="ToDateResource1"></asp:Label>
                                                            </td>
                                                            <td class="DataArea">
                                                                <igsch:WebDateChooser ID="EndDate" runat="server" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" EnableTheming="True" Height="18px" meta:resourcekey="txtBirthDateResource1" NullDateLabel="" Style="font-family: Tahoma; font-size: 8pt; font-weight: Normal; color: Black; border: solid 1px #CCCCCC; text-align: right;"
                                                                    Value="" Width="150px">
                                                                </igsch:WebDateChooser>
                                                            </td>
                                                        </tr>
                                                ...
                                                <td style="width: 47%; height: 16px; vertical-align: top">
                                                    <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                        <tr>
                                                            <td class="SeparArea"></td>
                                                            <td class="LabelArea">
                                                                <asp:Label ID="AttCustomizeOptsLabel" runat="server" SkinID="Label_DefaultNormal" Text="Customization Options" meta:resourcekey="AttCustomizeOptsLabelResource"></asp:Label>
                                                            </td>
                                                            <td class="DataArea">
                                                                <asp:RadioButton ID="EmployeeRadioButton" runat="server" Text="By Employee" GroupName="options" AutoPostBack="true" 
                                                                    Checked="true" meta:resourcekey="EmployeeRadioButtonResource" Style="font-size: small" OnCheckedChanged="AttCustomizeOpts_CheckedChanged" />
                                                                <asp:RadioButton ID="PlanRadioButton" runat="server" Text="By Plan" GroupName="options"  AutoPostBack="true" 
                                                                    meta:resourcekey="PlanRadioButtonResource" Style="font-size: small" OnCheckedChanged="AttCustomizeOpts_CheckedChanged"/>
                                                            </td>
                                                    </table>
                                                </td>
                                                <td style="width: 6%; height: 16px; vertical-align: top"></td>
                                                ...
                                                <td style="width: 47%; height: 16px; vertical-align: top">
                                                    <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                        <tr>
                                                            <td class="SeparArea"></td>
                                                            <td class="LabelArea">
                                                                <asp:Label ID="EmployeeCodeLabel" runat="server" Text="الكود" SkinID="Label_DefaultNormal"
                                                                    meta:resourcekey="EmployeeCodeLabelResource"></asp:Label>
                                                                <asp:Label ID="Label5" runat="server" Text="*" Style="color: #FF0000" meta:resourcekey="Label_Star1Resource1"></asp:Label>
                                                            </td>
                                                            <td class="DataAreawithsearch">
                                                                <asp:TextBox ID="EmployeeCodeTextBox" runat="server" SkinID="TextBox_SmalltNormalC" MaxLength="30"
                                                                    AutoPostBack="True" meta:resourcekey="txtCodeResource1"></asp:TextBox>
                                                            </td>
                                                            <td class="search">
                                                                <igtxt:WebImageButton ID="EmployeeCodeImageButton" runat="server" AutoSubmit="False" Height="18px"
                                                                    Overflow="NoWordWrap" UseBrowserDefaults="False" Width="24px" meta:resourcekey="btnSearchCodeResource1">
                                                                    <Alignments TextImage="ImageBottom" />
                                                                    <Appearance>
                                                                        <Image Url="./Img/forum_search.gif" />
                                                ...
                                                <td style="width: 47%; height: 16px; vertical-align: top">
                                                    <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                        <tr>
                                                            <td class="SeparArea"></td>
                                                            <td class="LabelArea">
                                                                <asp:Label ID="AttendanceClassLabel" runat="server" SkinID="Label_DefaultNormal" Text="فئة الموظفين" meta:resourcekey="lblAttendanceClassResource1"></asp:Label>
                                                            </td>
                                                            <td class="DataArea">
                                                ...
                                                <td style="width: 47%; height: 16px; vertical-align: top">
                                                    <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                        <tr>
                                                            <td class="SeparArea"></td>
                                                            <td class="LabelArea">
                                                                <asp:Label ID="EmpEngNameLabel" runat="server" Text="الاسم إنجليزى" SkinID="Label_DefaultNormal"
                                                                    meta:resourcekey="EmpEngNameLabelResource"></asp:Label>
                                                            </td>
                                                            <td class="DataArea">
                                                                <asp:TextBox ID="EmpEngNameTextBox" runat="server" SkinID="TextBox_LargeNormalltr" MaxLength="255"
                                                                    meta:resourcekey="txtEngNameResource1"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                ...
                                                <td style="width: 47%; height: 16px; vertical-align: top">
                                                    <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                        <tr>
                                                            <td class="SeparArea"></td>
                                                            <td class="LabelArea">
                                                                <asp:Label ID="EmpArbNameLabel" runat="server" Text="الاسم عربي" SkinID="Label_DefaultNormal"
                                                                    meta:resourcekey="EmpArbNameLabelResource"></asp:Label>
                                                            </td>
                                                            <td class="DataArea">
                                                                <asp:TextBox ID="EmpArbNameTextBox" runat="server" SkinID="TextBox_LargeNormalltr" MaxLength="255"
                                                                    meta:resourcekey="txtEngNameResource1"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    ...
                                                    <table style="width: 100%; height: 30px; vertical-align: bottom; border-bottom: 1px solid black"
                                                        ...
                                                        <tr>
                                                            <td style="vertical-align: bottom" class="style1">
                                                                <asp:Label ID="Label_Title1" runat="server" Text="الرجاء تعريف الدوام لكل يوم من أيام الإسبوع"
                                            ...
                                            <tr>
                                                <td style="height: 16px; vertical-align: top" colspan="3">
                                                    <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                        <tr>
                                                            <td>
                                                                <igtbl:UltraWebGrid  Browser="UpLevel"   ID="uwgEmployeesClassesCalenderSetCustomizeDays" runat="server" EnableAppStyling="True"
                                                                    Height="230px" meta:resourcekey="uwgForNationalityResource1" SkinID="Default"
                                                                    Width="100%">
                                                                    <DisplayLayout AllowColSizingDefault="Free" AllowColumnMovingDefault="OnServer" AllowSortingDefault="OnClient"
                                                                        ...
                                                                        HeaderClickActionDefault="SortSingle" Name="uwgAttendShiftsDays" RowHeightDefault="18px"
                                                                        ...
                                                                        <FrameStyle BackColor="Window" BorderColor="InactiveCaption" BorderStyle="Solid"
                                                                            BorderWidth="1px" Font-Names="Microsoft Sans Serif" Font-Size="8.25pt" Height="230px"
                                                                            Width="100%">
                                                                        </FrameStyle>
                                                                    ...
                                                                    <Bands>
                                                                        <igtbl:UltraGridBand meta:resourcekey="UltraGridBandResource1" AllowAdd="Yes">
                                                                            ...
                                                                            <Columns>
                                                                                ...
                                                                                <igtbl:UltraGridColumn BaseColumnName="DayNo" Key="DayNo" DataType="System.Int32" meta:resourcekey="DayNameResource1"
                                                                                    ...
                                                                                    <ValueList>
                                                                                        <ValueListItems>
                                                                                            <igtbl:ValueListItem DataValue="1" DisplayText="السبت" Key="1" meta:resourcekey="Day1NameResource1" />
                                                                                            <igtbl:ValueListItem DataValue="2" DisplayText="الأحد" Key="2" meta:resourcekey="Day2NameResource1" />
                                                                                            <igtbl:ValueListItem DataValue="3" DisplayText="الإثنين" Key="3" meta:resourcekey="Day3NameResource1" />
                                                                                            <igtbl:ValueListItem DataValue="4" DisplayText="الثلاثاء" Key="4" meta:resourcekey="Day4NameResource1" />
                                                                                            <igtbl:ValueListItem DataValue="5" DisplayText="الأربعاء" Key="5" meta:resourcekey="Day5NameResource1" />
                                                                                            <igtbl:ValueListItem DataValue="6" DisplayText="الخميس" Key="6" meta:resourcekey="Day6NameResource1" />
                                                                                            <igtbl:ValueListItem DataValue="7" DisplayText="الجمعة" Key="7" meta:resourcekey="Day7NameResource1" />
                                                                                        </ValueListItems>
                                                                                    </ValueList>
                                                                                ...
                                                                                <igtbl:UltraGridColumn BaseColumnName="TimeIn1" Key="TimeIn1" Width="15%" EditorControlID="WebDateTimeEdit1" meta:resourcekey="TimeIn1Resource1"
                                                                                    Type="Custom">
                                                                                ...
                                                                                <igtbl:UltraGridColumn Width="15%" BaseColumnName="TimeOut1" Key="TimeOut1" EditorControlID="WebDateTimeEdit1" meta:resourcekey="TimeOut1Resource1"
                                                                                    Type="Custom">
                                                                                ...
                                                                                <igtbl:UltraGridColumn Width="15%" BaseColumnName="FirstShiftTimeInFingerprintStart" Key="FirstShiftTimeInFingerprintStart" EditorControlID="WebDateTimeEdit1" meta:resourcekey="shiftFingerprintStartResource"
                                                                                    Type="Custom">
                                                                                    <Header Caption="بداية عمل البصمة">
                                                                                        <RowLayoutColumnInfo OriginX="2" />
                                                                                    </Header>
                                                                                    <CellStyle HorizontalAlign="Center">
                                                                                    </CellStyle>
                                                                                ...
                                                                                <igtbl:UltraGridColumn Width="15%" BaseColumnName="FirstShiftEntryTimeInClose" Key="FirstShiftEntryTimeInClose" EditorControlID="WebDateTimeEdit1" meta:resourcekey="shiftEntryTimeInCloseResource"
                                                                                    Type="Custom">
                                                                                    <Header Caption="نهايةالدخول">
                                                                                        <RowLayoutColumnInfo OriginX="2" />
                                                                                    </Header>
                                                                                    <CellStyle HorizontalAlign="Center">
                                                                                    </CellStyle>
                                                                                ...
                                                                                <igtbl:UltraGridColumn Width="15%" BaseColumnName="FirstShiftTimeOutFingerprintClose" Key="FirstShiftTimeOutFingerprintClose" EditorControlID="WebDateTimeEdit1" meta:resourcekey="shiftFingerprintEndResource"
                                                                                    Type="Custom">
                                                                                    <Header Caption="نهاية عمل البصمة">
                                                                                        <RowLayoutColumnInfo OriginX="2" />
                                                                                    </Header>
                                                                                    <CellStyle HorizontalAlign="Center">
                                                                                    </CellStyle>
                                                                                ...
                                                                                <igtbl:UltraGridColumn BaseColumnName="TimeIn2" Key="TimeIn2" Width="15%" EditorControlID="WebDateTimeEdit1" meta:resourcekey="TimeIn2Resource1"
                                                                                    Type="Custom">
                                                                                    <Header Caption="الدوام من">
                                                                                        <RowLayoutColumnInfo OriginX="3" />
                                                                                    </Header>
                                                                                ...
                                                                                <igtbl:UltraGridColumn Width="15%" BaseColumnName="TimeOut2" Key="TimeOut2" EditorControlID="WebDateTimeEdit1" meta:resourcekey="TimeOut2Resource1"
                                                                                    Type="Custom">
                                                                                    <Header Caption="الدوام إلى">
                                                                                        <RowLayoutColumnInfo OriginX="2" />
                                                                                    </Header>
                                                                                ...
                                                                                <igtbl:UltraGridColumn Width="15%" BaseColumnName="SecondShiftTimeInFingerprintStart" Key="SecondShiftTimeInFingerprintStart" EditorControlID="WebDateTimeEdit1" meta:resourcekey="shiftFingerprintStartResource"
                                                                                    Type="Custom">
                                                                                    <Header Caption="بداية عمل البصمة">
                                                                                        <RowLayoutColumnInfo OriginX="2" />
                                                                                    </Header>
                                                                                ...
                                                                                <igtbl:UltraGridColumn Width="15%" BaseColumnName="SecondShiftEntryTimeInClose" Key="SecondShiftEntryTimeInClose" EditorControlID="WebDateTimeEdit1" meta:resourcekey="shiftEntryTimeInCloseResource"
                                                                                    Type="Custom">
                                                                                    <Header Caption="نهايةالدخول">
                                                                                        <RowLayoutColumnInfo OriginX="2" />
                                                                                    </Header>
                                                                                ...
                                                                                <igtbl:UltraGridColumn Width="15%" BaseColumnName="SecondShiftTimeOutFingerprintClose" Key="SecondShiftTimeOutFingerprintClose" EditorControlID="WebDateTimeEdit1" meta:resourcekey="shiftFingerprintEndResource"
                                                                                    Type="Custom">
                                                                                    <Header Caption="نهاية عمل البصمة">
                                                                                        <RowLayoutColumnInfo OriginX="2" />
                                                                                    </Header>
                                                                                ...
                                                                                <igtbl:UltraGridColumn BaseColumnName="IsDayOff" DataType="System.Boolean" Key="IsDayOff" meta:resourcekey="IsDayOfResource1"
