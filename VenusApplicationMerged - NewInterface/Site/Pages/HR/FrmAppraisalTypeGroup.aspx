<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmAppraisalTypeGroup.aspx.vb" Inherits="frmProfession"
...
<%--                                                            <asp:Label ID="Label_Star1" runat="server" Text="*" Style="color: #FF0000" meta:resourcekey="lblCodeResource1"></asp:Label>--%>
                                                        </td>
                                        ...
                                        <tr>
                                            <td style="width: 100%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        <td>
                                                                                                       <igtbl:UltraWebGrid  Browser="UpLevel"  ID="uwgAppTypeGroups" runat="server" EnableAppStyling="False"
    ...
    <Bands>
        <igtbl:UltraGridBand meta:resourcekey="UltraGridBandResource1">
            ...
            <Columns>
                                                            ...
                                                            <igtbl:UltraGridColumn BaseColumnName="ID" DataType="System.Int32" Hidden="True" AllowUpdate="No"
                                          Key="ID" meta:resourcekey="CriteriaGroupIDResource1"  >
 
                                          <Header Caption="ID">
                                          </Header>
                                      </igtbl:UltraGridColumn>
                
                                  <igtbl:UltraGridColumn BaseColumnName="Code" DataType="System.Int32"   AllowUpdate="No"
                                      Key="Code" meta:resourcekey="CodeResource1"  >
                                  ...
                                  <igtbl:UltraGridColumn BaseColumnName="EngName" DataType="System.Int32"   AllowUpdate="No"
                                      Key="EngName" meta:resourcekey="EngNameResource1"  >
                                  ...
                                  <igtbl:UltraGridColumn BaseColumnName="ArbName" DataType="System.string"   AllowUpdate="No"
                                      Key="ArbName" meta:resourcekey="EngNameResource1"  >
 
                                      <Header Caption="ArbName">
                                      </Header>
                                  </igtbl:UltraGridColumn>
                                                                <igtbl:UltraGridColumn BaseColumnName="IsOneTimeOnly" DataType="System.Int32"   AllowUpdate="No"
                                              Key="IsOneTimeOnly" meta:resourcekey="CriteriaCodeResource1" type="CheckBox" >
 
                                              <Header Caption="IsOneTimeOnly">
                                              </Header>
                                          </igtbl:UltraGridColumn>
                
                                     <igtbl:UltraGridColumn BaseColumnName="OneTimePeriod" DataType="System.String" AllowUpdate="No"
                                        Key="OneTimePeriod" meta:resourcekey="OneTimePeriodColumnResource4"
                                        Width="10%">
                                        <Header Caption="One Time Period">
                                      ...
                                      <igtbl:UltraGridColumn BaseColumnName="AppraisalFrequency" DataType="System.Int32"   AllowUpdate="No"
    Key="AppraisalFrequency" meta:resourcekey="AppraisalFrequencyResource1">
 
    <Header Caption="AppraisalFrequency">
    </Header>
</igtbl:UltraGridColumn>

                
                                      <igtbl:UltraGridColumn BaseColumnName="NotificationPeriod" DataType="System.Int32"   AllowUpdate="No"
    Key="NotificationPeriod" meta:resourcekey="AppraisalFrequencyResource1">
 
    <Header Caption="Notification Period">
    </Header>
</igtbl:UltraGridColumn>
