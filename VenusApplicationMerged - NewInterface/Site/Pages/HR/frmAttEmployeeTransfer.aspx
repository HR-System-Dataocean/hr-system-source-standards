<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmAttEmployeeTransfer.aspx.vb"
    Inherits="frmAttEmployeeTransfer" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
...
<body style="margin: 0; padding: 0;">
    <form id="frmAttEmployeeTransfer" runat="server" >
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="labelDescEnglishName0" runat="server" meta:resourcekey="labelDescArabicNameResource1" SkinID="Label_DefaultNormal" Text="اسم الموظف  عربي" Width="90px"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="txtArbName" runat="server" MaxLength="255" meta:resourcekey="labelDescArabicNameResource1" ReadOnly="True" SkinID="TextBox_LargeNormalC" TabIndex="1"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                      ...
                                      <%--  <tr>
                                                ...
                                                <table cellspacing="6" style="width: 100%; height: 30px; vertical-align: bottom;
                                                    ...
                                                    <tr>
                                                        <td style="vertical-align: bottom">
                                                            <asp:Label ID="Label2" runat="server" meta:resourcekey="Label_Title2Resource3" SkinID="Label_DefaultBold"
                                        ...
                                        <tr>
                                            <td style="height: 100%" colspan="3">
                                                ...
                                                <igtbl:UltraWebGrid  Browser="UpLevel"   ID="uwgWorkPlans" runat="server"
                                                    EnableAppStyling="True" Height="150px" 
                                                    ...
                                                    SkinID="Default"   Width="99%">
                                                        <DisplayLayout AllowColSizingDefault="Free"
                                                            ...
                                                            Name="uwgEmployeeVacations" RowHeightDefault="15px"
                                                        ...
                                                        <Bands>
                                                           <igtbl:UltraGridBand AllowSorting="Yes">
                                                               <Columns>
                                                                ...
                                                                <igtbl:UltraGridColumn BaseColumnName="ArbName" Key="ArbName" width="34%"  meta:resourcekey="lblShiftPlanResource1" >
                                                                ...
                                                                <igtbl:UltraGridColumn BaseColumnName="FromDate" DataType="System.DateTime"
                                                                    Format="dd/MM/yyyy" Key="FromDate" meta:resourcekey="lblFromDateRegResource1"
                                                                    Width="33%" >
                                                                    <CellStyle HorizontalAlign="Center">
                                                                    </CellStyle>
                                                                ...
                                                                <igtbl:UltraGridColumn BaseColumnName="ToDate" DataType="System.DateTime"
                                                                    Format="dd/MM/yyyy" Key="ToDate" meta:resourcekey="lblToDateRegResource1"
                                                                    Width="33%">
                                                                    <CellStyle HorizontalAlign="Center">
                                                                    </CellStyle>
