<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmEmployeesHmsCommissionCategory.aspx.vb" Inherits="frmGrades"
        ...
        function OnSucceeded(result, userContext, methodName) {
            if (methodName == 'GetEmpName') {
                if (result != '') {
                    ...
                    var cellNext = Row.getCellFromKey("CommissionPc");
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                           <asp:CheckBox ID="ChkIsLineCommission"   runat="server" Text ="النسبة على مستوى الموظف؟" TextAlign="Left" AutoPostBack="True" /> 
                                                        </td>
                                                        <td class="DataArea">
                                                ...
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            ...
                                                            <asp:Label ID="lblTotalCommission" runat="server" meta:resourcekey="lblRegularHoursResource1" SkinID="Label_DefaultNormal" Text=" النسبة على مستوى الفئة"></asp:Label>
                                                            
                                                        </td>
                                                        <td class="DataArea">
                                                            
                                                            <igtxt:WebNumericEdit ID="txtTotalCommission" runat="server" MaxValue="24" meta:resourcekey="txtRegularHoursResource1" MinValue="0" NullText="0" SkinID="WebNumericEdit_Fix">
                                                    ...
                                                    <Bands>
                                                        <igtbl:UltraGridBand meta:resourcekey="UltraGridBandResource4"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <igtbl:UltraGridColumn   Key="DoctorCode"
                                                                    Type="Custom" Width="10%" BaseColumnName="DoctorCode" meta:resourcekey="UltraGridColumnResource3">
                                                                    <Header Caption="Doctor Code">
                                                                       
                                                                    </Header>
                                                                      
                                                                </igtbl:UltraGridColumn>

                                                                 <igtbl:UltraGridColumn BaseColumnName="EmployeeCode" 
                                                                    Key="EmployeeCode" Width="20%" meta:resourcekey="UltraGridColumnResource115">
                                                                 ...
                                                                 <igtbl:UltraGridColumn BaseColumnName="FullName" AllowUpdate="No" 
                                                                    Key="FullName" Width="50%" meta:resourcekey="UltraGridColumnResource115">
                                                                    <Header Caption="FullName">
                                                                  ...
                                                                  <igtbl:UltraGridColumn BaseColumnName="CommissionPc" 
                                                                       Key="CommissionPc" Width="17%" 
                                                                 ...
                                                                 <igtbl:UltraGridColumn BaseColumnName="ID" Hidden="true"
                                                                    ...
                                                                    <igtbl:UltraGridColumn Key="btnDel" Width="2%" Type="Button" CellButtonDisplay="Always"
