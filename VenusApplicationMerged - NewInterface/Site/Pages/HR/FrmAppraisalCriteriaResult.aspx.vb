...
#Region "Protected Sub"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim CriteriaID As Integer = Request.QueryString.Item("CriteriaID")
    ...
    Private Sub FillAppraisalCriteria()
        ...
        Try
            ...
            If ProfileCls.CurrentLanguage = "Ar" Then
                ...
                Position = " dbo.hrs_Positions.ArbName "
                Department = " sys_Departments.ArbName "
                EvaluatorName = " dbo.fn_GetEmpName(Hrs_Employees.code,1)  "
            ...
            Else
                ...
                Position = " dbo.hrs_Positions.EngName "
                Department = " sys_Departments.EngName "
                EvaluatorName = " dbo.fn_GetEmpName(Hrs_Employees.code,0)  "
            End If
            ...
            connection2 = New Data.SqlClient.SqlConnection(connetionString2)
            Dim strselect As String
            strselect = "  SELECT    " & EvaluatorName & " as EvaluatorName, dbo.App_AppraisalResult.App_EmployeeID, dbo.App_AppraisalResult.CriteriaID,  " & CriteriaName & "  as Criteria , dbo.APP_AppraisalCriterias.MinimumScore, dbo.APP_AppraisalCriterias.MaximumScore,dbo.App_AppraisalResult.Score AS Result,dbo.APP_AppraisalCriterias.Weight,dbo.App_AppraisalResult.NotificationID,  dbo.App_AppraisalNotifications.ConfigurationID,dbo.App_AppraisalConfigurations.StageWeight, (dbo.App_AppraisalResult.Score / dbo.APP_AppraisalCriterias.MaximumScore)*100 AS EvalCriteriaScore,CAST(dbo.App_AppraisalResult.Score AS FLOAT) / dbo.APP_AppraisalCriterias.MaximumScore * dbo.App_AppraisalConfigurations.StageWeight / 100 AS StageScore ,App_AppraisalResult.Remarks FROM     dbo.App_AppraisalResult INNER JOIN dbo.App_Criteria ON dbo.App_AppraisalResult.CriteriaID = dbo.App_Criteria.ID INNER JOIN dbo.APP_AppraisalCriterias ON dbo.APP_AppraisalCriterias.CriteriaID = dbo.App_Criteria.ID and APP_AppraisalCriterias.AppraisalID=App_AppraisalResult.AppraisalID INNER JOIN dbo.App_AppraisalNotifications ON dbo.App_AppraisalResult.NotificationID = dbo.App_AppraisalNotifications.ID INNER JOIN dbo.App_AppraisalConfigurations ON dbo.App_AppraisalConfigurations.ID = dbo.App_AppraisalNotifications.ConfigurationID INNER JOIN dbo.hrs_Employees ON dbo.App_AppraisalResult.App_EmployeeID = dbo.hrs_Employees.ID GROUP BY dbo.App_Criteria.ArbName, dbo.APP_AppraisalCriterias.MinimumScore, dbo.APP_AppraisalCriterias.MaximumScore, dbo.APP_AppraisalCriterias.Weight, dbo.App_AppraisalResult.NotificationID, dbo.App_AppraisalNotifications.ConfigurationID, dbo.App_AppraisalResult.App_EmployeeID, dbo.App_AppraisalConfigurations.StageWeight, dbo.App_AppraisalResult.Score / dbo.APP_AppraisalCriterias.MaximumScore, CAST(dbo.App_AppraisalResult.Score AS FLOAT) / dbo.APP_AppraisalCriterias.MaximumScore * dbo.App_AppraisalConfigurations.StageWeight / 100, CAST(dbo.App_AppraisalResult.Score AS FLOAT) / dbo.APP_AppraisalCriterias.MaximumScore * dbo.App_AppraisalConfigurations.StageWeight / 100 * dbo.APP_AppraisalCriterias.Weight / 100, dbo.App_AppraisalResult.AppraisalID, dbo.App_AppraisalResult.EmployeeID, dbo.App_AppraisalResult.CriteriaID, dbo.hrs_Employees.Code, dbo.hrs_Employees.EngName ,App_AppraisalResult.ID,App_AppraisalResult.AppraisalID ,dbo.App_AppraisalResult.Score ,App_AppraisalResult.Remarks,dbo.App_Criteria.EngName "
            strselect &= " Having App_AppraisalResult.AppraisalID=" & AppraisalID & " And  App_AppraisalResult.EmployeeID= " & EmployeeID & " And App_AppraisalResult.CriteriaID=" & CriteriaID & ""
            command2 = New Data.SqlClient.SqlCommand(strselect, connection2)
            adapter2.SelectCommand = command2
            adapter2.Fill(DS2, "Table1")
            adapter2.Dispose()
    ...
    Protected Sub btnSave_Click(sender As Object, e As Infragistics.WebUI.WebDataInput.ButtonEventArgs) Handles btnSave.Click
        ...
        If SaveDG() Then
            UpdateCommand = "update App_AppraisalNotifications set Completed=1,RegDate=GetDate() where id=" & NotificationID & "  and EmployeeID=" & EmployeeID & ""
            ...
            If DSConfig.Tables(0).Rows.Count > 0 Then
                ...
                For Each row In DSConfig.Tables(0).Rows
                    If row("UserTypeID") = 1 Then  'مدير مباشر
                        ...
                        If DsEmployees.Rows.Count > 0 Then
                            For Each Erow In DsEmployees.Rows
                                strNotification = "INSERT INTO [dbo].[App_AppraisalNotifications] ([AppraisalID],[APP_EmployeeID],[EmployeeID],[ConfigurationLevel] )Values(" & AppraisalID & "," & Erow("ManagerID") & "," & Erow("EmployeeID") & "," & row("Rank") & ")"
                    ...
                    If row("UserTypeID") = 2 Then  'درجة وظيفية
                        ...
                        If DsEmployeesInPosition.Rows.Count > 0 Then
                            For Each Erow In DsEmployeesInPosition.Rows
                                ...
                                strNotification = "INSERT INTO [dbo].[App_AppraisalNotifications] ([AppraisalID],[APP_EmployeeID],[EmployeeID],[ConfigurationLevel] )Values(" & AppraisalID & "," & Erow("EmployeeID") & "," & EmployeeID & "," & row("Rank") & ")"
                    ...
                    If row("UserTypeID") = 3 Then   'موظف
                        DsAppraisalEmployees = GetAppraisalEmployees(AppraisalID)
                        For Each AppRow In DsAppraisalEmployees.Rows
                            strNotification = "INSERT INTO [dbo].[App_AppraisalNotifications] ([AppraisalID],[APP_EmployeeID],[EmployeeID],[ConfigurationLevel] )Values(" & AppraisalID & "," & row("EmployeeID") & "," & AppRow("EmployeeID") & "," & row("Rank") & ")"
                            Microsoft.ApplicationBlocks.Data.SqlHelper.ExecuteNonQuery(ConnectionString, Data.CommandType.Text, strNotification)
                        Next
                    End If
                Next
