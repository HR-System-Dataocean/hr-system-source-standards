<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmAnnualVacationRequestAction.aspx.vb"
...
<%--                                                         <td style="width: 40px; text-align: center;">
     <igtxt:WebImageButton ID="BtnShowAttachment" runat="server" AutoPostBack="True" Height="18px"
         Overflow="NoWordWrap" UseBrowserDefaults="False" Width="24px" meta:resourcekey="btnDeleteResource1">
         <Alignments TextImage="ImageBottom" />
         <Appearance>
             <Image Url="~/Common/Images/MsgL.png" />
         </Appearance>
     </igtxt:WebImageButton>
 </td>--%>
                                                        <td style="width: 40px; text-align: center;">
                                                ...
                                                <table cellspacing="6" style="width: 100%; height: 30px; vertical-align: bottom;
                                                    ...
                                                    <tr>
                                                        <td style="vertical-align: bottom">
                                                            <asp:Label ID="Label4" runat="server" meta:resourcekey="Label_Title1Resource2" SkinID="Label_DefaultBold"
                                                                Text="تفاصيل الاجراء"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="label5" runat="server" Width="90px" SkinID="Label_DefaultBold"
                                                                Text="عدد الايام المعتمد" meta:resourcekey="labelConfirmedDaysResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="txtConfirmedDays" runat="server" SkinID="TextBox_SmalltNormalc" meta:resourcekey="lbTotalValResource1"
                                                               AutoPostBack="false" TabIndex="40" ReadOnly="False"></asp:TextBox>
                                                            <asp:Label ID="Label6" runat="server" meta:resourcekey="lblRegDateValueResource1"
                                                     ...
                                                     <tr>
                                                      ...
                                                      <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="label7" runat="server" Width="60px" SkinID="Label_DefaultBold"
                                                                Text="ملاحظات" meta:resourcekey="labelRemarksResource1"></asp:Label>
                                                        </td>


                                                        <td class="DataArea">
                                                            <asp:TextBox ID="txtActionRemarks" runat="server" SkinID="TextBox_LargeNormalC"
                                                                ReadOnly="false" MaxLength="255" meta:resourcekey="lblDescEnglishNameResource1"
        ...
        <td class="DataArea">
            <asp:TextBox ID="txtRequestType" runat="server" SkinID="TextBox_SmalltNormalC" MaxLength="30"
                AutoPostBack="True" meta:resourcekey="txtRequestTypeResource1">
           </asp:TextBox>
        </td>
                                        ...
                                        <tr>
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table cellspacing="6" style="width: 100%; height: 10px; vertical-align: bottom;
                                                    ...
                                                    <tr>
                                                        <td style="vertical-align: bottom">
                                                            <asp:Label ID="Label1" runat="server" meta:resourcekey="LblDetailsResource2" SkinID="Label_DefaultBold"
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="txtTotalVal" runat="server" SkinID="TextBox_SmalltNormalc" meta:resourcekey="lbTotalValResource1"
                                                ...
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                       <%-- <td class="SeparArea">
                                                        ...
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="txtStartDate" runat="server" BorderColor="#CCCCCC" BorderStyle="Solid"
                                                                BorderWidth="1px" Height="18px" NullDateLabel="" Style="font-family: Tahoma;
                                                                font-size: 8pt; font-weight: Normal; color: Black; border: solid 1px #CCCCCC"
                                                                Width="130px">
                                                            </asp:TextBox>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="labelRemainVal" runat="server" Width="90px" SkinID="Label_DefaultNormal"
                                                                Text="ايام الاجازة" meta:resourcekey="lblNoOfDaysResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="txtRemainVal" runat="server" SkinID="TextBox_SmalltNormalc" meta:resourcekey="lbRemainValResource1"
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="DataArea">
                                                            <Asp:textbox ID="txtEndDate" runat="server" BorderColor="#CCCCCC" BorderStyle="Solid"
                                                                BorderWidth="1px" Height="18px" NullDateLabel="" Style="font-family: Tahoma;
                                                                font-size: 8pt; font-weight: Normal; color: Black; border: solid 1px #CCCCCC"
                                                                Width="130px">
                                                            </Asp:textbox>
                                            ...
                                            <tr>
                                                    ...
                                                    <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td class="LabelArea">
                                                                <asp:Label ID="lblWebDateChooser3" runat="server" Width="90px" meta:resourcekey="lblAlternativeResource1"
                                                                    SkinID="Label_DefaultNormal" Text="الموظف البديل"></asp:Label>
                                                            </td>
                                                               <td>
                  <asp:TextBox ID="txtAlternativeUser" Width="50px" runat="server"  MaxLength="15"
...
<td>
 <asp:TextBox ID="TxtAlternativeEmpName" Width="160px" runat="server"  MaxLength="100"
        AutoPostBack="false"  meta:resourcekey="txtEmployeeResource1">
                                                            ...
                                                            <%--<td class="DataArea">
                                                                <asp:TextBox ID="TxtAlternativeUser" runat="server" SkinID="TextBox_SmalltNormalc" meta:resourcekey="lbConsumeValResource1"
                                                                    TabIndex="6" AutoPostBack="True"></asp:TextBox>
                                                            </td>--%>
                                                        </tr>
                                                    </table>
    ...
    <asp:Label ID="LblRemarks" runat="server" Width="90px" SkinID="Label_DefaultNormal"
        Text="ملاحظات " meta:resourcekey="lblLblRemarksResource1"></asp:Label>
                    ...
                    <td class="DataArea">
        <asp:TextBox ID="TxtRemarks" runat="server" Width="450"  meta:resourcekey="LblRemarksResource1"
