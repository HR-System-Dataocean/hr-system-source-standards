<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmFiscalYearsPeriodsObjects.aspx.vb"
    Inherits="frmFiscalYearsPeriodsObjects" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
...
<head runat="server">
    <title>* Venus Payroll * ~Fiscal Years Periods Objects</title>
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmFiscalYearsPeriodsObjects" runat="server">
                                    ...
                                    <table style="width: 100%; height: 100%; min-height: 350px; vertical-align: top"
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="ddlObjects" runat="server" Visible="False">
                                                            </asp:DropDownList>
                                        ...
                                        <tr>
                                            <td style="width: 100%; vertical-align: top" colspan="3">
                                                <igtbl:UltraWebGrid    Browser="UpLevel"  ID="uwgData" runat="server" EnableAppStyling="False" Height="280px"
