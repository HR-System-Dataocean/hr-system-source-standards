<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmForms.aspx.vb" Inherits="frmForms"
...
<head runat="server">
    <title>* Venus Payroll * ~Forms</title>
    <script src="Scripts/App_JScript.js" type="text/javascript"></script>
    <script src="Scripts/App_JScript_M.js" type="text/javascript"></script>
    <script src="Scripts/App_OtherFields_JScript.js" type="text/javascript"></script>
    <script src="Scripts/App_Search_JScript.js" type="text/javascript"></script>
    <script src="Scripts/App_JScript_PayRoll.js" type="text/javascript"></script>
    <script src="Scripts/App_JScript_frmForms.js" type="text/javascript"></script>
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    ...
    <div style="display: none">
        ...
        <asp:TextBox ID="txtArbName" runat="server" SkinID="TextBox_LargeNormalltr" MaxLength="255"
                                ...
                                <ContentTemplate>
                                    <table style="width: 100%; height: 100%; min-height: 350px; vertical-align: top"
                                        ...
                                        <tr>
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblEngName" runat="server" Text="اسم النموذج" meta:resourcekey="lblfrmNameResource1"
                                                                SkinID="Label_DefaultNormal"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="txtEngName" runat="server" SkinID="TextBox_LargeNormalltr" meta:resourcekey="txtfrmNameResource1"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblRank" runat="server" SkinID="Label_DefaultNormal" Text="الترتيب"
                                                                meta:resourcekey="lblRankResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <igtxt:WebNumericEdit ID="txtRank" runat="server" SkinID="WebNumericEdit_Default"
                                                                MaxValue="999" MinValue="0" NullText="0" meta:resourcekey="txtRankResource1">
                                            ...
                                            <td>
                                                <asp:Label ID="Label7" runat="server" Width="5px" Text=" " meta:resourcekey="Label7Resource1"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblEngDescription" runat="server" Text="التوصيف إنجليزى" SkinID="Label_DefaultNormal"
                                                                meta:resourcekey="lblEngNameResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="txtEngDescription" runat="server" SkinID="TextBox_LargeNormalltr"
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblHeight" runat="server" SkinID="Label_DefaultNormal" Text="الارتفاع"
                                                                meta:resourcekey="lblHeightResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <igtxt:WebNumericEdit ID="txtHeight" runat="server" MaxValue="9999" MinValue="0"
                                                                NullText="0" SkinID="WebNumericEdit_Default" meta:resourcekey="txtHeightResource1">
                                                            </igtxt:WebNumericEdit>
                                                        </td>
                                                    </tr>
                                                </table>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblArbDescription" runat="server" Text="التوصيف عربى" SkinID="Label_DefaultNormal"
                                                                meta:resourcekey="lblArbNameResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="txtArbDescription" runat="server" SkinID="TextBox_LargeNormalrtl"
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblWidth" runat="server" SkinID="Label_DefaultNormal" Text="العرض"
                                                                meta:resourcekey="lblWidthResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <igtxt:WebNumericEdit ID="txtWidth" runat="server" MaxValue="9999" MinValue="0" NullText="0"
                                                                SkinID="WebNumericEdit_Default" meta:resourcekey="txtWidthResource1">
                                                            </igtxt:WebNumericEdit>
                                                        </td>
                                                    </tr>
                                                </table>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblModule" runat="server" Text="تابع لبرنامج" SkinID="Label_DefaultNormal"
                                                                meta:resourcekey="lblModuleResource1"></asp:Label>
                                                            <asp:Label ID="Label_Star2" runat="server" meta:resourcekey="Label_Star1Resource1"
                                                                Style="color: #FF0000" Text="*"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="ddlModule" runat="server" SkinID="DropDownList_LargNormal"
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblForm" runat="server" SkinID="Label_DefaultNormal" Text="نموذج البحث"
                                                                meta:resourcekey="lblFormResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="ddlForm" runat="server" SkinID="DropDownList_LargNormal" meta:resourcekey="ddlFormResource1">
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                </table>
                                                ...
                                                <table style="width: 100%; height: 30px; vertical-align: bottom; border-bottom: 1px solid black"
                                                    ...
                                                    <tr>
                                                        <td style="vertical-align: bottom">
                                                            <asp:Label ID="Label_Title1" runat="server" Text="الرجاء اضافة الحقول للنماذج" SkinID="Label_DefaultBold"
                                        ...
                                        <tr>
                                            <td style="height: 16px; vertical-align: top" colspan="3">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        <td>
                                                            <igtbl:UltraWebGrid   Browser="UpLevel"   ID="uwgFormParameters" runat="server" EnableAppStyling="False"
                                                                Height="150px" Width="99%" SkinID="Default" meta:resourcekey="uwgFormParametersResource1">
                                                                <DisplayLayout AllowColSizingDefault="Free" AllowColumnMovingDefault="OnServer" AllowDeleteDefault="Yes"
                                                                    ...
                                                                    <ClientSideEvents AfterEnterEditModeHandler="uwgFormsParameters_AfterEnterEditModeHandler"
                                                                        AfterCellUpdateHandler="uwgFormsParameters_AfterCellUpdateHandler" BeforeCellChangeHandler="uwgFormsParameters_BeforeCellChangeHandler" />
                                                                </DisplayLayout>
                                                                <Bands>
                                                                    <igtbl:UltraGridBand meta:resourcekey="UltraGridBandResource1">
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <igtbl:UltraGridColumn BaseColumnName="FormID" DataType="System.Int32" Hidden="True"
                                                                                Key="FormID" meta:resourcekey="UltraGridColumnResource2">
                                                                                <Header Caption="FormID">
                                                                            ...
                                                                            <igtbl:UltraGridColumn BaseColumnName="ParamName" Type="Custom" EditorControlID="WteNames"
                                                                                Key="ParamName" Width="49%" meta:resourcekey="UltraGridColumnResource3">
                                                                            ...
                                                                            <igtbl:UltraGridColumn Type="Custom" EditorControlID="wteValues" BaseColumnName="ParamValue"
                                                                                Key="ParamValue" Width="49%" meta:resourcekey="UltraGridColumnResource4">
                                                                                <Header Caption="Parameter Value">
