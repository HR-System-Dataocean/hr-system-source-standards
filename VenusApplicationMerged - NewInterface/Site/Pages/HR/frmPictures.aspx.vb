...
#Region "Private Functions"
        ...
        Try
            ...
            With ClsObjectsAttachments
                ...
                If chkIsDefault.Checked Then
                    ClsObjectsAttachments.CLearDefaultPhoto(ObjectID, RecordID)
    ...
    Public Function GetValues(ByRef ClsObjectsAttachments As Clssys_ObjectsAttachments) As Boolean
        ...
        Try
            With ClsObjectsAttachments
                ...
                chkIsDefault.Checked = .IsProfilePicture
            End With
            Return True
        Catch ex As Exception
            Return False
    ...
    Private Function SavePart() As Boolean
        ...
        If txtAttached.FileName <> "" Then
            ClsObjectsAttachments.Find("  sys_ObjectsAttachments.ObjectID = " & ObjectID & " AND sys_ObjectsAttachments.RecordID = " & RecordID & " AND sys_ObjectsAttachments.FileName = '" & txtAttached.FileName & "'")
        ...
        Else
            ...
            Else
                ClsObjectsAttachments = New Clssys_ObjectsAttachments(Me.Page)
                ClsObjectsAttachments.Find(" sys_ObjectsAttachments.ID = " & Val(txtID.Value))
                With ClsObjectsAttachments
                    .ObjectID = ObjectID
                    .RecordID = RecordID
