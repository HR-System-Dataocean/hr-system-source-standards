<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmAppraisalCriteriaResult.aspx.vb"
...
<body style="height: 100%; margin: 0; padding: 0;">
            ...
            <tr>
                <td class="Details">
                    <igtab:UltraWebTab ID="UltraWebTab1" runat="server" EnableAppStyling="True" SkinID="Default"
                        ...
                        <Tabs>
                            <igtab:Tab Text="مراحل التقييم للمعيار" meta:resourcekey="TabResource1">
                                <ContentTemplate>
    ...
    <td style="height: 16px; vertical-align: top" colspan="3">
      ...
      <Header Caption="CriteriaID">
                                             ...
                                             <igtbl:UltraGridColumn BaseColumnName="Criteria" DataType="System.String"
                                                Key="Criteria" meta:resourcekey="CriteriaNameColumnResource4"
                                                Width="20%">
                           ...
                           <igtbl:UltraGridColumn BaseColumnName="EvaluatorName" DataType="System.String"
                                                  Key="EvaluatorName" meta:resourcekey="EvaluatorNameColumnResource4"
                                                  Width="20%">
        ...
        <Footer>
            <RowLayoutColumnInfo OriginX="3" />
                                       ...
                                       <igtbl:UltraGridColumn BaseColumnName="Result" AllowUpdate="Yes" DataType="System.Int32"
                                         ...
                                         <igtbl:UltraGridColumn AllowUpdate="Yes" BaseColumnName="Remarks" DataType="System.String"
                                             Key="Remarks" meta:resourcekey="AppraisalRemarksColumnResource4"
                                            Width="20%">
