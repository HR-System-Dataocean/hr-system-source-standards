<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmCities.aspx.vb" Inherits="frmCities"
...
<head runat="server">
    <title>* Venus Payroll * ~ Cities</title>
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmCities" runat="server">
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblRegion0" runat="server" SkinID="Label_DefaultNormal" Text="مفتاح هاتف البلد"
                                                                meta:resourcekey="lblRegion0Resource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <igtxt:WebMaskEdit ID="txtPhoneKey" runat="server" SkinID="TextBox_LargeNormalrtl"
                                                                Width="100%" InputMask="(###) ###-####" BorderStyle="Solid" BorderColor="White"
                                                                meta:resourcekey="txtPhoneKeyResource1">
                                                            </igtxt:WebMaskEdit>
                                                        </td>
                                                    </tr>
                                                </table>
