<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmRequestTypes.aspx.vb" Inherits="frmRequestTypes"
...
<head runat="server">
    <title>* Venus Payroll * ~Relegions</title>
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmRequestTypes" runat="server">
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
    <asp:Label ID="lblNoOfTimes" meta:resourcekey="lblNoOfTimesResource1" runat="server"
        SkinID="Label_DefaultNormal" Text="عدد المرات في الشهر"></asp:Label>
</td>
<td class="DataArea">
    <asp:TextBox ID="txtNoOfTimes" runat="server" SkinID="TextBox_SmalltNormalC" MaxLength="30"
    AutoPostBack="false" meta:resourcekey="txtCodeResource1"></asp:TextBox>
</td>
                                                    </tr>
                                                </table>
                                            </td>
      ...
      <td style="width: 47%; height: 16px; vertical-align: top">
          <table style="width: 100%; vertical-align: top" cellspacing="0">
              <tr>
                 ...
                 <td class="LabelArea">
    <asp:Label ID="lblTimesPeriodPerMonth" meta:resourcekey="lblTimesPeriodPerMonthResource1" runat="server"
        SkinID="Label_DefaultNormal" Text="المدة المسموحة خلال الشهر"></asp:Label>
</td>
<td class="DataArea">
     <asp:TextBox ID="txtTimesPeriodPerMonth" runat="server" SkinID="TextBox_SmalltNormalC" MaxLength="30"
 AutoPostBack="false" meta:resourcekey="txtCodeResource1"></asp:TextBox>
</td>
              </tr>
          </table>
      ...
      <td style="width: 47%; height: 16px; vertical-align: top">
          <table style="width: 100%; vertical-align: top" cellspacing="0">
              <tr>
                  ...
                  <td class="LabelArea">
    <asp:Label ID="lblAutoSerialAttach" meta:resourcekey="lblAutoSerialAttachResource1" runat="server"
        SkinID="Label_DefaultNormal" Text="التسلسل تلقائي بالمرفقات"></asp:Label>
</td>
<td class="DataArea">
    <asp:CheckBox ID="chkAutoSerialAttach" runat="server" AutoPostBack="True" />
</td>
              </tr>
          </table>
      </td>
      ...
      <td style="width: 47%; height: 16px; vertical-align: top">
          <table style="width: 100%; vertical-align: top" cellspacing="0">
              <tr>
                  ...
                  <td class="LabelArea">
    <asp:Label ID="lblRequiredAttach" meta:resourcekey="lblRequiredAttachResource1" runat="server"
        SkinID="Label_DefaultNormal" Text="المرفقات مطلوبة"></asp:Label>
</td>
<td class="DataArea">
    <asp:CheckBox ID="chkRequiredAttach" runat="server" AutoPostBack="True" />
</td>
              </tr>
          </table>
      </td>
      ...
      <td style="width: 47%; height: 16px; vertical-align: top">
          <table style="width: 100%; vertical-align: top" cellspacing="0">
              <tr>
                 ...
                 <td class="LabelArea">
    <asp:Label ID="lblIsPaidWithSalary" meta:resourcekey="lblIsPaidWithSalaryResource1" runat="server"
        SkinID="Label_DefaultNormal" Text="تدفع المستحقات مع الراتب"></asp:Label>
</td>
<td class="DataArea">
    <asp:CheckBox ID="chkIsPaidWithSalary" runat="server"  AutoPostBack="True" />
</td>
              </tr>
          </table>
      </td>
      ...
      <td style="width: 47%; height: 16px; vertical-align: top">
          <table style="width: 100%; vertical-align: top" cellspacing="0">
              <tr>
                 ...
                 <td class="LabelArea">
    <asp:Label ID="lblNotActive" meta:resourcekey="lblNotActiveResource1" runat="server"
        SkinID="Label_DefaultNormal" Text="غير نشط"></asp:Label>
</td>
<td class="DataArea">
    <asp:CheckBox ID="chkNotActive" runat="server"  AutoPostBack="True" />
</td>
              </tr>
          </table>
      </td>
