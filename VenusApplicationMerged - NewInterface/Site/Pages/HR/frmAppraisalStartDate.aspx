<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmAppraisalStartDate.aspx.vb"
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblVacationType" runat="server" SkinID="Label_DefaultNormal" Text="Appraisal Type"
                                                                Width="90px" meta:resourcekey="lblVacationTypeResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="DdlAppraisalType" runat="server" SkinID="DropDownList_LargNormal"
                                                        ...
                                                        <igtbl:UltraGridBand meta:resourcekey="UltraGridBandResource4">
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <igtbl:UltraGridColumn Key="EmployeeID" Width="60px" BaseColumnName="EmployeeID"
                                                                    ...
                                                                    <igtbl:UltraGridColumn Key="EmployeeCode" Width="100px" BaseColumnName="EmployeeCode"
                                                                ...
                                                                <igtbl:UltraGridColumn AllowUpdate="No" Key="EmployeesName" Width="600" BaseColumnName="EmployeesName"
                                                                ...
                                                                <igtbl:UltraGridColumn BaseColumnName="JoinDate" Key="JoinDate" Width="120px" meta:resourcekey="UltraGridColumnResource5">
                                                                 ...
                                                                 <igtbl:UltraGridColumn BaseColumnName="LastExternalAppraisalDate" Key="LastExternalAppraisalDate" Width="200px" meta:resourcekey="UltraGridColumnResource5">
                                                                    <Header Caption="LastExternalAppraisalDate">
                                                                        <RowLayoutColumnInfo OriginX="4" />
                                                                    </Header>
                                                                    <HeaderStyle HorizontalAlign="Center" />
                                                                    <CellStyle HorizontalAlign="Center">
