<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmDelegationSChedule.aspx.vb"
    Inherits="frmDelegationSChedule" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
...
<head runat="server">
    <title>* Venus Payroll * ~ Delegation SChedule</title>
<meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">    

    <script type="text/javascript" src="/ig_res/scripts/Infragistics.js"></script>
<script type="text/javascript" src="/ig_res/scripts/Infragistics.WebUI.UltraWebGrid.js"></script>
    ...
    <script type="text/javascript">
        ...
        function OnGridDoubleClick(event) {
            var gridID = document.getElementById('hfGridClientID').value;  // Get Grid Client ID
            var uniqueID = document.getElementById('hfGridUniqueID').value; // Get Unique ID

            var grid = igtbl_getGridById(gridID); // Get grid object
            var cell = igtbl_getCellByElement(event.target); // Get clicked cell

            if (cell) {
                var row = cell.Row;
                var code = row.getCellFromKey("Code").getValue(); // Get "Code" column value

                // Debugging
                console.log("Double-click detected. Code: " + code);

                // Fire postback safely
                __doPostBack(uniqueID, 'DoubleClick$' + code);
            }
        }

        // Attach the event when the page loads
        function AttachGridDoubleClick() {
            var gridID = document.getElementById('hfGridClientID').value; // Get Grid Client ID
            var gridElement = document.getElementById(gridID);

            if (gridElement) {
                gridElement.ondblclick = OnGridDoubleClick;
                console.log("Double-click event attached to grid: " + gridID);
            }
        }
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
                                                ...
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                         <td class="SeparArea">
                                                          ...
                                                          <td class="LabelArea">
                                                            <asp:Label ID="label2" Width="120px" runat="server" Text=" الموظف البديل"
                                                                SkinID="Label_DefaultNormal" meta:resourcekey="labelAlternativeUserResource1"></asp:Label>
                                                        </td>
                                                       
                                                          <td>
                                                                         <asp:TextBox ID="txtDelegatorEmployeeID" Width="130px" runat="server"  MaxLength="15"
                                                                AutoPostBack="True" meta:resourcekey="txtDelegatorEmployeeIDResource1">
                                                           </asp:TextBox>
                                                                    
                                                                        <igtxt:WebImageButton ID="btnDelegatorSearch" runat="server" Height="18px" AutoSubmit="False"
                                                                            meta:resourcekey="btnDelegatorSearchResource1" Overflow="NoWordWrap" UseBrowserDefaults="False"
                                                                            Width="24px">
                                                                            <Alignments TextImage="ImageBottom" />
                                                                            <Appearance>
                                                                                <Image Url="./Img/forum_search.gif" />
                                                        ...
                                                        <td>
                                                         <asp:TextBox ID="TxtDelegatorName" Width="260px" runat="server"  MaxLength="100"
                                                ...
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                         <td class="SeparArea">
                                                          ...
                                                          <td class="LabelArea">
                                                            <asp:Label ID="label1" Width="120px" runat="server" Text=" الموظف البديل"
                                                                SkinID="Label_DefaultNormal" meta:resourcekey="labelDelegatedResource1"></asp:Label>
                                                        </td>
                                                       
                                                          <td>
                                                                         <asp:TextBox ID="txtDelegated" Width="130px" runat="server"  MaxLength="15"
    ...
    <td style="width: 47%; height: 16px; vertical-align: top">
        <table style="width: 100%; vertical-align: top" cellspacing="0">
            <tr>
                ...
                <td class="LabelArea">
                    <asp:Label ID="lblTodate" runat="server" Text="الى تاريخ" SkinID="Label_DefaultNormal"
    ...
    <td style="width: 47%; height: 16px; vertical-align: top">
        <table style="width: 100%; vertical-align: top" cellspacing="0">
             ...
             <tr>
                ...
                <td style="width: 50px;">
                    <asp:Label ID="lblRemarks" runat="server" Text="ملاحظات" SkinID="Label_DefaultNormal"
                ...
                <td class="DataArea">
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="DataArea">
                                                             <asp:CheckBox ID="chkCheckAll" runat="server" Text=" All " AutoPostBack="True"  meta:resourcekey="chkCheckAllResource1"/>
                                                        </td>
                                        ...
                                        <tr>
                                            <td style="height: 100%; vertical-align: auto" colspan="3">
                                                <table style="width: 47%; vertical-align: auto" cellspacing="0">
                                                    <tr>
                                                        <td>
                                                                    ...
                                                                    <igtbl:UltraGridBand AllowSorting="No" meta:resourcekey="UltraGridBandResource1"
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <igtbl:UltraGridColumn BaseColumnName="ID" Key="ID" Hidden="True">
                                                                             ...
                                                                             <igtbl:UltraGridColumn BaseColumnName="ScheduleId" Hidden="True" Key="ScheduleId">
                                                                                <Header>
                                                                            ...
                                                                            <igtbl:UltraGridColumn AllowUpdate="No" BaseColumnName="RequestTypeId" Key="RequestTypeId"
                                                                                meta:resourcekey="UltraGridColumnRequestId" Width="20%">
                                                                                <Header Caption="Request Type">
                                                                             ...
                                                                             <igtbl:UltraGridColumn AllowUpdate="No" BaseColumnName="RequestTypeName" Key="RequestTypeName"
                                                                                meta:resourcekey="UltraGridColumnRequestName" Width="70%">
                                                                                <Header Caption="Request Name">
                                                                                    <RowLayoutColumnInfo OriginX="2" />
                                                                                </Header>
                                                                                <CellStyle HorizontalAlign="Center">
                                                                                </CellStyle>
                                                                            ...
                                                                            <igtbl:UltraGridColumn BaseColumnName="Select" DataType="System.Boolean" Key="Select" meta:resourcekey="SelectResource1"
                                                                                    Width="10%" Type="CheckBox" AllowUpdate="Yes">
                                                                                    <Header Caption="اختيار">
                                        ...
                                        <tr>
                                                <td style="height: 100%; vertical-align: auto" colspan="3">
                                                    <igtbl:UltraWebGrid   Browser="UpLevel"   autopostback="true" ID="uwgEmployeeVacations" runat="server" EnableAppStyling="False"
                                                        ...
                                                        <Bands>
                                                            <igtbl:UltraGridBand meta:resourcekey="UltraGridBandResource1">
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <igtbl:UltraGridColumn BaseColumnName="Code"  DataType="System.Int32"
                                                                         Key="Code" meta:resourcekey="UltraGridCode"
                                                                        Width="10%">
                                                                        <Header Caption="الكود">
                                                                    ...
                                                                    <igtbl:UltraGridColumn BaseColumnName="FromDate"  DataType="System.DateTime"
                                                                        Format="dd/MM/yyyy hh:mm tt" Key="FromDate" meta:resourcekey="UltraGridFromDate"
                                                                        Width="15%">
                                                                     ...
                                                                     <igtbl:UltraGridColumn BaseColumnName="ToDate" DataType="System.DateTime"
                                                                        Format="dd/MM/yyyy hh:mm tt" Key="ActionDate" meta:resourcekey="UltraGridToDate"
                                                                        Width="15%">
                                                                        <Header Caption=" الى تاريخ">
                                                                            <RowLayoutColumnInfo OriginX="3" />
                                                                        </Header>
                                                                          <CellStyle HorizontalAlign="Center">
                                                                    </CellStyle>
    ...
    <script type="text/javascript">
        Sys.Application.add_load(function () {
            // تأكد من تحميل الجريد بعد تحديث الصفحة
            if (typeof igtbl_getRowById !== "undefined") {
                console.log("Grid functions loaded successfully");
            } else {
                console.warn("Grid functions not loaded. Check script references.");
            }
        });
    </script>
</body>
