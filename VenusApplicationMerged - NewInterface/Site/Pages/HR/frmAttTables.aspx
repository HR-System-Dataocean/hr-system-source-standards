<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmAttTables.aspx.vb" Inherits="frmAttTables"
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmAttTables" runat="server">
                                                ...
                                                <table style="width: 100%; height: 30px; vertical-align: bottom; border-bottom: 1px solid black"
                                                    ...
                                                    <tr>
                                                        <td style="vertical-align: bottom" class="style1">
                                                            <asp:Label ID="Label_Title1" runat="server" Text="برجاء إضافة الورديات المرتبطة بمخطط الدوامات"
                                        ...
                                        <tr>
                                            <td style="height: 16px; vertical-align: top" colspan="3">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        <td>
                                                            <igtbl:UltraWebGrid  Browser="UpLevel"   ID="uwgAttendanceTableClass" runat="server" EnableAppStyling="True"
                                                                ...
                                                                <Bands>
                                                                    <igtbl:UltraGridBand meta:resourcekey="UltraGridBandResource1" AllowAdd="Yes">
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <igtbl:UltraGridColumn BaseColumnName="AttendanceTableID" Hidden="True" Key="AttendanceTableID">
                                                                                <Header>
                                                                            ...
                                                                            <igtbl:UltraGridColumn Width="30%" BaseColumnName="EngName" Key="EngName" meta:resourcekey="UltraGridColumnResource3">
                                                                                <Header Caption="التوصيف إنجليزى">
                                                                            ...
                                                                            <igtbl:UltraGridColumn BaseColumnName="ArbName" Key="ArbName" Width="30%" EditorControlID="WebTextEdit1"
                                                                                Type="Custom" meta:resourcekey="UltraGridColumnResource4">
                                                                                <Header Caption="التوصيف عربى">
                                                                            ...
                                                                            <igtbl:UltraGridColumn Width="20%" BaseColumnName="TimeIn" Key="TimeIn" EditorControlID="WebDateTimeEdit1"
                                                                                Type="Custom" meta:resourcekey="UltraGridColumnResource5">
                                                                                <Header Caption="وقت الدخول">
                                                                                    <RowLayoutColumnInfo OriginX="2" />
                                                                                </Header>
                                                                                <Footer>
                                                                                    <RowLayoutColumnInfo OriginX="2" />
                                                                            ...
                                                                            <igtbl:UltraGridColumn Width="20%" BaseColumnName="TimeOut" Key="TimeOut" EditorControlID="WebDateTimeEdit1"
                                                                                Type="Custom" meta:resourcekey="UltraGridColumnResource6">
                                                                                <Header Caption="وقت الخروج">
                                                                                    <RowLayoutColumnInfo OriginX="2" />
                                                                                </Header>
                                                                                <Footer>
                                                                                    <RowLayoutColumnInfo OriginX="2" />
