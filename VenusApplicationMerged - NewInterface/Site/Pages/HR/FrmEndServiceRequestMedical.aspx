<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmEndServiceRequestMedical.aspx.vb"
...
<head runat="server">
    <title>* Venus Payroll * ~End Of Service Request- Medical</title>
    ...
    <script type="text/javascript" id="igClientScript">
        ...
        function OpenPrintedScreen(v) {
            ...
            var win = window.open("../../Interfaces/frmReportsGridViewer.aspx?Language=false&Criteria=RequestSerial&preview=1&ReportCode=CF_105&sq0=''&v=" + v, "_NEW", "height=" + hight + ",width=" + width + ",resizable=0,menubar=0,toolbar=0,location=0,directories=0,scrollbars=0,status=0,center=0");
            win.focus();
        }
    </script>
    <style type="text/css">
            ...
            <tr>
                <td class="Details">
                    <igtab:UltraWebTab ID="UltraWebTab1" runat="server" EnableAppStyling="True" SkinID="Default"
                        ...
                        <Tabs>
                            <igtab:Tab Text="طلب انهاء خدمة" meta:resourcekey="TabResource1">
                                <ContentTemplate>
                                    <table>
                                        <tr>
                                            <td style="width: 47%">
                                    <table style="width: 100%"
                                        ...
                                        <tr>
                                            <td style="width: 20%; height: 16px; vertical-align: top">
                                                <table style="width: 80%; vertical-align: top" cellspacing="0">
                                                     <tr>
                                                        <td class="SeparArea">
                                                        </td>
                                                        <td class="LabelArea">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="labelDescEnglishName" style="min-width: 90px;">
                                                            <asp:Label ID="label3"  runat="server" Text="اسم الموظف"
                                            ...
                                            <td style="width: 70%; height: 16px; vertical-align: top">
                                                <table style="width: 47%; vertical-align: top" cellspacing="0">
                                                     ...
                                                     <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="LblEOSType" runat="server" Width="120px" SkinID="Label_DefaultNormal"
                                                                Text="نوع نهاية الخدمة" meta:resourcekey="LblExecuseReasonResource1"></asp:Label>
                                                        </td>
                                                        <td class="SeparArea">
                                                        </td>
                                                        <td class="SeparArea">
                                            ...
                                            <td style="width: 6%; height: 16px; vertical-align: top">
                                                <table style="width: 47%; vertical-align: top" cellspacing="0">
                                                    ...
                                                    <td class="SeparArea">
                                                         ...
                                                         <td class="LabelArea">
                                                            <asp:Label ID="lblWebDateChooser1" runat="server" Width="120px" meta:resourcekey="lblWebDateChooser1Resource1"
                                                    ...
                                                    <td class="SeparArea">
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="Label4" runat="server" Width="120px" SkinID="Label_DefaultBold"
                                                                Text="مدة نهاية الخدمة :" meta:resourcekey="LblEndServicePeriod"></asp:Label>
                                                        </td>
                                                         <td class="LabelArea">
                                                            <asp:Label ID="Label6" runat="server" Width="40px" SkinID="Label_DefaultBold"
                                                                Text="سنة :" meta:resourcekey="LblYear"></asp:Label>
                                                        </td>
                                                         <td class="LabelArea">
                                                            <asp:Label ID="LblYear" runat="server" Width="35px" SkinID="Label_DefaultBold"
                                                                Text="0" meta:resourcekey="LblExecuseReasonResource2"></asp:Label>
                                                        </td>
                                                         <td class="LabelArea">
                                                            <asp:Label ID="Label7" runat="server" Width="40px" SkinID="Label_DefaultBold"
                                                                Text="شهر :" meta:resourcekey="LblMonth"></asp:Label>
                                                        </td>
                                                         <td class="LabelArea">
                                                            <asp:Label ID="LblMonth" runat="server" Width="35px" SkinID="Label_DefaultBold"
                                                                Text="0" meta:resourcekey="LblExecuseReasonResource2"></asp:Label>
                                                        </td>
                                                           <td class="LabelArea">
                                                            <asp:Label ID="Label8" runat="server" Width="40px" SkinID="Label_DefaultBold"
                                                                Text="يوم :" meta:resourcekey="LblDay"></asp:Label>
                                                        </td>
                                                         <td class="LabelArea">
                                                            <asp:Label ID="LblDay" runat="server" Width="35px" SkinID="Label_DefaultBold"
                                                                Text="0" meta:resourcekey="LblExecuseReasonResource2"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    </table>
                                            ...
                                            <td style="width: 47%; height: 10px; vertical-align: top">
                                                <table style="width: 50%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="Label2" Width="120px" runat="server" Text=" اسباب نهاية الخدمة"
                                                                SkinID="Label_DefaultNormal" meta:resourcekey="labelEOSReasons"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblRemarks" Width="120px" runat="server" Text=" ملاحظات"
                                                                SkinID="Label_DefaultNormal" meta:resourcekey="lblRemarks"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                        ...
                                        cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblReason" runat="server" Width="120px" SkinID="Label_DefaultNormal"
                                                                Text="حدد سبب الاستقالة:" meta:resourcekey="lblReasonResource1"></asp:Label>
                                                        </td>
                                                        <td class="SeparArea">
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="ddlReason" Width="300px" runat="server" SkinID="DropDownList_smallNormal"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblOtherReason" runat="server" Width="120px" SkinID="Label_DefaultNormal"
                                                                Text="سبب اخر:" meta:resourcekey="lblOtherReasonResource1"></asp:Label>
                                                        </td>
                                                        <td class="SeparArea">
                                                        </td>
                                                        <td class="DataArea">
                                                             <asp:TextBox ID="txtOtherReason" runat="server" Width="300px" 
                                                                ReadOnly="False" MaxLength="500" meta:resourcekey="lblDescEnglishNameResource1"
                                                                TabIndex="1"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea" >
                                                            <asp:Label ID="lblRateDepartment" runat="server" Width="190px" SkinID="Label_DefaultNormal"
                                                                Text="كيف تقيم تجربتك مع القسم؟" meta:resourcekey="lblRateDepartmentResource1"></asp:Label>
                                                        </td>
                                                        <td class="SeparArea">
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="ddlRateDepartment" Width="300px" runat="server" SkinID="DropDownList_smallNormal"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblRateUs" runat="server" Width="190px" SkinID="Label_DefaultNormal"
                                                                Text="كيف تقيم تجربتك معنا؟" meta:resourcekey="lblRateUsResource1"></asp:Label>
                                                        </td>
                                                        <td class="SeparArea">
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="ddlRateUs" Width="300px" runat="server" SkinID="DropDownList_smallNormal"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblBack" runat="server" Width="190px" SkinID="Label_DefaultNormal"
                                                                Text="هل من الممكن التفكير في العودة إلينا؟" meta:resourcekey="lblBackResource1"></asp:Label>
                                                        </td>
                                                        <td class="SeparArea">
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="ddlBack" Width="200px" runat="server" SkinID="DropDownList_smallNormal"
