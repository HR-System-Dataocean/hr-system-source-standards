...
<head runat="server">
    ...
    <style type="text/css">
        ...
        .MainContainer { width: 100%; padding: 5px; }
        .SeparArea { width: 5px; }
        .LabelArea { text-align: right; padding-left: 5px; padding-right: 5px; white-space: nowrap; }
        .DataArea { text-align: right; padding-left: 5px; padding-right: 5px; }
        .DataAreawithsearch { text-align: right; padding-left: 2px; padding-right: 2px; }
        .search { width: 30px; text-align: center; }
        .ClassChangeBox {
        ...
        function OpenModal1(pageurl, height, width, CheckID, SenderCtrl) {
            if (CheckID == false) {
                var $dialog = $('<div></div>')
                    ...
                    .dialog({ autoOpen: false, modal: true, height: height, width: width });
                ODialoge = $dialog;
                OSender = SenderCtrl;
                $dialog.dialog('open');
            }
        ...
        function CloseIt(retvalue) {
            if (retvalue != "") {
                ...
                if (Sender) {
                    ...
                    Sender.focus();
                    if (Sender.onchange) { Sender.onchange(); }
                    else { __doPostBack(Sender.name, ''); }
                }
            }
...
<body style="height: 100%; margin: 0; padding: 0;">
    <form id="frmChangeJoinDate" runat="server">
        ...
        <div class="MainContainer" runat="server" id="DIV">
                            ...
                            <tr>
                                ...
                                <td style="width: 24px">
                                    <asp:ImageButton ID="ImageButton_Save" Width="16px" Height="16px" runat="server"
                                        SkinID="HrSave_Command" meta:resourcekey="ImageButton_SaveResource1"
                                        CommandArgument="Save" OnClientClick="return ValidateForm();" />
                                </td>
                                <td style="width: 24px">
                                    <asp:ImageButton ID="ImageButton_New" Width="16px" Height="16px" runat="server"
                                        SkinID="HrNew_Command" meta:resourcekey="ImageButton_NewResource1" CommandArgument="New" />
                                </td>
                                <td style="width: 40px">
                                ...
                                <td style="width: 80px">
                                    <asp:ImageButton ID="ImageButton_Properties" Width="16px" Height="16px" runat="server"
                                        SkinID="HrProperties_Command" meta:resourcekey="ImageButton_PropertiesResource1" CommandArgument="Property" />
                                    <asp:LinkButton ID="LinkButton_Properties" runat="server" Text="خصائص"
                                        meta:resourcekey="LinkButton_PropertiesResource1" CommandArgument="Property"></asp:LinkButton>
                                </td>
                                <td style="width: 80px">
                                    ...
                                    <asp:LinkButton ID="LinkButton_Remarks" runat="server" Text="ملاحظات"
                                        meta:resourcekey="LinkButton_RemarksResource1" CommandArgument="Remarks"></asp:LinkButton>
                                </td>
                                <td style="width: 40px">
                                ...
                                <td style="width: 80px">
                                    ...
                                    <asp:LinkButton ID="LinkButton_Help" runat="server" Text="مساعدة"
                                        meta:resourcekey="LinkButton_HelpResource1"></asp:LinkButton>
                                </td>
                                <td style="width: 5%"></td>
                            </tr>
                        </table>
                            ...
                            <tr>
                                <td style="width: 32px; vertical-align: top">
                                    <asp:Image ID="Image_Logo" runat="server" ImageAlign="Middle"
                                        ImageUrl="~/Common/Images/ToolBox/Hr_ToolBox/edit.png" meta:resourcekey="Image_LogoResource2" />
                                </td>
                                        ...
                                        <tr>
                                                ...
                                                <table style="width: 100%;" cellspacing="0">
                                                    <tr>
                                                        <td style="width: 40%; height: 16px;">
                                                            <asp:Label ID="lblRegDate" runat="server" Text="سجل فى" SkinID="Label_CopyRightsBold" meta:resourcekey="lblRegDateResource2"></asp:Label>
                                                        </td>
                                            ...
                                            <td style="width: 49%;">
                                                <table style="width: 100%;" cellspacing="0">
                                                    <tr>
                                                        <td style="width: 40%; height: 16px;">
                                                            <asp:Label ID="lblRegUser" runat="server" Text="سجل بواسطة" SkinID="Label_CopyRightsBold" meta:resourcekey="lblRegUserResource2"></asp:Label>
                                                        </td>
                                                        <td style="width: 60%; height: 16px;">
                                        ...
                                        <tr>
                                            <td style="width: 49%;">
                                                <table style="width: 100%;" cellspacing="0">
                                                    <tr>
                                                        <td style="width: 40%; height: 16px;">
                                                            <asp:Label ID="lblCancelDate" runat="server" Text="تاريخ الالغاء" SkinID="Label_CopyRightsBold" meta:resourcekey="lblCancelDateResource2"></asp:Label>
                                                        </td>
                                                        <td style="width: 60%; height: 16px;">
                                                            <asp:Label ID="lblCancelDateValue" runat="server" SkinID="Label_CopyRightsNormal" meta:resourcekey="lblCancelDateValueResource2"></asp:Label>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                ...
                <tr>
                    <td class="Details">
                        <igtab:UltraWebTab ID="UltraWebTab1" runat="server" EnableAppStyling="True"
                            SkinID="Default" meta:resourcekey="UltraWebTab1Resource2">
                            <Tabs>
                                <igtab:Tab Text="تغيير تاريخ المباشرة" meta:resourcekey="TabResource2">
                                    <ContentTemplate>
                                        <table style="width: 100%; min-height: 350px; vertical-align: top" cellspacing="0">
                                                ...
                                                <td style="width: 47%; height: 16px; vertical-align: top">
                                                    <table style="width: 100%;" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td class="LabelArea">
                                                                <asp:Label ID="lblEmployeeCode" runat="server" Text="كود الموظف" SkinID="Label_DefaultNormal" meta:resourcekey="lblEmployeeCodeResource1"></asp:Label>
                                                                <asp:Label ID="Label_Star1" runat="server" Text="*" Style="color: #FF0000"></asp:Label>
                                                            </td>
                                                            <td class="DataAreawithsearch">
                                                                <asp:TextBox ID="txtEmployeeCode" runat="server" SkinID="TextBox_SmalltNormalC"
                                                                    MaxLength="30" AutoPostBack="True" meta:resourcekey="txtEmployeeCodeResource1"></asp:TextBox>
                                                            </td>
                                                            <td class="search">
                                                                <igtxt:WebImageButton ID="btnSearchEmployee" runat="server" AutoSubmit="False"
                                                                    Height="18px" Overflow="NoWordWrap" UseBrowserDefaults="False" Width="24px"
                                                                    meta:resourcekey="btnSearchEmployeeResource1">
                                                                    <Alignments TextImage="ImageBottom" />
                                                                    <Appearance><Image Url="./Img/forum_search.gif" /></Appearance>
                                                                </igtxt:WebImageButton>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                <td style="width: 6%; height: 16px;"></td>
                                                <td style="width: 47%; height: 16px;"></td>
                                            </tr>
                                                ...
                                                <td style="width: 47%; height: 16px; vertical-align: top">
                                                    <table style="width: 100%;" cellspacing="0">
                                                        <tr>
                                                            <td class="SeparArea"></td>
                                                            <td class="LabelArea">
                                                                <asp:Label ID="lblEmployeeName" runat="server" Text="اسم الموظف" SkinID="Label_DefaultNormal" meta:resourcekey="lblEmployeeNameResource1"></asp:Label>
                                                            </td>
                                                            <td class="DataArea">
                                                    ...
                                                    <table cellspacing="6" style="width: 100%; height: 30px; vertical-align: bottom; border-bottom: 1px solid black">
                                                        <tr>
                                                            <td style="vertical-align: bottom">
                                                                <asp:Label ID="lblCurrentInfo" runat="server" SkinID="Label_DefaultBold"
                                                                    Text="معلومات الموظف الحالية" meta:resourcekey="lblCurrentInfoResource1"></asp:Label>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                ...
                                                <td style="width: 47%; height: 16px; vertical-align: top">
                                                    <table style="width: 100%;" cellspacing="0">
                                                        <tr>
                                                            <td class="SeparArea"></td>
                                                            <td class="LabelArea">
                                                                <asp:Label ID="lblCurrentJoinDate" runat="server" Text="تاريخ المباشرة الحالي" SkinID="Label_DefaultNormal" meta:resourcekey="lblCurrentJoinDateResource1"></asp:Label>
                                                            </td>
                                                            <td class="DataArea">
                                                ...
                                                <td style="width: 47%; height: 16px; vertical-align: top">
                                                    <table style="width: 100%;" cellspacing="0">
                                                        <tr>
                                                            <td class="SeparArea"></td>
                                                            <td class="LabelArea">
                                                                <asp:Label ID="lblLastSalary" runat="server" Text="آخر راتب تم صرفه" SkinID="Label_DefaultNormal" meta:resourcekey="lblLastSalaryResource1"></asp:Label>
                                                            </td>
                                                            <td class="DataArea">
                                                ...
                                                <td style="width: 47%; height: 16px; vertical-align: top">
                                                    <table style="width: 100%;" cellspacing="0">
                                                        <tr>
                                                            <td class="SeparArea"></td>
                                                            <td class="LabelArea">
                                                                <asp:Label ID="lblCurrentClass" runat="server" Text="الفئة الحالية" SkinID="Label_DefaultNormal" meta:resourcekey="lblCurrentClassResource1"></asp:Label>
                                                            </td>
                                                            <td class="DataArea">
                                                ...
                                                <td style="width: 47%; height: 16px; vertical-align: top">
                                                    <table style="width: 100%;" cellspacing="0">
                                                        <tr>
                                                            <td class="SeparArea"></td>
                                                            <td class="LabelArea">
                                                                <asp:Label ID="lblCurrentBalance" runat="server" Text="الرصيد الحالي" SkinID="Label_DefaultNormal" meta:resourcekey="lblCurrentBalanceResource1"></asp:Label>
                                                            </td>
                                                            <td class="DataArea">
                                                    ...
                                                    <table style="width: 100%;" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td class="LabelArea" style="width: 22.5%;">
                                                                <asp:Label ID="lblAnnualVacation" runat="server" Text="الرصيد السنوي" SkinID="Label_DefaultNormal" meta:resourcekey="lblAnnualVacationResource1"></asp:Label>
                                                            </td>
                                                            ...
                                                            <td class="LabelArea" style="width: 20%;">
                                                                <asp:Label ID="lblAnnualExpireDate" runat="server" Text="تاريخ الانتهاء" SkinID="Label_DefaultNormal" meta:resourcekey="lblAnnualExpireDateResource1"></asp:Label>
                                                            </td>
                                                            <td class="DataArea" style="width: 30%;">
                                                ...
                                                <td style="width: 47%; height: 16px; vertical-align: top">
                                                    <table style="width: 100%;" cellspacing="0">
                                                        <tr>
                                                            <td class="SeparArea"></td>
                                                            <td class="LabelArea" style="width: 22.5%;">
                                                                <asp:Label ID="lblTransferredVacation" runat="server" Text="الرصيد المرحل" SkinID="Label_DefaultNormal" meta:resourcekey="lblTransferredVacationResource1"></asp:Label>
                                                            </td>
                                                            <td class="DataArea" style="width: 30%;">
                                                            ...
                                                            <td class="LabelArea" style="width: 20%;">
                                                                <asp:Label ID="lblTransferredExpireDate" runat="server" Text="تاريخ الانتهاء" SkinID="Label_DefaultNormal" meta:resourcekey="lblTransferredExpireDateResource1"></asp:Label>
                                                            </td>
                                                            <td class="DataArea" style="width: 30%;">
                                            ...
                                            <tr>
                                                <td style="width: 100%;" colspan="4">
                                                    <div class="DueBalanceBox">
                                                        <asp:Label ID="lblDueBalanceTitle" runat="server" Text="الرصيد المستحق حتى اليوم: " meta:resourcekey="lblDueBalanceTitleResource1"></asp:Label>
                                                        <asp:Label ID="lblDueBalance"      runat="server" Text="0.00" meta:resourcekey="lblDueBalanceResource1"></asp:Label>
                                                        <asp:Label ID="lblDueBalanceUnit"  runat="server" Text=" يوم" meta:resourcekey="lblDueBalanceUnitResource1"></asp:Label>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td style="width: 47%; height: 16px; vertical-align: top">
                                                    <table cellspacing="6" style="width: 100%; height: 30px; vertical-align: bottom; border-bottom: 1px solid black">
                                                        <tr>
                                                            <td style="vertical-align: bottom">
                                                                <asp:Label ID="lblNewData" runat="server" SkinID="Label_DefaultBold"
                                                                    Text="البيانات الجديدة" meta:resourcekey="lblNewDataResource1"></asp:Label>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                ...
                                                <td style="width: 47%; height: 16px; vertical-align: top">
                                                    <table style="width: 100%;" cellspacing="0">
                                                        <tr>
                                                            <td class="SeparArea"></td>
                                                            <td class="LabelArea">
                                                                <asp:Label ID="lblNewJoinDate" runat="server" Text="تاريخ المباشرة الجديد" SkinID="Label_DefaultNormal" meta:resourcekey="lblNewJoinDateResource1"></asp:Label>
                                                            </td>
                                                            <td class="DataArea">
                                                                <igsch:WebDateChooser ID="txtNewJoinDate" runat="server" BorderColor="#CCCCCC"
                                                                    BorderStyle="Solid" BorderWidth="1px" Height="18px" NullDateLabel=""
                                                                    Style="font-family: Tahoma; font-size: 8pt; font-weight: Normal; color: Black; border: solid 1px #CCCCCC"
                                                                    Width="130px">
                                                ...
                                                <td style="width: 47%; height: 16px; vertical-align: top">
                                                    <table style="width: 100%;" cellspacing="0">
                                                        <tr>
                                                            <td class="SeparArea"></td>
                                                            <td class="LabelArea">
                                                                <asp:Label ID="lblNewClass" runat="server" Text="الفئة الجديدة" SkinID="Label_DefaultNormal" meta:resourcekey="lblNewClassResource1"></asp:Label>
                                                            </td>
                                                            <td class="DataArea">
                                            ...
                                            <!-- قسم ترحيل الرصيد عند تغيير الفئة -->
                                            <tr>
                                                <td style="width: 100%;" colspan="4">
                                                                    ...
                                                                    <table style="width: 100%;" cellspacing="5">
                                                                        <tr>
                                                                            ...
                                                                            <td style="width: 75%; text-align: right;">
                                                                                <igsch:WebDateChooser ID="txtTransferExpireDate" runat="server"
                                                                                    BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px"
                                                                                    Height="18px" NullDateLabel=""
                                                                                    Style="font-family: Tahoma; font-size: 8pt; font-weight: Normal; color: Black; border: solid 1px #CCCCCC"
                                                                                    Width="130px" meta:resourcekey="txtTransferExpireDateResource1">
                                                                                </igsch:WebDateChooser>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                            ...
                                            <tr>
                                                <td style="width: 47%; height: 16px; vertical-align: top">
                                                    <table cellspacing="6" style="width: 100%; height: 30px; vertical-align: bottom; border-bottom: 1px solid black">
                                                        <tr>
                                                            <td style="vertical-align: bottom">
                                                                <asp:Label ID="lblReasonSection" runat="server" SkinID="Label_DefaultBold"
                                                                    Text="سبب التغيير" meta:resourcekey="lblReasonSectionResource1"></asp:Label>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                        ...
                                                        <tr>
                                                            <td style="width: 15%; font-weight: bold; vertical-align: top; padding: 5px; text-align: right;">
                                                                <asp:Label ID="lblReasonJoinDate" runat="server"
                                                                    Text="سبب التغيير:" SkinID="Label_DefaultNormal"
        ...
        <script type="text/javascript">
            ...
            function CheckClassChange() {
                var ddlClass = document.getElementById('<%= ddlNewClass.ClientID %>');
                var hdnCurrentClass = document.getElementById('<%= hdnCurrentClassID.ClientID %>');
                ...
                if (classChanged) {
                    ...
                    var chkTransfer = document.getElementById('<%= chkTransferBalance.ClientID %>');
            ...
            function ToggleTransferExpireDate() {
                ...
                if (chkTransfer && chkTransfer.checked) {
                    ...
                    var txtDate = document.getElementById('<%= txtTransferExpireDate.ClientID %>');
            ...
            function ValidateForm() {
                ...
                var currentJoinDate = document.getElementById('<%= txtCurrentJoinDate.ClientID %>').value;
                var newJoinDateVal = document.getElementById('<%= txtNewJoinDate.ClientID %>').value;
                var hdnCurrentClass = document.getElementById('<%= hdnCurrentClassID.ClientID %>');
                var ddlClass        = document.getElementById('<%= ddlNewClass.ClientID %>');
                ...
                if (classChanged) {
                    var chkTransfer = document.getElementById('<%= chkTransferBalance.ClientID %>');
                    if (chkTransfer && chkTransfer.checked) {
                        var expireDate = document.getElementById('<%= txtTransferExpireDate.ClientID %>').value;
                        if (expireDate == '') {
                            errorMsg += '- ' + document.getElementById('<%= lblTransferExpireDateMsg.ClientID %>').innerHTML + '\n';
                            isValid = false;
                        }
                    }
                }
            ...
            $(document).ready(function () {
                $('#<%= ddlNewClass.ClientID %>').change(function () {
                    CheckClassChange();
                });
                $('#<%= chkTransferBalance.ClientID %>').click(function () {
