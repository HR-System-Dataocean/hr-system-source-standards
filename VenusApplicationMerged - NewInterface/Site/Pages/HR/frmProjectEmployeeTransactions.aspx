<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmProjectEmployeeTransactions.aspx.vb"
    Inherits="frmProjectEmployeeTransactions" Culture="auto" UICulture="auto" meta:resourcekey="PageResource1" %>
...
<head runat="server">
    <title>* Venus Payroll * ~ frmProjectEmployeeTransactions</title>
        ...
        function uwg_ClickCellButtonHandler(gridName, cellId) {
            ...
            if (cell.Index == 3) {
                ...
                if (currProjectEmployee != null)
                    OpenModal1('frmProjectEmployeeTransfeer.aspx?ID=' + currProjectEmployee, 500, 1000, true, '');
                return false;
            }
                ...
                var currProjectEmployee = cellID.getValue()
                if (currProjectEmployee != null)
                    OpenModal1('frmProjectEmployeeExtension.aspx?ID=' + currProjectEmployee, 450, 1000, true, '');
                return false;
            }
                ...
                var currProjectEmployee = cellID.getValue()
                if (currProjectEmployee != null)
                    OpenModal1('frmProjectEmployeePenalities.aspx?ID=' + currProjectEmployee, 450, 1000, true, '');
                return false;
            }
                ...
                var currProjectEmployee = cellID.getValue()
                if (currProjectEmployee != null)
                    OpenModal1('frmProjectEmployeeRewards.aspx?ID=' + currProjectEmployee, 450, 1000, true, '');
                return false;
            }
        }
    </script>
...
<body style="height: 100%; margin: 0; padding: 0;">
    <form id="frmProjectEmployeeTransactions" runat="server" defaultbutton="ImageButton1">
                        ...
                        <tr>
                            ...
                            <td style="vertical-align: middle">
                                <asp:Label ID="Label_Header" runat="server" Style="font-family: Tahoma; font-size: 8pt;
                                    font-weight: Normal;" meta:resourcekey="Label_HeaderResource1">نموذج حركات موظفى المشاريع</asp:Label>
                            </td>
                        </tr>
                    </table>
                </td>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblCode" runat="server" Text="الرقم الوظيفى" Width="90px" SkinID="Label_DefaultNormal"
                                                    ...
                                                    <Bands>
                                                        <igtbl:UltraGridBand AllowSorting="No" meta:resourcekey="UltraGridBandResource1">
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <igtbl:UltraGridColumn CellButtonDisplay="Always" Type="Button" Width="80px" meta:resourcekey="UltraGridColumnResource4">
                                                                    <Header Caption="التنقل">
