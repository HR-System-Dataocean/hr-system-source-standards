...
#Region "Protected Sub"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            Try
                ...
                UrlString = "'frmModalSearchScreen.aspx?TargetControl=" & txtMananger.ID & "&SearchID=" & csSearchID & "&'," & IntDimension & ",720,false,'" & txtMananger.ClientID & "'"
                btnManagerSearch.ClientSideEvents.Click = "OpenModal1(" & UrlString & ")"
    ...
    Protected Sub txtManager_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtMananger.TextChanged
        Try
            If Not String.IsNullOrEmpty(txtMananger.Text) Then
                ...
                connection2 = New Data.SqlClient.SqlConnection(connetionString2)
                Dim strselect As String
                strselect = "select " & EmpName & "  FROM  Hrs_Employees where Code='" & txtMananger.Text & "'"
                'command2 = New Data.SqlClient.SqlCommand(strselect, connection2)
                ...
                If ClsEmployees.ID > 0 Then
                    ...
                    txtManagerName.Text = EmployeeName
...
#Region "Private Functions"
    ...
    Private Sub FillEmployeeRequestsByStatus()
        Try
            ...
            If Not String.IsNullOrEmpty(txtEmpCode.Text) Then
                ClsEmployees.Find("Code='" & txtEmpCode.Text & "'")
                Where = " And SS_RequestActions.EmployeeID= '" & ClsEmployees.ID & "'"
            End If
            ...
            ElseIf ddlStatus.SelectedValue = 5 Then  'ملغي    
                If DdlRequestType.SelectedValue.Trim() = "SS_0011" Then
                    str1 = "select distinct(SS_VacationRequest.ID),SS_VacationRequest.VacationType ,SS_VacationRequest.Code as RequestSerial ,SS_VacationRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_VacationRequest.RequestDate,SS_VacationRequest.VacationType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName0 & "' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName & "' else  " & vacationName2 & "  end as RequestType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then 'SS_0011' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then 'SS_0012' when SS_VacationRequest.VacationType='SS_0018' then 'SS_0018' else  'SS_0013'  end as FormCode from SS_VacationRequest join hrs_Employees on SS_VacationRequest.EmployeeID=hrs_Employees.id join hrs_VacationsTypes on SS_VacationRequest.VacationTypeID= hrs_VacationsTypes.ID join SS_RequestActions on SS_RequestActions.RequestSerial= SS_VacationRequest.ID and (SS_RequestActions.FormCode='SS_0011' or SS_RequestActions.FormCode='SS_0012' or SS_RequestActions.FormCode='SS_0013') where  VacationType='SS_0011' and Requestdate>= convert(datetime,'" & ddlFromDate.Value & "',103)  and Requestdate<=convert(datetime,'" & ddlToDate.Value & "',103)  and SS_RequestActions.ActionID is not null and SS_RequestActions.ActionID=4 and SS_VacationRequest.ID not in (select RequestSerial from SS_RequestActions where FormCode='SS_0011'  and( ActionID =2 or ActionID is null)) " & Where & " Order By SS_VacationRequest.RequestDate desc"


                ElseIf DdlRequestType.SelectedValue.Trim() = "SS_0012" Then
                    str1 = "select distinct(SS_VacationRequest.ID),SS_VacationRequest.VacationType ,SS_VacationRequest.Code as RequestSerial ,SS_VacationRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_VacationRequest.RequestDate,SS_VacationRequest.VacationType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName0 & "' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName & "' else  " & vacationName2 & "  end as RequestType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then 'SS_0011' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then 'SS_0012' when SS_VacationRequest.VacationType='SS_0018' then 'SS_0018' else  'SS_0013'  end as FormCode from SS_VacationRequest join hrs_Employees on SS_VacationRequest.EmployeeID=hrs_Employees.id join hrs_VacationsTypes on SS_VacationRequest.VacationTypeID= hrs_VacationsTypes.ID join SS_RequestActions on SS_RequestActions.RequestSerial= SS_VacationRequest.ID and (SS_RequestActions.FormCode='SS_0011' or SS_RequestActions.FormCode='SS_0012' or SS_RequestActions.FormCode='SS_0013') where  VacationType='SS_0012' and Requestdate>= convert(datetime,'" & ddlFromDate.Value & "',103)  and Requestdate<=convert(datetime,'" & ddlToDate.Value & "',103)  and SS_RequestActions.ActionID is not null and SS_RequestActions.ActionID=4 and SS_VacationRequest.ID not in (select RequestSerial from SS_RequestActions where FormCode='SS_0012'  and( ActionID =2 or ActionID is null)) " & Where & " Order By SS_VacationRequest.RequestDate desc"

                ElseIf DdlRequestType.SelectedValue.Trim() = "SS_0013" Then
                    str1 = "select distinct(SS_VacationRequest.ID),SS_VacationRequest.VacationType ,SS_VacationRequest.Code as RequestSerial ,SS_VacationRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_VacationRequest.RequestDate,SS_VacationRequest.VacationType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName0 & "' when SS_VacationRequest.VacationType='SS_0013' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName & "' else  " & vacationName2 & "  end as RequestType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then 'SS_0011' when SS_VacationRequest.VacationType='SS_0013' and SS_VacationRequest.VacationTypeID =1 then 'SS_0012' when SS_VacationRequest.VacationType='SS_0018' then 'SS_0018' else  'SS_0013'  end as FormCode from SS_VacationRequest join hrs_Employees on SS_VacationRequest.EmployeeID=hrs_Employees.id join hrs_VacationsTypes on SS_VacationRequest.VacationTypeID= hrs_VacationsTypes.ID join SS_RequestActions on SS_RequestActions.RequestSerial= SS_VacationRequest.ID and (SS_RequestActions.FormCode='SS_0011' or SS_RequestActions.FormCode='SS_0012' or SS_RequestActions.FormCode='SS_0013') where  VacationType='SS_0012' and Requestdate>= convert(datetime,'" & ddlFromDate.Value & "',103)  and Requestdate<=convert(datetime,'" & ddlToDate.Value & "',103) and SS_RequestActions.ActionID is not null and SS_RequestActions.ActionID=4 and SS_VacationRequest.ID not in (select RequestSerial from SS_RequestActions where FormCode='SS_0012'  and( ActionID =2 or ActionID is null)) " & Where & " Order By SS_VacationRequest.RequestDate desc"

                ElseIf DdlRequestType.SelectedValue.Trim() = "SS_0014" Then
                    str1 = " select distinct(SS_ExecuseRequest.ID),'4' as VacationType,SS_ExecuseRequest.Code as RequestSerial ,SS_ExecuseRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_ExecuseRequest.RequestDate,'', '" & permName & "'  as RequestType ,'SS_0014' as FormCode from SS_ExecuseRequest join hrs_Employees on SS_ExecuseRequest.EmployeeID=hrs_Employees.id join SS_RequestActions on SS_RequestActions.RequestSerial= SS_ExecuseRequest.ID and (SS_RequestActions.FormCode='SS_0014') where Requestdate>= convert(datetime,'" & ddlFromDate.Value & "',103)  and Requestdate<=convert(datetime,'" & ddlToDate.Value & "',103) and SS_RequestActions.ActionID is not null and SS_RequestActions.ActionID=4 and SS_ExecuseRequest.ID not in (select RequestSerial from SS_RequestActions where FormCode='SS_0014'  and( ActionID =2 or ActionID is null)) " & Where & "  Order By SS_ExecuseRequest.RequestDate desc"

                ElseIf DdlRequestType.SelectedValue.Trim() = "SS_0015" Then
                    str1 = "select distinct(SS_EndOfServiceRequest.ID),'5' as VacationType,SS_EndOfServiceRequest.Code as RequestSerial ,SS_EndOfServiceRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_EndOfServiceRequest.RequestDate,'', case when SS_EndOfServiceRequest.FormCode='SS_0015' then '" & ServiceName & "' else '" & mServiceName & "' end  as RequestType ,SS_EndOfServiceRequest.FormCode as FormCode from SS_EndOfServiceRequest join hrs_Employees on SS_EndOfServiceRequest.EmployeeID=hrs_Employees.id join SS_RequestActions on SS_RequestActions.RequestSerial= SS_EndOfServiceRequest.ID and (SS_RequestActions.FormCode='SS_0015')  where Requestdate>= convert(datetime,'" & ddlFromDate.Value & "',103)  and Requestdate<=convert(datetime,'" & ddlToDate.Value & "',103)  and SS_RequestActions.ActionID is not null and SS_RequestActions.ActionID=4 and SS_EndOfServiceRequest.ID not in (select RequestSerial from SS_RequestActions where FormCode='SS_0015'  and( ActionID =2 or ActionID is null)) " & Where & " Order By SS_EndOfServiceRequest.RequestDate desc"

                ElseIf DdlRequestType.SelectedValue = 0 Then
                    str1 = "select distinct(SS_VacationRequest.ID),SS_VacationRequest.VacationType ,SS_VacationRequest.Code as RequestSerial ,SS_VacationRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_VacationRequest.RequestDate,SS_VacationRequest.VacationType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName0 & "' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName & "' else  " & vacationName2 & "  end as RequestType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then 'SS_0011' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then 'SS_0012' when SS_VacationRequest.VacationType='SS_0018' then 'SS_0018' else  'SS_0013'  end as FormCode from SS_VacationRequest join hrs_Employees on SS_VacationRequest.EmployeeID=hrs_Employees.id join hrs_VacationsTypes on SS_VacationRequest.VacationTypeID= hrs_VacationsTypes.ID join SS_RequestActions on SS_RequestActions.RequestSerial= SS_VacationRequest.ID and (SS_RequestActions.FormCode='SS_0011' or SS_RequestActions.FormCode='SS_0012' or SS_RequestActions.FormCode='SS_0013') where Requestdate>= convert(datetime,'" & ddlFromDate.Value & "',103)  and Requestdate<=convert(datetime,'" & ddlToDate.Value & "',103)  and SS_RequestActions.ActionID is not null and SS_RequestActions.ActionID=4 and SS_VacationRequest.ID not in (select RequestSerial from SS_RequestActions where (FormCode='SS_0011' or FormCode='SS_0012' or FormCode='SS_0013') and( ActionID =2 or ActionID is null)) " & Where & " union select distinct(SS_ExecuseRequest.ID),'4' as VacationType,SS_ExecuseRequest.Code as RequestSerial ,SS_ExecuseRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_ExecuseRequest.RequestDate,'', '" & permName & "'  as RequestType ,'SS_0014' as FormCode from SS_ExecuseRequest join hrs_Employees on SS_ExecuseRequest.EmployeeID=hrs_Employees.id join SS_RequestActions on SS_RequestActions.RequestSerial= SS_ExecuseRequest.ID and (SS_RequestActions.FormCode='SS_0014') where Requestdate>= convert(datetime,'" & ddlFromDate.Value & "',103)  and Requestdate<=convert(datetime,'" & ddlToDate.Value & "',103) and SS_RequestActions.ActionID is not null and SS_RequestActions.ActionID=4 and SS_ExecuseRequest.ID not in (select RequestSerial from SS_RequestActions where FormCode='SS_0014'  and( ActionID =2 or ActionID is null)) " & Where & " union select distinct(SS_EndOfServiceRequest.ID),'5' as VacationType,SS_EndOfServiceRequest.Code as RequestSerial ,SS_EndOfServiceRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_EndOfServiceRequest.RequestDate,'', case when SS_EndOfServiceRequest.FormCode='SS_0015' then '" & ServiceName & "' else '" & mServiceName & "' end  as RequestType ,SS_EndOfServiceRequest.FormCode as FormCode from SS_EndOfServiceRequest join hrs_Employees on SS_EndOfServiceRequest.EmployeeID=hrs_Employees.id join SS_RequestActions on SS_RequestActions.RequestSerial= SS_EndOfServiceRequest.ID and (SS_RequestActions.FormCode='SS_0015')  where Requestdate>= convert(datetime,'" & ddlFromDate.Value & "',103)  and Requestdate<=convert(datetime,'" & ddlToDate.Value & "',103)  and SS_RequestActions.ActionID is not null and SS_RequestActions.ActionID=4 and SS_EndOfServiceRequest.ID not in (select RequestSerial from SS_RequestActions where FormCode='SS_0015'   and( ActionID =2 or ActionID is null)) " & Where & " Order By SS_VacationRequest.RequestDate desc"
        ...
        Try
            ...
            If ddlStatus.SelectedValue = 2 Then  'رفض
                If DdlRequestType.SelectedIndex <> 0 Then
                    str1 = "select distinct(SS_VFollowup.ID),SS_VFollowup.FormCode as VacationType ,SS_VFollowup.RequestSerial as RequestSerial ,SS_VFollowup.EmployeeID ," & EmpName & " as EmployeeName,SS_VFollowup.RequestDate ," & RequestType & " as RequestType ,SS_VFollowup.FormCode as FormCode from SS_VFollowup where Requestdate>=convert(datetime,'" & ddlFromDate.Value & "',103)  And Requestdate<=convert(datetime,'" & ddlToDate.Value & "',103)    and RequestStautsTypeID is not null and RequestStautsTypeID=2 and FormCode='" & DdlRequestType.SelectedValue.Trim() & "' " & Where & " Order By SS_VFollowup.RequestDate desc"
                Else
                    str1 = "select distinct(SS_VFollowup.ID),SS_VFollowup.FormCode as VacationType,SS_VFollowup.RequestSerial as RequestSerial ,SS_VFollowup.EmployeeID ," & EmpName & " as EmployeeName,SS_VFollowup.RequestDate ," & RequestType & " as RequestType ,SS_VFollowup.FormCode as FormCode from SS_VFollowup where Requestdate>=convert(datetime,'" & ddlFromDate.Value & "',103)  And Requestdate<=convert(datetime,'" & ddlToDate.Value & "',103)    and RequestStautsTypeID is not null and RequestStautsTypeID=2 " & Where & " Order By SS_VFollowup.RequestDate desc"
                End If

            ElseIf ddlStatus.SelectedValue = 1 Then  'موافقة    
                If DdlRequestType.SelectedIndex <> 0 Then
                    str1 = "select distinct(SS_VFollowup.ID),SS_VFollowup.FormCode as VacationType ,SS_VFollowup.RequestSerial as RequestSerial ,SS_VFollowup.EmployeeID ," & EmpName & " as EmployeeName,SS_VFollowup.RequestDate ," & RequestType & " as RequestType ,SS_VFollowup.FormCode as FormCode from SS_VFollowup where Requestdate>=convert(datetime,'" & ddlFromDate.Value & "',103)  And Requestdate<=convert(datetime,'" & ddlToDate.Value & "',103)    and RequestStautsTypeID is not null and RequestStautsTypeID=1 and FormCode='" & DdlRequestType.SelectedValue.Trim() & "' " & Where & " Order By SS_VFollowup.RequestDate desc"
                Else
                    str1 = "select distinct(SS_VFollowup.ID),SS_VFollowup.FormCode as VacationType ,SS_VFollowup.RequestSerial as RequestSerial ,SS_VFollowup.EmployeeID ," & EmpName & " as EmployeeName,SS_VFollowup.RequestDate," & RequestType & " as RequestType ,SS_VFollowup.FormCode as FormCode from SS_VFollowup where Requestdate>=convert(datetime,'" & ddlFromDate.Value & "',103)  And Requestdate<=convert(datetime,'" & ddlToDate.Value & "',103)    and RequestStautsTypeID is not null and RequestStautsTypeID=1 " & Where & " Order By SS_VFollowup.RequestDate desc"
                End If
            ElseIf ddlStatus.SelectedValue = 4 Then 'تحت التنفيذ
                If DdlRequestType.SelectedIndex <> 0 Then
                    str1 = "select distinct(SS_VFollowup.ID),SS_VFollowup.FormCode as VacationType ,SS_VFollowup.RequestSerial as RequestSerial ,SS_VFollowup.EmployeeID ," & EmpName & " as EmployeeName,SS_VFollowup.RequestDate ," & RequestType & " as RequestType ,SS_VFollowup.FormCode as FormCode from SS_VFollowup where Requestdate>=convert(datetime,'" & ddlFromDate.Value & "',103)  And Requestdate<=convert(datetime,'" & ddlToDate.Value & "',103)    and RequestStautsTypeID is not null and RequestStautsTypeID=4 and FormCode='" & DdlRequestType.SelectedValue.Trim() & "' " & Where & " Order By SS_VFollowup.RequestDate desc"
                Else
                    str1 = "select distinct(SS_VFollowup.ID),SS_VFollowup.FormCode as VacationType ,SS_VFollowup.RequestSerial as RequestSerial ,SS_VFollowup.EmployeeID ," & EmpName & " as EmployeeName,SS_VFollowup.RequestDate ," & RequestType & " as RequestType ,SS_VFollowup.FormCode as FormCode from SS_VFollowup where Requestdate>=convert(datetime,'" & ddlFromDate.Value & "',103)  And Requestdate<=convert(datetime,'" & ddlToDate.Value & "',103)    and RequestStautsTypeID is not null and RequestStautsTypeID=4 " & Where & " Order By SS_VFollowup.RequestDate desc"
                End If

            ElseIf ddlStatus.SelectedValue = 3 Then 'جديد
                If DdlRequestType.SelectedIndex <> 0 Then
                    str1 = "select distinct(SS_VFollowup.ID),SS_VFollowup.FormCode as VacationType ,SS_VFollowup.RequestSerial as RequestSerial ,SS_VFollowup.EmployeeID ," & EmpName & " as EmployeeName,SS_VFollowup.RequestDate," & RequestType & " as RequestType ,SS_VFollowup.FormCode as FormCode from SS_VFollowup where Requestdate>=convert(datetime,'" & ddlFromDate.Value & "',103)  And Requestdate<=convert(datetime,'" & ddlToDate.Value & "',103)    and RequestStautsTypeID is not null and RequestStautsTypeID=3 and FormCode='" & DdlRequestType.SelectedValue.Trim() & "' " & Where & " Order By SS_VFollowup.RequestDate desc"
                Else
                    str1 = "select distinct(SS_VFollowup.ID),SS_VFollowup.FormCode as VacationType ,SS_VFollowup.RequestSerial as RequestSerial ,SS_VFollowup.EmployeeID ," & EmpName & " as EmployeeName,SS_VFollowup.RequestDate ," & RequestType & " as RequestType ,SS_VFollowup.FormCode as FormCode from SS_VFollowup where Requestdate>=convert(datetime,'" & ddlFromDate.Value & "',103)  And Requestdate<=convert(datetime,'" & ddlToDate.Value & "',103)    and RequestStautsTypeID is not null and RequestStautsTypeID=3 " & Where & " Order By SS_VFollowup.RequestDate desc"
                End If
            ElseIf ddlStatus.SelectedValue = 5 Then 'ملغي
                If DdlRequestType.SelectedIndex <> 0 Then
                    str1 = "select distinct(SS_VFollowup.ID),SS_VFollowup.FormCode as VacationType ,SS_VFollowup.RequestSerial as RequestSerial ,SS_VFollowup.EmployeeID ," & EmpName & " as EmployeeName,SS_VFollowup.RequestDate ," & RequestType & " as RequestType ,SS_VFollowup.FormCode as FormCode from SS_VFollowup where Requestdate>=convert(datetime,'" & ddlFromDate.Value & "',103)  And Requestdate<=convert(datetime,'" & ddlToDate.Value & "',103)    and RequestStautsTypeID is not null and RequestStautsTypeID=5 and FormCode='" & DdlRequestType.SelectedValue.Trim() & "' " & Where & " Order By SS_VFollowup.RequestDate desc"
                Else
                    str1 = "select distinct(SS_VFollowup.ID),SS_VFollowup.FormCode as VacationType ,SS_VFollowup.RequestSerial as RequestSerial ,SS_VFollowup.EmployeeID ," & EmpName & " as EmployeeName,SS_VFollowup.RequestDate ," & RequestType & " as RequestType ,SS_VFollowup.FormCode as FormCode from SS_VFollowup where Requestdate>=convert(datetime,'" & ddlFromDate.Value & "',103)  And Requestdate<=convert(datetime,'" & ddlToDate.Value & "',103)    and RequestStautsTypeID is not null and RequestStautsTypeID=5 " & Where & " Order By SS_VFollowup.RequestDate desc"
                End If
            ElseIf ddlStatus.SelectedValue = 0 Then 'برجاء الاختيار
                FillEmployeeVacations()
    ...
    Private Sub FillEmployeeVacations()
        Try
            ...
            str1 = "select ID,VacationType,RequestSerial,EmployeeID," & EmpName & ",RequestDate,VacationType," & RequestType & ",FormCode from SS_VFollowup"
            ...
            If Not String.IsNullOrEmpty(txtEmpCode.Text) Then
                ClsEmployees.Find("Code='" & txtEmpCode.Text & "'")
                Criteria &= " And EmployeeID= '" & ClsEmployees.ID & "'"
            End If

            If ddlBranch.SelectedValue > 0 Then
                Criteria += " and SS_VFollowup.EmployeeID in (select ID from hrs_Employees where BranchID=" & ddlBranch.SelectedValue & ") "
            End If
            If ddlDepartment.SelectedValue > 0 Then
                Criteria += " and SS_VFollowup.EmployeeID in (select ID from hrs_Employees where DepartmentID=" & ddlDepartment.SelectedValue & ") "
            End If
            If Not String.IsNullOrEmpty(txtMananger.Text) Then
                ClsEmployees.Find("Code='" & txtMananger.Text & "'")
    ...
    Private Sub GetAllEmployeeRequests()
        Try
            ...
            str1 = "select ID,FormCode as VacationType,RequestSerial,EmployeeID," & EmpName & ",RequestDate,FormCode as VacationType," & RequestType & ",FormCode from SS_VFollowup where year(Requestdate)=year(GETDATE()) "
    ...
    Public Sub FillRowColors()
        ...
        For Each row As Infragistics.WebUI.UltraWebGrid.UltraGridRow In uwgEmployeeVacations.Rows
            ...
            If RequestSerial = "V_ADM_ 2297" Then
                RequestSerial = "V_ADM_ 2297"
            End If
