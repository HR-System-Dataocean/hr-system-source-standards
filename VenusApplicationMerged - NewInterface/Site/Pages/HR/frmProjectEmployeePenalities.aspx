<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmProjectEmployeePenalities.aspx.vb"
    Inherits="frmProjectEmployeePenalities" Culture="auto" UICulture="auto" meta:resourcekey="PageResource1"  %>
...
<head runat="server">
    <title>* Venus Payroll * ~ frmProjectEmployeePenalities</title>
...
<body style="height: 100%; margin: 0; padding: 0;">
    <form id="frmProjectEmployeePenalities" runat="server" defaultbutton="ImageButton1">
                                    ...
                                    <table style="width: 100%; height: 100%; min-height: 350px; vertical-align: top"
                                            ...
                                            <td style="width: 47%">
                                                <table style="width: 100%; height: 100%">
                                                    <tr>
                                                        ...
                                                        <td style="width: 90px;">
                                                            <asp:Label ID="Label_StartDate" runat="server" Text="تاريخ المخالفة" 
                                                ...
                                                <table style="width: 100%; height: 30px; vertical-align: bottom; border-bottom: 1px solid black"
                                                    ...
                                                    <tr>
                                                        <td style="vertical-align: bottom">
                                                            <asp:Label ID="Label1" runat="server" Text="معلومات المخالفة" 
                                        ...
                                        <tr>
                                            <td style="vertical-align: top" class="style1">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblProject" runat="server" SkinID="Label_DefaultNormal" Text="إختر المخالفة"
                                                                Width="90px" meta:resourcekey="lblProjectResource1" ></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="ddlPenality" runat="server" 
                                                                SkinID="DropDownList_LargNormal" meta:resourcekey="ddlPenalityResource1" >
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                </table>
                                            ...
                                            <td style="vertical-align: top" class="style2">
                                                <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="ddlPenality"
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                ...
                                                <asp:LinkButton ID="LinkButton_Absent" runat="server" SkinID="LinkButton_DefaultBold"
                                                    Text="حفظ المخالفة" ValidationGroup="G" meta:resourcekey="LinkButton_AbsentResource1" 
                                                    ></asp:LinkButton>
                                            </td>
                                        </tr>
                                        <tr>
