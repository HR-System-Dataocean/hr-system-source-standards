<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmPreparedPeriods.aspx.vb"
    Inherits="frmPreparedPeriods" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
...
<head runat="server">
    <title>* Venus Payroll * ~Prepared Periods</title>
...
<body style="height: 100%; margin: 0; padding: 0;">
    <form id="frmPreparedPeriods" runat="server" defaultbutton="ImageButton1">
 ...
 <td class="LabelArea">
                  <td class="LabelArea">
    <asp:Label ID="LblHasBankNo" runat="server" Style="margin-right: 20px; width: 21%; font-size: small" Text="موظفين ليس لهم حساب بنكي " SkinID="TextBox_LargeNormalC"
        meta:resourcekey="LblHasBankNoResource1"></asp:Label>
   <asp:CheckBox ID="ChkHasBankNo" runat="server" />
</td>
