...
Partial Class frmEvalSPoints
    Inherits MainPage
#Region "Public Decleration"
    Private ClsSPointsList As ClsEval_SPointsList
...
#Region "Protected Sub"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ClsSPointsList = New ClsEval_SPointsList(Me.Page)
        Dim ClsObjects As New Clssys_Objects(Page)
        Dim ClsSearchs As New Clssys_Searchs(Page)
        Dim SearchID As Integer = 0
        Try
            Dim clsSearchsColumns As New Clssys_SearchsColumns(Page)
            If ClsObjects.Find(" Code='" & ClsSPointsList.Table.Trim & "'") Then
            ...
            If Not IsPostBack Then
                Page.Session.Add("ConnectionString", ClsSPointsList.ConnectionString)
                ClsSPointsList.AddOnChangeEventToControls("frmEvalSPoints", Page, UltraWebTab1)
            ...
            If (txtCode.Text <> "") Then
                ClsSPointsList.Find(" Code='" & txtCode.Text & "'")
                IntrecordID = ClsSPointsList.ID
        ...
        Catch ex As Exception
            ...
            mErrorHandler.RecordExceptions_DataBase("", ex, Err.Number, ClsSPointsList.RegUserID, Venus.Shared.ErrorsHandler.eRecordingType.System_DataBase)
    ...
    Protected Sub ImageButton_Command(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.CommandEventArgs) Handles ImageButton_Save.Command, ImageButton_SaveN.Command, LinkButton_SaveN.Command, ImageButton_New.Command, ImageButton_Print.Command, ImageButton_Properties.Command, LinkButton_Properties.Command, ImageButton_Remarks.Command, LinkButton_Remarks.Command, ImageButton_Last.Command, ImageButton_Next.Command, ImageButton_Back.Command, ImageButton_First.Command, ImageButton_Delete.Command
        ...
        Dim ObjNavigationHandler As New Venus.Shared.Web.NavigationHandler(ClsSPointsList.ConnectionString)
        Select Case e.CommandArgument
            ...
            Case "New"
                AfterOperation()
            Case "Delete"
                ClsSPointsList.Delete("Code='" & txtCode.Text & "'")
                AfterOperation()
            Case "Property"
                ClsSPointsList.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmPropertyScreen.aspx?ID=" & ClsSPointsList.ID & "&TableName=" & ClsSPointsList.Table, 477, 313, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Property", False)
            Case "Remarks"
                ClsSPointsList.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmRemarks.aspx?ID=" & ClsSPointsList.ID & "&TableName=" & ClsSPointsList.Table, 410, 210, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Remarks", False)
            Case "Print"
            ...
            Case "First"
                ClsSPointsList.Find("Code='" & txtCode.Text & "'")
                ClsSPointsList.FirstRecord()
                GetValues(ClsSPointsList)
            Case "Previous"
                ClsSPointsList.Find("Code='" & txtCode.Text & "'")
                If Not ClsSPointsList.previousRecord() Then
                    ClsSPointsList.Find("Code='" & txtCode.Text & "'")
            ...
            Case "Next"
                ClsSPointsList.Find("Code='" & txtCode.Text & "'")
                If Not ClsSPointsList.NextRecord() Then
                    ClsSPointsList.Find("Code='" & txtCode.Text & "'")
...
#Region "Private Functions"
    Private Function SavePart() As Boolean
        Dim StrMode As String = Request.QueryString.Item("Mode")
        ClsSPointsList = New ClsEval_SPointsList(Page)

        Try
            ClsSPointsList.Find("Code='" & txtCode.Text & "'")

            If ClsSPointsList.ID > 0 Then
                If Not AssignValue(ClsSPointsList) Then
                    Exit Function
                End If
                ClsSPointsList.Update("Code='" & txtCode.Text & "'")
            ...
            clsMainOtherFields.CollectDataAndSave(value.Text, ClsSPointsList.Table, ClsSPointsList.ID)
            value.Text = ""
            Return True
        Catch ex As Exception
            Return False
        End Try
    End Function
    Private Function AssignValue(ByRef ClsSPointsList As ClsEval_SPointsList) As Boolean
        Try
            With ClsSPointsList
                .Code = txtCode.Text
        ...
        End Try
    End Function
    Private Function GetValues(ByVal ClsSPointsList As ClsEval_SPointsList) As Boolean
        ...
        Try
            ...
            With ClsSPointsList
                ...
                If Page.IsPostBack Then
                    CreateOtherFields(ClsSPointsList.ID)
                End If
            End With
            Return True
        Catch ex As Exception
    ...
    Private Function CheckCode() As Boolean
        ...
        Try
            ClsSPointsList.Find("Code='" & txtCode.Text & "'")
            IntId = ClsSPointsList.ID
            txtEngName.Focus()
            If ClsSPointsList.ID > 0 Then
                GetValues(ClsSPointsList)
                StrMode = "E"
            Else
                If ClsSPointsList.CheckRecordExistance(" Code='" & txtCode.Text & "'") Then
                    txtCode.Text = ""
                    txtCode.Focus()
                End If
            ...
            End If
            SetToolBarDefaults()
            SetToolBarPermission(Me, ClsSPointsList.ConnectionString, ClsSPointsList.DataBaseUserRelatedID, ClsSPointsList.GroupID, StrMode)
            SetToolBarRecordPermission(Me, ClsSPointsList.ConnectionString, ClsSPointsList.DataBaseUserRelatedID, ClsSPointsList.GroupID, ClsSPointsList.Table, IntId)
    ...
    Private Sub LoadDataUpdateSchedules(ByVal formName As String)
        ...
        ClsSPointsList = New ClsEval_SPointsList(Me.Page)
        ClsSPointsList.Find(" code = '" & txtCode.Text & "'")
        Dim recordID As Integer = ClsSPointsList.ID
        If (recordID > 0) Then
    ...
    Private Function CreateOtherFields(ByVal IntRecordID As Integer)
        ...
        If clsMainOtherFields.CheckOtherFieldsButton(Me.Page, ClsSPointsList.Table) = True Then
            Dim StrTablename As String
            ClsSPointsList = New ClsEval_SPointsList(Me)
            StrTablename = ClsSPointsList.Table
