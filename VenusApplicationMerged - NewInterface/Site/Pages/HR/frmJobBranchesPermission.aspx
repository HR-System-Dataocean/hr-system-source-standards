<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmJobBranchesPermission.aspx.vb"
    Inherits="frmJobBranchesPermission" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" ResponseEncoding="UTF-8" %>
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmJobBranchesPermission" runat="server">
                                                ...
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                         <td class="SeparArea">
                                                          ...
                                                          <td>
                                                                       <asp:textbox ID="TxtPositionCode" runat="server" autopostback="true" >
    </asp:textbox>
    <igtxt:WebImageButton ID="WebImageButton5" runat="server" AutoSubmit="False" Height="10px"
                            ...
                            <Appearance>
                                <Image Url="./Img/forum_search.gif" />
                                                        ...
                                                        <td>
                                                          <asp:textbox ID="TxtPositionName"  Width="260px" runat="server"  MaxLength="100"
                                                                AutoPostBack="false" meta:resourcekey="txtBirthDateResource1" >
    </asp:textbox>
                                                            </td>
                                                          <td class="spacearea">
                                                                ...
                                                                <Bands>
                                                                    <igtbl:UltraGridBand AllowSorting="No" meta:resourcekey="UltraGridBandResource1"
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <igtbl:UltraGridColumn BaseColumnName="BranchId" Key="BranchId" Hidden="True">
                                                                                <Header Caption="">
                                                                                </Header>
                                                                            ...
                                                                            <igtbl:UltraGridColumn AllowUpdate="No" BaseColumnName="Code" Key="Code"
                                                                             ...
                                                                             <igtbl:UltraGridColumn AllowUpdate="No" BaseColumnName="BranchName" Key="BranchName"
                                                                                meta:resourcekey="UltraGridColumnBranchName" Width="70%">
                                                                                <Header Caption="Branch Name">
                                                                                    <RowLayoutColumnInfo OriginX="2" />
                                                                                </Header>
                                                                                <CellStyle HorizontalAlign="Center">
                                                                                </CellStyle>
