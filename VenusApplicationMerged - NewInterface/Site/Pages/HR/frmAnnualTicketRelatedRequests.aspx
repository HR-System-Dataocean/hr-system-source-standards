<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmAnnualTicketRelatedRequests.aspx.vb"
    Inherits="frmAnnualTicketRelatedRequests" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
...
<head runat="server">
    <title>* Venus Payroll * ~Occurrence Variance Reporting Letters</title>
    ...
    <script type="text/javascript" id="igClientScript">
        ...
        function OpenPrintedScreen(v) {
            ...
            var win = window.open("../../Interfaces/frmReportsGridViewer.aspx?Language=false&Criteria=RequestSerial&preview=1&ReportCode=CF_146&sq0=''&v=" + v, "_NEW", "height=" + hight + ",width=" + width + ",resizable=0,menubar=0,toolbar=0,location=0,directories=0,scrollbars=0,status=0,center=0");
            win.focus();
        }
    </script>
    <style type="text/css">
...
<body style="margin: 0; padding: 0;">
    <form id="frmAnnualTicketRelatedRequests" runat="server" defaultbutton="Button1">
                                                ...
                                                <table style="width: 50%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="SeparArea">
                                                         ...
                                                         <td class="LabelArea">
     <asp:Label ID="LblTickectDate" runat="server" Width="90px" meta:resourcekey="LblTickectDateResource1"
         SkinID="Label_DefaultNormal" Text="تاريخ التذاكر"></asp:Label>
 </td>
 <td class="DataArea">
     <igsch:WebDateChooser ID="txtTickectDate" runat="server" BorderColor="#CCCCCC" BorderStyle="Solid"
         BorderWidth="1px" Height="18px" NullDateLabel="" Style="font-family: Tahoma;
         font-size: 8pt; font-weight: Normal; color: Black; border: solid 1px #CCCCCC"
         Width="130px">
         <AutoPostBack ValueChanged="True" />
 ...
 <td class="LabelArea">
    <asp:Label ID="lblDirection" Width="70px" runat="server" Text=" Direction"
        SkinID="Label_DefaultNormal" meta:resourcekey="lblDirectionResource1"></asp:Label>
</td>

  <td class="DataArea">
    <asp:TextBox ID="txtDirection" Width="150" runat="server" SkinID="TextBox_DefaultNormalC"
        ReadOnly="False" MaxLength="255" meta:resourcekey="txtDirectionResource1"
        TabIndex="1"></asp:TextBox>
  </td> 
                                                        </tr>
                                                    <tr>
 ...
 <td class="LabelArea">
    <asp:Label ID="LblAdultNo" Width="70px" runat="server" Text="No Of Adults"
        SkinID="Label_DefaultNormal" meta:resourcekey="LblAdultNoResource1"></asp:Label>
</td>

  <td class="DataArea">
    <asp:TextBox ID="TxtAdultNo" Width="150" runat="server" SkinID="TextBox_DefaultNormalC"
        ReadOnly="false" MaxLength="255" meta:resourcekey="TxtAdultNoResource1"
        TabIndex="1"></asp:TextBox>
  </td>
  <td class="LabelArea">
    <asp:Label ID="lblChildNo" Width="70px" runat="server" Text="No Of Children"
        SkinID="Label_DefaultNormal" meta:resourcekey="lblChildNoResource1"></asp:Label>
</td>

  <td class="DataArea">
    <asp:TextBox ID="TxtChiledNo" Width="150" runat="server" SkinID="TextBox_DefaultNormalC"
        ReadOnly="false" MaxLength="255" meta:resourcekey="TxtChiledNoResource1"
        TabIndex="1"></asp:TextBox>
  </td>
