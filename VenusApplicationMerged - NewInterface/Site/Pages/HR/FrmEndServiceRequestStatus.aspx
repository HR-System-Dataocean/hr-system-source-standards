<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmEndServiceRequestStatus.aspx.vb"
               ...
               AutoPostBack="True" meta:resourcekey="txtRequestTypeResource1" ReadOnly="true">
                                                    ...
                                                    <tr>
                                                      ...
                                                      <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="LblEOSDate" runat="server" Width="90px" SkinID="Label_DefaultNormal"
                                                                Text=" تاريخ نهاية الخدمة" meta:resourcekey="LblEOSDateResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="TxtEOSDateDate" runat="server" SkinID="TextBox_SmalltNormalc" meta:resourcekey="lbRemainValResource1"
                                                                TabIndex="1" ReadOnly="True"></asp:TextBox>
                                                        </td>
                                                           <td class="SeparArea">
                                                        </td>
                                            ...
                                            <%--        <tr>
                                                         <td class="LabelArea">
                                                            <asp:Label ID="Label4" runat="server" Width="100px" SkinID="Label_DefaultBold"
                                                                Text="مدة نهاية الخدمة :" meta:resourcekey="LblExecuseReasonResource1"></asp:Label>
                                                        </td>
                                                         <td class="LabelArea">
                                                            <asp:Label ID="Label6" runat="server" Width="30px" SkinID="Label_DefaultBold"
                                                                Text="سنة :" meta:resourcekey="LblExecuseReasonResource1"></asp:Label>
                                                        </td>
                                                         <td class="LabelArea">
                                                         ...
                                                         <td class="LabelArea">
                                                            <asp:Label ID="Label7" runat="server" Width="30px" SkinID="Label_DefaultBold"
                                                                Text="شهر :" meta:resourcekey="LblExecuseReasonResource1"></asp:Label>
                                                        </td>
                                                         <td class="LabelArea">
                                                         ...
                                                         <td class="LabelArea">
                                                            <asp:Label ID="Label8" runat="server" Width="30px" SkinID="Label_DefaultBold"
                                                                Text="يوم :" meta:resourcekey="LblExecuseReasonResource1"></asp:Label>
                                                        </td>
                                                         <td class="LabelArea">
...
<%--                                                     <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                         ...
                                                         <td>
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="TxtEOSReasons" runat="server" Width="200px" 
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <igtbl:UltraGridColumn BaseColumnName="Action"  DataType="System.String"
                                                                     ...
                                                                     <igtbl:UltraGridColumn BaseColumnName="ActionDate" DataType="System.DateTime"
                                                                        Format="dd/MM/yyyy hh:mm tt" Key="ActionDate" meta:resourcekey="ActionDateResource4"
                                                                        Width="15%">
                                                                     ...
                                                                     <igtbl:UltraGridColumn BaseColumnName="ConfirmedNoOfdays" DataType="System.String"
                                                                        Key="ConfirmedNoOfdays" meta:resourcekey="ConfirmedNoOfdaysResource4"
                                                                        Width="15%">
                                                                     ...
                                                                     <igtbl:UltraGridColumn BaseColumnName="ActionRemarks" DataType="System.String"
                                                                         Key="ActionRemarks" meta:resourcekey="ActionRemarksResource4"
                                                                        Width="20%">
