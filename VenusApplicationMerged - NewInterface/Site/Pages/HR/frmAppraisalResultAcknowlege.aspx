<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmAppraisalResultAcknowlege.aspx.vb"
...
<body style="margin: 0; padding: 0;">
    ...
    <td class="DataArea">
       <asp:TextBox ID="txtAppraisalName" runat="server" SkinID="TextBox_LargeNormalC"
    ...
    <td class="DataArea">
     <asp:Label ID="lblAcknowlege" runat="server" Text="تم العلم" SkinID="Label_DefaultNormal"  meta:resourcekey="lblAcknowlegeResource1" />
 <asp:RadioButton ID="chkAcknowlege" runat="server" GroupName="EvalType" CssClass="radio-option" autopostback="true" />
 <asp:Label ID="LblObjection" runat="server" Text="تسجيل اعتراض" SkinID="Label_DefaultNormal"  meta:resourcekey="LblObjectionResource1" />
 <asp:RadioButton ID="ChkObjection" runat="server" GroupName="EvalType" CssClass="radio-option" autopostback="true" />
 </td>
...
<tr>
     ...
     <td class="LabelArea">              
     <asp:Label ID="LblObjectionDetails" runat="server" Text="تفاصيل الاعتراض" SkinID="Label_DefaultNormal" meta:resourcekey="LblObjectionDetails"></asp:Label>
                 </td>
 <td colspan="3">
     <asp:TextBox ID="txtObjectionDetails" runat="server" TextMode="MultiLine" Rows="2" width="500px"/>
 </td>
             ...
             <td style="height: 10px" colspan="3">
                     ...
                     Key="EmployeeName" meta:resourcekey="EmployeeNameResource1"    Hidden="True">
