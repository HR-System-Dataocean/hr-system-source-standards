<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmNationalities.aspx.vb"
    Inherits="frmNationalities" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
...
<head runat="server">
    <title>* Venus Payroll * ~Nationalities</title>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="Label_Route" meta:resourcekey="Label_RouteResource1" runat="server"
                                                                SkinID="Label_DefaultNormal" Text="مسار السفر" Visible="False"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="ddlRoute" runat="server" SkinID="DropDownList_LargNormal" Visible="False">
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                </table>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="Label_TravelClass" meta:resourcekey="Label_ClassResource1" runat="server"
                                                                SkinID="Label_DefaultNormal" Text="درجة السفر" Visible="False"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="DropDownList_Class" runat="server" SkinID="DropDownList_LargNormal" Visible="False">
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                </table>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblIsMainNationality" runat="server" Text="الرئيسية" SkinID="Label_DefaultNormal"
                                                                meta:resourcekey="lblIsMainNationality"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:CheckBox ID="chkIsMainNationality" runat="server" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblTicketAmount" runat="server" Text="قيمة التذكره" SkinID="Label_DefaultNormal"
                                                                meta:resourcekey="lblIsMainNationality" Visible="False"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                           <asp:TextBox ID="txtTicketAmount" runat="server" SkinID="TextBox_LargeNormalrtl" MaxLength="255"
                                                                meta:resourcekey="txtTicketAmountResource1" Visible="False" ></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
