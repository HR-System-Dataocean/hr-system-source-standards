<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmRegions.aspx.vb" Inherits="frmRegions"
...
<head runat="server">
    <title>* Venus Payroll * ~Regions</title>
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmRegions" runat="server">
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblCountry" runat="server" Text="الدولة" SkinID="Label_DefaultNormal"
                                                        ...
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="ddlCountry" runat="server" SkinID="DropDownList_LargNormal"
