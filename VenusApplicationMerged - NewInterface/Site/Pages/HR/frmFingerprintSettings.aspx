<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmFingerprintSettings.aspx.vb" Inherits="frmFingerprintSettings"
...
<head runat="server">
    <title>* Venus Payroll * ~FingerprintSettings</title>
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmFingerprintSettings" runat="server">
                    ...
                    <td style="width: 100%; height: 60px; vertical-align: top" colspan="3">
                        <table style="width: 100%; height: 18px; vertical-align: top; border-bottom: 1px solid silver">
                            <tr>
                                ...
                                <td style="width: 80px">
                                    <asp:ImageButton ID="TestImageButton" Width="16px" Height="16px" runat="server"
                                        SkinID="HrProperties_Command" meta:resourcekey="ImageButton_PropertiesResource1"
                                        CommandArgument="Property" />
                                    <asp:LinkButton ID="TestLinkButton" runat="server" Text="Test" meta:resourcekey="LinkButton_PropertiesResource1"
                                        CommandArgument="Test"></asp:LinkButton>
                                </td>
                                                ...
                                                <td style="width: 47%; height: 16px; vertical-align: top">
                                                    <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                        <tr>
                                                            <td class="SeparArea"></td>
                                                            <td class="LabelArea">
                                                                <asp:Label ID="IsDefaultLabel" runat="server" meta:resourcekey="lblIsDefaultResource"
                                                                    SkinID="Label_DefaultNormal" Text="أساسي"></asp:Label>
                                                            </td>
                                                            <td class="DataArea">
                                                                <asp:CheckBox ID="IsDefaultCheckbox" runat="server" meta:resourcekey="IsDefaultCheckboxResource" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                ...
                                                <td style="width: 47%; height: 16px; vertical-align: top">
                                                    <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                        <tr>
                                                            <td class="SeparArea"></td>
                                                            <td class="LabelArea">
                                                                <asp:Label ID="ServerIPLabel" runat="server" Text="Server IP" SkinID="Label_DefaultNormal"
                                                                    meta:resourcekey="lblServerIPResource"></asp:Label>
                                                            </td>
                                                            <td class="DataArea">
                                                                <asp:TextBox ID="ServerIPTextBox" runat="server" SkinID="TextBox_LargeNormalrtl" MaxLength="255"
                                                                    meta:resourcekey="txFingerprinttDatabaseNameResource"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                ...
                                                <td style="width: 47%; height: 16px; vertical-align: top">
                                                    <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                        <tr>
                                                            <td class="SeparArea"></td>
                                                            <td class="LabelArea">
                                                                <asp:Label ID="FingerprintDatabaseNameLabel" runat="server" Text="اسم الداتا بيز" SkinID="Label_DefaultNormal"
                                                                    meta:resourcekey="lblFingerprintDatabaseNameResource"></asp:Label>
                                                            </td>
                                                            <td class="DataArea">
                                                                <asp:TextBox ID="FingerprintDatabaseNameTextBox" runat="server" SkinID="TextBox_LargeNormalrtl" MaxLength="255"
                                                                    meta:resourcekey="txFingerprinttDatabaseNameResource"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                ...
                                                <td style="width: 47%; height: 16px; vertical-align: top">
                                                    <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                        <tr>
                                                            <td class="SeparArea"></td>
                                                            <td class="LabelArea">
                                                                <asp:Label ID="FingerPrintTableNameLabel" runat="server" Text="اسم الجدول" SkinID="Label_DefaultNormal"
                                                                    meta:resourcekey="lblFingerPrintTableNameResource"></asp:Label>
                                                            </td>
                                                            <td class="DataArea">
                                                                <asp:TextBox ID="FingerPrintTableNameTextBox" runat="server" SkinID="TextBox_LargeNormalrtl" MaxLength="255"
                                                                    meta:resourcekey="txtTableNameResource"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                ...
                                                <td style="width: 47%; height: 16px; vertical-align: top">
                                                    <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                        <tr>
                                                            <td class="SeparArea"></td>
                                                            <td class="LabelArea">
                                                                <asp:Label ID="UserIdLabel" runat="server" Text="اسم عامود المستخدم" SkinID="Label_DefaultNormal"
                                                                    meta:resourcekey="lblUserIdColumnNameResource"></asp:Label>
                                                            </td>
                                                            <td class="DataArea">
                                                                <asp:TextBox ID="UserIdTextBox" runat="server" SkinID="TextBox_LargeNormalrtl" MaxLength="255"
                                                                    meta:resourcekey="txtColumnNameResource"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                ...
                                                <td style="width: 47%; height: 16px; vertical-align: top">
                                                    <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                        <tr>
                                                            <td class="SeparArea"></td>
                                                            <td class="LabelArea">
                                                                <asp:Label ID="CheckInOutLabel" runat="server" Text="اسم عامود التاريخ" SkinID="Label_DefaultNormal"
                                                                    meta:resourcekey="lblCheckInOutColumnNameResource"></asp:Label>
                                                            </td>
                                                            <td class="DataArea">
                                                                <asp:TextBox ID="CheckInOutTextBox" runat="server" SkinID="TextBox_LargeNormalrtl" MaxLength="255"
                                                                    meta:resourcekey="txtColumnNameResource"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    ...
                                                    <td style="width: 47%; height: 16px; vertical-align: top">
                                                        <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                            <tr>
                                                                <td class="SeparArea"></td>
                                                                <td class="LabelArea">
                                                                    <asp:Label ID="UsersTableNameLabel" runat="server" Text="اسم جدول المستخدمين" SkinID="Label_DefaultNormal"
                                                                        meta:resourcekey="lblUsersTableNameResource"></asp:Label>
                                                                </td>
                                                                <td class="DataArea">
                                                                    <asp:TextBox ID="UsersTableNameTextBox" runat="server" SkinID="TextBox_LargeNormalrtl" MaxLength="255"
                                                                        meta:resourcekey="txtColumnNameResource"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    ...
                                                    <td style="width: 47%; height: 16px; vertical-align: top">
                                                        <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                            <tr>
                                                                <td class="SeparArea"></td>
                                                                <td class="LabelArea">
                                                                    <asp:Label ID="UsersTableIdntityLabel" runat="server" Text="اسم عامود المعرف للمستخدمين" SkinID="Label_DefaultNormal"
                                                                        meta:resourcekey="lblUsersTableIdntityResource"></asp:Label>
                                                                </td>
                                                                <td class="DataArea">
                                                                    <asp:TextBox ID="UsersTableIdntityTextBox" runat="server" SkinID="TextBox_LargeNormalrtl" MaxLength="255"
                                                                        meta:resourcekey="txtColumnNameResource"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        ...
                                                        <td style="width: 47%; height: 16px; vertical-align: top">
                                                            <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                                <tr>
                                                                    <td class="SeparArea"></td>
                                                                    <td class="LabelArea">
                                                                        <asp:Label ID="UserMatchColumnNameLabel" runat="server" Text="اسم عامود ربط المستخدم" SkinID="Label_DefaultNormal"
                                                                            meta:resourcekey="lblUserMatchColumnNameResource"></asp:Label>
                                                                    </td>
                                                                    <td class="DataArea">
                                                                        <asp:TextBox ID="UserMatchColumnNameTextBox" runat="server" SkinID="TextBox_LargeNormalrtl" MaxLength="255"
                                                                            meta:resourcekey="txtColumnNameResource"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                            </table>
