<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmDocumentTypesGroup.aspx.vb" Inherits="frmDocumentTypesGroup"
...
<head runat="server">
    <title>* Venus Payroll * ~DocumentTypesGroup</title>
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmDocumentTypesGroup" runat="server">
                                                    ...
                                                    <tr>
                                                        <td style="width: 40%; height: 16px; vertical-align: middle;">
                                                            <asp:Label ID="lblRegUser" runat="server" Text="سجل بواسطة" SkinID="Label_CopyRightsBold"
                                                                meta:resourcekey="lblRegUserResource1" Height="85px"></asp:Label>
                                                        </td>
                                                        <td style="width: 60%; height: 16px; vertical-align: middle;">
