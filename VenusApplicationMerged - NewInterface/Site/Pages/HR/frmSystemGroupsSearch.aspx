<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmSystemGroupsSearch.aspx.vb"
...
<head runat="server">
    <title>* Venus Payroll * ~System Groups Srearch </title>
                                    ...
                                    <table style="width: 100%; height: 100%; min-height: 350px; vertical-align: top"
                                        ...
                                        <tr>
                                            <td style="width: 100%; vertical-align: top;">
                                                <igtbl:UltraWebGrid  Browser="UpLevel"   ID="UwgSearchUsers" runat="server" EnableAppStyling="True" Height="100%"
                                                        ...
                                                        <igtbl:UltraGridBand meta:resourcekey="UltraGridBandResource1">
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <igtbl:UltraGridColumn AllowRowFiltering="False" CellButtonDisplay="Always" Key="Groups"
                                                                    Type="Button" Width="7.5%" meta:resourcekey="UltraGridColumnResource7" Hidden="True">
                                                                ...
                                                                <igtbl:UltraGridColumn BaseColumnName="ID" Hidden="True" Key="ID" Width="0px" meta:resourcekey="UltraGridColumnResource24">
                                                                    <Header>
