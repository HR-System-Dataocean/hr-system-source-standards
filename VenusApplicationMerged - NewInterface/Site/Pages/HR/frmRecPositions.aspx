<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmRecPositions.aspx.vb"
    Inherits="frmRecPositions" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmRecPositions" runat="server">
                                                ...
                                                <table style="width: 100%; height: 30px; vertical-align: bottom; border-bottom: 1px solid black"
                                                    ...
                                                    <tr>
                                                        <td style="vertical-align: bottom">
                                                            <asp:Label ID="Label_Title1" runat="server" Text="الإعدادات"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblDepartment" runat="server" 
                                                                meta:resourcekey="lblDepartmentResource1" SkinID="Label_DefaultNormal" 
                                                                Text="القسم "></asp:Label>
                                                            <asp:Label ID="Label_Star2" runat="server" 
                                                                meta:resourcekey="Label_Star1Resource1" Style="color: #FF0000" Text="*"></asp:Label>
                                                            </td>
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="ddlDepartment" runat="server" 
                                                                meta:resourcekey="ddlDepartmentResource1" SkinID="DropDownList_LargNormal">
                                                            </asp:DropDownList>
                                                            </td>
                                                    </tr>
                                                </table>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblRefCode" runat="server" 
                                                                meta:resourcekey="lblRefCodeResource1" SkinID="Label_DefaultNormal" 
                                                                Text="الكود المشار اليه"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="txtRefCode" runat="server" AutoPostBack="True" MaxLength="30" 
                                                                meta:resourcekey="txtRefCodeResource1" SkinID="TextBox_SmalltNormalC"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblBranch" runat="server" 
                                                                meta:resourcekey="lblParentBranchResource1" SkinID="Label_DefaultNormal" 
                                                                Text=" الفرع "></asp:Label>
                                                            <asp:Label ID="Label_Star3" runat="server" 
                                                                meta:resourcekey="Label_Star1Resource1" Style="color: #FF0000" Text="*"></asp:Label>
                                                            </td>
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="ddlBranch" runat="server" 
                                                                meta:resourcekey="ddl_PrantBranchResource1" SkinID="DropDownList_LargNormal">
                                                            </asp:DropDownList>
                                                            </td>
                                                    </tr>
                                                </table>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblPositionQTY" runat="server" 
                                                                meta:resourcekey="lblPositionQTYResource1" SkinID="Label_DefaultNormal" 
                                                                Text="عدد اماكن الوظائف"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <igtxt:WebNumericEdit ID="txtPositionQTY" runat="server" MaxLength="10" 
                                                                MaxValue="9999" meta:resourcekey="txtPositionQTYRecourcekey" MinValue="0" 
                                                                NullText="0" SkinID="WebNumericEdit_Fix" Width="130px">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblPosition" runat="server" 
                                                                meta:resourcekey="lblPositionResource1" SkinID="Label_DefaultNormal" 
                                                                Text="المركز الوظيفى"></asp:Label>
                                                            <asp:Label ID="Label_Star4" runat="server" 
                                                                meta:resourcekey="Label_Star1Resource1" Style="color: #FF0000" Text="*"></asp:Label>
                                                            </td>
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="ddlRefPosition" runat="server" 
                                                                meta:resourcekey="ddlRefPositionResource1" SkinID="DropDownList_LargNormal">
                                                            </asp:DropDownList>
                                                            </td>
                                                    </tr>
                                                </table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblStatus" runat="server" meta:resourcekey="lblStatusResource1" 
                                                                SkinID="Label_DefaultNormal" Text="الحالة"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblGStartDate" runat="server" 
                                                                meta:resourcekey="lblGStartDateResource1" SkinID="Label_DefaultNormal" 
                                                                Text="البداية بالتاريخ الميلادى"></asp:Label>
                                                            </td>
                                                        <td class="DataArea">
                                                            <igtxt:WebDateTimeEdit ID="txtGStartDate" runat="server" AutoPostBack="True" 
                                                                meta:resourcekey="txtGStartDateRecourcekey" SkinID="WebDateTimeEdit_Fix">
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblHStartDate" runat="server" 
                                                                meta:resourcekey="lblHStartDateResource1" SkinID="Label_DefaultNormal" 
                                                                Text="البداية بالتاريخ الهجرى"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <igtxt:WebDateTimeEdit ID="txtHStartDate" runat="server" AutoPostBack="True" 
                                                                meta:resourcekey="txtHStartDateRecourcekey" SkinID="WebDateTimeEdit_Fix">
                                                            </igtxt:WebDateTimeEdit>
                                                        </td>
                                                    </tr>
                                                </table>
