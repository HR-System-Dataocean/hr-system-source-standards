<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmPaySlipRequest.aspx.vb"
    Inherits="FrmPaySlipRequest" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
...
<head runat="server">
    <title>* Venus Payroll * ~ PaySlip Request</title>
    ...
    <script type="text/javascript" id="igClientScript">
        ...
        function OpenPrintedScreen(v) {
            ...
            var win = window.open("../../Interfaces/frmReportsGridViewer.aspx?Language=false&Criteria=RequestSerial&preview=1&ReportCode=CF_135&sq0=''&v=" + v, "_NEW", "height=" + hight + ",width=" + width + ",resizable=0,menubar=0,toolbar=0,location=0,directories=0,scrollbars=0,status=0,center=0");
            win.focus();
        }
    </script>
    <style type="text/css">
...
<body style="margin: 0; padding: 0;">
            ...
            <tr>
                <td class="Details">
                    <igtab:UltraWebTab ID="UltraWebTab1" runat="server" EnableAppStyling="True" SkinID="Default"
                        ...
                        <Tabs>
                            <igtab:Tab Text="PaySlip Request" meta:resourcekey="TabResource1">
                                <ContentTemplate>
    ...
    <td class="DataArea">
       ...
       <td class="LabelArea">
           <asp:Label ID="lblRecipient" Width="120px" runat="server" Text=" recipient"
               SkinID="Label_DefaultNormal" meta:resourcekey="lblRecipientResource1"></asp:Label>
       </td>
       <td class="DataArea">
           <asp:TextBox ID="TxtRecipient" runat="server" Height="30px" Width="600px" 
