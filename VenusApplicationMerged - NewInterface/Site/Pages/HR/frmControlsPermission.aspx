<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmControlsPermission.aspx.vb"
    Inherits="frmControlsPermission" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
...
<head runat="server">
    <title>* Venus Payroll * ~Controls Permission</title>
    ...
    <script language="javascript" src="Scripts/app_controlspermissions.js"></script>
</head>
<body style="height: 100%; margin: 0; padding: 0;">
    <form id="frmControlsPermission" runat="server">
    <div runat="server" id="DIV" style="background-color: #BEDCFF;">
                            ...
                            <igtab:Tab Text="عام" meta:resourcekey="TabResource1">
                                <ContentTemplate>
                                    <table style="width: 100%; height: 100%; min-height: 350px; vertical-align: top"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 30%;">
                                                            <asp:Label ID="lblForms" runat="server" Text="الشاشة" SkinID="Label_DefaultNormal"
                                                                meta:resourcekey="lblFormsResource1"></asp:Label>
                                                        </td>
                                                        <td style="width: 40%;">
                                                            <asp:DropDownList ID="DdlForms" runat="server" meta:resourcekey="DdlFormsResource1"
                                                ...
                                                <table style="width: 100%; height: 30px;" cellspacing="6">
                                                    <tr>
                                                        <td>
                                                            ...
                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                            &nbsp;
                                                            <asp:CheckBox ID="chkNotVisible" runat="server" meta:resourcekey="chkNotVisibleResource1"
                                                                Text=" " />
                                                            &nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
                                                            <asp:CheckBox ID="chkReadOnly" runat="server" meta:resourcekey="chkReadOnlyResource1"
                                                                Text=" " />
                                                            &nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                            &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;
                                                        </td>
                                        ...
                                        <tr>
                                            <td style="width: 100%; vertical-align: auto" colspan="2">
                                                <igtbl:UltraWebGrid    Browser="UpLevel"  ID="UwgSearchUsers" runat="server" EnableAppStyling="False" Height="100%"
                                                    ...
                                                    <Bands>
                                                        <igtbl:UltraGridBand meta:resourcekey="UltraGridBandResource1">
                                                            ...
                                                            <Columns>
                                                                <igtbl:UltraGridColumn AllowUpdate="No" BaseColumnName="Code" Width="95px" meta:resourcekey="UltraGridColumnResource1">
                                                                ...
                                                                <igtbl:UltraGridColumn AllowUpdate="No" BaseColumnName="EngName" Width="230px" meta:resourcekey="UltraGridColumnResource2">
                                                                ...
                                                                <igtbl:UltraGridColumn AllowUpdate="No" BaseColumnName="ArbName" Width="230px" meta:resourcekey="UltraGridColumnResource3">
                                                                ...
                                                                <igtbl:UltraGridColumn AllowUpdate="Yes" BaseColumnName="IsEnabled" CellButtonDisplay="Always"
                                                                    DataType="System.Boolean" Hidden="True" Type="CheckBox" Width="80px" meta:resourcekey="UltraGridColumnResource4">
                                                                ...
                                                                <igtbl:UltraGridColumn AllowUpdate="Yes" Key="IsVisible" BaseColumnName="IsVisible"
                                                                    CellButtonDisplay="Always" DataType="System.Boolean" Type="CheckBox" Width="80px"
                                                                    meta:resourcekey="UltraGridColumnResource5">
                                                                    <HeaderStyle HorizontalAlign="Center" />
                                                                    <Header Caption="Not Visible">
                                                                ...
                                                                <igtbl:UltraGridColumn AllowUpdate="Yes" Key="IsReadOnly" BaseColumnName="IsReadOnly"
                                                                    CellButtonDisplay="Always" DataType="System.Boolean" Type="CheckBox" Width="80px"
                                                                    meta:resourcekey="UltraGridColumnResource6">
                                                                    <HeaderStyle HorizontalAlign="Center" />
                                                                    <Header Caption="ReadOnly">
        ...
        <asp:HiddenField ID="txtNotVisibleC" runat="server" />
        <asp:HiddenField ID="txtReadOnlyC" runat="server" />
