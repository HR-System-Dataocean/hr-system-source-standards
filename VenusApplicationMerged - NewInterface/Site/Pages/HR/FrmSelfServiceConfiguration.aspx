<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmSelfServiceConfiguration.aspx.vb"
...
<head runat="server">
    ...
    <script type="text/javascript" id="igClientScript">
        ...
        //function uwgSSConfiguration_ClickCellButtonHandler(gridName, cellId) {
        //        debugger
        //    var ultraTab = igtab_getTabById("UltraWebTab1");
        
        //    var Row = igtbl_getActiveRow(gridName);
        //    var UserTypeID = Row.getCellFromKey("UserType").getValue();
        //    //var x=Row.getcellfromkey().
        //    if (UserTypeID = 1) 
            
        //    {

        //        Row.cells("Position").allowediting =no
        //    }
    ...
    <div class="Div_MasterContainer" runat="server" id="DIV">
            ...
            <tr>
                <td class="Details">
                    <igtab:UltraWebTab ID="UltraWebTab1" runat="server" EnableAppStyling="True" SkinID="Default"
                        ...
                        <Tabs>
                            <igtab:Tab Text="اعدادات الخدمة الذاتية" meta:resourcekey="TabResource1">
                                <ContentTemplate>
                                            ...
                                            <td style="width: 55%; height: 16px; vertical-align: top">
                                                <table style="width: 50%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblFormCode" runat="server" Width="65px" SkinID="Label_DefaultNormal"
                                                                Text="نوع الطلب" meta:resourcekey="lblVacationTypeResource1"></asp:Label>
                                                        </td>
                                                        <td class="SeparArea">
                                                        </td>
                                                        <td class="SeparArea">
                                                        ...
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="ddlFormCode" Width="200px" runat="server" AutoPostBack="True" SkinID="DropDownList_smallNormal"
                                        ...
                                        <tr>
                                                <td style="height: 100%; vertical-align: auto" colspan="3">
                                                    <table style="width: 100%; vertical-align: auto" cellspacing="0">
                                                        <tr>
                                                            <td>
                                                                <igtbl:UltraWebGrid   Browser="UpLevel"  ID="uwgSSConfiguration" runat="server" EnableAppStyling="True"
                                                                    ...
                                                                    <Bands>
                                                                        <igtbl:UltraGridBand meta:resourcekey="UltraGridBandResource1" AllowAdd="Yes">
                                                                            ...
                                                                            <Columns>
                                                                                ...
                                                                                <igtbl:UltraGridColumn BaseColumnName="UserType" meta:resourcekey="AcceptUltraGridBandResource1" Key="UserType" DataType="System.Int32"
                                                                                    Type="DropDownList" Width="20%" AllowUpdate="Yes">
                                                                                    <Header Caption="نوع الموافقة">
                                                                                ...
                                                                                <igtbl:UltraGridColumn BaseColumnName="Position" Key="Position" Width="20%" meta:resourcekey="jopUltraGridBandResource1"
                                                                                    Type="DropDownList">

                                                                                    <Header Caption="الدرجة الوظيفية">
                                                                                ...
                                                                                <igtbl:UltraGridColumn Width="20%" BaseColumnName="Employee" Key="Employee" meta:resourcekey="empUltraGridBandResource1" Type="DropDownList">
                                                                        ...
                                                                        <igtbl:UltraGridColumn Width="20%" BaseColumnName="Rank" Key="Rank" meta:resourcekey="arrangeUltraGridBandResource1"
                                                                                    Type="DropDownList">
                                                                                    <Header Caption="الترتيب">
                                                                                        <RowLayoutColumnInfo OriginX="2" />
                                                                                    </Header>
                                                                                    <CellStyle HorizontalAlign="Center">
                                                                                    </CellStyle>
                                                                                ...
                                                                                <igtbl:UltraGridColumn BaseColumnName="CanEdit" DataType="System.Boolean" Key="IsDayOff" meta:resourcekey="CanEditUltraGridBandResource1"
                                                                                    Width="20%" Type="CheckBox" AllowUpdate="Yes">
                                                                                    <Header Caption="يمكنه التعديل">
                                                                                ...
                                                                                <igtbl:UltraGridColumn BaseColumnName="IsFinal" DataType="System.Boolean" Key="IsDayOff" meta:resourcekey="forEverUltraGridBandResource1"
                                                                                    Width="20%" Type="CheckBox" AllowUpdate="Yes">
                                                                                    <Header Caption="نهائي">
                                                                                        <RowLayoutColumnInfo OriginX="5" />
                                                                                    </Header>
                                                                                    <HeaderStyle HorizontalAlign="Center" />
                                                                                    <CellStyle HorizontalAlign="Center">
                                                                                 ...
                                                                                 <igtbl:UltraGridColumn BaseColumnName="ApplyForAll" DataType="System.Boolean" Key="IsDayOff" meta:resourcekey="allapliedUltraGridBandResource1"
     Width="20%" Type="CheckBox" AllowUpdate="Yes">
     <Header Caption="يطبق علي الجميع">
         <RowLayoutColumnInfo OriginX="10" />
     </Header>
     <HeaderStyle HorizontalAlign="Center" />
     <CellStyle HorizontalAlign="Center">
     ...
     <Footer>
         <RowLayoutColumnInfo OriginX="10" />
                                                                                 ...
                                                                                 <igtbl:UltraGridColumn BaseColumnName="CanBeCanceledInThisLevel" DataType="System.Boolean" Key="CanBeCanceledInThisLevel" meta:resourcekey="CanBeCanceledInThisLevelResource1"
     Width="20%" Type="CheckBox" AllowUpdate="Yes">
     <Header Caption="يمكن الالغاء في هذه المرحلة">
         <RowLayoutColumnInfo OriginX="10" />
     </Header>
     <HeaderStyle HorizontalAlign="Center" />
     <CellStyle HorizontalAlign="Center">
