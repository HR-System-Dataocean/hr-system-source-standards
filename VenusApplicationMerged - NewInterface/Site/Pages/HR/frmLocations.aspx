<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmLocations.aspx.vb" Inherits="frmLocations"
...
<head runat="server">
    <title>* Venus Payroll * ~Locations</title>
    ...
    <script src="../../Common/Script/JQuery/Float.js"></script>
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    ...
    <div class="Div_MasterContainer" runat="server" id="DIV">
                        ...
                        <tr>
                            ...
                            <td style="width: 24px">
                                <asp:ImageButton ID="ImageButton_Save" Width="16px" Height="16px" runat="server"
                                    CommandArgument="Save" SkinID="HrSave_Command" meta:resourcekey="ImageButton_SaveResource1"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblEngName" runat="server" Text="التوصيف إنجليزى" SkinID="Label_DefaultNormal"
                                                                meta:resourcekey="lblEngNameResource1" ForeColor="Red"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblCost1" runat="server" Width="80px" SkinID="Label_DefaultNormal"
                                                                    Text="1 مركز التكلفة" meta:resourcekey="lblCost1Resource1"></asp:Label>
                                                        </td>
                                                        <td class="DataAreawithsearch">
                                                            <asp:TextBox ID="TxtCostCenter1" Enabled="false" runat="server" SkinID="TextBox_SmalltNormalC" MaxLength="30" meta:resourcekey="txtCodeResource1" ></asp:TextBox>
                                                        </td>
                                                        <td class="search">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="Label2" runat="server" Width="80px" SkinID="Label_DefaultNormal"
                                                                    Text="2 مركز التكلفة" meta:resourcekey="lblCost2Resource1"></asp:Label>
                                                        </td>
                                                        <td class="DataAreawithsearch">
                                                            <asp:TextBox ID="TxtCostCenter2" Enabled="false" runat="server" SkinID="TextBox_SmalltNormalC" MaxLength="30" meta:resourcekey="txtCodeResource1" ></asp:TextBox>
                                                        </td>
                                                        <td class="search">
                                                            <table style="width:100%">
                                                            <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="Label3" runat="server" Width="80px" SkinID="Label_DefaultNormal"
                                                                    Text="3 مركز التكلفة" meta:resourcekey="lblCost3Resource1"></asp:Label>
                                                        </td>
                                                        <td class="DataAreawithsearch">
                                                            <asp:TextBox ID="TxtCostCenter3" Enabled="false" runat="server" SkinID="TextBox_SmalltNormalC" MaxLength="30" meta:resourcekey="txtCodeResource1" ></asp:TextBox>
                                                        </td>
                                                        <td class="search">
                                                            <table style="width:100%">
                                                            <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="Label4" runat="server" Width="80px" SkinID="Label_DefaultNormal"
                                                                    Text="4 مركز التكلفة" meta:resourcekey="lblCost4Resource1"></asp:Label>
                                                        </td>
                                                        <td class="DataAreawithsearch">
                                                            <asp:TextBox ID="TxtCostCenter4" Enabled="false" runat="server" SkinID="TextBox_SmalltNormalC" MaxLength="30" meta:resourcekey="txtCodeResource1" ></asp:TextBox>
                                                        </td>
                                                        <td class="search">
                                                            <table style="width:100%">
                                                            <tr>
      ...
      <td class="DataAreawithsearch">
          <asp:DropDownList ID="ddlDepartment" Enabled="false" runat="server" meta:resourcekey="ddlDepartmentResource1"
        SkinID="DropDownList_LargNormal" AutoPostBack="false">
    </asp:DropDownList>
      </td>
      <td class="search">
          <table style="width:100%">
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblBranches" runat="server" SkinID="Label_DefaultNormal" Text="الفرع"
                                                                meta:resourcekey="lblBranchesResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="DdlBranches" runat="server" SkinID="DropDownList_LargNormal"
                                                                Width="100%" meta:resourcekey="DdlBranchesResource1">
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                </table>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblCities" runat="server" SkinID="Label_DefaultNormal" Text="البلد"
                                                                meta:resourcekey="lblCitiesResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="DdlCities" runat="server" SkinID="DropDownList_LargNormal"
                                                                Width="100%" meta:resourcekey="DdlCitiesResource1">
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                </table>
