<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmAnnualVacationsRequestInternalAdmin.aspx.vb"
    Inherits="frmAnnualVacationsRequestInternalAdmin" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
            ...
            <tr>
                <td class="Details">
                    <igtab:UltraWebTab ID="UltraWebTab1" runat="server" EnableAppStyling="True" SkinID="Default"
                        ...
                        <Tabs>
                            <igtab:Tab Text="طلب اجازة سنوي طبي" meta:resourcekey="TabResource1">
                                <ContentTemplate>
                                                         ...
                                                         <td class="SeparArea">
                                                          ...
                                                          <td class="LabelArea">
                                                            <asp:Label ID="label2" Width="70px" runat="server" Text=" الموظف البديل"
                                                                SkinID="Label_DefaultNormal" meta:resourcekey="labelAlternativeResource1"></asp:Label>
                                                        </td>
                                                ...
                                                <table cellspacing="6" style="width: 100%; height: 30px; vertical-align: bottom;
                                                    ...
                                                    <tr>
                                                        <td style="vertical-align: top">
                                                            <asp:Label ID="Label1" runat="server" meta:resourcekey="LblRequestDetailsResource1" SkinID="Label_DefaultBold"
