<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmEmployeesVacationsAdvanceSettlementDependonVacation.aspx.vb"
    Inherits="frmEmployeesVacationsAdvanceSettlementDependonVacation" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
...
<body style="height: 100%; margin: 0; padding: 0;">
    <form id="frmEmployeesVacationsAdvanceSettlementDependonVacation" runat="server">
                                    ...
                                    <ContentTemplate>
                                        ...
                                        <table style="width: 100%; height: 100%; vertical-align: top" cellspacing="0">
                                           ...
                                           <asp:Label ID="lblVactionNetDays" runat="server" SkinID="Label_DefaultNormal" Text="Net days"
                                            ...
                                            <tr>
                                                <td style="width: 47%; height: 30px; vertical-align: top;">&nbsp;<asp:Label ID="Label_Title1" runat="server" meta:resourcekey="Label_Title1Resource1"
                                            ...
                                            <tr>
                                                <td style="width: 47%; height: 30px; vertical-align: top;">&nbsp;<asp:Label ID="Label11" runat="server"
