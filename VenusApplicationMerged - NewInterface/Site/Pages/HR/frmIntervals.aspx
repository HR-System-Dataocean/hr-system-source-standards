<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmIntervals.aspx.vb" Inherits="frmIntervals"
...
<head runat="server">
    <title>~* Venus Payroll * Intervals ~</title>
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmIntervals" runat="server">
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblNumber" runat="server" meta:resourcekey="lblNumberResource1" SkinID="Label_DefaultNormal"
                                                                Text="الرقم"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="txtNumber" runat="server" MaxLength="255" meta:resourcekey="txtNumberResource1"
