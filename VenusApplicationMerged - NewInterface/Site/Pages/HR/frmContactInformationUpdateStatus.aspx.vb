...
#Region "Private Functions"
    ...
    Private Sub CancelRequest(FormCode As String, RequestSerial As String)
        ...
        If CanbeCanceled Then
            ...
            UpdateCommandRank = "UPDATE SS_ContactInformationUpdate SET [RequestStautsTypeID] = 5 WHERE ID=" & RequestSerial & ""
            ...
            UpdateCommand = "update SS_RequestActions set seen=1 where ConfigID=" & ConfigID & " "
            SqlCommand = New SqlClient.SqlCommand
            SqlCommand.Connection = New SqlClient.SqlConnection(ConnStr)
            SqlCommand.CommandType = CommandType.Text
