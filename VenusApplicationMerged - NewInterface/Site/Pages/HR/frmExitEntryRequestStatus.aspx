<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmExitEntryRequestStatus.aspx.vb"
...
<body style="margin: 0; padding: 0;">
    ...
    <td class="SeparArea">
                                                        ...
                                                        <td class="LabelArea">
    <asp:Label ID="LblExitDate" runat="server" Width="90px" SkinID="Label_DefaultNormal"
        Text="Exit Date" meta:resourcekey="LblExitDateResource1"></asp:Label>
</td>
<td class="DataArea">
    <asp:TextBox ID="TxtExitDate" runat="server" SkinID="TextBox_SmalltNormalc" meta:resourcekey="lbRemainValResource1"
        TabIndex="1" ReadOnly="True"></asp:TextBox>
</td>
    <td class="LabelArea">
        <asp:Label ID="LblEntryDate" runat="server" Width="90px" SkinID="Label_DefaultNormal"
            Text=" Entry Date" meta:resourcekey="LblEntryDateResource1"></asp:Label>
    </td>
    <td class="DataArea">
        <asp:TextBox ID="TxtEntryDate" runat="server" SkinID="TextBox_SmalltNormalc" meta:resourcekey="lbRemainValResource1"
            TabIndex="1" ReadOnly="True"></asp:TextBox>
    </td>
       <td class="SeparArea">
    </td>
