...
#Region "Public Decleration"
    Private ClsCities As Clssys_Cities
...
#Region "Protected Sub"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        clsCities = New Clssys_Cities(Me.Page)
        Dim ClsCountries As New Clssys_Countries(Page)
        Dim ClsRegions As New Clssys_Regions(Page, "sys_Regions")
        Dim ClsObjects As New Clssys_Objects(Page)
        Dim ClsSearchs As New Clssys_Searchs(Page)
        Dim SearchID As Integer = 0
        Try
            Dim clsSearchsColumns As New Clssys_SearchsColumns(Page)
            If ClsObjects.Find(" Code='" & ClsCities.Table.Trim & "'") Then
            ...
            If Not IsPostBack Then
                Page.Session.Add("ConnectionString", ClsCities.ConnectionString)
                ClsCities.AddOnChangeEventToControls("frmCities", Page, UltraWebTab1)
            ...
            If (txtCode.Text <> "") Then
                ClsCities.Find(" Code='" & txtCode.Text & "'")
                IntrecordID = ClsCities.ID
        ...
        Catch ex As Exception
            ...
            mErrorHandler.RecordExceptions_DataBase("", ex, Err.Number, ClsCities.RegUserID, Venus.Shared.ErrorsHandler.eRecordingType.System_DataBase)
    ...
    Protected Sub ImageButton_Command(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.CommandEventArgs) Handles ImageButton_Save.Command, ImageButton_SaveN.Command, LinkButton_SaveN.Command, ImageButton_New.Command, ImageButton_Print.Command, ImageButton_Properties.Command, LinkButton_Properties.Command, ImageButton_Remarks.Command, LinkButton_Remarks.Command, ImageButton_Last.Command, ImageButton_Next.Command, ImageButton_Back.Command, ImageButton_First.Command, ImageButton_Delete.Command
        ...
        Dim ObjNavigationHandler As New Venus.Shared.Web.NavigationHandler(ClsCities.ConnectionString)
        Select Case e.CommandArgument
            ...
            Case "New"
                AfterOperation()
            Case "Delete"
                ClsCities.Delete("Code='" & txtCode.Text & "'")
                AfterOperation()
            Case "Property"
                If ClsCities.Find("Code='" & txtCode.Text & "'") Then
                    Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmPropertyScreen.aspx?ID=" & ClsCities.ID & "&TableName=" & ClsCities.Table, 477, 313, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Property", False)
                End If
            Case "Remarks"
                If ClsCities.Find("Code='" & txtCode.Text & "'") Then
                    Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmRemarks.aspx?ID=" & ClsCities.ID & "&TableName=" & ClsCities.Table, 410, 210, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Remarks", False)
                End If
            ...
            Case "First"
                ClsCities.Find("Code='" & txtCode.Text & "'")
                ClsCities.FirstRecord()
                GetValues(ClsCities)
            Case "Previous"
                ClsCities.Find("Code='" & txtCode.Text & "'")
                If Not ClsCities.previousRecord() Then
                    ClsCities.Find("Code='" & txtCode.Text & "'")
            ...
            Case "Next"
                ClsCities.Find("Code='" & txtCode.Text & "'")
                If Not ClsCities.NextRecord() Then
                    ClsCities.Find("Code='" & txtCode.Text & "'")
...
#Region "Private Functions"
    Private Function SavePart() As Boolean
        Dim StrMode As String = Request.QueryString.Item("Mode")
        ClsCities = New Clssys_Cities(Page)

        Try
            ClsCities.Find("Code='" & txtCode.Text & "'")

            If ClsCities.ID > 0 Then
                If Not AssignValue(ClsCities) Then
                    Exit Function
                End If
                ClsCities.Update("Code='" & txtCode.Text & "'")
            ...
            clsMainOtherFields.CollectDataAndSave(value.Text, ClsCities.Table, ClsCities.ID)
            value.Text = ""
            Return True
        Catch ex As Exception
            Return False
        End Try
    End Function
    Private Function AssignValue(ByRef ClsCities As Clssys_Cities) As Boolean
        Try
            With ClsCities
                .Code = txtCode.Text
        ...
        End Try
    End Function
    Private Function GetValues(ByVal ClsCities As Clssys_Cities) As Boolean
        ...
        Try
            ...
            With ClsCities
                ...
                If Not ClsCities.RegUserID = Nothing Then
                    ClsUser.Find("ID=" & ClsCities.RegUserID)
                End If
    ...
    Private Function CheckCode() As Boolean
        ...
        Try
            ...
            If ClsCities.ID > 0 Then
                ...
                StrMode = "E"
            Else
                If ClsCities.CheckRecordExistance(" Code='" & txtCode.Text & "'") Then
                    txtCode.Text = ""
                    txtCode.Focus()
                End If
            ...
            End If
            SetToolBarDefaults()
            SetToolBarPermission(Me, ClsCities.ConnectionString, ClsCities.DataBaseUserRelatedID, ClsCities.GroupID, StrMode)
            SetToolBarRecordPermission(Me, ClsCities.ConnectionString, ClsCities.DataBaseUserRelatedID, ClsCities.GroupID, ClsCities.Table, IntId)
    ...
    Private Sub LoadDataUpdateSchedules(ByVal formName As String)
        ...
        ClsCities = New Clssys_Cities(Me.Page)
        ClsCities.Find(" code = '" & txtCode.Text & "'")
        Dim recordID As Integer = ClsCities.ID
        If (recordID > 0) Then
    ...
    Private Function CreateOtherFields(ByVal IntRecordID As Integer)
        ...
        If clsMainOtherFields.CheckOtherFieldsButton(Me.Page, ClsCities.Table) = True Then
            Dim StrTablename As String
            ClsCities = New Clssys_Cities(Me)
            StrTablename = ClsCities.Table
