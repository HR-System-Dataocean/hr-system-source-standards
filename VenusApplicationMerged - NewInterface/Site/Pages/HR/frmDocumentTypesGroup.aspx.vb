...
Partial Class frmDocumentTypesGroup
    Inherits MainPage
#Region "Public Decleration"
    Private ClsDocumentTypesGroup As Clssys_DocumentTypesGroup
...
#Region "Protected Sub"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ClsDocumentTypesGroup = New Clssys_DocumentTypesGroup(Me.Page)
        Dim ClsObjects As New Clssys_Objects(Page)
        Dim ClsSearchs As New Clssys_Searchs(Page)
        Dim SearchID As Integer = 0
        Try
            Dim clsSearchsColumns As New Clssys_SearchsColumns(Page)
            If ClsObjects.Find(" Code='" & ClsDocumentTypesGroup.Table.Trim & "'") Then
            ...
            If Not IsPostBack Then
                Page.Session.Add("ConnectionString", ClsDocumentTypesGroup.ConnectionString)
                ClsDocumentTypesGroup.AddOnChangeEventToControls("frmDocumentTypesGroup", Page, UltraWebTab1)
            ...
            If (txtCode.Text <> "") Then
                ClsDocumentTypesGroup.Find(" Code='" & txtCode.Text & "'")
                IntrecordID = ClsDocumentTypesGroup.ID
        ...
        Catch ex As Exception
            ...
            mErrorHandler.RecordExceptions_DataBase("", ex, Err.Number, ClsDocumentTypesGroup.RegUserID, Venus.Shared.ErrorsHandler.eRecordingType.System_DataBase)
    ...
    Protected Sub ImageButton_Command(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.CommandEventArgs) Handles ImageButton_Save.Command, ImageButton_SaveN.Command, LinkButton_SaveN.Command, ImageButton_New.Command, ImageButton_Print.Command, ImageButton_Properties.Command, LinkButton_Properties.Command, ImageButton_Remarks.Command, LinkButton_Remarks.Command, ImageButton_Last.Command, ImageButton_Next.Command, ImageButton_Back.Command, ImageButton_First.Command, ImageButton_Delete.Command
        ...
        Dim ObjNavigationHandler As New Venus.Shared.Web.NavigationHandler(ClsDocumentTypesGroup.ConnectionString)
        Select Case e.CommandArgument
            ...
            Case "Delete"
                ...
                ClsDocumentTypesGroup.Delete("Code='" & txtCode.Text & "'")
                AfterOperation()
            Case "Property"
                ClsDocumentTypesGroup.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmPropertyScreen.aspx?ID=" & ClsDocumentTypesGroup.ID & "&TableName=" & ClsDocumentTypesGroup.Table, 477, 313, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Property", False)
            Case "Remarks"
                ClsDocumentTypesGroup.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmRemarks.aspx?ID=" & ClsDocumentTypesGroup.ID & "&TableName=" & ClsDocumentTypesGroup.Table, 410, 210, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Remarks", False)
            Case "Print"
            ...
            Case "First"
                ClsDocumentTypesGroup.Find("Code='" & txtCode.Text & "'")
                ClsDocumentTypesGroup.FirstRecord()
                GetValues(ClsDocumentTypesGroup)
            Case "Previous"
                ClsDocumentTypesGroup.Find("Code='" & txtCode.Text & "'")
                If Not ClsDocumentTypesGroup.previousRecord() Then
                    ClsDocumentTypesGroup.Find("Code='" & txtCode.Text & "'")
            ...
            Case "Next"
                ClsDocumentTypesGroup.Find("Code='" & txtCode.Text & "'")
                If Not ClsDocumentTypesGroup.NextRecord() Then
                    ClsDocumentTypesGroup.Find("Code='" & txtCode.Text & "'")
            ...
            Case "Last"
                ClsDocumentTypesGroup.Find("Code='" & txtCode.Text & "'")
                ClsDocumentTypesGroup.LastRecord()
                GetValues(ClsDocumentTypesGroup)
        End Select
    End Sub
...
#Region "Private Functions"
    Private Function SavePart() As Boolean
        Dim StrMode As String = Request.QueryString.Item("Mode")
        ClsDocumentTypesGroup = New Clssys_DocumentTypesGroup(Page)

        Try
            ClsDocumentTypesGroup.Find("Code='" & txtCode.Text & "'")

            If ClsDocumentTypesGroup.ID > 0 Then
                If Not AssignValue(ClsDocumentTypesGroup) Then
                    Exit Function
                End If
                ClsDocumentTypesGroup.Update("Code='" & txtCode.Text & "'")

            Else
                If Not AssignValue(ClsDocumentTypesGroup) Then
                    Exit Function
                End If
                ClsDocumentTypesGroup.Save()

            End If

            ClsDocumentTypesGroup.Find("Code='" & txtCode.Text & "'")

            clsMainOtherFields.CollectDataAndSave(value.Text, ClsDocumentTypesGroup.Table, ClsDocumentTypesGroup.ID)
            value.Text = ""
            Return True
        Catch ex As Exception
            Return False
        End Try
    End Function
    Private Function AssignValue(ByRef ClsDocumentTypesGroup As Clssys_DocumentTypesGroup) As Boolean
        Try
            With ClsDocumentTypesGroup
                .Code = txtCode.Text
        ...
        End Try
    End Function
    Private Function GetValues(ByVal ClsDocumentTypesGroup As Clssys_DocumentTypesGroup) As Boolean
        ...
        Try
            ...
            With ClsDocumentTypesGroup
                ...
                If Page.IsPostBack Then
                    CreateOtherFields(ClsDocumentTypesGroup.ID)
                End If
            End With
            Return True
        Catch ex As Exception
    ...
    Private Function SetToolbarSetting(ByVal ptrType As String, ByVal ClsClass As Object, ByVal intID As Integer) As Boolean
        Try
            Select Case ptrType
                ...
                Case "D"
                    ClsDocumentTypesGroup.Find("ID=" & intID)
                    GetValues(ClsDocumentTypesGroup)
    ...
    Private Function CheckCode() As Boolean
        ...
        Try
            ClsDocumentTypesGroup.Find("Code='" & txtCode.Text & "'")
            IntId = ClsDocumentTypesGroup.ID
            txtEngName.Focus()
            If ClsDocumentTypesGroup.ID > 0 Then
                GetValues(ClsDocumentTypesGroup)
                StrMode = "E"
            Else
                If ClsDocumentTypesGroup.CheckRecordExistance(" Code='" & txtCode.Text & "'") Then
                    txtCode.Text = ""
                    txtCode.Focus()
                End If
            ...
            End If
            SetToolBarDefaults()
            SetToolBarPermission(Me, ClsDocumentTypesGroup.ConnectionString, ClsDocumentTypesGroup.DataBaseUserRelatedID, ClsDocumentTypesGroup.GroupID, StrMode)
            SetToolBarRecordPermission(Me, ClsDocumentTypesGroup.ConnectionString, ClsDocumentTypesGroup.DataBaseUserRelatedID, ClsDocumentTypesGroup.GroupID, ClsDocumentTypesGroup.Table, IntId)
    ...
    Private Sub LoadDataUpdateSchedules(ByVal formName As String)
        ...
        ClsDocumentTypesGroup = New Clssys_DocumentTypesGroup(Me.Page)
        ClsDocumentTypesGroup.Find(" code = '" & txtCode.Text & "'")
        Dim recordID As Integer = ClsDocumentTypesGroup.ID
        If (recordID > 0) Then
    ...
    Private Function CreateOtherFields(ByVal IntRecordID As Integer)
        ...
        If clsMainOtherFields.CheckOtherFieldsButton(Me.Page, ClsDocumentTypesGroup.Table) = True Then
            Dim StrTablename As String
            ClsDocumentTypesGroup = New Clssys_DocumentTypesGroup(Me)
            StrTablename = ClsDocumentTypesGroup.Table
