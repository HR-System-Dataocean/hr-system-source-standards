<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmSelfServiceTransUserPermissions.aspx.vb" Inherits="frmUsers"
            ...
            <td style="width: 47%; height: 16px; vertical-align: top">
                <table style="width: 100%; vertical-align: top" cellspacing="0">
                    <tr>
                        ...
                        <td class="LabelArea">
                            <asp:Label ID="lblDeleteSelfServiceTransactions" runat="server" Text="Delete SS Transactions" SkinID="Label_DefaultNormal"
                                meta:resourcekey="lblDeleteSelfServiceTransactionsResource1"></asp:Label>
                        </td>
                        <td class="DataArea">
                    <asp:CheckBox ID="ChkCanDeleteSelfServiceTransactions" runat="server" meta:resourcekey="ChkCanDeleteSelfServiceTransactionsResource1" />
