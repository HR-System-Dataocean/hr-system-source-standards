...
#Region "Public Decleration"
    Private ClsNationality As Clssys_Nationality
...
#Region "Protected Sub"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ClsNationality = New Clssys_Nationality(Me.Page)
        Dim ClsObjects As New Clssys_Objects(Page)
        Dim ClsSearchs As New Clssys_Searchs(Page)
        Dim SearchID As Integer = 0
        Try
            Dim clsSearchsColumns As New Clssys_SearchsColumns(Page)
            If ClsObjects.Find(" Code='" & ClsNationality.Table.Trim & "'") Then
            ...
            If Not IsPostBack Then
                Page.Session.Add("ConnectionString", ClsNationality.ConnectionString)
                ClsNationality.AddOnChangeEventToControls("frmNationalities", Page, UltraWebTab1)
                ...
                Dim clsTicketsRoutes = New Clshrs_TicketsRoutes(Page)
                clsTicketsRoutes.GetDropDownList(ddlRoute, True, " CancelDate is null")

                Dim clsTicketsClass = New Clshrs_TicketsClasses(Page)
                clsTicketsClass.GetDropDownList(DropDownList_Class, True, " CancelDate is null")
            End If
            '================================== Add DateUpdateSchedules [Start]
            Dim IntrecordID As Integer
            If (txtCode.Text <> "") Then
                ClsNationality.Find(" Code='" & txtCode.Text & "'")
                IntrecordID = ClsNationality.ID
        ...
        Catch ex As Exception
            ...
            mErrorHandler.RecordExceptions_DataBase("", ex, Err.Number, ClsNationality.RegUserID, Venus.Shared.ErrorsHandler.eRecordingType.System_DataBase)
    ...
    Protected Sub ImageButton_Command(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.CommandEventArgs) Handles ImageButton_Save.Command, ImageButton_SaveN.Command, LinkButton_SaveN.Command, ImageButton_New.Command, ImageButton_Print.Command, ImageButton_Properties.Command, LinkButton_Properties.Command, ImageButton_Remarks.Command, LinkButton_Remarks.Command, ImageButton_Last.Command, ImageButton_Next.Command, ImageButton_Back.Command, ImageButton_First.Command, ImageButton_Delete.Command
        ...
        Dim ObjNavigationHandler As New Venus.Shared.Web.NavigationHandler(ClsNationality.ConnectionString)
        Select Case e.CommandArgument
            ...
            Case "New"
                AfterOperation()
            Case "Delete"
                ClsNationality.Delete("Code='" & txtCode.Text & "'")
                AfterOperation()
            Case "Property"
                ClsNationality.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmPropertyScreen.aspx?ID=" & ClsNationality.ID & "&TableName=" & ClsNationality.Table, 477, 313, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Property", False)
            Case "Remarks"
                ClsNationality.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmRemarks.aspx?ID=" & ClsNationality.ID & "&TableName=" & ClsNationality.Table, 410, 210, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Remarks", False)
            Case "Print"
            ...
            Case "First"
                ClsNationality.Find("Code='" & txtCode.Text & "'")
                ClsNationality.FirstRecord()
                GetValues(ClsNationality)
            Case "Previous"
                ClsNationality.Find("Code='" & txtCode.Text & "'")
                If Not ClsNationality.previousRecord() Then
                    ClsNationality.Find("Code='" & txtCode.Text & "'")
            ...
            Case "Next"
                ClsNationality.Find("Code='" & txtCode.Text & "'")
                If Not ClsNationality.NextRecord() Then
                    ClsNationality.Find("Code='" & txtCode.Text & "'")
...
#Region "Private Functions"
    Private Function SavePart() As Boolean
        Dim StrMode As String = Request.QueryString.Item("Mode")
        ClsNationality = New Clssys_Nationality(Page)

        Try
            ClsNationality.Find("Code='" & txtCode.Text & "'")

            If ClsNationality.ID > 0 Then
                If Not AssignValue(ClsNationality) Then
                    Exit Function
                End If
                ClsNationality.Update("Code='" & txtCode.Text & "'")
            ...
            clsMainOtherFields.CollectDataAndSave(value.Text, ClsNationality.Table, ClsNationality.ID)
            value.Text = ""
            Return True
        Catch ex As Exception
            Return False
        End Try
    End Function
    Private Function AssignValue(ByRef ClsNationality As Clssys_Nationality) As Boolean
        Try
            With ClsNationality
                .Code = txtCode.Text
                ...
                .IsMainNationality = chkIsMainNationality.Checked
                .TravelRoute = ddlRoute.SelectedValue
                .TravelClass = DropDownList_Class.SelectedValue
                If txtTicketAmount.Text <> "" Then
                    .TicketAmount = txtTicketAmount.Text
                End If
            End With
        ...
        End Try
    End Function
    Private Function GetValues(ByVal ClsNationality As Clssys_Nationality) As Boolean
        ...
        Try
            ...
            With ClsNationality
                ...
                chkIsMainNationality.Checked = .IsMainNationality
                txtTicketAmount.Text = .TicketAmount
                ddlRoute.SelectedValue = .TravelRoute
                DropDownList_Class.SelectedValue = .TravelClass
                ...
                If Page.IsPostBack Then
                    CreateOtherFields(ClsNationality.ID)
                End If
            End With
            Return True
        Catch ex As Exception
    ...
    Private Function CheckCode() As Boolean
        ...
        Try
            ClsNationality.Find("Code='" & txtCode.Text & "'")
            IntId = ClsNationality.ID
            txtEngName.Focus()
            If ClsNationality.ID > 0 Then
                GetValues(ClsNationality)
                StrMode = "E"
            Else
                If ClsNationality.CheckRecordExistance(" Code='" & txtCode.Text & "'") Then
                    txtCode.Text = ""
                    txtCode.Focus()
                End If
            ...
            End If
            SetToolBarDefaults()
            SetToolBarPermission(Me, ClsNationality.ConnectionString, ClsNationality.DataBaseUserRelatedID, ClsNationality.GroupID, StrMode)
            SetToolBarRecordPermission(Me, ClsNationality.ConnectionString, ClsNationality.DataBaseUserRelatedID, ClsNationality.GroupID, ClsNationality.Table, IntId)
    ...
    Private Function Clear() As Boolean
        ...
        lblRegDateValue.Text = ""
        lblCancelDateValue.Text = ""
        chkIsMainNationality.Checked = False
        ddlRoute.SelectedValue = 0
        DropDownList_Class.SelectedValue = 0
    End Function
    Private Sub LoadDataUpdateSchedules(ByVal formName As String)
        Dim controlName As String = String.Empty
        ClsNationality = New Clssys_Nationality(Me.Page)
        ClsNationality.Find(" code = '" & txtCode.Text & "'")
        Dim recordID As Integer = ClsNationality.ID
        If (recordID > 0) Then
    ...
    Private Function CreateOtherFields(ByVal IntRecordID As Integer)
        ...
        If clsMainOtherFields.CheckOtherFieldsButton(Me.Page, ClsNationality.Table) = True Then
            Dim StrTablename As String
            ClsNationality = New Clssys_Nationality(Me)
            StrTablename = ClsNationality.Table
