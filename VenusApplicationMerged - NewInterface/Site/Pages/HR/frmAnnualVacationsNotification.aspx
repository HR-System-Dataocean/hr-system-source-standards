<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmAnnualVacationsNotification.aspx.vb"
...
<head runat="server">
    <title>* Venus Payroll * ~Employee Vacation Notification</title>
    ...
    <script type="text/javascript" id="igClientScript">
        ...
        function uwgEmployeeVacations_ClickCellButtonHandler(gridName, cellId) {
            ...
            var ConfigID = Row.getCellFromKey("ConfigID").getValue();
            ...
            if (cell.Column.Index == 7) {
                ...
                if (FormCode == "SS_0011" || FormCode == "SS_0012" || FormCode == "SS_0013" || FormCode == "SS_0018" || FormCode == "SS_0030" || FormCode == "SS_0031" || FormCode == "SS_0032" || FormCode == "SS_0033" || FormCode == "SS_0034" || FormCode == "SS_0035" || FormCode == "SS_0036" || FormCode == "SS_0037") {
                    OpenModal1("FrmAnnualVacationRequestAction.aspx?RequestSerial=" + RequestSerial + "&FormCode=" + FormCode + "& &RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 800, 850, false, "");

                }
                if (FormCode == "SS_0014") {
                    OpenModal1("FrmExceuseRequestAction.aspx?RequestSerial=" + RequestSerial + " & EmployeeID=" + EmployeeID + "  & FormCode=" + FormCode + "&RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 560, 800, false, "");
                }
                if (FormCode == "SS_0015" || FormCode == "SS_0019") {
                    OpenModal1("FrmEndOfServiceRequestAction.aspx?RequestSerial=" + RequestSerial + "&FormCode=" + FormCode + "&RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 560, 800, false, "");
                }
                ...
                if (FormCode == "SS_00199") {
                    OpenModal1("FrmConflictofInterestFormRequestAction.aspx?RequestSerial=" + RequestSerial + "&FormCode=" + FormCode + "&RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 560, 800, false, "");
                }
                if (FormCode == "SS_00198") {
                    OpenModal1("FrmAssaultEscalationFormRequestAction.aspx?RequestSerial=" + RequestSerial + "&FormCode=" + FormCode + "&RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 560, 800, false, "");
                }
                if (FormCode == "SS_00197") {
                    OpenModal1("FrmInterviewEvaluationFormRequestAction.aspx?RequestSerial=" + RequestSerial + "&FormCode=" + FormCode + "&RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 560, 800, false, "");
                }
                if (FormCode == "SS_00196") {
                    OpenModal1("FrmGrievanceFormRequestAction.aspx?RequestSerial=" + RequestSerial + " &FormCode=" + FormCode + " &RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 560, 800, false, "");
                }
                if (FormCode == "SS_00195") {
                    OpenModal1("FrmTrainingRequestAction.aspx?RequestSerial=" + RequestSerial + "&FormCode=" + FormCode + "&RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 560, 800, false, "");
                }
                if (FormCode == "SS_00194") {
                    OpenModal1("FrmOtherLetterRequestAction.aspx?RequestSerial=" + RequestSerial + "&FormCode=" + FormCode + "&RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 560, 800, false, "");
                }
                if (FormCode == "SS_00193") {
                    OpenModal1("FrmLoanLetterRequestAction.aspx?RequestSerial=" + RequestSerial + "&FormCode=" + FormCode + "&RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 560, 800, false, "");
                }
                if (FormCode == "SS_00192") {
                    OpenModal1("frmVisaRequestAction.aspx?RequestSerial=" + RequestSerial + "&FormCode=" + FormCode + "&RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 560, 800, false, "");
                }
                if (FormCode == "SS_00191") {
                    OpenModal1("frmExitEntryRequestAction.aspx?RequestSerial=" + RequestSerial + "&FormCode=" + FormCode + "&RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 560, 800, false, "");
                }                           
               if (FormCode == "SS_001910") {
                   OpenModal1("FrmPhysiciansPrivilegingFormRequestAction.aspx?RequestSerial=" + RequestSerial + "&FormCode=" + FormCode + "&RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 560, 800, false, "");
                }
                if (FormCode == "SS_001911") {
                    OpenModal1("FrmDaycareSupportReaquestAction.aspx?RequestSerial=" + RequestSerial + "&FormCode=" + FormCode + "&RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 560, 800, false, "");
                }
                if (FormCode == "SS_001912") {
                    OpenModal1("FrmEducationSupportRequestAction.aspx?RequestSerial=" + RequestSerial + "&RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 560, 800, false, "");
                }

                if (FormCode == "SS_001913") {
                    OpenModal1("FrmAdvanceHousingRequestAction.aspx?RequestSerial=" + RequestSerial + "&FormCode=" + FormCode + "&RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 560, 800, false, "");
                }
                if (FormCode == "SS_001914") {
                    OpenModal1("frmAdvanceSalaryRequestAction.aspx?RequestSerial=" + RequestSerial + "&FormCode=" + FormCode + "&RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 560, 800, false, "");
                }
                if (FormCode == "SS_001915") {
                    OpenModal1("FrmChamberofCommerceLetterRequestAction.aspx?RequestSerial=" + RequestSerial + "&FormCode=" + FormCode + "&RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 560, 800, false, "");
                }
                if (FormCode == "SS_001916") {
                    OpenModal1("FrmSCFHSLetterRequestAction.aspx?RequestSerial=" + RequestSerial + "&FormCode=" + FormCode + "&RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 560, 800, false, "");
                }
                if (FormCode == "SS_001917") {
                    OpenModal1("FrmPaySlipRequestAction.aspx?RequestSerial=" + RequestSerial + "&FormCode=" + FormCode + "&RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 560, 800, false, "");
                }
                if (FormCode == "SS_001918") {
                    OpenModal1("frmOccurrenceVarianceReportingLettersAction.aspx?RequestSerial=" + RequestSerial + "&FormCode=" + FormCode + "&RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 560, 800, false, "");
                }
                if (FormCode == "SS_001919") {
                    OpenModal1("frmOvertimeRequestAction.aspx?RequestSerial=" + RequestSerial + "&FormCode=" + FormCode + "&RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 560, 800, false, "");
                }
                if (FormCode == "SS_001920") {
                    OpenModal1("frmEducationFeesCompensationApplicationAction.aspx?RequestSerial=" + RequestSerial + "&FormCode=" + FormCode + "&RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 560, 800, false, "");
                }
                if (FormCode == "SS_001921") {
                    OpenModal1("frmBankAccountUpdateAction.aspx?RequestSerial=" + RequestSerial + "&FormCode=" + FormCode + "&RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 560, 800, false, "");
                }
                if (FormCode == "SS_001922") {
                    OpenModal1("frmContactInformationUpdateAction.aspx?RequestSerial=" + RequestSerial + "&FormCode=" + FormCode + "&RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 560, 800, false, "");
                }
                if (FormCode == "SS_001923") {
                    OpenModal1("frmDependentsInformationUpdateAction.aspx?RequestSerial=" + RequestSerial + "&FormCode=" + FormCode + "&RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 560, 800, false, "");
                }
                if (FormCode == "SS_001924") {
                    OpenModal1("frmMedicalInsuranceAdjustmentsAction.aspx?RequestSerial=" + RequestSerial + "&FormCode=" + FormCode + "&RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 560, 800, false, "");
                }
                if (FormCode == "SS_001925") {
                    OpenModal1("frmOtherLegalDocumentUpdatesAction.aspx?RequestSerial=" + RequestSerial + "&FormCode=" + FormCode + "&RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 560, 800, false, "");
                }
                if (FormCode == "SS_001926") {
                    OpenModal1("frmEmployeeFileUpdateAction.aspx?RequestSerial=" + RequestSerial + "&FormCode=" + FormCode + "&RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 560, 800, false, "");
                }
                if (FormCode == "SS_001927") {
                    OpenModal1("frmBusinessORTrainingTravelAction.aspx?RequestSerial=" + RequestSerial + "&FormCode=" + FormCode + "&RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 560, 800, false, "");
                }
                if (FormCode == "SS_001928") {
                    OpenModal1("frmAnnualTicketRelatedRequestsAction.aspx?RequestSerial=" + RequestSerial + "&FormCode=" + FormCode + "&RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 560, 800, false, "");
                }
                if (FormCode == "SS_001929") {
                    OpenModal1("frmChangeWorkHoursRequestAction.aspx?RequestSerial=" + RequestSerial + "&FormCode=" + FormCode + "&RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 560, 800, false, "");
                }
                        ...
                        <tr>
                          <%--  <td style="width: 32px; vertical-align: top">
                               ...
                               <td class="SeparArea">
                                                        ...
                                                        <td  style="width:50px" class="LabelArea">
                             ...
                             <td  style="width:10px" class="LabelArea">
                                                            <asp:Label ID="Label1" runat="server" Width="50px" SkinID="Label_LargtNormal"
                                                                Text="السنة" meta:resourcekey="lblYearResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                ...
                                <td  style="width:20px" class="LabelArea">
                                                            <asp:Label ID="Label2" runat="server" Width="50px" SkinID="Label_LargtNormal"
                                                                Text="الشهر" meta:resourcekey="lblMonthResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="DdlMonth" runat="server" AutoPostBack="True" SkinID="DropDownList_DefaultNormal"
                                                                meta:resourcekey="RequestTypeResource1" TabIndex="3">
                                                            </asp:DropDownList>
                                                        </td>
            ...
            <tr>
                <td class="Details">
                    <igtab:UltraWebTab ID="UltraWebTab1" runat="server" EnableAppStyling="True" SkinID="Default"
                        ...
                        <Tabs>
                            <igtab:Tab Text="تنبيهات الطلبات" meta:resourcekey="TabResource1">
                                <ContentTemplate>
                                                    ...
                                                    <igtbl:UltraWebGrid  Browser="UpLevel"   ID="uwgEmployeeVacations" runat="server" EnableAppStyling="False"
                                                        ...
                                                        <Bands>
                                                            <igtbl:UltraGridBand meta:resourcekey="UltraGridBandResource1">
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <igtbl:UltraGridColumn BaseColumnName="ID" DataType="System.Int32" Hidden="True"
                                                                        Key="ID" meta:resourcekey="UltraGridColumnResource1" Type="DropDownList">
                                                                        
                                                                        <Header Caption="ID">
                                                                        </Header>
                                                                    </igtbl:UltraGridColumn>
                                                                    <igtbl:UltraGridColumn BaseColumnName="FormCode" DataType="System.String" Hidden="True"
                                                                        Key="FormCode" meta:resourcekey="UltraGridColumnResource1" Type="DropDownList">
                                                                    ...
                                                                    <igtbl:UltraGridColumn BaseColumnName="RequestDate" DataType="System.Date"
                                                                        Width="15%" Format="dd/MM/yyyy hh:mm tt" Hidden="False" Key="ExpectedStartDate" meta:resourcekey="RequestDateResource2">
                                                                    ...
                                                                    <igtbl:UltraGridColumn BaseColumnName="RequestType" DataType="System.String"
                                                                     Width="15%"  Hidden="False" Key="RequestType" meta:resourcekey="RequestTypeResource3">
                                                                    ...
                                                                    <igtbl:UltraGridColumn Type="Button" Key="Action" Width="20%" AllowRowFiltering="False" CellButtonDisplay="Always"
                                                                    meta:resourcekey="ActionsResource16">
                                                                    ...
                                                                    <igtbl:UltraGridColumn Type="Button" Key="Attachment" Width="20%" AllowRowFiltering="False" CellButtonDisplay="Always"
                                                                    ...
                                                                    <CellButtonStyle BackgroundImage="~/Common/Images/ToolBox/Hr_ToolBox/Print.png" BorderStyle="None"
                                                                     ...
                                                                     <igtbl:UltraGridColumn BaseColumnName="EmployeeID" DataType="System.Int32" Hidden="True"
                                                                        ...
                                                                        Key="EmployeeID" meta:resourcekey="UltraGridColumnResource1" Type="DropDownList">
                                                            ...
                                                            <igtbl:UltraGridBand meta:resourcekey="UltraGridBandResource2">
                                                                <Columns>
                                                                    <igtbl:UltraGridColumn BaseColumnName="RequestSerial" DataType="System.Int32" Key="VacationTypeID"
                                                                        meta:resourcekey="UltraGridColumnResource1" Type="DropDownList" Width="200px">
                                                                        <Header Caption="Request Serial">
                                                                        </Header>
                                                                    </igtbl:UltraGridColumn>
                                                                    <igtbl:UltraGridColumn BaseColumnName="StartDate" DataType="System.DateTime"
                                                                        Format="dd/MM/yyyy hh:mm tt" Key="StartDate" meta:resourcekey="UltraGridColumnResource4"
                                                                        Width="220px">
                                                                    ...
                                                                    <igtbl:UltraGridColumn BaseColumnName="EndDate" DataType="System.DateTime"
                                                                        Format="dd/MM/yyyy hh:mm tt" Key="EndDate" meta:resourcekey="UltraGridColumnResource5"
                                                                        Width="220px">
