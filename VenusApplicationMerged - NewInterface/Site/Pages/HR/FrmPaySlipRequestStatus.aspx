<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmPaySlipRequestStatus.aspx.vb"
...
<body style="margin: 0; padding: 0;">
    ...
    <Appearance>
       ...
       <td class="DataArea">
          ...
          <td class="LabelArea">
              <asp:Label ID="LblRecipient" runat="server" Width="90px" SkinID="Label_DefaultNormal"
                  Text="Recipient" meta:resourcekey="LblRecipientResource1"></asp:Label>
          </td>
          <td class="DataArea">
              <asp:TextBox ID="TxtRecipient" runat="server" width="350px" meta:resourcekey="TxtRecipientResource1"
