<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmCurrencies.aspx.vb" Inherits="frmCurrencies"
...
<head runat="server">
    <title>* Venus Payroll * ~Currencies</title>
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmCurrencies" runat="server">
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblEngSymbol" runat="server" SkinID="Label_DefaultNormal" Text="الرمز بالانجليزية"
                                                                meta:resourcekey="lblEngSymbolResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="txtEngSymbol" runat="server" MaxLength="255" SkinID="TextBox_LargeNormalrtl"
                                                                meta:resourcekey="txtEngSymbolResource1"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblArbSymbol" runat="server" SkinID="Label_DefaultNormal" Text="الرمز بالعربي"
                                                                meta:resourcekey="lblArbSymbolResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="txtArbSymbol" runat="server" MaxLength="255" SkinID="TextBox_LargeNormalrtl"
                                                                meta:resourcekey="txtArbSymbolResource1"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblDecimalFarctEng" runat="server" SkinID="Label_DefaultNormal" Text="الجزء بالانجليزي"
                                                                meta:resourcekey="lblDecimalFarctEngResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="txtDecimalFarctEng" runat="server" MaxLength="255" SkinID="TextBox_LargeNormalrtl"
                                                                meta:resourcekey="txtDecimalFarctEngResource1"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblDecimalFarctArb" runat="server" SkinID="Label_DefaultNormal" Text="الجزء بالعربي"
                                                                meta:resourcekey="lblDecimalFarctArbResource1"></asp:Label>
                                                            &nbsp;
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="txtDecimalFarctArb" runat="server" MaxLength="255" SkinID="TextBox_LargeNormalrtl"
                                                                meta:resourcekey="txtDecimalFarctArbResource1"></asp:TextBox>
                                                            &nbsp;
                                                        </td>
                                                    </tr>
                                                </table>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblAmount" runat="server" SkinID="Label_DefaultNormal" Text="المبلغ"
                                                                meta:resourcekey="lblAmountResource1"></asp:Label>
                                                            &nbsp;
                                                        </td>
                                                        <td class="DataArea">
                                                            <igtxt:WebNumericEdit ID="txtAmount" runat="server" MinValue="0" Nullable="False"
                                                                SkinID="WebNumericEdit_Fix" ValueText="0" meta:resourcekey="txtAmountResource1">
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblDecimalFract1" runat="server" SkinID="Label_DefaultNormal" Text="الكسر العشرى"
                                                                meta:resourcekey="lblDecimalFract1Resource1"></asp:Label>
                                                            &nbsp;
                                                        </td>
                                                        <td class="DataArea">
                                                            <igtxt:WebNumericEdit ID="txtDecimalFract" runat="server" MinValue="0" Nullable="False"
                                                                SkinID="WebNumericEdit_Fix" ValueText="0" meta:resourcekey="txtDecimalFractResource1">
                                                            </igtxt:WebNumericEdit>
                                                            &nbsp;
                                                        </td>
                                                    </tr>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblNoOfDecimalPlaces" runat="server" SkinID="Label_DefaultNormal"
                                                                Text="عدد العلامات العشرية" meta:resourcekey="lblNoOfDecimalPlacesResource1"></asp:Label>
                                                            &nbsp;
                                                        </td>
                                                        <td class="DataArea">
                                                            <igtxt:WebNumericEdit ID="txtNoOfDecimalPlaces" runat="server" MinValue="0" Nullable="False"
                                                                SkinID="WebNumericEdit_Fix" ValueText="1" meta:resourcekey="txtNoOfDecimalPlacesResource1">
                                                            </igtxt:WebNumericEdit>
                                                            &nbsp;
                                                        </td>
                                                    </tr>
