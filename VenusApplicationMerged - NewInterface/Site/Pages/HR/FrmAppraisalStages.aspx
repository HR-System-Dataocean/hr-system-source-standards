<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmAppraisalStages.aspx.vb"
            ...
            <tr>
                <td class="Details">
                    <igtab:UltraWebTab ID="UltraWebTab1" runat="server" EnableAppStyling="True" SkinID="Default"
                        ...
                        <Tabs>
                            <igtab:Tab Text="  مراحل التقييم" meta:resourcekey="TabResource1">
                                <ContentTemplate>
                                           ...
                                           <tr>
                                            ...
                                            <tr>
                                                <td style="height: 16px; vertical-align: top" colspan="3">
                                                    <igtbl:UltraWebGrid  Browser="UpLevel"   ID="uwgAppraisalStages" runat="server" EnableAppStyling="False"
                                                        ...
                                                        <Bands>
                                                            <igtbl:UltraGridBand meta:resourcekey="UltraGridBandResource1">
                                                                ...
                                                                <Columns>
                                                                    <igtbl:UltraGridColumn BaseColumnName="EmployeeName" Width="35%" DataType="System.Int32" Hidden="False" AllowUpdate="No"
                                                                        Key="VacationTypeID" meta:resourcekey="EmployeeNameResource1"  >
                                                                    ...
                                                                    <igtbl:UltraGridColumn BaseColumnName="NotificationsentDate"  DataType="System.String"
                                                                         Key="NotificationsentDate" meta:resourcekey="NotificationsentDateResource4"
                                                                        Width="20%">
                                                                        <Header Caption="Notification sen tDate">
                                                                    ...
                                                                    <igtbl:UltraGridColumn BaseColumnName="Status"  DataType="System.String"
                                                                        Format="dd/MM/yyyy hh:mm tt" Key="Status" meta:resourcekey="StatusResource4"
                                                                        Width="20%">
                                                                        <Header Caption="Stage Status">
                                                                            <RowLayoutColumnInfo OriginX="3" />
                                                                        </Header>
                                                                         <CellStyle HorizontalAlign="Center">
                                                                    </CellStyle>
                                                                     ...
                                                                     <igtbl:UltraGridColumn BaseColumnName="CompleteDate" DataType="System.DateTime"
                                                                        Format="dd/MM/yyyy hh:mm tt" Key="CompleteDate" meta:resourcekey="CompleteDateResource4"
                                                                        Width="15%">
                                                                        <Header Caption="CompleteDate">
                                                                            <RowLayoutColumnInfo OriginX="3" />
                                                                        </Header>
                                                                          <CellStyle HorizontalAlign="Center">
                                                                    </CellStyle>
