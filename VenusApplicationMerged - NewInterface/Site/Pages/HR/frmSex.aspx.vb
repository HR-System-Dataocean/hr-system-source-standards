...
#Region "Public Decleration"
    Private ClsBasicFiles As ClsBasicFiles
...
#Region "Protected Sub"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ClsBasicFiles = New ClsBasicFiles(Me.Page, "hrs_Sex")
        Dim ClsObjects As New Clssys_Objects(Page)
        Dim ClsSearchs As New Clssys_Searchs(Page)
        Dim SearchID As Integer = 0
        Try
            Dim clsSearchsColumns As New Clssys_SearchsColumns(Page)
            If ClsObjects.Find(" Code='" & ClsBasicFiles.Table.Trim & "'") Then
            ...
            If Not IsPostBack Then
                Page.Session.Add("ConnectionString", ClsBasicFiles.ConnectionString)
                ClsBasicFiles.AddOnChangeEventToControls("frmSex", Page, UltraWebTab1)
            ...
            If (txtCode.Text <> "") Then
                ClsBasicFiles.Find(" Code='" & txtCode.Text & "'")
                IntrecordID = ClsBasicFiles.ID
        ...
        Catch ex As Exception
            ...
            mErrorHandler.RecordExceptions_DataBase("", ex, Err.Number, ClsBasicFiles.RegUserID, Venus.Shared.ErrorsHandler.eRecordingType.System_DataBase)
    ...
    Protected Sub ImageButton_Command(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.CommandEventArgs) Handles ImageButton_Save.Command, ImageButton_SaveN.Command, LinkButton_SaveN.Command, ImageButton_New.Command, ImageButton_Print.Command, ImageButton_Properties.Command, LinkButton_Properties.Command, ImageButton_Remarks.Command, LinkButton_Remarks.Command, ImageButton_Last.Command, ImageButton_Next.Command, ImageButton_Back.Command, ImageButton_First.Command, ImageButton_Delete.Command
        ...
        Dim ObjNavigationHandler As New Venus.Shared.Web.NavigationHandler(ClsBasicFiles.ConnectionString)
        Select Case e.CommandArgument
            ...
            Case "New"
                AfterOperation()
            Case "Delete"
                ClsBasicFiles.Delete("Code='" & txtCode.Text & "'")
                AfterOperation()
            Case "Property"
                ClsBasicFiles.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmPropertyScreen.aspx?ID=" & ClsBasicFiles.ID & "&TableName=" & ClsBasicFiles.Table, 477, 313, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Property", False)
            Case "Remarks"
                ClsBasicFiles.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmRemarks.aspx?ID=" & ClsBasicFiles.ID & "&TableName=" & ClsBasicFiles.Table, 410, 210, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Remarks", False)
            Case "Print"
            ...
            Case "First"
                ClsBasicFiles.Find("Code='" & txtCode.Text & "'")
                ClsBasicFiles.FirstRecord()
                GetValues(ClsBasicFiles)
            Case "Previous"
                ClsBasicFiles.Find("Code='" & txtCode.Text & "'")
                If Not ClsBasicFiles.previousRecord() Then
                    ClsBasicFiles.Find("Code='" & txtCode.Text & "'")
            ...
            Case "Next"
                ClsBasicFiles.Find("Code='" & txtCode.Text & "'")
                If Not ClsBasicFiles.NextRecord() Then
                    ClsBasicFiles.Find("Code='" & txtCode.Text & "'")
...
#Region "Private Functions"
    Private Function SavePart() As Boolean
        Dim StrMode As String = Request.QueryString.Item("Mode")
        ClsBasicFiles = New ClsBasicFiles(Page, "hrs_Sex")

        Try
            ClsBasicFiles.Find("Code='" & txtCode.Text & "'")

            If ClsBasicFiles.ID > 0 Then
                If Not AssignValue(ClsBasicFiles) Then
                    Exit Function
                End If
                ClsBasicFiles.Update("Code='" & txtCode.Text & "'")
            ...
            clsMainOtherFields.CollectDataAndSave(value.Text, ClsBasicFiles.Table, ClsBasicFiles.ID)
            value.Text = ""
            Return True
        Catch ex As Exception
            Return False
        End Try
    End Function
    Private Function AssignValue(ByRef ClsBasicFiles As ClsBasicFiles) As Boolean
        Try
            With ClsBasicFiles
                .Code = txtCode.Text
        ...
        End Try
    End Function
    Private Function GetValues(ByVal ClsBasicFiles As ClsBasicFiles) As Boolean
        ...
        Try
            ...
            With ClsBasicFiles
                ...
                If Page.IsPostBack Then
                    CreateOtherFields(ClsBasicFiles.ID)
                End If
            End With
            Return True
        Catch ex As Exception
    ...
    Private Function CheckCode() As Boolean
        ...
        Try
            ClsBasicFiles.Find("Code='" & txtCode.Text & "'")
            IntId = ClsBasicFiles.ID
            txtEngName.Focus()
            If ClsBasicFiles.ID > 0 Then
                GetValues(ClsBasicFiles)
                StrMode = "E"
            Else
                If ClsBasicFiles.CheckRecordExistance(" Code='" & txtCode.Text & "'") Then
                    txtCode.Text = ""
                    txtCode.Focus()
                End If
            ...
            End If
            SetToolBarDefaults()
            SetToolBarPermission(Me, ClsBasicFiles.ConnectionString, ClsBasicFiles.DataBaseUserRelatedID, ClsBasicFiles.GroupID, StrMode)
            SetToolBarRecordPermission(Me, ClsBasicFiles.ConnectionString, ClsBasicFiles.DataBaseUserRelatedID, ClsBasicFiles.GroupID, ClsBasicFiles.Table, IntId)
    ...
    Private Sub LoadDataUpdateSchedules(ByVal formName As String)
        ...
        ClsBasicFiles = New ClsBasicFiles(Me.Page, "hrs_Sex")
        ClsBasicFiles.Find(" code = '" & txtCode.Text & "'")
        Dim recordID As Integer = ClsBasicFiles.ID
        If (recordID > 0) Then
    ...
    Private Function CreateOtherFields(ByVal IntRecordID As Integer)
        ...
        If clsMainOtherFields.CheckOtherFieldsButton(Me.Page, ClsBasicFiles.Table) = True Then
            Dim StrTablename As String
            ClsBasicFiles = New ClsBasicFiles(Me, "hrs_Sex")
            StrTablename = ClsBasicFiles.Table
