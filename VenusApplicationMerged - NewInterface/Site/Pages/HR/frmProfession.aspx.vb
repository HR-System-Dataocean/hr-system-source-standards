...
#Region "Public Decleration"
    Private ClsProfessions As Clshrs_Professions
...
#Region "Protected Sub"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ClsProfessions = New Clshrs_Professions(Me.Page)
        Dim ClsObjects As New Clssys_Objects(Page)
        Dim ClsSearchs As New Clssys_Searchs(Page)
        Dim SearchID As Integer = 0
        Try
            Dim clsSearchsColumns As New Clssys_SearchsColumns(Page)
            If ClsObjects.Find(" Code='" & ClsProfessions.Table.Trim & "'") Then
            ...
            If Not IsPostBack Then
                Page.Session.Add("ConnectionString", ClsProfessions.ConnectionString)
                ClsProfessions.AddOnChangeEventToControls("frmProfession", Page, UltraWebTab1)
            ...
            If (txtCode.Text <> "") Then
                ClsProfessions.Find(" Code='" & txtCode.Text & "'")
                IntrecordID = ClsProfessions.ID
        ...
        Catch ex As Exception
            ...
            mErrorHandler.RecordExceptions_DataBase("", ex, Err.Number, ClsProfessions.RegUserID, Venus.Shared.ErrorsHandler.eRecordingType.System_DataBase)
    ...
    Protected Sub ImageButton_Command(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.CommandEventArgs) Handles ImageButton_Save.Command, ImageButton_SaveN.Command, LinkButton_SaveN.Command, ImageButton_New.Command, ImageButton_Print.Command, ImageButton_Properties.Command, LinkButton_Properties.Command, ImageButton_Remarks.Command, LinkButton_Remarks.Command, ImageButton_Last.Command, ImageButton_Next.Command, ImageButton_Back.Command, ImageButton_First.Command, ImageButton_Delete.Command
        ...
        Dim ObjNavigationHandler As New Venus.Shared.Web.NavigationHandler(ClsProfessions.ConnectionString)
        Select Case e.CommandArgument
            ...
            Case "New"
                AfterOperation()
            Case "Delete"
                ClsProfessions.Delete("Code='" & txtCode.Text & "'")
                AfterOperation()
            Case "Property"
                ClsProfessions.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmPropertyScreen.aspx?ID=" & ClsProfessions.ID & "&TableName=" & ClsProfessions.Table, 477, 313, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Property", False)
            Case "Remarks"
                ClsProfessions.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmRemarks.aspx?ID=" & ClsProfessions.ID & "&TableName=" & ClsProfessions.Table, 410, 210, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Remarks", False)
            Case "Print"
            ...
            Case "First"
                ClsProfessions.Find("Code='" & txtCode.Text & "'")
                ClsProfessions.FirstRecord()
                GetValues(ClsProfessions)
            Case "Previous"
                ClsProfessions.Find("Code='" & txtCode.Text & "'")
                If Not ClsProfessions.previousRecord() Then
                    ClsProfessions.Find("Code='" & txtCode.Text & "'")
            ...
            Case "Next"
                ClsProfessions.Find("Code='" & txtCode.Text & "'")
                If Not ClsProfessions.NextRecord() Then
                    ClsProfessions.Find("Code='" & txtCode.Text & "'")
...
#Region "Private Functions"
    Private Function SavePart() As Boolean
        Dim StrMode As String = Request.QueryString.Item("Mode")
        ClsProfessions = New Clshrs_Professions(Page)

        Try
            ClsProfessions.Find("Code='" & txtCode.Text & "'")

            If ClsProfessions.ID > 0 Then
                If Not AssignValue(ClsProfessions) Then
                    Exit Function
                End If
                ClsProfessions.Update("Code='" & txtCode.Text & "'")
            ...
            clsMainOtherFields.CollectDataAndSave(value.Text, ClsProfessions.Table, ClsProfessions.ID)
            value.Text = ""
            Return True
        Catch ex As Exception
            Return False
        End Try
    End Function
    Private Function AssignValue(ByRef ClsProfessions As Clshrs_Professions) As Boolean
        Try
            With ClsProfessions
                .Code = txtCode.Text
        ...
        End Try
    End Function
    Private Function GetValues(ByVal ClsProfessions As Clshrs_Professions) As Boolean
        ...
        Try
            ...
            With ClsProfessions
                ...
                If Page.IsPostBack Then
                    CreateOtherFields(ClsProfessions.ID)
                End If
            End With
            Return True
        Catch ex As Exception
    ...
    Private Function CheckCode() As Boolean
        ...
        Try
            ClsProfessions.Find("Code='" & txtCode.Text & "'")
            IntId = ClsProfessions.ID
            txtEngName.Focus()
            If ClsProfessions.ID > 0 Then
                GetValues(ClsProfessions)
                StrMode = "E"
            Else
                If ClsProfessions.CheckRecordExistance(" Code='" & txtCode.Text & "'") Then
                    txtCode.Text = ""
                    txtCode.Focus()
                End If
            ...
            End If
            SetToolBarDefaults()
            SetToolBarPermission(Me, ClsProfessions.ConnectionString, ClsProfessions.DataBaseUserRelatedID, ClsProfessions.GroupID, StrMode)
            SetToolBarRecordPermission(Me, ClsProfessions.ConnectionString, ClsProfessions.DataBaseUserRelatedID, ClsProfessions.GroupID, ClsProfessions.Table, IntId)
    ...
    Private Sub LoadDataUpdateSchedules(ByVal formName As String)
        ...
        ClsProfessions = New Clshrs_Professions(Me.Page)
        ClsProfessions.Find(" code = '" & txtCode.Text & "'")
        Dim recordID As Integer = ClsProfessions.ID
        If (recordID > 0) Then
    ...
    Private Function CreateOtherFields(ByVal IntRecordID As Integer)
        ...
        If clsMainOtherFields.CheckOtherFieldsButton(Me.Page, ClsProfessions.Table) = True Then
            Dim StrTablename As String
            ClsProfessions = New Clshrs_Professions(Me)
            StrTablename = ClsProfessions.Table
