<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmAppraisalConfiguration.aspx.vb"
            ...
            <tr>
                <td class="Details">
                    <igtab:UltraWebTab ID="UltraWebTab1" runat="server" EnableAppStyling="True" SkinID="Default"
                        ...
                        <Tabs>
                            <igtab:Tab Text="اعدادات مراحل التقييم" meta:resourcekey="TabResource1">
                                <ContentTemplate>
                                            ...
                                            <td style="width: 55%; height: 16px; vertical-align: top">
                                                <table style="width: 50%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblAppraisal" runat="server" Width="65px" SkinID="Label_DefaultNormal"  Text="اختر التقييم" meta:resourcekey="lblAppraisalResource1"></asp:Label>
                                                        </td>
                                                        <td class="SeparArea">
                                                        </td>
                                                        <td class="SeparArea">
                                                                        ...
                                                                        <igtbl:UltraGridColumn Width="25%" BaseColumnName="Rank" Key="Rank" meta:resourcekey="RankUltraGridBandResource1"
                                                                           ...
                                                                           <igtbl:UltraGridColumn Width="25%" BaseColumnName="StageWeight" Key="StageWeight" meta:resourcekey="StageWeightResource1" >
                                                                                ...
                                                                                <igtbl:UltraGridColumn BaseColumnName="HasObjection" DataType="System.Boolean" Key="HasObjection" meta:resourcekey="HasObjectionUltraGridBandResource1"
                                                                                            Width="20%" Type="CheckBox" AllowUpdate="No">
                                                                                            <Header Caption="يمكنه الاعتراض">
                                                                                ...
                                                                                <igtbl:UltraGridColumn Width="25%" BaseColumnName="NoOfObjections" Key="NoOfObjections" meta:resourcekey="NoOfObjectionsResource1"  AllowUpdate="No">
                                                                                          <Header Caption="عدد مرات الاعتراض">
                                                                                              <RowLayoutColumnInfo OriginX="2" />
                                                                                          </Header>
                                                                                          <CellStyle HorizontalAlign="Center">
                                                                                          </CellStyle>
