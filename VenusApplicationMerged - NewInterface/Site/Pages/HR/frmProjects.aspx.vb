...
#Region "Protected Sub"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            'If ClsObjects.Find(" Code='CostCenter'") Then
            '    If ClsSearchs.Find(" ObjectID='" & ClsObjects.ID & "'") Then
            '        SearchID = ClsSearchs.ID
            '        Dim IntDimension As Integer = 510
            '        Dim UrlString1 = "'frmModalSearchScreen.aspx?TargetControl=" & TxtCos1.ID & "&SearchID=" & SearchID & "&'," & IntDimension & ",720,false,'" & TxtCos1.ClientID & "'"
            '        btnCost1.ClientSideEvents.Click = "OpenModal1(" & UrlString1 & ")"
            ...
            If Not IsPostBack Then
                ...
                ClsProjects.AddOnChangeEventToControls("frmProjects", Page, UltraWebTab1)
...
#Region "Private Functions"
    ...
    Private Function GetValues() As Boolean
        ...
        Try
            ...
            ddlDepartment.SelectedValue = ClsProjects.DepartmentID
            TxtCostCenter1.Text = ClsProjects.CostCenterCode1
            TxtCostCenter2.Text = ClsProjects.CostCenterCode2
            TxtCostCenter3.Text = ClsProjects.CostCenterCode3
            TxtCostCenter4.Text = ClsProjects.CostCenterCode4
    ...
    Private Function CreateOtherFields(ByVal IntRecordID As Integer)
        ...
        If clsMainOtherFields.CheckOtherFieldsButton(Me.Page, ClsProjects.Table) = True Then
            ...
            If objDS.Tables(0).Rows.Count > 0 Then
                clsMainOtherFields.CreateOtherFieldsTabs(clsSysObjects.ID, dsOtherFields, UltraWebTab1, Me.name, Me.realname, "U", objDS, "Interfaces_frmProjects")
            Else
                clsMainOtherFields.CreateOtherFieldsTabs(clsSysObjects.ID, dsOtherFields, UltraWebTab1, Me.name, Me.realname, "A", objDS, "Interfaces_frmProjects")
            End If
        End If
    End Function
