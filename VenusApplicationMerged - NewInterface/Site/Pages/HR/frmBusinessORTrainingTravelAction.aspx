<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmBusinessORTrainingTravelAction.aspx.vb"
    Inherits="frmBusinessORTrainingTravelAction" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
...
<body style="height: 100%; margin: 0; padding: 0;">
    <form id="frmBusinessORTrainingTravelAction" runat="server">
   ...
   <tr>
    ...
    <td style="width: 47%; height: 16px; vertical-align: top">
        <table style="width: 100%; vertical-align: top" cellspacing="0">
            ...
            <tr>
                 <td class="SeparArea">
                                                          ...
                                                          <td class="LabelArea" style="min-width: 90px;">
          <asp:Label ID="lblJoinDate" runat="server" Text="Join date" SkinID="Label_DefaultNormal"
      ...
      <td class="DataArea">
          <asp:TextBox ID="TxtJoinDate" runat="server" SkinID="TextBox_SmalltNormalC" MaxLength="30"
              AutoPostBack="False" ReadOnly="False"  meta:resourcekey="TxtJoinDateResource1">
         </asp:TextBox>
      </td>
            </tr>
        </table>
    ...
    <td style="width: 47%; height: 16px; vertical-align: top">
       ...
       <td style="width: 47%; height: 16px; vertical-align: top">
           <table style="width: 100%; vertical-align: top" cellspacing="0">
                   ...
                   <td class="LabelArea">
                       <asp:Label ID="lblFromDate" Width="120px" runat="server" Text="من تاريخ"
                           SkinID="Label_DefaultNormal" meta:resourcekey="lblFromDateResource1"></asp:Label>
                   </td>
                   <td class="DataArea">
                    <Asp:TextBox ID="txtDromDate" runat="server" BorderColor="#CCCCCC" BorderStyle="Solid"
                           BorderWidth="1px" Height="18px" NullDateLabel="" Style="font-family: Tahoma;
                           font-size: 8pt; font-weight: Normal; color: Black; border: solid 1px #CCCCCC"
                           Width="130px">
                       </Asp:TextBox>
                 ...
                 <td class="LabelArea">
                       <asp:Label ID="lblToDate" Width="90px" runat="server" Text="الي تاريخ  "
                           SkinID="Label_DefaultNormal" meta:resourcekey="lblToDateResource1"></asp:Label>
                   </td>
                   <td class="DataArea">
                    <Asp:TextBox ID="txtToDate" runat="server" BorderColor="#CCCCCC" BorderStyle="Solid"
                           BorderWidth="1px" Height="18px" NullDateLabel="" Style="font-family: Tahoma;
                           font-size: 8pt; font-weight: Normal; color: Black; border: solid 1px #CCCCCC"
                           Width="130px">
                       </Asp:TextBox>
       ...
       <td style="width: 47%; height: 16px; vertical-align: top">
           <table style="width: 100%; vertical-align: top" cellspacing="0">
                 ...
                 <td class="LabelArea">
                       <asp:Label ID="lblTravelReason" Width="90px" runat="server" Text="سبب السفر  "
                           SkinID="Label_DefaultNormal" meta:resourcekey="lblTravelReasonResource1"></asp:Label>
                   </td>
                   <td class="DataArea">
                    <Asp:TextBox ID="TxtTravelReason" runat="server" BorderColor="#CCCCCC" BorderStyle="Solid"
                           BorderWidth="1px" Height="18px" NullDateLabel="" Style="font-family: Tahoma;
                           font-size: 8pt; font-weight: Normal; color: Black; border: solid 1px #CCCCCC"
                           Width="130px">
                       </Asp:TextBox>
