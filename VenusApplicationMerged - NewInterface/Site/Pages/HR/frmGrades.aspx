<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmGrades.aspx.vb" Inherits="frmGrades"
...
<head runat="server">
    <title>* Venus Payroll * ~Grades</title>
    <script src="Scripts/App_JScript.js" type="text/javascript"></script>
    <script src="Scripts/App_JScript_M.js" type="text/javascript"></script>
    <script src="Scripts/App_OtherFields_JScript.js" type="text/javascript"></script>
    <script src="Scripts/App_Search_JScript.js" type="text/javascript"></script>
    <script src="Scripts/App_JScript_PayRoll.js" type="text/javascript"></script>
    <script src="Scripts/App_Grades.js" type="text/javascript"></script>
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmGrades" runat="server">
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblGradeLevel" runat="server" SkinID="Label_DefaultNormal" Text="مستوى الحزم"
                                                                meta:resourcekey="lblGradeLevelResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <igtxt:WebNumericEdit ID="txtGradeLevel" runat="server" MinValue="0" NullText="0"
                                                                SkinID="WebNumericEdit_Fix" meta:resourcekey="txtGradeLevelResource1">
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblRegularHours" runat="server" SkinID="Label_DefaultNormal" Text="ساعات العمل "
                                                                meta:resourcekey="lblRegularHoursResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <igtxt:WebNumericEdit ID="txtRegularHours" runat="server" MaxValue="24" MinValue="1"
                                                                NullText="0" SkinID="WebNumericEdit_Fix" meta:resourcekey="txtRegularHoursResource1">
                                                                <ClientSideEvents Blur="txtRegularHoursLostFocusToGrid" />
                                                            </igtxt:WebNumericEdit>
                                                        </td>
                                                    </tr>
                                                </table>
                                                ...
                                                <table style="width: 100%; height: 30px; vertical-align: bottom; border-bottom: 1px solid black"
                                                    ...
                                                    <tr>
                                                        <td style="vertical-align: bottom">
                                                            <asp:Label ID="Label1" runat="server" Text="برجاء تحديد البنود" SkinID="Label_DefaultBold"
                                        ...
                                        <tr>
                                            <td style="height: 100%; vertical-align: top" colspan="3">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        <td>
                                                            <igtbl:UltraWebGrid   Browser="UpLevel"   ID="uwgGradesTransactions" runat="server" EnableAppStyling="False"
                                                                Height="100%" Width="99%" SkinID="Default" meta:resourcekey="uwgGradesTransactionsResource1">
                                                                <DisplayLayout AllowColSizingDefault="Free" AllowColumnMovingDefault="OnServer" AllowDeleteDefault="Yes"
                                                                    ...
                                                                    <ClientSideEvents AfterCellUpdateHandler="uwgGradesTransactions_AfterCellUpdateHandler"
                                                                        CellChangeHandler="uwgGradesTransactions_CellChangeHandler" EditKeyUpHandler="uwgGradesTransactions_EditKeyUpHandler" />
                                                                </DisplayLayout>
                                                                <Bands>
                                                                    <igtbl:UltraGridBand meta:resourcekey="ZResourceZUltraGridBandResource1" AllowAdd="Yes">
                                                                        <RowEditTemplate>
                                                                            <p align="right">
                                                                                <br />
                                                                            </p>
                                                                        ...
                                                                        <Columns>
                                                                            <igtbl:UltraGridColumn BaseColumnName="ID" Hidden="True" Key="ID" Width="0px" meta:resourcekey="UltraGridColumnResource5">
                                                                                <Header Caption="ID">
                                                                                </Header>
                                                                            </igtbl:UltraGridColumn>
                                                                            <igtbl:UltraGridColumn AllowUpdate="Yes" BaseColumnName="TransactionTypeID" CellButtonDisplay="Always"
                                                                                Key="TransactionTypeID" Type="DropDownList" Width="100%" meta:resourcekey="UltraGridColumnResource6">
                                                                                <Validators>
                                                                            ...
                                                                            <igtbl:UltraGridColumn AllowNull="False" AllowUpdate="Yes" BaseColumnName="MinValue"
                                                                                CellButtonDisplay="Always" DataType="System.Double" EditorControlID="" Format="###,###,###.##"
                                                                                Key="MinValue" Type="Custom" Width="90px" meta:resourcekey="UltraGridColumnResource7">
                                                                            ...
                                                                            <igtbl:UltraGridColumn AllowNull="False" AllowUpdate="Yes" BaseColumnName="MaxValue"
                                                                                CellButtonDisplay="Always" DataType="System.Double" Format="###,###,###.##" Key="MaxValue"
                                                                                Type="Custom" Width="90px" meta:resourcekey="UltraGridColumnResource8">
                                                                            ...
                                                                            <igtbl:UltraGridColumn AllowUpdate="Yes" BaseColumnName="PaidatVacation" CellButtonDisplay="Always"
                                                                                Key="PaidatVacation" Type="DropDownList" Width="120px" meta:resourcekey="UltraGridColumnResource9">
                                                                            ...
                                                                            <igtbl:UltraGridColumn AllowUpdate="Yes" BaseColumnName="OnceatPeriod" CellButtonDisplay="Always"
                                                                                Key="OnceatPeriod" Type="CheckBox" Width="120px" meta:resourcekey="UltraGridColumnResource10">
                                                                                <Header Caption="Once Per Period">
                                                                            ...
                                                                            <igtbl:UltraGridColumn AllowUpdate="Yes" BaseColumnName="IntervalID" CellButtonDisplay="Always"
                                                                                Key="IntervalID" Type="DropDownList" Width="140px" meta:resourcekey="UltraGridColumnResource11">
