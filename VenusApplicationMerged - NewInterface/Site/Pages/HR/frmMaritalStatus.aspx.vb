...
#Region "Public Decleration"
    Private ClsMaritalStatus As Clshrs_MaritalStatus
...
#Region "Protected Sub"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ClsMaritalStatus = New Clshrs_MaritalStatus(Me.Page)
        Dim ClsObjects As New Clssys_Objects(Page)
        Dim ClsSearchs As New Clssys_Searchs(Page)
        Dim SearchID As Integer = 0
        Try
            Dim clsSearchsColumns As New Clssys_SearchsColumns(Page)
            If ClsObjects.Find(" Code='" & ClsMaritalStatus.Table.Trim & "'") Then
            ...
            If Not IsPostBack Then
                Page.Session.Add("ConnectionString", ClsMaritalStatus.ConnectionString)
                ClsMaritalStatus.AddOnChangeEventToControls("frmMaritalStatus", Page, UltraWebTab1)
            ...
            If (txtCode.Text <> "") Then
                ClsMaritalStatus.Find(" Code='" & txtCode.Text & "'")
                IntrecordID = ClsMaritalStatus.ID
        ...
        Catch ex As Exception
            ...
            mErrorHandler.RecordExceptions_DataBase("", ex, Err.Number, ClsMaritalStatus.RegUserID, Venus.Shared.ErrorsHandler.eRecordingType.System_DataBase)
    ...
    Protected Sub ImageButton_Command(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.CommandEventArgs) Handles ImageButton_Save.Command, ImageButton_SaveN.Command, LinkButton_SaveN.Command, ImageButton_New.Command, ImageButton_Print.Command, ImageButton_Properties.Command, LinkButton_Properties.Command, ImageButton_Remarks.Command, LinkButton_Remarks.Command, ImageButton_Last.Command, ImageButton_Next.Command, ImageButton_Back.Command, ImageButton_First.Command, ImageButton_Delete.Command
        ...
        Dim ObjNavigationHandler As New Venus.Shared.Web.NavigationHandler(ClsMaritalStatus.ConnectionString)
        Select Case e.CommandArgument
            ...
            Case "New"
                AfterOperation()
            Case "Delete"
                ClsMaritalStatus.Delete("Code='" & txtCode.Text & "'")
                AfterOperation()
            Case "Property"
                If ClsMaritalStatus.Find("Code='" & txtCode.Text & "'") Then
                    Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmPropertyScreen.aspx?ID=" & ClsMaritalStatus.ID & "&TableName=" & ClsMaritalStatus.Table, 477, 313, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Property", False)
                End If
            Case "Remarks"
                If ClsMaritalStatus.Find("Code='" & txtCode.Text & "'") Then
                    Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmRemarks.aspx?ID=" & ClsMaritalStatus.ID & "&TableName=" & ClsMaritalStatus.Table, 410, 210, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Remarks", False)
                End If
            ...
            Case "First"
                ClsMaritalStatus.Find("Code='" & txtCode.Text & "'")
                ClsMaritalStatus.FirstRecord()
                GetValues(ClsMaritalStatus)
            Case "Previous"
                ClsMaritalStatus.Find("Code='" & txtCode.Text & "'")
                If Not ClsMaritalStatus.previousRecord() Then
                    ClsMaritalStatus.Find("Code='" & txtCode.Text & "'")
            ...
            Case "Next"
                ClsMaritalStatus.Find("Code='" & txtCode.Text & "'")
                If Not ClsMaritalStatus.NextRecord() Then
                    ClsMaritalStatus.Find("Code='" & txtCode.Text & "'")
...
#Region "Private Functions"
    Private Function SavePart() As Boolean
        Dim StrMode As String = Request.QueryString.Item("Mode")
        ClsMaritalStatus = New Clshrs_MaritalStatus(Page)

        Try
            ClsMaritalStatus.Find("Code='" & txtCode.Text & "'")

            If ClsMaritalStatus.ID > 0 Then
                If Not AssignValue(ClsMaritalStatus) Then
                    Exit Function
                End If
                ClsMaritalStatus.Update("Code='" & txtCode.Text & "'")

            Else
                If Not AssignValue(ClsMaritalStatus) Then
                    Exit Function
                End If
                ClsMaritalStatus.Save()

            End If

            ClsMaritalStatus.Find("Code='" & txtCode.Text & "'")

            clsMainOtherFields.CollectDataAndSave(value.Text, ClsMaritalStatus.Table, ClsMaritalStatus.ID)
            value.Text = ""
            Return True
        Catch ex As Exception
            Return False
        End Try
    End Function
    Private Function AssignValue(ByRef ClsMaritalStatus As Clshrs_MaritalStatus) As Boolean
        Try
            With ClsMaritalStatus
                .Code = txtCode.Text
        ...
        End Try
    End Function
    Private Function GetValues(ByVal ClsMaritalStatus As Clshrs_MaritalStatus) As Boolean
    ...
    Private Function SetToolbarSetting(ByVal ptrType As String, ByVal ClsClass As Object, ByVal intID As Integer) As Boolean
        Try
            Select Case ptrType
                ...
                Case "D"
                    ClsMaritalStatus.Find("ID=" & intID)
                    GetValues(ClsMaritalStatus)
    ...
    Private Function CheckCode() As Boolean
        ...
        Try
            ClsMaritalStatus.Find("Code='" & txtCode.Text & "'")
            IntId = ClsMaritalStatus.ID
            txtEngName.Focus()
            If ClsMaritalStatus.ID > 0 Then
                GetValues(ClsMaritalStatus)
                StrMode = "E"
            Else
                If ClsMaritalStatus.CheckRecordExistance(" Code='" & txtCode.Text & "'") Then
                    txtCode.Text = ""
                    txtCode.Focus()
                End If
            ...
            End If
            SetToolBarDefaults()
            SetToolBarPermission(Me, ClsMaritalStatus.ConnectionString, ClsMaritalStatus.DataBaseUserRelatedID, ClsMaritalStatus.GroupID, StrMode)
            SetToolBarRecordPermission(Me, ClsMaritalStatus.ConnectionString, ClsMaritalStatus.DataBaseUserRelatedID, ClsMaritalStatus.GroupID, ClsMaritalStatus.Table, IntId)
    ...
    Private Sub LoadDataUpdateSchedules(ByVal formName As String)
        ...
        ClsMaritalStatus = New Clshrs_MaritalStatus(Me.Page)
        ClsMaritalStatus.Find(" code = '" & txtCode.Text & "'")
        Dim recordID As Integer = ClsMaritalStatus.ID
        If (recordID > 0) Then
    ...
    Private Function CreateOtherFields(ByVal IntRecordID As Integer)
        ...
        If clsMainOtherFields.CheckOtherFieldsButton(Me.Page, ClsMaritalStatus.Table) = True Then
            Dim StrTablename As String
            ClsMaritalStatus = New Clshrs_MaritalStatus(Me)
            StrTablename = ClsMaritalStatus.Table
