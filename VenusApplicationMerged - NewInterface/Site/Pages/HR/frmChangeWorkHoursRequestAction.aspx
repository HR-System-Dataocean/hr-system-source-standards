<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmChangeWorkHoursRequestAction.aspx.vb"
    Inherits="frmChangeWorkHoursRequestAction" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
...
<body style="height: 100%; margin: 0; padding: 0;">
    <form id="frmChangeWorkHoursRequestAction" runat="server">
                            ...
                            <igtab:Tab Text="عام" meta:resourcekey="TabResource1">
                                <ContentTemplate>
                                    <table style="width: 100%; height: 100%; min-height: 350px; vertical-align: top"
                                        ...
                                        <tr>
                                            <td style="height: 100%">
                                                <table style="width: 100%; height: 100%; vertical-align: top; border-bottom: 1px solid silver">
                                                    <tr>
                                                        <td style="width: 5px">
                                                        </td>
