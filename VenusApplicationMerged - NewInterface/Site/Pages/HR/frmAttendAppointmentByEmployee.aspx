<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmAttendAppointmentByEmployee.aspx.vb"
            ...
            <tr>
                <td class="Details">
                    <igtab:UltraWebTab ID="UltraWebTab1" runat="server" EnableAppStyling="True" SkinID="Default"
                        ...
                        <Tabs>
                            <igtab:Tab Text="اسنادات الدوام لموظف" meta:resourcekey="TabResource1">
                                <ContentTemplate>
                                    <table style="width: 100%; height: 100%; min-height: 350px; vertical-align: top"
                                        cellspacing="0">
                                   
                                        <tr>
                                            <td style="width: 55%; height: 16px; vertical-align: top">
                                                <table style="width: 25%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                      <td class="SeparArea">
                                                      </td>
                                                      <td class="LabelArea">
                                                      <asp:Label ID="LblEmpCode" runat="server" Width="65px" SkinID="Label_DefaultNormal"
                                                        Text=" الموظف" meta:resourcekey="LblEmpCodeResource1"></asp:Label>
                                                      </td>
         
         
                                                      <td class="DataArea">
                                                      <asp:TextBox ID="TxtEmpCode" runat="server" SkinID="TextBox_SmalltNormalC" MaxLength="30"
                                                       AutoPostBack="True" meta:resourcekey="txtCodeResource1" Enabled="True"></asp:TextBox>
                                                       </td>
                                                     
                                                      <td class="search">
                                                      <igtxt:WebImageButton ID="BtnEmpSearch" runat="server" AutoSubmit="False" Height="18px"
  ...
  <asp:TextBox ID="TxtEmpName" runat="server"   EnableTheming="True" Height="18px" meta:resourcekey="txtBirthDateResource1" NullDateLabel="" Style="font-family: Tahoma; font-size: 8pt; font-weight: Normal;
        color: Black; border: solid 1px #CCCCCC" Value="" Width="300px">
                                                    ...
                                                    <tr>
                                                             ...
                                                             <td class="LabelArea">
             <asp:Label ID="LblShift" runat="server" Width="65px" SkinID="Label_DefaultNormal"
                 Text="خطة الدوام" meta:resourcekey="LblShiftResource1"></asp:Label>
         </td>
        
                  
                                                             <td class="DataArea">
     <asp:TextBox ID="TxtAttendShifts" runat="server" SkinID="TextBox_SmalltNormalC" MaxLength="30"
    AutoPostBack="True" meta:resourcekey="txtCodeResource1" Enabled="True"></asp:TextBox>
     </td>
         ...
         <Appearance>
             <Image Url="./Img/forum_search.gif" />
                                                        ...
                                                        <td class="DataArea">
  <asp:TextBox ID="TxtShiftName" runat="server"   EnableTheming="True" Height="18px" meta:resourcekey="txtBirthDateResource1" NullDateLabel="" Style="font-family: Tahoma; font-size: 8pt; font-weight: Normal;
        color: Black; border: solid 1px #CCCCCC" Value="" Width="300px">
    </asp:TextBox>
</td>
                                                    ...
                                                    <tr>
                                                             ...
                                                             <td class="LabelArea">
             <asp:Label ID="LblPeriod" runat="server" Width="65px" SkinID="Label_DefaultNormal"
                 Text="الفترة الزمنية" meta:resourcekey="LblCodeResource1"></asp:Label>
         </td>
        
                                                             <td class="DataArea">
 <asp:DropDownList ID="ddlPeriod" Width="200px" runat="server" AutoPostBack="True" SkinID="DropDownList_smallNormal"
     meta:resourcekey="ddlPeriodResource1" TabIndex="3">
 </asp:DropDownList>
     </td>
                                        ...
                                        <tr>
                                                <td style="height: 100%; vertical-align: top" colspan="3">
                                                    <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                        <tr>
                                                            <td>
                                                                <igtbl:UltraWebGrid  Browser="UpLevel"   ID="uwgPeriodDays" runat="server" EnableAppStyling="True"
                                                                    ...
                                                                    <DisplayLayout AllowColSizingDefault="Free" AllowDeleteDefault="Yes"  AllowAddNewDefault="Yes" AllowColumnMovingDefault="OnServer"
                                                                        ...
                                                                        Name="uwgPeriodDays" RowHeightDefault="18px"
                                                              ...
                                                              <%--           <ClientSideEvents AfterCellUpdateHandler="uwgSSConfiguration_ClickCellButtonHandler"
                                                            ClickCellButtonHandler="uwgSSConfiguration_ClickCellButtonHandler" />--%>
...
<%--                                                                                <igtbl:UltraGridColumn BaseColumnName="AttendShiftID" Hidden="True" Key="AttendShiftID">
                                                                                ...
                                                                                <igtbl:UltraGridColumn BaseColumnName="Date" Key="Date" DataType="System.String"
                                                                                   Width="30%" AllowUpdate="No">
                                                                                    ...
                                                                                    <Footer>
                                                                                       ...
                                                                                       <igtbl:UltraGridColumn BaseColumnName="DateNameEnglish" Key="DateNameEnglish" DataType="System.String"
                                                                                       ...
                                                                                       <RowLayoutColumnInfo OriginX="2" />
                                                                                         ...
                                                                                         <RowLayoutColumnInfo OriginX="2" />
                                                                                                                              ...
                                                                                                                              <igtbl:UltraGridColumn BaseColumnName="DateNameArabic" Key="DateNameArabic" DataType="System.String"
       
                                                                                           Width="30%" AllowUpdate="No">
           
                                                                                           <Header Caption="اليوم">
                                                                                       <RowLayoutColumnInfo OriginX="2" />
                                                                                          </Header>
                                                                                ...
                                                                                <igtbl:UltraGridColumn BaseColumnName="Apply" DataType="System.Boolean" Key="Apply"
                                                                                    Width="30%" Type="CheckBox" AllowUpdate="Yes">
                                                                                    <Header Caption="اسناد ">
