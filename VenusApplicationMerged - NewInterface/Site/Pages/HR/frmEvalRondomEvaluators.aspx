<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmEvalRondomEvaluators.aspx.vb"
                                ...
                                <ContentTemplate>
                                        ...
                                        <tr>
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lbl0" runat="server" Width="95px" Text="Select Employee" 
                                                                SkinID="Label_DefaultNormal" meta:resourcekey="lbl0Resource1"  ></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="DdlEmployee" runat="server" 
                                                                skinID="DropDownList_LargNormal" meta:resourcekey="DdlEmployeeResource1" >
                                                            </asp:DropDownList>
                                                            </td>
                                            ...
                                            <td style="width: 6%; height: 16px; vertical-align: top">
                                                <igtxt:WebImageButton ID="btnSearchCode1" runat="server" AutoSubmit="False" 
                                                ...
                                                <table style="width: 100%; height: 30px; vertical-align: bottom; border-bottom: 1px solid black"
                                                    ...
                                                    <tr>
                                                        <td style="vertical-align: bottom">
                                                            <asp:Label ID="Label_Title1" runat="server" Text="Add Rondom Evaluators"
