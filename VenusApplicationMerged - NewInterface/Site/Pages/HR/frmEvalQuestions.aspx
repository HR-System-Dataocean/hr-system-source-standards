<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmEvalQuestions.aspx.vb"
    Inherits="frmEvalQuestions" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
...
<head runat="server">
    <title>* Venus Payroll * ~Eval Questions</title>
    ...
    <script type="text/javascript" id="igClientScript">
        function uwgQuestionAnswers_AfterExitEditModeHandler(gridName, cellId) {
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmEvalQuestions" runat="server">
        <div style="display: none">
            <igtbl:UltraWebGrid   Browser="UpLevel"  ID="uwgGroups" runat="server"
                EnableAppStyling="False" Height="120px"
                SkinID="Default" Width="100%" meta:resourcekey="uwgGroupsResource1">
                ...
                <Bands>
                    <igtbl:UltraGridBand meta:resourcekey="UltraGridBandResource1" AllowAdd="Yes">
                        ...
                        <Columns>
                            <igtbl:UltraGridColumn AllowUpdate="Yes" BaseColumnName="IsCriteria" Key="IsCriteria"
                                CellButtonDisplay="Always" DataType="System.Boolean" Type="CheckBox"
                                Width="141px" meta:resourcekey="UltraGridColumnResource1">
                            ...
                            <igtbl:UltraGridColumn AllowResize="Fixed" AllowUpdate="No" Width="100%"
            ...
            <igtxt:WebTextEdit meta:resourcekey="WebTextEdit1Recourcekey" ID="WebTextEdit1"
                                                ...
                                                <td style="width: 47%; height: 16px; vertical-align: top">
                                                    <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                        <tr>
                                                            <td class="SeparArea"></td>
                                                            <td class="LabelArea">
                                                                <asp:Label ID="lblArbName1" runat="server" SkinID="Label_DefaultNormal"
                                                                    Text="English Content" meta:resourcekey="lblArbName1Resource1"></asp:Label>
                                                            </td>
                                                            <td class="DataArea">
                                                                <asp:TextBox ID="txtEngQuestion" runat="server" MaxLength="255"
                                                                    SkinID="TextBox_LargeNormalltr" meta:resourcekey="txtEngQuestionResource1"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                ...
                                                <td style="width: 47%; height: 16px; vertical-align: top">
                                                    <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                        <tr>
                                                            <td class="SeparArea"></td>
                                                            <td class="LabelArea">
                                                                <asp:Label ID="lblArbName0" runat="server" SkinID="Label_DefaultNormal"
                                                                    Text="Element Status" meta:resourcekey="lblArbName0Resource1"></asp:Label>
                                                            </td>
                                                            <td class="DataArea">
                                                                <asp:CheckBox ID="QStatus" runat="server" meta:resourcekey="QStatusResource1" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                ...
                                                <td style="width: 47%; height: 16px; vertical-align: top">
                                                    <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                        <tr>
                                                            <td class="SeparArea"></td>
                                                            <td class="LabelArea">
                                                                <asp:Label ID="lblArbName2" runat="server" SkinID="Label_DefaultNormal"
                                                                    Text="Arabic Content" meta:resourcekey="lblArbName2Resource1"></asp:Label>
                                                            </td>
                                                            <td class="DataArea">
                                                                <asp:TextBox ID="txtAraQuestion" runat="server" MaxLength="255"
                                                                    SkinID="TextBox_LargeNormalrtl"
                                                                    meta:resourcekey="txtAraQuestionResource1"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                    ...
                                                    <table style="width: 100%; height: 30px; vertical-align: bottom; border-bottom: 1px solid black"
                                                        ...
                                                        <tr>
                                                            <td style="vertical-align: bottom">
                                                                <asp:Label ID="Label1" runat="server" Text="Element Answers"
                                            ...
                                            <tr>
                                                <td style="height: 16px; vertical-align: top" colspan="3">
                                                    <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                        <tr>
                                                            <td>
                                                                <igtbl:UltraWebGrid  Browser="UpLevel"   ID="uwgQuestionAnswers" runat="server"
                                                                    EnableAppStyling="False" Height="250px"
                                                                    SkinID="Default" Width="100%"
                                                                    meta:resourcekey="uwgQuestionAnswersResource1">
                                                                    <DisplayLayout AllowColSizingDefault="Free" AllowColumnMovingDefault="OnServer"
                                                                        AllowDeleteDefault="Yes" AllowSortingDefault="OnClient"
                                                                        AllowUpdateDefault="Yes" AutoGenerateColumns="False"
                                                                        BorderCollapseDefault="Separate" HeaderClickActionDefault="SortSingle"
                                                                        ...
                                                                        <FrameStyle BackColor="Window" BorderColor="InactiveCaption"
                                                                            BorderStyle="Solid" BorderWidth="1px" Font-Names="Microsoft Sans Serif"
                                                                            Font-Size="8.25pt" Height="250px" Width="100%">
                                                                        </FrameStyle>

                                                                        <ClientSideEvents AfterExitEditModeHandler="uwgQuestionAnswers_AfterExitEditModeHandler" />
                                                                        ...
                                                                        <igtbl:UltraGridBand meta:resourcekey="ZResourceZUltraGridBandResource1" AllowAdd="Yes">
                                                                            ...
                                                                            <Columns>
                                                                                <igtbl:UltraGridColumn BaseColumnName="ID"
                                                                                    Hidden="True" Key="ID" Width="0px"
                                                                                    meta:resourcekey="UltraGridColumnResource4">
                                                                                    <Header Caption="ID">
                                                                                    </Header>
                                                                                </igtbl:UltraGridColumn>
                                                                                <igtbl:UltraGridColumn BaseColumnName="Answer_Eng" Width="50%"
                                                                                    meta:resourcekey="UltraGridColumnResource5">
                                                                                    <Header Caption="Answer English" Title="Answer_Eng">
                                                                                        <RowLayoutColumnInfo OriginX="1" />
                                                                                    </Header>
                                                                                ...
                                                                                <igtbl:UltraGridColumn BaseColumnName="Answer_Arb" Width="50%"
                                                                                    EditorControlID="WebTextEdit1" Type="Custom"
                                                                                    meta:resourcekey="UltraGridColumnResource6">
                                                                                    <Header Caption="Answer Arabic" Title="Answer_Arb">
                                                                                        <RowLayoutColumnInfo OriginX="2" />
                                                                                    </Header>
                                                                                    <HeaderStyle HorizontalAlign="Center" />
                                                                                    <CellStyle HorizontalAlign="Center">
                                                                                ...
                                                                                <igtbl:UltraGridColumn BaseColumnName="APower"
                                                                                    DataType="System.Int32" Key="APower" Width="120px"
                                                                                    meta:resourcekey="UltraGridColumnResource7">
                                                                                    <Header Caption="Answer Power" Title="APower">
                                                                                ...
                                                                                <igtbl:UltraGridColumn BaseColumnName="RegComputerID"
                                                                                    DataType="System.Int32" Key="RegComputerID" Width="100px"
                                                                                    meta:resourcekey="UltraGridColumnResource8">
                                                                                    <Header Caption="Rank" Title="Rank">
