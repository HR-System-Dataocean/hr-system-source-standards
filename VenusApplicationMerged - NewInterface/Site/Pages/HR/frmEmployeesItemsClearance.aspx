<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmEmployeesItemsClearance.aspx.vb"
    Inherits="frmEmployeesItemsClearance" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
...
<body style="height: 100%; margin: 0; padding: 0;">
    <form id="frmEmployeesItemsClearance" runat="server" defaultbutton="ImageButton1">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 20px">
                                                <asp:ImageButton ID="ImageButton_Save" Width="16px" Height="16px" runat="server"
                                                    CommandArgument="Save" SkinID="HrSave_Command" />
                                            </td>
                                            <td style="width: 100px">
                                    ...
                                    <table style="width: 100%; height: 100%; min-height: 350px; vertical-align: top"
                                        ...
                                        <tr>
                                            <td style="vertical-align: top" colspan="3">
                                                <igtbl:UltraWebGrid   Browser="UpLevel"  ID="uwgPendingItems" runat="server" EnableAppStyling="False"
                                                    ...
                                                    <Bands>
                                                        <igtbl:UltraGridBand AllowSorting="No" meta:resourcekey="UltraGridBandResource1">
                                                            <Columns>
                                                                ...
                                                                <igtbl:UltraGridColumn AllowUpdate="No" BaseColumnName="ItemName" Key="ItemName"
                                                                ...
                                                                <igtbl:UltraGridColumn AllowUpdate="No" BaseColumnName="LicenseNumber" Key="LicenseNumber"
                                                                    Width="120px" meta:resourcekey="UltraGridColumnResource6">
                                                                    <Header Caption="License Number">
                                                                ...
                                                                <igtbl:UltraGridColumn BaseColumnName="ReceivedDate" AllowUpdate="No" Key="ReceivedDate"
                                                                    Width="100px" meta:resourcekey="UltraGridColumnResource7">
                                                                    <Header Caption="Recieve Date">
