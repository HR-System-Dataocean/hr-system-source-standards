<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmEmployeeOfficialVacations.aspx.vb"
    Inherits="frmEmployeeOfficialVacations" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
                                ...
                                <igtab:Tab Text="عام" meta:resourcekey="TabResource1">
                                    <ContentTemplate>
                                        <table style="width: 100%; height: 100%; min-height: 350px; vertical-align: top"
                                            ...
                                            <tr>
                                                <td style="height: 16px; width: 15%; vertical-align: top;">
                                                    <table cellspacing="0" style="width: 100%; vertical-align: top">
                                                        <tr>
                                                            ...
                                                            <td class="LabelArea" style="height: 16px; width: 40%; vertical-align: top;">
                                                                ...
                                                                <Bands>
                                                                    <igtbl:UltraGridBand AllowSorting="No" meta:resourcekey="UltraGridBandResource1"
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <igtbl:UltraGridColumn BaseColumnName="Year" Key="Year" Hidden="True" Width="1px">
                                                                                <Header Caption="">
                                                                                </Header>
                                                                            </igtbl:UltraGridColumn>
