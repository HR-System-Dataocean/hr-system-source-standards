<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmOtherVacationsRequest.aspx.vb"
...
<head runat="server">
    <title>* Venus Payroll * ~Employee Other Vacation Request</title>
            ...
            <tr>
                <td class="Details">
                    <igtab:UltraWebTab ID="UltraWebTab1" runat="server" EnableAppStyling="True" SkinID="Default"
                        ...
                        <Tabs>
                            <igtab:Tab Text="طلب اجازة اخري" meta:resourcekey="TabResource1">
                                <ContentTemplate>
...
<%--                                               الموظف البديل         --%>
                                        ...
                                        <tr>
                                         ...
                                         <tr>    
                                             <td>
<div>
            <asp:Panel ID="AttachPnl" runat="server"  BackColor="#f0f0f0" Height="99%" Width="100%">
                <table style="width: 40%; vertical-align: top" cellspacing="0">
                                                 <tr>
       
                   <td class="SeparArea">
                                                        </td>
                   <td style="vertical-align: top">
                       <asp:Label ID="lblAttachments" runat="server" meta:resourcekey="lblAttachmentsResource2" SkinID="Label_DefaultBold"
    ...
    <td class="LabelArea">
        <asp:Label ID="lblDocumentNumber" runat="server" Width="95px" SkinID="Label_DefaultNormal"
...
<td>
    ...
    <td class="LabelArea">
        <asp:Label ID="lblReferanceNumber" runat="server" meta:resourcekey="lblReferanceNumberResource1"
            SkinID="Label_DefaultNormal" Text="Referance Number" Width="95px"></asp:Label>
    </td>
    <td class="DataArea">
          <asp:TextBox ID="txtReferanceNumber" runat="server" meta:resourcekey="TextBox_MachineCodeResource1"
 ...
 <td class="SeparArea">
        ...
        <td style="width: 24px">
            <asp:Button id="AddButton" runat="server" Text="Add ttachment"/>
                     ...
                     <tr>
                         <td>
                             <igtbl:UltraWebGrid    Browser="UpLevel"  ID="UwgEmployeeDocuments" runat="server" EnableAppStyling="True"
                                 Height="130px" Width="98%" SkinID="Default" meta:resourcekey="uwgForNationalityResource1">
                                 <DisplayLayout AllowColSizingDefault="Free" AllowColumnMovingDefault="OnServer" AllowDeleteDefault="Yes"
                                     ...
                                     <FrameStyle BackColor="Window" BorderColor="InactiveCaption" BorderStyle="Solid"
                                         BorderWidth="1px" Font-Names="Microsoft Sans Serif" Font-Size="8.25pt" Height="130px"
                                         Width="98%">
                                     </FrameStyle>
                                 ...
                                 <Bands>
                                     <igtbl:UltraGridBand meta:resourcekey="UltraGridBandResource1">
                                         ...
                                         <Columns>
                                             ...
                                             <igtbl:UltraGridColumn BaseColumnName="FileBytes" Key="FileBytes"   
                       meta:resourcekey="UltraGridColumnResource11">
    <Header Caption="FileBytes">
    ...
    <Footer>
        <RowLayoutColumnInfo OriginX="10" />
                                             ...
                                             <igtbl:UltraGridColumn BaseColumnName="FileName" Key="FileName" Type="DropDownList"
