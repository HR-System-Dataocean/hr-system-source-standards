<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmAppraisalEvaluation.aspx.vb"
...
<td class="DataArea">
    ...
    <asp:Label ID="lblLastAppDate" runat="server" Width="60px" SkinID="Label_LargtNormal"
...
<td class="DataArea">
                                <igtxt:WebMaskEdit ID="txtFromDate" runat="server" InputMask="##/##/####" 
                                     SkinID="WebMaskEdit_Fix" Width="220px">
                                 </igtxt:WebMaskEdit>
  </td>
              </tr>
                            <tr>
...
<%--            <tr>
                <td class="SeparArea"></td>
                <td class="LabelArea">
     <asp:Label ID="lblTotalPercent" Width="90px" runat="server" Text="TotalPercen"
          meta:resourcekey="lblTotalPercenResource1"></asp:Label>
 </td>
 <td class="DataArea">
     <asp:TextBox ID="txtTotalPercent" runat="server" SkinID="TextBox_SmalltNormalC" CssClass="js-total-percent"
    ...
    <td style="width: 47%; height: 16px; vertical-align: top">
                ...
                <tr>
    <td style="height: 300px; vertical-align: auto" colspan="3">
            ...
            <Bands>
                <igtbl:UltraGridBand meta:resourcekey="UltraGridBandResource1">
                    ...
                    <Columns>
                        ...
                        <igtbl:UltraGridColumn BaseColumnName="CriteriaGroupID" DataType="System.Int32" Hidden="True"
      ...
      <Header Caption="CriteriaID">
                                             ...
                                             <igtbl:UltraGridColumn BaseColumnName="CriteriaGroupName" DataType="System.String"
      ...
      <Header Caption="CriteriaID">
        ...
        <Footer>
            <RowLayoutColumnInfo OriginX="3" />
                                       ...
                                       <igtbl:UltraGridColumn BaseColumnName="AppraisalScore" AllowUpdate="Yes" DataType="System.Int32"
                                         ...
                                         <igtbl:UltraGridColumn AllowUpdate="Yes" BaseColumnName="AppraisalRemarks" DataType="System.String"
                                             Key="AppraisalRemarks" meta:resourcekey="AppraisalRemarksColumnResource4"
                                            Width="35%">
    ...
    <Footer>
        <RowLayoutColumnInfo OriginX="3" />
                             ...
                             <igtbl:UltraGridColumn BaseColumnName="Weight" DataType="System.Int32" Hidden="True"
                                 Key="Weight" meta:resourcekey="UltraGridColumnResource1"  >
               ...
               <tr>
       <td style="width: 47%; height: 60px; vertical-align: top">
           <table style="width: 100%; vertical-align: top" cellspacing="0">
               <tr>
                   <td class="SeparArea">
                   </td>
                   <td class="LabelArea">
                       <asp:Label ID="lblWeaknessPoints" Width="90px" runat="server" Text="WeaknessPoints"
                           SkinID="Label_DefaultNormal" meta:resourcekey="lblWeaknessPointsResource1"></asp:Label>
                   </td>
                   <td class="DataArea">
                       <asp:TextBox ID="txtWeaknessPoints" runat="server" Width="350px"
                           Height="50px" MaxLength="8000"
                           TextMode="MultiLine" meta:resourcekey="txtWeaknessPointsResource1"
                           TabIndex="1"></asp:TextBox>
                   </td>
                    <td class="LabelArea">
     <asp:Label ID="lblStrengthPoints" Width="90px" runat="server" Text="StrengthPoints"
         SkinID="Label_DefaultNormal" meta:resourcekey="lblStrengthPointsResource1"></asp:Label>
 </td>
 <td class="DataArea">
     <asp:TextBox ID="txtStrengthPoints" runat="server" Width="350px"
         Height="50px" MaxLength="8000"
         TextMode="MultiLine" meta:resourcekey="txtStrengthPointsResource1"
         TabIndex="1"></asp:TextBox>
 </td>
               </tr>
           </table>
       ...
       <td style="width: 47%; height: 60px; vertical-align: top">
          ...
          <td style="width: 47%; height: 16px; vertical-align: top">
             ...
             <tr>
       <td style="height: 100px; vertical-align: auto" colspan="3">
