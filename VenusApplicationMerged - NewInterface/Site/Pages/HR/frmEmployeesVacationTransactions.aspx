<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmEmployeesVacationTransactions.aspx.vb"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="DataArea">
                                                                <igtxt:WebNumericEdit ID="SettlementDaysText" runat="server" SkinID="WebNumericEdit_Fix" MinDecimalPlaces="Two"
                                                                    Nullable="False" MaxLength="5" meta:resourcekey="txtPreparedDaysResource1">
                                                                    <ClientSideEvents ValueChange="dopostback()" />
                                                                </igtxt:WebNumericEdit>
                                                            </td>
                                                        </tr>
