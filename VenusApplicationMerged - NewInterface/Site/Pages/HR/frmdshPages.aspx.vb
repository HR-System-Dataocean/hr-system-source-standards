...
Partial Class frmdshPages
    Inherits MainPage
#Region "Public Decleration"
    Private ClsdshPages As Clsdsh_Pages
...
#Region "Protected Sub"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ClsdshPages = New Clsdsh_Pages(Me.Page)
        Dim ClsObjects As New Clssys_Objects(Page)
        Dim ClsSearchs As New Clssys_Searchs(Page)
        Dim SearchID As Integer = 0
        Try
            Dim clsSearchsColumns As New Clssys_SearchsColumns(Page)
            If ClsObjects.Find(" Code='" & ClsdshPages.Table.Trim & "'") Then
            ...
            If Not IsPostBack Then
                Page.Session.Add("ConnectionString", ClsdshPages.ConnectionString)
                ClsdshPages.AddOnChangeEventToControls("frmdshPages", Page, UltraWebTab1)
            ...
            If (txtCode.Text <> "") Then
                ClsdshPages.Find(" Code='" & txtCode.Text & "'")
                IntrecordID = ClsdshPages.ID
        ...
        Catch ex As Exception
            ...
            mErrorHandler.RecordExceptions_DataBase("", ex, Err.Number, ClsdshPages.RegUserID, Venus.Shared.ErrorsHandler.eRecordingType.System_DataBase)
    ...
    Protected Sub ImageButton_Command(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.CommandEventArgs) Handles ImageButton_Save.Command, ImageButton_SaveN.Command, LinkButton_SaveN.Command, ImageButton_New.Command, ImageButton_Print.Command, ImageButton_Properties.Command, LinkButton_Properties.Command, ImageButton_Remarks.Command, LinkButton_Remarks.Command, ImageButton_Last.Command, ImageButton_Next.Command, ImageButton_Back.Command, ImageButton_First.Command, ImageButton_Delete.Command
        ...
        Dim ObjNavigationHandler As New Venus.Shared.Web.NavigationHandler(ClsdshPages.ConnectionString)
        Select Case e.CommandArgument
            ...
            Case "New"
                AfterOperation()
            Case "Delete"
                ClsdshPages.Delete("Code='" & txtCode.Text & "'")
                AfterOperation()
            Case "Property"
                ClsdshPages.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmPropertyScreen.aspx?ID=" & ClsdshPages.ID & "&TableName=" & ClsdshPages.Table, 477, 313, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Property", False)
            Case "Remarks"
                ClsdshPages.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmRemarks.aspx?ID=" & ClsdshPages.ID & "&TableName=" & ClsdshPages.Table, 410, 210, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Remarks", False)
            Case "Print"
            ...
            Case "First"
                ClsdshPages.Find("Code='" & txtCode.Text & "'")
                ClsdshPages.FirstRecord()
                GetValues(ClsdshPages)
            Case "Previous"
                ClsdshPages.Find("Code='" & txtCode.Text & "'")
                If Not ClsdshPages.previousRecord() Then
                    ClsdshPages.Find("Code='" & txtCode.Text & "'")
            ...
            Case "Next"
                ClsdshPages.Find("Code='" & txtCode.Text & "'")
                If Not ClsdshPages.NextRecord() Then
                    ClsdshPages.Find("Code='" & txtCode.Text & "'")
...
#Region "Private Functions"
    Private Function SavePart() As Boolean
        Dim StrMode As String = Request.QueryString.Item("Mode")
        ClsdshPages = New Clsdsh_Pages(Page)

        Try
            ClsdshPages.Find("Code='" & txtCode.Text & "'")

            If ClsdshPages.ID > 0 Then
                If Not AssignValue(ClsdshPages) Then
                    Exit Function
                End If
                ClsdshPages.Update("Code='" & txtCode.Text & "'")
            ...
            clsMainOtherFields.CollectDataAndSave(value.Text, ClsdshPages.Table, ClsdshPages.ID)
            value.Text = ""
            Return True
        Catch ex As Exception
            Return False
        End Try
    End Function
    Private Function AssignValue(ByRef ClsdshPages As Clsdsh_Pages) As Boolean
        Try
            With ClsdshPages
                .Code = txtCode.Text
        ...
        End Try
    End Function
    Private Function GetValues(ByVal ClsdshPages As Clsdsh_Pages) As Boolean
        ...
        Try
            ...
            With ClsdshPages
                ...
                If Page.IsPostBack Then
                    CreateOtherFields(ClsdshPages.ID)
                End If
            End With
            Return True
        Catch ex As Exception
    ...
    Private Function CheckCode() As Boolean
        ...
        Try
            ClsdshPages.Find("Code='" & txtCode.Text & "'")
            IntId = ClsdshPages.ID
            txtEngName.Focus()
            If ClsdshPages.ID > 0 Then
                GetValues(ClsdshPages)
                StrMode = "E"
            Else
                If ClsdshPages.CheckRecordExistance(" Code='" & txtCode.Text & "'") Then
                    txtCode.Text = ""
                    txtCode.Focus()
                End If
            ...
            End If
            SetToolBarDefaults()
            SetToolBarPermission(Me, ClsdshPages.ConnectionString, ClsdshPages.DataBaseUserRelatedID, ClsdshPages.GroupID, StrMode)
            SetToolBarRecordPermission(Me, ClsdshPages.ConnectionString, ClsdshPages.DataBaseUserRelatedID, ClsdshPages.GroupID, ClsdshPages.Table, IntId)
    ...
    Private Sub LoadDataUpdateSchedules(ByVal formName As String)
        ...
        ClsdshPages = New Clsdsh_Pages(Me.Page)
        ClsdshPages.Find(" code = '" & txtCode.Text & "'")
        Dim recordID As Integer = ClsdshPages.ID
        If (recordID > 0) Then
    ...
    Private Function CreateOtherFields(ByVal IntRecordID As Integer)
        ...
        If clsMainOtherFields.CheckOtherFieldsButton(Me.Page, ClsdshPages.Table) = True Then
            Dim StrTablename As String
            ClsdshPages = New Clsdsh_Pages(Me)
            StrTablename = ClsdshPages.Table
