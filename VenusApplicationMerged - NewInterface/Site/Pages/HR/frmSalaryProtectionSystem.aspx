<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmSalaryProtectionSystem.aspx.vb"
    Inherits="frmSalaryProtectionSystem" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="DropDownList_Bank" runat="server" SkinID="DropDownList_LargNormal">
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                </table>
