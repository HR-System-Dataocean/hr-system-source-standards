<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmTransferPayParts.aspx.vb"
    Inherits="frmTransferPayParts" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmTransferPayParts" runat="server">
    ...
    <div class="Div_MasterContainer" runat="server" id="DIV">
                                    ...
                                    <table style="width: 47%; height: 100%; min-height: 350px; vertical-align: top"
                                        ...
                                        <tr>
                                             <td style="width: 10px"></td>
                                                          ...
                                                          <td class="LabelArea">
                                                            <asp:Label ID="lblCurrentInstallment" Width="100px" runat="server" Text=" Current Installment "
                                                                SkinID="Label_DefaultNormal" meta:resourcekey="lblCurrentInstallmentResource1"></asp:Label>
                                                        </td>
                                                       
                                                          <td>
                                                                         <asp:TextBox ID="txtCurrentInstallment" Width="120px" runat="server"  MaxLength="15"
                                                                 meta:resourcekey="txtCurrentInstallmentResource1">
                                                           </asp:TextBox>
     ...
     <td style="width: 10px"></td>
                  ...
                  <td class="LabelArea">
                    <asp:Label ID="lblTransValue" Width="100px" runat="server" Text=" Trans Value "
                        SkinID="Label_DefaultNormal" meta:resourcekey="lblTransValueResource1"></asp:Label>
                </td>
               
                  <td>
                                 <asp:TextBox ID="txtTransValue" Width="120px" runat="server"  MaxLength="15"
                         meta:resourcekey="txtTransValueResource1">
                   </asp:TextBox>
