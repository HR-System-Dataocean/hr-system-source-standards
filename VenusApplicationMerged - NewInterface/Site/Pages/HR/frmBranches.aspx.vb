...
#Region "Public Decleration"
    Private ClsBranches As Clssys_Branches
...
#Region "Protected Sub"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ClsBranches = New Clssys_Branches(Me.Page)
        Dim ClsObjects As New Clssys_Objects(Page)
        Dim ClsSearchs As New Clssys_Searchs(Page)
        Dim SearchID As Integer = 0
        Try
            Dim clsSearchsColumns As New Clssys_SearchsColumns(Page)
            If ClsObjects.Find(" Code='" & ClsBranches.Table.Trim & "'") Then
            ...
            If Not IsPostBack Then
                Page.Session.Add("ConnectionString", ClsBranches.ConnectionString)
                ClsBranches.AddOnChangeEventToControls("frmBranches", Page, UltraWebTab1)
                ...
                ClsBranches.GetDropDownList(DdlParentBranch, True)
            End If
            '================================== Add DateUpdateSchedules [Start]
            Dim IntrecordID As Integer
            If (txtCode.Text <> "") Then
                ClsBranches.Find(" Code='" & txtCode.Text & "'")
                IntrecordID = ClsBranches.ID
        ...
        Catch ex As Exception
            ...
            mErrorHandler.RecordExceptions_DataBase("", ex, Err.Number, ClsBranches.RegUserID, Venus.Shared.ErrorsHandler.eRecordingType.System_DataBase)
    ...
    Protected Sub ImageButton_Command(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.CommandEventArgs) Handles ImageButton_Save.Command, ImageButton_SaveN.Command, LinkButton_SaveN.Command, ImageButton_New.Command, ImageButton_Print.Command, ImageButton_Properties.Command, LinkButton_Properties.Command, ImageButton_Remarks.Command, LinkButton_Remarks.Command, ImageButton_Last.Command, ImageButton_Next.Command, ImageButton_Back.Command, ImageButton_First.Command, ImageButton_Delete.Command
        ...
        Dim ObjNavigationHandler As New Venus.Shared.Web.NavigationHandler(ClsBranches.ConnectionString)
        Select Case e.CommandArgument
            ...
            Case "New"
                AfterOperation()
            Case "Delete"
                ClsBranches.Delete("Code='" & txtCode.Text & "'")
                AfterOperation()
            Case "Property"
                ClsBranches.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmPropertyScreen.aspx?ID=" & ClsBranches.ID & "&TableName=" & ClsBranches.Table, 477, 313, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Property", False)
            Case "Remarks"
                ClsBranches.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmRemarks.aspx?ID=" & ClsBranches.ID & "&TableName=" & ClsBranches.Table, 410, 210, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Remarks", False)
            Case "Print"
            ...
            Case "First"
                ClsBranches.Find("Code='" & txtCode.Text & "'")
                ClsBranches.FirstRecord()
                GetValues(ClsBranches)
            Case "Previous"
                ClsBranches.Find("Code='" & txtCode.Text & "'")
                If Not ClsBranches.previousRecord() Then
                    ClsBranches.Find("Code='" & txtCode.Text & "'")
            ...
            Case "Next"
                ClsBranches.Find("Code='" & txtCode.Text & "'")
                If Not ClsBranches.NextRecord() Then
                    ClsBranches.Find("Code='" & txtCode.Text & "'")
...
#Region "Private Functions"
    Private Function SavePart() As Boolean
        ...
        Try
            ...
            If ClsBranches.ID > 0 Then
                If Not AssignValue(ClsBranches) Then
                    Exit Function
                End If
                ClsBranches.Update("Code='" & txtCode.Text & "'")
        ...
        End Try
    End Function
    Private Function AssignValue(ByRef ClsBranches As Clssys_Branches) As Boolean
        Try
            With ClsBranches
                .Code = txtCode.Text
                ...
                .ParentID = IIf(DdlParentBranch.SelectedItem.Value = 0, Nothing, DdlParentBranch.SelectedItem.Value)
                .DefaultAbsent = chkDefaultAbsent.Checked
                .PrepareDay = txtPrepareDay.Value
                .AffectPeriod = chkAffectPeriod.Checked
            End With
        ...
        End Try
    End Function
    Private Function GetValues(ByVal ClsBranches As Clssys_Branches) As Boolean
        ...
        Try
            ...
            With ClsBranches
                ...
                chkAffectPeriod.Checked = .AffectPeriod
                chkDefaultAbsent.Checked = .DefaultAbsent
                ...
                If str.Trim <> String.Empty Then
                    .GetDropDownList(DdlParentBranch, True, " sys_Branches.ID <> " & .ID & " And sys_Branches.ID  not in ( " & str & " )")
                Else
                    .GetDropDownList(DdlParentBranch, True, "sys_Branches.ID <> " & .ID)
                End If
                DdlParentBranch.SelectedValue = IIf(.ParentID Is Nothing, 0, .ParentID)
                ...
                If Page.IsPostBack Then
                    CreateOtherFields(ClsBranches.ID)
                End If
            End With
            Return True
        Catch ex As Exception
    ...
    Private Function CheckCode() As Boolean
        ...
        Try
            ClsBranches.Find("Code='" & txtCode.Text & "'")
            IntId = ClsBranches.ID
            txtEngName.Focus()
            If ClsBranches.ID > 0 Then
                GetValues(ClsBranches)
                StrMode = "E"
            Else
                If ClsBranches.CheckRecordExistance(" Code='" & txtCode.Text & "'") Then
                    txtCode.Text = ""
                    txtCode.Focus()
                End If
            ...
            End If
            SetToolBarDefaults()
            SetToolBarPermission(Me, ClsBranches.ConnectionString, ClsBranches.DataBaseUserRelatedID, ClsBranches.GroupID, StrMode)
            SetToolBarRecordPermission(Me, ClsBranches.ConnectionString, ClsBranches.DataBaseUserRelatedID, ClsBranches.GroupID, ClsBranches.Table, IntId)
    ...
    Private Function Clear() As Boolean
        ...
        lblRegDateValue.Text = ""
        lblCancelDateValue.Text = ""
        chkAffectPeriod.Checked = False
        chkDefaultAbsent.Checked = False
    ...
    Private Sub LoadDataUpdateSchedules(ByVal formName As String)
        ...
        ClsBranches = New Clssys_Branches(Me.Page)
        ClsBranches.Find(" code = '" & txtCode.Text & "'")
        Dim recordID As Integer = ClsBranches.ID
        If (recordID > 0) Then
    ...
    Private Function CreateOtherFields(ByVal IntRecordID As Integer)
        ...
        If clsMainOtherFields.CheckOtherFieldsButton(Me.Page, ClsBranches.Table) = True Then
            ...
            ClsBranches = New Clssys_Branches(Me)
