...
#Region "Protected Sub"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If ClsObjects.Find(" Code='" & ClsModules.Table.Trim & "'") Then
            ...
            If Not IsPostBack Then
                Page.Session.Add("ConnectionString", ClsModules.ConnectionString)
                ClsModules.AddOnChangeEventToControls("frmModules", Page, UltraWebTab1)
            ...
            If (txtCode.Text <> "") Then
                ClsModules.Find(" Code='" & txtCode.Text & "'")
                IntrecordID = ClsModules.ID
        ...
        Catch ex As Exception
            ...
            mErrorHandler.RecordExceptions_DataBase("", ex, Err.Number, ClsModules.RegUserID, Venus.Shared.ErrorsHandler.eRecordingType.System_DataBase)
    ...
    Protected Sub ImageButton_Command(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.CommandEventArgs) Handles ImageButton_Save.Command, ImageButton_SaveN.Command, LinkButton_SaveN.Command, ImageButton_New.Command, ImageButton_Print.Command, ImageButton_Properties.Command, LinkButton_Properties.Command, ImageButton_Remarks.Command, LinkButton_Remarks.Command, ImageButton_Last.Command, ImageButton_Next.Command, ImageButton_Back.Command, ImageButton_First.Command, ImageButton_Delete.Command
        ...
        Dim ObjNavigationHandler As New Venus.Shared.Web.NavigationHandler(ClsModules.ConnectionString)
        Select Case e.CommandArgument
            ...
            Case "New"
                AfterOperation()
            Case "Delete"
                ClsModules.Delete("Code='" & txtCode.Text & "'")
                AfterOperation()
            Case "Property"
                ClsModules.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmPropertyScreen.aspx?ID=" & ClsModules.ID & "&TableName=" & ClsModules.Table, 477, 313, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Property", False)
            Case "Remarks"
                ClsModules.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmRemarks.aspx?ID=" & ClsModules.ID & "&TableName=" & ClsModules.Table, 410, 210, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Remarks", False)
            Case "Print"
            ...
            Case "First"
                ClsModules.Find("Code='" & txtCode.Text & "'")
                ClsModules.FirstRecord()
                GetValues(ClsModules)
            Case "Previous"
                ClsModules.Find("Code='" & txtCode.Text & "'")
                If Not ClsModules.previousRecord() Then
                    ClsModules.Find("Code='" & txtCode.Text & "'")
            ...
            Case "Next"
                ClsModules.Find("Code='" & txtCode.Text & "'")
                If Not ClsModules.NextRecord() Then
                    ClsModules.Find("Code='" & txtCode.Text & "'")
...
#Region "Private Functions"
    Private Function SavePart() As Boolean
        ...
        Try
            ...
            If ClsModules.ID > 0 Then
                If Not AssignValue(ClsModules) Then
                    Exit Function
                End If
                ClsModules.Update("Code='" & txtCode.Text & "'")
            ...
            clsMainOtherFields.CollectDataAndSave(value.Text, ClsModules.Table, ClsModules.ID)
            value.Text = ""
            Return True
        Catch ex As Exception
            Return False
        End Try
    End Function
    Private Function AssignValue(ByRef ClsModules As Clssys_Modules) As Boolean
        Try
            With ClsModules
                .Code = txtCode.Text
                ...
                .IsRegistered = chkIsRegistered.Checked
                .FiscalYearDependant = chkFiscalYearDependant.Checked
            End With
        ...
        End Try
    End Function
    Private Function GetValues(ByVal ClsModules As Clssys_Modules) As Boolean
        ...
        Try
            ...
            With ClsModules
                ...
                chkIsRegistered.Checked = .IsRegistered
                chkFiscalYearDependant.Checked = .FiscalYearDependant
                ...
                If Page.IsPostBack Then
                    CreateOtherFields(ClsModules.ID)
                End If
            End With
            Return True
        Catch ex As Exception
    ...
    Private Function CheckCode() As Boolean
        ...
        Try
            ...
            If ClsModules.ID > 0 Then
                ...
                StrMode = "E"
            Else
                If ClsModules.CheckRecordExistance(" Code='" & txtCode.Text & "'") Then
                    txtCode.Text = ""
                    txtCode.Focus()
                End If
            ...
            End If
            SetToolBarDefaults()
            SetToolBarPermission(Me, ClsModules.ConnectionString, ClsModules.DataBaseUserRelatedID, ClsModules.GroupID, StrMode)
            SetToolBarRecordPermission(Me, ClsModules.ConnectionString, ClsModules.DataBaseUserRelatedID, ClsModules.GroupID, ClsModules.Table, IntId)
    ...
    Private Function Clear() As Boolean
        ...
        chkFiscalYearDependant.Checked = False
    ...
    Private Sub LoadDataUpdateSchedules(ByVal formName As String)
        ...
        ClsModules = New Clssys_Modules(Me.Page)
        ClsModules.Find(" code = '" & txtCode.Text & "'")
        Dim recordID As Integer = ClsModules.ID
        If (recordID > 0) Then
    ...
    Private Function CreateOtherFields(ByVal IntRecordID As Integer)
        ...
        If clsMainOtherFields.CheckOtherFieldsButton(Me.Page, ClsModules.Table) = True Then
            Dim StrTablename As String
            ClsModules = New Clssys_Modules(Me)
            StrTablename = ClsModules.Table
