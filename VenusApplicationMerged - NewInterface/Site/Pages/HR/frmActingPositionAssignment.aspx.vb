...
Partial Class frmActingPositionAssignment
    ...
    Protected Sub Toolbar_Command(ByVal sender As Object, ByVal e As CommandEventArgs) Handles _
        ...
        ImageButton_Print.Command, ImageButton_Properties.Command, LinkButton_Properties.Command,
    ...
    Private Sub BindGrid()
        ...
        Dim positionName As String = If(ProfileCls.CurrentLanguage = "Ar", "P.ArbName", "P.EngName")
        Dim sql As String = "SELECT A.Code, P.Code+' - '+ISNULL(" & positionName & ",'') OriginalPosition," &
            " E.Code+' - '+ISNULL(" & nameExpression & ",'') ActingEmployee, A.EffectiveFrom, A.EffectiveTo" &
            " FROM hrs_ActingPositionAssignments A INNER JOIN hrs_Positions P ON P.ID=A.OriginalPositionID" &
