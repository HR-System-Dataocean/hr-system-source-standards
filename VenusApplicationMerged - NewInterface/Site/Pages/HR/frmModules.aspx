<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmModules.aspx.vb" Inherits="frmModules"
...
<head runat="server">
    <title>* Venus Payroll * ~Modules</title>
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmModules" runat="server">
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblPrefix" runat="server" Text="رمز الإختصار" SkinID="Label_DefaultNormal"
                                                                meta:resourcekey="lblPrefixResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="txtPrefix" runat="server" SkinID="TextBox_LargeNormalrtl" MaxLength="255"
                                                                meta:resourcekey="txtPrefixResource1"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblIsRegister" runat="server" Text="مسجل" SkinID="Label_DefaultNormal"
                                                                meta:resourcekey="lblIsRegisterResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:CheckBox ID="chkIsRegistered" runat="server" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblFiscalYearDependant" runat="server" Text="مرتبط بالسنوات المالية"
                                                                SkinID="Label_DefaultNormal" meta:resourcekey="lblFiscalYearDependantResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:CheckBox ID="chkFiscalYearDependant" runat="server" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
