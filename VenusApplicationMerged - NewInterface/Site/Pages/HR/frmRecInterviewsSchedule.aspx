<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmRecInterviewsSchedule.aspx.vb"
    Inherits="frmRecInterviewsSchedule" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
...
<head runat="server">
    <title>* Venus Payroll * ~Interviews Schedule</title>
    ...
    <script src="Scripts/App_JScript_frmRecInterviewsSchedule.js" type="text/javascript"
        id="igClientScript"></script>
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmRecInterviewsSchedule" runat="server">
    ...
    <div style="display: none">
        ...
        <asp:TextBox ID="txtReturned" runat="server" AutoPostBack="True" onkeypress="return AllowAlphaNumericOnly(this);"
            meta:resourcekey="txtReturnedResource1"></asp:TextBox>
        <igtxt:WebTextEdit ID="txtApplicantCode" runat="server" meta:resourcekey="txtApplicantCodeRecourcekey"
            Text="00" style="display: none;">
            <ClientSideEvents KeyDown="txtApplicantCode_KeyDown" />
        </igtxt:WebTextEdit>
        <igtxt:WebDateTimeEdit meta:resourcekey="WebDateTimeEdit1Recourcekey" ID="WebDateTimeEdit1"
            runat="server" DataMode="Text" style="display: none;">
        </igtxt:WebDateTimeEdit>
        <igtxt:WebMaskEdit meta:resourcekey="WebMaskEdit1Recourcekey" ID="WebMaskEdit1" runat="server"
            InputMask="##:##" style="display: none;">
        </igtxt:WebMaskEdit>
        <igtxt:WebTextEdit meta:resourcekey="txtInterviewerCodeRecourcekey" ID="txtInterviewerCode"
            runat="server" Text="00" style="display: none;">
            <ClientSideEvents KeyDown="txtInterviewerCode_KeyDown" />
        </igtxt:WebTextEdit>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblApplicantSend" runat="server" SkinID="Label_DefaultNormal" Text="ارسال لمُتقدم للوظيفة"
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblopenvacancy" runat="server" SkinID="Label_DefaultNormal" Text="وظيفة متاحة"
                                                                meta:resourcekey="lblopenvacancyResource1"></asp:Label>
                                                            <asp:Label ID="Label_Star2" runat="server" meta:resourcekey="Label_Star1Resource1"
                                                                Style="color: #FF0000" Text="*"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="ddlopenvacancy" runat="server" meta:resourcekey="ddlDepartmentResource1"
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblStatus" runat="server" meta:resourcekey="lblStatusResource1" SkinID="Label_DefaultNormal"
                                                                Text="ارسال لمُجري للمقالبة"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:CheckBox ID="ChkInterViewserSend" runat="server" Height="20px" meta:resourcekey="ChkInterViewserSendRecourcekey"
                                                                TabIndex="5" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblEvalType" runat="server" SkinID="Label_DefaultNormal" Text=" نوع التقييم"
                                                                meta:resourcekey="lblEvalTypeResource1"></asp:Label>
                                                            <asp:Label ID="Label_Star3" runat="server" meta:resourcekey="Label_Star1Resource1"
                                                                Style="color: #FF0000" Text="*"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="ddlEvalType" runat="server" meta:resourcekey="ddl_PrantBranchResource1" AutoPostBack ="true"
                                                    ...
                                                    <tr>
                                                        <td class="LabelArea">
                                                            ...
                                                            <igtxt:WebImageButton ID="btnAddPeriod" runat="server" ClickOnEnterKey="False" ClickOnSpaceKey="False"
                                                                Height="18px" ImageDirectory="/ig_common/20071CLR20/Styles/Office2007Blue/WebImageButton/"
                                                                meta:resourcekey="btnAddPeriodResource1" Text="Applicants Advanced" UseBrowserDefaults="False">
                                                    ...
                                                    <tr>
                                                        <td style="vertical-align: bottom">
                                                            <asp:Label ID="Label_Title1" runat="server" meta:resourcekey="Label_Title1Resource1"
                                                                SkinID="Label_DefaultBold" Text="الرجاء تحديد بيانات المُتقدم للوظيفة"></asp:Label>
                                                            <asp:Label ID="Label_Star4" runat="server" meta:resourcekey="Label_Star1Resource1"
                                                                Style="color: #FF0000" Text="*"></asp:Label>
                                                        </td>
                                                    </tr>
                                                </table>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <igtbl:UltraWebGrid  Browser="UpLevel"   ID="uwgApplicants" runat="server" EnableAppStyling="False" Height="120px"
                                                                meta:resourcekey="uwgApplicantsResource1" SkinID="Default" Width="100%">
                                                                <DisplayLayout AllowColSizingDefault="Free" AllowColumnMovingDefault="OnServer" AllowDeleteDefault="Yes"
                                                                    ...
                                                                    <ClientSideEvents AfterEnterEditModeHandler="uwgApplicants_AfterEnterEditModeHandler"
                                                                        AfterCellUpdateHandler="uwgApplicants_AfterCellUpdateHandler" ClickCellButtonHandler="uwgApplicants_ClickCellButtonHandler" />
                                                                </DisplayLayout>
                                                                <Bands>
                                                                    <igtbl:UltraGridBand meta:resourcekey="UltraGridBandResource1" AllowAdd="Yes" 
                                                                        AllowDelete="Yes" AllowSorting="Yes" AllowUpdate="Yes">
                                                                        <RowEditTemplate>
                                                                            <p align="right">
                                                                                <br />
                                                                            </p>
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <igtbl:UltraGridColumn BaseColumnName="Applicant_ID" DataType="System.Int32" Hidden="True"
                                                                                Key="AID" meta:resourcekey="UltraGridColumnResource2">
                                                                                <Header Caption="Applicant_ID">
                                                                            ...
                                                                            <igtbl:UltraGridColumn AllowUpdate="Yes" BaseColumnName="Code" EditorControlID="txtApplicantCode"
                                                                                Key="Code" Type="Custom" Width="12%" 
                                                                                meta:resourcekey="UltraGridColumnResource3">
                                                                                <HeaderStyle HorizontalAlign="Center" />
                                                                                <CellStyle HorizontalAlign="Center">
                                                                                </CellStyle>
                                                                                <Header Caption="Applicant Code">
                                                                            ...
                                                                            <igtbl:UltraGridColumn AllowUpdate="No" Key="ApplicantName" Width="20%" 
                                                                                meta:resourcekey="UltraGridColumnResource4">
                                                                                <HeaderStyle HorizontalAlign="Center" />
                                                                                <CellStyle HorizontalAlign="Center">
                                                                                </CellStyle>
                                                                                <Header Caption="Applicant Name" Title="">
                                                                            ...
                                                                            <igtbl:UltraGridColumn AllowUpdate="Yes" BaseColumnName="E_Mail" Key="E_Mail" 
                                                                                Width="20%" meta:resourcekey="UltraGridColumnResource5">
                                                                                <HeaderStyle HorizontalAlign="Center" />
                                                                                <CellStyle HorizontalAlign="Center">
                                                                                </CellStyle>
                                                                                <Header Caption="Applicant Mail">
                                                                            ...
                                                                            <igtbl:UltraGridColumn BaseColumnName="GStartDate" EditorControlID="WebDateTimeEdit1"
                                                                                Key="GStartDate" Type="Custom" Width="12%" 
                                                                            ...
                                                                            <igtbl:UltraGridColumn BaseColumnName="HStartDate" EditorControlID="WebDateTimeEdit1"
                                                                                Key="HStartDate" Type="Custom" Width="12%" 
                                                                            ...
                                                                            <igtbl:UltraGridColumn BaseColumnName="Houre" EditorControlID="WebMaskEdit1" Key="Houre"
                                                                                Type="Custom" Width="12%" meta:resourcekey="UltraGridColumnResource8">
                                                                                <Header Caption="Time">
                                                                            ...
                                                                            <igtbl:UltraGridColumn AllowUpdate="Yes" BaseColumnName="IsCriteria" CellButtonDisplay="Always"
                                                                                DataType="System.Boolean" Type="CheckBox" Width="12%" 
                                                                                meta:resourcekey="UltraGridColumnResource9">
                                                                                <Header Caption="Send Mail">
                                                                            ...
                                                                            <igtbl:UltraGridColumn CellButtonDisplay="Always" Type="Button" Width="23px" 
                                                                                meta:resourcekey="UltraGridColumnResource10">
                                                                                <Header Caption="CV">
                                                                                    <RowLayoutColumnInfo OriginX="9" />
                                                                                </Header>
                                                                                <CellButtonStyle BackgroundImage="~/Pages/HR/Img/srch_but_off.gif" Height="20px"
                                                    ...
                                                    <tr>
                                                        <td style="vertical-align: bottom">
                                                            <asp:Label ID="Label1" runat="server"  SkinID="Label_DefaultBold"
                                                                Text="الرجاء تحديد بيانات المُجري للمقابلة" 
                                                                meta:resourcekey="Label1Resource1"></asp:Label>
                                                            <asp:Label ID="Label_Star5" runat="server" meta:resourcekey="Label_Star1Resource1"
                                                                Style="color: #FF0000" Text="*"></asp:Label>
                                                        </td>
                                                    </tr>
                                                </table>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <igtbl:UltraWebGrid  Browser="UpLevel"   ID="uwgInterviewer" runat="server" EnableAppStyling="False" Height="120px"
                                                                meta:resourcekey="uwgInterviewerResource1" SkinID="Default" Width="100%">
                                                                <DisplayLayout AllowColSizingDefault="Free" AllowColumnMovingDefault="OnServer" AllowDeleteDefault="Yes"
                                                                    AllowSortingDefault="OnClient" AllowUpdateDefault="Yes" AutoGenerateColumns="False"
                                                                    BorderCollapseDefault="Separate" HeaderClickActionDefault="SortSingle" Name="uwgForNationality"
                                                                    RowHeightDefault="18px" RowSelectorsDefault="No" SelectTypeRowDefault="Extended"
                                                                    ...
                                                                    <ClientSideEvents AfterCellUpdateHandler="uwgInterviewers_AfterCellUpdateHandler"
                                                                        AfterEnterEditModeHandler="uwgInterviewers_AfterEnterEditModeHandler" />
                                                                </DisplayLayout>
                                                                <Bands>
                                                                    <igtbl:UltraGridBand meta:resourcekey="UltraGridBandResource2" AllowAdd="Yes">
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <igtbl:UltraGridColumn BaseColumnName="Interviewer_ID" DataType="System.Int32" Hidden="True"
                                                                                Key="EID" meta:resourcekey="UltraGridColumnResource13">
                                                                                <Header Caption="Interviewer_ID">
                                                                                    <RowLayoutColumnInfo OriginX="2" />
                                                                                </Header>
                                                                                <Footer>
                                                                                    <RowLayoutColumnInfo OriginX="2" />
                                                                            ...
                                                                            <igtbl:UltraGridColumn AllowUpdate="Yes" BaseColumnName="Code" EditorControlID="txtInterviewerCode"
                                                                                Key="Code" Type="Custom" Width="15%" 
                                                                                meta:resourcekey="UltraGridColumnResource14">
                                                                                <Header Caption="Interviewer Code" Title="">
                                                                                    <RowLayoutColumnInfo OriginX="3" />
                                                                                </Header>
                                                                                <HeaderStyle HorizontalAlign="Center" />
                                                                                <CellStyle HorizontalAlign="Center">
                                                                            ...
                                                                            <igtbl:UltraGridColumn AllowUpdate="No" Key="InterViewerName" Width="25%" 
                                                                                meta:resourcekey="UltraGridColumnResource15">
                                                                                <Header Caption="InterViewer Name" Title="">
                                                                                    <RowLayoutColumnInfo OriginX="4" />
                                                                                </Header>
                                                                                <HeaderStyle HorizontalAlign="Center" />
                                                                                <CellStyle HorizontalAlign="Center">
                                                                            ...
                                                                            <igtbl:UltraGridColumn AllowUpdate="Yes" BaseColumnName="E_Mail" Key="E_Mail" 
                                                                                Width="25%" meta:resourcekey="UltraGridColumnResource16">
                                                                                <Header Caption="Interviewer Mail">
                                                                                    <RowLayoutColumnInfo OriginX="5" />
                                                                                </Header>
                                                                                <HeaderStyle HorizontalAlign="Center" />
                                                                                <CellStyle HorizontalAlign="Center">
                                                                            ...
                                                                            <igtbl:UltraGridColumn BaseColumnName="DefaultEvalType" EditorControlID="" Key="DefaultEvalType"
                                                                            ...
                                                                            <igtbl:UltraGridColumn AllowUpdate="Yes" BaseColumnName="PowerPCT" DataType="System.Int32"
                                                                                Key="Power" Width="10%" meta:resourcekey="UltraGridColumnResource18">
                                                                                <HeaderStyle HorizontalAlign="Center" />
                                                                            ...
                                                                            <igtbl:UltraGridColumn AllowUpdate="Yes" BaseColumnName="IsCriteria" CellButtonDisplay="Always"
                                                                                DataType="System.Boolean" Type="CheckBox" Width="70px" 
