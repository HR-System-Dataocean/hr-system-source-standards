<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmPaySlipRequestAction.aspx.vb"
...
<%--                                            <td style="width: 47%; height: 16px; vertical-align: top">
    ...
    <asp:Label ID="lblRecipient" runat="server" Width="90px" SkinID="Label_DefaultNormal"
        Text="ملاحظات " meta:resourcekey="lblRecipientResource1"></asp:Label>
</td>
                    <td class="DataArea">
        <asp:TextBox ID="TxtRecipient" runat="server" Width="450"  meta:resourcekey="TxtRecipient"
    ...
    <asp:Label ID="LblRequestRemarks" runat="server" Width="90px" SkinID="Label_DefaultNormal"
        ...
        <asp:TextBox ID="TxtRequestRemarks" runat="server" Width="450"  meta:resourcekey="LblRemarksResource1"
            TabIndex="7" AutoPostBack="false"></asp:TextBox>
    </td>
             </tr>
         </table>
     </td>
