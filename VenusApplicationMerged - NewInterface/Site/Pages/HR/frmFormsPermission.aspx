<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmFormsPermission.aspx.vb"
    Inherits="frmFormsPermission" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
...
<head runat="server">
    ...
    <script language="javascript" src="Scripts/App_FormsPermissions.js"></script>
</head>
<body style="margin: 0; padding: 0;">
    <form id="frmFormsPermission" runat="server">
    <div runat="server" id="DIV" style="background-color: #BEDCFF;">
                                                ...
                                                <table style="width: 100%; height: 30px;" cellspacing="6">
                                                    <tr>
                                                        <td>
                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                            &nbsp;&nbsp;
                                                            <asp:CheckBox ID="chkAllowAdd" runat="server" meta:resourcekey="chkAllowAddResource1"
                                                                Text=" " />
                                                            &nbsp;&nbsp; &nbsp;
                                                            <asp:CheckBox ID="chkAllowEdit" runat="server" meta:resourcekey="chkAllowEditResource1"
                                                                Text=" " />
                                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                                            <asp:CheckBox ID="chkAllowDelete" runat="server" meta:resourcekey="chkAllowDeleteResource1"
                                                                Text=" " />
                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                            <asp:CheckBox ID="chkAllowView" runat="server" meta:resourcekey="chkAllowViewResource1"
                                                                Text=" " />
                                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                                            <asp:CheckBox ID="chkAllowPrint" runat="server" meta:resourcekey="chkAllowPrintResource1"
                                                                Text=" " />
                                                            &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
                                                    ...
                                                    <Bands>
                                                        <igtbl:UltraGridBand meta:resourcekey="UltraGridBandResource1">
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <igtbl:UltraGridColumn AllowUpdate="No" BaseColumnName="ParentName" Width="100px"
                                                                    meta:resourcekey="UltraGridColumnResource4">
                                                                    <Header Caption="Parent Name">
                                                                ...
                                                                <igtbl:UltraGridColumn AllowUpdate="Yes" BaseColumnName="AllowAdd" CellButtonDisplay="Always"
                                                                    meta:resourcekey="UltraGridColumnResource5" DataType="System.Boolean" Key="AllowAdd"
                                                                ...
                                                                <igtbl:UltraGridColumn AllowUpdate="Yes" BaseColumnName="AllowEdit" CellButtonDisplay="Always"
                                                                    meta:resourcekey="UltraGridColumnResource6" DataType="System.Boolean" Key="AllowEdit"
                                                                    Type="CheckBox" Width="40px">
                                                                    <HeaderStyle HorizontalAlign="Center" />
                                                                    <Header Caption="Edit">
                                                                ...
                                                                <igtbl:UltraGridColumn AllowUpdate="Yes" BaseColumnName="AllowDelete" CellButtonDisplay="Always"
                                                                    meta:resourcekey="UltraGridColumnResource7" DataType="System.Boolean" Key="AllowDelete"
                                                                    Type="CheckBox" Width="40px">
                                                                    <HeaderStyle HorizontalAlign="Center" />
                                                                ...
                                                                <igtbl:UltraGridColumn AllowUpdate="Yes" BaseColumnName="AllowView" CellButtonDisplay="Always"
                                                                    meta:resourcekey="UltraGridColumnResource8" DataType="System.Boolean" Key="AllowView"
                                                                    Type="CheckBox" Width="40px">
                                                                    <HeaderStyle HorizontalAlign="Center" />
                                                                    <Header Caption="View ">
                                                                ...
                                                                <igtbl:UltraGridColumn AllowUpdate="Yes" BaseColumnName="AllowPrint" CellButtonDisplay="Always"
                                                                    meta:resourcekey="UltraGridColumnResource9" DataType="System.Boolean" Key="AllowPrint"
                                                                    Type="CheckBox" Width="40px">
                                                                    <HeaderStyle HorizontalAlign="Center" />
                                                                    <Header Caption="Print">
                                                                ...
                                                                <igtbl:UltraGridColumn AllowUpdate="Yes" BaseColumnName="CheckAll" CellButtonDisplay="Always"
                                                                    meta:resourcekey="UltraGridColumnResource11" Key="CheckAll" Type="CheckBox" Width="60px">
        ...
        <asp:HiddenField ID="txtAddC" runat="server" />
