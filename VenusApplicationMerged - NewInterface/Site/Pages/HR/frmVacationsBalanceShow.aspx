<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmVacationsBalanceShow.aspx.vb"
    Inherits="frmVacationsBalanceShow" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
...
<head runat="server">
    <title>* Venus Payroll * ~View VacationsBalanceShow</title>
                    ...
                    <table style="width: 45%; height: 42px; vertical-align: top">
                        <tr>
                            <td style="width: 32px; vertical-align: top">
                              ...
                              <td  style="width:10px" class="LabelArea">
                          <asp:Label ID="LBLDepartment" runat="server" SkinID="Label_DefaultBold" Text="Year" meta:resourcekey="LBLDepartmentResource1"></asp:Label>
                      </td>
                      <td class="DataArea">
                        <asp:DropDownList ID="ddlDepartment" runat="server" AutoPostBack="True" SkinID="DropDownList_DefaultNormal"
                              meta:resourcekey="ddlDepartmentResource1" TabIndex="3">
                          </asp:DropDownList>
                      </td>
                                <td  style="width:20px" class="LabelArea">
                                                            <asp:Label ID="lblBalanceType" runat="server" Visible="false" Width="50px" SkinID="Label_LargtNormal"
                                                                Text="نوع الرصيد" meta:resourcekey="lblBalanceTypeResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                        <asp:DropDownList ID="ddlBalanceType" runat="server"  Visible="false" AutoPostBack="True" SkinID="DropDownList_DefaultNormal"
                                                                meta:resourcekey="DdlBalanceTypeResource1" TabIndex="3">
                                                            </asp:DropDownList>
                                                        </td>
                            <%--Refresh--%>
                           <td>&nbsp;&nbsp;
                                                       ...
                                                       <td>&nbsp;&nbsp;
                                                           ...
                                                           <td class="LabelArea">
                                                                  <asp:Label ID="LblDirectManager" runat="server" Width="50px" meta:resourcekey="LblDirectManagerResource1"
                                                                    SkinID="Label_DefaultNormal" Text="المدير المباشر "  style="margin-right: 10px;"></asp:Label>
                                                                   <%--<asp:TextBox ID="txtEmpCode" Width="50px" runat="server"  MaxLength="15"
                                                                 AutoPostBack="True" meta:resourcekey="txtEmpCodeResource1">
                                                                 </asp:TextBox>--%>
                                                            </td>
                                                               <td>
                  <asp:TextBox ID="TxtDirectMngrCode" Width="50px" runat="server"  MaxLength="15"
         AutoPostBack="True" meta:resourcekey="TxtDirectMngrResource1">
    </asp:TextBox>
             </td>
    <td>
...
<td>
 <asp:TextBox ID="TxtDirectMngrName" Width="160px" runat="server"  MaxLength="100"
        AutoPostBack="false"  meta:resourcekey="TxtDirectMngrNamrResource1">
   </asp:TextBox>
    </td>
...
<td>
 <asp:TextBox ID="TxtEmpName" Width="160px" runat="server"  MaxLength="100"
     ...
     <asp:ImageButton ID="ImageButton_Refresh" runat="server" ImageUrl="~/Common/Images/refresh.png" />
                                                         ...
                                                         <td>
     <asp:ImageButton ID="ImageButton_Excel" runat="server" ImageUrl="~/Common/Images/Excel.png" />
 </td>
            ...
            <tr>
                <td class="Details">
                    <igtab:UltraWebTab ID="UltraWebTab1" runat="server" EnableAppStyling="True" SkinID="Default"
                        ...
                        <Tabs>
                            <igtab:Tab Text="الموظفين الجدد" meta:resourcekey="FollowupMyRequestsTabResource1">
                                <ContentTemplate>
                                                    ...
                                                    <igtbl:UltraWebGrid  Browser="UpLevel"   ID="uwgEmployeeVacations" runat="server" EnableAppStyling="False"
                                                        ...
                                                        <Bands>
                                                            <igtbl:UltraGridBand meta:resourcekey="UltraGridBandResource1">
                                                                ...
                                                                <Columns>
                                                                    <igtbl:UltraGridColumn BaseColumnName="ID" Width="1%" DataType="System.Int32" Hidden="True"
                                                                        Key="ID" meta:resourcekey="RequestSerialResource1">
                                                                    ...
                                                                    <igtbl:UltraGridColumn BaseColumnName="Code" Width="10%" DataType="System.Int32" Hidden="False"
                                                                        Key="ID" meta:resourcekey="RequestSerialResource1">
...
<igtbl:UltraGridColumn BaseColumnName="Position" Width="30%" DataType="System.String" Hidden="False"
       ...
       <CellStyle HorizontalAlign="Center">
        ...
        <Header Caption=" Department ">
           ...
           <CellStyle HorizontalAlign="Center">
                                                                    ...
                                                                    <igtbl:UltraGridColumn BaseColumnName="Year" Width="10%" DataType="System.Int32"
                                                                        Hidden="True" Key="Year" meta:resourcekey="YearResource1">
                                                                    ...
                                                                    <igtbl:UltraGridColumn BaseColumnName="BalanceType" Width="15%" DataType="System.string"
                                                                          Hidden="True" Key="BalanceType" meta:resourcekey="BalanceTypeResource1">
                                                                        
                                                                        <Header Caption="BalanceType ">
                                                                     ...
                                                                     <igtbl:UltraGridColumn BaseColumnName="BalanceTransfered" Width="10%" DataType="System.Int32"
      Hidden="False" Key="BalanceTransfered" meta:resourcekey="BalanceTransferedResource1">
    
    <Header Caption="BalanceTransfered">
        <RowLayoutColumnInfo OriginX="2" />
    </Header>
    <CellStyle HorizontalAlign="Center">
</CellStyle>
    ...
    <Footer>
        <RowLayoutColumnInfo OriginX="2" />
                                                                    ...
                                                                    <igtbl:UltraGridColumn BaseColumnName="Balance" Width="10%" DataType="System.Int32"
      Hidden="False" Key="Balance" meta:resourcekey="BalanceResource1">
  ...
  <igtbl:UltraGridColumn BaseColumnName="Consumed" Width="10%" DataType="System.Int32"
      Hidden="False" Key="Consumed" meta:resourcekey="ConsumedResource1">
    
    <Header Caption="Consumed">
        <RowLayoutColumnInfo OriginX="2" />
    </Header>
    <CellStyle HorizontalAlign="Center">
</CellStyle>
  ...
  <igtbl:UltraGridColumn BaseColumnName="Remaining" Width="10%" DataType="System.Int32"
      Hidden="False" Key="Remaining" meta:resourcekey="RemainingResource1">
    ...
    <igtbl:UltraGridColumn BaseColumnName="Actualbalance" Width="10%" DataType="System.Int32"
      Hidden="False" Key="Actualbalance" meta:resourcekey="ActualbalanceResource1">
    
    <Header Caption="Actualbalance">
        <RowLayoutColumnInfo OriginX="2" />
    </Header>
    <CellStyle HorizontalAlign="Center">
</CellStyle>
    <Footer>
       ...
       <igtbl:UltraGridColumn BaseColumnName="DueDate" Width="15%" DataType="System.Date"
    ...
    <Footer>
        <RowLayoutColumnInfo OriginX="1" />
                                                                    ...
                                                                    <igtbl:UltraGridColumn BaseColumnName="Remarks" Width="15%" DataType="System.string"
                                                                          Hidden="true" Key="Remarks" meta:resourcekey="RemarksResource1">
