...
Partial Class frmTicketsAgencies
    Inherits MainPage
...
#Region "Protected Sub"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If ClsObjects.Find(" Code='" & ClsTicketsAgencies.Table.Trim & "'") Then
            ...
            If Not IsPostBack Then
                ...
                ClsTicketsAgencies.AddOnChangeEventToControls("frmTicketsAgencies", Page, UltraWebTab1)
            ...
            If (txtCode.Text <> "") Then
                ClsTicketsAgencies.Find(" Code='" & txtCode.Text & "'")
                IntrecordID = ClsTicketsAgencies.ID
    ...
    Protected Sub ImageButton_Command(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.CommandEventArgs) Handles ImageButton_Save.Command, ImageButton_SaveN.Command, LinkButton_SaveN.Command, ImageButton_New.Command, ImageButton_Print.Command, ImageButton_Properties.Command, LinkButton_Properties.Command, ImageButton_Remarks.Command, LinkButton_Remarks.Command, ImageButton_Last.Command, ImageButton_Next.Command, ImageButton_Back.Command, ImageButton_First.Command, ImageButton_Delete.Command
        ...
        Select Case e.CommandArgument
            ...
            Case "New"
                AfterOperation()
            Case "Delete"
                ClsTicketsAgencies.Delete("Code='" & txtCode.Text & "'")
                AfterOperation()
            Case "Property"
                ClsTicketsAgencies.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmPropertyScreen.aspx?ID=" & ClsTicketsAgencies.ID & "&TableName=" & ClsTicketsAgencies.Table, 477, 313, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Property", False)
            Case "Remarks"
                ClsTicketsAgencies.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmRemarks.aspx?ID=" & ClsTicketsAgencies.ID & "&TableName=" & ClsTicketsAgencies.Table, 410, 210, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Remarks", False)
            Case "Print"
            ...
            Case "First"
                ClsTicketsAgencies.Find("Code='" & txtCode.Text & "'")
                ClsTicketsAgencies.FirstRecord()
                GetValues(ClsTicketsAgencies)
            Case "Previous"
                ClsTicketsAgencies.Find("Code='" & txtCode.Text & "'")
                If Not ClsTicketsAgencies.previousRecord() Then
                    ClsTicketsAgencies.Find("Code='" & txtCode.Text & "'")
            ...
            Case "Next"
                ClsTicketsAgencies.Find("Code='" & txtCode.Text & "'")
                If Not ClsTicketsAgencies.NextRecord() Then
                    ClsTicketsAgencies.Find("Code='" & txtCode.Text & "'")
...
#Region "Private Functions"
    Private Function SavePart() As Boolean
        ...
        Try
            ...
            If ClsTicketsAgencies.ID > 0 Then
                If Not AssignValue(ClsTicketsAgencies) Then
                    Exit Function
                End If
                ClsTicketsAgencies.Update("Code='" & txtCode.Text & "'")

            Else
                If Not AssignValue(ClsTicketsAgencies) Then
                    Exit Function
                End If
                ClsTicketsAgencies.Save()

            End If

            ClsTicketsAgencies.Find("Code='" & txtCode.Text & "'")

            clsMainOtherFields.CollectDataAndSave(value.Text, ClsTicketsAgencies.Table, ClsTicketsAgencies.ID)
            value.Text = ""
            Return True
        Catch ex As Exception
            Return False
        End Try
    End Function
    Private Function AssignValue(ByRef ClsTicketsAgencies As Clshrs_TicketsAgencies) As Boolean
        Try
        ...
        End Try
    End Function
    Private Function GetValues(ByVal ClsTicketsAgencies As Clshrs_TicketsAgencies) As Boolean
        ...
        Try
            ...
            With ClsTicketsAgencies
                ...
                If Page.IsPostBack Then
                    CreateOtherFields(ClsTicketsAgencies.ID)
                End If
            End With
            Return True
        Catch ex As Exception
    ...
    Private Function CheckCode() As Boolean
        ...
        Try
            ClsTicketsAgencies.Find("Code='" & txtCode.Text & "'")
            IntId = ClsTicketsAgencies.ID
            txtEngName.Focus()
            If ClsTicketsAgencies.ID > 0 Then
                GetValues(ClsTicketsAgencies)
                StrMode = "E"
            Else
                If ClsTicketsAgencies.CheckRecordExistance(" Code='" & txtCode.Text & "'") Then
                    txtCode.Text = ""
                    txtCode.Focus()
                End If
            ...
            End If
            SetToolBarDefaults()
            SetToolBarPermission(Me, ClsTicketsAgencies.ConnectionString, ClsTicketsAgencies.DataBaseUserRelatedID, ClsTicketsAgencies.GroupID, StrMode)
            SetToolBarRecordPermission(Me, ClsTicketsAgencies.ConnectionString, ClsTicketsAgencies.DataBaseUserRelatedID, ClsTicketsAgencies.GroupID, ClsTicketsAgencies.Table, IntId)
    ...
    Private Sub LoadDataUpdateSchedules(ByVal formName As String)
        ...
        ClsTicketsAgencies = New Clshrs_TicketsAgencies(Me.Page)
        ClsTicketsAgencies.Find(" code = '" & txtCode.Text & "'")
        Dim recordID As Integer = ClsTicketsAgencies.ID
        If (recordID > 0) Then
    ...
    Private Function CreateOtherFields(ByVal IntRecordID As Integer)
        ...
        If clsMainOtherFields.CheckOtherFieldsButton(Me.Page, ClsTicketsAgencies.Table) = True Then
            Dim StrTablename As String
            ClsTicketsAgencies = New Clshrs_TicketsAgencies(Me)
            StrTablename = ClsTicketsAgencies.Table
