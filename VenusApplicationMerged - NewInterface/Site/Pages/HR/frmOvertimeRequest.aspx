<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmOvertimeRequest.aspx.vb"
    Inherits="frmOvertimeRequest" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
...
<head runat="server">
    <title>* Venus Payroll * ~Overtime Request</title>
    ...
    <script type="text/javascript" id="igClientScript">
        ...
        function OpenPrintedScreen(v) {
            ...
            var win = window.open("../../Interfaces/frmReportsGridViewer.aspx?Language=false&Criteria=RequestSerial&preview=1&ReportCode=CF_137&sq0=''&v=" + v, "_NEW", "height=" + hight + ",width=" + width + ",resizable=0,menubar=0,toolbar=0,location=0,directories=0,scrollbars=0,status=0,center=0");
            win.focus();
        }
...
<body style="margin: 0; padding: 0;">
    <form id="frmOvertimeRequest" runat="server" defaultbutton="Button1">
            ...
            <tr>
                <td class="Details">
                    <igtab:UltraWebTab ID="UltraWebTab1" runat="server" EnableAppStyling="True" SkinID="Default"
                        ...
                        <Tabs>
                            <igtab:Tab Text="Other Letter Request" meta:resourcekey="TabResource1">
                                <ContentTemplate>
                                    <table style="width: 100%; height: 100%; min-height: 350px; vertical-align: top"
                                        ...
                                        <tr>
                                           <td style="width: 40%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                     <tr>
                                                        <td class="SeparArea">
                                                        </td>
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblRequestDate" Width="90px" runat="server" Text="Request Date"
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td class="LabelArea">
    <asp:Label ID="label3" Width="70px" runat="server" Text="Employee Name"
        SkinID="Label_DefaultNormal" meta:resourcekey="labelDescEnglishNameResource1"></asp:Label>
                                         ...
                                         <%-- <td class="SeparArea">
                                                    ...
                                                    <td class="DataArea">
    <asp:TextBox ID="lblDescEnglishName" Width="250px" runat="server" SkinID="TextBox_DefaultNormalC"
        ...
        TabIndex="1"></asp:TextBox>
                                                        ...
                                                        <td class="LabelArea" style="min-width: 90px;">
                                                            <asp:Label ID="Label4" runat="server" Text="Department" SkinID="Label_DefaultNormal"
                                                                meta:resourcekey="lbldepaertmentResource1"></asp:Label>
                                                        </td>
                                                     
                                                 
                                          
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="txtDepartment" runat="server"  SkinID="TextBox_SmalltNormalC" MaxLength="30"
                                                                AutoPostBack="False" meta:resourcekey="txtEmployeeResource1">
                                                           </asp:TextBox>
                                                        </td>
                                                      ...
                                                      <td class="LabelArea">
    <asp:Label ID="label5" Width="70px" runat="server" Text="Nationality"
        SkinID="Label_DefaultNormal" meta:resourcekey="labelNationalityResource1"></asp:Label>
</td>
                                         ...
                                         <%-- <td class="SeparArea">
                                                    ...
                                                    <td class="DataArea">
    <asp:TextBox ID="txtNationality" Width="150" runat="server" SkinID="TextBox_DefaultNormalC"
        ReadOnly="True" MaxLength="255" meta:resourcekey="lblDescEnglishNameResource1"
        TabIndex="1"></asp:TextBox>
</td>
                                                        ...
                                                        <td class="LabelArea" style="min-width: 90px;">
                                                            <asp:Label ID="Label6" runat="server" Text="Position" SkinID="Label_DefaultNormal"
                                                        ...
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="txtPosition" runat="server" SkinID="TextBox_SmalltNormalC" MaxLength="30"
                                                                AutoPostBack="False" ReadOnly="False"  meta:resourcekey="txtEmployeeResource1">
                                                           </asp:TextBox>
                                                        </td>
                                                         <td class="SeparArea">
                                                     </td>
                                                    ...
                                                    <tr>
                                                        <td style="vertical-align: top">
                                                            <asp:Label ID="Label1" runat="server" meta:resourcekey="Label_Title1Resource2" SkinID="Label_DefaultBold"
                                                                Text=" Request Details"></asp:Label>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                            ...
                                            <td style="width: 6%; height: 16px; vertical-align: top">
                                                <table style="width: 47%; vertical-align: top" cellspacing="0">
                                                    ...
                                                    <td class="SeparArea">
                                                         ...
                                                         <%--<td class="LabelArea">
                                                            <asp:Label ID="lblWebDateChooser1" runat="server" Width="120px" meta:resourcekey="lblExecuseDateResource1"
                                                                SkinID="Label_DefaultNormal" Text=" Exit Date"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
     ...
     <td class="LabelArea">
       <%-- <asp:Label ID="Label2" runat="server" Width="120px" meta:resourcekey="lblExecuseDateResource1"
            SkinID="Label_DefaultNormal" Text=" Entry Date"></asp:Label>--%>
    </td>
    <td class="DataArea">
      <%--  <igsch:WebDateChooser ID="WebDateChooser2" runat="server" BorderColor="#CCCCCC" BorderStyle="Solid"
            ...
            <AutoPostBack ValueChanged="True" />
                                    ...
                                    <tr>
                                            <td style="width: 40%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea" style="min-width: 90px;">
                                                            <asp:Label ID="lblHoursNo" runat="server" Text="Hours Number" SkinID="Label_DefaultNormal"
                                                                meta:resourcekey="lblHoursNoResource1"></asp:Label>
                                                        </td>
                                                     
                                                 
                                          
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="txtHoursNo" runat="server" SkinID="TextBox_SmalltNormalC" MaxLength="30"
                                                                AutoPostBack="False" ReadOnly="False"  meta:resourcekey="txtHoursNoResource1" onkeypress="return isNumberKey(event)">
                                                           </asp:TextBox>
                                                            </td>
                                                         <td class="SeparArea">
                                                        </td>
                                                         <td class="LabelArea" style="min-width: 90px;">
                                                            <asp:Label ID="lblMinutsNo" runat="server" Text="Minuts Number" SkinID="Label_DefaultNormal"
                                                                meta:resourcekey="lblMinutsNoResource1"></asp:Label>
                                                        </td>
                                                     
                                                 
                                          
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="txtMinutsNo" runat="server" SkinID="TextBox_SmalltNormalC" MaxLength="30"
                                                                AutoPostBack="False" ReadOnly="False"  meta:resourcekey="txtMinutsNoResource1" onkeypress="return isNumberKey(event)">
                                                           </asp:TextBox>
                                                            </td>
                                        ...
                                        <td style="width: 3%; height: 16px; vertical-align: top">
                                            </td>
                                            <td style="width: 67%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        <td class="SeparArea">
                                                        </td>
                                     ...
                                     <tr>
                                            <td style="width: 40%; height: 16px; vertical-align: top">
                                                <table style="width: 77%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea" style="min-width: 90px;">
                                                            <asp:Label ID="lblOverTimeDate" runat="server" Text="OverTime Date" SkinID="Label_DefaultNormal"
                                                                meta:resourcekey="lblOverTimeDateResource1"></asp:Label>
                                                        </td>
                                                     
                                                 
                                          
                                                        <td class="DataArea">
                                                           <igsch:WebDateChooser ID="OverTimeDate" runat="server" BorderColor="#CCCCCC" BorderStyle="Solid"
                                                                BorderWidth="1px" Height="18px" NullDateLabel="" Style="font-family: Tahoma;
                                                                font-size: 8pt; font-weight: Normal; color: Black; border: solid 1px #CCCCCC"
                                                                Width="130px">
                                                            </igsch:WebDateChooser>
                                        ...
                                        <td style="width: 3%; height: 16px; vertical-align: top">
                                            ...
                                            <td style="width: 57%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        <td class="SeparArea">
                                                        </td>
                                       ...
                                       <td style="width: 40%; height: 16px; vertical-align: top">
                                                 <table style="width: 77%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                              ...
                                                              <td class="LabelArea">
                                                            <asp:Label ID="lblOverTimeType" runat="server" Width="80px" SkinID="Label_DefaultNormal"
                                                                Text="Overtime Type" meta:resourcekey="lblOverTimeTypeResource1"></asp:Label>
                                                        
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="ddlOverTimeType" runat="server" SkinID="DropDownList_DefaultNormal"
                                                                meta:resourcekey="DdlOverTimeTypeResource1">
                                                                <asp:ListItem meta:resourcekey="lstRegularOvertime" Selected="True" Text="Regular Overtime" Value="201"></asp:ListItem>
                                                                <asp:ListItem meta:resourcekey="lstHolidaysOvertime" Text="Overtime on Holidays" Value="202"></asp:ListItem>
                                                            </asp:DropDownList>
                                                        </td>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 50%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblRemarks" Width="120px" runat="server" Text=" Remarks"
                                                                SkinID="Label_DefaultNormal" meta:resourcekey="lblRemarksResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="TxtRemarks" runat="server" Height="150px" Width="600px" TextMode="MultiLine"
                                                                ReadOnly="False" MaxLength="5000" meta:resourcekey="lblDescEnglishNameResource1"
                                                                TabIndex="1"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
