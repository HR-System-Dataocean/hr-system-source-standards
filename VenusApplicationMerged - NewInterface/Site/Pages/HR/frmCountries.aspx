<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmCountries.aspx.vb" Inherits="frmCountries"
...
<head runat="server">
    <title>* Venus Payroll * ~Countries</title>
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmCountries" runat="server">
                                                    ...
                                                    <table cellspacing="6" style="width: 100%; height: 30px; vertical-align: bottom; border-bottom: 1px solid black">
                                                        <tr>
                                                            <td style="vertical-align: bottom">
                                                                <asp:Label ID="Label_Label_Title2" runat="server" meta:resourcekey="Label_Title2Resource1"
                                                                    SkinID="Label_DefaultBold" Text="الإعدادات"></asp:Label>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                ...
                                                <td style="width: 47%; height: 16px; vertical-align: top">
                                                    <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                        <tr>
                                                            <td class="SeparArea"></td>
                                                            <td class="LabelArea">
                                                                <asp:Label ID="lblCurrency" runat="server" Text="العملة" SkinID="Label_DefaultNormal"
                                                ...
                                                <td style="width: 47%; height: 16px; vertical-align: top">
                                                    <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                        <tr>
                                                            <td class="SeparArea"></td>
                                                            <td class="LabelArea">
                                                                <asp:Label ID="lblNationality" runat="server" Text="الجنســية" SkinID="Label_DefaultNormal"
                                                ...
                                                <td style="width: 47%; height: 16px; vertical-align: top">
                                                    <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                        <tr>
                                                            <td class="SeparArea"></td>
                                                            <td class="LabelArea">
                                                                <asp:Label ID="lblCountryKey" runat="server" Text="مفتـاح هاتف البلد" SkinID="Label_DefaultNormal"
                                                                    meta:resourcekey="lblCountryKeyResource1"></asp:Label>
                                                            </td>
                                                            <td class="DataArea">
                                                                <igtxt:WebMaskEdit ID="txtPhoneKey" runat="server" InputMask="########" SkinID="WebMaskEdit_Default">
                                                                </igtxt:WebMaskEdit>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                ...
                                                <td style="width: 47%; height: 16px; vertical-align: top">
                                                    <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                        <tr>
                                                            <td class="SeparArea"></td>
                                                            <td class="LabelArea">
                                                                <asp:Label ID="lblMainCountry" runat="server" Text="الدولة الرئيسية" SkinID="Label_DefaultNormal"
                                                                    meta:resourcekey="lblMainCountryResource1"></asp:Label>
                                                            </td>
                                                            <td class="DataArea">
                                                                <asp:CheckBox ID="ChkMainCountry" runat="server" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
