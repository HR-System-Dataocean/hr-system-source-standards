<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmEmployeePenalty.aspx.vb"
    Inherits="frmEmployeePenalty" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
...
<head runat="server">
    <title>* Venus Payroll * ~ Job Branches Permission</title>
<%--<meta charset="UTF-8">
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmEmployeePenalty" runat="server">
                                                ...
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                         <td class="SeparArea">
                                                          ...
                                                          <td class="LabelArea">
                                                            <asp:Label ID="lblTrxDate" Width="120px" runat="server" Text=" التاريخ "
                                                                SkinID="Label_DefaultNormal" meta:resourcekey="lblTrxDateResource1"></asp:Label>
                                                        </td>
                                                       
                                                          <td>
                                                                       <igsch:WebDateChooser ID="txtTransactionDate" runat="server" BorderColor="#CCCCCC"
                                                                BorderStyle="Solid" BorderWidth="1px" EnableTheming="True" Height="18px" meta:resourcekey="txtTransactionDateResource1"
                                                                NullDateLabel="" Style="font-family: Tahoma; font-size: 8pt; font-weight: Normal;
                                                                color: Black; border: solid 1px #CCCCCC" Value="" Width="137px" EnableAppStyling="False">
                                                ...
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                         <td class="SeparArea">
                                                          ...
                                                          <td class="LabelArea">
                                                            <asp:Label ID="lblTransactionType" Width="120px" runat="server" Text=" TransactionType "
                                                                SkinID="Label_DefaultNormal" meta:resourcekey="lblTransactionTypeResource1"></asp:Label>
                                                        </td>
                                                ...
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                         <td class="SeparArea">
                                                          ...
                                                          <td class="LabelArea">
                                                            <asp:Label ID="lblDaysNo" Width="120px" runat="server" Text=" DaysNo "
                                                                SkinID="Label_DefaultNormal" meta:resourcekey="lblDaysNoResource1"></asp:Label>
                                                        </td>
                                                       
                                                          <td>
                                                                       <asp:TextBox ID="txtDaysNo" runat="server" SkinID="TextBox_SmalltNormalc" 
                                                             autopostback="false"     TabIndex  ="5" ReadOnly="false"></asp:TextBox>
                                                ...
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                         <td class="SeparArea">
                                                          ...
                                                          <td>
                                                                       <asp:TextBox ID="TxtRemarks" runat="server" Width="465px" 
