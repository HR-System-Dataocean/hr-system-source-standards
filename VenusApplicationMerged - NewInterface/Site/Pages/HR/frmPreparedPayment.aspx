<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmPreparedPayment.aspx.vb"
    Inherits="frmPreparedPayment" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
...
<body style="height: 100%; margin: 0; padding: 0;">
    <form id="frmPreparedPayment" runat="server" defaultbutton="ImageButton1">
                                                    ...
                                                    <Bands>
                                                        <igtbl:UltraGridBand AllowSorting="No" meta:resourcekey="UltraGridBandResource1">
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <igtbl:UltraGridColumn AllowUpdate="No" CellButtonDisplay="Always" Key="Payed" BaseColumnName="Payed"
                                                                    Type="CheckBox" Width="80px" meta:resourcekey="UltraGridColumnPayedResource">
                                                                    <Header Caption="Payed">
