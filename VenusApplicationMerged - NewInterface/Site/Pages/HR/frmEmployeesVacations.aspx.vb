...
#Region "Private Functions"
        ...
        If ClsContracts.ID > 0 Then
            ...
            If lbVactionID.Text = "" Then
                If ClsVacations.RoundAnnualVacBalance = True Then
                    ...
                    lbTotalVal.Text = RoundVacationBalance(Math.Round(dblVacationDays, 0))
    ...
    Private Function SavePart() As Boolean
        ...
        '2- عدد ايام الاجازة اكبر من الرصيد
        ...
        Try
            ...
            '3- تارخ العودة اكبر من تاريخ البداية
