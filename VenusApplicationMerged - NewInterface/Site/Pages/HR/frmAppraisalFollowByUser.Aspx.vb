...
Partial Class frmAppraisalFollowByUser
    Inherits MainPage
...
#Region "Private Functions"
    ...
    Private Sub GetAppraisalNotifications()
        Try
            ...
            str1 = "Select * from V_AppraisalFinalResult join Hrs_Employees E on V_AppraisalFinalResult.EmployeeID=E.ID where   E.ManagerID= " & ClsEmployees.ID & " "
