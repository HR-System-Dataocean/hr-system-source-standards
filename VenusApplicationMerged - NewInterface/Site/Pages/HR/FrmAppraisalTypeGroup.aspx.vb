...
#Region "Public Decleration"
    Private ClsAppraisalTypeGroups As Clshrs_AppraisalTypeGroup
...
#Region "Protected Sub"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ClsAppraisalTypeGroups = New Clshrs_AppraisalTypeGroup(Me.Page)
        Dim ClsObjects As New Clssys_Objects(Page)
        Dim ClsSearchs As New Clssys_Searchs(Page)
        Dim SearchID As Integer = 0
        Try
            Dim clsSearchsColumns As New Clssys_SearchsColumns(Page)
            If ClsObjects.Find(" Code='" & ClsAppraisalTypeGroups.Table.Trim & "'") Then
            ...
            If Not IsPostBack Then
                Page.Session.Add("ConnectionString", ClsAppraisalTypeGroups.ConnectionString)
                ClsAppraisalTypeGroups.AddOnChangeEventToControls("frmProfession", Page, UltraWebTab1)
            ...
            If (txtCode.Text <> "") Then
                ClsAppraisalTypeGroups.Find(" Code='" & txtCode.Text & "'")
                IntrecordID = ClsAppraisalTypeGroups.ID
        ...
        Catch ex As Exception
            ...
            mErrorHandler.RecordExceptions_DataBase("", ex, Err.Number, ClsAppraisalTypeGroups.RegUserID, Venus.Shared.ErrorsHandler.eRecordingType.System_DataBase)
    ...
    Protected Sub ImageButton_Command(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.CommandEventArgs) Handles ImageButton_Save.Command, ImageButton_SaveN.Command, LinkButton_SaveN.Command, ImageButton_New.Command, ImageButton_Print.Command, ImageButton_Properties.Command, LinkButton_Properties.Command, ImageButton_Remarks.Command, LinkButton_Remarks.Command, ImageButton_Last.Command, ImageButton_Next.Command, ImageButton_Back.Command, ImageButton_First.Command, ImageButton_Delete.Command
        ...
        Dim ObjNavigationHandler As New Venus.Shared.Web.NavigationHandler(ClsAppraisalTypeGroups.ConnectionString)
        Select Case e.CommandArgument
            ...
            Case "New"
                AfterOperation()
            Case "Delete"
                ClsAppraisalTypeGroups.Delete("Code='" & txtCode.Text & "'")
                AfterOperation()
            Case "Property"
                ClsAppraisalTypeGroups.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmPropertyScreen.aspx?ID=" & ClsAppraisalTypeGroups.ID & "&TableName=" & ClsAppraisalTypeGroups.Table, 477, 313, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Property", False)
            Case "Remarks"
                ClsAppraisalTypeGroups.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmRemarks.aspx?ID=" & ClsAppraisalTypeGroups.ID & "&TableName=" & ClsAppraisalTypeGroups.Table, 410, 210, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Remarks", False)
            Case "Print"
            ...
            Case "First"
                ClsAppraisalTypeGroups.Find("Code='" & txtCode.Text & "'")
                ClsAppraisalTypeGroups.FirstRecord()
                GetValues(ClsAppraisalTypeGroups)
            Case "Previous"
                ClsAppraisalTypeGroups.Find("Code='" & txtCode.Text & "'")
                If Not ClsAppraisalTypeGroups.previousRecord() Then
                    ClsAppraisalTypeGroups.Find("Code='" & txtCode.Text & "'")
            ...
            Case "Next"
                ClsAppraisalTypeGroups.Find("Code='" & txtCode.Text & "'")
                If Not ClsAppraisalTypeGroups.NextRecord() Then
                    ClsAppraisalTypeGroups.Find("Code='" & txtCode.Text & "'")
            ...
            Case "Last"
                ClsAppraisalTypeGroups.Find("Code='" & txtCode.Text & "'")
                ClsAppraisalTypeGroups.LastRecord()
                GetValues(ClsAppraisalTypeGroups)
        End Select
    End Sub
...
#Region "Private Functions"
    Private Function SavePart() As Boolean
        Dim StrMode As String = Request.QueryString.Item("Mode")
        ClsAppraisalTypeGroups = New Clshrs_AppraisalTypeGroup(Page)

        Try
            ClsAppraisalTypeGroups.Find("Code='" & txtCode.Text & "'")

            If ClsAppraisalTypeGroups.ID > 0 Then
                If Not AssignValue(ClsAppraisalTypeGroups) Then
                    Exit Function
                End If
                ClsAppraisalTypeGroups.Update("Code='" & txtCode.Text & "'")

            Else
                If Not AssignValue(ClsAppraisalTypeGroups) Then
                    Exit Function
                End If
                ClsAppraisalTypeGroups.Save()

            End If

            ClsAppraisalTypeGroups.Find("Code='" & txtCode.Text & "'")

            clsMainOtherFields.CollectDataAndSave(value.Text, ClsAppraisalTypeGroups.Table, ClsAppraisalTypeGroups.ID)
            value.Text = ""
            Return True
        Catch ex As Exception
            Return False
        End Try
    End Function
    Private Function AssignValue(ByRef ClsAppraisalTypeGroups As Clshrs_AppraisalTypeGroup) As Boolean
        Try
            With ClsAppraisalTypeGroups
                .Code = txtCode.Text
        ...
        End Try
    End Function
    Private Function GetValues(ByVal ClsAppraisalTypeGroups As Clshrs_AppraisalTypeGroup) As Boolean
        ...
        Try
            ...
            With ClsAppraisalTypeGroups
                ...
                If Page.IsPostBack Then
                    CreateOtherFields(ClsAppraisalTypeGroups.ID)
                End If
            End With
            Return True
        Catch ex As Exception
    ...
    Private Function SetToolbarSetting(ByVal ptrType As String, ByVal ClsClass As Object, ByVal intID As Integer) As Boolean
        Try
            Select Case ptrType
                ...
                Case "D"
                    ClsAppraisalTypeGroups.Find("ID=" & intID)
                    GetValues(ClsAppraisalTypeGroups)
    ...
    Private Function CheckCode() As Boolean
        ...
        Try
            ClsAppraisalTypeGroups.Find("Code='" & txtCode.Text & "'")
            IntId = ClsAppraisalTypeGroups.ID
            txtEngName.Focus()
            If ClsAppraisalTypeGroups.ID > 0 Then
                GetValues(ClsAppraisalTypeGroups)
                StrMode = "E"
            Else
                If ClsAppraisalTypeGroups.CheckRecordExistance(" Code='" & txtCode.Text & "'") Then
                    txtCode.Text = ""
                    txtCode.Focus()
                End If
            ...
            End If
            SetToolBarDefaults()
            SetToolBarPermission(Me, ClsAppraisalTypeGroups.ConnectionString, ClsAppraisalTypeGroups.DataBaseUserRelatedID, ClsAppraisalTypeGroups.GroupID, StrMode)
            SetToolBarRecordPermission(Me, ClsAppraisalTypeGroups.ConnectionString, ClsAppraisalTypeGroups.DataBaseUserRelatedID, ClsAppraisalTypeGroups.GroupID, ClsAppraisalTypeGroups.Table, IntId)
            ...
            If ClsAppraisalTypeGroups.ID > 0 Then
                Dim str As String = "  select ID,Code,EngName,ArbName,IsOneTimeOnly,OneTimePeriod,AppraisalFrequency,NotificationPeriod  from APP_APpraisaltypes where AppraisalTypeGroupID=" & ClsAppraisalTypeGroups.ID & " "
                ds = SqlHelper.ExecuteDataset(connectionString, CommandType.Text, str)
                If ds.Tables(0).Rows.Count > 0 Then
                    uwgAppTypeGroups.DataSource = ds.Tables(0)
                    uwgAppTypeGroups.DataBind()
                Else
                    uwgAppTypeGroups.DataSource = Nothing
                    uwgAppTypeGroups.DataBind()
    ...
    Private Sub LoadDataUpdateSchedules(ByVal formName As String)
        ...
        ClsAppraisalTypeGroups = New Clshrs_AppraisalTypeGroup(Me.Page)
        ClsAppraisalTypeGroups.Find(" code = '" & txtCode.Text & "'")
        Dim recordID As Integer = ClsAppraisalTypeGroups.ID
        If (recordID > 0) Then
    ...
    Private Function CreateOtherFields(ByVal IntRecordID As Integer)
        ...
        If clsMainOtherFields.CheckOtherFieldsButton(Me.Page, ClsAppraisalTypeGroups.Table) = True Then
            Dim StrTablename As String
            ClsAppraisalTypeGroups = New Clshrs_AppraisalTypeGroup(Me)
            StrTablename = ClsAppraisalTypeGroups.Table
