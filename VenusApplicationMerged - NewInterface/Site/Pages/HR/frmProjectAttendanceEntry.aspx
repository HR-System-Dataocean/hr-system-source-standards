<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmProjectAttendanceEntry.aspx.vb"
    Inherits="frmProjectAttendanceEntry" Culture="auto" UICulture="auto" meta:resourcekey="PageResource1" %>
...
<head runat="server">
    <title>* Venus Payroll * ~ frmProjectAttendanceEntry</title>
...
<body style="height: 100%; margin: 0; padding: 0;">
    <form id="frmProjectAttendanceEntry" runat="server" defaultbutton="ImageButton1">
                                                    ...
                                                    <td style="width: 47%; height: 16px; vertical-align: top">
                                                        <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                            <tr>
                                                                ...
                                                                <td class="LabelArea">
                                                                    <asp:Button ID="Button1" runat="server" BackColor="Red" BorderStyle="Solid" BorderWidth="1px"
                                                                        Width="30px" />
                                                                </td>
                                                                <td class="DataArea">
                                                                    <asp:Label ID="Label_EmpDayOff" runat="server" meta:resourcekey="Label_EmpDayOffResource1"
                                                                        SkinID="Label_DefaultNormal" Text="الموظفين فى راحة" Width="240px"></asp:Label>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="SeparArea">
                                                                ...
                                                                <td class="LabelArea">
                                                                    <asp:Button ID="Button2" runat="server" BackColor="#33CCFF" BorderStyle="Solid" BorderWidth="1px"
                                                                        Width="30px" />
                                                                </td>
                                                                <td class="DataArea">
                                                                    <asp:Label ID="Label_EmpEntered" runat="server" meta:resourcekey="Label_EmpEnteredResource1"
                                                                        SkinID="Label_DefaultNormal" Text="الموظفين الذين سبق إدخالهم" Width="224px"></asp:Label>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                        ...
                                                        <igtbl:UltraWebGrid   Browser="UpLevel"   ID="UwgSearchEmployees" runat="server" EnableAppStyling="True"
                                                            ...
                                                            <Bands>
                                                                <igtbl:UltraGridBand AllowSorting="No" meta:resourcekey="UltraGridBandResource1">
                                                                    ...
                                                                    <Columns>
                                                                        <igtbl:UltraGridColumn Width="80px" AllowUpdate="Yes" BaseColumnName="Marked" Key="Marked"
