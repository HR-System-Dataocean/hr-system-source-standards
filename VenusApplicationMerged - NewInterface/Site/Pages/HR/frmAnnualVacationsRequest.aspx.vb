...
#Region "Private Functions"
    ...
    Public Function SaveAnnualVacationRequest() As Boolean
        ...
        Try
            ...
            'ClsEmployeeVacation.Find("EmployeeID=" & txtEmployee.te)
            ...
            If ClsEmployeesVacations2.GetEmployeeLastVacation(ClsEmployees.ID) Then
                ...
                End If
            End If
            If ClsEmployeesVacations2.ExpectedEndDate > WebDateChooser1.Value Then
    ...
    Private Sub FillEmployeeVacations()
        Try
            ...
            Dim str1 As String = "select ID,VacationType, RequestSerial ,EmployeeID ," & EmpName & " as EmployeeName,RequestDate ,NoOfDays, " & RequestName & " as RequestType, FormCode from SS_VAnnualVacationsFollowup where  EmployeeID= " & ClsEmployees.ID & "  and FormCode='SS_0011' Order By RequestDate desc"
