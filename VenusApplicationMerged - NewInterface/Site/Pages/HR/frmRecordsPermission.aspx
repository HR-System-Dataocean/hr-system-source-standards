<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmRecordsPermission.aspx.vb"
    Inherits="frmRecordsPermission" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
...
<head runat="server">
    <title>Records Permission</title>
    ...
    <script language="javascript" src="Scripts/App_RecordsPermissions.js"></script>
</head>
<body style="margin: 0; padding: 0;">
    <form id="frmRecordsPermission" runat="server">
    <div runat="server" id="DIV" style="background-color: #BEDCFF;">
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td style="width: 30%;">
                                                            <asp:Label ID="lblTables" runat="server" Text="الجدول" SkinID="Label_DefaultNormal"
                                                                meta:resourcekey="lblTableResource1"></asp:Label>
                                                        </td>
                                                        <td style="width: 40%;">
                                                            <asp:DropDownList ID="DdlTables" runat="server" meta:resourcekey="DdlTablesResource1"
                                        ...
                                        <tr>
                                                ...
                                                <table style="width: 100%; height: 30px; vertical-align: bottom; border-bottom: 1px solid black"
                                                    ...
                                                    <tr>
                                                        <td style="vertical-align: bottom">
                                                            <asp:Label ID="Label_Title1" runat="server" Text="برجاء تحديد صلاحيات للشاشات" SkinID="Label_DefaultBold"
                                            ...
                                            <td style="width: 47%; vertical-align: top;">
                                                <table style="width: 100%; height: 30px;" cellspacing="6">
                                                    <tr>
                                                        <td>
                                                            &nbsp;<asp:CheckBox ID="chkAllowEdit" runat="server" meta:resourcekey="chkAllowAddResource1"
                                                                Text=" " />
                                                            &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
                                                            <asp:CheckBox ID="chkAllowDelete" runat="server" meta:resourcekey="chkAllowEditResource1"
                                                                Text=" " />
                                                            &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
                                                            <asp:CheckBox ID="chkAllowView" runat="server" meta:resourcekey="chkAllowDeleteResource1"
                                                                Text=" " />
                                                            &nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                                                            <asp:CheckBox ID="chkAllowPrint" runat="server" meta:resourcekey="chkAllowViewResource1"
                                                                Text=" " />
                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;
                                                            <asp:CheckBox ID="chkIsSpecific" runat="server" meta:resourcekey="chkAllowPrintResource1"
                                                                Text=" " />
                                                            &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;
                                            ...
                                            <td style="width: 100%; vertical-align: auto" colspan="3">
                                                <igtbl:UltraWebGrid  Browser="UpLevel"   ID="UwgSearchUsers" runat="server" EnableAppStyling="False" Height="100%"
                                                    ...
                                                    <DisplayLayout AllowColSizingDefault="Free" AllowAddNewDefault="Yes" AllowColumnMovingDefault="OnServer"
                                                        ...
                                                        <ClientSideEvents AfterCellUpdateHandler="UwgSearchUsers_AfterCellUpdateHandler" />
                                                    </DisplayLayout>
                                                    <Bands>
                                                        <igtbl:UltraGridBand meta:resourcekey="UltraGridBandResource1">
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <igtbl:UltraGridColumn AllowUpdate="No" BaseColumnName="Code" Width="60px" meta:resourcekey="UltraGridColumnResource1">
                                                                    <Header Caption="Code">
                                                                ...
                                                                <igtbl:UltraGridColumn AllowUpdate="No" BaseColumnName="EngName" Width="145px" meta:resourcekey="UltraGridColumnResource2">
                                                                ...
                                                                <igtbl:UltraGridColumn AllowUpdate="No" BaseColumnName="ArbName" Width="145px" meta:resourcekey="UltraGridColumnResource3">
                                                                ...
                                                                <igtbl:UltraGridColumn AllowUpdate="Yes" BaseColumnName="CantEdit" meta:resourcekey="UltraGridColumnResource5"
                                                                    CellButtonDisplay="Always" DataType="System.Boolean" Key="CantEdit" Type="CheckBox"
                                                                    Width="60px">
                                                                    <HeaderStyle HorizontalAlign="Center" />
                                                                    <Header Caption="No Edit">
                                                                ...
                                                                <igtbl:UltraGridColumn AllowUpdate="Yes" BaseColumnName="CantDelete" meta:resourcekey="UltraGridColumnResource6"
                                                                    CellButtonDisplay="Always" Key="CantDelete" Type="CheckBox" Width="60px" DataType="System.Boolean">
                                                                    <Header Caption="No Delete">
                                                                ...
                                                                <igtbl:UltraGridColumn AllowUpdate="Yes" BaseColumnName="CantView" meta:resourcekey="UltraGridColumnResource7"
                                                                    CellButtonDisplay="Always" DataType="System.Boolean" Key="CantView" Type="CheckBox"
                                                                    Width="60px">
                                                                    <HeaderStyle HorizontalAlign="Center" />
                                                                    <Header Caption="No View ">
                                                                ...
                                                                <igtbl:UltraGridColumn AllowUpdate="Yes" BaseColumnName="CantPrint" meta:resourcekey="UltraGridColumnResource8"
                                                                    CellButtonDisplay="Always" DataType="System.Boolean" Key="CantPrint" Type="CheckBox"
                                                                    Width="60px">
                                                                    <HeaderStyle HorizontalAlign="Center" />
                                                                    <Header Caption="No Print">
                                                                ...
                                                                <igtbl:UltraGridColumn BaseColumnName="IsSpacific" Key="IsSpacific" meta:resourcekey="UltraGridColumnResource9"
                                                                    AllowUpdate="Yes" CellButtonDisplay="Always" Type="CheckBox" Width="65px">
                                                                    <Header Caption="Is Spacific">
                                                                ...
                                                                <igtbl:UltraGridColumn BaseColumnName="CheckAll" Key="CheckAll" meta:resourcekey="UltraGridColumnResource11"
                                                                    AllowUpdate="Yes" CellButtonDisplay="Always" Type="CheckBox" Width="60px">
                                                                    <Header Caption="Check All">
                                                                        <RowLayoutColumnInfo OriginX="9" />
                                                                    </Header>
                                                                    <Footer>
                                                                        <RowLayoutColumnInfo OriginX="9" />
        ...
        <asp:HiddenField ID="txtIsSpecificC" runat="server" />
        <asp:HiddenField ID="txtEditC" runat="server" />
        <asp:HiddenField ID="txtDeleteC" runat="server" />
        <asp:HiddenField ID="txtViewC" runat="server" />
        <asp:HiddenField ID="txtGridCount" runat="server" />
        <asp:HiddenField ID="txtGridCountAll" runat="server" />
        <asp:HiddenField ID="txtCheckAllC" runat="server" />
        <asp:HiddenField ID="txtPrintC" runat="server" />
    </div>
    </form>
</body>
</html>
