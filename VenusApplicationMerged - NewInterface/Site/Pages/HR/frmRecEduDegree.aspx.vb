...
Partial Class frmRecEduDegree
    Inherits MainPage
#Region "Public Decleration"
    Private ClsEducationDegree As ClsRec_EducationDegree
...
#Region "Protected Sub"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ClsEducationDegree = New ClsRec_EducationDegree(Me.Page)
        Dim ClsObjects As New Clssys_Objects(Page)
        Dim ClsSearchs As New Clssys_Searchs(Page)
        Dim SearchID As Integer = 0
        Try
            Dim clsSearchsColumns As New Clssys_SearchsColumns(Page)
            If ClsObjects.Find(" Code='" & ClsEducationDegree.Table.Trim & "'") Then
            ...
            If Not IsPostBack Then
                Page.Session.Add("ConnectionString", ClsEducationDegree.ConnectionString)
                ClsEducationDegree.AddOnChangeEventToControls("frmRecEduDegree", Page, UltraWebTab1)
            ...
            If (txtCode.Text <> "") Then
                ClsEducationDegree.Find(" Code='" & txtCode.Text & "'")
                IntrecordID = ClsEducationDegree.ID
        ...
        Catch ex As Exception
            ...
            mErrorHandler.RecordExceptions_DataBase("", ex, Err.Number, ClsEducationDegree.RegUserID, Venus.Shared.ErrorsHandler.eRecordingType.System_DataBase)
    ...
    Protected Sub ImageButton_Command(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.CommandEventArgs) Handles ImageButton_Save.Command, ImageButton_SaveN.Command, LinkButton_SaveN.Command, ImageButton_New.Command, ImageButton_Print.Command, ImageButton_Properties.Command, LinkButton_Properties.Command, ImageButton_Remarks.Command, LinkButton_Remarks.Command, ImageButton_Last.Command, ImageButton_Next.Command, ImageButton_Back.Command, ImageButton_First.Command, ImageButton_Delete.Command
        ...
        Dim ObjNavigationHandler As New Venus.Shared.Web.NavigationHandler(ClsEducationDegree.ConnectionString)
        Select Case e.CommandArgument
            ...
            Case "Delete"
                ...
                ClsCountries.Find(" CurrencyID= " & ClsEducationDegree.ID & " And IsNull(CancelDate,'')='' ")
                If ClsCountries.DataSet.Tables(0).Rows.Count > 0 Then
                    ...
                    Return
                Else
                    ClsEducationDegree.Delete("Code='" & txtCode.Text & "'")
                    AfterOperation()
                End If
            Case "Property"
                If ClsEducationDegree.Find("Code='" & txtCode.Text & "'") Then
                    Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmPropertyScreen.aspx?ID=" & ClsEducationDegree.ID & "&TableName=" & ClsEducationDegree.Table, 477, 313, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Property", False)
                End If
            Case "Remarks"
                If ClsEducationDegree.Find("Code='" & txtCode.Text & "'") Then
                    Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmRemarks.aspx?ID=" & ClsEducationDegree.ID & "&TableName=" & ClsEducationDegree.Table, 410, 210, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Remarks", False)
                End If
            ...
            Case "First"
                ClsEducationDegree.Find("Code='" & txtCode.Text & "'")
                ClsEducationDegree.FirstRecord()
                GetValues(ClsEducationDegree)
            Case "Previous"
                ClsEducationDegree.Find("Code='" & txtCode.Text & "'")
                If Not ClsEducationDegree.previousRecord() Then
                    ClsEducationDegree.Find("Code='" & txtCode.Text & "'")
            ...
            Case "Next"
                ClsEducationDegree.Find("Code='" & txtCode.Text & "'")
                If Not ClsEducationDegree.NextRecord() Then
                    ClsEducationDegree.Find("Code='" & txtCode.Text & "'")
...
#Region "Private Functions"
    Private Function SavePart() As Boolean
        Dim StrMode As String = Request.QueryString.Item("Mode")
        ClsEducationDegree = New ClsRec_EducationDegree(Page)

        Try
            ClsEducationDegree.Find("Code='" & txtCode.Text & "'")

            If ClsEducationDegree.ID > 0 Then
                If Not AssignValue(ClsEducationDegree) Then
                    Exit Function
                End If
                ClsEducationDegree.Update("Code='" & txtCode.Text & "'")

            Else
                If Not AssignValue(ClsEducationDegree) Then
                    Exit Function
                End If
                ClsEducationDegree.Save()

            End If

            ClsEducationDegree.Find("Code='" & txtCode.Text & "'")

            clsMainOtherFields.CollectDataAndSave(value.Text, ClsEducationDegree.Table, ClsEducationDegree.ID)
            value.Text = ""
            Return True
        Catch ex As Exception
            Return False
        End Try
    End Function
    Private Function AssignValue(ByRef ClsEducationDegree As ClsRec_EducationDegree) As Boolean
        Try
            With ClsEducationDegree
                .Code = txtCode.Text
        ...
        End Try
    End Function
    Private Function GetValues(ByVal ClsEducationDegree As ClsRec_EducationDegree) As Boolean
    ...
    Private Function SetToolbarSetting(ByVal ptrType As String, ByVal ClsClass As Object, ByVal intID As Integer) As Boolean
        Try
            Select Case ptrType
                ...
                Case "D"
                    ClsEducationDegree.Find("ID=" & intID)
                    GetValues(ClsEducationDegree)
    ...
    Private Function CheckCode() As Boolean
        ...
        Try
            ClsEducationDegree.Find("Code='" & txtCode.Text & "'")
            IntId = ClsEducationDegree.ID
            txtEngName.Focus()
            If ClsEducationDegree.ID > 0 Then
                GetValues(ClsEducationDegree)
                StrMode = "E"
            Else
                If ClsEducationDegree.CheckRecordExistance(" Code='" & txtCode.Text & "'") Then
                    txtCode.Text = ""
                    txtCode.Focus()
                End If
            ...
            End If
            SetToolBarDefaults()
            SetToolBarPermission(Me, ClsEducationDegree.ConnectionString, ClsEducationDegree.DataBaseUserRelatedID, ClsEducationDegree.GroupID, StrMode)
            SetToolBarRecordPermission(Me, ClsEducationDegree.ConnectionString, ClsEducationDegree.DataBaseUserRelatedID, ClsEducationDegree.GroupID, ClsEducationDegree.Table, IntId)
    ...
    Private Sub LoadDataUpdateSchedules(ByVal formName As String)
        ...
        ClsEducationDegree = New ClsRec_EducationDegree(Me.Page)
        ClsEducationDegree.Find(" code = '" & txtCode.Text & "'")
        Dim recordID As Integer = ClsEducationDegree.ID
        If (recordID > 0) Then
    ...
    Private Function CreateOtherFields(ByVal IntRecordID As Integer)
        ...
        If clsMainOtherFields.CheckOtherFieldsButton(Me.Page, ClsEducationDegree.Table) = True Then
            Dim StrTablename As String
            ClsEducationDegree = New ClsRec_EducationDegree(Me)
            StrTablename = ClsEducationDegree.Table
