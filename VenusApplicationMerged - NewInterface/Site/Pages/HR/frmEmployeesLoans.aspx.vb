    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If Not IsPostBack Then
                ...
                ClsEmployeesPayability.AddOnChangeEventToControls("frmEmployeesLoans", Page, UltraWebTab1)
            ...
            If (lblDescLoanCode.Text <> "" And hdnSettelment.Value = "1") Then
                If ClsEmployeesPayability.Find("Number='" & lblDescLoanCode.Text & "'") Then
                    ...
                    tempClsEmployeesPayability.Find(" EmployeeID=" & ClsEmployeesPayability.EmployeeID)
        ...
        Try
            ...
            If OriginalLaonAmount = 0 Then
                ...
                For Each ObjRow In uwgScheduleTemplet.Rows
                    ...
                    Else
                        StrSqlCommand &= "Insert Into hrs_EmployeesPayabilitiesSchedules(" & _
                        "EmployeePayabilityId," & _
                        "DueDate," & _
                        "DueAmount," & _
                        "RegUserID," & _
                        "CompanyId" & _
                        ")values(" & _
                        IntId & ",'" & _
                        currDate.ToString("dd/MM/yyyy") & "'," & _
                        IIf(ObjRow.Cells(0).Value = Nothing, 0, ObjRow.Cells(0).Value) & "," & _
                        clsEmployeesPayability.DataBaseUserRelatedID & "," & _
                        clsEmployeesPayability.MainCompanyID & _
                        ");" & vbNewLine
                    End If
