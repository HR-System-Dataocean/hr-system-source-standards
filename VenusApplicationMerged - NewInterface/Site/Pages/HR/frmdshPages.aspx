<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmdshPages.aspx.vb" Inherits="frmdshPages"
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmdshPages" runat="server">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblCol" runat="server" 
                                                                meta:resourcekey="lblColResource1" SkinID="Label_DefaultNormal" 
                                                                Text="عدد الأعمدة"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <igtxt:WebNumericEdit ID="txtCol" runat="server" DataMode="Int" 
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table cellspacing="0" style="width: 100%; vertical-align: top">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblRws" runat="server" meta:resourcekey="lblRwsResource1"
                                                                SkinID="Label_DefaultNormal" Text="عدد الصفوف"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <igtxt:WebNumericEdit ID="txtRws" runat="server" DataMode="Int" MinValue="0"
