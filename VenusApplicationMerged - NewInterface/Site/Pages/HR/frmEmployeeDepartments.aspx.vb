...
Partial Class frmEmployeeDepartments
    Inherits MainPage
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If Not IsPostBack Then
                ...
                ClsDelegationSChedule.AddOnChangeEventToControls("frmEmployeeDepartments", Page, UltraWebTab1)
                GetData(0)
                'AddNewRow()
...
#Region "Private Functions"
    ...
    Private Function GetData(EmpId As Integer) As Boolean
        Try
            ...
            If ProfileCls.CurrentLanguage = "Ar" Then
                EmpName = " sys_Departments.ArbName "
            Else
                EmpName = " sys_Departments.EngName "
            End If


            Dim str As String = "SELECT  sys_Departments.Id as DepartmentId, sys_Departments.Code as DepartmentCode," & EmpName & " as DepartmentName,(Case when (select hrs_EmployeeDepartments.ID from hrs_EmployeeDepartments where hrs_EmployeeDepartments.DepartmentId=sys_Departments.Id and EmpId=" & EmpId & ") IS NULL then 0 else 1 end) as [Select]  FROM sys_Departments  where CancelDate is null Order By sys_Departments.Id  "
    ...
    Private Function SaveGrid(EmpId As Integer) As Boolean
        Try
            ...
            str &=
                                    " DELETE FROM [dbo].[hrs_EmployeeDepartments] where " &
                                    " EmpId = " & EmpId & " ;"
            ...
            For Each row As Infragistics.WebUI.UltraWebGrid.UltraGridRow In UwgSearchEmployees.Rows
                ...
                If row.Cells.FromKey("Select").Value <> Nothing Then
                    ...
                    str = "set dateformat DMY; "
                    str &= " INSERT INTO [dbo].[hrs_EmployeeDepartments] ([EmpId],[DepartmentId]) VALUES " &
                                    "(" & EmpId &
                                    ",'" & row.Cells.FromKey("DepartmentId").Value &
                                    "');" & vbNewLine
    ...
    Private Sub FillEmployeeVacations()
        Try
            ...
            Dim str1 As String = "SELECT  hrs_EmployeeDepartments.DepartmentId, hrs_EmployeeDepartments.DepartmentCode," & EmpName & " as DepartmentName,(Case when hrs_EmployeeDepartments.Id IS NULL then 0 else 1 end) as Select  FROM hrs_EmployeeDepartments Right join sys_Departments on sys_Departments.ID= hrs_EmployeeDepartments.DepartmentId where EmpId=" & ClsEmployees.ID & " Order By hrs_EmployeeDepartments.DepartmentId "
