<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmGradesSteps.aspx.vb"
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblMainDepartment" runat="server" meta:resourcekey="lblMainDepartmentResource1"
                                                                SkinID="Label_DefaultNormal" Text="المستوى"></asp:Label>
                                        ...
                                        <tr>
                                                ...
                                                <table style="width: 100%; height: 30px; vertical-align: bottom; border-bottom: 1px solid black"
                                                    ...
                                                    <tr>
                                                        <td style="vertical-align: bottom">
                                                            <asp:Label ID="Label_Title1" runat="server" Text="برجاء اختيار المراتب " SkinID="Label_DefaultBold"
                                            ...
                                            <td style="width: 47%; vertical-align: top;">
                                                <table style="width: 100%; height: 30px; vertical-align: bottom; border-bottom: 1px solid black"
                                                    ...
                                                    <tr>
                                                        <td style="vertical-align: bottom">
                                                            <asp:Label ID="Label_Title2" runat="server" Text="برجاء تحديد بنود المراتب" SkinID="Label_DefaultBold"
                                                ...
                                                <ContentTemplate>
                                                    <td style="width: 47%; height: 100%; vertical-align: top">
                                                        <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                            <tr>
                                                                <td>
                                                                    <igtbl:UltraWebGrid   Browser="UpLevel"   ID="uwgGradesSteps" runat="server" EnableAppStyling="False" Height="100%"
                                                                            ...
                                                                            <igtbl:UltraGridBand>
                                                                                <Columns>
                                                                                    ...
                                                                                    <igtbl:UltraGridColumn AllowUpdate="No" BaseColumnName="EngName" CellButtonDisplay="Always"
                                                                                        HeaderText="Grade Step" Key="EngName" meta:resourceKey="UltraGridColumnResource4"
                                                                                        Width="65%">
                                                                                        <Header Caption="Grade Step">
                                                                                    ...
                                                                                    <igtbl:UltraGridColumn AllowUpdate="No" BaseColumnName="Step" CellButtonDisplay="Always"
                                                                                        HeaderText="Step" Key="Step" meta:resourceKey="UltraGridColumnResource5" Width="35%">
                                                                                        <Header Caption="Step">
                                                                                    ...
                                                                                    <igtbl:UltraGridColumn AllowUpdate="No" BaseColumnName="ArbName" CellButtonDisplay="Always"
                                                                                        HeaderText="Grade Step" Hidden="True" Key="ArbName" Width="65%">
                                                                                        <Header Caption="Grade Step">
                                                                            ...
                                                                            <igtbl:UltraGridBand>
                                                                                <Columns>
                                                                                    ...
                                                                                    <igtbl:UltraGridColumn AllowUpdate="Yes" BaseColumnName="GradeTransactionID" CellButtonDisplay="Always"
                                                                                        ...
                                                                                        meta:resourceKey="UltraGridColumnResource2" Type="DropDownList" Width="75%">
                                                                                        <Header Caption="Grade Transactions">
                                                                                            <RowLayoutColumnInfo OriginX="1" />
                                                                                        </Header>
                                                                                        <Footer>
                                                                                            <RowLayoutColumnInfo OriginX="1" />
                                                                                    ...
                                                                                    <igtbl:UltraGridColumn AllowUpdate="Yes" BaseColumnName="Amount" CellButtonDisplay="Always"
                                                                                        ...
                                                                                        meta:resourceKey="UltraGridColumnResource3" Type="Custom" Width="15%">
