<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmSponsors.aspx.vb" Inherits="frmSponsors_"
...
<head runat="server">
    <title>* Venus Payroll * ~Sponsors</title>
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmSponsors" runat="server">
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblSponsorNumber" runat="server" Text="رقم الكفيل" SkinID="Label_DefaultNormal"
                                                                meta:resourcekey="lblSponsorNumberResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <igtxt:WebMaskEdit ID="wneSponsorNumber" runat="server" InputMask="##############"
