...
Imports System.Data
Partial Class frmItemDocuments
...
#Region "Public Decleration"
    ...
    Private ClsFileUpload As ClsFileUpload
...
#Region "Protected Sub"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim ClsFileUpload As New ClsFileUpload(Me.Page)
        ...
        If Request.QueryString("combId") <> Nothing And Request.QueryString("combId") = "" Then
            CombID = Request.QueryString("combId")
        End If
        ...
        Try
            ...
            End If
                ...
                ClsFileUpload.Find(TableName, "ID=" & IntRecordId)
                lblDescEmployeeCode.Text = ClsFileUpload.Code
                lblDescEnglishName.Text = ClsFileUpload.ArbName

            Dim clsSearchsColumns = New Clssys_SearchsColumns(Me.Page)
            DdlAttachedFiles.Attributes.Add("onChange", "setlink();")
            If Not IsPostBack Then
                Page.Session.Add("ConnectionString", ClsFileUpload.ConnectionString)
    ...
    Protected Sub ImageButton_PopupCommand(sender As Object, e As System.Web.UI.WebControls.CommandEventArgs) Handles ImageButton_Save.Command, ImageButton_New.Command, ImageButton_Delete.Command
        Dim ClsFileUpload As New ClsFileUpload(Me.Page)
        Dim ObjNavigationHandler As New Venus.Shared.Web.NavigationHandler(ClsFileUpload.ConnectionString)
    ...
    Protected Sub btnDeleteAttachment_Click(ByVal sender As Object, ByVal e As Infragistics.WebUI.WebDataInput.ButtonEventArgs) Handles btnDeleteAttachment.Click
        ...
        Dim ItemID As Integer
            ClsFileUpload = New ClsFileUpload(Page)
            ClsFileUpload.Find(TableName, "Code='" & lblDescEmployeeCode.Text & "'")
            ItemID = ClsFileUpload.ID
