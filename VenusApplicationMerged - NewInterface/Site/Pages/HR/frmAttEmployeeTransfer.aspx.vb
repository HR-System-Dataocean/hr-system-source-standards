...
Partial Class frmAttEmployeeTransfer
    Inherits MainPage
#Region "Public Decleration"
    Private ClsAttendAppointmentMembers As Clshrs_Att_AttendAppointmentMembers
    Private ClsAttendAppointment As Clshrs_Att_AttendAppointment
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If Not IsPostBack Then
                ...
                ClsEmployees.AddOnChangeEventToControls("frmAttEmployeeTransfer", Page, UltraWebTab1)
    ...
    Protected Sub ImageButton_Command(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.CommandEventArgs) Handles ImageButton_Save.Command, LinkButton_SaveN.Command, ImageButton_New.Command, ImageButton_Print.Command, ImageButton_Properties.Command, LinkButton_Properties.Command, ImageButton_Remarks.Command, LinkButton_Remarks.Command, ImageButton_Last.Command, ImageButton_Next.Command, ImageButton_Back.Command, ImageButton_First.Command, ImageButton_Delete.Command
        ...
        Dim ClsAttendAppointmentMembers As New Clshrs_Att_AttendAppointmentMembers(Page)
        Select Case e.CommandArgument
            ...
            Case "Delete"
                ClsEmployees.Find("Code='" & txtCode.Text & "'")
                ClsAttendAppointmentMembers.Delete("AppointID=" & lbAppointmentID.Text & "and Employeeid=" & ClsEmployees.ID)
    ...
    Private Function GetValues(ByVal ClsEmployees As Clshrs_Employees) As Boolean
        ...
        Dim ClsAttendAppointmentMembers As New Clshrs_Att_AttendAppointmentMembers(Page)
        Dim ClsAttendAppointment As New Clshrs_Att_AttendAppointment(Page)
        ...
        'End If
        DS1 = Microsoft.ApplicationBlocks.Data.SqlHelper.ExecuteDataset(clsDAL.ConnectionString, Data.CommandType.StoredProcedure, "dbo.shift_FindAllAttendWorkPlan", param)
