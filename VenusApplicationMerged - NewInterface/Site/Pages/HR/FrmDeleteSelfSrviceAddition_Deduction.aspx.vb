            ...
            Case "Delete"
                ...
                Else
                    Try
                        ...
                        ClsEmployeesPayability.Delete("Number='" & Number & "'")



                        If CancelRequest(RequestID, FormCode, ClsEmployeesPayability.EmployeeID) Then
...
#Region "Private Function"
    Private Function CancelRequest(RequestSerial As String, FormCode As String, EmployeeID As Integer) As Boolean
        ...
        If FormCode = "SS_001913" Then
            TableName = "SS_AdvanceHousingRequest"
        End If
        If FormCode = " SS_001914 " Then
            TableName = " SS_AdvanceSalaryRequest "
        End If
        If FormCode = "SS_001919" Then
            TableName = " SS_OvertimeRequest "
        End If
        UpdateCommandRank = "UPDATE " & TableName & "  SET [RequestStautsTypeID] = 5 WHERE ID=" & RequestSerial & ""
