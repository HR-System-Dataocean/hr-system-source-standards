<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmAppraisalDepartmentCriteria.aspx.vb"
...
<head runat="server">
    ...
    <script type="text/javascript" id="igClientScript">
        ...
        //function uwgDepartmentcriteria_ClickCellButtonHandler(gridName, cellId) {
        //        debugger
            ...
            <tr>
                <td class="Details">
                    <igtab:UltraWebTab ID="UltraWebTab1" runat="server" EnableAppStyling="True" SkinID="Default"
                        ...
                        <Tabs>
                            <igtab:Tab Text="معايير التقييم للاقسام" meta:resourcekey="TabResource1">
                                <ContentTemplate>
                                            ...
                                            <td style="width: 55%; height: 16px; vertical-align: top">
                                                <table style="width: 50%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblDeprtment" runat="server" Width="65px" SkinID="Label_DefaultNormal"
                                                                Text="القسم" meta:resourcekey="lblDeprtmentResource1"></asp:Label>
                                                        </td>
                                                        <td class="SeparArea">
                                                        </td>
                                                        <td class="SeparArea">
                                                        ...
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="ddlDepartment" Width="200px" runat="server" AutoPostBack="True" SkinID="DropDownList_smallNormal"
                                        ...
                                        <tr>
                                                <td style="height: 16px; vertical-align: top" colspan="3">
                                                    <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                        <tr>
                                                            <td>
                                                                <igtbl:UltraWebGrid   Browser="UpLevel"  ID="uwgDepartmentcriteria" runat="server" EnableAppStyling="True"
                                                                    ...
                                                                    <DisplayLayout AllowColSizingDefault="Free" AllowDeleteDefault="Yes"  AllowAddNewDefault="Yes" AllowColumnMovingDefault="OnServer"
                                                                        ...
                                                                        Name="uwgDepartmentcriteria" RowHeightDefault="18px"
                                                              ...
                                                              <%--           <ClientSideEvents AfterCellUpdateHandler="uwgDepartmentcriteria_ClickCellButtonHandler"
                                                            ClickCellButtonHandler="uwgDepartmentcriteria_ClickCellButtonHandler" />--%>
                                                                    ...
                                                                    <Bands>
                                                                        <igtbl:UltraGridBand meta:resourcekey="UltraGridBandResource1" AllowAdd="Yes">
                                                                            ...
                                                                            <Columns>
                                                                                ...
                                                                                <igtbl:UltraGridColumn BaseColumnName="CriteriaName"  Key="CriteriaName" Type="DropDownList"  DataType="System.Int32" meta:resourcekey="CriteriaNameResource1" >
                                                                                 ...
                                                                                 <igtbl:UltraGridColumn BaseColumnName="ByPercentage" DataType="System.Boolean" Key="ByPrecentage" meta:resourcekey="ByPrecentageResource1"
                                                                                                     Width="20%" Type="CheckBox"  >
                                                                                              <Header Caption="نسبة">
                                                                                             <RowLayoutColumnInfo OriginX="10" />
                                                                                           </Header>
                                                                                 ...
                                                                                 <igtbl:UltraGridColumn BaseColumnName="MaximumScore"  Key="Score" DataType="System.string" meta:resourcekey="MaximumScoreResource1" >
                                                                                ...
                                                                                <igtbl:UltraGridColumn BaseColumnName="Include" DataType="System.Boolean" Key="Include" meta:resourcekey="IncludeResource1"
                                                                                    Width="20%" Type="CheckBox"  >
