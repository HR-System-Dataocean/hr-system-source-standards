...
Partial Class frmProjectEmployeeApplicants
    Inherits MainPage
...
#Region "Private Function"
    ...
    Private Function GetData() As Boolean
        Try
            ...
            strCommand = "Set DateFormat DMY; select ID,Code,dbo.fn_GetEmpName(Code," & ClsNavigationHandler.SetLanguage(Page, "0/1") & ") AS EmployeeName from hrs_Employees where isnull(IsProjectRelated,0) = 1 and isnull(RegComputerID,0) = 1 and isnull(IsSpecialForce,0) = 0 and ID in (select EmployeeID from hrs_ProjectPlacementEmployees)"


            Dim strFilter As String = " And ID > 0 "
...
#End Region
    ...
    Protected Sub LinkButton2_Click(sender As Object, e As System.EventArgs) Handles LinkButton2.Click
        Dim clsProjects As New Clshrs_Projects(Me, "hrs_Projects")
        Dim str As String = "delete from hrs_Employees where ID = " & HiddenField_EMPID.Value
