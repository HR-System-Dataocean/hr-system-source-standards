<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmRecApplicantsFilter.aspx.vb" Inherits="Pages_HR_frmRecApplicantsFilter" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<body style="margin: 0; padding: 0;">
    <form id="frmRecApplicantsFilter" runat="server">
                        ...
                        <tr>
                            ...
                            <td style="width: 120px">
                                <asp:ImageButton ID="ImageButton_SaveN" Width="16px" Height="16px" runat="server"
                                    ...
                                    meta:resourcekey="ImageButton_SaveNResource1" />
                            ...
                            <td style="width: 40px">
                                <asp:Label ID="Label_TSP1" runat="server" Text="|" 
                                    meta:resourcekey="Label_TSP1Resource1"></asp:Label>
                            </td>
                            <td style="width: 24px">
                            ...
                            <td style="width: 40px">
                                <asp:Label ID="Label_TSP2" runat="server" Text="|" 
                                    meta:resourcekey="Label_TSP2Resource1" ></asp:Label>
                            </td>
                            <td style="width: 24px">
                                            ...
                                            <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td style="width: 60%; height: 16px; vertical-align: middle;">
                                                        <asp:Label ID="lblRegDateValue" runat="server" SkinID="Label_CopyRightsNormal" meta:resourcekey="lblRegDateValueResource1" 
                                                            ></asp:Label>
                                                    </td>
                                                </tr>
                                            </table>
                                        ...
                                        <td style="width: 49%; vertical-align: top">
                                            <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td style="width: 60%; height: 16px; vertical-align: middle;">
                                                        <asp:Label ID="lblRegUserValue" runat="server" SkinID="Label_CopyRightsNormal" meta:resourcekey="lblRegUserValueResource1" 
                                                            ></asp:Label>
                                                    </td>
                                                </tr>
                                            </table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblCode" runat="server" Text="الكود" 
                                                                SkinID="Label_DefaultNormal" meta:resourcekey="lblCodeResource1" ></asp:Label>
                                                            <asp:Label ID="Label_Star1" runat="server" Text="*" Style="color: #FF0000" meta:resourcekey="Label_Star1Resource1" 
                                                                ></asp:Label>
                                                        </td>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblEngName" runat="server" Text="التوصيف إنجليزى" 
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblArbName" runat="server" Text="التوصيف عربى" 
                                                                SkinID="Label_DefaultNormal" meta:resourcekey="lblArbNameResource1"
                                                                ></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="txtArbName" runat="server" SkinID="TextBox_LargeNormalrtl" 
                                                                MaxLength="255" meta:resourcekey="txtArbNameResource1"
                                                                ></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table cellspacing="0" style="width: 100%; vertical-align: top">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblArbName0" runat="server" 
                                                                 SkinID="Label_DefaultNormal" 
                                                                Text="Salary Power" meta:resourcekey="lblArbName0Resource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <igtxt:WebNumericEdit ID="txtSalaryPower" runat="server" SkinID="WebNumericEdit_Fix"  DataMode="Int"  MaxLength="10" MaxValue="9999" 
                                                                 MinValue="0" NullText="0" meta:resourcekey="txtSalaryPowerResource1">
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table cellspacing="0" style="width: 100%; vertical-align: top">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblArbName1" runat="server" 
                                                                 SkinID="Label_DefaultNormal" 
                                                                Text="Experiences  Power" meta:resourcekey="lblArbName1Resource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <igtxt:WebNumericEdit ID="txtExpPower" runat="server" SkinID="WebNumericEdit_Fix"  DataMode="Int" MaxLength="10" MaxValue="9999" 
                                                                 MinValue="0" NullText="0" meta:resourcekey="txtExpPowerResource1">
                                                            </igtxt:WebNumericEdit>
                                                        </td>
                                                    </tr>
                                                </table>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table cellspacing="0" style="width: 100%; vertical-align: top">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblArbName2" runat="server" 
                                                                 SkinID="Label_DefaultNormal" 
                                                                Text="Evaluation Power" meta:resourcekey="lblArbName2Resource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <igtxt:WebNumericEdit ID="txtEvaluaPower" runat="server" SkinID="WebNumericEdit_Fix" DataMode="Int" MaxLength="10" MaxValue="9999" 
                                                                 MinValue="0" NullText="0" meta:resourcekey="txtEvaluaPowerResource1">
                                                            </igtxt:WebNumericEdit>
                                                        </td>
                                                    </tr>
                                                </table>
