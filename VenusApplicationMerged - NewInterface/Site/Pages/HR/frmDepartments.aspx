<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmDepartments.aspx.vb"
                                        ...
                                        <table style="width: 100%; height: 100%; min-height: 350px; vertical-align: top"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="LabelArea">
                                                                <asp:Label ID="lblParentBranch" runat="server" meta:resourcekey="lblParentBranchResource1"
                                                                    SkinID="Label_DefaultNormal" Text=" القطاع "></asp:Label>
                                                            </td>
                                                            <td class="DataArea">
                                                                <asp:DropDownList ID="ddl_Sectors" runat="server" SkinID="DropDownList_LargNormal"
                                                                    meta:resourcekey="ddl_SectorsResource1">
                                                                </asp:DropDownList>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                ...
                                                <td style="width: 47%; height: 16px; vertical-align: top">
                                                    <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                        <tr>
                                                            <td class="SeparArea"></td>
                                                            <td class="LabelArea">
                                                                <asp:Label ID="LblCostCenterCode" runat="server" Text=" كود مركز التكلفة" SkinID="Label_DefaultNormal"
                                                                    meta:resourcekey="lblCostCenterCode1"></asp:Label>
                                                            </td>
                                                            <td class="DataArea">
                                                                <asp:TextBox ID="TxtCostCenterCode" runat="server" SkinID="TextBox_LargeNormalrtl" MaxLength="255"
                                                                    meta:resourcekey="txtCostCenterCode1"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                        ...
                                                        <tr>
                                                            <td style="vertical-align: bottom">
                                                                <asp:Label ID="Label_Title1" runat="server" meta:resourcekey="Label_Title1Resource1"
                                                                    SkinID="Label_DefaultBold" Text="برجاء تحديد الفروع المرتبط بها هذا القسم"></asp:Label>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            ...
                                            <tr>
                                                <td style="height: 100%" colspan="3">
                                                    <igtbl:UltraWebGrid   Browser="UpLevel"  ID="uwgBranches" runat="server" EnableAppStyling="False" Height="100%"
                                                        Width="100%" SkinID="Default" meta:resourcekey="uwgBranchesResource1">
                                                        ...
                                                        <Bands>
                                                            <igtbl:UltraGridBand meta:resourcekey="UltraGridBandResource1">
                                                                <Columns>
                                                                    ...
                                                                    <igtbl:UltraGridColumn AllowUpdate="No" BaseColumnName="EngName" Key="EngName" meta:resourcekey="GridEngName"
                                                                        Width="45%">
                                                                        <Header Caption="Branch English Name">
                                                                    ...
                                                                    <igtbl:UltraGridColumn AllowUpdate="No" BaseColumnName="ArbName" Key="ArbName" meta:resourcekey="GridArbName"
                                                                        Width="45%">
                                                                        <Header Caption="Branch Arabic Name">
