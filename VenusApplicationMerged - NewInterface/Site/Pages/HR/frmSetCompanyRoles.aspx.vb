...
Partial Class frmSetCompanyRoles
    Inherits MainPage
#Region "Public Decleration"
    Private ClsCompanyRoles As Clssys_CompanyRoles
...
#Region "Protected Sub"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ClsCompanyRoles = New Clssys_CompanyRoles(Me.Page)
        Dim ClsObjects As New Clssys_Objects(Page)
        Dim ClsSearchs As New Clssys_Searchs(Page)
        Dim SearchID As Integer = 0
        Try
            Dim clsSearchsColumns As New Clssys_SearchsColumns(Page)
            If ClsObjects.Find(" Code='" & ClsCompanyRoles.Table.Trim & "'") Then
            ...
            If Not IsPostBack Then
                Page.Session.Add("ConnectionString", ClsCompanyRoles.ConnectionString)
                ClsCompanyRoles.AddOnChangeEventToControls("frmSetCompanyRoles", Page, UltraWebTab1)
                ...
                ClsCompanyRoles.GetDropDownList(ddl_MainLevel, True, "RoleLevel = 0")
            End If
            '================================== Add DateUpdateSchedules [Start]
            Dim IntrecordID As Integer
            If (txtCode.Text <> "") Then
                ClsCompanyRoles.Find(" Code='" & txtCode.Text & "'")
                IntrecordID = ClsCompanyRoles.ID
        ...
        Catch ex As Exception
            ...
            mErrorHandler.RecordExceptions_DataBase("", ex, Err.Number, ClsCompanyRoles.RegUserID, Venus.Shared.ErrorsHandler.eRecordingType.System_DataBase)
    ...
    Protected Sub ImageButton_Command(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.CommandEventArgs) Handles ImageButton_Save.Command, ImageButton_SaveN.Command, LinkButton_SaveN.Command, ImageButton_New.Command, ImageButton_Print.Command, ImageButton_Properties.Command, LinkButton_Properties.Command, ImageButton_Remarks.Command, LinkButton_Remarks.Command, ImageButton_Last.Command, ImageButton_Next.Command, ImageButton_Back.Command, ImageButton_First.Command, ImageButton_Delete.Command
        ...
        Dim ObjNavigationHandler As New Venus.Shared.Web.NavigationHandler(ClsCompanyRoles.ConnectionString)
        Select Case e.CommandArgument
            ...
            Case "New"
                AfterOperation()
            Case "Delete"
                ClsCompanyRoles.Delete("Code='" & txtCode.Text & "'")
                AfterOperation()
            Case "Property"
                ClsCompanyRoles.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmPropertyScreen.aspx?ID=" & ClsCompanyRoles.ID & "&TableName=" & ClsCompanyRoles.Table, 477, 313, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Property", False)
            Case "Remarks"
                ClsCompanyRoles.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmRemarks.aspx?ID=" & ClsCompanyRoles.ID & "&TableName=" & ClsCompanyRoles.Table, 410, 210, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Remarks", False)
            Case "Print"
            ...
            Case "First"
                ClsCompanyRoles.Find("Code='" & txtCode.Text & "'")
                ClsCompanyRoles.FirstRecord()
                GetValues(ClsCompanyRoles)
            Case "Previous"
                ClsCompanyRoles.Find("Code='" & txtCode.Text & "'")
                If Not ClsCompanyRoles.previousRecord() Then
                    ClsCompanyRoles.Find("Code='" & txtCode.Text & "'")
            ...
            Case "Next"
                ClsCompanyRoles.Find("Code='" & txtCode.Text & "'")
                If Not ClsCompanyRoles.NextRecord() Then
                    ClsCompanyRoles.Find("Code='" & txtCode.Text & "'")
...
#Region "Private Functions"
    Private Function SavePart() As Boolean
        Dim StrMode As String = Request.QueryString.Item("Mode")
        ClsCompanyRoles = New Clssys_CompanyRoles(Page)

        Try
            ClsCompanyRoles.Find("Code='" & txtCode.Text & "'")

            If ClsCompanyRoles.ID > 0 Then
                If Not AssignValue(ClsCompanyRoles) Then
                    Exit Function
                End If
                ClsCompanyRoles.Update("Code='" & txtCode.Text & "'")

            Else
                If Not AssignValue(ClsCompanyRoles) Then
                    Exit Function
                End If
                ClsCompanyRoles.Save()
            ...
            If ClsCompanyRoles.ID > 0 Then
                ...
                ClsObjects.Find("Code='" & ClsCompanyRoles.Table.ToString().Trim() & "'")
                    ...
                    If Not System.IO.File.Exists(StrRealPath & strFileName) Then
                        ...
                        If txtAttachedFile.FileName <> "" Then
                            If Not ClsDocumentAttachment.Find("Recordid=" & IntRecordId & " And ObjectID=" & ObjectID & " And IsImageView Is Null ") Then
                                AssignValueAttachment(ClsDocumentAttachment, ObjectID, IntRecordId)
            ...
            clsMainOtherFields.CollectDataAndSave(value.Text, ClsCompanyRoles.Table, ClsCompanyRoles.ID)
            value.Text = ""
            Return True
        Catch ex As Exception
            Return False
        End Try
    End Function
    Private Function AssignValueAttachment(ByRef ClsDocumentAttachment As Clssys_DocumentsInformationAttachments, ByVal objectid As Integer, ByVal recordid As Integer) As Boolean
        ClsDocumentAttachment.DbObject = objectid
        ClsDocumentAttachment.RecordId = recordid
        ...
        Return True
    End Function
    Private Function AssignValue(ByRef ClsCompanyRoles As Clssys_CompanyRoles) As Boolean
        Try
            With ClsCompanyRoles
                .Code = txtCode.Text
                .EngName = txtEngName.Text
                .ArbName = txtArbName.Text
                .ArbName4S = txtArbName.Text
                .RoleLevel = ddl_MainLevel.SelectedValue
                .RelatedForm = DropDownList_RelForms.SelectedValue
            End With
        ...
        End Try
    End Function
    Private Function GetValues(ByVal ClsCompanyRoles As Clssys_CompanyRoles) As Boolean
        ...
        Try
            ...
            With ClsCompanyRoles
                ...
                DropDownList_RelForms.SelectedValue = .RelatedForm

                .GetDropDownList(ddl_MainLevel, True, "RoleLevel = 0")
                ddl_MainLevel.SelectedValue = .RoleLevel
                ...
                If ClsDocumentAttachment.Find("RecordID=" & ClsCompanyRoles.ID & " And ObjectID= " & ClsObjects.ID & " And Isnull(CancelDate , '') = '' ") Then
                ...
                If Page.IsPostBack Then
                    CreateOtherFields(ClsCompanyRoles.ID)
                End If
            End With
            Return True
        Catch ex As Exception
    ...
    Private Function CheckCode() As Boolean
        ...
        Try
            ClsCompanyRoles.Find("Code='" & txtCode.Text & "'")
            IntId = ClsCompanyRoles.ID
            txtEngName.Focus()
            If ClsCompanyRoles.ID > 0 Then
                GetValues(ClsCompanyRoles)
                StrMode = "E"
            Else
                If ClsCompanyRoles.CheckRecordExistance(" Code='" & txtCode.Text & "'") Then
                    txtCode.Text = ""
                    txtCode.Focus()
                End If
                Clear()
            ...
            End If
            SetToolBarDefaults()
            SetToolBarPermission(Me, ClsCompanyRoles.ConnectionString, ClsCompanyRoles.DataBaseUserRelatedID, ClsCompanyRoles.GroupID, StrMode)
            SetToolBarRecordPermission(Me, ClsCompanyRoles.ConnectionString, ClsCompanyRoles.DataBaseUserRelatedID, ClsCompanyRoles.GroupID, ClsCompanyRoles.Table, IntId)
    ...
    Private Function Clear() As Boolean
        ...
        ddl_MainLevel.SelectedIndex = 0
        DropDownList_RelForms.SelectedValue = 0
        ImageButton_Delete.Enabled = False
        lblRegDateValue.Text = ""
        lblRegDateValue.Text = ""
        lblCancelDateValue.Text = ""
    ...
    Private Sub LoadDataUpdateSchedules(ByVal formName As String)
        ...
        ClsCompanyRoles = New Clssys_CompanyRoles(Me.Page)
        ClsCompanyRoles.Find(" code = '" & txtCode.Text & "'")
        Dim recordID As Integer = ClsCompanyRoles.ID
        If (recordID > 0) Then
    ...
    Private Function CreateOtherFields(ByVal IntRecordID As Integer)
        ...
        clsMainOtherFields = New clsSys_MainOtherFields(Me.Page)
        If clsMainOtherFields.CheckOtherFieldsButton(Me.Page, ClsCompanyRoles.Table) = True Then
            Dim StrTablename As String
            ClsCompanyRoles = New Clssys_CompanyRoles(Me)
            StrTablename = ClsCompanyRoles.Table
