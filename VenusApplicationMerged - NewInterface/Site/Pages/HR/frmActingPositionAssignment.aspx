...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function apaSwitchTab(idx) {
            var tab = igtab_getTabById('UltraWebTab1');
            if (tab) tab.setSelectedIndex(idx);
            $('.apa-tab').removeClass('active');
            $('.apa-tab[data-tab="' + idx + '"]').addClass('active');
            $('.apa-tab-panel').hide();
            $('#apaPanel' + idx).show();
            return false;
        }
    ...
    <style type="text/css">
        * { box-sizing: border-box; }
        ...
        .apa-wrap { padding: 12px 16px 20px; min-height: 100%; }
        .apa-toolbar {
            display: flex; align-items: center; flex-wrap: wrap; gap: 6px;
            background: #fff; border: 1px solid #d5e0ec; border-radius: 8px;
            padding: 8px 12px; margin-bottom: 14px;
        }
        .apa-toolbar .tb-spacer { flex: 1; }
        .apa-toolbar a, .apa-toolbar .tb-link {
            display: inline-flex; align-items: center; gap: 5px;
            color: #2c5282; text-decoration: none; font-size: 12px;
            padding: 4px 8px; border-radius: 4px;
        }
        .apa-toolbar a:hover { background: #eef5fc; }
        .apa-toolbar img { vertical-align: middle; }
        .apa-nav { display: inline-flex; gap: 2px; align-items: center; }

        .apa-header {
            display: flex; flex-wrap: wrap; align-items: flex-start;
            justify-content: space-between; gap: 16px; margin-bottom: 12px;
        }
        .apa-title-block { display: flex; align-items: flex-start; gap: 12px; min-width: 240px; flex: 1; }
        .apa-hero-icon {
        ...
        .apa-page-sub { font-size: 12px; color: #718096; margin: 0; line-height: 1.45; max-width: 420px; }
        ...
        .apa-status-active { color: #1e7e34; }
        .apa-status-active .apa-dot { background: #22c55e; }
        .apa-status-ended { color: #64748b; }
        .apa-status-ended .apa-dot { background: #94a3b8; }
        .apa-status-cancelled { color: #c0392b; }
        .apa-status-cancelled .apa-dot { background: #ef4444; }
        .apa-status-pending { color: #b45309; }
        .apa-status-pending .apa-dot { background: #f59e0b; }
        ...
        .apa-details-title { font-size: 16px; font-weight: 700; color: #1a365d; margin: 0; }
        .apa-details-sub { font-size: 12px; color: #718096; margin: 0 0 14px; }
        .apa-readonly-badge {
        ...
        .apa-section { margin-bottom: 18px; }
        .apa-section-head {
        ...
        .apa-field.full { flex: 1 1 100%; }
        .apa-field-label {
            display: block; font-size: 11px; color: #718096; margin-bottom: 4px;
        }
        .apa-field-value, .apa-field input[type=text], .apa-field textarea {
        ...
        .apa-field textarea { font-weight: 500 !important; min-height: 56px; resize: vertical; }
        .apa-hidden-ctrls { display: none !important; }
        ...
        .apa-tx-id { font-size: 13px; font-weight: 700; color: #1a365d; }
        .apa-badge {
            display: inline-flex; align-items: center; gap: 5px;
            border-radius: 12px; padding: 3px 10px; font-size: 11px; font-weight: 700;
        }
        .apa-badge-active { background: #e8f8ef; color: #1e7e34; border: 1px solid #a9dfbf; }
        .apa-badge-ended { background: #f1f5f9; color: #64748b; border: 1px solid #cbd5e1; }
        .apa-badge-cancelled { background: #fdecea; color: #c0392b; border: 1px solid #f5c6cb; }
        .apa-badge-pending { background: #fff7ed; color: #b45309; border: 1px solid #fcd34d; }

        .apa-timeline { position: relative; padding: 0 0 8px 0; margin: 0 0 14px; list-style: none; }
        .apa-timeline:before {
            content: ''; position: absolute; top: 8px; bottom: 8px;
            width: 2px; background: #dbe4ee;
        }
        [dir=ltr] .apa-timeline:before { left: 7px; }
        [dir=rtl] .apa-timeline:before { right: 7px; }
        .apa-timeline li {
            position: relative; padding-bottom: 14px;
        }
        [dir=ltr] .apa-timeline li { padding-left: 24px; }
        [dir=rtl] .apa-timeline li { padding-right: 24px; }
        .apa-timeline .tl-dot,
        span.tl-dot {
        ...
        [dir=ltr] .apa-timeline .tl-dot { left: 1px; }
        [dir=rtl] .apa-timeline .tl-dot { right: 1px; }
        .apa-timeline .tl-dot.green {
            background: #22c55e; box-shadow: 0 0 0 2px #22c55e;
        }
        .apa-timeline .tl-dot.grey {
            background: #94a3b8; box-shadow: 0 0 0 2px #94a3b8;
        }
        .apa-timeline .tl-dot.red {
        ...
        .apa-meta-list { margin: 0 0 12px; }
        .apa-meta-row {
            display: flex; justify-content: space-between; gap: 8px;
            padding: 6px 0; border-bottom: 1px solid #eef2f7; font-size: 12px;
        }
        .apa-meta-row .k { color: #718096; }
        .apa-meta-row .v { color: #1a365d; font-weight: 600; text-align: end; }
        ...
        .apa-records-sub { font-size: 11px; color: #718096; margin: 4px 0 0; }
        .apa-filters { display: flex; flex-wrap: wrap; gap: 8px; align-items: center; }
        .apa-filters input[type=text], .apa-filters select {
            border: 1px solid #c9d7e6; border-radius: 6px; padding: 7px 10px;
            font-size: 12px; color: #1a365d; background: #fff; min-width: 140px;
        }
        .apa-filters input[type=text] { min-width: 220px; }

        .apa-table-wrap { overflow-x: auto; border: 1px solid #e2e8f0; border-radius: 8px; }
        .apa-table {
        ...
        .apa-table tr:nth-child(even) td { background: #f8fbfe; }
        .apa-table tr:hover td { background: #eef6fc; }
        .apa-cell-main { font-weight: 600; }
        .apa-cell-sub { display: block; font-size: 11px; color: #718096; font-weight: 400; margin-top: 2px; }
        .apa-view-btn {
            display: inline-flex; align-items: center; gap: 5px;
        ...
        .apa-view-btn:hover { background: #eef6fc; }
        .apa-empty {
            text-align: center; padding: 28px; color: #718096; font-size: 13px;
        }

        .apa-ig-tab-host { display: none !important; height: 0; overflow: hidden; }

        @media (max-width: 900px) {
            .apa-sidebar { flex: 1 1 100%; width: 100%; }
            .apa-filters input[type=text] { min-width: 160px; }
        }
    </style>
</head>
<body style="height:100%; margin:0; padding:0">
<form id="frmActingPositionAssignment" runat="server">
<div id="DIV" runat="server" class="Div_MasterContainer apa-wrap">

    <!-- Toolbar -->
    <div class="apa-toolbar">
    ...
    <div class="apa-header">
        <div class="apa-title-block">
            <div class="apa-hero-icon" aria-hidden="true"></div>
            <div>
                <h1 class="apa-page-title"><asp:Label ID="Label_Header" runat="server" Text="Position Acting Assignment" meta:resourcekey="Label_HeaderResource1" /></h1>
                <p class="apa-page-sub"><asp:Label ID="lblSubtitle" runat="server" Text="View acting assignment details, effective period, status, and registration information." meta:resourcekey="lblSubtitleResource1" /></p>
            </div>
        </div>
        <div class="apa-summary">
            <div class="apa-summary-card">
            ...
            <div class="apa-summary-card">
                ...
                <span class="val">
                    <asp:Panel ID="spanSummaryStatus" runat="server" CssClass="apa-status-pill apa-status-active" style="display:inline-flex;align-items:center;gap:6px;">
                        <span class="apa-dot"></span>
    ...
    <!-- Custom tabs -->
    <div class="apa-tabs">
        <a href="#" class="apa-tab active" data-tab="0" onclick="return apaSwitchTab(0);">
            <asp:Literal ID="litTabGeneral" runat="server" Text="General" meta:resourcekey="TabResource1" />
        </a>
        <a href="#" class="apa-tab" data-tab="1" onclick="return apaSwitchTab(1);">
    ...
    <asp:Panel ID="pnlHiddenData" runat="server" CssClass="apa-hidden-ctrls" style="display:none;">
        ...
        <asp:Label ID="lblOriginalPosition" runat="server" Text="Assigned Position" meta:resourcekey="lblOriginalPositionResource1" />
        <asp:TextBox ID="txtOriginalPosition" runat="server" Width="145px" AutoPostBack="True" MaxLength="30" Enabled="False" />
        <igtxt:WebImageButton ID="btnOriginalPositionSearch" runat="server" AutoSubmit="False" Width="24px" Height="18px" Enabled="False"><Appearance><Image Url="./Img/forum_search.gif" /></Appearance></igtxt:WebImageButton>
        <asp:TextBox ID="txtOriginalPositionName" runat="server" Width="255px" CssClass="readonly" ReadOnly="True" Enabled="False" />
    ...
    <!-- General panel -->
    <div id="apaPanel0" class="apa-tab-panel">
        <div class="apa-main-grid">
            <!-- Assignment details -->
            <div class="apa-details">
                <div class="apa-details-head">
                    <h2 class="apa-details-title"><asp:Literal ID="litDetailsTitle" runat="server" Text="Assignment Details" meta:resourcekey="litDetailsTitleResource1" /></h2>
                    <span class="apa-readonly-badge"><asp:Literal ID="litReadonly" runat="server" Text="Read-only" meta:resourcekey="litReadonlyResource1" /></span>
                </div>
                <p class="apa-details-sub"><asp:Literal ID="litDetailsSub" runat="server" Text="This screen is read-only. Information is displayed for review and reference." meta:resourcekey="litDetailsSubResource1" /></p>

                <!-- Position Information -->
                <div class="apa-section">
                    <div class="apa-section-head">
                        <span class="apa-section-icon">P</span>
                        <asp:Literal ID="litSecPosition" runat="server" Text="Position Information" meta:resourcekey="litSecPositionResource1" />
                    </div>
                    <div class="apa-fields-row">
                        <div class="apa-field">
                            <span class="apa-field-label"><asp:Literal ID="litFldPosition" runat="server" Text="Assigned Position" meta:resourcekey="lblOriginalPositionResource1" /></span>
                            <asp:Label ID="lblPositionDisplay" runat="server" CssClass="apa-field-value" Text="—" />
                        </div>
                        <div class="apa-field">
                            <span class="apa-field-label"><asp:Literal ID="litFldDept" runat="server" Text="Department" meta:resourcekey="litFldDeptResource1" /></span>
                            <asp:Label ID="lblDepartmentDisplay" runat="server" CssClass="apa-field-value" Text="—" />
                        </div>
                        <div class="apa-field">
                            <span class="apa-field-label"><asp:Literal ID="litFldReportsTo" runat="server" Text="Reports To" meta:resourcekey="litFldReportsToResource1" /></span>
                            <asp:Label ID="lblReportsToDisplay" runat="server" CssClass="apa-field-value" Text="—" />
                        </div>
                    </div>
                </div>
                ...
                <div class="apa-section">
                    <div class="apa-section-head">
                        <span class="apa-section-icon">E</span>
                        <asp:Literal ID="litSecEmployee" runat="server" Text="Acting Employee Information" meta:resourcekey="litSecEmployeeResource1" />
                    </div>
                    <div class="apa-fields-row">
                        <div class="apa-field">
                            <span class="apa-field-label"><asp:Literal ID="litFldEmployee" runat="server" Text="Acting Employee" meta:resourcekey="lblActingEmployeeResource1" /></span>
                            <asp:Label ID="lblEmployeeDisplay" runat="server" CssClass="apa-field-value" Text="—" />
                        </div>
                        <div class="apa-field">
                            <span class="apa-field-label"><asp:Literal ID="litFldCurrPos" runat="server" Text="Current Position" meta:resourcekey="litFldCurrPosResource1" /></span>
                            <asp:Label ID="lblCurrentPositionDisplay" runat="server" CssClass="apa-field-value" Text="—" />
                        </div>
                        <div class="apa-field">
                            <span class="apa-field-label"><asp:Literal ID="litFldEmpDept" runat="server" Text="Employee Department" meta:resourcekey="litFldEmpDeptResource1" /></span>
                            <asp:Label ID="lblEmpDepartmentDisplay" runat="server" CssClass="apa-field-value" Text="—" />
                        </div>
                    </div>
                </div>
                ...
                <div class="apa-section">
                    <div class="apa-section-head">
                        <span class="apa-section-icon">D</span>
                        <asp:Literal ID="litSecPeriod" runat="server" Text="Effective Period" meta:resourcekey="litSecPeriodResource1" />
                    </div>
                    <div class="apa-fields-row">
                        <div class="apa-field">
                            <span class="apa-field-label"><asp:Literal ID="litFldStart" runat="server" Text="Acting Start Date" meta:resourcekey="lblEffectiveFromResource1" /></span>
                            <asp:Label ID="lblStartDisplay" runat="server" CssClass="apa-field-value" Text="—" />
                        </div>
                        <div class="apa-field">
                            <span class="apa-field-label"><asp:Literal ID="litFldEnd" runat="server" Text="Acting End Date" meta:resourcekey="lblEffectiveToResource1" /></span>
                            <asp:Label ID="lblEndDisplay" runat="server" CssClass="apa-field-value" Text="—" />
                        </div>
                        <div class="apa-field">
                            <span class="apa-field-label"><asp:Literal ID="litFldDuration" runat="server" Text="Assignment Duration" meta:resourcekey="litFldDurationResource1" /></span>
                            <asp:Label ID="lblDurationDisplay" runat="server" CssClass="apa-field-value" Text="—" />
                        </div>
                    </div>
                </div>

                <!-- Reason and Remarks -->
                <div class="apa-section" style="margin-bottom:0">
                    <div class="apa-section-head">
                        <span class="apa-section-icon">R</span>
                        <asp:Literal ID="litSecReason" runat="server" Text="Reason and Remarks" meta:resourcekey="litSecReasonResource1" />
                    </div>
                    <div class="apa-fields-row" style="margin-bottom:10px">
                        <div class="apa-field full">
                            <span class="apa-field-label"><asp:Literal ID="litFldReason" runat="server" Text="Acting Reason" meta:resourcekey="lblReasonResource1" /></span>
                            <asp:Label ID="lblReasonDisplay" runat="server" CssClass="apa-field-value" Text="—" />
                        </div>
                    </div>
                    <div class="apa-fields-row">
                        <div class="apa-field full">
                            <span class="apa-field-label"><asp:Literal ID="litFldRemarks" runat="server" Text="Remarks" meta:resourcekey="lblRemarksResource1" /></span>
                            <asp:Label ID="lblRemarksDisplay" runat="server" CssClass="apa-field-value" Text="—" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="apa-sidebar">
                ...
                <div class="apa-tx-row">
                    ...
                    <asp:Label ID="lblSidebarBadge" runat="server" CssClass="apa-badge apa-badge-active" Text="—" />
                </div>

                <ul class="apa-timeline">
                    <li>
                ...
                <div class="apa-meta-list">
                    <div class="apa-meta-row">
        ...
        <!-- Records table -->
        <div class="apa-records">
            <div class="apa-records-head">
                <div>
                    <h3 class="apa-records-title">
                        <span class="apa-section-icon">T</span>
                        <asp:Literal ID="litRecordsTitle" runat="server" Text="Acting Assignment Records" meta:resourcekey="litRecordsTitleResource1" />
                    </h3>
                    <p class="apa-records-sub"><asp:Literal ID="litRecordsSub" runat="server" Text="Browse and open acting assignment transactions." meta:resourcekey="litRecordsSubResource1" /></p>
                </div>
            ...
            <asp:Panel ID="pnlGridTable" runat="server" CssClass="apa-table-wrap">
                <table class="apa-table">
                    <thead>
                        <tr>
                            ...
                            <th><asp:Literal ID="litColPosition" runat="server" Text="Assigned Position" meta:resourcekey="litColPositionResource1" /></th>
                            <th><asp:Literal ID="litColEmployee" runat="server" Text="Acting Employee" meta:resourcekey="litColEmployeeResource1" /></th>
                ...
                <asp:Repeater ID="rptAssignments" runat="server">
                    <ItemTemplate>
                                <tr>
                                    <td class="apa-cell-main"><%# Eval("Code") %></td>
                                    <td>
                                        <span class="apa-cell-main"><%# Eval("PositionTitle") %></span>
                                        <span class="apa-cell-sub"><%# Eval("PositionDept") %></span>
                                    </td>
                                    <td>
                                        <span class="apa-cell-main"><%# Eval("EmployeeDisplay") %></span>
                                        <span class="apa-cell-sub"><%# Eval("EmployeePosition") %></span>
                                    </td>
                                    <td><%# Eval("StartText") %></td>
                                    <td><%# Eval("EndText") %></td>
                                    <td><%# Eval("Reason") %></td>
                                    <td>
                                        <span class='apa-status-pill <%# Eval("StatusCss") %>'>
                                            <span class="apa-dot"></span><%# Eval("StatusText") %>
                                        </span>
                                    </td>
                                    <td>
                                        <asp:LinkButton ID="btnView" runat="server" CssClass="apa-view-btn"
                ...
                <asp:Panel ID="pnlEmptyGrid" runat="server" Visible="False" CssClass="apa-empty">
                    <asp:Literal ID="litEmptyGrid" runat="server" Text="No acting assignment records found." meta:resourcekey="litEmptyGridResource1" />
                </asp:Panel>
        </div>
    </div>

    <!-- Audit Trail panel -->
    <div id="apaPanel1" class="apa-tab-panel" style="display:none">
        <div class="apa-details">
            <div class="apa-details-head">
                <h2 class="apa-details-title"><asp:Literal ID="litAuditTitle" runat="server" Text="Audit Trail" meta:resourcekey="TabAuditResource1" /></h2>
            </div>
            <p class="apa-details-sub"><asp:Literal ID="litAuditSub" runat="server" Text="Registration and status milestones for this transaction." meta:resourcekey="litAuditSubResource1" /></p>
            <ul class="apa-timeline" style="max-width:480px">
                <li>
                    <span class="tl-dot"></span>
