<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmAnnualVacationsRequest.aspx.vb"
                                                ...
                                                <td style="height: 100%; vertical-align: top" colspan="3">
                                                    <igtbl:UltraWebGrid  Browser="UpLevel" ID="uwgEmployeeVacations" runat="server" EnableAppStyling="False"
                                                        ...
                                                        <DisplayLayout AllowColSizingDefault="Free" AllowColumnMovingDefault="OnServer" AllowSortingDefault="OnClient"
                                                            ...
                                                            HeaderClickActionDefault="SortSingle" Name="uwgEmployeeVacations" RowHeightDefault="15px"
                                                          ...
                                                          <ClientSideEvents AfterCellUpdateHandler="uwg_AfterCellUpdateHandler"   ClickCellButtonHandler="uwgEmployeeVacations_ClickCellButtonHandler" />
