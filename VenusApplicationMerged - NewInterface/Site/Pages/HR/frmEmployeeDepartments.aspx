<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmEmployeeDepartments.aspx.vb"
    Inherits="frmEmployeeDepartments" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
...
<head runat="server">
    <title>* Venus Payroll * ~ Employee Departments</title>
<meta charset="UTF-8">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <igtbl:UltraWebGrid  Browser="UpLevel"   autopostback="true" ID="UwgSearchEmployees" runat="server" EnableAppStyling="True"
                                                                Height="450px" meta:resourcekey="uwgForNationalityResource1" SkinID="Default"
                                                                Width="100%">
                                                                ...
                                                                <Bands>
                                                                    <igtbl:UltraGridBand AllowSorting="No" meta:resourcekey="UltraGridBandResource1"
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <igtbl:UltraGridColumn BaseColumnName="DepartmentID" Key="DepartmentID" Hidden="True">
                                                                                <Header Caption="">
                                                                                </Header>
                                                                            </igtbl:UltraGridColumn>
                                                                            
                                                                            <igtbl:UltraGridColumn AllowUpdate="No" BaseColumnName="DepartmentCode" Key="DepartmentCode"
                                                                                meta:resourcekey="UltraGridColumnDepartmentCode" Width="20%">
                                                                             ...
                                                                             <igtbl:UltraGridColumn AllowUpdate="No" BaseColumnName="DepartmentName" Key="DepartmentName"
                                                                                meta:resourcekey="UltraGridColumnDepartmentName" Width="70%">
