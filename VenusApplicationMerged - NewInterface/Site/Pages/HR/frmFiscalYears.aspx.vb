...
#Region "Protected Sub"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If ClsObjects.Find(" Code='" & ClsFiscalYears.Table.Trim & "'") Then
            ...
            If Not IsPostBack Then
                ...
                ClsFiscalYears.AddOnChangeEventToControls("frmFiscalYears", Page, UltraWebTab1)
            ...
            If (txtCode.Text <> "") Then
                ClsFiscalYears.Find(" Code='" & txtCode.Text & "'")
                IntrecordID = ClsFiscalYears.ID
    ...
    Protected Sub ImageButton_Command(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.CommandEventArgs) Handles ImageButton_Save.Command, ImageButton_SaveN.Command, LinkButton_SaveN.Command, ImageButton_New.Command, ImageButton_Print.Command, ImageButton_Properties.Command, LinkButton_Properties.Command, ImageButton_Remarks.Command, LinkButton_Remarks.Command, ImageButton_Last.Command, ImageButton_Next.Command, ImageButton_Back.Command, ImageButton_First.Command, ImageButton_Delete.Command
        ...
        Select Case e.CommandArgument
            ...
            Case "New"
                AfterOperation()
            Case "Delete"
                clsFiscalYearsPeriods.Find("FiscalYearID=" & ClsFiscalYears.ID)
                If (clsFiscalYearsPeriods.DataSet.Tables(0).Rows.Count > 0) Then
                    Venus.Shared.Web.ClientSideActions.MsgBoxBasic(Page, " This Fiscal Year has Child Periods")
                    Return
                End If
                If (ClsFiscalYears.ID > 0) Then
                Else
                    Venus.Shared.Web.ClientSideActions.MsgBoxBasic(Page, " Fiscal Year Not Found ")
                    Exit Sub
                End If
                clsFiscalYearsPeriods.Delete("FiscalYearID =" & ClsFiscalYears.ID)
                ClsFiscalYears.Delete("Code='" & txtCode.Text & "'")
                AfterOperation()
            Case "Property"
                If ClsFiscalYears.Find("Code='" & txtCode.Text & "'") Then
                    Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmPropertyScreen.aspx?ID=" & ClsFiscalYears.ID & "&TableName=" & ClsFiscalYears.Table, 477, 313, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Property", False)
                End If
            Case "Remarks"
                If ClsFiscalYears.Find("Code='" & txtCode.Text & "'") Then
                    Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmRemarks.aspx?ID=" & ClsFiscalYears.ID & "&TableName=" & ClsFiscalYears.Table, 410, 210, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Remarks", False)
                End If
            ...
            Case "First"
                ...
                GetValues(ClsFiscalYears)
            Case "Previous"
                ClsFiscalYears.Find("Code='" & txtCode.Text & "'")
                If Not ClsFiscalYears.previousRecord() Then
                    ClsFiscalYears.Find("Code='" & txtCode.Text & "'")
            ...
            Case "Next"
                ClsFiscalYears.Find("Code='" & txtCode.Text & "'")
                If Not ClsFiscalYears.NextRecord() Then
                    ClsFiscalYears.Find("Code='" & txtCode.Text & "'")
...
#Region "Private Functions"
    Private Function SavePart() As Boolean
        ...
        Try
            ...
            If ClsFiscalYears.ID > 0 Then
                If Not AssignValue(ClsFiscalYears) Then
                    Exit Function
                End If
                ClsFiscalYears.Update("Code='" & txtCode.Text & "'")
            ...
            clsMainOtherFields.CollectDataAndSave(value.Text, ClsFiscalYears.Table, ClsFiscalYears.ID)
            value.Text = ""
            Return True
        Catch ex As Exception
            Return False
        End Try
    End Function
    Private Function AssignValue(ByRef ClsFiscalYears As Clssys_FiscalYears) As Boolean
        Try
            With ClsFiscalYears
                .Code = txtCode.Text
        ...
        End Try
    End Function
    Private Function GetValues(ByVal ClsFiscalYears As Clssys_FiscalYears) As Boolean
    ...
    Private Function CheckCode() As Boolean
        ...
        Try
            ClsFiscalYears.Find("Code='" & txtCode.Text & "'")
            IntId = ClsFiscalYears.ID
            txtEngName.Focus()
            If ClsFiscalYears.ID > 0 Then
                GetValues(ClsFiscalYears)
                StrMode = "E"
            Else
                If ClsFiscalYears.CheckRecordExistance(" Code='" & txtCode.Text & "'") Then
                    txtCode.Text = ""
                    txtCode.Focus()
                End If
            ...
            End If
            SetToolBarDefaults()
            SetToolBarPermission(Me, ClsFiscalYears.ConnectionString, ClsFiscalYears.DataBaseUserRelatedID, ClsFiscalYears.GroupID, StrMode)
            SetToolBarRecordPermission(Me, ClsFiscalYears.ConnectionString, ClsFiscalYears.DataBaseUserRelatedID, ClsFiscalYears.GroupID, ClsFiscalYears.Table, IntId)
    ...
    Private Function CreateOtherFields(ByVal IntRecordID As Integer)
        ...
        If clsMainOtherFields.CheckOtherFieldsButton(Me.Page, ClsFiscalYears.Table) = True Then
            Dim StrTablename As String
            ClsFiscalYears = New Clssys_FiscalYears(Me)
            StrTablename = ClsFiscalYears.Table
