<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmAdvancedSalaryRequestNew.aspx.vb"
    Inherits="FrmAdvancedSalaryRequestNew" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
...
<head runat="server">
    <title>* Venus Payroll * ~ Advance Request</title>
    ...
    <script type="text/javascript" id="igClientScript">
        ...
        function OpenPrintedScreen(v) {
            ...
            var win = window.open("../../Interfaces/frmReportsGridViewer.aspx?Language=false&Criteria=RequestSerial&preview=1&ReportCode=CF_132&sq0=''&v=" + v, "_NEW", "height=" + hight + ",width=" + width + ",resizable=0,menubar=0,toolbar=0,location=0,directories=0,scrollbars=0,status=0,center=0");
            win.focus();
        }
    </script>
    <style type="text/css">
            ...
            <tr>
                <td class="Details">
                    <igtab:UltraWebTab ID="UltraWebTab1" runat="server" EnableAppStyling="True" SkinID="Default"
                        ...
                        <Tabs>
                            <igtab:Tab Text="Advance Housing Request" meta:resourcekey="TabResource1">
                                <ContentTemplate>
    ...
    <td class="DataArea">
        <%--<igsch:WebDateChooser ID="WebDateChooser2" runat="server" BorderColor="#CCCCCC" BorderStyle="Solid"
            ...
            <AutoPostBack ValueChanged="True" />
                                        ...
                                        <tr>
             <td style="width: 40%; height: 16px; vertical-align: top">
                 <table style="width: 91%; vertical-align: top" cellspacing="0">
                     <tr>
                         ...
                         <td class="LabelArea" style="min-width: 90px;">
                             <asp:Label ID="lblInstallmentDate" runat="server" Text="Installment Start Date" SkinID="Label_DefaultNormal"
                                 meta:resourcekey="lblInstallmentDateResource1"></asp:Label>
                         </td>
                      
                  
           
                         <td class="DataArea">
                            <igsch:WebDateChooser ID="InstallmentDate" runat="server" BorderColor="#CCCCCC" BorderStyle="Solid"
                                 BorderWidth="1px" Height="18px" NullDateLabel="" Style="font-family: Tahoma;
                                 font-size: 8pt; font-weight: Normal; color: Black; border: solid 1px #CCCCCC"
                                 Width="130px">
                             </igsch:WebDateChooser>
                          ...
                          <td class="LabelArea" style="min-width: 90px;">
                             <asp:Label ID="lblInstallments" runat="server" Text="عدد الأقساط" SkinID="Label_DefaultNormal"
                                 meta:resourcekey="lblInstallmentsNoResource1"></asp:Label>
                         </td>
                      
                  
           
                         <td class="DataArea">
                             <asp:TextBox ID="txtInstallmentsNo" runat="server" SkinID="TextBox_SmalltNormalC" MaxLength="30"
                                 AutoPostBack="False" ReadOnly="False"  meta:resourcekey="txtInstallmentsNoResource1" onkeypress="return isNumberKey(event)">
                            </asp:TextBox>
                             </td>
