...
#Region "Private Functions"
        ...
        Try
            ...
            If ddlStatus.SelectedValue = 2 Then  'رفض
                ...
                ElseIf DdlRequestType.SelectedValue.Trim() = "SS_0013" Then
                    If DdlYear.SelectedValue > 0 And DdlMonth.SelectedValue = 0 Then
                        str1 = "select distinct(SS_VacationRequest.ID),SS_VacationRequest.VacationType ,SS_VacationRequest.Code as RequestSerial ,SS_VacationRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_VacationRequest.RequestDate,SS_VacationRequest.VacationType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName0 & "' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName & "' else  " & vacationName2 & "  end as RequestType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then 'SS_0011' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then 'SS_0012' when SS_VacationRequest.VacationType='SS_0018' then 'SS_0018' else  'SS_0013'  end as FormCode from SS_VacationRequest join hrs_Employees on SS_VacationRequest.EmployeeID=hrs_Employees.id join hrs_VacationsTypes on SS_VacationRequest.VacationTypeID= hrs_VacationsTypes.ID join SS_RequestActions on SS_RequestActions.RequestSerial= SS_VacationRequest.ID and (SS_RequestActions.FormCode='SS_0011' or SS_RequestActions.FormCode='SS_0012' or SS_RequestActions.FormCode='SS_0013') where year(Requestdate)=" & DdlYear.SelectedValue & " and SS_VacationRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID is not null and SS_RequestActions.ActionID=2 and VacationType='SS_0013' Order By SS_VacationRequest.RequestDate desc"
                ...
                ElseIf DdlRequestType.SelectedValue.Trim() = "SS_0014" Then
                    If DdlYear.SelectedValue > 0 And DdlMonth.SelectedValue = 0 Then
                        str1 = "select Distinct(SS_ExecuseRequest.ID),'4' as VacationType,SS_ExecuseRequest.Code as RequestSerial ,SS_ExecuseRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_ExecuseRequest.RequestDate,'', '" & permName & "'  as RequestType ,'SS_0014' as FormCode from SS_ExecuseRequest join hrs_Employees on SS_ExecuseRequest.EmployeeID=hrs_Employees.id join SS_RequestActions on SS_RequestActions.RequestSerial= SS_ExecuseRequest.ID and (SS_RequestActions.FormCode='SS_0014') where year(Requestdate)=" & DdlYear.SelectedValue & " and SS_ExecuseRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID is not null and SS_RequestActions.ActionID=2 Order By SS_ExecuseRequest.RequestDate desc"
                    ElseIf DdlYear.SelectedValue > 0 And DdlMonth.SelectedValue > 0 Then
                        str1 = "select Distinct(SS_ExecuseRequest.ID),'4' as VacationType,SS_ExecuseRequest.Code as RequestSerial ,SS_ExecuseRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_ExecuseRequest.RequestDate,'', '" & permName & "'  as RequestType ,'SS_0014' as FormCode from SS_ExecuseRequest join hrs_Employees on SS_ExecuseRequest.EmployeeID=hrs_Employees.id join SS_RequestActions on SS_RequestActions.RequestSerial= SS_ExecuseRequest.ID and (SS_RequestActions.FormCode='SS_0014') where year(Requestdate)=" & DdlYear.SelectedValue & " And Month(SS_VacationRequest.RequestDate)=" & DdlMonth.SelectedValue & "  and SS_ExecuseRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID is not null and SS_RequestActions.ActionID=2 Order By SS_ExecuseRequest.RequestDate desc"
                    ElseIf DdlYear.SelectedValue = 0 And DdlMonth.SelectedValue = 0 Then
                        str1 = "select Distinct(SS_ExecuseRequest.ID),'4' as VacationType,SS_ExecuseRequest.Code as RequestSerial ,SS_ExecuseRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_ExecuseRequest.RequestDate,'', '" & permName & "'  as RequestType ,'SS_0014' as FormCode from SS_ExecuseRequest join hrs_Employees on SS_ExecuseRequest.EmployeeID=hrs_Employees.id join SS_RequestActions on SS_RequestActions.RequestSerial= SS_ExecuseRequest.ID and (SS_RequestActions.FormCode='SS_0014') where year(Requestdate)=year(GETDATE()) and SS_ExecuseRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID is not null and SS_RequestActions.ActionID=2 Order By SS_ExecuseRequest.RequestDate desc"
                    End If

                ElseIf DdlRequestType.SelectedValue.Trim() = "SS_0015" Then
                    If DdlYear.SelectedValue > 0 And DdlMonth.SelectedValue = 0 Then
                        str1 = "select SS_EndOfServiceRequest.ID,'5' as VacationType,SS_EndOfServiceRequest.Code as RequestSerial ,SS_EndOfServiceRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_EndOfServiceRequest.RequestDate,'', case when SS_EndOfServiceRequest.FormCode='SS_0015' then '" & ServiceName & "' else '" & mServiceName & "' end  as RequestType ,SS_EndOfServiceRequest.FormCode as FormCode from SS_EndOfServiceRequest join hrs_Employees on SS_EndOfServiceRequest.EmployeeID=hrs_Employees.id join SS_RequestActions on SS_RequestActions.RequestSerial= SS_EndOfServiceRequest.ID and (SS_RequestActions.FormCode='SS_0015')  where year(Requestdate)=" & DdlYear.SelectedValue & "  and SS_EndOfServiceRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID is not null and SS_RequestActions.ActionID=2 Order By SS_EndOfServiceRequest.RequestDate desc"
                    ElseIf DdlYear.SelectedValue > 0 And DdlMonth.SelectedValue > 0 Then
                        str1 = "select SS_EndOfServiceRequest.ID,'5' as VacationType,SS_EndOfServiceRequest.Code as RequestSerial ,SS_EndOfServiceRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_EndOfServiceRequest.RequestDate,'', case when SS_EndOfServiceRequest.FormCode='SS_0015' then '" & ServiceName & "' else '" & mServiceName & "' end  as RequestType ,SS_EndOfServiceRequest.FormCode as FormCode from SS_EndOfServiceRequest join hrs_Employees on SS_EndOfServiceRequest.EmployeeID=hrs_Employees.id join SS_RequestActions on SS_RequestActions.RequestSerial= SS_EndOfServiceRequest.ID and (SS_RequestActions.FormCode='SS_0015')  where year(Requestdate)=" & DdlYear.SelectedValue & " And Month(SS_VacationRequest.RequestDate)=" & DdlMonth.SelectedValue & "   and SS_EndOfServiceRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID is not null and SS_RequestActions.ActionID=2 Order By SS_EndOfServiceRequest.RequestDate desc"
                    ElseIf DdlYear.SelectedValue = 0 And DdlMonth.SelectedValue = 0 Then
                        str1 = "select SS_EndOfServiceRequest.ID,'5' as VacationType,SS_EndOfServiceRequest.Code as RequestSerial ,SS_EndOfServiceRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_EndOfServiceRequest.RequestDate,'', case when SS_EndOfServiceRequest.FormCode='SS_0015' then '" & ServiceName & "' else '" & mServiceName & "' end  as RequestType ,SS_EndOfServiceRequest.FormCode as FormCode from SS_EndOfServiceRequest join hrs_Employees on SS_EndOfServiceRequest.EmployeeID=hrs_Employees.id join SS_RequestActions on SS_RequestActions.RequestSerial= SS_EndOfServiceRequest.ID and (SS_RequestActions.FormCode='SS_0015')  where year(Requestdate)=year(GETDATE()) and SS_EndOfServiceRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID is not null and SS_RequestActions.ActionID=2 Order By SS_EndOfServiceRequest.RequestDate desc"
                    End If
                ElseIf DdlRequestType.SelectedValue = 0 Then
                    str1 = "select distinct(SS_VacationRequest.ID),SS_VacationRequest.VacationType ,SS_VacationRequest.Code as RequestSerial ,SS_VacationRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_VacationRequest.RequestDate,SS_VacationRequest.VacationType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName0 & "' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName & "' else  " & vacationName2 & "  end as RequestType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then 'SS_0011' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then 'SS_0012' when SS_VacationRequest.VacationType='SS_0018' then 'SS_0018' else  'SS_0013'  end as FormCode from SS_VacationRequest join hrs_Employees on SS_VacationRequest.EmployeeID=hrs_Employees.id join hrs_VacationsTypes on SS_VacationRequest.VacationTypeID= hrs_VacationsTypes.ID join SS_RequestActions on SS_RequestActions.RequestSerial= SS_VacationRequest.ID and (SS_RequestActions.FormCode='SS_0011' or SS_RequestActions.FormCode='SS_0012' or SS_RequestActions.FormCode='SS_0013') where year(Requestdate)=year(GETDATE()) and SS_VacationRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID is not null and SS_RequestActions.ActionID=2  union select SS_ExecuseRequest.ID,'4' as VacationType,SS_ExecuseRequest.Code as RequestSerial ,SS_ExecuseRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_ExecuseRequest.RequestDate,'', '" & permName & "'  as RequestType ,'SS_0014' as FormCode from SS_ExecuseRequest join hrs_Employees on SS_ExecuseRequest.EmployeeID=hrs_Employees.id join SS_RequestActions on SS_RequestActions.RequestSerial= SS_ExecuseRequest.ID and (SS_RequestActions.FormCode='SS_0014') where year(Requestdate)=year(GETDATE()) and SS_ExecuseRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID is not null and SS_RequestActions.ActionID=2 union select SS_EndOfServiceRequest.ID,'5' as VacationType,SS_EndOfServiceRequest.Code as RequestSerial ,SS_EndOfServiceRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_EndOfServiceRequest.RequestDate,'', case when SS_EndOfServiceRequest.FormCode='SS_0015' then '" & ServiceName & "' else '" & mServiceName & "' end  as RequestType ,SS_EndOfServiceRequest.FormCode as FormCode from SS_EndOfServiceRequest join hrs_Employees on SS_EndOfServiceRequest.EmployeeID=hrs_Employees.id join SS_RequestActions on SS_RequestActions.RequestSerial= SS_EndOfServiceRequest.ID and (SS_RequestActions.FormCode='SS_0015')  where year(Requestdate)=year(GETDATE()) and SS_EndOfServiceRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID is not null and SS_RequestActions.ActionID=2 Order By SS_VacationRequest.RequestDate desc"
                End If
                'str1 = "select distinct(SS_VacationRequest.ID),SS_VacationRequest.VacationType ,SS_VacationRequest.Code as RequestSerial ,SS_VacationRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_VacationRequest.RequestDate,SS_VacationRequest.VacationType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then '"& vacationName0 &"' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then '"& vacationName &"' else  "& vacationName2 &"  end as RequestType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then 'SS_0011' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then 'SS_0012' when SS_VacationRequest.VacationType='SS_0018' then 'SS_0018' else  'SS_0013'  end as FormCode from SS_VacationRequest join hrs_Employees on SS_VacationRequest.EmployeeID=hrs_Employees.id join hrs_VacationsTypes on SS_VacationRequest.VacationTypeID= hrs_VacationsTypes.ID join SS_RequestActions on SS_RequestActions.RequestSerial= SS_VacationRequest.ID and (SS_RequestActions.FormCode='SS_0011' or SS_RequestActions.FormCode='SS_0012' or SS_RequestActions.FormCode='SS_0013') where year(Requestdate)=year(GETDATE()) and SS_VacationRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID is not null and SS_RequestActions.ActionID=2  union select SS_ExecuseRequest.ID,'4' as VacationType,SS_ExecuseRequest.Code as RequestSerial ,SS_ExecuseRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_ExecuseRequest.RequestDate,'', '"& permName &"'  as RequestType ,'SS_0014' as FormCode from SS_ExecuseRequest join hrs_Employees on SS_ExecuseRequest.EmployeeID=hrs_Employees.id join SS_RequestActions on SS_RequestActions.RequestSerial= SS_ExecuseRequest.ID and (SS_RequestActions.FormCode='SS_0014') where year(Requestdate)=year(GETDATE()) and SS_ExecuseRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID is not null and SS_RequestActions.ActionID=2 union select SS_EndOfServiceRequest.ID,'5' as VacationType,SS_EndOfServiceRequest.Code as RequestSerial ,SS_EndOfServiceRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_EndOfServiceRequest.RequestDate,'', case when SS_EndOfServiceRequest.FormCode='SS_0015' then '"& ServiceName &"' else '"& mServiceName &"' end  as RequestType ,SS_EndOfServiceRequest.FormCode as FormCode from SS_EndOfServiceRequest join hrs_Employees on SS_EndOfServiceRequest.EmployeeID=hrs_Employees.id join SS_RequestActions on SS_RequestActions.RequestSerial= SS_EndOfServiceRequest.ID and (SS_RequestActions.FormCode='SS_0015')  where year(Requestdate)=year(GETDATE()) and SS_EndOfServiceRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID is not null and SS_RequestActions.ActionID=2 Order By SS_VacationRequest.RequestDate desc"
            ElseIf ddlStatus.SelectedValue = 1 Then  'موافقة    
                If DdlRequestType.SelectedValue.Trim() = "SS_0011" Then
                    If DdlYear.SelectedValue > 0 And DdlMonth.SelectedValue = 0 Then
                        str1 = "select distinct(SS_VacationRequest.ID),SS_VacationRequest.VacationType ,SS_VacationRequest.Code as RequestSerial ,SS_VacationRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_VacationRequest.RequestDate,SS_VacationRequest.VacationType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName0 & "' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName & "' else  " & vacationName2 & "  end as RequestType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then 'SS_0011' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then 'SS_0012' when SS_VacationRequest.VacationType='SS_0018' then 'SS_0018' else  'SS_0013'  end as FormCode from SS_VacationRequest join hrs_Employees on SS_VacationRequest.EmployeeID=hrs_Employees.id join hrs_VacationsTypes on SS_VacationRequest.VacationTypeID= hrs_VacationsTypes.ID join SS_RequestActions on SS_RequestActions.RequestSerial= SS_VacationRequest.ID and (SS_RequestActions.FormCode='SS_0011' or SS_RequestActions.FormCode='SS_0012' or SS_RequestActions.FormCode='SS_0013') where  VacationType='SS_0011' and year(Requestdate)=" & DdlYear.SelectedValue & " And SS_VacationRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID is not null and SS_RequestActions.ActionID=1 and SS_VacationRequest.ID not in (select RequestSerial from SS_RequestActions where FormCode='SS_0011'  and( ActionID =2 or ActionID is null))  Order By SS_VacationRequest.RequestDate desc"
                    ElseIf DdlYear.SelectedValue > 0 And DdlMonth.SelectedValue > 0 Then
                        str1 = "select distinct(SS_VacationRequest.ID),SS_VacationRequest.VacationType ,SS_VacationRequest.Code as RequestSerial ,SS_VacationRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_VacationRequest.RequestDate,SS_VacationRequest.VacationType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName0 & "' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName & "' else  " & vacationName2 & "  end as RequestType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then 'SS_0011' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then 'SS_0012' when SS_VacationRequest.VacationType='SS_0018' then 'SS_0018' else  'SS_0013'  end as FormCode from SS_VacationRequest join hrs_Employees on SS_VacationRequest.EmployeeID=hrs_Employees.id join hrs_VacationsTypes on SS_VacationRequest.VacationTypeID= hrs_VacationsTypes.ID join SS_RequestActions on SS_RequestActions.RequestSerial= SS_VacationRequest.ID and (SS_RequestActions.FormCode='SS_0011' or SS_RequestActions.FormCode='SS_0012' or SS_RequestActions.FormCode='SS_0013') where  VacationType='SS_0011' and year(Requestdate)=" & DdlYear.SelectedValue & " And Month(SS_VacationRequest.RequestDate)=" & DdlMonth.SelectedValue & "  and SS_VacationRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID is not null and SS_RequestActions.ActionID=1 and SS_VacationRequest.ID not in (select RequestSerial from SS_RequestActions where FormCode='SS_0011'  and( ActionID =2 or ActionID is null))  Order By SS_VacationRequest.RequestDate desc"
                    ElseIf DdlYear.SelectedValue = 0 And DdlMonth.SelectedValue = 0 Then
                        str1 = "select distinct(SS_VacationRequest.ID),SS_VacationRequest.VacationType ,SS_VacationRequest.Code as RequestSerial ,SS_VacationRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_VacationRequest.RequestDate,SS_VacationRequest.VacationType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName0 & "' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName & "' else  " & vacationName2 & "  end as RequestType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then 'SS_0011' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then 'SS_0012' when SS_VacationRequest.VacationType='SS_0018' then 'SS_0018' else  'SS_0013'  end as FormCode from SS_VacationRequest join hrs_Employees on SS_VacationRequest.EmployeeID=hrs_Employees.id join hrs_VacationsTypes on SS_VacationRequest.VacationTypeID= hrs_VacationsTypes.ID join SS_RequestActions on SS_RequestActions.RequestSerial= SS_VacationRequest.ID and (SS_RequestActions.FormCode='SS_0011' or SS_RequestActions.FormCode='SS_0012' or SS_RequestActions.FormCode='SS_0013') where  VacationType='SS_0011' and year(Requestdate)=year(GETDATE()) And SS_VacationRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID is not null and SS_RequestActions.ActionID=1 and SS_VacationRequest.ID not in (select RequestSerial from SS_RequestActions where FormCode='SS_0011'  and( ActionID =2 or ActionID is null))  Order By SS_VacationRequest.RequestDate desc"
                    End If
                ElseIf DdlRequestType.SelectedValue.Trim() = "SS_0012" Then
                    If DdlYear.SelectedValue > 0 And DdlMonth.SelectedValue = 0 Then
                        str1 = "select distinct(SS_VacationRequest.ID),SS_VacationRequest.VacationType ,SS_VacationRequest.Code as RequestSerial ,SS_VacationRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_VacationRequest.RequestDate,SS_VacationRequest.VacationType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName0 & "' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName & "' else  " & vacationName2 & "  end as RequestType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then 'SS_0011' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then 'SS_0012' when SS_VacationRequest.VacationType='SS_0018' then 'SS_0018' else  'SS_0013'  end as FormCode from SS_VacationRequest join hrs_Employees on SS_VacationRequest.EmployeeID=hrs_Employees.id join hrs_VacationsTypes on SS_VacationRequest.VacationTypeID= hrs_VacationsTypes.ID join SS_RequestActions on SS_RequestActions.RequestSerial= SS_VacationRequest.ID and (SS_RequestActions.FormCode='SS_0011' or SS_RequestActions.FormCode='SS_0012' or SS_RequestActions.FormCode='SS_0013') where  VacationType='SS_0012' and year(Requestdate)=" & DdlYear.SelectedValue & " And SS_VacationRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID is not null and SS_RequestActions.ActionID=1 and SS_VacationRequest.ID not in (select RequestSerial from SS_RequestActions where FormCode='SS_0012'  and( ActionID =2 or ActionID is null))  Order By SS_VacationRequest.RequestDate desc"
                    ElseIf DdlYear.SelectedValue > 0 And DdlMonth.SelectedValue > 0 Then
                        str1 = "select distinct(SS_VacationRequest.ID),SS_VacationRequest.VacationType ,SS_VacationRequest.Code as RequestSerial ,SS_VacationRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_VacationRequest.RequestDate,SS_VacationRequest.VacationType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName0 & "' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName & "' else  " & vacationName2 & "  end as RequestType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then 'SS_0011' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then 'SS_0012' when SS_VacationRequest.VacationType='SS_0018' then 'SS_0018' else  'SS_0013'  end as FormCode from SS_VacationRequest join hrs_Employees on SS_VacationRequest.EmployeeID=hrs_Employees.id join hrs_VacationsTypes on SS_VacationRequest.VacationTypeID= hrs_VacationsTypes.ID join SS_RequestActions on SS_RequestActions.RequestSerial= SS_VacationRequest.ID and (SS_RequestActions.FormCode='SS_0011' or SS_RequestActions.FormCode='SS_0012' or SS_RequestActions.FormCode='SS_0013') where  VacationType='SS_0012' and year(Requestdate)=" & DdlYear.SelectedValue & " And Month(SS_VacationRequest.RequestDate)=" & DdlMonth.SelectedValue & "  and SS_VacationRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID is not null and SS_RequestActions.ActionID=1 and SS_VacationRequest.ID not in (select RequestSerial from SS_RequestActions where FormCode='SS_0012'  and( ActionID =2 or ActionID is null))  Order By SS_VacationRequest.RequestDate desc"
                    ElseIf DdlYear.SelectedValue = 0 And DdlMonth.SelectedValue = 0 Then
                        str1 = "select distinct(SS_VacationRequest.ID),SS_VacationRequest.VacationType ,SS_VacationRequest.Code as RequestSerial ,SS_VacationRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_VacationRequest.RequestDate,SS_VacationRequest.VacationType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName0 & "' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName & "' else  " & vacationName2 & "  end as RequestType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then 'SS_0011' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then 'SS_0012' when SS_VacationRequest.VacationType='SS_0018' then 'SS_0018' else  'SS_0013'  end as FormCode from SS_VacationRequest join hrs_Employees on SS_VacationRequest.EmployeeID=hrs_Employees.id join hrs_VacationsTypes on SS_VacationRequest.VacationTypeID= hrs_VacationsTypes.ID join SS_RequestActions on SS_RequestActions.RequestSerial= SS_VacationRequest.ID and (SS_RequestActions.FormCode='SS_0011' or SS_RequestActions.FormCode='SS_0012' or SS_RequestActions.FormCode='SS_0013') where  VacationType='SS_0012' and year(Requestdate)=year(GETDATE()) And SS_VacationRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID is not null and SS_RequestActions.ActionID=1 and SS_VacationRequest.ID not in (select RequestSerial from SS_RequestActions where FormCode='SS_0012'  and( ActionID =2 or ActionID is null))  Order By SS_VacationRequest.RequestDate desc"
                    End If
                ElseIf DdlRequestType.SelectedValue.Trim() = "SS_0013" Then
                    If DdlYear.SelectedValue > 0 And DdlMonth.SelectedValue = 0 Then
                ...
                ElseIf DdlRequestType.SelectedValue.Trim() = "SS_0014" Then
                    If DdlYear.SelectedValue > 0 And DdlMonth.SelectedValue = 0 Then
                        str1 = " select distinct(SS_ExecuseRequest.ID),'4' as VacationType,SS_ExecuseRequest.Code as RequestSerial ,SS_ExecuseRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_ExecuseRequest.RequestDate,'', '" & permName & "'  as RequestType ,'SS_0014' as FormCode from SS_ExecuseRequest join hrs_Employees on SS_ExecuseRequest.EmployeeID=hrs_Employees.id join SS_RequestActions on SS_RequestActions.RequestSerial= SS_ExecuseRequest.ID and (SS_RequestActions.FormCode='SS_0014') where year(Requestdate)=" & DdlYear.SelectedValue & " And SS_ExecuseRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID is not null and SS_RequestActions.ActionID=1 and SS_ExecuseRequest.ID not in (select RequestSerial from SS_RequestActions where FormCode='SS_0014'  and( ActionID =2 or ActionID is null))   Order By SS_ExecuseRequest.RequestDate desc"
                    ElseIf DdlYear.SelectedValue > 0 And DdlMonth.SelectedValue > 0 Then
                        str1 = " select distinct(SS_ExecuseRequest.ID),'4' as VacationType,SS_ExecuseRequest.Code as RequestSerial ,SS_ExecuseRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_ExecuseRequest.RequestDate,'', '" & permName & "'  as RequestType ,'SS_0014' as FormCode from SS_ExecuseRequest join hrs_Employees on SS_ExecuseRequest.EmployeeID=hrs_Employees.id join SS_RequestActions on SS_RequestActions.RequestSerial= SS_ExecuseRequest.ID and (SS_RequestActions.FormCode='SS_0014') where year(Requestdate)=" & DdlYear.SelectedValue & " And Month(SS_VacationRequest.RequestDate)=" & DdlMonth.SelectedValue & "  and SS_ExecuseRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID is not null and SS_RequestActions.ActionID=1 and SS_ExecuseRequest.ID not in (select RequestSerial from SS_RequestActions where FormCode='SS_0014'  and( ActionID =2 or ActionID is null))   Order By SS_ExecuseRequest.RequestDate desc"
                ...
                ElseIf DdlRequestType.SelectedValue.Trim() = "SS_0015" Then
                    ...
                    End If
                ElseIf DdlRequestType.SelectedValue = 0 Then
                    str1 = "select distinct(SS_VacationRequest.ID),SS_VacationRequest.VacationType ,SS_VacationRequest.Code as RequestSerial ,SS_VacationRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_VacationRequest.RequestDate,SS_VacationRequest.VacationType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName0 & "' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName & "' else  " & vacationName2 & "  end as RequestType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then 'SS_0011' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then 'SS_0012' when SS_VacationRequest.VacationType='SS_0018' then 'SS_0018' else  'SS_0013'  end as FormCode from SS_VacationRequest join hrs_Employees on SS_VacationRequest.EmployeeID=hrs_Employees.id join hrs_VacationsTypes on SS_VacationRequest.VacationTypeID= hrs_VacationsTypes.ID join SS_RequestActions on SS_RequestActions.RequestSerial= SS_VacationRequest.ID and (SS_RequestActions.FormCode='SS_0011' or SS_RequestActions.FormCode='SS_0012' or SS_RequestActions.FormCode='SS_0013') where year(Requestdate)=year(GETDATE()) and SS_VacationRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID is not null and SS_RequestActions.ActionID=1 and SS_VacationRequest.ID not in (select RequestSerial from SS_RequestActions where (FormCode='SS_0011' or FormCode='SS_0012' or FormCode='SS_0013') and( ActionID =2 or ActionID is null))  union select distinct(SS_ExecuseRequest.ID),'4' as VacationType,SS_ExecuseRequest.Code as RequestSerial ,SS_ExecuseRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_ExecuseRequest.RequestDate,'', '" & permName & "'  as RequestType ,'SS_0014' as FormCode from SS_ExecuseRequest join hrs_Employees on SS_ExecuseRequest.EmployeeID=hrs_Employees.id join SS_RequestActions on SS_RequestActions.RequestSerial= SS_ExecuseRequest.ID and (SS_RequestActions.FormCode='SS_0014') where year(Requestdate)=year(GETDATE()) and SS_ExecuseRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID is not null and SS_RequestActions.ActionID=1 and SS_ExecuseRequest.ID not in (select RequestSerial from SS_RequestActions where FormCode='SS_0014'  and( ActionID =2 or ActionID is null)) union select distinct(SS_EndOfServiceRequest.ID),'5' as VacationType,SS_EndOfServiceRequest.Code as RequestSerial ,SS_EndOfServiceRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_EndOfServiceRequest.RequestDate,'', case when SS_EndOfServiceRequest.FormCode='SS_0015' then '" & ServiceName & "' else '" & mServiceName & "' end  as RequestType ,SS_EndOfServiceRequest.FormCode as FormCode from SS_EndOfServiceRequest join hrs_Employees on SS_EndOfServiceRequest.EmployeeID=hrs_Employees.id join SS_RequestActions on SS_RequestActions.RequestSerial= SS_EndOfServiceRequest.ID and (SS_RequestActions.FormCode='SS_0015')  where year(Requestdate)=year(GETDATE()) and SS_EndOfServiceRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID is not null and SS_RequestActions.ActionID=1 and SS_EndOfServiceRequest.ID not in (select RequestSerial from SS_RequestActions where FormCode='SS_0015'  and( ActionID =2 or ActionID is null))  Order By SS_VacationRequest.RequestDate desc"
            ...
            ElseIf ddlStatus.SelectedValue = 4 Then 'تحت التنفيذ
                If DdlRequestType.SelectedValue.Trim() = "SS_0011" Then
                    If DdlYear.SelectedValue > 0 And DdlMonth.SelectedValue = 0 Then
                        str1 = "select distinct(SS_VacationRequest.ID),SS_VacationRequest.VacationType ,SS_VacationRequest.Code as RequestSerial ,SS_VacationRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_VacationRequest.RequestDate,SS_VacationRequest.VacationType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName0 & "' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName & "' else  " & vacationName2 & "  end as RequestType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then 'SS_0011' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then 'SS_0012' when SS_VacationRequest.VacationType='SS_0018' then 'SS_0018' else  'SS_0013'  end as FormCode from SS_VacationRequest join hrs_Employees on SS_VacationRequest.EmployeeID=hrs_Employees.id join hrs_VacationsTypes on SS_VacationRequest.VacationTypeID= hrs_VacationsTypes.ID join SS_RequestActions on SS_RequestActions.RequestSerial= SS_VacationRequest.ID and (SS_RequestActions.FormCode='SS_0011' or SS_RequestActions.FormCode='SS_0012' or SS_RequestActions.FormCode='SS_0013') where FormCode='SS_0011' And year(Requestdate)=" & DdlYear.SelectedValue & " and SS_VacationRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID =1  and SS_VacationRequest.ID  in (select  RequestSerial from SS_RequestActions group by RequestSerial,EmployeeID,ActionID having count (RequestSerial) =1 and EmployeeID= " & ClsEmployees.ID & "   and ActionID is null)  Order By SS_VacationRequest.RequestDate desc"
                    ElseIf DdlYear.SelectedValue > 0 And DdlMonth.SelectedValue > 0 Then
                        str1 = "select distinct(SS_VacationRequest.ID),SS_VacationRequest.VacationType ,SS_VacationRequest.Code as RequestSerial ,SS_VacationRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_VacationRequest.RequestDate,SS_VacationRequest.VacationType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName0 & "' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName & "' else  " & vacationName2 & "  end as RequestType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then 'SS_0011' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then 'SS_0012' when SS_VacationRequest.VacationType='SS_0018' then 'SS_0018' else  'SS_0013'  end as FormCode from SS_VacationRequest join hrs_Employees on SS_VacationRequest.EmployeeID=hrs_Employees.id join hrs_VacationsTypes on SS_VacationRequest.VacationTypeID= hrs_VacationsTypes.ID join SS_RequestActions on SS_RequestActions.RequestSerial= SS_VacationRequest.ID and (SS_RequestActions.FormCode='SS_0011' or SS_RequestActions.FormCode='SS_0012' or SS_RequestActions.FormCode='SS_0013') where FormCode='SS_0011' And year(Requestdate)=" & DdlYear.SelectedValue & " And Month(SS_VacationRequest.RequestDate)=" & DdlMonth.SelectedValue & "  and SS_VacationRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID =1  and SS_VacationRequest.ID  in (select  RequestSerial from SS_RequestActions group by RequestSerial,EmployeeID,ActionID having count (RequestSerial) =1 and EmployeeID= " & ClsEmployees.ID & "   and ActionID is null)  Order By SS_VacationRequest.RequestDate desc"
                    ElseIf DdlYear.SelectedValue = 0 And DdlMonth.SelectedValue = 0 Then
                        str1 = "select distinct(SS_VacationRequest.ID),SS_VacationRequest.VacationType ,SS_VacationRequest.Code as RequestSerial ,SS_VacationRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_VacationRequest.RequestDate,SS_VacationRequest.VacationType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName0 & "' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName & "' else  " & vacationName2 & "  end as RequestType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then 'SS_0011' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then 'SS_0012' when SS_VacationRequest.VacationType='SS_0018' then 'SS_0018' else  'SS_0013'  end as FormCode from SS_VacationRequest join hrs_Employees on SS_VacationRequest.EmployeeID=hrs_Employees.id join hrs_VacationsTypes on SS_VacationRequest.VacationTypeID= hrs_VacationsTypes.ID join SS_RequestActions on SS_RequestActions.RequestSerial= SS_VacationRequest.ID and (SS_RequestActions.FormCode='SS_0011' or SS_RequestActions.FormCode='SS_0012' or SS_RequestActions.FormCode='SS_0013') where FormCode='SS_0011' And year(Requestdate)=year(GETDATE()) and SS_VacationRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID =1  and SS_VacationRequest.ID  in (select  RequestSerial from SS_RequestActions group by RequestSerial,EmployeeID,ActionID having count (RequestSerial) =1 and EmployeeID= " & ClsEmployees.ID & "   and ActionID is null)  Order By SS_VacationRequest.RequestDate desc"
                    End If
                ElseIf DdlRequestType.SelectedValue.Trim() = "SS_0012" Then
                    If DdlYear.SelectedValue > 0 And DdlMonth.SelectedValue = 0 Then
                        str1 = "select distinct(SS_VacationRequest.ID),SS_VacationRequest.VacationType ,SS_VacationRequest.Code as RequestSerial ,SS_VacationRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_VacationRequest.RequestDate,SS_VacationRequest.VacationType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName0 & "' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName & "' else  " & vacationName2 & "  end as RequestType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then 'SS_0011' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then 'SS_0012' when SS_VacationRequest.VacationType='SS_0018' then 'SS_0018' else  'SS_0013'  end as FormCode from SS_VacationRequest join hrs_Employees on SS_VacationRequest.EmployeeID=hrs_Employees.id join hrs_VacationsTypes on SS_VacationRequest.VacationTypeID= hrs_VacationsTypes.ID join SS_RequestActions on SS_RequestActions.RequestSerial= SS_VacationRequest.ID and (SS_RequestActions.FormCode='SS_0011' or SS_RequestActions.FormCode='SS_0012' or SS_RequestActions.FormCode='SS_0013') where FormCode='SS_0012' And year(Requestdate)=" & DdlYear.SelectedValue & " and SS_VacationRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID =1  and SS_VacationRequest.ID  in (select  RequestSerial from SS_RequestActions group by RequestSerial,EmployeeID,ActionID having count (RequestSerial) =1 and EmployeeID= " & ClsEmployees.ID & "   and ActionID is null)  Order By SS_VacationRequest.RequestDate desc"
                    ElseIf DdlYear.SelectedValue > 0 And DdlMonth.SelectedValue > 0 Then
                        str1 = "select distinct(SS_VacationRequest.ID),SS_VacationRequest.VacationType ,SS_VacationRequest.Code as RequestSerial ,SS_VacationRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_VacationRequest.RequestDate,SS_VacationRequest.VacationType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName0 & "' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName & "' else  " & vacationName2 & "  end as RequestType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then 'SS_0011' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then 'SS_0012' when SS_VacationRequest.VacationType='SS_0018' then 'SS_0018' else  'SS_0013'  end as FormCode from SS_VacationRequest join hrs_Employees on SS_VacationRequest.EmployeeID=hrs_Employees.id join hrs_VacationsTypes on SS_VacationRequest.VacationTypeID= hrs_VacationsTypes.ID join SS_RequestActions on SS_RequestActions.RequestSerial= SS_VacationRequest.ID and (SS_RequestActions.FormCode='SS_0011' or SS_RequestActions.FormCode='SS_0012' or SS_RequestActions.FormCode='SS_0013') where FormCode='SS_0012' And year(Requestdate)=" & DdlYear.SelectedValue & " And Month(SS_VacationRequest.RequestDate)=" & DdlMonth.SelectedValue & "  and SS_VacationRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID =1  and SS_VacationRequest.ID  in (select  RequestSerial from SS_RequestActions group by RequestSerial,EmployeeID,ActionID having count (RequestSerial) =1 and EmployeeID= " & ClsEmployees.ID & "   and ActionID is null)  Order By SS_VacationRequest.RequestDate desc"
                    ElseIf DdlYear.SelectedValue = 0 And DdlMonth.SelectedValue = 0 Then
                        str1 = "select distinct(SS_VacationRequest.ID),SS_VacationRequest.VacationType ,SS_VacationRequest.Code as RequestSerial ,SS_VacationRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_VacationRequest.RequestDate,SS_VacationRequest.VacationType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName0 & "' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName & "' else  " & vacationName2 & "  end as RequestType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then 'SS_0011' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then 'SS_0012' when SS_VacationRequest.VacationType='SS_0018' then 'SS_0018' else  'SS_0013'  end as FormCode from SS_VacationRequest join hrs_Employees on SS_VacationRequest.EmployeeID=hrs_Employees.id join hrs_VacationsTypes on SS_VacationRequest.VacationTypeID= hrs_VacationsTypes.ID join SS_RequestActions on SS_RequestActions.RequestSerial= SS_VacationRequest.ID and (SS_RequestActions.FormCode='SS_0011' or SS_RequestActions.FormCode='SS_0012' or SS_RequestActions.FormCode='SS_0013') where FormCode='SS_0012' And year(Requestdate)=year(GETDATE()) and SS_VacationRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID =1  and SS_VacationRequest.ID  in (select  RequestSerial from SS_RequestActions group by RequestSerial,EmployeeID,ActionID having count (RequestSerial) =1 and EmployeeID= " & ClsEmployees.ID & "   and ActionID is null)  Order By SS_VacationRequest.RequestDate desc"
                    End If
                ElseIf DdlRequestType.SelectedValue.Trim() = "SS_0013" Then
                    If DdlYear.SelectedValue > 0 And DdlMonth.SelectedValue = 0 Then
                        str1 = "select distinct(SS_VacationRequest.ID),SS_VacationRequest.VacationType ,SS_VacationRequest.Code as RequestSerial ,SS_VacationRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_VacationRequest.RequestDate,SS_VacationRequest.VacationType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName0 & "' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName & "' else  " & vacationName2 & "  end as RequestType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then 'SS_0011' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then 'SS_0012' when SS_VacationRequest.VacationType='SS_0018' then 'SS_0018' else  'SS_0013'  end as FormCode from SS_VacationRequest join hrs_Employees on SS_VacationRequest.EmployeeID=hrs_Employees.id join hrs_VacationsTypes on SS_VacationRequest.VacationTypeID= hrs_VacationsTypes.ID join SS_RequestActions on SS_RequestActions.RequestSerial= SS_VacationRequest.ID and (SS_RequestActions.FormCode='SS_0011' or SS_RequestActions.FormCode='SS_0012' or SS_RequestActions.FormCode='SS_0013') where FormCode='SS_0013' And year(Requestdate)=" & DdlYear.SelectedValue & " and SS_VacationRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID =1  and SS_VacationRequest.ID  in (select  RequestSerial from SS_RequestActions group by RequestSerial,EmployeeID,ActionID having count (RequestSerial) =1 and EmployeeID= " & ClsEmployees.ID & "   and ActionID is null)  Order By SS_VacationRequest.RequestDate desc"
                    ElseIf DdlYear.SelectedValue > 0 And DdlMonth.SelectedValue > 0 Then
                        str1 = "select distinct(SS_VacationRequest.ID),SS_VacationRequest.VacationType ,SS_VacationRequest.Code as RequestSerial ,SS_VacationRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_VacationRequest.RequestDate,SS_VacationRequest.VacationType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName0 & "' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName & "' else  " & vacationName2 & "  end as RequestType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then 'SS_0011' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then 'SS_0012' when SS_VacationRequest.VacationType='SS_0018' then 'SS_0018' else  'SS_0013'  end as FormCode from SS_VacationRequest join hrs_Employees on SS_VacationRequest.EmployeeID=hrs_Employees.id join hrs_VacationsTypes on SS_VacationRequest.VacationTypeID= hrs_VacationsTypes.ID join SS_RequestActions on SS_RequestActions.RequestSerial= SS_VacationRequest.ID and (SS_RequestActions.FormCode='SS_0011' or SS_RequestActions.FormCode='SS_0012' or SS_RequestActions.FormCode='SS_0013') where FormCode='SS_0013' And year(Requestdate)=" & DdlYear.SelectedValue & " And Month(SS_VacationRequest.RequestDate)=" & DdlMonth.SelectedValue & "  and SS_VacationRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID =1  and SS_VacationRequest.ID  in (select  RequestSerial from SS_RequestActions group by RequestSerial,EmployeeID,ActionID having count (RequestSerial) =1 and EmployeeID= " & ClsEmployees.ID & "   and ActionID is null)  Order By SS_VacationRequest.RequestDate desc"
                    ElseIf DdlYear.SelectedValue = 0 And DdlMonth.SelectedValue = 0 Then
                        str1 = "select distinct(SS_VacationRequest.ID),SS_VacationRequest.VacationType ,SS_VacationRequest.Code as RequestSerial ,SS_VacationRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_VacationRequest.RequestDate,SS_VacationRequest.VacationType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName0 & "' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName & "' else  " & vacationName2 & "  end as RequestType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then 'SS_0011' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then 'SS_0012' when SS_VacationRequest.VacationType='SS_0018' then 'SS_0018' else  'SS_0013'  end as FormCode from SS_VacationRequest join hrs_Employees on SS_VacationRequest.EmployeeID=hrs_Employees.id join hrs_VacationsTypes on SS_VacationRequest.VacationTypeID= hrs_VacationsTypes.ID join SS_RequestActions on SS_RequestActions.RequestSerial= SS_VacationRequest.ID and (SS_RequestActions.FormCode='SS_0011' or SS_RequestActions.FormCode='SS_0012' or SS_RequestActions.FormCode='SS_0013') where FormCode='SS_0013' And year(Requestdate)=year(GETDATE()) and SS_VacationRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID =1  and SS_VacationRequest.ID  in (select  RequestSerial from SS_RequestActions group by RequestSerial,EmployeeID,ActionID having count (RequestSerial) =1 and EmployeeID= " & ClsEmployees.ID & "   and ActionID is null)  Order By SS_VacationRequest.RequestDate desc"
                    End If

                ElseIf DdlRequestType.SelectedValue.Trim() = "SS_0014" Then
                    If DdlYear.SelectedValue > 0 And DdlMonth.SelectedValue = 0 Then
                        str1 = " select distinct(SS_ExecuseRequest.ID),'4' as VacationType,SS_ExecuseRequest.Code as RequestSerial ,SS_ExecuseRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_ExecuseRequest.RequestDate,'', '" & permName & "'  as RequestType ,'SS_0014' as FormCode from SS_ExecuseRequest join hrs_Employees on SS_ExecuseRequest.EmployeeID=hrs_Employees.id join SS_RequestActions on SS_RequestActions.RequestSerial= SS_ExecuseRequest.ID and (SS_RequestActions.FormCode='SS_0014') where year(Requestdate)=" & DdlYear.SelectedValue & " and SS_ExecuseRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID is not null and SS_RequestActions.ActionID=1 and SS_ExecuseRequest.ID  in  (select  RequestSerial from SS_RequestActions group by RequestSerial,EmployeeID,ActionID having count (RequestSerial) =1 and EmployeeID= " & ClsEmployees.ID & "   and ActionID is null)   Order By SS_ExecuseRequest.RequestDate desc"
                    ElseIf DdlYear.SelectedValue > 0 And DdlMonth.SelectedValue > 0 Then
                        str1 = " select distinct(SS_ExecuseRequest.ID),'4' as VacationType,SS_ExecuseRequest.Code as RequestSerial ,SS_ExecuseRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_ExecuseRequest.RequestDate,'', '" & permName & "'  as RequestType ,'SS_0014' as FormCode from SS_ExecuseRequest join hrs_Employees on SS_ExecuseRequest.EmployeeID=hrs_Employees.id join SS_RequestActions on SS_RequestActions.RequestSerial= SS_ExecuseRequest.ID and (SS_RequestActions.FormCode='SS_0014') where year(Requestdate)=" & DdlYear.SelectedValue & " And Month(SS_VacationRequest.RequestDate)=" & DdlMonth.SelectedValue & "  and SS_ExecuseRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID is not null and SS_RequestActions.ActionID=1 and SS_ExecuseRequest.ID  in  (select  RequestSerial from SS_RequestActions group by RequestSerial,EmployeeID,ActionID having count (RequestSerial) =1 and EmployeeID= " & ClsEmployees.ID & "   and ActionID is null)   Order By SS_ExecuseRequest.RequestDate desc"
                    ElseIf DdlYear.SelectedValue = 0 And DdlMonth.SelectedValue = 0 Then
                        str1 = " select distinct(SS_ExecuseRequest.ID),'4' as VacationType,SS_ExecuseRequest.Code as RequestSerial ,SS_ExecuseRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_ExecuseRequest.RequestDate,'', '" & permName & "'  as RequestType ,'SS_0014' as FormCode from SS_ExecuseRequest join hrs_Employees on SS_ExecuseRequest.EmployeeID=hrs_Employees.id join SS_RequestActions on SS_RequestActions.RequestSerial= SS_ExecuseRequest.ID and (SS_RequestActions.FormCode='SS_0014') where year(Requestdate)=year(GETDATE()) and SS_ExecuseRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID is not null and SS_RequestActions.ActionID=1 and SS_ExecuseRequest.ID  in  (select  RequestSerial from SS_RequestActions group by RequestSerial,EmployeeID,ActionID having count (RequestSerial) =1 and EmployeeID= " & ClsEmployees.ID & "   and ActionID is null)   Order By SS_ExecuseRequest.RequestDate desc"
                ...
                ElseIf DdlRequestType.SelectedValue.Trim() = "SS_0015" Then
                    If DdlYear.SelectedValue > 0 And DdlMonth.SelectedValue = 0 Then
                        str1 = "select distinct(SS_EndOfServiceRequest.ID),'5' as VacationType,SS_EndOfServiceRequest.Code as RequestSerial ,SS_EndOfServiceRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_EndOfServiceRequest.RequestDate,'', case when SS_EndOfServiceRequest.FormCode='SS_0015' then '" & ServiceName & "' else '" & mServiceName & "' end  as RequestType ,SS_EndOfServiceRequest.FormCode as FormCode from SS_EndOfServiceRequest join hrs_Employees on SS_EndOfServiceRequest.EmployeeID=hrs_Employees.id join SS_RequestActions on SS_RequestActions.RequestSerial= SS_EndOfServiceRequest.ID and (SS_RequestActions.FormCode='SS_0015')  where year(Requestdate)=" & DdlYear.SelectedValue & " and SS_EndOfServiceRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID is not null and SS_RequestActions.ActionID=1 and SS_EndOfServiceRequest.ID in  (select  RequestSerial from SS_RequestActions group by RequestSerial,EmployeeID,ActionID having count (RequestSerial) =1 and EmployeeID= " & ClsEmployees.ID & "   and ActionID is null)  Order By SS_EndOfServiceRequest.RequestDate desc"
                    ...
                    End If
                ElseIf DdlRequestType.SelectedValue = 0 Then
                    str1 = "select distinct(SS_VacationRequest.ID),SS_VacationRequest.VacationType ,SS_VacationRequest.Code as RequestSerial ,SS_VacationRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_VacationRequest.RequestDate,SS_VacationRequest.VacationType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName0 & "' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName & "' else  " & vacationName2 & "  end as RequestType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then 'SS_0011' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then 'SS_0012' when SS_VacationRequest.VacationType='SS_0018' then 'SS_0018' else  'SS_0013'  end as FormCode from SS_VacationRequest join hrs_Employees on SS_VacationRequest.EmployeeID=hrs_Employees.id join hrs_VacationsTypes on SS_VacationRequest.VacationTypeID= hrs_VacationsTypes.ID join SS_RequestActions on SS_RequestActions.RequestSerial= SS_VacationRequest.ID and (SS_RequestActions.FormCode='SS_0011' or SS_RequestActions.FormCode='SS_0012' or SS_RequestActions.FormCode='SS_0013') where year(Requestdate)=year(GETDATE()) and SS_VacationRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID =1  and SS_VacationRequest.ID  in (select  RequestSerial from SS_RequestActions group by RequestSerial,EmployeeID,ActionID having count (RequestSerial) =1 and EmployeeID= " & ClsEmployees.ID & "   and ActionID is null)  union select distinct(SS_ExecuseRequest.ID),'4' as VacationType,SS_ExecuseRequest.Code as RequestSerial ,SS_ExecuseRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_ExecuseRequest.RequestDate,'', '" & permName & "'  as RequestType ,'SS_0014' as FormCode from SS_ExecuseRequest join hrs_Employees on SS_ExecuseRequest.EmployeeID=hrs_Employees.id join SS_RequestActions on SS_RequestActions.RequestSerial= SS_ExecuseRequest.ID and (SS_RequestActions.FormCode='SS_0014') where year(Requestdate)=year(GETDATE()) and SS_ExecuseRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID is not null and SS_RequestActions.ActionID=1 and SS_ExecuseRequest.ID  in  (select  RequestSerial from SS_RequestActions group by RequestSerial,EmployeeID,ActionID having count (RequestSerial) =1 and EmployeeID= " & ClsEmployees.ID & "   and ActionID is null) union select distinct(SS_EndOfServiceRequest.ID),'5' as VacationType,SS_EndOfServiceRequest.Code as RequestSerial ,SS_EndOfServiceRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_EndOfServiceRequest.RequestDate,'', case when SS_EndOfServiceRequest.FormCode='SS_0015' then '" & ServiceName & "' else '" & mServiceName & "' end  as RequestType ,SS_EndOfServiceRequest.FormCode as FormCode from SS_EndOfServiceRequest join hrs_Employees on SS_EndOfServiceRequest.EmployeeID=hrs_Employees.id join SS_RequestActions on SS_RequestActions.RequestSerial= SS_EndOfServiceRequest.ID and (SS_RequestActions.FormCode='SS_0015')  where year(Requestdate)=year(GETDATE()) and SS_EndOfServiceRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID is not null and SS_RequestActions.ActionID=1 and SS_EndOfServiceRequest.ID in  (select  RequestSerial from SS_RequestActions group by RequestSerial,EmployeeID,ActionID having count (RequestSerial) =1 and EmployeeID= " & ClsEmployees.ID & "   and ActionID is null)  Order By SS_VacationRequest.RequestDate desc"
                End If
            ...
            ElseIf ddlStatus.SelectedValue = 3 Then 'جديد
                If DdlRequestType.SelectedValue.Trim() = "SS_0011" Then
                    If DdlYear.SelectedValue > 0 And DdlMonth.SelectedValue = 0 Then
                        str1 = "select distinct(SS_VacationRequest.ID),SS_VacationRequest.VacationType ,SS_VacationRequest.Code as RequestSerial ,SS_VacationRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_VacationRequest.RequestDate,SS_VacationRequest.VacationType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName0 & "' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName & "' else  " & vacationName2 & "  end as RequestType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then 'SS_0011' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then 'SS_0012' when SS_VacationRequest.VacationType='SS_0018' then 'SS_0018' else  'SS_0013'  end as FormCode from SS_VacationRequest join hrs_Employees on SS_VacationRequest.EmployeeID=hrs_Employees.id join hrs_VacationsTypes on SS_VacationRequest.VacationTypeID= hrs_VacationsTypes.ID join SS_RequestActions on SS_RequestActions.RequestSerial= SS_VacationRequest.ID and (SS_RequestActions.FormCode='SS_0011' or SS_RequestActions.FormCode='SS_0012' or SS_RequestActions.FormCode='SS_0013') where FormCode='SS_0011' And year(Requestdate)=" & DdlYear.SelectedValue & " and SS_VacationRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID is null  and SS_VacationRequest.ID  in (select  RequestSerial from SS_RequestActions group by RequestSerial,EmployeeID having count (RequestSerial) =1 and EmployeeID= " & ClsEmployees.ID & " )  Order By SS_VacationRequest.RequestDate desc"
                ...
                ElseIf DdlRequestType.SelectedValue.Trim() = "SS_0014" Then
                    If DdlYear.SelectedValue > 0 And DdlMonth.SelectedValue = 0 Then
                        str1 = "select distinct(SS_ExecuseRequest.ID),'4' as VacationType,SS_ExecuseRequest.Code as RequestSerial ,SS_ExecuseRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_ExecuseRequest.RequestDate,'', '" & permName & "'  as RequestType ,'SS_0014' as FormCode from SS_ExecuseRequest join hrs_Employees on SS_ExecuseRequest.EmployeeID=hrs_Employees.id join SS_RequestActions on SS_RequestActions.RequestSerial= SS_ExecuseRequest.ID and (SS_RequestActions.FormCode='SS_0014') where year(Requestdate)=" & DdlYear.SelectedValue & " and SS_ExecuseRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID is  null  and SS_ExecuseRequest.ID  in  (select  RequestSerial from SS_RequestActions group by RequestSerial,EmployeeID having count (RequestSerial) =1 and EmployeeID= " & ClsEmployees.ID & "  )  Order By SS_ExecuseRequest.RequestDate desc"
                    ElseIf DdlYear.SelectedValue > 0 And DdlMonth.SelectedValue > 0 Then
                        str1 = "select distinct(SS_ExecuseRequest.ID),'4' as VacationType,SS_ExecuseRequest.Code as RequestSerial ,SS_ExecuseRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_ExecuseRequest.RequestDate,'', '" & permName & "'  as RequestType ,'SS_0014' as FormCode from SS_ExecuseRequest join hrs_Employees on SS_ExecuseRequest.EmployeeID=hrs_Employees.id join SS_RequestActions on SS_RequestActions.RequestSerial= SS_ExecuseRequest.ID and (SS_RequestActions.FormCode='SS_0014') where year(Requestdate)=" & DdlYear.SelectedValue & " And Month(SS_VacationRequest.RequestDate)=" & DdlMonth.SelectedValue & "  and SS_ExecuseRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID is  null  and SS_ExecuseRequest.ID  in  (select  RequestSerial from SS_RequestActions group by RequestSerial,EmployeeID having count (RequestSerial) =1 and EmployeeID= " & ClsEmployees.ID & "  )  Order By SS_ExecuseRequest.RequestDate desc"
                ...
                ElseIf DdlRequestType.SelectedValue.Trim() = "SS_0015" Then
                    If DdlYear.SelectedValue > 0 And DdlMonth.SelectedValue = 0 Then
                        str1 = "  select distinct(SS_EndOfServiceRequest.ID),'5' as VacationType,SS_EndOfServiceRequest.Code as RequestSerial ,SS_EndOfServiceRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_EndOfServiceRequest.RequestDate,'', case when SS_EndOfServiceRequest.FormCode='SS_0015' then '" & ServiceName & "' else '" & mServiceName & "' end  as RequestType ,SS_EndOfServiceRequest.FormCode as FormCode from SS_EndOfServiceRequest join hrs_Employees on SS_EndOfServiceRequest.EmployeeID=hrs_Employees.id join SS_RequestActions on SS_RequestActions.RequestSerial= SS_EndOfServiceRequest.ID and (SS_RequestActions.FormCode='SS_0015')  where year(Requestdate)=" & DdlYear.SelectedValue & " and SS_EndOfServiceRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID is null  and SS_EndOfServiceRequest.ID in  (select  RequestSerial from SS_RequestActions group by RequestSerial,EmployeeID having count (RequestSerial) =1 and EmployeeID= " & ClsEmployees.ID & ")  Order By SS_EndOfServiceRequest.RequestDate desc"
                    ...
                    End If
                ElseIf DdlRequestType.SelectedValue = 0 Then
                    str1 = "select distinct(SS_VacationRequest.ID),SS_VacationRequest.VacationType ,SS_VacationRequest.Code as RequestSerial ,SS_VacationRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_VacationRequest.RequestDate,SS_VacationRequest.VacationType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName0 & "' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName & "' else  " & vacationName2 & "  end as RequestType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then 'SS_0011' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then 'SS_0012' when SS_VacationRequest.VacationType='SS_0018' then 'SS_0018' else  'SS_0013'  end as FormCode from SS_VacationRequest join hrs_Employees on SS_VacationRequest.EmployeeID=hrs_Employees.id join hrs_VacationsTypes on SS_VacationRequest.VacationTypeID= hrs_VacationsTypes.ID join SS_RequestActions on SS_RequestActions.RequestSerial= SS_VacationRequest.ID and (SS_RequestActions.FormCode='SS_0011' or SS_RequestActions.FormCode='SS_0012' or SS_RequestActions.FormCode='SS_0013') where year(Requestdate)=year(GETDATE()) and SS_VacationRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID is null  and SS_VacationRequest.ID  in (select  RequestSerial from SS_RequestActions group by RequestSerial,EmployeeID having count (RequestSerial) =1 and EmployeeID= " & ClsEmployees.ID & " )  union select distinct(SS_ExecuseRequest.ID),'4' as VacationType,SS_ExecuseRequest.Code as RequestSerial ,SS_ExecuseRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_ExecuseRequest.RequestDate,'', '" & permName & "'  as RequestType ,'SS_0014' as FormCode from SS_ExecuseRequest join hrs_Employees on SS_ExecuseRequest.EmployeeID=hrs_Employees.id join SS_RequestActions on SS_RequestActions.RequestSerial= SS_ExecuseRequest.ID and (SS_RequestActions.FormCode='SS_0014') where year(Requestdate)=year(GETDATE()) and SS_ExecuseRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID is  null  and SS_ExecuseRequest.ID  in  (select  RequestSerial from SS_RequestActions group by RequestSerial,EmployeeID having count (RequestSerial) =1 and EmployeeID= " & ClsEmployees.ID & "  ) union select distinct(SS_EndOfServiceRequest.ID),'5' as VacationType,SS_EndOfServiceRequest.Code as RequestSerial ,SS_EndOfServiceRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_EndOfServiceRequest.RequestDate,'', case when SS_EndOfServiceRequest.FormCode='SS_0015' then '" & ServiceName & "' else '" & mServiceName & "' end  as RequestType ,SS_EndOfServiceRequest.FormCode as FormCode from SS_EndOfServiceRequest join hrs_Employees on SS_EndOfServiceRequest.EmployeeID=hrs_Employees.id join SS_RequestActions on SS_RequestActions.RequestSerial= SS_EndOfServiceRequest.ID and (SS_RequestActions.FormCode='SS_0015')  where year(Requestdate)=year(GETDATE()) and SS_EndOfServiceRequest.EmployeeID= " & ClsEmployees.ID & " and SS_RequestActions.ActionID is null  and SS_EndOfServiceRequest.ID in  (select  RequestSerial from SS_RequestActions group by RequestSerial,EmployeeID having count (RequestSerial) =1 and EmployeeID= " & ClsEmployees.ID & ")  Order By SS_VacationRequest.RequestDate desc"
                End If
    ...
    Private Sub FillEmployeeRequestsByStatusNew()
        Try
            ...
            If ClsEmployees.ID > 0 Then
                Where = " And SS_VFollowup.EmployeeID= '" & ClsEmployees.ID & "'"
            End If
            If DdlYear.SelectedValue > 0 Then
                Where = Where & " And year(Requestdate)=" & DdlYear.SelectedValue & " "
            End If
            If DdlMonth.SelectedValue > 0 Then
                Where = Where & " And Month(SS_VacationRequest.RequestDate)=" & DdlMonth.SelectedValue & " "
            End If


            If ddlStatus.SelectedValue = 2 Then  'رفض
                If DdlRequestType.SelectedIndex <> 0 Then
                    str1 = "select distinct(SS_VFollowup.ID),SS_VFollowup.FormCode as VacationType ,SS_VFollowup.RequestSerial as RequestSerial ,SS_VFollowup.EmployeeID ," & EmpName & " as EmployeeName,SS_VFollowup.RequestDate,SS_VFollowup.VacationType ," & RequestType & " as RequestType ,SS_VFollowup.FormCode as FormCode from SS_VFollowup where RequestStautsTypeID is not null and RequestStautsTypeID=2 and FormCode='" & DdlRequestType.SelectedValue.Trim() & "' " & Where & " Order By SS_VFollowup.RequestDate desc"
                Else
                    str1 = "select distinct(SS_VFollowup.ID),SS_VFollowup.FormCode as VacationType ,SS_VFollowup.RequestSerial as RequestSerial ,SS_VFollowup.EmployeeID ," & EmpName & " as EmployeeName,SS_VFollowup.RequestDate,SS_VFollowup.VacationType ," & RequestType & " as RequestType ,SS_VFollowup.FormCode as FormCode from SS_VFollowup where RequestStautsTypeID is not null and RequestStautsTypeID=2 " & Where & " Order By SS_VFollowup.RequestDate desc"
                End If

            ElseIf ddlStatus.SelectedValue = 1 Then  'موافقة    
                If DdlRequestType.SelectedIndex <> 0 Then
                    str1 = "select distinct(SS_VFollowup.ID),SS_VFollowup.FormCode as VacationType ,SS_VFollowup.RequestSerial as RequestSerial ,SS_VFollowup.EmployeeID ," & EmpName & " as EmployeeName,SS_VFollowup.RequestDate,SS_VFollowup.VacationType ," & RequestType & " as RequestType ,SS_VFollowup.FormCode as FormCode from SS_VFollowup where   RequestStautsTypeID is not null and RequestStautsTypeID=1 and FormCode='" & DdlRequestType.SelectedValue.Trim() & "' " & Where & " Order By SS_VFollowup.RequestDate desc"
                Else
                    str1 = "select distinct(SS_VFollowup.ID),SS_VFollowup.FormCode as VacationType ,SS_VFollowup.RequestSerial as RequestSerial ,SS_VFollowup.EmployeeID ," & EmpName & " as EmployeeName,SS_VFollowup.RequestDate,SS_VFollowup.VacationType ," & RequestType & " as RequestType ,SS_VFollowup.FormCode as FormCode from SS_VFollowup where   RequestStautsTypeID is not null and RequestStautsTypeID=1 " & Where & " Order By SS_VFollowup.RequestDate desc"
                End If
            ElseIf ddlStatus.SelectedValue = 4 Then 'تحت التنفيذ
                If DdlRequestType.SelectedIndex <> 0 Then
                    str1 = "select distinct(SS_VFollowup.ID),SS_VFollowup.FormCode as VacationType ,SS_VFollowup.RequestSerial as RequestSerial ,SS_VFollowup.EmployeeID ," & EmpName & " as EmployeeName,SS_VFollowup.RequestDate,SS_VFollowup.VacationType ," & RequestType & " as RequestType ,SS_VFollowup.FormCode as FormCode from SS_VFollowup where   RequestStautsTypeID is not null and RequestStautsTypeID=4 and FormCode='" & DdlRequestType.SelectedValue.Trim() & "' " & Where & " Order By SS_VFollowup.RequestDate desc"
                Else
                    str1 = "select distinct(SS_VFollowup.ID),SS_VFollowup.FormCode as VacationType ,SS_VFollowup.RequestSerial as RequestSerial ,SS_VFollowup.EmployeeID ," & EmpName & " as EmployeeName,SS_VFollowup.RequestDate,SS_VFollowup.VacationType ," & RequestType & " as RequestType ,SS_VFollowup.FormCode as FormCode from SS_VFollowup where   RequestStautsTypeID is not null and RequestStautsTypeID=4 " & Where & " Order By SS_VFollowup.RequestDate desc"
                End If

            ElseIf ddlStatus.SelectedValue = 3 Then 'جديد
                If DdlRequestType.SelectedIndex <> 0 Then
                    str1 = "select distinct(SS_VFollowup.ID),SS_VFollowup.FormCode as VacationType ,SS_VFollowup.RequestSerial as RequestSerial ,SS_VFollowup.EmployeeID ," & EmpName & " as EmployeeName,SS_VFollowup.RequestDate,SS_VFollowup.VacationType ," & RequestType & " as RequestType ,SS_VFollowup.FormCode as FormCode from SS_VFollowup where   RequestStautsTypeID is not null and RequestStautsTypeID=3 and FormCode='" & DdlRequestType.SelectedValue.Trim() & "' " & Where & " Order By SS_VFollowup.RequestDate desc"
                Else
                    str1 = "select distinct(SS_VFollowup.ID),SS_VFollowup.FormCode as VacationType ,SS_VFollowup.RequestSerial as RequestSerial ,SS_VFollowup.EmployeeID ," & EmpName & " as EmployeeName,SS_VFollowup.RequestDate,SS_VFollowup.VacationType ," & RequestType & " as RequestType ,SS_VFollowup.FormCode as FormCode from SS_VFollowup where   RequestStautsTypeID is not null and RequestStautsTypeID=3 " & Where & " Order By SS_VFollowup.RequestDate desc"
                End If
            ElseIf ddlStatus.SelectedValue = 5 Then 'ملغي
                If DdlRequestType.SelectedIndex <> 0 Then
                    str1 = "select distinct(SS_VFollowup.ID),SS_VFollowup.FormCode as VacationType ,SS_VFollowup.RequestSerial as RequestSerial ,SS_VFollowup.EmployeeID ," & EmpName & " as EmployeeName,SS_VFollowup.RequestDate,SS_VFollowup.VacationType ," & RequestType & " as RequestType ,SS_VFollowup.FormCode as FormCode from SS_VFollowup where   RequestStautsTypeID is not null and RequestStautsTypeID=5 and FormCode='" & DdlRequestType.SelectedValue.Trim() & "' " & Where & " Order By SS_VFollowup.RequestDate desc"
                Else
                    str1 = "select distinct(SS_VFollowup.ID),SS_VFollowup.FormCode as VacationType ,SS_VFollowup.RequestSerial as RequestSerial ,SS_VFollowup.EmployeeID ," & EmpName & " as EmployeeName,SS_VFollowup.RequestDate,SS_VFollowup.VacationType ," & RequestType & " as RequestType ,SS_VFollowup.FormCode as FormCode from SS_VFollowup where   RequestStautsTypeID is not null and RequestStautsTypeID=5 " & Where & " Order By SS_VFollowup.RequestDate desc"
                End If
            ElseIf ddlStatus.SelectedValue = 0 Then 'برجاء الاختيار
                FillEmployeeVacations()
    ...
    Private Sub FillEmployeeVacations()
        Try
            ...
            If ProfileCls.CurrentLanguage = "Ar" Then
                ...
                RequestType = "RequestArbName as RequestType"

            Else
                EmpName = " EmployeeEngName as EmployeeName"
                RequestType = "RequestEngName as RequestType"

            End If

            Dim str1 As String

            str1 = "select ID,VacationType,RequestSerial,EmployeeID," & EmpName & ",RequestDate,VacationType," & RequestType & ",FormCode from SS_VFollowup where  EmployeeID= " & ClsEmployees.ID & ""
            Dim Criteria As String = " "
            If Not String.IsNullOrEmpty(DdlRequestType.SelectedValue.Trim()) And DdlRequestType.SelectedValue.Trim() <> "0" Then
                Criteria &= "and FormCode='" & DdlRequestType.SelectedValue.Trim() & "'"
            End If
            If DdlYear.SelectedValue > 0 Then
                Criteria += "And Year(RequestDate) = " & DdlYear.SelectedValue & ""
            End If
            If DdlMonth.SelectedValue > 0 Then
                Criteria += "And Month(RequestDate)=" & DdlMonth.SelectedValue & ""
            End If
    ...
    Private Sub GetAllEmployeeRequests()
        Try
            ...
            'str1 = "select SS_VacationRequest.ID,SS_VacationRequest.VacationType ,SS_VacationRequest.Code as RequestSerial ,SS_VacationRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_VacationRequest.RequestDate,SS_VacationRequest.VacationType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName0 & "' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then '" & vacationName & "' else  " & vacationName2 & "  end as RequestType ,case when  SS_VacationRequest.VacationType='SS_0011' and SS_VacationRequest.VacationTypeID =1 then 'SS_0011' when SS_VacationRequest.VacationType='SS_0012' and SS_VacationRequest.VacationTypeID =1 then 'SS_0012' when SS_VacationRequest.VacationType='SS_0018' then 'SS_0018' else  'SS_0013'  end as FormCode from SS_VacationRequest join hrs_Employees on SS_VacationRequest.EmployeeID=hrs_Employees.id join hrs_VacationsTypes on SS_VacationRequest.VacationTypeID= hrs_VacationsTypes.ID where year(Requestdate)=year(GETDATE()) and EmployeeID= " & ClsEmployees.ID & " union select SS_ExecuseRequest.ID,'4' as VacationType,SS_ExecuseRequest.Code as RequestSerial ,SS_ExecuseRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_ExecuseRequest.RequestDate,'', '" & permName & "'  as RequestType ,'SS_0014' as FormCode from SS_ExecuseRequest join hrs_Employees on SS_ExecuseRequest.EmployeeID=hrs_Employees.id where year(Requestdate)=year(GETDATE()) and EmployeeID= " & ClsEmployees.ID & " union select SS_EndOfServiceRequest.ID,'5' as VacationType,SS_EndOfServiceRequest.Code as RequestSerial ,SS_EndOfServiceRequest.EmployeeID ," & EmpName & " as EmployeeName,SS_EndOfServiceRequest.RequestDate,'', case when FormCode='SS_0015' then '" & ServiceName & "' else '" & mServiceName & "' end  as RequestType ,FormCode as FormCode from SS_EndOfServiceRequest join hrs_Employees on SS_EndOfServiceRequest.EmployeeID=hrs_Employees.id where year(Requestdate)=year(GETDATE()) and EmployeeID= " & ClsEmployees.ID & " Order By SS_VacationRequest.RequestDate desc"
            str1 = "select ID,VacationType,RequestSerial,EmployeeID," & EmpName & ",RequestDate,VacationType," & RequestType & ",FormCode from SS_VFollowup where year(Requestdate)=year(GETDATE()) and EmployeeID= " & ClsEmployees.ID & ""
