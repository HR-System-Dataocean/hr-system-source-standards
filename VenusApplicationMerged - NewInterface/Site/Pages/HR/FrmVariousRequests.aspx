<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmVariousRequests.aspx.vb"
...
<head runat="server">
    <title>* Venus Payroll * ~Various Request</title>
            ...
            <tr>
                <td class="Details">
                    <igtab:UltraWebTab ID="UltraWebTab1" runat="server" EnableAppStyling="True" SkinID="Default"
                        ...
                        <Tabs>
                            <igtab:Tab Text="طلبات متنـــوعــة" meta:resourcekey="TabResource1">
                                <ContentTemplate>
...
<%--                                                         اسم الموظف--%>
                                                       <td class="LabelArea">
      <asp:Label ID="labelDescEnglishName" Width="80px" runat="server" Text="اسم الموظف"
   ...
   <td class="DataArea">
      <asp:TextBox ID="lblDescEnglishName" Width="200px" runat="server" 
...
<td class="spacearea">
                                                                       ...
                                                                       <%--القسم--%>
                                                        <td class="LabelArea" style="min-width: 90px;">
                                                            <asp:Label ID="lblDepartment" runat="server" Text="القسم " SkinID="Label_DefaultNormal"
                                                                meta:resourcekey="lblDepartment"></asp:Label>
                                                        </td>
...
<%--                                                       <%--الوظيفة--%>
                                                       <td class="LabelArea">
      <asp:Label ID="LblPosition" Width="80px" runat="server" Text="المهنة"
          SkinID="Label_DefaultNormal" meta:resourcekey="LblPosition"></asp:Label>
  </td>
  
 
  
                                                      <td class="DataArea">
      <asp:TextBox ID="txtPosition" Width="200px" runat="server" 
          ReadOnly="True" MaxLength="255" meta:resourcekey="lblDescEnglishNameResource1"
          TabIndex="1"></asp:TextBox>
  </td>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 50%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblRequestType" runat="server" Width="50px" SkinID="Label_DefaultNormal"
                                                        ...
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="DdlRequestType" Width="200px" runat="server" SkinID="DropDownList_smallNormal"
                                            ...
                                            <td style="width: 47%; height: 2px; vertical-align: top">
                                                <table style="width: 47%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="LblDirectedTo" runat="server" Width="90px" SkinID="Label_DefaultNormal"
                                                                Text="اسم الجهة" meta:resourcekey="LblDirectedToResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="txtEntityName" runat="server" Width="300px"   meta:resourcekey="lbRemainValResource1"
                                                              ReadOnly="false" MaxLength="500"></asp:TextBox>
                                                        </td>
