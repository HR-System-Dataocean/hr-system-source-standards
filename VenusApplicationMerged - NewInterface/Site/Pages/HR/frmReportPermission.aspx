<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmReportPermission.aspx.vb"
    Inherits="frmReportPermission" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
...
<head runat="server">
    <title>* Venus Payroll * ~Report Permission</title>
    ...
    <script language="javascript" src="Scripts/App_ReportsPermissions.js"></script>
</head>
<body style="margin: 0; padding: 0;">
    <form id="frmReportPermission" runat="server">
                                ...
                                <ContentTemplate>
                                    <table style="width: 100%; height: 100%; min-height: 350px; vertical-align: top"
                                        ...
                                        <tr>
                                                ...
                                                <table style="width: 100%; height: 30px; vertical-align: bottom; border-bottom: 1px solid black"
                                                    ...
                                                    <tr>
                                                        <td style="vertical-align: bottom; height: 23px">
                                                            <asp:Label ID="Label_Title1" runat="server" Text="برجاء تحديد صلاحيات للتقارير" SkinID="Label_DefaultBold"
                                            ...
                                            <td style="width: 47%; vertical-align: top;">
                                                <table style="width: 100%; height: 30px; vertical-align: bottom;" cellspacing="6">
                                                    <tr>
                                                        <td style="vertical-align: bottom" class="style1">
                                                            ...
                                                            <asp:CheckBox ID="chkAllowPrint" runat="server" meta:resourcekey="chkAllowPrintResource1"
                                                                Text=" " />
                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<asp:CheckBox ID="chkAllowExport"
                                                                runat="server" meta:resourcekey="chkAllowExportResource1" Text=" " />
                                                            &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    ...
                                                    <Bands>
                                                        <igtbl:UltraGridBand meta:resourcekey="UltraGridBandResource1">
                                                            ...
                                                            <FilterOptions AllString="" EmptyString="" NonEmptyString="">
                                                                <FilterDropDownStyle BackColor="White" BorderColor="Silver" BorderStyle="None" BorderWidth="1px"
                                                                    CustomRules="overflow:auto;" Font-Names="Verdana,Arial,Helvetica,sans-serif"
                                                            ...
                                                            <Columns>
                                                                <igtbl:UltraGridColumn AllowUpdate="No" BaseColumnName="Code" Width="100px" meta:resourcekey="UltraGridColumnResource1">
                                                                ...
                                                                <igtbl:UltraGridColumn AllowUpdate="No" BaseColumnName="EngName" Width="200px" meta:resourcekey="UltraGridColumnResource2">
                                                                ...
                                                                <igtbl:UltraGridColumn AllowUpdate="No" BaseColumnName="ArbName" Width="200px" meta:resourcekey="UltraGridColumnResource3">
                                                                ...
                                                                <igtbl:UltraGridColumn AllowUpdate="Yes" BaseColumnName="AllowView" CellButtonDisplay="Always"
                                                                    DataType="System.Boolean" Key="AllowView" Type="CheckBox" Width="50px" meta:resourcekey="UltraGridColumnResource4">
                                                                    <HeaderStyle HorizontalAlign="Center" />
                                                                    <Header Caption="View ">
                                                                ...
                                                                <igtbl:UltraGridColumn AllowUpdate="Yes" BaseColumnName="AllowPrint" CellButtonDisplay="Always"
                                                                    DataType="System.Boolean" Key="AllowPrint" Type="CheckBox" Width="50px" meta:resourcekey="UltraGridColumnResource5">
                                                                    <HeaderStyle HorizontalAlign="Center" />
                                                                ...
                                                                <igtbl:UltraGridColumn AllowUpdate="Yes" BaseColumnName="AllowExport" CellButtonDisplay="Always"
                                                                    DataType="System.Boolean" Key="AllowExport" Type="CheckBox" Width="50px" meta:resourcekey="UltraGridColumnResource6">
                                                                    <HeaderStyle HorizontalAlign="Center" />
                                                                    <Header Caption="Export">
                                                                ...
                                                                <igtbl:UltraGridColumn BaseColumnName="ID" Hidden="True" Key="ID" Width="100%" meta:resourcekey="UltraGridColumnResource7">
                                                                    <Header>
                                                                ...
                                                                <igtbl:UltraGridColumn AllowUpdate="Yes" BaseColumnName="CheckAll" CellButtonDisplay="Always"
                                                                    Key="CheckAll" Type="CheckBox" Width="70px" meta:resourcekey="UltraGridColumnResource8">
                                                                    <HeaderStyle HorizontalAlign="Center" />
