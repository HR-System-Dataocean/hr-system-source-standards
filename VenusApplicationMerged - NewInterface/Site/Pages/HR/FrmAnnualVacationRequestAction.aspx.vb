            ...
            If ddlAction.SelectedValue = 2 Then   'رفض
                ...
                If dsconfig.Tables(0).Rows.Count > 0 Then
                    If CBool(dsconfig.Tables(0).Rows(0)("ApplyForAll")) Then
                        ...
                        Dim UpdateCommand2 As String = "update SS_RequestActions set  seen=1 , IsHidden=1 where ConfigID=" & ConfigID & " and RequestSerial=" & RequestSerial & " And AcionID <> 3 and SS_EmployeeID <>" & ClsEmployees.ID & ""
