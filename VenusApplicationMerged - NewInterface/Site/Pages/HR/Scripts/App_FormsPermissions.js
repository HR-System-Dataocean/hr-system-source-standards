...
function UwgSearchUsers_AfterCellUpdateHandler(gridName, cellId){
	...
	var Row            = Cell.getRow()
	var CellCheckAll   = Row.getCell(10).getValue(); 
    ...
    if (Cell.Column.Key == "CheckAll") 
     {
       ...
       if(CellCheckAll==true || CellCheckAll==1) { 
          ...
          if(Row.getCell(4).getValue()) {
             checkReachCount("txtAddC",false);
             window.document.all.item("UltraWebTab1$_ctl0$chkAllowAdd").checked = false;
         }
      ...
      {
          var CellAllowView   = Row.getCell(7).getValue(); 
          if(CellAllowView==false){
             ...
             Row.getCell(6).setValue(false);
             Row.getCell(8).setValue(false);   
             Row.getCell(10).setValue(false);
             window.document.all.item("UltraWebTab1$_ctl0$chkCheckAll").checked = false;
             window.document.all.item("UltraWebTab1$_ctl0$chkAllowView").checked = false; 
             checkAllChecks(Row.getCell(4).getValue(),Row.getCell(5).getValue(),Row.getCell(6).getValue(),Row.getCell(7).getValue(),Row.getCell(8).getValue(),Row.getCell(10));
             checkReachCount("txtViewC",false);
             checkReachCount("txtGridCount",false);
             ////
     ...
     else if(Cell.Column.Key == "AllowPrint" || Cell.Column.Key=="AllowDelete" || Cell.Column.Key == "AllowEdit" || Cell.Column.Key == "AllowAdd" ) 
      {
          if(Cell.Value==true){
             bEnterCheck = false;
...
function UwgSearchCheckColumns(IntColumnIndex){
     ...
     switch(IntColumnIndex)
       {
         case 4:
             ctrName = "UltraWebTab1$_ctl0$chkAllowAdd";
            StrHoldingCountsCtrName  = "txtAddC" ;
            break ;
         case 5:
        ...
        case 11:
            ctrName = "UltraWebTab1$_ctl0$chkCheckAll";
            StrHoldingCountsCtrName = "txtCheckAllC"
            break;
     }
     ...
     if (ctrlValue   ==true) {
         ...
         if (IntColumnIndex == 10 && ctrlValue ==1)
           {
               window.document.all.item("UltraWebTab1$_ctl0$chkAllowAdd").checked = true;
             ...
             window.document.all.item("txtAddC").value = MaxValue ; 
       ...
       {
        ctrlValue   = 0; 
        if (IntColumnIndex == 10 && ctrlValue ==0)
          {
              window.document.all.item("UltraWebTab1$_ctl0$chkAllowAdd").checked = false;
              window.document.all.item("UltraWebTab1$_ctl0$chkAllowEdit").checked = false;
              window.document.all.item("UltraWebTab1$_ctl0$chkAllowDelete").checked = false;
            ...
            window.document.all.item("txtAddC").value = 0 ; 
         ...
         else if (IntColumnIndex == 7 && ctrlValue ==0)
          {
              window.document.all.item("UltraWebTab1$_ctl0$chkAllowAdd").checked = false;
              window.document.all.item("UltraWebTab1$_ctl0$chkAllowEdit").checked = false;
              window.document.all.item("UltraWebTab1$_ctl0$chkAllowDelete").checked = false;
