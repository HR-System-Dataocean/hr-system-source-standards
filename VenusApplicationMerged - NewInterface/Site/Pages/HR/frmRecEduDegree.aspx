<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmRecEduDegree.aspx.vb"
    Inherits="frmRecEduDegree" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
...
<head runat="server">
    <title>* Venus Payroll * ~Recruitment Education Degree</title>
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmRecEduDegree" runat="server">
