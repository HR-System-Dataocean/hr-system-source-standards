<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmChangeWorkHoursRequest.aspx.vb"
    Inherits="frmChangeWorkHoursRequest" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
...
<head runat="server">
    ...
    <script type="text/javascript" id="igClientScript">
        ...
        function OpenPrintedScreen(v) {
            ...
            var win = window.open("../../Interfaces/frmReportsGridViewer.aspx?Language=false&Criteria=RequestSerial&preview=1&ReportCode=CF_149&sq0=''&v=" + v, "_NEW", "height=" + hight + ",width=" + width + ",resizable=0,menubar=0,toolbar=0,location=0,directories=0,scrollbars=0,status=0,center=0");
            win.focus();
        }
    </script>
    <style type="text/css">
...
<body style="margin: 0; padding: 0;">
    <form id="frmChangeWorkHoursRequest" runat="server" defaultbutton="Button1">
                                            ...
                                            <td style="width: 40%; height: 16px; vertical-align: top">
                                                <table style="width: 90%; vertical-align: top" cellspacing="0">
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td class="LabelArea">
    <asp:Label ID="label3" Width="100px" runat="server" Text="Employee Name"
        SkinID="Label_DefaultNormal" meta:resourcekey="labelDescEnglishNameResource1"></asp:Label>
                                         ...
                                         <%-- <td class="SeparArea">
                                                    ...
                                                    <td class="DataArea">
    <asp:TextBox ID="lblDescEnglishName" Width="150" runat="server" SkinID="TextBox_DefaultNormalC"
        ...
        TabIndex="1"></asp:TextBox>
                                                      ...
                                                      <td class="LabelArea">
    <asp:Label ID="label5" Width="150px" runat="server" Text="Nationality"
            ...
            <AutoPostBack ValueChanged="True" />
                                        ...
                                        <tr>
                                            <table style="width: 100%;">
                                                     <tr>
                                                           <td id="myTd3" runat="server" style="width: 50%;">
                                                                    <table style="width: 100%;">
     ...
     <td style="width: 47%; height: 16px; vertical-align: top">
         <table style="width: 100%; vertical-align: top" cellspacing="0">
             <tr>
                 ...
                 <td class="LabelArea">
                     <asp:Label ID="lblFromTime" runat="server" Width="80px" SkinID="Label_DefaultNormal"
     Text="FromTime" meta:resourcekey="lblFromTimeResource1"></asp:Label>
                 </td>
                 <td class="DataArea">
                      <asp:TextBox ID="txtFromTime" runat="server" SkinID="TextBox_DefaultNormalC"  meta:resourcekey="txtFromTimeResource1">
</asp:TextBox>
                 </td>
             </tr>
         </table>
     ...
     <td style="width: 47%; height: 16px; vertical-align: top">
         <table style="width: 100%; vertical-align: top" cellspacing="0">
             <tr>
                 ...
                 <td class="LabelArea">
                     <asp:Label ID="lblFromDate" runat="server" SkinID="Label_DefaultNormal" Text="FromDate"
    Width="80px" meta:resourcekey="lblFromDateResource1"></asp:Label>
                 </td>
                 <td class="DataArea">
     ...
     <td style="width: 47%; height: 16px; vertical-align: top">
         <table style="width: 100%; vertical-align: top" cellspacing="0">
             <tr>
                 ...
                 <td class="LabelArea">
                     <asp:Label ID="lblToTime" runat="server" Width="80px" SkinID="Label_DefaultNormal"
     Text="ToTime" meta:resourcekey="lblToTimeResource1"></asp:Label>
                 </td>
                 <td class="DataArea">
                                           <asp:TextBox ID="txtToTime" runat="server" SkinID="TextBox_DefaultNormalC"  meta:resourcekey="txtToTimeResource1">
</asp:TextBox>
                 </td>
             </tr>
         </table>
     ...
     <td style="width: 47%; height: 16px; vertical-align: top">
         <table style="width: 100%; vertical-align: top" cellspacing="0">
             <tr>
                 ...
                 <td class="LabelArea">
                     <asp:Label ID="lblToDate" runat="server" SkinID="Label_DefaultNormal" Text="ToDate"
    Width="80px" meta:resourcekey="lblToDateResource1"></asp:Label>
                 </td>
                 <td class="DataArea">
