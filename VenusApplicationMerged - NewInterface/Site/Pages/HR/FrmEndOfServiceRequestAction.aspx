<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmEndOfServiceRequestAction.aspx.vb"
...
<body style="height: 100%; margin: 0; padding: 0;">
                    ...
                    <igtab:UltraWebTab ID="UltraWebTab1" runat="server" EnableAppStyling="True" SkinID="Default"
                        ...
                        <Tabs>
                            <igtab:Tab Text="عام" meta:resourcekey="TabResource1">
                                <ContentTemplate>
                                    <table style="width: 100%; height: 100%; min-height: 350px; vertical-align: auto"
                                        cellspacing="0">
                                        <tr>
                                                ...
                                                <table style="width: 100%; height: 18px; vertical-align: top; border-bottom: 1px solid silver">
                                                    <tr>
                                                        ...
                                                        <td  style="width: 5px" class="LabelArea">
                                                            <asp:Label ID="LblAction" runat="server" Width="90px" SkinID="Label_DefaultBold"
                                                                Text="الاجراء" meta:resourcekey="LblActionResource1"></asp:Label>
                                                        </td>
               ...
               <%-- <td class="DataArea">
                      <asp:ImageButton ID="ImageButton_Refresh" runat="server" ImageUrl="~/Common/Images/refresh.png" />
                                        ...
                                        <tr>
                                           ...
                                           <tr>
    <td style="width: 47%; height: 16px; vertical-align: top">
        <table style="width: 95%; vertical-align: top" cellspacing="0">
            <tr>
                 <td class="SeparArea">
                </td>
                <td class="LabelArea">
                    <asp:Label ID="LblActionRemarks" runat="server" Width="100px" Text="ملاحظات الاجراء" SkinID="Label_DefaultBold"
                        meta:resourcekey="LblActionRemarksResource1"></asp:Label>
                </td>
                <td class="DataArea">
                    <asp:TextBox ID="TxtActionRemarks" runat="server" SkinID="TextBox_LargeNormalC" 
                        ReadOnly="false" MaxLength="400" Width="300px" meta:resourcekey="TxtActionRemarksResource1">
                   </asp:TextBox>
                </td>
                                                ...
                                                <table cellspacing="6" style="width: 100%; height: 30px; vertical-align: bottom;
                                                    ...
                                                    <tr>
                                                        <td style="vertical-align: bottom">
                                                            <asp:Label ID="Label4" runat="server" meta:resourcekey="LblActionDetailsResource2" SkinID="Label_DefaultBold"
                                        ...
                                        <tr>
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 47%; vertical-align: top" cellspacing="0">
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="LblRequestSerial" Width="100px" runat="server" Text="مسلسل الطلب"
    ...
    <td style="width: 47%; height: 16px; vertical-align: top">
        <table style="width: 100%; vertical-align: top" cellspacing="0">
            <tr>
                ...
                <td class="LabelArea">
                    <asp:Label ID="Label10" runat="server" Width="90px" Text="الوظيفة" SkinID="Label_DefaultNormal"
    ...
    <td class="LabelArea">
        <asp:Label ID="lblJoinDate" runat="server" Width="90px" Text="تاريخ التعيين" SkinID="Label_DefaultNormal"
    ...
    <td style="width: 47%; height: 16px; vertical-align: top">
        <table style="width: 100%; vertical-align: top" cellspacing="0">
            <tr>
                ...
                <td class="LabelArea" style="min-width: 90px;">
                    <asp:Label ID="Label11" runat="server" Text="القسم" SkinID="Label_DefaultNormal"
                        ...
                        AutoPostBack="True" meta:resourcekey="TxtDepartmentResource1">
                                     ...
                                     <table>
                                           <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="Label2"  runat="server" Width="150px" SkinID="Label_DefaultNormal"
                                                                Text="حدد سبب الاستقالة:" meta:resourcekey="lblReasonResource1"></asp:Label>
                                                        </td>
                                                        <td class="SeparArea">
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="ddlReason" Enabled="false" Width="300px" runat="server" SkinID="DropDownList_smallNormal"
                                                                meta:resourcekey="ddlReasonResource1" TabIndex="3">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblOtherReason" runat="server" Width="150px" SkinID="Label_DefaultNormal"
                                                                Text="سبب اخر:" meta:resourcekey="lblOtherReasonResource1"></asp:Label>
                                                        </td>
                                                        <td class="SeparArea">
                                                        </td>
                                                        <td class="DataArea">
                                                             <asp:TextBox ID="txtOtherReason" Enabled="false" runat="server" Width="300px" 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea" >
                                                            <asp:Label ID="lblRateDepartment" runat="server" Width="150px" SkinID="Label_DefaultNormal"
                                                                Text="كيف تقيم تجربتك مع القسم؟" meta:resourcekey="lblRateDepartmentResource1"></asp:Label>
                                                        </td>
                                                        <td class="SeparArea">
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="ddlRateDepartment" Enabled="false" Width="300px" runat="server" SkinID="DropDownList_smallNormal"
                                                                meta:resourcekey="ddlRateDepartmentResource1" TabIndex="3">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblRateUs" runat="server" Width="150px" SkinID="Label_DefaultNormal"
                                                                Text="كيف تقيم تجربتك معنا؟" meta:resourcekey="lblRateUsResource1"></asp:Label>
                                                        </td>
                                                        <td class="SeparArea">
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="ddlRateUs" Enabled="false" Width="300px" runat="server" SkinID="DropDownList_smallNormal"
                                                                meta:resourcekey="RateUsResource1" TabIndex="3">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblBack" runat="server" Width="150px" SkinID="Label_DefaultNormal"
                                                                Text="هل من الممكن العودة إلينا؟" meta:resourcekey="lblBackResource1"></asp:Label>
                                                        </td>
                                                        <td class="SeparArea">
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="ddlBack" Enabled="false" Width="200px" runat="server" SkinID="DropDownList_smallNormal"
                                                                meta:resourcekey="ddlBackResource1" TabIndex="3">
                                                                <asp:ListItem meta:resourcekey="lblSelectResource1" Value="0">حدد الخيار</asp:ListItem>
                                                                                    <asp:ListItem meta:resourcekey="lblYesResource1" Value="1">Yes</asp:ListItem>
                                                                                    <asp:ListItem meta:resourcekey="lblNOResource1" Value="2">NO</asp:ListItem>
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                     </table>
                                 ...
                                 <td style="width: 45%">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 47%; height: 2px; vertical-align: top">
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblEOSDate" runat="server" Width="90px" meta:resourcekey="lblWebDateChooser1Resource1"
                                                                SkinID="Label_DefaultNormal" Text="تاريخ نهاية الخدمة"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="txtEOSDate" runat="server" BorderColor="#CCCCCC" BorderStyle="Solid"
                                                                BorderWidth="1px" Height="18px" NullDateLabel="" Style="font-family: Tahoma;
                                                                font-size: 8pt; font-weight: Normal; color: Black; border: solid 1px #CCCCCC"
                                                                Width="130px">
                                                            </asp:TextBox>
                                                       ...
                                                       <tr>
                                                         ...
                                                         <td class="LabelArea">
                                                            <asp:Label ID="LblEOSType" runat="server" Width="90px" SkinID="Label_DefaultNormal"
                                                                Text=" نوع نهاية الخدمة" meta:resourcekey="LblEOSTypeResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                             <asp:DropDownList ID="DdlEOSType" Width="200px" runat="server" SkinID="DropDownList_smallNormal"
                                                                meta:resourcekey="DdlEOSTypeResource1" TabIndex="3">
                                        ...
                                        <tr>
                                           ...
                                           <%-- <td style="width: 6%; height: 16px; vertical-align: top">
                                                ...
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                         <td class="LabelArea">
                                                            <asp:Label ID="LblEOSPeriod" runat="server"  SkinID="Label_DefaultBold"
                                                                Text="مدة نهاية الخدمة :" meta:resourcekey="LblEOSPeriodResource1"></asp:Label>
                                                        </td>
                                                
                                                         <td style="width: 10%" class="LabelArea">
                                                            <asp:Label ID="LblYear1" runat="server" Width="30px" SkinID="Label_DefaultBold"
                                                                Text="سنة :" meta:resourcekey="LblYear1Resource1LblYear1Resource1"></asp:Label>
                                                        </td>
                                                         <td style="width: 10%" class="LabelArea">
                                                            <asp:Label ID="LblYear" runat="server" Width="5px" SkinID="Label_DefaultBold"
                                                                Text="0" meta:resourcekey="LblExecuseReasonResource1"></asp:Label>
                                                        </td>
                                                    
                                                         <td style="width: 10%" class="LabelArea">
                                                            <asp:Label ID="LblMonth1" runat="server" Width="30px" SkinID="Label_DefaultBold"
                                                                Text="شهر :" meta:resourcekey="LblMonth1Resource1"></asp:Label>
                                                        </td>
                                                         <td style="width: 10%" class="LabelArea">
                                                            <asp:Label ID="LblMonth" runat="server" Width="5px" SkinID="Label_DefaultBold"
                                                                Text="0" meta:resourcekey="LblExecuseReasonResource1"></asp:Label>
                                                        </td>

                                                         <td style="width: 10%" class="LabelArea">
                                                            <asp:Label ID="LblDay1" runat="server" Width="30px" SkinID="Label_DefaultBold"
                                                                Text="يوم :" meta:resourcekey="LblDay1Resource1"></asp:Label>
                                                        </td>
                                                         <td style="width: 10%" class="LabelArea">
                                                            <asp:Label ID="LblDay" runat="server" Width="2px" SkinID="Label_DefaultBold"
                                                                Text="0" meta:resourcekey="LblExecuseReasonResource1"></asp:Label>
                                                        </td>
                                                           </tr>
                                                </table>
                                                     ...
                                                     <tr>
                                            <td style="width: 47%; height: 10px; vertical-align: top">
                                            ...
                                            <td style="width: 47%; height: 10px; vertical-align: top">
                                                <table style="width: 50%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="LblReason" Width="120px" runat="server" Text=" اسباب نهاية الخدمة"
                                                                SkinID="Label_DefaultNormal" meta:resourcekey="LblReasonResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="TxtEOSReasons" runat="server" Width="600px" 
                                                                ReadOnly="False" MaxLength="500" meta:resourcekey="lblDescEnglishNameResource1"
                                                                TabIndex="1"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblRemarks" Width="120px" runat="server" Text=" ملاحظات"
                                                                SkinID="Label_DefaultNormal" meta:resourcekey="lblRemarksResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
