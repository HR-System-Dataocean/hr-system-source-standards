<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmEmployeesVacationsAdvance.aspx.vb"
    Inherits="frmEmployeesVacationsAdvance" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
...
<head runat="server">
    ...
    <script type="text/javascript" id="igClientScript">
        ...
        function uwgEmployeeVacations_ClickCellButtonHandler(gridName, cellId) {
            ...
            var intPaymentTransID = Row.getCellFromKey("PaymentTrnID").getValue();
            var mode = window.location.search.split('&')[0];

            if (cellId.includes("4")) {
                if (intPaymentTransID > 0) {
                    ...
                    if (window.document.all.item("lblLage").innerText == "0")
                        msg = 'this vaction without benfits'
                    else
                        msg = ' هذه الاجازة بدون مستحقات'
                    alert(msg)
                }
            }

            if (cellId.includes("5")) {
                var hight = window.screen.availHeight - 35;
                var width = window.screen.availWidth - 10;
...
<body style="margin: 0; padding: 0;">
    <form id="frmEmployeesVacationsAdvance" runat="server" defaultbutton="Button1">
                        ...
                        <tr>
                            ...
                            <td style="width: 80px">
                                <asp:ImageButton ID="ImageButton_Role" Width="16px" Height="16px" runat="server"
                                    SkinID="HrRole_Command" OnClientClick="OpenModal1('CompanyRoles.aspx?FrmID=2',450,844,false,''); return false;" />
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="labelTotalVal" runat="server" Width="90px" SkinID="Label_DefaultNormal"
                                                                Text="الإجمالي" meta:resourcekey="labelTotalValResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                        ...
                                                        <td class="LabelArea">--%>
                                                             &nbsp;&nbsp;
                                                            <asp:Label ID="lblNewYear" runat="server" SkinID="Label_CopyRightsNormal"
                                                                Text="جديد" meta:resourcekey="lblNewBalanceResource1"></asp:Label>
                                                            <asp:Label ID="lblNewBalance" runat="server" SkinID="Label_CopyRightsNormal"
                                                                Text="0" ></asp:Label>


                                                             <asp:Label ID="lblConsumed" runat="server" SkinID="Label_CopyRightsNormal"
                                                                Text="مستهلك" meta:resourcekey="lblConsumedBalanceResource1"></asp:Label>
                                                            <asp:Label ID="lblNewConsumed" runat="server" SkinID="Label_CopyRightsNormal"
                                                                Text="0" ></asp:Label>

                                                            <asp:Label ID="lblRemain" runat="server" SkinID="Label_CopyRightsNormal"
                                                                Text="متبقي" meta:resourcekey="lblRemainBalanceResource1"></asp:Label>
                                                            <asp:Label ID="lblNewRemain" runat="server" SkinID="Label_CopyRightsNormal"
                                                                Text="0" ></asp:Label>

                                                         &nbsp;&nbsp;
                                                            <asp:Label ID="lblTransferYear" runat="server" SkinID="Label_CopyRightsNormal"
                                                                Text="مرحل" meta:resourcekey="lblTransferBalanceResource1"></asp:Label>
                                                             <asp:Label ID="lblTransferBalance" runat="server" SkinID="Label_CopyRightsNormal"
                                                                Text="0" ></asp:Label>

                                                            <asp:Label ID="lblConsumedT" runat="server" SkinID="Label_CopyRightsNormal"
                                                                Text="مرحل" ></asp:Label>
                                                             <asp:Label ID="lblTransferConsumed" runat="server" SkinID="Label_CopyRightsNormal"
                                                                Text="0" ></asp:Label>

                                                            <asp:Label ID="lblRemainT" runat="server" SkinID="Label_CopyRightsNormal"
                                                                Text="مرحل" meta:resourcekey="lblTransferBalanceResource1"></asp:Label>
                                                             <asp:Label ID="lblTransferRemain" runat="server" SkinID="Label_CopyRightsNormal"
                                                                Text="0" ></asp:Label>
                                                              &nbsp;&nbsp;
                                                            <asp:Label ID="lblCompLbl" runat="server" SkinID="Label_CopyRightsNormal"
                                                                Text="تعويض" meta:resourcekey="lblTransferBalanceResource1"></asp:Label>
                                                             <asp:Label ID="lblCompData" runat="server" SkinID="Label_CopyRightsNormal"
                                                                Text="0" ></asp:Label>

                                                            <asp:Label ID="lblCompConsumedLbl" runat="server" SkinID="Label_CopyRightsNormal"
                                                                Text="تعويض" ></asp:Label>
                                                             <asp:Label ID="lblCompConsumedData" runat="server" SkinID="Label_CopyRightsNormal"
                                                                Text="0" ></asp:Label>

                                                            <asp:Label ID="lblCompRemainLbl" runat="server" SkinID="Label_CopyRightsNormal"
                                                                Text="تعويض" meta:resourcekey="lblTransferBalanceResource1"></asp:Label>
                                                             <asp:Label ID="lblCompRemainData" runat="server" SkinID="Label_CopyRightsNormal"
                                                                Text="0" ></asp:Label>
                                                        </td>
                                                    </tr>
                                                </table>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblWebDateChooser1" runat="server" Width="90px" meta:resourcekey="lblWebDateChooser1Resource1"
                                                                SkinID="Label_DefaultNormal" Text="تاريخ البدء"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="labelRemainVal" runat="server" Width="90px" SkinID="Label_DefaultNormal"
                                                                Text="الباقي" meta:resourcekey="labelRemainValResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblWebDateChooser2" runat="server" Width="90px" meta:resourcekey="lblWebDateChooser2Resource1"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="LabelArea">
                                                                <asp:Label ID="lblvactiondays" runat="server" Width="90px" SkinID="Label_DefaultNormal"
                                                                    Text="المستهلكة" meta:resourcekey="lblvactiondaysResource1"></asp:Label>
                                                            </td>
                                                            <td class="DataArea">
                                                ...
                                                <td style="width: 47%; height: 16px; vertical-align: top">
                                                    <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td class="LabelArea">
                                                                <asp:Label ID="lblWebDateChooser3" runat="server" Width="90px" meta:resourcekey="lblWebDateChooser3Resource1"
                                                                    SkinID="Label_DefaultNormal" Text="تاريخ الرجوع المتوقع"></asp:Label>
                                                            </td>
                                                            <td class="DataArea">
                                                                <igsch:WebDateChooser ID="WebDateChooser3" runat="server" BorderColor="#CCCCCC" BorderStyle="Solid"
                                                                    BorderWidth="1px" Height="18px" NullDateLabel="" Style="font-family: Tahoma;
                                                                    font-size: 8pt; font-weight: Normal; color: Black; border: solid 1px #CCCCCC"
                                                                    Width="130px">
                                                                    <AutoPostBack ValueChanged="True" />
                                                                </igsch:WebDateChooser>
                                                                           <asp:Label ID="LblEndDate" runat="server" Width="90px" meta:resourcekey="lblEndDateResource1"
                                                                                        SkinID="Label_DefaultNormal" Text="تاريخ انتهاء الاجازة "></asp:Label>
                                                                         <asp:Label ID="TxtEndDate" runat="server" Width="90px" 
                                                                                    SkinID="Label_DefaultNormal" Text=""></asp:Label>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblRemarks" Width="90px" runat="server" Text="ملاحظات"
                                                        ...
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="txtRemarks" runat="server" SkinID="TextBox_LargeNormalC"
                                                                 MaxLength="255" meta:resourcekey="lblDescEnglishNameResource1"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                                        ...
                                                        <Bands>
                                                            <igtbl:UltraGridBand meta:resourcekey="UltraGridBandResource1">
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <igtbl:UltraGridColumn BaseColumnName="IsContracial" DataType="System.Boolean" Hidden="True"
                                                                        Key="IsContracial" meta:resourcekey="UltraGridColumnResource9" Type="CheckBox"
                                                                        Width="10%">
                                                                    ...
                                                                    <igtbl:UltraGridColumn BaseColumnName="ID" DataType="System.Int32" Hidden="True"
                                                                     ...
                                                                     <igtbl:UltraGridColumn BaseColumnName="PaymentTrnID" DataType="System.Int32" Hidden="True"
                                                                        Key="PaymentTrnID" meta:resourcekey="UltraGridColumnResource10">
                                                                        <Header>
                                                                            <RowLayoutColumnInfo OriginX="9" />
                                                                        </Header>
                                                                        <Footer>
                                                                   ...
                                                                   <igtbl:UltraGridColumn BaseColumnName="TotalDays" DataType="System.int"
                                                                         Key="TotalDays" meta:resourcekey="UltraGridColumnResource11" Width ="10%">
                                                                        <Header Caption="Total Days">
                                                                            <RowLayoutColumnInfo OriginX="3" />
                                                                        </Header>
                                                                        <Footer>
                                                                            <RowLayoutColumnInfo OriginX="3" />
                                                                      ...
                                                                      <igtbl:UltraGridColumn BaseColumnName="ConsumDays" DataType="System.Int32" 
                                                                        Key="ConsumDays" meta:resourcekey="UltraGridColumnResource15" Width="10%">
                                                                    ...
                                                                    <igtbl:UltraGridColumn BaseColumnName="vactiondays" DataType="System.Int32" 
                                                                        Key="vactiondays" meta:resourcekey="UltraGridColumnResource12" Width="10%">
                                                                        <Header Caption="vactiondays">
                                                                            <RowLayoutColumnInfo OriginX="9" />
                                                                        </Header>
                                                                        <Footer>
                                                                            <RowLayoutColumnInfo OriginX="9" />
                                                                    ...
                                                                    <igtbl:UltraGridColumn BaseColumnName="RemainingDays" DataType="System.Int32" 
                                                                        Key="RemainingDays" meta:resourcekey="UltraGridColumnResource14" Width="10%">
                                                                        <Header Caption="RemainingDays">
                                                                            <RowLayoutColumnInfo OriginX="9" />
                                                                        </Header>
                                                                        <Footer>
                                                                            <RowLayoutColumnInfo OriginX="9" />
