<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmProjects.aspx.vb" Inherits="frmProjects"
...
<head runat="server">
    <title>* Venus Payroll * ~Projects</title>
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmProjects" runat="server">
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="DataAreawithsearch">
                                                            <asp:TextBox ID="TxtCostCenter1" runat="server" SkinID="TextBox_SmalltNormalC" MaxLength="30" meta:resourcekey="txtCodeResource1" ></asp:TextBox>
                                                        </td>
                                                        <td class="search">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="Label1" runat="server" Width="80px" SkinID="Label_DefaultNormal"
                                                                    Text="2 مركز التكلفة" meta:resourcekey="lblCost2Resource1"></asp:Label>
                                                        </td>
                                                        <td class="DataAreawithsearch">
                                                            <asp:TextBox ID="TxtCostCenter2" runat="server" SkinID="TextBox_SmalltNormalC" MaxLength="30" meta:resourcekey="txtCodeResource1" ></asp:TextBox>
                                                        </td>
                                                        <td class="search">
                                                            <table style="width:100%">
                                                            <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="DataAreawithsearch">
                                                            <asp:TextBox ID="TxtCostCenter3" runat="server" SkinID="TextBox_SmalltNormalC" MaxLength="30" meta:resourcekey="txtCodeResource1" ></asp:TextBox>
                                                        </td>
                                                        <td class="search">
                                                            <table style="width:100%">
                                                            <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="DataAreawithsearch">
                                                            <asp:TextBox ID="TxtCostCenter4" runat="server" SkinID="TextBox_SmalltNormalC" MaxLength="30" meta:resourcekey="txtCodeResource1" ></asp:TextBox>
                                                        </td>
                                                        <td class="search">
                                                            <table style="width:100%">
                                                            <tr>
