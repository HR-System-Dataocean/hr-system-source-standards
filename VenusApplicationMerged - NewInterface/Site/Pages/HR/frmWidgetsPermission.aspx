<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmWidgetsPermission.aspx.vb"
    Inherits="frmWidgetsPermission" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
...
<head runat="server">
    <title>* Venus Payroll * ~Modules Permission</title>
    ...
    <script language="javascript" src="Scripts/app_modulespermissions.js" type="text/javascript"></script>
</head>
<body style="margin: 0; padding: 0;">
    <form id="frmWidgetsPermission" runat="server">
                                    ...
                                    <table style="width: 100%; height: 100%; min-height: 350px; vertical-align: top"
                                                ...
                                                <table style="width: 100%; height: 30px; vertical-align: bottom; border-bottom: 1px solid black"
                                                    ...
                                                    <tr>
                                                        <td style="vertical-align: bottom">
                                                            <asp:Label ID="Label_Title1" runat="server" Text="برجاء تحديد صلاحيات للبرامج" SkinID="Label_DefaultBold"
                                        ...
                                        <tr>
                                            <td style="width: 100%; vertical-align: top" colspan="3">
                                                <igtbl:UltraWebGrid  Browser="UpLevel"   ID="UwgSearchUsers" runat="server" EnableAppStyling="False" Height="268px"
                                                    ...
                                                    <DisplayLayout AllowColSizingDefault="Free" AllowAddNewDefault="Yes" AllowColumnMovingDefault="OnServer"
                                                        ...
                                                        <FrameStyle BackColor="Window" BorderColor="InactiveCaption" BorderStyle="Solid"
                                                            BorderWidth="1px" Font-Names="Microsoft Sans Serif" Font-Size="8.25pt" Height="268px"
                                                            Width="100%">
                                                        </FrameStyle>
                                                        <ClientSideEvents ClickCellButtonHandler="UwgSearchUsers_ClickCellButtonHandler"
                                                            AfterCellUpdateHandler="UwgSearchUsers_AfterCellUpdateHandler" />
                                                        ...
                                                        <igtbl:UltraGridBand meta:resourcekey="UltraGridBandResource1">
                                                            <Columns>
                                                                ...
                                                                <igtbl:UltraGridColumn AllowUpdate="Yes" BaseColumnName="AllowView" CellButtonDisplay="Always"
                                                                    DataType="System.Boolean" Type="CheckBox" Width="90px" meta:resourcekey="UltraGridColumnResource4">
                                                                    <HeaderStyle HorizontalAlign="Center" />
