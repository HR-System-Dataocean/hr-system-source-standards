<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmEmployeesHmsTotalCommission.aspx.vb"
    ...
    <script type="text/javascript" id="igClientScript">
        ...
        function uwg_AfterCellUpdateHandler(gridName, cellId) {
            ...
            if (Deduction2.Id === cellId) {
                ...
                DueAmount.setValue(NetAmount.getValue() - Deduction2.getValue());
            }
                                                ...
                                                <igtbl:UltraWebGrid   Browser="UpLevel"  ID="UWGEmployeesCommission" runat="server" EnableAppStyling="True"
                                                    ...
                                                    <Bands>
                                                        <igtbl:UltraGridBand meta:resourcekey="UltraGridBandResource4">
                                                            ...
                                                            <Columns>
                                                                <igtbl:UltraGridColumn Width="5%" Key="Selected" AllowUpdate="Yes" Type="CheckBox" meta:resourcekey="UltraGridColumnResource2">
                                                                    <Header Caption="√">
                                                                   ...
                                                                   <igtbl:UltraGridColumn BaseColumnName="EmployeeCode" Width="10%"   AllowUpdate="No" Key="EmployeeCode"  
                                                                 ...
                                                                 <igtbl:UltraGridColumn BaseColumnName="EmployeeName" AllowUpdate="No" 
                                                                    Key="EmployeeName" Width="25%" meta:resourcekey="UltraGridColumnResource115">
                                                                    ...
                                                                    <igtbl:UltraGridColumn BaseColumnName="NetAmount" AllowUpdate="No" Key="NetAmount" Width="15%" 
                                                                  ...
                                                                  <igtbl:UltraGridColumn BaseColumnName="Deduction2" Key="Deduction2" Width="20%" 
                                                                    DataType="System.double" meta:resourcekey="UltraGridColumnResource5">
                                                                ...
                                                                <igtbl:UltraGridColumn BaseColumnName="DueAmount" AllowUpdate="No" Key="DueAmount" Width="15%" 
                                                                    DataType="System.double" meta:resourcekey="UltraGridColumnResource5">
