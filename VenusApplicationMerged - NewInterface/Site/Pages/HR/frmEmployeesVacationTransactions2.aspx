<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmEmployeesVacationTransactions2.aspx.vb"
                            ...
                            <igtab:Tab Text="عام" meta:resourcekey="TabResource1">
                                <ContentTemplate>
                                    ...
                                    <table style="width: 100%; height: 100%; vertical-align: top" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="DataArea">
                                                            <igtxt:WebMaskEdit ID="wdtHPaymentDate" runat="server" AutoPostBack="True" DataMode="RawText"
                                                                InputMask="##/##/####" meta:resourcekey="wdtHPaymentDateResource1" SkinID="WebMaskEdit_Fix">
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="DataArea">
                                                            <igtxt:WebNumericEdit ID="txtPreparedDays" runat="server" SkinID="WebNumericEdit_Fix"
                                                                MinValue="0" MaxValue="999" Nullable="False" MaxLength="3" meta:resourcekey="txtPreparedDaysResource1">
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="DataArea">
                                                            <igtxt:WebNumericEdit ID="lblNetSalary" runat="server" MinValue="0" Nullable="False"
                                        ...
                                        <tr>
                                            <td colspan="3">
                                               <igtbl:UltraWebGrid   Browser="UpLevel"  ID="uwgVactionInfo" runat="server" EnableAppStyling="True"
                                                    ...
                                                    <Bands>
                                                        <igtbl:UltraGridBand meta:resourcekey="UltraGridBandResource3">
                                                            ...
                                                            <Columns>
                                                                <igtbl:UltraGridColumn AllowGroupBy="No" AllowUpdate="No" BaseColumnName="RequiredWorkingDays"
                                                                    Key="RequiredWorkingDays" meta:resourcekey="UltraGridColumnRequiredWorkingDays" Type="NotSet" 
                                                                    Width="16%">
                                                                    <Header Caption="RequiredWorkingDays">
                                                                    </Header>
                                                                    <CellStyle CssClass="DescriptionCellgrid">
                                                                    </CellStyle>
                                                                </igtbl:UltraGridColumn>
                                                                 <igtbl:UltraGridColumn AllowGroupBy="No" AllowUpdate="No" BaseColumnName="Duration"
                                                                    Key="Duration" meta:resourcekey="UltraGridColumnRequiredDuration" Type="NotSet" 
                                                                    Width="10%">
                                                                 ...
                                                                 <igtbl:UltraGridColumn AllowGroupBy="No" AllowUpdate="No" BaseColumnName="FromDate"

                                                                    Key="FromDate" meta:resourcekey="UltraGridColumnFromDate" Type="NotSet" 
                                                                    Width="12%">
                                                                ...
                                                                <igtbl:UltraGridColumn AllowUpdate="No" BaseColumnName="ToDate"  
                                                                     Key="ToDate" meta:resourcekey="UltraGridColumnToDate"
                                                                    Width="12%">
                                                                ...
                                                                <igtbl:UltraGridColumn AllowUpdate="No"  BaseColumnName="TotalDays" Key="TotalDays" 
                                                                    meta:resourcekey="UltraGridColumnTotalDays" Width="10%">
                                                                    <Header Caption="TotalDays">
                                                                ...
                                                                <igtbl:UltraGridColumn AllowUpdate="No" BaseColumnName="DeductionDays" 
                                                                    Key="DeductionDays" meta:resourcekey="UltraGridColumnDeductionDays" Width="10%">
                                                                    <Header Caption="DeductionDays">
                                                                ...
                                                                <igtbl:UltraGridColumn BaseColumnName="NetDays" AllowUpdate ="No"   Key="NetDays" 
                                                                    meta:resourcekey="UltraGridColumnNetDays"
                                                                    Width="10%">
                                                                    <Header Caption="NetDays">
                                                                 ...
                                                                 <igtbl:UltraGridColumn BaseColumnName="VactionBalance" AllowUpdate ="No"  Key="VactionBalance" 
                                                                    meta:resourcekey="UltraGridColumnNetDays" DataType="System.Double"
                                                                    Width="10%">
                                                                    <Header Caption="VactionBalance">
                                                                        <RowLayoutColumnInfo OriginX="4" />
                                                                    </Header>
                                                                    <Footer>
                                                                        <RowLayoutColumnInfo OriginX="4" />
                                                                ...
                                                                <igtbl:UltraGridColumn BaseColumnName="Amount"  Key="Amount" AllowUpdate ="No" 
                                                                    meta:resourcekey="UltraGridColumnNetDays" DataType="System.Double"
                                                                    Width="10%">
                                        ...
                                        <tr>
                                            <td style="height: 30px; vertical-align: top;" colspan="3">
                                                <igtbl:UltraWebGrid  Browser="UpLevel"   ID="uwgVacationHistory" runat="server" EnableAppStyling="True"
                                                    Height="100%" SkinID="Default" Width="100%" meta:resourcekey="uwgVacationHistoryResource1">
