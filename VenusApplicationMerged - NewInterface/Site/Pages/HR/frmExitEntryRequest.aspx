<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmExitEntryRequest.aspx.vb"
...
<head runat="server">
    <title>* Venus Payroll * ~Exit & Entry Request</title>
    ...
    <script type="text/javascript" id="igClientScript">
        ...
        function OpenPrintedScreen(v) {
            ...
            var win = window.open("../../Interfaces/frmReportsGridViewer.aspx?Language=false&Criteria=RequestSerial&preview=1&ReportCode=CF_147&sq0=''&v=" + v, "_NEW", "height=" + hight + ",width=" + width + ",resizable=0,menubar=0,toolbar=0,location=0,directories=0,scrollbars=0,status=0,center=0");
            win.focus();
        }
    </script>
    <style type="text/css">
            ...
            <tr>
                <td class="Details">
                    <igtab:UltraWebTab ID="UltraWebTab1" runat="server" EnableAppStyling="True" SkinID="Default"
                        ...
                        <Tabs>
                            <igtab:Tab Text="Exit & Entry Request" meta:resourcekey="TabResource1">
                                <ContentTemplate>
                                        ...
                                        <tr>
                                            <td style="width: 6%; height: 16px; vertical-align: top">
                                                <table style="width: 47%; vertical-align: top" cellspacing="0">
                                                    ...
                                                    <td class="LabelArea">
    <asp:Label ID="LblExitDate" runat="server" Width="120px" meta:resourcekey="LblExitDateResource1"
        SkinID="Label_DefaultNormal" Text=" Exit Date"></asp:Label>
</td>
<td class="DataArea">
    <igsch:WebDateChooser ID="txtExitDate" runat="server" BorderColor="#CCCCCC" BorderStyle="Solid"
        BorderWidth="1px" Height="18px" NullDateLabel="" Style="font-family: Tahoma;
        font-size: 8pt; font-weight: Normal; color: Black; border: solid 1px #CCCCCC"
        Width="130px">
     ...
     <td class="LabelArea">
        <asp:Label ID="LblEntryDate" runat="server" Width="120px" meta:resourcekey="LblEntryDateResource1"
            SkinID="Label_DefaultNormal" Text=" Entry Date"></asp:Label>
    </td>
    <td class="DataArea">
        <igsch:WebDateChooser ID="txtEntryDate" runat="server" BorderColor="#CCCCCC" BorderStyle="Solid"
            BorderWidth="1px" Height="18px" NullDateLabel="" Style="font-family: Tahoma;
            font-size: 8pt; font-weight: Normal; color: Black; border: solid 1px #CCCCCC"
            Width="130px">
            <AutoPostBack ValueChanged="True" />
