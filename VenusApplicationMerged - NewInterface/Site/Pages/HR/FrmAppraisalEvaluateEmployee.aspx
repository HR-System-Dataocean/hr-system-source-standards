<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmAppraisalEvaluateEmployee.aspx.vb"
...
<body style="height: 100%; margin: 0; padding: 0;">
    ...
    <td class="LabelArea">
        <asp:Label ID="lblObjectionDetais" runat="server" Width="90px" Text="تفاصيل الاعتراض" SkinID="Label_DefaultNormal"
            meta:resourcekey="lblObjectionDetaisResource1"></asp:Label>
    </td>
    <td class="DataArea">
        <asp:TextBox ID="txtObjectionDetais" runat="server" SkinID="TextBox_LargeNormalC" 
            ReadOnly="True" MaxLength="255" TextMode="MultiLine" Rows="3"  meta:resourcekey="txtObjectionDetaisResource1">
       </asp:TextBox>
    </td>
