<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmEmployeesExcuses.aspx.vb"
    Inherits="frmEmployeesExcuses" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmEmployeesExcuses" runat="server">
        <div style="display: none">
            <asp:TextBox ID="lbExcuseID" runat="server" Visible="False"></asp:TextBox>
                                    ...
                                    <ContentTemplate>
                                        <table style="width: 100%; vertical-align: top"
                                            ...
                                            <tr>
                                                                ...
                                                                <td>
                                                                    <table cellspacing="0" style="width: 100%; vertical-align: top">
                                                                        <tr>
                                                                            <td class="SeparArea"></td>
                                                                            <td class="LabelArea">
                                                                                <asp:Label ID="lblExcusesType" runat="server" meta:resourcekey="lblExcusesTImeResource1" SkinID="Label_DefaultNormal" Text="وقت الإذن" Width="90px"></asp:Label>
                                                                            </td>
                                                                            <td class="DataArea">
                                                                                <asp:DropDownList ID="DdlExcuseType" runat="server" AutoPostBack="true" meta:resourcekey="DdlExcusesTypeResource1" SkinID="DropDownList_SmalltNormal" TabIndex="3">
                                                                                    <asp:ListItem Value="0" meta:resourcekey="lblSelectResource1">حدد الخيار</asp:ListItem>
                                                                                    ...
                                                                                    <asp:ListItem meta:resourcekey="lblAllShiftResource1" Value="Full">كامل الدوام</asp:ListItem>
                                                                                    <asp:ListItem meta:resourcekey="lblInShiftResource1" Value="Duting">خلال الدوام</asp:ListItem>
                                                                                </asp:DropDownList>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                ...
                                                                <td>
                                                                    <table cellspacing="0" style="width: 100%; vertical-align: top">
                                                                        <tr>
                                                                            <td class="SeparArea"></td>
                                                                            <td class="LabelArea">
                                                                                <asp:Label ID="Label4" runat="server" meta:resourcekey="lblExcusesTypeResource1" SkinID="Label_DefaultNormal" Text="نوع الإذن" Width="90px"></asp:Label>
                                                                            </td>
                                                                            <td class="DataArea">
                                                                                <asp:DropDownList ID="DdlExcuseCalcType" runat="server" AutoPostBack="true" meta:resourcekey="DdlExcusesTypeResource1" SkinID="DropDownList_SmalltNormal" TabIndex="3">
                                                                                    <asp:ListItem Value="0" meta:resourcekey="lblSelectResource1">حدد الخيار</asp:ListItem>
                                                                                    <asp:ListItem meta:resourcekey="lblNoSubResource1" Value="1">إذن غير مخصوم</asp:ListItem>
                                                                                    <asp:ListItem meta:resourcekey="lblBackTimeResource1" Value="2">تايم باك </asp:ListItem>
                                                                                    <asp:ListItem meta:resourcekey="lblEmployeePayedResource1" Value="3"> اذن علي حساب الموظف</asp:ListItem>
                                                                                </asp:DropDownList>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                ...
                                                                <td>
                                                                    <table cellspacing="0" style="width: 100%; vertical-align: top">
                                                                        <tr>
                                                                            <td class="SeparArea"></td>
                                                                            <td class="LabelArea">
                                                                                <asp:Label ID="ExcuseTargetLabel" runat="server" meta:resourcekey="lblExcuseTargetResource" SkinID="Label_DefaultNormal" Text="سبب الإستئذان" Width="90px"></asp:Label>
                                                                            </td>
                                                                            <td class="DataArea">
                                                                                <asp:DropDownList ID="DdlExcuseTarget" runat="server" AutoPostBack="true" meta:resourcekey="DdlExcuseTargetResource" SkinID="DropDownList_SmalltNormal" TabIndex="3">
                                                                                    <asp:ListItem Value="0" meta:resourcekey="lblSelectResource1">حدد الخيار</asp:ListItem>
                                                                                    <asp:ListItem meta:resourcekey="lblMedicalResource1" Value="Sick">عذر مرضي</asp:ListItem>
                                                                                    <asp:ListItem meta:resourcekey="lblBusinessResource1" Value="Business">عذر عمل</asp:ListItem>
                                                                                    <asp:ListItem meta:resourcekey="lblPersonalResource1" Value="Personal">عذر شخصي</asp:ListItem>
                                                                                </asp:DropDownList>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                ...
                                                                <td>
                                                                    <table cellspacing="0" style="width: 100%; vertical-align: top">
                                                                        <tr>
                                                                            ...
                                                                            <td class="DataArea">
                                                                                <igsch:WebDateChooser ID="WebDateChooser1" runat="server" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" EnableAppStyling="True" Height="18px" NullDateLabel="" Style="font-family: Tahoma; font-size: 8pt; font-weight: Normal; color: Black; border: solid 1px #CCCCCC"
                                                                                    Width="130px">
                                                                ...
                                                                <td style="width: 25%; height: 16px; vertical-align: top">
                                                                    <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                                        <tr>
                                                                            <td class="SeparArea"></td>
                                                                            <td class="LabelArea">
                                                                                <asp:Label ID="ExcuseDurationLabel" runat="server" Text="مدة الإستئذان" SkinID="Label_DefaultNormal"
                                                                                    meta:resourcekey="lblExcuseDurationResource" Width="90px"></asp:Label>
                                                                            </td>
                                                                            <td class="DataArea">
                                                                                <asp:TextBox ID="ExcuseDurationTextBox" runat="server" SkinID="TextBox_SmalltNormalC" MaxLength="255"
                                                                                    meta:resourcekey="txtExcuseDurationResource" placeholder="00:00"></asp:TextBox>
                                                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" ValidationGroup="valgrp" runat="server"
                                                                                    ControlToValidate="ExcuseDurationTextBox" ValidationExpression="^([0-1]?[0-9]|2[0-3]):[0-5][0-9]$"
                                                                ...
                                                                <td>
                                                                    <table cellspacing="0" style="width: 100%; vertical-align: top; height: 18px;">
                                                                        <tr>
                                                                            <td class="SeparArea"></td>
                                                                            <td class="LabelArea">
                                                                                <asp:Label ID="labelDescNationality" runat="server" meta:resourcekey="txtNotesResource1" SkinID="Label_DefaultNormal" Text="ملاحظات" Width="90px"></asp:Label>
                                                                            </td>
                                                                            <td class="DataArea">
                                                                                <asp:TextBox ID="txtNotes" runat="server" TextMode="MultiLine" meta:resourcekey="txtNotesResource1" SkinID="TextBox_LargeNormalc" TabIndex="2"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <igtbl:UltraWebGrid   Browser="UpLevel"  ID="uwgEmployeeExcuse" runat="server"
                                                            EnableAppStyling="True" Height="100%" 
                                                            meta:resourcekey="uwgEmployeeVacationsResource1" 
                                                            SkinID="Default" Width="99%">
                                                            <DisplayLayout AllowColSizingDefault="Free" 
                                                                ...
                                                                GridLinesDefault="NotSet" 
                                                                HeaderClickActionDefault="SortMulti" 
                                                                Name="uwgEmployeeVacations"
                                                                ...
                                                                <FrameStyle BackColor="Window" BorderColor="InactiveCaption" BorderStyle="Solid" BorderWidth="1px" Font-Names="Microsoft Sans Serif" Font-Size="8.25pt" Height="100%" Width="99%">
                                                                </FrameStyle>
                                                            ...
                                                            <Bands>
                                                                <igtbl:UltraGridBand meta:resourcekey="UltraGridBandResource1" AllowSorting="Yes">
                                                                    <AddNewRow View="NotSet" Visible="NotSet">
                                                                    </AddNewRow>
                                                                    <Columns>
                                                                        <igtbl:UltraGridColumn BaseColumnName="ID" DataType="System.Int32" Hidden="True" Key="ID">
                                                                        </igtbl:UltraGridColumn>
                                                                        <igtbl:UltraGridColumn AllowUpdate="No" Hidden="true" BaseColumnName="ExcuseTarget" Key="ExcuseTarget" meta:resourceKey="UltraGridColumnResource0" Width="15%">
                                                                        ...
                                                                        <igtbl:UltraGridColumn AllowUpdate="No" BaseColumnName="ExcuseType" Key="ExcuseType" meta:resourcekey="UltraGridColumnResource1" Type="DropDownList" Width="15%">
                                                                            <Header>
                                                              ...
                                                              <igtbl:UltraGridColumn AllowUpdate="No" BaseColumnName="ExcuseCalcTypeName" Key="ExcuseCalcTypeName" meta:resourcekey="UltraGridColumnResource11" Type="DropDownList" Width="15%">
                                                                     <Header>
                                                                             <RowLayoutColumnInfo OriginX="2" />
                                                                      </Header>
                                                                      <Footer>
                                                                        ...
                                                                        <igtbl:UltraGridColumn AllowUpdate="No" BaseColumnName="ExcuseTarget" Key="ExcuseType" meta:resourcekey="UltraGridColumnResource2" Type="DropDownList" Width="15%">
                                                                            <Header Caption="سبب الأستئذان">
                                                                                <RowLayoutColumnInfo OriginX="2" />
                                                                            </Header>
                                                                            <Footer>
                                                                                <RowLayoutColumnInfo OriginX="2" />
                                                                        ...
                                                                        <igtbl:UltraGridColumn AllowUpdate="No" BaseColumnName="ExcuseDate" DataType="System.DateTime" Format="dd/MM/yyyy" Key="ExcuseDate" meta:resourcekey="UltraGridColumnResource22" Width="15%">
                                                                        ...
                                                                        <igtbl:UltraGridColumn AllowUpdate="No" BaseColumnName="ExcuseHours" Key="ExcuseHours" meta:resourceKey="UltraGridColumnResource3" Width="15%">
                                                                            <HeaderStyle HorizontalAlign="Center" />
                                                                            <CellStyle HorizontalAlign="Center">
                                                                            </CellStyle>
                                                                            <Header Caption="مدة الإستئذان">
                                                                        ...
                                                                        <igtbl:UltraGridColumn AllowUpdate="No" BaseColumnName="Shift" Key="Shift" meta:resourceKey="UltraGridColumnResource4" Width="15%">
                                                                            <HeaderStyle HorizontalAlign="Center" />
                                                                            <CellStyle HorizontalAlign="Center">
                                                                            </CellStyle>
                                                                            <Header Caption="الوردية">
                                                                        ...
                                                                        <igtbl:UltraGridColumn AllowUpdate="No" BaseColumnName="Notes" Key="Notes" meta:resourceKey="UltraGridColumnResource5" Width="50%">
                                                                            <CellStyle HorizontalAlign="Center">
                                                                            </CellStyle>
                                                                            <Header Caption="الملاحظات">
                                                                                <RowLayoutColumnInfo OriginX="6" />
                                                                            </Header>
                                                                            <Footer>
                                                                                <RowLayoutColumnInfo OriginX="6" />
