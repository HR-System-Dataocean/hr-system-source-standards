<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmEvalEvaluationTypes.aspx.vb"
    Inherits="frmEvalEvaluationTypes" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmEvalEvaluationTypes" runat="server">
                ...
                <td style="width: 100%; height: 60px; vertical-align: top" colspan="3">
                    <table style="width: 100%; height: 18px; vertical-align: top; border-bottom: 1px solid silver">
                        <tr>
                            ...
                            <td style="width: 40px">
                                <asp:Label ID="Label1" runat="server" Text="|" meta:resourcekey="Label_TSP2Resource1"></asp:Label>
                            </td>
                            <td style="width: 24px">
                                <asp:ImageButton ID="ImageButton_0" Width="16px" Height="16px" runat="server" CommandArgument="btnSC"
                                    ImageUrl="~/Pages/HR/Img/forum_newmsg.gif" meta:resourcekey="btnScalcs" />
                            </td>
                            <td style="width: 24px">
                                <asp:ImageButton ID="ImageButton_1" Width="16px" Height="16px" meta:resourcekey="btnModules"
                                    runat="server" CommandArgument="btnMO" ImageUrl="~/Pages/HR/Img/discuss_16.gif" />
                            </td>
                            <td style="width: 24px">
                                <asp:ImageButton ID="ImageButton_2" Width="15px" Height="12px" meta:resourcekey="btnCha"
                                    runat="server" CommandArgument="btnCH" ImageUrl="~/Pages/HR/Img/i.p.edit.gif" />
                            </td>
                            <td style="width: 40px">
                                &nbsp;
                            </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblCode" runat="server" Text="الكود" SkinID="Label_DefaultNormal"
                                                                meta:resourcekey="lblCodeResource1" Width="95px"></asp:Label>
                                                        </td>
                                                        <td style="width: 5px;">
                                                            <asp:Label ID="Label_Star1" runat="server" meta:resourcekey="Label_Star1Resource1"
                                                                Style="color: #FF0000" Text="*"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="txtCode" runat="server" AutoPostBack="True" MaxLength="30" meta:resourcekey="txtCodeResource1"
                                                                SkinID="TextBox_SmalltNormalC"></asp:TextBox>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblEngName" runat="server" Text="التوصيف إنجليزى" SkinID="Label_DefaultNormal"
                                                                meta:resourcekey="lblEngNameResource1" Width="95px"></asp:Label>
                                                        </td>
                                                        <td style="width: 5px;">
                                                            &nbsp;&nbsp;
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblArbName" runat="server" Text="التوصيف عربى" SkinID="Label_DefaultNormal"
                                                                meta:resourcekey="lblArbNameResource1" Width="95px"></asp:Label>
                                                        </td>
                                                        <td style="width: 5px;">
                                                            &nbsp;&nbsp;
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lbl0" runat="server" meta:resourcekey="lbl0Resource1" SkinID="Label_DefaultNormal"
                                                                Text="Evaluation Power" Width="95px"></asp:Label>
                                                        </td>
                                                        <td style="width: 5px;">
                                                            &nbsp;&nbsp;
                                                        </td>
                                                        <td class="DataArea">
                                                            <igtxt:WebNumericEdit ID="txtEPower" runat="server" meta:resourcekey="txtEPowerResource1"
                                                                MinValue="0" NullText="0" SkinID="WebNumericEdit_Fix">
