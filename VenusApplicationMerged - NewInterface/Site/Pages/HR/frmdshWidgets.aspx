<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmdshWidgets.aspx.vb" Inherits="frmdshWidgets"
...
<head runat="server">
    <title>* Venus Payroll * ~Branches</title>
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmdshWidgets" runat="server">
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="DataAreawithsearch" style="height: 16px">
                                                        ...
                                                        <td class="search" style="height: 16px">
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblPage" runat="server" meta:resourcekey="lblPageResource1" SkinID="Label_DefaultNormal"
                                                                Text="الصفحة"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="DdlPage" runat="server" SkinID="DropDownList_LargNormal">
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                </table>
                                            ...
                                            <td style="width: 47%">
                                                <table style="width: 100%; height: 100%">
                                                    <tr>
                                                        ...
                                                        <td style="width: 90px;">
                                                            <asp:Label ID="lblSrc" runat="server" Text="المصدر" meta:resourcekey="lblSrcResource1"
                                                                SkinID="Label_DefaultNormal"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="txtSrc" runat="server" SkinID="TextBox_LargeNormalrtl" MaxLength="255"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table cellspacing="0" style="width: 100%; vertical-align: top">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblCol" runat="server" meta:resourcekey="lblColResource1" SkinID="Label_DefaultNormal"
                                                                Text="العمود"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <igtxt:WebNumericEdit ID="txtCol" runat="server" DataMode="Int" MinValue="0" NullText="0"
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table cellspacing="0" style="width: 100%; vertical-align: top">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblViewType" runat="server" meta:resourcekey="lblViewTypeResource1"
                                                                SkinID="Label_DefaultNormal" Text="طريقة العرض"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:RadioButton ID="rbchart" runat="server" SkinID="RadioButton_DefaultNormal" 
                                                                Text="Chart" meta:resourcekey="rbchartResource1" GroupName="VT" />
                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                            <asp:RadioButton ID="rbpie" runat="server" SkinID="RadioButton_DefaultNormal" 
                                                                Text="Pie" meta:resourcekey="rbpieResource1" GroupName="VT" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table cellspacing="0" style="width: 100%; vertical-align: top">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblRws" runat="server" meta:resourcekey="lblRwsResource1" SkinID="Label_DefaultNormal"
                                                                Text="الصف"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <igtxt:WebNumericEdit ID="txtRws" runat="server" DataMode="Int" MinValue="0" NullText="0"
                                                                SkinID="WebNumericEdit_Default" ValueText="0">
                                                            </igtxt:WebNumericEdit>
                                                        </td>
                                                    </tr>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table cellspacing="0" style="width: 100%; vertical-align: top">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblOrientation" runat="server" meta:resourcekey="lblOrientationResource1"
                                                                SkinID="Label_DefaultNormal" Text="إتجاه العرض"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:RadioButton ID="rbHorizontal" runat="server" 
                                                                SkinID="RadioButton_DefaultNormal" Text="Horizontal" 
                                                                meta:resourcekey="rbHorizontalResource1" GroupName="O" />
                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                            <asp:RadioButton ID="rbVertical" runat="server" 
                                                                SkinID="RadioButton_DefaultNormal" Text="Vertical" 
                                                                meta:resourcekey="rbVerticalResource1" GroupName="O" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
