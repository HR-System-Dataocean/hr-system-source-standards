<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmBusinessORTrainingTravel.aspx.vb"
    Inherits="frmBusinessORTrainingTravel" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
...
<head runat="server">
    ...
    <script type="text/javascript" id="igClientScript">
        ...
        function OpenPrintedScreen(v) {
            ...
            var win = window.open("../../Interfaces/frmReportsGridViewer.aspx?Language=false&Criteria=RequestSerial&preview=1&ReportCode=CF_145&sq0=''&v=" + v, "_NEW", "height=" + hight + ",width=" + width + ",resizable=0,menubar=0,toolbar=0,location=0,directories=0,scrollbars=0,status=0,center=0");
            win.focus();
        }
    </script>
    <style type="text/css">
...
<body style="margin: 0; padding: 0;">
    <form id="frmBusinessORTrainingTravel" runat="server" defaultbutton="Button1">
      ...
      <%--  <igsch:WebDateChooser ID="WebDateChooser2" runat="server" BorderColor="#CCCCCC" BorderStyle="Solid"
            ...
            <AutoPostBack ValueChanged="True" />
                               ...
                               <tr>
                                                    ...
                                                    <td class="LabelArea">
    <asp:Label ID="LblFromDate" runat="server" Width="120px" meta:resourcekey="LblFromDateResource1"
        SkinID="Label_DefaultNormal" Text=" Exit Date"></asp:Label>
</td>
<td class="DataArea">
    <igsch:WebDateChooser ID="txtFromDate" runat="server" BorderColor="#CCCCCC" BorderStyle="Solid"
     ...
     <td class="LabelArea">
        <asp:Label ID="LblToDate" runat="server" Width="120px" meta:resourcekey="LblToDateResource1"
            SkinID="Label_DefaultNormal" Text=" Entry Date"></asp:Label>
    </td>
    <td class="DataArea">
     ...
     <td class="LabelArea">
         <asp:Label ID="lblTravelReason" runat="server" Width="50px" SkinID="Label_DefaultNormal"
             Text="سبب السفر" meta:resourcekey="lblTravelReasonResource1"></asp:Label>
     </td>
 
     <td class="DataArea">
         <asp:DropDownList ID="ddlTravelReason" Width="200px" AutoPostBack="true" runat="server" SkinID="DropDownList_smallNormal"
             meta:resourcekey="ddlTravelReasonResource1" TabIndex="3">
         </asp:DropDownList>
     </td>
