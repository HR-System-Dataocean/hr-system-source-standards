<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmEvalWPoints.aspx.vb"
    Inherits="frmEvalWPoints" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
...
<head runat="server">
    <title>* Venus Payroll * ~Evaluation Weakness Points</title>
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmEvalWPoints" runat="server">
