<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmTransactionGroups.aspx.vb"
    Inherits="frmTransactionGroups" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
...
<head id="Head1" runat="server">
    <title>* Venus Payroll * ~Transactions Groups</title>
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmTransactionGroups" runat="server">
