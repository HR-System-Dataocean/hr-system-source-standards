<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmContactInformationUpdateStatus.aspx.vb"
...
<head runat="server">
    <title>* Venus Payroll * ~Employee Vacation Request Status</title>
...
<body style="margin: 0; padding: 0;">
    ...
    <Appearance>
            ...
            <tr>
                <td class="Details">
                    <igtab:UltraWebTab ID="UltraWebTab1" runat="server" EnableAppStyling="True" SkinID="Default"
                        ...
                        <Tabs>
                            <igtab:Tab Text="  حالة الطلب" meta:resourcekey="TabResource1">
                                <ContentTemplate>
       ...
       <td class="LblEmpCode" style="min-width: 90px;">
           <asp:Label ID="Label1" runat="server" Text="Emp Code" SkinID="Label_DefaultNormal"
       ...
       <td class="DataArea">
           <asp:TextBox ID="TxtEmpCode" runat="server" SkinID="TextBox_SmalltNormalC" MaxLength="30"
               AutoPostBack="True" meta:resourcekey="TxtEmpCodeResource1" ReadOnly="true">
          </asp:TextBox>
       </td>
       ...
       <td class="LblEmpName" style="min-width: 90px;">
           <asp:Label ID="Label3" runat="server" Text="Emp Name" SkinID="Label_DefaultNormal"
               meta:resourcekey="LblEmpNameResource1"></asp:Label>
       </td>
       <td class="DataArea">
           <asp:TextBox ID="TxtEmpName" runat="server" SkinID="TextBox_SmalltNormalC" MaxLength="30"
               AutoPostBack="True" meta:resourcekey="TxtEmpNameResource1" ReadOnly="true">
          </asp:TextBox>
       </td>
           ...
           <asp:TextBox ID="txtRequestType" runat="server" SkinID="TextBox_SmalltNormalC" MaxLength="30"
               AutoPostBack="True" meta:resourcekey="txtRequestTypeResource1" ReadOnly="true">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblRequestSerial" runat="server" Width="90px" SkinID="Label_DefaultNormal"
                                                                Text="مسلسل الطلب" meta:resourcekey="lblRequestSerialResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="TxtRequestSerial" runat="server" SkinID="TextBox_SmalltNormalc" meta:resourcekey="lbRemainValResource1"
                                                                TabIndex="1" ReadOnly="True"></asp:TextBox>
                                                        </td>
                                                           <td class="SeparArea">
                                                        </td>
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblRequestDate" runat="server" Width="90px" SkinID="Label_DefaultNormal"
                                                                Text="تاريخ الطلب" meta:resourcekey="lblRequestDateResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="TxtRequestDate" runat="server" SkinID="TextBox_SmalltNormalc" meta:resourcekey="lbRemainValResource1"
                                                                TabIndex="1" ReadOnly="True"></asp:TextBox>
                                                        </td>
                                                    </tr>
     ...
     Text="Email" meta:resourcekey="lblEmailResource1"></asp:Label>
                 </td>
                 <td class="DataArea">
                     <asp:TextBox ID="txtOldEmail" Enabled="false" runat="server" SkinID="TextBox_LargeNormalC" meta:resourcekey="txtEmailResource1"></asp:TextBox>
                 </td>
             </tr>
         </table>
     </td>
    ...
    Text="Mobile No" meta:resourcekey="lblMobileResource1"></asp:Label>
                 ...
                 <td class="DataArea">
                     <asp:TextBox ID="txtOldMobile" Enabled="false" runat="server" SkinID="TextBox_LargeNormalC" meta:resourcekey="txtMobileResource1"></asp:TextBox>
                 </td>
             </tr>
         </table>
     </td>
     ...
     <td style="width: 47%; height: 16px; vertical-align: top">
         <table style="width: 100%; vertical-align: top" cellspacing="0">
             <tr>
                 ...
                 <td class="LabelArea">
                     <asp:Label ID="Label2" runat="server" Width="80px" SkinID="Label_DefaultNormal"
     Text="Phone" meta:resourcekey="lblPhoneResource1"></asp:Label>
                 </td>
                 <td class="DataArea">
<asp:TextBox ID="txtOldPhone" runat="server" Enabled="false" SkinID="TextBox_LargeNormalC" meta:resourcekey="txtPhoneResource1"></asp:TextBox>
                 </td>
             </tr>
         </table>
     </td>
     ...
     <td style="width: 47%; height: 16px; vertical-align: top">
         <table style="width: 100%; vertical-align: top" cellspacing="0">
             <tr>
                 ...
                 <td class="LabelArea">
                     <asp:Label ID="Label7" runat="server" SkinID="Label_DefaultNormal" Text="Address"
    Width="80px" meta:resourcekey="lblAddressResource1"></asp:Label>
                 </td>
                 <td class="DataArea">
                     <asp:TextBox ID="txtOldAddress" runat="server" Enabled="false" SkinID="TextBox_LargeNormalC" meta:resourcekey="txtAddressResource1"></asp:TextBox>
                 </td>
             </tr>
         </table>
     </td>
     ...
     <td style="width: 47%; height: 16px; vertical-align: top">
         <table style="width: 100%; vertical-align: top" cellspacing="0">
             <tr>
                 ...
                 <td class="LabelArea">
                     <asp:Label ID="lblEmail" runat="server" Width="80px" SkinID="Label_DefaultNormal"
     Text="Email" meta:resourcekey="lblEmailResource1"></asp:Label>
                 </td>
                 <td class="DataArea">
                  <asp:TextBox ID="txtEmail" Enabled="false" runat="server" SkinID="TextBox_LargeNormalC" meta:resourcekey="txtEmailResource1"></asp:TextBox>
                 </td>
             </tr>
         </table>
     </td>
     ...
     <td style="width: 47%; height: 16px; vertical-align: top">
         <table style="width: 100%; vertical-align: top" cellspacing="0">
             <tr>
                 ...
                 <td class="LabelArea">
                     <asp:Label ID="lblMobile" runat="server" SkinID="Label_DefaultNormal" Text="Mobile"
    Width="80px" meta:resourcekey="lblMobileResource1"></asp:Label>
                 </td>
                 <td class="DataArea">
                     <asp:TextBox ID="txtMobile" Enabled="false" runat="server" SkinID="TextBox_LargeNormalC" meta:resourcekey="txtMobileResource1"></asp:TextBox>
                 </td>
             </tr>
         </table>
     </td>
     ...
     <td style="width: 47%; height: 16px; vertical-align: top">
         <table style="width: 100%; vertical-align: top" cellspacing="0">
             <tr>
                 ...
                 <td class="LabelArea">
                     <asp:Label ID="lblPhone" runat="server" Width="80px" SkinID="Label_DefaultNormal"
     Text="Phone" meta:resourcekey="lblPhoneResource1"></asp:Label>
                 </td>
                 <td class="DataArea">
                     <asp:TextBox ID="txtPhone" Enabled="false" runat="server" SkinID="TextBox_LargeNormalC" meta:resourcekey="txtPhoneResource1"></asp:TextBox>
                 </td>
             </tr>
         </table>
     </td>
     ...
     <td style="width: 47%; height: 16px; vertical-align: top">
         <table style="width: 100%; vertical-align: top" cellspacing="0">
             <tr>
                 ...
                 <td class="LabelArea">
                     <asp:Label ID="lblAddress" runat="server" SkinID="Label_DefaultNormal" Text="Address"
    Width="80px" meta:resourcekey="lblAddressResource1"></asp:Label>
                 </td>
                 <td class="DataArea">
                     <asp:TextBox ID="txtAddress" Enabled="false" runat="server" SkinID="TextBox_LargeNormalC" meta:resourcekey="txtAddressResource1"></asp:TextBox>
                 </td>
             </tr>
         </table>
     </td>
                                                ...
                                                <table>
                                                     <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="LblRemarks" runat="server" Width="90px" SkinID="Label_DefaultNormal"
                                                                Text="ملاحظات" meta:resourcekey="LblRemarksResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="TxtRemarks" runat="server" width="300px" meta:resourcekey="lbRemainValResource1"
                                                                TabIndex="1" TextMode="MultiLine"  ReadOnly="True"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                                            ...
                                                            <igtbl:UltraGridBand meta:resourcekey="UltraGridBandResource1">
                                                                ...
                                                                <Columns>
                                                                    <igtbl:UltraGridColumn BaseColumnName="EmployeeName" Width="35%" DataType="System.Int32" Hidden="False"
                                                                        Key="VacationTypeID" meta:resourcekey="EmployeeNameResource1" Type="DropDownList">
                                                                    ...
                                                                    <igtbl:UltraGridColumn BaseColumnName="Action"  DataType="System.String"
                                                                        Format="dd/MM/yyyy hh:mm tt" Key="Action" meta:resourcekey="UltraGridActionResource4"
                                                                        Width="20%">
                                                                     ...
                                                                     <igtbl:UltraGridColumn BaseColumnName="ActionDate" DataType="System.DateTime"
                                                                        Format="dd/MM/yyyy hh:mm tt" Key="ActionDate" meta:resourcekey="UltraGridActionDateResource4"
                                                                        Width="15%">
                                                                    ...
                                                                    --%>
                                                                     <igtbl:UltraGridColumn BaseColumnName="ActionRemarks" DataType="System.String"
                                                                         Key="ActionRemarks" meta:resourcekey="UltraGridActionRemarksResource4"
                                                                        Width="20%">
