...
#Region "Public Decleration"
    Private ClsAppraisalEvaluatorsTypes As Clshrs_AppraisalEvaluatorsTypes
...
#Region "Protected Sub"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ClsAppraisalEvaluatorsTypes = New Clshrs_AppraisalEvaluatorsTypes(Me.Page)
        Dim ClsObjects As New Clssys_Objects(Page)
        Dim ClsSearchs As New Clssys_Searchs(Page)
        Dim SearchID As Integer = 0
        Try
            Dim clsSearchsColumns As New Clssys_SearchsColumns(Page)
            If ClsObjects.Find(" Code='" & ClsAppraisalEvaluatorsTypes.Table.Trim & "'") Then
            ...
            If Not IsPostBack Then
                Page.Session.Add("ConnectionString", ClsAppraisalEvaluatorsTypes.ConnectionString)
                ClsAppraisalEvaluatorsTypes.AddOnChangeEventToControls("frmProfession", Page, UltraWebTab1)
            ...
            If (txtCode.Text <> "") Then
                ClsAppraisalEvaluatorsTypes.Find(" Code='" & txtCode.Text & "'")
                IntrecordID = ClsAppraisalEvaluatorsTypes.ID
        ...
        Catch ex As Exception
            ...
            mErrorHandler.RecordExceptions_DataBase("", ex, Err.Number, ClsAppraisalEvaluatorsTypes.RegUserID, Venus.Shared.ErrorsHandler.eRecordingType.System_DataBase)
    ...
    Protected Sub ImageButton_Command(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.CommandEventArgs) Handles ImageButton_Save.Command, ImageButton_SaveN.Command, LinkButton_SaveN.Command, ImageButton_New.Command, ImageButton_Print.Command, ImageButton_Properties.Command, LinkButton_Properties.Command, ImageButton_Remarks.Command, LinkButton_Remarks.Command, ImageButton_Last.Command, ImageButton_Next.Command, ImageButton_Back.Command, ImageButton_First.Command, ImageButton_Delete.Command
        ...
        Dim ObjNavigationHandler As New Venus.Shared.Web.NavigationHandler(ClsAppraisalEvaluatorsTypes.ConnectionString)
        Select Case e.CommandArgument
            ...
            Case "New"
                AfterOperation()
            Case "Delete"
                ClsAppraisalEvaluatorsTypes.Delete("Code='" & txtCode.Text & "'")
                AfterOperation()
            Case "Property"
                ClsAppraisalEvaluatorsTypes.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmPropertyScreen.aspx?ID=" & ClsAppraisalEvaluatorsTypes.ID & "&TableName=" & ClsAppraisalEvaluatorsTypes.Table, 477, 313, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Property", False)
            Case "Remarks"
                ClsAppraisalEvaluatorsTypes.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmRemarks.aspx?ID=" & ClsAppraisalEvaluatorsTypes.ID & "&TableName=" & ClsAppraisalEvaluatorsTypes.Table, 410, 210, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Remarks", False)
            Case "Print"
            ...
            Case "First"
                ClsAppraisalEvaluatorsTypes.Find("Code='" & txtCode.Text & "'")
                ClsAppraisalEvaluatorsTypes.FirstRecord()
                GetValues(ClsAppraisalEvaluatorsTypes)
            Case "Previous"
                ClsAppraisalEvaluatorsTypes.Find("Code='" & txtCode.Text & "'")
                If Not ClsAppraisalEvaluatorsTypes.previousRecord() Then
                    ClsAppraisalEvaluatorsTypes.Find("Code='" & txtCode.Text & "'")
            ...
            Case "Next"
                ClsAppraisalEvaluatorsTypes.Find("Code='" & txtCode.Text & "'")
                If Not ClsAppraisalEvaluatorsTypes.NextRecord() Then
                    ClsAppraisalEvaluatorsTypes.Find("Code='" & txtCode.Text & "'")
            ...
            Case "Last"
                ClsAppraisalEvaluatorsTypes.Find("Code='" & txtCode.Text & "'")
                ClsAppraisalEvaluatorsTypes.LastRecord()
                GetValues(ClsAppraisalEvaluatorsTypes)
        End Select
    End Sub
...
#Region "Private Functions"
    Private Function SavePart() As Boolean
        Dim StrMode As String = Request.QueryString.Item("Mode")
        ClsAppraisalEvaluatorsTypes = New Clshrs_AppraisalEvaluatorsTypes(Page)

        Try
            ClsAppraisalEvaluatorsTypes.Find("Code='" & txtCode.Text & "'")

            If ClsAppraisalEvaluatorsTypes.ID > 0 Then
                If Not AssignValue(ClsAppraisalEvaluatorsTypes) Then
                    Exit Function
                End If
                ClsAppraisalEvaluatorsTypes.Update("Code='" & txtCode.Text & "'")

            Else
                If Not AssignValue(ClsAppraisalEvaluatorsTypes) Then
                    Exit Function
                End If
                ClsAppraisalEvaluatorsTypes.Save()

            End If

            ClsAppraisalEvaluatorsTypes.Find("Code='" & txtCode.Text & "'")

            clsMainOtherFields.CollectDataAndSave(value.Text, ClsAppraisalEvaluatorsTypes.Table, ClsAppraisalEvaluatorsTypes.ID)
            value.Text = ""
            Return True
        Catch ex As Exception
            Return False
        End Try
    End Function
    Private Function AssignValue(ByRef ClsAppraisalEvaluatorsTypes As Clshrs_AppraisalEvaluatorsTypes) As Boolean
        Try
            With ClsAppraisalEvaluatorsTypes
                .Code = txtCode.Text
        ...
        End Try
    End Function
    Private Function GetValues(ByVal ClsAppraisalEvaluatorsTypes As Clshrs_AppraisalEvaluatorsTypes) As Boolean
        ...
        Try
            ...
            With ClsAppraisalEvaluatorsTypes
                ...
                If Page.IsPostBack Then
                    CreateOtherFields(ClsAppraisalEvaluatorsTypes.ID)
                End If
            End With
            Return True
        Catch ex As Exception
    ...
    Private Function SetToolbarSetting(ByVal ptrType As String, ByVal ClsClass As Object, ByVal intID As Integer) As Boolean
        Try
            Select Case ptrType
                ...
                Case "D"
                    ClsAppraisalEvaluatorsTypes.Find("ID=" & intID)
                    GetValues(ClsAppraisalEvaluatorsTypes)
    ...
    Private Function CheckCode() As Boolean
        ...
        Try
            ClsAppraisalEvaluatorsTypes.Find("Code='" & txtCode.Text & "'")
            IntId = ClsAppraisalEvaluatorsTypes.ID
            txtEngName.Focus()
            If ClsAppraisalEvaluatorsTypes.ID > 0 Then
                GetValues(ClsAppraisalEvaluatorsTypes)
                StrMode = "E"
            Else
                If ClsAppraisalEvaluatorsTypes.CheckRecordExistance(" Code='" & txtCode.Text & "'") Then
                    txtCode.Text = ""
                    txtCode.Focus()
                End If
            ...
            End If
            SetToolBarDefaults()
            SetToolBarPermission(Me, ClsAppraisalEvaluatorsTypes.ConnectionString, ClsAppraisalEvaluatorsTypes.DataBaseUserRelatedID, ClsAppraisalEvaluatorsTypes.GroupID, StrMode)
            SetToolBarRecordPermission(Me, ClsAppraisalEvaluatorsTypes.ConnectionString, ClsAppraisalEvaluatorsTypes.DataBaseUserRelatedID, ClsAppraisalEvaluatorsTypes.GroupID, ClsAppraisalEvaluatorsTypes.Table, IntId)
    ...
    Private Function AfterOperation() As Boolean
        ClsAppraisalEvaluatorsTypes.Clear()
        GetValues(ClsAppraisalEvaluatorsTypes)
        ImageButton_Delete.Enabled = False
    ...
    Private Sub LoadDataUpdateSchedules(ByVal formName As String)
        ...
        ClsAppraisalEvaluatorsTypes = New Clshrs_AppraisalEvaluatorsTypes(Me.Page)
        ClsAppraisalEvaluatorsTypes.Find(" code = '" & txtCode.Text & "'")
        Dim recordID As Integer = ClsAppraisalEvaluatorsTypes.ID
        If (recordID > 0) Then
    ...
    Private Function CreateOtherFields(ByVal IntRecordID As Integer)
        ...
        If clsMainOtherFields.CheckOtherFieldsButton(Me.Page, ClsAppraisalEvaluatorsTypes.Table) = True Then
            Dim StrTablename As String
            ClsAppraisalEvaluatorsTypes = New Clshrs_AppraisalEvaluatorsTypes(Me)
            StrTablename = ClsAppraisalEvaluatorsTypes.Table
