<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmBranches.aspx.vb" Inherits="frmBranches"
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmBranches" runat="server">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblParentBranch" runat="server" meta:resourcekey="lblParentBranchResource1"
                                                                SkinID="Label_DefaultNormal" Text=" الفرع الأب " Visible="False"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="DdlParentBranch" runat="server" SkinID="DropDownList_LargNormal"
                                                                meta:resourcekey="ddl_PrantBranchResource1" Visible="False">
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                </table>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table cellspacing="0" style="width: 100%; vertical-align: top">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblDefaultAbsent" runat="server" meta:resourcekey="lblDefaultAbsentResource1"
                                                                SkinID="Label_DefaultNormal" Text="الإفتراضى غياب"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:CheckBox ID="chkDefaultAbsent" runat="server" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table cellspacing="0" style="width: 100%; vertical-align: top">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblAffectPeriod" runat="server" meta:resourcekey="lblAffectPeriodResource1"
                                                                SkinID="Label_DefaultNormal" Text="يؤثر فى الفترة المالية"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:CheckBox ID="chkAffectPeriod" runat="server" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
