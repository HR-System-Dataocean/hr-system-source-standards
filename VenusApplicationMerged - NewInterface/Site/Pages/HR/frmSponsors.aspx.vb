...
Partial Class frmSponsors_
    Inherits MainPage
#Region "Public Decleration"
    Private ClsSponsors As Clshrs_Sponsors
...
#Region "Protected Sub"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ClsSponsors = New Clshrs_Sponsors(Me.Page)
        Dim ClsObjects As New Clssys_Objects(Page)
        Dim ClsSearchs As New Clssys_Searchs(Page)
        Dim SearchID As Integer = 0
        Try
            Dim clsSearchsColumns As New Clssys_SearchsColumns(Page)
            If ClsObjects.Find(" Code='" & ClsSponsors.Table.Trim & "'") Then
            ...
            If Not IsPostBack Then
                Page.Session.Add("ConnectionString", ClsSponsors.ConnectionString)
                ClsSponsors.AddOnChangeEventToControls("frmSponsors", Page, UltraWebTab1)
            ...
            If (txtCode.Text <> "") Then
                ClsSponsors.Find(" Code='" & txtCode.Text & "'")
                IntrecordID = ClsSponsors.ID
        ...
        Catch ex As Exception
            ...
            mErrorHandler.RecordExceptions_DataBase("", ex, Err.Number, ClsSponsors.RegUserID, Venus.Shared.ErrorsHandler.eRecordingType.System_DataBase)
    ...
    Protected Sub ImageButton_Command(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.CommandEventArgs) Handles ImageButton_Save.Command, ImageButton_SaveN.Command, LinkButton_SaveN.Command, ImageButton_New.Command, ImageButton_Print.Command, ImageButton_Properties.Command, LinkButton_Properties.Command, ImageButton_Remarks.Command, LinkButton_Remarks.Command, ImageButton_Last.Command, ImageButton_Next.Command, ImageButton_Back.Command, ImageButton_First.Command, ImageButton_Delete.Command
        ...
        Dim ObjNavigationHandler As New Venus.Shared.Web.NavigationHandler(ClsSponsors.ConnectionString)
        Select Case e.CommandArgument
            ...
            Case "New"
                AfterOperation()
            Case "Delete"
                ClsSponsors.Delete("Code='" & txtCode.Text & "'")
                AfterOperation()
            Case "Property"
                ClsSponsors.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmPropertyScreen.aspx?ID=" & ClsSponsors.ID & "&TableName=" & ClsSponsors.Table, 477, 313, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Property", False)
            Case "Remarks"
                ClsSponsors.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmRemarks.aspx?ID=" & ClsSponsors.ID & "&TableName=" & ClsSponsors.Table, 410, 210, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Remarks", False)
            Case "Print"
            ...
            Case "First"
                ClsSponsors.Find("Code='" & txtCode.Text & "'")
                ClsSponsors.FirstRecord()
                GetValues(ClsSponsors)
            Case "Previous"
                ClsSponsors.Find("Code='" & txtCode.Text & "'")
                If Not ClsSponsors.previousRecord() Then
                    ClsSponsors.Find("Code='" & txtCode.Text & "'")
            ...
            Case "Next"
                ClsSponsors.Find("Code='" & txtCode.Text & "'")
                If Not ClsSponsors.NextRecord() Then
                    ClsSponsors.Find("Code='" & txtCode.Text & "'")
...
#Region "Private Functions"
    Private Function SavePart() As Boolean
        Dim StrMode As String = Request.QueryString.Item("Mode")
        ClsSponsors = New Clshrs_Sponsors(Page)

        Try
            ClsSponsors.Find("Code='" & txtCode.Text & "'")

            If ClsSponsors.ID > 0 Then
                If Not AssignValue(ClsSponsors) Then
                    Exit Function
                End If
                ClsSponsors.Update("Code='" & txtCode.Text & "'")
            ...
            clsMainOtherFields.CollectDataAndSave(value.Text, ClsSponsors.Table, ClsSponsors.ID)
            value.Text = ""
            Return True
        Catch ex As Exception
            Return False
        End Try
    End Function
    Private Function AssignValue(ByRef ClsSponsors As Clshrs_Sponsors) As Boolean
        Try
            With ClsSponsors
                .Code = txtCode.Text
                .EngName = txtEngName.Text
                .ArbName = txtArbName.Text
                .ArbName4S = wneSponsorNumber.Value
            End With
        ...
        End Try
    End Function
    Private Function GetValues(ByVal ClsSponsors As Clshrs_Sponsors) As Boolean
        ...
        Try
            ...
            With ClsSponsors
                ...
                wneSponsorNumber.Value = .ArbName4S
                ...
                If Page.IsPostBack Then
                    CreateOtherFields(ClsSponsors.ID)
                End If
            End With
            Return True
        Catch ex As Exception
    ...
    Private Function CheckCode() As Boolean
        ...
        Try
            ClsSponsors.Find("Code='" & txtCode.Text & "'")
            IntId = ClsSponsors.ID
            txtEngName.Focus()
            If ClsSponsors.ID > 0 Then
                GetValues(ClsSponsors)
                StrMode = "E"
            Else
                If ClsSponsors.CheckRecordExistance(" Code='" & txtCode.Text & "'") Then
                    txtCode.Text = ""
                    txtCode.Focus()
                End If
            ...
            End If
            SetToolBarDefaults()
            SetToolBarPermission(Me, ClsSponsors.ConnectionString, ClsSponsors.DataBaseUserRelatedID, ClsSponsors.GroupID, StrMode)
            SetToolBarRecordPermission(Me, ClsSponsors.ConnectionString, ClsSponsors.DataBaseUserRelatedID, ClsSponsors.GroupID, ClsSponsors.Table, IntId)
    ...
    Private Sub LoadDataUpdateSchedules(ByVal formName As String)
        ...
        ClsSponsors = New Clshrs_Sponsors(Me.Page)
        ClsSponsors.Find(" code = '" & txtCode.Text & "'")
        Dim recordID As Integer = ClsSponsors.ID
        If (recordID > 0) Then
    ...
    Private Function CreateOtherFields(ByVal IntRecordID As Integer)
        ...
        If clsMainOtherFields.CheckOtherFieldsButton(Me.Page, ClsSponsors.Table) = True Then
            Dim StrTablename As String
            ClsSponsors = New Clshrs_Sponsors(Me)
            StrTablename = ClsSponsors.Table
