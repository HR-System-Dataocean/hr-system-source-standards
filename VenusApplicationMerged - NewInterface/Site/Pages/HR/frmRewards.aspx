<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmRewards.aspx.vb" Inherits="Rewards"
...
<head runat="server">
    <title>* Venus Payroll * ~Penalities</title>
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmRewards" runat="server">
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="Label_TransactionType" runat="server" Text="الحركة المالية" SkinID="Label_DefaultNormal"
                                                                meta:resourcekey="Label_TransactionType"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="ddlTransactionType" runat="server" SkinID="DropDownList_LargNormal"
                                                                meta:resourcekey="ddlTransactionType">
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                </table>
