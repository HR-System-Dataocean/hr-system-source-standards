...
Partial Class frmTicketsRoutes
    Inherits MainPage
#Region "Public Decleration"
    Private ClsTicketsRoutes As Clshrs_TicketsRoutes
...
#Region "Protected Sub"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ClsTicketsRoutes = New Clshrs_TicketsRoutes(Me.Page)
        Dim ClsObjects As New Clssys_Objects(Page)
        Dim ClsSearchs As New Clssys_Searchs(Page)
        Dim SearchID As Integer = 0
        Try
            Dim clsSearchsColumns As New Clssys_SearchsColumns(Page)
            If ClsObjects.Find(" Code='" & ClsTicketsRoutes.Table.Trim & "'") Then
            ...
            If Not IsPostBack Then
                Page.Session.Add("ConnectionString", ClsTicketsRoutes.ConnectionString)
                ClsTicketsRoutes.AddOnChangeEventToControls("frmTicketsRoutes", Page, UltraWebTab1)
            ...
            If (txtCode.Text <> "") Then
                ClsTicketsRoutes.Find(" Code='" & txtCode.Text & "'")
                IntrecordID = ClsTicketsRoutes.ID
        ...
        Catch ex As Exception
            ...
            mErrorHandler.RecordExceptions_DataBase("", ex, Err.Number, ClsTicketsRoutes.RegUserID, Venus.Shared.ErrorsHandler.eRecordingType.System_DataBase)
    ...
    Protected Sub ImageButton_Command(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.CommandEventArgs) Handles ImageButton_Save.Command, ImageButton_SaveN.Command, LinkButton_SaveN.Command, ImageButton_New.Command, ImageButton_Print.Command, ImageButton_Properties.Command, LinkButton_Properties.Command, ImageButton_Remarks.Command, LinkButton_Remarks.Command, ImageButton_Last.Command, ImageButton_Next.Command, ImageButton_Back.Command, ImageButton_First.Command, ImageButton_Delete.Command
        ...
        Dim ObjNavigationHandler As New Venus.Shared.Web.NavigationHandler(ClsTicketsRoutes.ConnectionString)
        Select Case e.CommandArgument
            ...
            Case "New"
                AfterOperation()
            Case "Delete"
                ClsTicketsRoutes.Delete("Code='" & txtCode.Text & "'")
                AfterOperation()
            Case "Property"
                ClsTicketsRoutes.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmPropertyScreen.aspx?ID=" & ClsTicketsRoutes.ID & "&TableName=" & ClsTicketsRoutes.Table, 477, 313, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Property", False)
            Case "Remarks"
                ClsTicketsRoutes.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmRemarks.aspx?ID=" & ClsTicketsRoutes.ID & "&TableName=" & ClsTicketsRoutes.Table, 410, 210, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Remarks", False)
            Case "Print"
            ...
            Case "First"
                ClsTicketsRoutes.Find("Code='" & txtCode.Text & "'")
                ClsTicketsRoutes.FirstRecord()
                GetValues(ClsTicketsRoutes)
            Case "Previous"
                ClsTicketsRoutes.Find("Code='" & txtCode.Text & "'")
                If Not ClsTicketsRoutes.previousRecord() Then
                    ClsTicketsRoutes.Find("Code='" & txtCode.Text & "'")
            ...
            Case "Next"
                ClsTicketsRoutes.Find("Code='" & txtCode.Text & "'")
                If Not ClsTicketsRoutes.NextRecord() Then
                    ClsTicketsRoutes.Find("Code='" & txtCode.Text & "'")
...
#Region "Private Functions"
    Private Function SavePart() As Boolean
        Dim StrMode As String = Request.QueryString.Item("Mode")
        ClsTicketsRoutes = New Clshrs_TicketsRoutes(Page)

        Try
            ClsTicketsRoutes.Find("Code='" & txtCode.Text & "'")

            If ClsTicketsRoutes.ID > 0 Then
                If Not AssignValue(ClsTicketsRoutes) Then
                    Exit Function
                End If
                ClsTicketsRoutes.Update("Code='" & txtCode.Text & "'")

            Else
                If Not AssignValue(ClsTicketsRoutes) Then
                    Exit Function
                End If
                ClsTicketsRoutes.Save()

            End If

            ClsTicketsRoutes.Find("Code='" & txtCode.Text & "'")

            clsMainOtherFields.CollectDataAndSave(value.Text, ClsTicketsRoutes.Table, ClsTicketsRoutes.ID)
            value.Text = ""
            Return True
        Catch ex As Exception
            Return False
        End Try
    End Function
    Private Function AssignValue(ByRef ClsTicketsRoutes As Clshrs_TicketsRoutes) As Boolean
        Try
            With ClsTicketsRoutes
                .Code = txtCode.Text
        ...
        End Try
    End Function
    Private Function GetValues(ByVal ClsTicketsRoutes As Clshrs_TicketsRoutes) As Boolean
        ...
        Try
            ...
            With ClsTicketsRoutes
                ...
                If Page.IsPostBack Then
                    CreateOtherFields(ClsTicketsRoutes.ID)
                End If
            End With
            Return True
        Catch ex As Exception
    ...
    Private Function SetToolbarSetting(ByVal ptrType As String, ByVal ClsClass As Object, ByVal intID As Integer) As Boolean
        Try
            Select Case ptrType
                ...
                Case "D"
                    ClsTicketsRoutes.Find("ID=" & intID)
                    GetValues(ClsTicketsRoutes)
    ...
    Private Function CheckCode() As Boolean
        ...
        Try
            ClsTicketsRoutes.Find("Code='" & txtCode.Text & "'")
            IntId = ClsTicketsRoutes.ID
            txtEngName.Focus()
            If ClsTicketsRoutes.ID > 0 Then
                GetValues(ClsTicketsRoutes)
                StrMode = "E"
            Else
                If ClsTicketsRoutes.CheckRecordExistance(" Code='" & txtCode.Text & "'") Then
                    txtCode.Text = ""
                    txtCode.Focus()
                End If
            ...
            End If
            SetToolBarDefaults()
            SetToolBarPermission(Me, ClsTicketsRoutes.ConnectionString, ClsTicketsRoutes.DataBaseUserRelatedID, ClsTicketsRoutes.GroupID, StrMode)
            SetToolBarRecordPermission(Me, ClsTicketsRoutes.ConnectionString, ClsTicketsRoutes.DataBaseUserRelatedID, ClsTicketsRoutes.GroupID, ClsTicketsRoutes.Table, IntId)
    ...
    Private Sub LoadDataUpdateSchedules(ByVal formName As String)
        ...
        ClsTicketsRoutes = New Clshrs_TicketsRoutes(Me.Page)
        ClsTicketsRoutes.Find(" code = '" & txtCode.Text & "'")
        Dim recordID As Integer = ClsTicketsRoutes.ID
        If (recordID > 0) Then
    ...
    Private Function CreateOtherFields(ByVal IntRecordID As Integer)
        ...
        If clsMainOtherFields.CheckOtherFieldsButton(Me.Page, ClsTicketsRoutes.Table) = True Then
            Dim StrTablename As String
            ClsTicketsRoutes = New Clshrs_TicketsRoutes(Me)
            StrTablename = ClsTicketsRoutes.Table
