...
Partial Class frmEvalRecommendations
    Inherits MainPage
#Region "Public Decleration"
    Private ClsRecommendations As ClsEval_Recommendations
...
#Region "Protected Sub"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ClsRecommendations = New ClsEval_Recommendations(Me.Page)
        Dim ClsObjects As New Clssys_Objects(Page)
        Dim ClsSearchs As New Clssys_Searchs(Page)
        Dim SearchID As Integer = 0
        Try
            Dim clsSearchsColumns As New Clssys_SearchsColumns(Page)
            If ClsObjects.Find(" Code='" & ClsRecommendations.Table.Trim & "'") Then
            ...
            If Not IsPostBack Then
                Page.Session.Add("ConnectionString", ClsRecommendations.ConnectionString)
                ClsRecommendations.AddOnChangeEventToControls("frmEvalRecommendations", Page, UltraWebTab1)
            ...
            If (txtCode.Text <> "") Then
                ClsRecommendations.Find(" Code='" & txtCode.Text & "'")
                IntrecordID = ClsRecommendations.ID
        ...
        Catch ex As Exception
            ...
            mErrorHandler.RecordExceptions_DataBase("", ex, Err.Number, ClsRecommendations.RegUserID, Venus.Shared.ErrorsHandler.eRecordingType.System_DataBase)
    ...
    Protected Sub ImageButton_Command(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.CommandEventArgs) Handles ImageButton_Save.Command, ImageButton_SaveN.Command, LinkButton_SaveN.Command, ImageButton_New.Command, ImageButton_Print.Command, ImageButton_Properties.Command, LinkButton_Properties.Command, ImageButton_Remarks.Command, LinkButton_Remarks.Command, ImageButton_Last.Command, ImageButton_Next.Command, ImageButton_Back.Command, ImageButton_First.Command, ImageButton_Delete.Command
        ...
        Dim ObjNavigationHandler As New Venus.Shared.Web.NavigationHandler(ClsRecommendations.ConnectionString)
        Select Case e.CommandArgument
            ...
            Case "New"
                AfterOperation()
            Case "Delete"
                ClsRecommendations.Delete("Code='" & txtCode.Text & "'")
                AfterOperation()
            Case "Property"
                ClsRecommendations.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmPropertyScreen.aspx?ID=" & ClsRecommendations.ID & "&TableName=" & ClsRecommendations.Table, 477, 313, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Property", False)
            Case "Remarks"
                ClsRecommendations.Find("Code='" & txtCode.Text & "'")
                Venus.Shared.Web.ClientSideActions.OpenWindowAdv(Page, "frmRemarks.aspx?ID=" & ClsRecommendations.ID & "&TableName=" & ClsRecommendations.Table, 410, 210, False, Venus.Shared.Web.ClientSideActions.WINDOW_TARGET._Blank, "Remarks", False)
            Case "Print"
            ...
            Case "First"
                ClsRecommendations.Find("Code='" & txtCode.Text & "'")
                ClsRecommendations.FirstRecord()
                GetValues(ClsRecommendations)
            Case "Previous"
                ClsRecommendations.Find("Code='" & txtCode.Text & "'")
                If Not ClsRecommendations.previousRecord() Then
                    ClsRecommendations.Find("Code='" & txtCode.Text & "'")
            ...
            Case "Next"
                ClsRecommendations.Find("Code='" & txtCode.Text & "'")
                If Not ClsRecommendations.NextRecord() Then
                    ClsRecommendations.Find("Code='" & txtCode.Text & "'")
...
#Region "Private Functions"
    Private Function SavePart() As Boolean
        Dim StrMode As String = Request.QueryString.Item("Mode")
        ClsRecommendations = New ClsEval_Recommendations(Page)

        Try
            ClsRecommendations.Find("Code='" & txtCode.Text & "'")

            If ClsRecommendations.ID > 0 Then
                If Not AssignValue(ClsRecommendations) Then
                    Exit Function
                End If
                ClsRecommendations.Update("Code='" & txtCode.Text & "'")

            Else
                If Not AssignValue(ClsRecommendations) Then
                    Exit Function
                End If
                ClsRecommendations.Save()

            End If

            ClsRecommendations.Find("Code='" & txtCode.Text & "'")

            clsMainOtherFields.CollectDataAndSave(value.Text, ClsRecommendations.Table, ClsRecommendations.ID)
            value.Text = ""
            Return True
        Catch ex As Exception
            Return False
        End Try
    End Function
    Private Function AssignValue(ByRef ClsRecommendations As ClsEval_Recommendations) As Boolean
        Try
            With ClsRecommendations
                .Code = txtCode.Text
        ...
        End Try
    End Function
    Private Function GetValues(ByVal ClsRecommendations As ClsEval_Recommendations) As Boolean
        ...
        Try
            ...
            With ClsRecommendations
                ...
                If Page.IsPostBack Then
                    CreateOtherFields(ClsRecommendations.ID)
                End If
            End With
            Return True
        Catch ex As Exception
    ...
    Private Function SetToolbarSetting(ByVal ptrType As String, ByVal ClsClass As Object, ByVal intID As Integer) As Boolean
        Try
            Select Case ptrType
                ...
                Case "D"
                    ClsRecommendations.Find("ID=" & intID)
                    GetValues(ClsRecommendations)
    ...
    Private Function CheckCode() As Boolean
        ...
        Try
            ClsRecommendations.Find("Code='" & txtCode.Text & "'")
            IntId = ClsRecommendations.ID
            txtEngName.Focus()
            If ClsRecommendations.ID > 0 Then
                GetValues(ClsRecommendations)
                StrMode = "E"
            Else
                If ClsRecommendations.CheckRecordExistance(" Code='" & txtCode.Text & "'") Then
                    txtCode.Text = ""
                    txtCode.Focus()
                End If
            ...
            End If
            SetToolBarDefaults()
            SetToolBarPermission(Me, ClsRecommendations.ConnectionString, ClsRecommendations.DataBaseUserRelatedID, ClsRecommendations.GroupID, StrMode)
            SetToolBarRecordPermission(Me, ClsRecommendations.ConnectionString, ClsRecommendations.DataBaseUserRelatedID, ClsRecommendations.GroupID, ClsRecommendations.Table, IntId)
    ...
    Private Sub LoadDataUpdateSchedules(ByVal formName As String)
        ...
        ClsRecommendations = New ClsEval_Recommendations(Me.Page)
        ClsRecommendations.Find(" code = '" & txtCode.Text & "'")
        Dim recordID As Integer = ClsRecommendations.ID
        If (recordID > 0) Then
    ...
    Private Function CreateOtherFields(ByVal IntRecordID As Integer)
        ...
        If clsMainOtherFields.CheckOtherFieldsButton(Me.Page, ClsRecommendations.Table) = True Then
            Dim StrTablename As String
            ClsRecommendations = New ClsEval_Recommendations(Me)
            StrTablename = ClsRecommendations.Table
