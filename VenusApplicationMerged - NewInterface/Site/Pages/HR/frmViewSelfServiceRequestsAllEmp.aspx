<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmViewSelfServiceRequestsAllEmp.aspx.vb"
                    ...
                    <table style="width: 45%; height: 30px; vertical-align: top">
                         <tr>
                            <td style="width: 32px; vertical-align: top">
                              ...
                              <td  style="width:20px" class="LabelArea">
                                                            <asp:Label ID="lblBranch" runat="server" Width="120px" SkinID="Label_LargtNormal"
                                                                Text="الفرع" meta:resourcekey="lblBranchResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="ddlBranch" runat="server" AutoPostBack="True" SkinID="DropDownList_DefaultNormal"
                                                                meta:resourcekey="BranchResource1" TabIndex="3">
                                                            </asp:DropDownList>
                                                        </td>

                                                        <td  style="width:20px" class="LabelArea">
                                                            <asp:Label ID="lblDepartment" runat="server" Width="53px" SkinID="Label_LargtNormal"
                                                                Text="القسم" meta:resourcekey="lblDepartmentResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="ddlDepartment" runat="server" AutoPostBack="True" SkinID="DropDownList_DefaultNormal"
                                                                meta:resourcekey="DepartmentResource1" TabIndex="3">
                                                            </asp:DropDownList>
                                                        </td>
                        ...
                        <%--    <td style="width: 50%; vertical-align: middle"></td>
                            ...
                            <td>
                                <asp:Label ID="Label8" runat="server" meta:resourcekey="Label_HeaderResource1"></asp:Label>
                            </td>
                            <td style="width: 50%; vertical-align: middle">
                                        ...
                                        <td style="width: 49%; vertical-align: top">
                                            <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td style="width: 60%; height: 16px; vertical-align: middle;">
                                                        <asp:Label ID="Label9" runat="server" SkinID="Label_CopyRightsNormal" meta:resourcekey="lblRegUserValueResource1"></asp:Label>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
            ...
            <tr>
                <td class="Details">
                    <igtab:UltraWebTab ID="UltraWebTab1" runat="server" EnableAppStyling="True" SkinID="Default"
                        ...
                        <Tabs>
                            <igtab:Tab Text="متابعة طلباتي" meta:resourcekey="FollowupMyRequestsTabResource1">
                                <ContentTemplate>
