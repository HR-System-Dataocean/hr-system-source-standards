<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmProjectPlacementPlanning.aspx.vb"
    Inherits="frmProjectPlacementPlanning" Culture="auto" UICulture="auto" meta:resourcekey="PageResource1"  %>
...
<head base target="_self" runat="server">
    <title>* Venus Payroll * ~ frmProjectPlacementPlanning</title>
    <script src="../../Common/Script/JQuery/jquery-1.6.2.js" type="text/javascript"></script>
    <script src="../../Common/Script/JQuery/jquery-ui-1.8.16.custom.min.js" type="text/javascript"></script>
</head>
<body style="height: 100%; margin: 0; padding: 0;">
    <form id="frmProjectPlacementPlanning" runat="server">
            ...
            <tr>
                <td class="Details">
                    <igtab:UltraWebTab ID="UltraWebTab1" runat="server" EnableAppStyling="True" 
                        ...
                        <Tabs>
                            <igtab:Tab Text="جدول الدوامات" meta:resourcekey="TabResource1" >
                                <ContentTemplate>
                                    <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Label ID="LblCnt1" runat="server" Font-Bold="True" Font-Size="12pt" Font-Underline="True"
                                                                ForeColor="#FF3300" meta:resourcekey="LblCnt1Resource1" ></asp:Label>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                        ...
                                        <tr>
                                            <td style="height: 18px">
                                                <table runat="server" style="width: 100%; height: 18px; vertical-align: top; border-bottom: 1px solid silver">
                                                    <tr runat="server">
                                                        <td style="width: 5px" runat="server">
                                                        </td>
                                                        <td runat="server">
                                                            <asp:Label ID="lblCode" runat="server" Width="100px" SkinID="Label_CopyRightsBold"
                                                                Text="الموقع"></asp:Label>
                                                        </td>
                                                        <td runat="server">
                                                            <asp:Label ID="lblProjectCode" runat="server" Width="200px" SkinID="Label_CopyRightsNormal"></asp:Label>
                                                        </td>
                                                        <td runat="server">
                                                            <asp:Label ID="lblName" runat="server" SkinID="Label_CopyRightsBold" Text="الوظيفة"
                                                                Width="100px"></asp:Label>
                                                        </td>
                                                        <td runat="server">
                                                            <asp:Label ID="lblProjectName" runat="server" Width="200px" SkinID="Label_CopyRightsNormal"></asp:Label>
                                                        </td>
                                                        <td runat="server">
                                                            <asp:Label ID="Label_Plan" runat="server" SkinID="Label_CopyRightsBold" Text="مخطط الدوام"
                                                                Width="100px"></asp:Label>
                                                        </td>
                                                        <td runat="server">
                                                            <asp:Label ID="Label_PlanName" runat="server" Width="200px" SkinID="Label_CopyRightsNormal"></asp:Label>
                                                        </td>
                                                        <td style="width: 5px" runat="server">
                                                            &nbsp;
                                                        </td>
                                    ...
                                    <table style="width: 100%; vertical-align: top" cellspacing="0">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 96%; vertical-align: top">
                                                <asp:Label ID="Label28" runat="server" SkinID="Label_CopyRightsNormal" 
                                                    
                                                    Text="فى حال الرغبة فى استبعاد وردية التاشير على استبعاد - والتطبيقات التأشير على التطبيق ثم الضغط على اعتماد" meta:resourcekey="Label28Resource1" 
                                                    ></asp:Label>
                                                <br />
                                                <asp:Label ID="LabelAltNote" runat="server" SkinID="Label_CopyRightsBold" 
                                                    Text="يمكن الضغط على استعادة لاستعادة كل الورديات او التطبيقات المسستبعده" meta:resourcekey="LabelAltNoteResource1" 
                                                    ></asp:Label>
                                                <igtbl:UltraWebGrid   Browser="UpLevel"   ID="uwglocationshift" runat="server" EnableAppStyling="True"
                                                    Height="150px" SkinID="Default" Width="100%" EnableTheming="True" meta:resourcekey="uwglocationshiftResource1" 
                                                    >
                                                    ...
                                                    <Bands>
                                                        <igtbl:UltraGridBand meta:resourcekey="UltraGridBandResource1" >
                                                            ...
                                                            <Columns>
                                                                <igtbl:UltraGridColumn BaseColumnName="IsActive" Key="IsActive" Type="CheckBox" Width="60px"
                                                                    DataType="System.Boolean" AllowUpdate="Yes" meta:resourcekey="UltraGridColumnResource1" 
                                                                    >
                                                                    <Header Caption="مستبعد">
                                                                    </Header>
                                    ...
                                    <table id="T1" runat="server" visible="true" style="width: 100%; vertical-align: top"
                                        cellspacing="0">
                                        <tr runat="server">
                                        ...
                                        <tr runat="server">
                                            <td style="width: 2%; vertical-align: top" runat="server">
                                            </td>
                                            <td style="width: 96%; vertical-align: top" runat="server">
                                                <igtbl:UltraWebGrid   Browser="UpLevel"   ID="uwgalt" runat="server" EnableAppStyling="True" Height="150px"
                                                    ...
                                                    <Bands>
                                                        <igtbl:UltraGridBand>
                                                            ...
                                                            <Columns>
                                                                <igtbl:UltraGridColumn BaseColumnName="IsActive" Key="IsActive" DataType="System.Boolean"
                                                                    Type="CheckBox" Width="60px" AllowUpdate="Yes">
                                                                    <Header Caption="مستبعد">
                                                                    </Header>
                                                                    <HeaderStyle HorizontalAlign="Center" />
                                                                    <CellStyle HorizontalAlign="Center">
                                                                ...
                                                                <igtbl:UltraGridColumn BaseColumnName="Sat" DataType="System.Boolean" Type="CheckBox"
                                                                    Width="7%" AllowUpdate="No">
                                                                    <Header Caption="السبت">
                                                                        <RowLayoutColumnInfo OriginX="4" />
                                                                    </Header>
                                                                    <Footer>
                                                                ...
                                                                <igtbl:UltraGridColumn BaseColumnName="Sun" DataType="System.Boolean" Type="CheckBox"
                                                                    Width="7%" AllowUpdate="No">
                                                                    <Header Caption="الأحد">
                                                                        <RowLayoutColumnInfo OriginX="5" />
                                                                    </Header>
                                                                ...
                                                                <igtbl:UltraGridColumn BaseColumnName="Mon" DataType="System.Boolean" Type="CheckBox"
                                                                    Width="7%" AllowUpdate="No">
                                                                    <Header Caption="الإثنين">
                                                                        <RowLayoutColumnInfo OriginX="6" />
                                                                    </Header>
                                                                ...
                                                                <igtbl:UltraGridColumn BaseColumnName="Tue" DataType="System.Boolean" Type="CheckBox"
                                                                    Width="7%" AllowUpdate="No">
                                                                    <Header Caption="الثلاثاء">
                                                                        <RowLayoutColumnInfo OriginX="7" />
                                                                    </Header>
                                                                ...
                                                                <igtbl:UltraGridColumn BaseColumnName="Wed" DataType="System.Boolean" Type="CheckBox"
                                                                    Width="7%" AllowUpdate="No">
                                                                    <Header Caption="الأربعاء">
                                                                        <RowLayoutColumnInfo OriginX="8" />
                                                                    </Header>
                                                                ...
                                                                <igtbl:UltraGridColumn BaseColumnName="Thu" DataType="System.Boolean" Type="CheckBox"
                                                                    Width="7%" AllowUpdate="No">
                                                                    <Header Caption="الخميس">
                                                                        <RowLayoutColumnInfo OriginX="9" />
                                                                    </Header>
                                                                ...
                                                                <igtbl:UltraGridColumn BaseColumnName="Fri" DataType="System.Boolean" Type="CheckBox"
                                                                    Width="7%" AllowUpdate="No">
                                                                    <Header Caption="الجمعة">
                                                                        <RowLayoutColumnInfo OriginX="10" />
                                                                    </Header>
