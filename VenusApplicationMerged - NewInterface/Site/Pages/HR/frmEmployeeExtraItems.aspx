<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmEmployeeExtraItems.aspx.vb"
    Inherits="frmEmployeeExtraItems" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
...
<body style="height: 100%; margin: 0; padding: 0;">
    <form id="frmEmployeeExtraItems" runat="server" defaultbutton="ImageButton1">
                        ...
                        <tr>
                            ...
                            <td style="width: 20px">
                                <asp:ImageButton ID="ImageButton_ImportIncrease" Width="9px" Height="9px" runat="server"
                                    meta:resourcekey="ImageButton_ImportIncreaseResource1" OnClientClick="OpenModal1('frmIncreasesLoad.aspx?F=FI',190,830,false,''); return false;"
                                    ImageUrl="~/Pages/HR/Img/cal_year.gif" />
                            </td>
                            <td style="width: 100px">
                                <asp:LinkButton ID="LinkButton_ImportIncrease" runat="server" Text="Import Increase"
                                    OnClientClick="OpenModal1('frmIncreasesLoad.aspx?F=FI',190,830,false,''); return false;"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="ddlFilter" runat="server" SkinID="DropDownList_LargNormal"
                                                                ...
                                                                <asp:ListItem Value="2" Text="Pending Non-transferable" meta:resourcekey="TransfeeredRes1"></asp:ListItem>
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                </table>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="DataArea">
                                                            <asp:DropDownList ID="DdlPeriods" runat="server" SkinID="DropDownList_LargNormal"
                                                                meta:resourcekey="DdlPeriodsResource1" AutoPostBack="True">
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                </table>
                                                    ...
                                                    <Bands>
                                                        <igtbl:UltraGridBand AllowSorting="No" meta:resourcekey="UltraGridBandResource1">
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <%--Rabie 25-5-2023--%>
                                                                <igtbl:UltraGridColumn AllowUpdate="Yes" BaseColumnName="ProjectCode" Key="ProjectCode"
                                                                    Width="100px" meta:resourcekey="UltraGridColumnResource7">
                                                                    <Header Caption="كود المشروع">
                                                                        <RowLayoutColumnInfo OriginX="2" />
                                                                    </Header>
                                                                    <CellStyle HorizontalAlign="Center">
                                                                    </CellStyle>
                                                                ...
                                                                <igtbl:UltraGridColumn AllowUpdate="No" BaseColumnName="ProjectName" Key="ProjectName"
                                                                    Width="100%" meta:resourcekey="UltraGridColumnResource8">
                                                                    <Header Caption="المشروع">
                                                                        <RowLayoutColumnInfo OriginX="3" />
                                                                    </Header>
                                                                    <CellStyle HorizontalAlign="Center">
                                                                    </CellStyle>
                                                                ...
                                                                <igtbl:UltraGridColumn BaseColumnName="Src" Key="Src" Hidden="True">
                                                                    <Header Caption="Src">
                                                                        <RowLayoutColumnInfo OriginX="11" />
                                                                    </Header>
                                                                    <Footer>
                                                                ...
                                                                <igtbl:UltraGridColumn BaseColumnName="TransactionNo" Key="TransactionNo" Hidden="True">
                                                                    <Header Caption="TransactionNo">
