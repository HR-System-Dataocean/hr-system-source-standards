<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmAppraisalCriteriaGroups.aspx.vb" Inherits="frmProfession"
                                            ...
                                            <td style="width: 100%; height: 16px; vertical-align: top">
                                                ...
                                                <tr>
                                                        <td class="SeparArea">
                                                                                                             ...
                                                                                                             <td class="LabelArea">
                                                            <asp:Label ID="LblCriteriaGroupType" runat="server" Text="المجموعة" SkinID="Label_DefaultNormal"
                                                                meta:resourcekey="LblCriteriaGroupTypeResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                          <asp:DropDownList ID="ddlCriteriaGroupType" Width="200px" runat="server" AutoPostBack="False" SkinID="DropDownList_smallNormal"
    meta:resourcekey="LblCriteriaGroupTypeResource1" TabIndex="3">
</asp:DropDownList>
                                                        </td>
                                                    </tr>
                                        ...
                                        <tr>
                         <td>
                                                         <igtbl:UltraWebGrid  Browser="UpLevel"  ID="uwgGroupCriterias" runat="server" EnableAppStyling="False"
                  ...
                  <Columns>
                                        ...
                                        <igtbl:UltraGridColumn BaseColumnName="CriteriaID" DataType="System.Int32" Hidden="True" AllowUpdate="No"
                                            ...
                                            <Header Caption="CriteriaID">
                                                    ...
                                                    Key=" Code" meta:resourcekey="CriteriaCodeResource1"  >
       
                                                    <Header Caption="Criteria Code">
                                                    </Header>
                                                </igtbl:UltraGridColumn>
