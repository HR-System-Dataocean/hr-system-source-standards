<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmAttendAppointment.aspx.vb"
    Inherits="frmAttendAppointment" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="DataAreawithsearch">
                                                            <asp:TextBox ID="txtCode" runat="server" SkinID="TextBox_SmalltNormalC" MaxLength="30"
                                                                AutoPostBack="True" meta:resourcekey="txtCodeResource1" Enabled="False"></asp:TextBox>
                                                        </td>
                                                        <td class="search">
                                                ...
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea" style="height: 16px">
                                                            <asp:Label ID="Label1" runat="server" SkinID="Label_DefaultNormal" Text="الفرع" meta:resourcekey="lblBranchResource1"></asp:Label>
                                                        </td>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea" style="height: 16px">
                                                            <asp:Label ID="DepartmentLabel" runat="server" SkinID="Label_DefaultNormal" Text="القسم" meta:resourcekey="lblDepartmentResource"></asp:Label>
                                                        </td>
                                                        <td class="DataArea" style="height: 16px">
     ...
     <td style="width: 47%; height: 16px; vertical-align: top">
         <table style="width: 100%; vertical-align: top" cellspacing="0">
             <tr>
                 ...
                 <td class="LabelArea" style="height: 16px">
                     <asp:Label ID="LblEmpCode" runat="server" SkinID="Label_DefaultNormal" Text="الموظف" meta:resourcekey="LblEmpCodeResource"></asp:Label>
                 </td>
               <td class="LabelArea">
  &nbsp;</td>                          
<td class="LabelArea">
    &nbsp;</td>
<td class="DataArea">
    <asp:TextBox ID="TxtEmpCode" runat="server"  AutoPostBack="True" Width="120px">
    </asp:TextBox>
    </td>
<td>
         <igtxt:WebImageButton ID="BtnEmpSearch" runat="server" AutoSubmit="False" Height="15px"
        Overflow="NoWordWrap" UseBrowserDefaults="False" Width="24px" meta:resourcekey="btnSearchCodeResource1">
        <Alignments TextImage="ImageBottom" />
        <Appearance>
            <Image Url="./Img/forum_search.gif" />
...
<td class="DataArea">
  <asp:TextBox ID="TxtEmpName" runat="server"   EnableTheming="True" Height="18px" meta:resourcekey="txtBirthDateResource1" NullDateLabel="" Style="font-family: Tahoma; font-size: 8pt; font-weight: Normal;
        color: Black; border: solid 1px #CCCCCC" Value="" Width="300px">
    </asp:TextBox>
</td>
             </tr>
         </table>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="Label_FromDate" runat="server" SkinID="Label_DefaultNormal" Text="من تاريخ" meta:resourcekey="txtFromDateResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <igsch:WebDateChooser ID="StartDate" runat="server" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" EnableTheming="True" Height="18px" meta:resourcekey="txtBirthDateResource1" NullDateLabel="" Style="font-family: Tahoma; font-size: 8pt; font-weight: Normal;
                                                                color: Black; border: solid 1px #CCCCCC; text-align: right;" Value="" Width="150px">
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                              <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="Label3" runat="server" SkinID="Label_DefaultNormal" Text="الى تاريخ" meta:resourcekey="txtToDateResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                            <igsch:WebDateChooser ID="EndDate" runat="server" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" EnableTheming="True" Height="18px" meta:resourcekey="txtBirthDateResource1" NullDateLabel="" Style="font-family: Tahoma; font-size: 8pt; font-weight: Normal;
                                                                color: Black; border: solid 1px #CCCCCC" Value="" Width="150px">
                                                            </igsch:WebDateChooser>
                                                        </td>
                                                    </tr>
                                                </table>  
                                            ...
                                            <td style="width: 50%; height: 16px; vertical-align: top">
                                              <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="Label2" runat="server" SkinID="Label_DefaultNormal" Text="خطة الدوام" meta:resourcekey="btnShiftPlanResource1"></asp:Label>
                                                        </td>
                                                        ...
                                                        <td class="LabelArea">
                                                            &nbsp;</td>
                                                        <td class="DataArea">
                                                            <asp:TextBox ID="TxtAttendShifts" runat="server"  AutoPostBack="True" Width="120px">
                                                            </asp:TextBox>
                                                            </td>
                                                        <td>
                                                                 <igtxt:WebImageButton ID="btnSearchShift" runat="server" AutoSubmit="False" Height="15px"
                                                                Overflow="NoWordWrap" UseBrowserDefaults="False" Width="24px" meta:resourcekey="btnSearchCodeResource1">
                                                                <Alignments TextImage="ImageBottom" />
                                                                <Appearance>
                                                                    <Image Url="./Img/forum_search.gif" />
                                                        ...
                                                        <td class="DataArea">
                                                          <asp:TextBox ID="TxtAttendShiftName" runat="server"   EnableTheming="True" Height="18px" meta:resourcekey="txtBirthDateResource1" NullDateLabel="" Style="font-family: Tahoma; font-size: 8pt; font-weight: Normal;
                                                                color: Black; border: solid 1px #CCCCCC" Value="" Width="300px">
                                                            </asp:TextBox>
                                                        </td>
                                                    </tr>
                                        ...
                                        <tr>
                                            <td style="height: 100%; vertical-align: top" colspan="3">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        <td>
                                                            <div style ="direction :revert-layer">
                                                            <ignav:UltraWebTree ID="UltraWebTree1" runat="server" CheckBoxes="True"   
                                                                EnableAppStyling="True" Font-Names="Tahoma" Font-Size="12pt" Height="100%"    
