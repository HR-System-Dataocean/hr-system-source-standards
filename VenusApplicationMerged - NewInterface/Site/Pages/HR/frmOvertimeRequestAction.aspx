<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmOvertimeRequestAction.aspx.vb"
    Inherits="frmOvertimeRequestAction" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function CloseMe() {
            try {
                // الحل 1: استخدام window.parent إذا كان موجوداً
                if (window.parent && window.parent.CloseIt) {
                    window.parent.CloseIt("");
                    window.parent.location.reload();
                }
                // الحل 2: استخدام opener إذا كان popup
                else if (window.opener) {
                    window.opener.location.reload();
                    window.close();
                }
                // الحل 3: استخدام jQuery dialog إذا كان modal
                else if (window.parent && window.parent.$) {
                    window.parent.$('.ui-dialog-content').dialog('close');
                    window.parent.location.reload();
                }
                // الحل 4: الإغلاق العادي
                else {
                    window.close();
                }
            } catch (e) {
...
<body style="height: 100%; margin: 0; padding: 0;">
    <form id="frmOvertimeRequestAction" runat="server">
...
<%--                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblHoursNo" Width="120px" runat="server" Text="Hours Number"
...
<td style="width: 47%; height: 16px; vertical-align: top">
    <table style="width: 100%; vertical-align: top" cellspacing="0">
            ...
            <td class="LabelArea">
                <asp:Label ID="lblConfirmedHours" Width="120px" runat="server" Text="Confirmed Hours"
                    SkinID="Label_DefaultNormal" meta:resourcekey="lblConfirmedHoursResource1"></asp:Label>
            </td>
            <td class="DataArea">
             <asp:TextBox ID="txtConfirmedHours" runat="server" SkinID="TextBox_SmalltNormalC" MaxLength="30"
                    AutoPostBack="False" ReadOnly="False"  meta:resourcekey="txtConfirmedHoursResource1">
               </asp:TextBox>
            </td>
           <td class="SeparArea">
            &nbsp;&nbsp;
          ...
          <td class="LabelArea" style="min-width: 90px;">
                <asp:Label ID="lblConfirmedMinuts" runat="server" Text="Confirmed Minuts" SkinID="Label_DefaultNormal"
                    meta:resourcekey="lblConfirmedMinutsResource1"></asp:Label>
            </td>
         
     
                                          
            <td class="DataArea">
                <asp:TextBox ID="txtConfirmedMinuts" runat="server" SkinID="TextBox_SmalltNormalC" MaxLength="30"
                    AutoPostBack="False" ReadOnly="False"  meta:resourcekey="txtConfirmedMinutsResource1" onkeypress="return isNumberKey(event)">
               </asp:TextBox>
                </td>
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblOverTimeType" Width="120px" runat="server" Text="Overtime Type" meta:resourcekey="lblOverTimeTypeResource1"
    ...
    <script type="text/javascript">
        // دالة عالمية يمكن استدعاؤها من الكود الخلفي
        function CloseModalAndRefreshParent() {
            try {
                // الطريقة 1: باستخدام jQuery UI
                if (typeof window.parent !== 'undefined' &&
                    typeof window.parent.$ !== 'undefined' &&
                    typeof window.parent.$.ui !== 'undefined') {

                    // إغلاق جميع الـ dialogs المفتوحة
                    window.parent.$('.ui-dialog-content').each(function () {
                        var dialog = window.parent.$(this);
                ...
                // الطريقة 2: باستخدام opener (لـ popup)
                ...
                // الطريقة 3: الإغلاق العادي
                window.close();

            } catch (error) {
                console.log('Error in CloseModalAndRefreshParent:', error);
                window.close();
            }
        }

        // دالة تدمج الرسالة والإغلاق
        function ShowMessageAndClose(message) {
            alert(message);
            CloseModalAndRefreshParent();
        }
    </script>
</body>
</html>
