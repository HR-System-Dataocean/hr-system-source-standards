        ...
        <tr><td>
            <table style="width:100%; height:58px">
                <tr>
                    ...
                    <td style="width:45%"><asp:Label ID="Label_Header" runat="server" Text="Employee Acting Assignment" Font-Bold="True" meta:resourcekey="Label_HeaderResource1" /></td>
                    <td>
                        <table style="width:100%">
            ...
            <igtab:UltraWebTab ID="UltraWebTab1" runat="server" EnableAppStyling="True" SkinID="Default">
                <Tabs><igtab:Tab Text="General" meta:resourcekey="TabResource1"><ContentTemplate>
                    <table class="assignment">
                        ...
                        <tr><td class="fieldLabel"><asp:Label ID="lblOriginalEmployee" runat="server" Text="Employee Being Replaced" meta:resourcekey="lblOriginalEmployeeResource1" /> <span class="required">*</span></td><td><asp:TextBox ID="txtOriginalEmployee" runat="server" Width="145px" AutoPostBack="True" MaxLength="30" Enabled="False" /><igtxt:WebImageButton ID="btnOriginalEmployeeSearch" runat="server" AutoSubmit="False" Width="24px" Height="18px" Enabled="False"><Appearance><Image Url="./Img/forum_search.gif" /></Appearance></igtxt:WebImageButton> <asp:TextBox ID="txtOriginalEmployeeName" runat="server" Width="255px" CssClass="readonly" ReadOnly="True" Enabled="False" /></td></tr>
