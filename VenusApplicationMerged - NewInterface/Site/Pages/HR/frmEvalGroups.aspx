<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmEvalGroups.aspx.vb" Inherits="frmEvalGroups"
...
<head runat="server">
    <title>* Venus Payroll * ~Eval Groups</title>
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmEvalGroups" runat="server">
                                                ...
                                                <table style="width: 100%; height: 30px; vertical-align: bottom; border-bottom: 1px solid black"
                                                    ...
                                                    <tr>
                                                        <td style="vertical-align: bottom">
                                                            <asp:Label ID="Label_Title1" runat="server" Text="برجاء تحديد العناصر التالية" SkinID="Label_DefaultBold"
                                        ...
                                        <tr>
                                            <td style="height: 16px; vertical-align: top" colspan="3">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        <td>
                                                            <igtbl:UltraWebGrid  Browser="UpLevel"   ID="uwgQuestions" runat="server" EnableAppStyling="False" Height="200px"
                                                                meta:resourcekey="uwgForNationalityResource1" SkinID="Default" Width="100%">
                                                                    ...
                                                                    <igtbl:UltraGridBand meta:resourcekey="UltraGridBandResource1">
                                                                        ...
                                                                        <Columns>
                                                                            <igtbl:UltraGridColumn AllowUpdate="Yes" BaseColumnName="IsCriteria" CellButtonDisplay="Always"
                                                                                DataType="System.Boolean" meta:resourcekey="UltraGridColumnResource1" Type="CheckBox"
                                                                                Width="80px">
                                                                            ...
                                                                            <igtbl:UltraGridColumn AllowResize="Fixed" AllowUpdate="No" meta:resourcekey="UltraGridColumnResource3"
                                                                                Width="100%">
                                                                                <CellStyle HorizontalAlign="Center">
                                                                                </CellStyle>
                                                                                <Header Caption="Elements Content">
