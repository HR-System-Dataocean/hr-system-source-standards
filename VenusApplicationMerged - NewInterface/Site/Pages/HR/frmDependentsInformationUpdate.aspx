<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmDependentsInformationUpdate.aspx.vb"
    Inherits="frmDependentsInformationUpdate" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
...
<head runat="server">
    ...
    <script type="text/javascript" id="igClientScript">
        ...
        function OpenPrintedScreen(v) {
            ...
            var win = window.open("../../Interfaces/frmReportsGridViewer.aspx?Language=false&Criteria=RequestSerial&preview=1&ReportCode=CF_141&sq0=''&v=" + v, "_NEW", "height=" + hight + ",width=" + width + ",resizable=0,menubar=0,toolbar=0,location=0,directories=0,scrollbars=0,status=0,center=0");
            win.focus();
        }
    </script>
    <style type="text/css">
...
<body style="margin: 0; padding: 0;">
    <form id="frmDependentsInformationUpdate" runat="server" defaultbutton="Button1">
