<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmEmployeeClassChange.aspx.vb"
    Inherits="frmEmployeeClassChange" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmEmployeeClassChange" runat="server">
                                         ...
                                         <h3>
                                            ...
                                            <div id="DivContract" runat="server">
                                                <table style="width: 100%;">
                                                    <tr>
                                                           <td id="myTd4" runat="server" style="background:Gainsboro;width: 45%;">
                                                                    <table style="width: 100%;">
    ...
    Width="80px" meta:resourcekey="lblEmployeeClassResource1"></asp:Label>
     ...
     meta:resourcekey="ddlEmployeeClassResource1">
                 ...
                 <td class="DataArea">
                                                         ...
                                                         &nbsp;&nbsp;&nbsp;&nbsp;
                                                            ...
                                                            <asp:Label ID="lblConsumedT" runat="server" SkinID="Label_CopyRightsNormal"
                                                                Text="مرحل" meta:resourcekey="lblConsumedBalanceResource1" ></asp:Label>
                                                            ...
                                                            <asp:Label ID="lblRemainT" runat="server" SkinID="Label_CopyRightsNormal"
                                                                Text="مرحل" meta:resourcekey="lblRemainBalanceResource1"></asp:Label>
             ...
             <tr>
                 ...
                 <td class="LabelArea">
                      <asp:Label ID="Label3" runat="server" meta:resourcekey="lblStartDateResource1"
                                                                SkinID="Label_DefaultNormal" Text="تاريخ التأثير"></asp:Label>
                 </td>
                 <td class="DataArea">
    ...
    Width="80px" meta:resourcekey="lblEmployeeClassResource1"></asp:Label>
     ...
     meta:resourcekey="ddlEmployeeClassResource1">
             ...
             <tr>
                 ...
                 <td class="DataArea">
                                                                                <asp:Label ID="lblAllBalance" runat="server"  SkinID="Label_DefaultNormal"
                                                                Text="الرصيد" meta:resourcekey="lbAllBalanceResource1"></asp:Label>
                                                            <asp:TextBox ID="txtAllBalance" runat="server" AutoPostBack="True" SkinID="TextBox_SmalltNormalC" meta:resourcekey="lbAllBalanceResource1"
                                                                    TabIndex="6"></asp:TextBox>


                                                             <asp:Label ID="lblAllConsumed" runat="server" SkinID="Label_DefaultNormal"
                                                                Text="المستهلك" meta:resourcekey="lblAllConsumedBalanceResource1"></asp:Label>
                                                             <asp:TextBox ID="txtAllConsumed" runat="server" AutoPostBack="True" SkinID="TextBox_SmalltNormalC" meta:resourcekey="lbConsumeValResource1"
                                                                    TabIndex="6"></asp:TextBox>

                                                       <asp:Label ID="Label1" runat="server" SkinID="Label_DefaultNormal"
                                                                Text="المتبقي" meta:resourcekey="lblRemainBalanceResource1"></asp:Label>
                                                             <asp:TextBox ID="txtRemain" runat="server" Enabled="false" SkinID="TextBox_SmalltNormalC" meta:resourcekey="lbRemainValResource1"
