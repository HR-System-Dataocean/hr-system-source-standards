<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmEndOfServices.aspx.vb"
    Inherits="frmEndOfServices" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
...
<head runat="server">
    <title>* Venus Payroll * ~EndofServices Types</title>
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmEndOfServices" runat="server">
                                                ...
                                                <table style="width: 100%; height: 30px; vertical-align: bottom; border-bottom: 1px solid black"
                                                    ...
                                                    <tr>
                                                        <td style="vertical-align: bottom">
                                                            <asp:Label ID="Label_Title1" runat="server" Text="برجاء تحديد الشرائح المختلفة لنهاية الخدمة"
                                        ...
                                        <tr>
                                            <td style="height: 16px; vertical-align: top" colspan="3">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                        <td>
                                                            <igtbl:UltraWebGrid  Browser="UpLevel"   ID="uwgEndOfServiceRules" runat="server" EnableAppStyling="True"
                                                                Height="280px" Width="100%" SkinID="Default" meta:resourcekey="uwgEndOfServiceRulesResource1">
                                                                <DisplayLayout AllowColSizingDefault="Free" AllowAddNewDefault="Yes" AllowColumnMovingDefault="OnServer"
                                                                    ...
                                                                    <ClientSideEvents CellClickHandler="uwgEndOfServiceRules_CellClickHandler" />
                                                                </DisplayLayout>
                                                                <Bands>
                                                                    <igtbl:UltraGridBand meta:resourcekey="UltraGridBandResource1">
                                                                        <Columns>
                                                                            <igtbl:UltraGridColumn BaseColumnName="EndOfServiceID" DataType="System.Int32" FieldLen="4"
                                                                                Hidden="True" Key="EndOfServiceID" meta:resourcekey="UltraGridColumnResource1">
                                                                            </igtbl:UltraGridColumn>
                                                                            <igtbl:UltraGridColumn BaseColumnName="FromWorkingMonths" DataType="System.Int32"
                                                                                EditorControlID="" FieldLen="3" FooterText="Vacation Type" HeaderText="From Working Months"
                                                                                Key="FromWorkingMonths" Width="20%" meta:resourcekey="UltraGridColumnResource2">
                                                                                <Header Caption="From Working Months">
                                                                                    <RowLayoutColumnInfo OriginX="1" />
                                                                                </Header>
                                                                                <Footer Caption="Vacation Type">
                                                                                    <RowLayoutColumnInfo OriginX="1" />
                                                                                </Footer>
                                                                            </igtbl:UltraGridColumn>
                                                                            <igtbl:UltraGridColumn BaseColumnName="ToWorkingMonths" DataType="System.Int32" EditorControlID=""
                                                                                FieldLen="3" HeaderText="To Working Months" Key="ToWorkingMonths" Width="20%"
                                                                                meta:resourcekey="UltraGridColumnResource3">
                                                                                <Header Caption="To Working Months">
                                                                            ...
                                                                            <igtbl:UltraGridColumn AllowUpdate="No" BaseColumnName="Formula" HeaderText="Formula"
                                                                                Key="Formula" Width="25%" meta:resourcekey="UltraGridColumnResource4">
                                                                                <CellButtonStyle BackColor="Transparent">
                                                                                </CellButtonStyle>
                                                                                <SelectedHeaderStyle VerticalAlign="Middle">
                                                                                </SelectedHeaderStyle>
                                                                                <CellStyle VerticalAlign="Middle">
                                                                                </CellStyle>
                                                                                <Header Caption="Formula">
                                                                                    <SelectedStyle VerticalAlign="Middle">
                                                                                    </SelectedStyle>
                                                                            ...
                                                                            <igtbl:UltraGridColumn BaseColumnName="AmountPercent" DataType="System.Int32" Key="AmountPercent"
                                                                                Width="10%" meta:resourcekey="UltraGridColumnResource5">
                                                                                <Header Caption="PCT">
                                                                            ...
                                                                            <igtbl:UltraGridColumn AllowUpdate="No" BaseColumnName="ExtraDedFormula" HeaderText="ExtraFormula"
                                                                                Key="Formula" Width="25%" meta:resourcekey="UltraGridColumnResource6">
                                                                                <CellButtonStyle BackColor="Transparent">
                                                                                </CellButtonStyle>
                                                                                <SelectedHeaderStyle VerticalAlign="Middle">
                                                                                </SelectedHeaderStyle>
