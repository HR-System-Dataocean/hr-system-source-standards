<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmOvertimeRequestStatus.aspx.vb"
    ...
    <Appearance>
      ...
      <table style="width: 100%; vertical-align: top" cellspacing="0">
       ...
       <td class="LblEmpCode" style="min-width: 90px;">
           <asp:Label ID="Label2" runat="server" Text="Emp Code" SkinID="Label_DefaultNormal"
       ...
       <td class="LblEmpName" style="min-width: 90px;">
           <asp:Label ID="Label1" runat="server" Text="Emp Name" SkinID="Label_DefaultNormal"
               ...
               AutoPostBack="True" meta:resourcekey="TxtEmpNameResource1" ReadOnly="true">
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblHoursNo" Width="90px" runat="server" Text="Hours Number"
                                                                SkinID="Label_DefaultNormal" meta:resourcekey="lblHoursNoResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                         <asp:TextBox ID="txtHoursNo" runat="server" SkinID="TextBox_SmalltNormalC" MaxLength="30"
                                                                AutoPostBack="False" ReadOnly="False"  meta:resourcekey="txtHoursNoResource1">
                                                           </asp:TextBox>
                                                        </td>
                                                       <td class="SeparArea">
                                                        &nbsp;&nbsp;
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                       ...
                                                       <td class="LabelArea">
                                                            <asp:Label ID="lblOverTimeDate" Width="90px" runat="server" Text="OverTime Date"
                                                                SkinID="Label_DefaultNormal" meta:resourcekey="lblOverTimeDateResource1"></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                            ...
                                            <td style="width: 47%; height: 16px; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblOverTimeType" Width="90px" runat="server" Text="Overtime Type" meta:resourcekey="lblOverTimeTypeResource1"
