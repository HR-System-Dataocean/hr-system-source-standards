<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmVariousRequestTypes.aspx.vb" Inherits="frmReligions"
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmReligions" runat="server">
    ...
    <div class="Div_MasterContainer" runat="server" id="DIV">
       ...
       <td class="LabelArea">
           <asp:Label ID="LblReportName" runat="server" Text="اسم التقرير" SkinID="Label_DefaultNormal"
               meta:resourcekey="LblReportNameResource1"></asp:Label>
       </td>
       <td class="DataArea">
           <asp:TextBox ID="TxtReportName" runat="server" SkinID="TextBox_LargeNormalrtl" MaxLength="255"
               meta:resourcekey="TxtReportNameResource1"></asp:TextBox>
       </td>
   </tr>
                                                </table>
                                            </td>
