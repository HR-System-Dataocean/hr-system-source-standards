<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmSectors.aspx.vb"
    Inherits="frmSectors" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
...
<head runat="server">
    <title>* Venus Payroll * ~Sectors</title>
...
<body style="height: 100%; margin: 0; padding: 0;" onload='adjustHeight()'>
    <form id="frmSectors" runat="server">
                                    ...
                                    <table style="width: 100%; height: 100%; min-height: 350px; vertical-align: top"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="LabelArea">
                                                            <asp:Label ID="lblParentBranch" runat="server" meta:resourcekey="lblParentBranchResource1"
                                                                SkinID="Label_DefaultNormal" Text=" القطاع الرئيسى "></asp:Label>
                                                        </td>
                                                        <td class="DataArea">
                                                    ...
                                                    <tr>
                                                        <td style="vertical-align: bottom">
                                                            <asp:Label ID="Label_Title1" runat="server" meta:resourcekey="Label_Title1Resource1"
                                                                SkinID="Label_DefaultBold" Text="برجاء تحديد الأقسام المرتبطة بهذا القطاع"></asp:Label>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                        ...
                                        <tr>
                                            <td style="height: 100%" colspan="3">
                                                <igtbl:UltraWebGrid  Browser="UpLevel"   ID="uwgDepartment" runat="server" EnableAppStyling="False" Height="100%"
                                                        ...
                                                        <igtbl:UltraGridBand meta:resourcekey="UltraGridBandResource1">
                                                            <Columns>
                                                                ...
                                                                <igtbl:UltraGridColumn AllowUpdate="No" BaseColumnName="EngName" Key="EngName" meta:resourcekey="GridEngName"
                                                                    Width="45%">
                                                                    <Header Caption="Department English Name">
                                                                ...
                                                                <igtbl:UltraGridColumn AllowUpdate="No" BaseColumnName="ArbName" Key="ArbName" meta:resourcekey="GridArbName"
                                                                    Width="45%">
                                                                    <Header Caption="Department Arabic Name">
                                                                ...
                                                                <igtbl:UltraGridColumn BaseColumnName="DepartmentID"
                                                                    DataType="System.Int64" Hidden="True" Key="DepartmentID">
                                                                    <Header>
