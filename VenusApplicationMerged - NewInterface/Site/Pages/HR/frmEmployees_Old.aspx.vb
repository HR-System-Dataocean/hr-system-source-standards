...
#Region "Private Functions"
    ...
    Private Function SetToolBarPermissions(ByVal StrKeys As String, ByVal blContracts As Boolean)
        If StrKeys.Trim.Length > 0 Then
            ...
            Else
                ...
                If arrKeys(2) <> "1" Then ImageButton_Save.Enabled = False : ImageButton_SaveN.Enabled = False
    ...
    Private Sub AddEventToControls()
        ...
        ImageButton_Documents.Attributes.Add("onclick", "OpenModal1('frmEmployeesDocuments.aspx?TB=" & ClsEmployees.Table.ToString.Trim() & "&SV=" & ClsEmployees.ID & "&',495,800,true,false,''); return false;")
