<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmAnnualVacationsNotificationORG.aspx.vb"
    ...
    <script type="text/javascript" id="igClientScript">
        ...
        function uwgEmployeeVacations_ClickCellButtonHandler(gridName, cellId) {
            ...
            if (cell.Column.Index == 7) {
                ...
                if (FormCode == "SS_0011" || FormCode == "SS_0012" || FormCode == "SS_0013" || FormCode == "SS_0018") {
                    OpenModal1("FrmAnnualVacationRequestAction.aspx?RequestSerial=" + RequestSerial + "&RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 800, 800, false, "");

                }
                if (FormCode == "SS_0014") {
                    OpenModal1("FrmExceuseRequestAction.aspx?RequestSerial=" + RequestSerial + "&RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 560, 800, false, "");
                }
                if (FormCode == "SS_0015" || FormCode == "SS_0019") {
                    OpenModal1("FrmEndOfServiceRequestAction.aspx?RequestSerial=" + RequestSerial + "&RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 560, 800, false, "");
                }
                ...
                if (FormCode == "SS_001911") {
                    OpenModal1("FrmDaycareSupportReaquestAction.aspx?RequestSerial=" + RequestSerial + "&RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 560, 800, false, "");
                }
                if (FormCode == "SS_001910") {
                    OpenModal1("FrmPhysiciansPrivilegingFormRequestAction.aspx?RequestSerial=" + RequestSerial + "&RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 560, 800, false, "");
                }
                if (FormCode == "SS_00199") {
                    OpenModal1("FrmConflictofInterestFormRequestAction.aspx?RequestSerial=" + RequestSerial + "&RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 560, 800, false, "");
                }
                if (FormCode == "SS_00198") {
                    OpenModal1("FrmAssaultEscalationFormRequestAction.aspx?RequestSerial=" + RequestSerial + "&RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 560, 800, false, "");
                }
                if (FormCode == "SS_00197") {
                    OpenModal1("FrmInterviewEvaluationFormRequestAction.aspx?RequestSerial=" + RequestSerial + "&RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 560, 800, false, "");
                }
                if (FormCode == "SS_00196") {
                    OpenModal1("FrmGrievanceFormRequestAction.aspx?RequestSerial=" + RequestSerial + "&RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 560, 800, false, "");
                }
                if (FormCode == "SS_00195") {
                    OpenModal1("FrmTrainingRequestAction.aspx?RequestSerial=" + RequestSerial + "&RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 560, 800, false, "");
                }
                if (FormCode == "SS_00194") {
                    OpenModal1("FrmOtherLetterRequestAction.aspx?RequestSerial=" + RequestSerial + "&RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 560, 800, false, "");
                }
                if (FormCode == "SS_00193") {
                    OpenModal1("FrmLoanLetterRequestAction.aspx?RequestSerial=" + RequestSerial + "&RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 560, 800, false, "");
                }
                if (FormCode == "SS_00192") {
                    OpenModal1("frmVisaRequestAction.aspx?RequestSerial=" + RequestSerial + "&RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 560, 800, false, "");
                }
                if (FormCode == "SS_00191") {
                    OpenModal1("frmExitEntryRequestAction.aspx?RequestSerial=" + RequestSerial + "&RequestType=" + RequestType.value + "&ConfigID= " + ConfigID, 560, 800, false, "");
                }
            }
            else {
                var ultraTab = igtab_getTabById("UltraWebTab1");
