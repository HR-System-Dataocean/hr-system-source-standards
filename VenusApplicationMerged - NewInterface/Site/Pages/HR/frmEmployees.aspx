<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmEmployees.aspx.vb" Inherits="frmEmployees"
                    ...
                    <td style="width: 100%; height: 60px; vertical-align: top" colspan="3">
                        <table style="width: 100%; height: 18px; vertical-align: top; border-bottom: 1px solid silver">
                            <tr>
                                ...
                                <td style="width: 24px">
                                    <asp:ImageButton ID="ImageButton1_Save" Width="16px" Height="16px" runat="server"
                                ...
                                <td style="width: 80px">
                                    <asp:ImageButton ID="ImageButton_History" Width="16px" Height="16px" runat="server"
                                        ImageUrl="./img/Form.bmp" CommandArgument="History" meta:resourcekey="ImageButton_PropertiesResource1" />
                                    <asp:LinkButton ID="LinkButton_History" runat="server" Text="السجل" CommandArgument="History"
                                        meta:resourcekey="LinkButton_HistoryResource1"></asp:LinkButton>
                                </td>
                                <td style="width: 80px">
                                ...
                                <td style="width: 40px">
                                    ...
                                    <asp:LinkButton ID="LinkButton_Import" runat="server" CommandArgument="Import" Style="font-family: Tahoma; font-size: 8pt; font-weight: Normal;"
                                        Text="التحقق من رقم الهوية" meta:resourcekey="LinkButton_ImportResource1" Visible="True"
                                            ...
                                            <td style="width: 49%; vertical-align: top">
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    <tr>
                                                       ...
                                                       <tr>
       <td style="width: 40%; height: 16px; vertical-align: middle;">
           <asp:Label ID="LblLastUpdateBy" runat="server" Text="اخر تعديل بواسطة" SkinID="Label_CopyRightsBold"
               meta:resourcekey="LblLastUpdateByResource1"></asp:Label>

       </td>
       <td style="width: 60%; height: 16px; vertical-align: middle;">
      <asp:Label ID="LblLastUpdateByValue" runat="server" SkinID="Label_CopyRightsNormal" meta:resourcekey="LblLastUpdateByValue"></asp:Label>
  </td>
       <td style="width: 60%; height: 16px; vertical-align: middle;">
           <asp:Label ID="lblLastUpdateDate" runat="server" SkinID="Label_CopyRightsNormal" meta:resourcekey="lblLastUpdateDateResource1"></asp:Label>
       </td>
                                                                                ...
                                                                                <tr>
                                                                                    <td style="width: 20%;">
                                                                                        <igtxt:WebImageButton ID="btnSearchCode" runat="server" AutoSubmit="False" Height="18px"
                                                                                         ...
                                                                                         <asp:Label ID="lblEmpID" runat="server" meta:resourcekey="lblEmpIDResource1" SkinID="Label_DefaultNormal"
     Text="Code "></asp:Label>
                                                                                    </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td colspan="4">
                                                                            ...
                                                                            <asp:Label ID="lblInsertRequestsForAnotherEmployee" runat="server" Style="margin-right: 20px; width: 21%; font-size: small" Text="Insert RequestsFor others" SkinID="TextBox_LargeNormalC"
                                                                                meta:resourcekey="lblInsertRequestsForAnotherEmployeeResource1"></asp:Label>
                                                                            <asp:CheckBox ID="chkInsertRequestsForAnotherEmployee" runat="server" />

                                                                            <asp:Label ID="lblIsSocialInsuranceIncluded" runat="server" Style="margin-right: 20px; width: 21%; font-size: small" Text="Social Insurance Included" SkinID="TextBox_LargeNormalC"
                                                                                meta:resourcekey="lblIsSocialInsuranceIncludedResource1"></asp:Label>
                                                                            <asp:CheckBox ID="chkIsSocialInsuranceIncluded" runat="server" />
                                                                        </td>
                                                                        <td colspan="4">
...
<td>
  ...
  <td>
      <asp:TextBox ID="txtPhone" runat="server" SkinID="TextBox_LargeNormalC" meta:resourcekey="txtPhoneResource1"></asp:TextBox>
                                                        ...
                                                        <td>
                                                            <asp:Label ID="lblAddress" runat="server" SkinID="Label_DefaultNormal" Text="Address As Per Contract"
                                                                Width="80px" meta:resourcekey="lblAddressResource1"></asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtAddress" runat="server" SkinID="TextBox_LargeNormalC" meta:resourcekey="txtPhoneResource1"></asp:TextBox>
                                                        </td>
                                                       <%-- <td>&nbsp;&nbsp;
                                                        </td>--%>
                                                    </tr>
 ...
 <td>
     <asp:DropDownList ID="ddlLblPaymentType" runat="server" SkinID="DropDownList_LargNormal" meta:resourcekey="ddlBankResource1">
         ...
         <asp:ListItem meta:resourcekey="SalaryAccountLabel" Value="Salary">بطاقة راتب</asp:ListItem>--%>
                                            ...
                                            <%-- --=========== 12-11-2024   Issue Date=============--%>
                                                    <tr>
    <td>&nbsp;
    </td>
    <td>
        <asp:Label ID="lblPassportIssueDate" runat="server" Width="80px" SkinID="Label_DefaultNormal"
            Text="Passport Issue Date" meta:resourcekey="lblPassportIssueDateResource1"></asp:Label>
    </td>
    <td>
                        <igtxt:WebMaskEdit ID="txtPassportIssueDate" runat="server" InputMask="##/##/####" SkinID="WebMaskEdit_Default">
</igtxt:WebMaskEdit>
    </td>
    <td></td>
    <td>
        <asp:Label ID="lblIdentityIssueDate" runat="server" SkinID="Label_DefaultNormal" Text="Identity Issue Date"
            Width="80px" meta:resourcekey="lblIdentityIssueDateResource1"></asp:Label>
    </td>
    <td>
                <%--<asp:TextBox ID="txtIdentityIssueDate" runat="server" SkinID="TextBox_LargeNormalC" ></asp:TextBox>--%>
                <%--<asp:TextBox ID="txtSSNoIssueDate" runat="server" SkinID="TextBox_LargeNormalC"></asp:TextBox>--%>
               <igtxt:WebMaskEdit ID="txtSSNoIssueDate" runat="server" InputMask="##/##/####" SkinID="WebMaskEdit_Default">
</igtxt:WebMaskEdit>
    ...
    <td>
        <asp:Label ID="lblPassportExpireDate" runat="server" Width="80px" SkinID="Label_DefaultNormal"
            Text="Passport Expire Date" meta:resourcekey="lblPassportExpireDateResource1"></asp:Label>
    </td>
    <td>
                      <asp:TextBox ID="textPssportExpDate" runat="server" SkinID="TextBox_LargeNormalC"></asp:TextBox>

   <%--   <igtxt:WebMaskEdit ID="textPssportExpDate" runat="server" InputMask="##/##/####" SkinID="WebMaskEdit_Default">
  </igtxt:WebMaskEdit>--%>
    </td>
    <td></td>
    <td>
        <asp:Label ID="lblIdentityExpireDate" runat="server" SkinID="Label_DefaultNormal" Text="Identity Expire Date"
            Width="80px" meta:resourcekey="lblIdentityExpireDateResource1"></asp:Label>
    </td>
    <td>

      <igtxt:WebMaskEdit ID="txtSSNoExpireDate" runat="server" InputMask="##/##/####" SkinID="WebMaskEdit_Default">
  </igtxt:WebMaskEdit>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                         <%--   <asp:DropDownList ID="ddlPosition" runat="server" SkinID="DropDownList_LargNormal"
                                                                ...
                                                                <asp:textbox ID="TxtPositionCode" runat="server" autopostback="true"  OnTextChanged="TxtPositionCode_TextChanged">
    </asp:textbox>
    <igtxt:WebImageButton ID="WebImageButton5" runat="server" AutoSubmit="False" Height="10px"
                            meta:resourcekey="btnSearchPpsitionResource1" Overflow="NoWordWrap" UseBrowserDefaults="False"
                            Width="20px">
                            <Alignments TextImage="ImageBottom" />
                            <Appearance>
                                <Image Url="./Img/forum_search.gif" />
     ...
     <asp:textbox ID="TxtPositionName" runat="server"  Width="300" EnableTheming="True" Height="18px" meta:resourcekey="txtBirthDateResource1" NullDateLabel="" Style="font-family: Tahoma; font-size: 8pt; font-weight: Normal;
color: Black; border: solid 1px #CCCCCC" Value="" >
    </asp:textbox>
