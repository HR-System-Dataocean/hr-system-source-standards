...
#Region "Public Decleration"
    Private ClsReligions As Clshrs_Religions
...
#Region "Protected Sub"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ClsReligions = New Clshrs_Religions(Me.Page, "hrs_Religions")
        ...
        Catch ex As Exception
            ...
            mErrorHandler.RecordExceptions_DataBase("", ex, Err.Number, ClsReligions.RegUserID, Venus.Shared.ErrorsHandler.eRecordingType.System_DataBase)
...
#Region "Private Functions"
    Private Function SavePart() As Boolean
        Dim StrMode As String = Request.QueryString.Item("Mode")
        ClsReligions = New Clshrs_Religions(Page, "hrs_Religions")

        Try
            ClsReligions.Find("Code='" & txtCode.Text & "'")

            If ClsReligions.ID > 0 Then
            ...
            clsMainOtherFields.CollectDataAndSave(value.Text, ClsReligions.Table, ClsReligions.ID)
            value.Text = ""
            Return True
        Catch ex As Exception
            Return False
        End Try
    End Function
    Private Function AssignValue(ByRef ClsReligions As Clshrs_Religions) As Boolean
        Try
            With ClsReligions
                .Code = txtCode.Text
        ...
        End Try
    End Function
    Private Function GetValues(ByVal ClsReligions As Clshrs_Religions) As Boolean
        ...
        Try
            ...
            With ClsReligions
                ...
                If Page.IsPostBack Then
                    CreateOtherFields(ClsReligions.ID)
                End If
            End With
            Return True
        Catch ex As Exception
    ...
    Private Function CheckCode() As Boolean
        ...
        Try
            ClsReligions.Find("Code='" & txtCode.Text & "'")
            IntId = ClsReligions.ID
            txtEngName.Focus()
            If ClsReligions.ID > 0 Then
                GetValues(ClsReligions)
                StrMode = "E"
            Else
                If ClsReligions.CheckRecordExistance(" Code='" & txtCode.Text & "'") Then
                    txtCode.Text = ""
                    txtCode.Focus()
                End If
            ...
            End If
            SetToolBarDefaults()
            SetToolBarPermission(Me, ClsReligions.ConnectionString, ClsReligions.DataBaseUserRelatedID, ClsReligions.GroupID, StrMode)
            SetToolBarRecordPermission(Me, ClsReligions.ConnectionString, ClsReligions.DataBaseUserRelatedID, ClsReligions.GroupID, ClsReligions.Table, IntId)
    ...
    Private Sub LoadDataUpdateSchedules(ByVal formName As String)
        ...
        ClsReligions = New Clshrs_Religions(Me.Page, "hrs_Religions")
        ClsReligions.Find(" code = '" & txtCode.Text & "'")
        Dim recordID As Integer = ClsReligions.ID
        If (recordID > 0) Then
    ...
    Private Function CreateOtherFields(ByVal IntRecordID As Integer)
        ...
        If clsMainOtherFields.CheckOtherFieldsButton(Me.Page, ClsReligions.Table) = True Then
            Dim StrTablename As String
            ClsReligions = New Clshrs_Religions(Me, "hrs_Religions")
            StrTablename = ClsReligions.Table
