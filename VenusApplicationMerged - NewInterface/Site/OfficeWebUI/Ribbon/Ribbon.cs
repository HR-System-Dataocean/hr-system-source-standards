...
namespace OfficeWebUI
{
    ...
    public class OfficeRibbon : ControlAncestor, INamingContainer, ICompositeControlDesignerAccessor
    {
        ...
        private Boolean _LockToBackstage = false;
        ...
        [Browsable(true)]
        [Category("Appearance")]
        public Boolean LockToBackstage
        {
            get { return this._LockToBackstage; }
            set { this._LockToBackstage = value; }
        }
        ...
        private void _AddHelpButton()
        {
            ...
            if (_appMenuDirection == DocumentDirection.LTR) lHelpButtonContainer.CssClass = "RibbonHelpButtonContainer";
            else lHelpButtonContainer.CssClass = "RibbonHelpButtonContainerRtl";
        ...
        private void _AddToogleButton()
        {
            ...
            if (_appMenuDirection == DocumentDirection.LTR) lToggleButtonContainer.CssClass = "RibbonToggleButtonContainer";
            else lToggleButtonContainer.CssClass = "RibbonToggleButtonContainerRtl";
        ...
        private void _AddExtraControls()
        {
            ...
            if (_appMenuDirection == DocumentDirection.LTR) lExtraControlsContainer.CssClass = "RibbonExtraControlsContainer";
            else lExtraControlsContainer.CssClass = "RibbonExtraControlsContainerRtl";
        ...
        private void _AddExtraText()
        {
            ...
            if (_appMenuDirection == DocumentDirection.LTR) lExtraTextContainer.CssClass = "RibbonExtraTextContainer";
            else lExtraTextContainer.CssClass = "RibbonExtraTextContainerRtl";
        ...
        private void _AddApplicationMenu()
        {
            ...
            if (_appMenuDirection == DocumentDirection.LTR) lApplicationMenuContainer.Style.Add("float", "left");
            else lApplicationMenuContainer.Style.Add("float", "right");
            ...
            {
                if (_LockToBackstage == true)
                {
                    lApplicationMenu.Attributes.Add("onclick", "OfficeWebUI.Ribbon.ToggleOnBackstage(0)");
                }
                else
                {
        ...
        private void _BuildBackstage(Control container)
        {
            ...
            if (_appMenuDirection == DocumentDirection.LTR) lPanelPagesColumn.CssClass = "BackstagePagesColumn";
            else lPanelPagesColumn.CssClass = "BackstagePagesColumnRtl";
            container.Controls.Add(lPanelPagesColumn);

            Panel lPanelContentColumn = new Panel();

            if (_appMenuDirection == DocumentDirection.LTR) lPanelContentColumn.CssClass = "BackstageContentColumn";
            else lPanelContentColumn.CssClass = "BackstageContentColumnRtl";
