...
namespace OfficeWebUI.Workspace
{
    ...
    internal class AreaRenderer : ControlAncestor, IPostBackEventHandler
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            this._panelAreaButton.BackColor = _src.SortColor;
            //this._panelAreaButton.Attributes.Add("onclick", Page.ClientScript.GetPostBackEventReference(p));
            ...
            lTableCellText.Width = new Unit(87, UnitType.Percentage);
            ...
            //TableCell lTableCellColor = new TableCell();
            //lTableCellColor.Width = new Unit(20, UnitType.Pixel);
            ////lTableCellColor.BackColor = _src.SortColor;
            //lTableRow.Controls.Add(lTableCellColor);
