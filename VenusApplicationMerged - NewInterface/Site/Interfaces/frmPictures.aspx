<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmPictures.aspx.vb" Inherits="frmPictures"
...
<head runat="server">
    ...
    <script language="javascript" src="App_JScript.js" type="text/javascript"></script>
    <script language="javascript" src="App_JScript_M.js" type="text/javascript"></script>
    <script language="javascript" src="App_Pictures.js" type="text/javascript"></script>
</head>
                                                ...
                                                <table style="width: 100%; vertical-align: top" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 38%; vertical-align: top;" rowspan="2">
                                                            <igtbl:UltraWebGrid   ID="uwgDocumentPictures" runat="server" EnableAppStyling="False"
