...
#Region "Protected Subs"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            Dim RecordID As Integer = Request.QueryString.Item("RId")
    ...
    Protected Sub btnCancel_Click(ByVal sender As Object, ByVal e As Infragistics.WebUI.WebDataInput.ButtonEventArgs) Handles btnCancel.Click
        ...
        If txtID.Value <> "" Then
            ...
            'ClsObjectsAttachments.Delete("ID =" & Val(txtID.Value))
...
#Region "Private Functions"
    ...
    Private Function Laod_data_Grid() As Boolean
        ...
        Dim RecordID As Integer = Request.QueryString.Item("RId")
        ClsObjectsAttachments = New Clssys_ObjectsAttachments(Me.Page)
        ClsObjectsAttachments.Find(" isNull(CancelDate,'')='' AND ObjectID = " & ObjectID & " AND RecordID = " & RecordID & " AND (ExpiryDate >= '" & Date.Now.Date & "' OR ExpiryDate is null) ORDER BY IsProfilePicture DESC  ")
