...
<head runat="server">
    ...
    <script language="javascript" src="App_Search_JScript.js" type="text/javascript"></script>
...
<body bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    ...
    <div>
        ...
        <div align="left" style="border-right: 1px outset; border-top: 1px outset; z-index: 104;
            ...
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
            <igtbl:UltraWebGrid   ID="UwgSearch" runat="server" Browser="Xml" Height="250px" Style="z-index: 100;
                ...
                <DisplayLayout AllowColSizingDefault="Free" AllowColumnMovingDefault="OnServer" AllowSortingDefault="OnClient"
                    ...
                    RowSelectorsDefault="No" SelectTypeRowDefault="Extended" Version="4.00" CompactRendering="False"
