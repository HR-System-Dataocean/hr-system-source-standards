...
'Developer         : [0257]
'Description       : 1-Implement Data Acess Layer of sys_FiscalYears table with fields code,English name,
'                       Arabic name
'==========================================================================
Public Class Clssys_FiscalYears
...
#Region "Class Constructors"
    ...
    'Module         :  Hrs (Human Resource Module)
    'Project        :  Venus V.
    'Description    :  Intialize select,insert and update commands
    'Date Created      : 01-08-07
    'Developer         : [0257]
    'fn. Arguments  :
    '---------------------------------------------------------
    ...
    Public Sub New(ByVal Page As Web.UI.Page)
        ...
        mUpdateParameter = " Code=@Code,EngName=@EngName,ArbName=@ArbName,ArbName4S=@ArbName4S,CompanyID=@CompanyID,Remarks=@Remarks,RegUserID=@RegUserID,RegComputerID=@RegComputerID"
...
#Region "Public Function"
    ...
    'Module         :  Hrs (Human Resource Module)
    'Project        :  Venus V.
    'Description    :  Find all rows in sys_FiscalYears that match criteria or filter
    'Developer         : [0257]
    'Date Created      : 01-08-07
    'Modifacations  : 
    'fn. Arguments  :
    ...
    'Module         :  Hrs (Human Resource Module)
    'Project        :  Venus V.
    'Description    :  Save new record into sys_FiscalYears table
    ...
    'Module         :  Hrs (Human Resource Module)
    'Project        :  Venus V.
    'Description    :  update row that match with critera into sys_FiscalYears table
    '                  and return true if operation done otherwise report errors in ErrorPage
    'Developer         : [0257]
    'Date Created      : 01-08-07
    'fn. Arguments  :
    ...
    'Module         :  Hrs (Human Resource Module)
    'Project        :  Venus V.
    'Description    :  Delete new row that match critera into sys_FiscalYears table
    '                  and return true if operation done otherwise report errors in ErrorPage                    
    ...
    'Module         :  Hrs (Human Resource Module)
    'Project        :  Venus V.
    'Description    :  Get first record in sys_FiscalYears table
    '                  and return true if operation done otherwise report errors in ErrorPage
    'Developer         : [0257]
    'Date Created      : 01-08-07
    'Modifacations  : 
    ...
    'Module         :  Hrs (Human Resource Module)
    'Project        :  Venus V.
    'Description    :  Get last record in sys_FiscalYears table
    '                  and return true if operation done otherwise report errors in ErrorPage
    'Developer         : [0257]
    'Date Created      : 01-08-07
    'Modifacations  : 
    ...
    'Module         :  Hrs (Human Resource Module)
    'Project        :  Venus V.
    'Description    :  Get next record of current record  from sys_FiscalYears table 
    '                  and return true if operation done otherwise report errors in ErrorPage
    'Developer         : [0257]
    'Date Created      : 01-08-07
    'Modifacations  : 
    ...
    'Module         :  Hrs (Human Resource Module)
    'Project        :  Venus V.
    'Description    :  Get previous record to current record from sys_FiscalYears table
    '                  and return true if operation done otherwise report errors in ErrorPage
    'Developer         : [0257]
    'Date Created      : 01-08-07
    'Modifacations  : 
    ...
    Public Function FirstRecord(ByVal strFilter As String) As Boolean
        ...
        Try
            'StrSelectCommand = "SELECT TOP 1 * FROM " & mTable & " Where  IsNull(dbo.hrs_GetRecordViewStatus(ID,'" & Me.mTable & "'," & Me.mDataBaseUserRelatedID & "," & Me.GroupID & "),0) <> 1  ORDER BY ID ASC"
            StrSelectCommand = "Select TOP 1 * From " & Me.mTable & " Where IsNull(CancelDate,'')='' And IsNull(dbo.hrs_GetRecordViewStatus(ID,'" & Me.mTable & "'," & Me.mDataBaseUserRelatedID & "," & Me.GroupID & "),0) <> 1"
    ...
    'Module         :  Hrs (Human Resource Module)
    'Project        :  Venus V.
    'Description    :  Fill DropDownList with English name column from sys_FiscalYears table
    '                  and return true if operation done otherwise report errors in ErrorPage
    'Developer         : [0257]
    'Date Created      : 01-08-07
    ...
    'Parmeter Name      : Data Type : Description
    '---------------------------------------------------------
    'DdlValues             :ValueList     :used to fill it with English name
    '========================================================================
    ...
    '========================================================================
    Public Function GetDropDown(ByRef DdlValues As Global.System.Web.UI.WebControls.DropDownList, Optional ByVal NullNode As Boolean = False) As Boolean
        Dim ObjDataRow As DataRow
        Dim StrCommandString As String
        Dim ObjDataset As New DataSet
