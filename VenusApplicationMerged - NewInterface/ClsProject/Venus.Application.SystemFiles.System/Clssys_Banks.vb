...
'                   Table: sys_Banks
'                   Relations:
'                               sys_Banks.ID ->> hrs_Employees.BankID
'                               sys_Banks.ID ->> sys_BankAccounts.BankID
'                               sys_Banks.CompanyID ->> sys_Companies.ID
'=========================================================================
Public Class Clssys_Banks
...
#Region "Class Constructors"
    ...
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " sys_Banks "
        mInsertParameter = " Code,EngName,ArbName,ArbName4S,CompanyID,Remarks,RegUserID "
        mInsertParameterValues = " @Code,@EngName,@ArbName,@ArbName4S,@CompanyID,@Remarks,@RegUserID "
