...
#Region "Public Function"
    ...
    'Developer      :  DataOcean   
    'Date Created   :15/11/2015 20:09:01
    'Modifacations  :
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                mID = [Shared].DataHandler.DataValue_Out(.Item("ID"), SqlDbType.BigInt, True)
                mCode = [Shared].DataHandler.DataValue_Out(.Item("Code"), SqlDbType.VarChar)
                mExpiryDate = [Shared].DataHandler.DataValue_Out(.Item("ExpiryDate"), SqlDbType.DateTime)
                mExpiryTime = [Shared].DataHandler.DataValue_Out(.Item("ExpiryTime"), SqlDbType.VarChar)
                ...
                mDetails = [Shared].DataHandler.DataValue_Out(.Item("Details"), SqlDbType.VarChar)
                mIsOpen = [Shared].DataHandler.DataValue_Out(.Item("IsOpen"), SqlDbType.Bit)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@ExpiryDate", SqlDbType.DateTime)).Value = [Shared].DataHandler.DataValue_In(mExpiryDate, SqlDbType.DateTime)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@ExpiryTime", SqlDbType.VarChar)).Value = [Shared].DataHandler.DataValue_In(mExpiryTime, SqlDbType.VarChar)
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Details", SqlDbType.VarChar)).Value = [Shared].DataHandler.DataValue_In(mDetails, SqlDbType.VarChar)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@IsOpen", SqlDbType.Bit)).Value = [Shared].DataHandler.DataValue_In(mIsOpen, SqlDbType.Bit)
