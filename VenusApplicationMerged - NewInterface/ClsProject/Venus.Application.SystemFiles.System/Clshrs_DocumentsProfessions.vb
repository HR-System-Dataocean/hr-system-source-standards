Public Class Clssys_DocumentsProfessions
    Inherits ClsDataAcessLayer

#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " sys_DocumentsProfessions "
        mInsertParameter = " DocumentID,ProfessionID,Excluded,Remarks,RegUserID,RegComputerID"
        mInsertParameterValues = " @DocumentID,@ProfessionID,@Excluded,@Remarks,@RegUserID,@RegComputerID "
        mUpdateParameter = " DocumentID=@DocumentID,ProfessionID=@ProfessionID,Excluded=@Excluded,Remarks=@Remarks "
...
#Region "Public Function"
    ...
    Public Function SaveUpdate(ByVal Filter As String) As Boolean
        ...
        Try
            strSQL = "Select ID From sys_DocumentsProfessions Where " & Filter
