...
"
        ...
        SQL = String.Format(postJournalPreviewSqlTemplate, "hrs_PostJournalPreview_GetProjects_N")
        ExecuteUpdate(SQL)

        SQL = String.Format(postJournalPreviewSqlTemplate, "hrs_PostJournalPreview_GetProjects_V")
        ExecuteUpdate(SQL)

        SQL = String.Format(postJournalPreviewSqlTemplate, "hrs_PostJournalPreview_GetProjects_E")
        ExecuteUpdate(SQL)
...
SELECT 
    ...
    FormCode, 
    ConfigID, 
    SS_VacationRequest.Code AS RequestSerial, 
    ...
    CONVERT(varchar, SS_VacationRequest.RequestDate, 103) AS RequestDate, 
    SS_VacationRequest.VacationType, 
    CASE 
        WHEN SS_VacationRequest.VacationType = 'SS_0011' AND SS_VacationRequest.VacationTypeID = 1 THEN 'اجازة سنوي اداري' 
        WHEN SS_VacationRequest.VacationType = 'SS_0012' AND SS_VacationRequest.VacationTypeID = 1 THEN 'اجازة سنوي طبي' 
        WHEN SS_VacationRequest.VacationType = 'SS_0030' AND SS_VacationRequest.VacationTypeID = 1 THEN 'اجازة سنوي تشغيلي'
        WHEN SS_VacationRequest.VacationType = 'SS_0032' AND SS_VacationRequest.VacationTypeID = 1 THEN 'طلب إجازة سنوية – إداري داخلي'
        WHEN SS_VacationRequest.VacationType = 'SS_0033' AND SS_VacationRequest.VacationTypeID = 1 THEN 'طلب إجازة سنوية – تمريض'
        WHEN SS_VacationRequest.VacationType = 'SS_0034' AND SS_VacationRequest.VacationTypeID = 1 THEN 'طلب إجازة سنوية – الإدارة العامة'
        WHEN SS_VacationRequest.VacationType = 'SS_0031' THEN 'اجازة اخرى تشغيلي' 
        ELSE hrs_VacationsTypes.ArbName4S 
    END AS RequestArbName, 
    CASE 
        WHEN SS_VacationRequest.VacationType = 'SS_0011' AND SS_VacationRequest.VacationTypeID = 1 THEN 'Annual Vacation Admin' 
        WHEN SS_VacationRequest.VacationType = 'SS_0012' AND SS_VacationRequest.VacationTypeID = 1 THEN 'Annual Vacation Medical' 
        WHEN SS_VacationRequest.VacationType = 'SS_0030' AND SS_VacationRequest.VacationTypeID = 1 THEN 'Annual Vacation Operational' 
        WHEN SS_VacationRequest.VacationType = 'SS_0032' AND SS_VacationRequest.VacationTypeID = 1 THEN 'Annual Leave Request – Internal Administration'
        WHEN SS_VacationRequest.VacationType = 'SS_0033' AND SS_VacationRequest.VacationTypeID = 1 THEN 'Annual Leave Request – Nursing'
        WHEN SS_VacationRequest.VacationType = 'SS_0034' AND SS_VacationRequest.VacationTypeID = 1 THEN 'Annual Leave Request – General Administration'
        WHEN SS_VacationRequest.VacationType = 'SS_0031' THEN 'Other Vacation Operational' 
        ELSE hrs_VacationsTypes.EngName 
    END AS RequestEngName, 
    SS_EmployeeID,
    hrs_Employees.BranchID  -- **تمت الإضافة هنا**
FROM 
    SS_RequestActions 
    JOIN SS_VacationRequest ON SS_RequestActions.RequestSerial = SS_VacationRequest.ID AND SS_RequestActions.EmployeeID = SS_VacationRequest.EmployeeID 
    JOIN hrs_Employees ON SS_RequestActions.EmployeeID = hrs_Employees.ID 
    JOIN hrs_VacationsTypes ON SS_VacationRequest.VacationTypeID = hrs_VacationsTypes.ID
WHERE 
    (Seen IS NULL OR Seen = 0) 
    AND (FormCode = 'SS_0011' OR FormCode = 'SS_0012' OR FormCode = 'SS_0013' OR FormCode = 'SS_0030' OR FormCode = 'SS_0031' OR FormCode = 'SS_0032' OR FormCode = 'SS_0033' OR FormCode = 'SS_0034' OR FormCode = 'SS_0018')
