Public Class Clssys_CompaniesUsers
    Inherits ClsDataAcessLayer

#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        Me.mTable = " sys_CompaniesUsers "
        Me.mInsertParameter = " CompanyID,UserID,CanView,RegUserID,RegDate,CancelDate "
        Me.mInsertParameterValues = " @CompanyID,@UserID,@CanView,@RegUserID,@RegDate,@CancelDate "
        Me.mUpdateParameter = " CompanyID=@CompanyID,UserID=@UserID,CanView=@CanView,RegUserID=@RegUserID,RegDate=@RegDate,CancelDate=@CancelDate "
...
#Region "Public Function"
    ...
    Public Function SaveUpdate(ByVal Filter As String) As Boolean
        Try
            ...
            strSQL = "Select ID From sys_CompaniesUsers Where " & Filter
    ...
    Public Function previousRecord() As Boolean
        ...
        End Try
    End Function
    Public Function GetAllCompaniesByUser(ByVal inUserId As Integer, ByRef ds As Data.DataSet) As Boolean
        Try
            ds = Microsoft.ApplicationBlocks.Data.SqlHelper.ExecuteDataset(mConnectionString, "GetUsersCompanies", inUserId)
        Catch ex As Exception
            mPage.Session.Add("ErrorValue", ex)
            mErrorHandler.RecordExceptions_DataBase("", ex, Err.Number, 0, Venus.Shared.ErrorsHandler.eRecordingType.System_DataBase)
            mPage.Response.Redirect("ErrorPage.aspx")
...
#Region "Class Private Function"
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mGroupID = mDataHandler.DataValue_Out(.Item("CompanyID"), SqlDbType.Int, True)
                mUserID = mDataHandler.DataValue_Out(.Item("UserID"), SqlDbType.Int, True)
                mCanView = mDataHandler.DataValue_Out(.Item("CanView"), SqlDbType.Bit, True)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@CanView", SqlDbType.Bit)).Value = mDataHandler.DataValue_In(mCanView, SqlDbType.Bit, True)
