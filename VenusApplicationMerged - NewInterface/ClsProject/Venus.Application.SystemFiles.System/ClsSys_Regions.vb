Public Class Clssys_RegionsBase
    Inherits ClsDataAcessLayer
    '==================================================================
'Created by : [0258]
    'Date : 10/07/2007

    'Description: This Class Related to Countries Class
    'Have Relation : Yes
    'Class Relation : Cities 
    'Relation Type : One to many
    'Decript Relation : One Region can placed with more than Cities
...
#Region "Class Constructors"
    ...
    Public Sub New(ByVal Page As Web.UI.Page, ByVal TableName As String)
        MyBase.New(Page)
        mTable = TableName
        mInsertParameter = " Code,EngName,ArbName,ArbName4S,CountryID,Remarks,RegUserID,RegComputerID "
        mInsertParameterValues = " @Code,@EngName,@ArbName,@ArbName4S,@CountryID,@Remarks,@RegUserID,@RegComputerID "
        mUpdateParameter = " Code=@Code,EngName=@EngName,ArbName=@ArbName,ArbName4S=@ArbName4S,CountryID=@CountryID,Remarks=@Remarks "
...
#Region "Public Function"
    ...
    'Description: Find all columns from sys_Regions table where filter and canceldate = null  
    'Steps: 
    ...
    'Steps: 
    '       1-Execute sql statment to get ID from sys_Regions where filter 
    '       2-Check if ID > 0 this mean that row is already exist in sys_Regions  table 
    '       the make Update to this row
    '           IF ID =0 this mean that row is new row Then Insert the row in sys_Regions  table
    '==================================================================
    Public Function SaveUpdate(ByVal Filter As String) As Boolean
        Dim strSQL As String = String.Empty
        Dim Value As Integer
        Try
            strSQL = "Select ID From sys_Regions Where " & Filter
    ...
    'Description: Save New Row in sys_Regions  table
    'Steps: 
    ...
    'Description: Update existing Row in sys_Regions  table where filter
    'Steps: 
    '       1-execute sqlstatment to Update existing row in sys_Regions  table
    ...
    'Description: Delete existing Row in sys_Regions  table where filter
    'Steps: 
    '       1-execute sqlstatment to Delete existing row in sys_Regions  table
    ...
    'Created by : [0258]
    'Date : 09/07/2007
    'Description:  find first row in sys_Regions table
    'Steps: 
    '       1-execute sqlstatment to find first row in sys_Regions  table
    ...
    'Created by : [0258]
    'Date : 09/07/2007
    'Description:  find Last row in sys_Regions  table
    'Steps: 
    '       1-execute sqlstatment to find last row in sys_Regions  table
    '       2-Fill dataset with result of sqlstatment
    '       3-call Getparameter function to insert the result of dataset into private members of the class
    '==================================================================
    ...
    'Created by : [0258]
    'Date : 09/07/2007
    'Description:  find Next row in sys_Regions  table
    'Steps: 
    '       1-execute sqlstatment to find Next row in sys_Regions  table
    '       2-Fill dataset with result of sqlstatment
    '       3-call Getparameter function to insert the result of dataset into private members of the class
    '==================================================================
    ...
    'Created by : [0258]
    'Date : 09/07/2007
    'Description:  find previous row in sys_Regions  table
    'Steps: 
    '       1-execute sqlstatment to find previous row in sys_Regions  table
    '       2-Fill dataset with result of sqlstatment
    '       3-call Getparameter function to insert the result of dataset into private members of the class
    '==================================================================
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mCountryID = mDataHandler.DataValue_Out(.Item("CountryID"), SqlDbType.Int, True)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal ptrOperationType As OperationType) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@CountryID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mCountryID, SqlDbType.Int, True)
            ...
            End Select
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@CancelDate", SqlDbType.VarChar)).Value = mDataHandler.DataValue_In(mCancelDate, SqlDbType.VarChar)
        Catch ex As Exception
            mPage.Session.Add("ErrorValue", ex)
            mErrorHandler.RecordExceptions_DataBase("", ex, Err.Number, mDataBaseUserID, Venus.Shared.ErrorsHandler.eRecordingType.System_DataBase)
            mPage.Response.Redirect("ErrorPage.aspx")
...
End Class
Public Class Clssys_Regions
    Inherits Clssys_RegionsBase


    Public Sub New(ByVal Page As Web.UI.Page, ByVal TableName As String)
        MyBase.New(Page, "sys_Regions")
