...
Public Class Clssys_DocumentsNationalities
    Inherits ClsDataAcessLayer

#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " sys_DocumentsNationalities "
        mInsertParameter = " DocumentID,NationalityID,Excluded,Remarks,RegUserID,RegComputerID "
        mInsertParameterValues = " @DocumentID,@NationalityID,@Excluded,@Remarks,@RegUserID,@RegComputerID "
        mUpdateParameter = " DocumentID=@DocumentID,NationalityID=@NationalityID,Excluded=@Excluded,Remarks=@Remarks "
...
#Region "Public Function"
    ...
    Public Function SaveUpdate(ByVal Filter As String) As Boolean
        ...
        Try
            strSQL = "Select ID From sys_DocumentsNationalities Where " & Filter
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mExcluded = mDataHandler.DataValue_Out(.Item("Excluded"), SqlDbType.Bit)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Excluded", SqlDbType.Bit)).Value = mDataHandler.DataValue_In(mExcluded, SqlDbType.Bit)
