...
Private mViewFormID As Integer
Private mIsHide As Boolean
Private mViewType As Object
...
End Set
End Property
Public Property ViewType() As Object
Get
return mViewType
End Get
...
'Developer      :  DataOcean   
'Date Created   :10/05/2014 20:53:01
'Modifacations  :
'fn. Arguments  :
'---------------------------------------------------------
'Parmeter Name      : Data Type : Description
...
mFormID= [Shared].DataHandler.DataValue_Out(.Item("FormID"), SqlDbType.Int,True)
mObjectID= [Shared].DataHandler.DataValue_Out(.Item("ObjectID"), SqlDbType.Int,True)
mViewFormID= [Shared].DataHandler.DataValue_Out(.Item("ViewFormID"), SqlDbType.Int,True)
mIsHide= [Shared].DataHandler.DataValue_Out(.Item("IsHide"), SqlDbType.Bit)
mViewType= [Shared].DataHandler.DataValue_Out(.Item("ViewType"), SqlDbType.tinyint)
...
Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@FormID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mFormID, SqlDbType.Int)
Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@ObjectID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mObjectID, SqlDbType.Int)
Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@ViewFormID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mViewFormID, SqlDbType.Int)
...
Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@ViewType", SqlDbType.tinyint)).Value = mDataHandler.DataValue_In(mViewType, SqlDbType.tinyint)
