...
Public Class ReportViewerSti
    ...
    Public Function ViewReportDetails(ByVal StrFolderMapPath As String, ByVal ClsReportProperties As ClsRpw_ReportsProperties,
    ByVal DTCriteria As Data.DataTable) As Xml.XmlDocument
        ...
        End Try
    End Function
    Public Function ViewReportDetailsxml(ByVal XMLReports As String, ByVal ClsReportProperties As ClsRpw_ReportsProperties,
ByVal DTCriteria As Data.DataTable, ByVal language As Lang) As Xml.XmlDocument
        ...
        End Try
    End Function
    Public Function CreateReportDetails(ByVal ClsReportProperties As ClsRpw_ReportsProperties,
    ByVal DTColumnProperties As Data.DataTable, ByVal DTRowProperties As Data.DataTable, ByVal DTCriteria As Data.DataTable,
    ...
    Public Function UpdateReportDetails(ByVal ClsReportProperties As ClsRpw_ReportsProperties,
    ByVal DTColumnProperties As Data.DataTable, ByVal DTRowProperties As Data.DataTable, ByVal DTCriteria As Data.DataTable,
    ...
    Public Function VolatileReports(ByVal ClsReportProperties As ClsRpw_ReportsProperties,
    ...
    Private Function CreateReport(ByRef Reports As ReportsSti, ByVal ClsReportProperties As ClsRpw_ReportsProperties, ByVal DTCriteria As Data.DataTable) As Boolean
        Dim ObjColorConvertor As New Drawing.ColorConverter
        Dim Report As New ReportSti
        Try
            With Report
    ...
    Private Function UpdateReport(ByRef Reports As ReportsSti,
    ByVal ClsReportProperties As ClsRpw_ReportsProperties,
    ...
    Private Function CreateMainSections(ByRef Report As ReportSti, ByVal ClsReportProperties As ClsRpw_ReportsProperties) As Boolean
        Dim ObjColorConvertor As New Drawing.ColorConverter
        Dim Section As SectionSti
        Try
            With Report.Sections
                Section = New SectionSti
                With Section
                    .Name = "Detail"
                    .Height = 345
                    .Type = 0
    ...
    Private Function UpdateMainSections(ByRef Report As ReportSti,
    ...
    Private Function CreateFieldsHead(ByRef Report As ReportSti,
    ...
    Private Function UpdateFieldsHead(ByRef Report As ReportSti,
    ByVal ReportsProperties As ClsRpw_ReportsProperties, ByVal DtColumns As Data.DataTable) As Boolean
        ...
        Dim ObjDataHandler As New Venus.Shared.DataHandler
        Dim intCurrentWidth As Integer
        Dim ObjFieldE As FieldSti
        Dim ObjFieldA As FieldSti
        Dim bolNotVisable As Boolean
        Dim BolPerVisable As Boolean
        Dim IntColumnIndex As Integer
        Dim IntFieldLanguage As Integer
    ...
    Private Function CreateFieldsDetails(ByRef Report As ReportSti,
    ByVal ReportsProperties As ClsRpw_ReportsProperties, ByVal DtColumns As Data.DataTable) As Boolean
        Dim ObjDataRow As Data.DataRow
        Dim IntForeColor As Integer = 0
        Dim ObjColorConvertor As New Drawing.ColorConverter
    ...
    Private Function UpdateFieldsDetails(ByRef Report As ReportSti,
ByVal ReportsProperties As ClsRpw_ReportsProperties, ByVal DtColumns As Data.DataTable) As Boolean
    ...
    Private Function CreateFieldsFooter(ByRef Report As ReportSti,
    ByVal ReportsProperties As ClsRpw_ReportsProperties, ByVal DtColumns As Data.DataTable) As Boolean
    ...
    Private Function UpdateFieldsFooter(ByRef Report As ReportSti,
ByVal ReportsProperties As ClsRpw_ReportsProperties, ByVal DtColumns As Data.DataTable) As Boolean
    ...
    Private Function CreateRowProperities(ByRef Report As ReportSti,
    ...
    Private Function UpdateRowProperities(ByRef Report As ReportSti,
ByVal ReportsProperties As ClsRpw_ReportsProperties, ByVal DtRows As Data.DataTable) As Boolean
        Dim ObjColorConvertor As New Drawing.ColorConverter
        Dim ObjDataHandler As New Venus.Shared.DataHandler
        Dim IntCounter As Integer
    ...
    Private Function CreateGroup(ByRef Report As ReportSti, ByVal FieldName As String, ByVal Sorted As Integer, ByVal KeepTogether As Integer) As Boolean
        Dim ObjGroup As GroupSti
        Try
            With Report.Groups
                ObjGroup = New GroupSti
                With ObjGroup
    ...
    Private Function updateGroup(ByRef Report As ReportSti, ByVal FieldName As String, ByVal Sorted As Integer, ByVal KeepTogether As Integer) As Boolean
        Dim ObjGroup As GroupSti
        Dim StringHandler As New Venus.Shared.StringHandler
        Try
            With Report.Groups
    ...
    Private Function CreateSection(ByVal Report As ReportSti, ByVal FieldName As String, ByVal SectionHeight As Integer) As Integer
        Dim ObjSection As SectionSti
        Dim IntSectionNumber As Integer = 0
        Try
            With Report.Sections
                ObjSection = New SectionSti
                With ObjSection
    ...
    Private Function UpdateSection(ByVal Report As ReportSti, ByVal FieldName As String, ByVal SectionHeight As Integer) As Integer
        Dim ObjSection As SectionSti
        Dim StringHandler As New Venus.Shared.StringHandler
        Dim IntSectionNumber As Integer = 0
        Try
    ...
    Private Function CreateCriteria(ByRef Report As ReportSti,
    ByVal ReportsProperties As ClsRpw_ReportsProperties, ByVal DtColumns As Data.DataTable) As Boolean
        Dim ObjDataRow As Data.DataRow
        Dim IntForeColor As Integer = 0
        Dim ObjColorConvertor As New Drawing.ColorConverter
    ...
    Private Function UpdateCriteriaCaption(ByRef Report As ReportSti,
    ByVal ReportsProperties As ClsRpw_ReportsProperties, ByVal DtColumns As Data.DataTable) As Boolean
        Dim ObjDataRow As Data.DataRow
    ...
    Private Function UpdateCriteriaValue(ByRef Report As ReportSti,
        ByVal ReportsProperties As ClsRpw_ReportsProperties, ByVal DtColumns As Data.DataTable) As Boolean
        Dim ObjDataRow As Data.DataRow
        Dim IntTotalWidth As Integer = Report.Layout.MarginLeft
        Dim IntForeColor As Integer = 0
    ...
    Private Function CreateFieldsBorders(ByRef Report As ReportSti, ByVal FieldName As String, ByVal ObjDataRow As Data.DataRow) As Boolean
        Dim ObjFiled As FieldSti
        Dim ObjLine As New FieldSti
        Dim ObjDataHandler As New Venus.Shared.DataHandler
        ...
        ObjLine.BorderColor = IIf(ObjDataHandler.DataValue_Out(ObjDataRow("TopBorderStyle"), Data.SqlDbType.Int) - 3 < 0,
        ...
        ObjLine.BorderColor = IIf(ObjDataHandler.DataValue_Out(ObjDataRow("BottomBorderStyle"), Data.SqlDbType.Int) - 3 < 0,
        ...
        ObjLine.BorderColor = IIf(ObjDataHandler.DataValue_Out(ObjDataRow("LeftBorderStyle"), Data.SqlDbType.Int) - 3 < 0,
        ...
        ObjLine.BorderColor = IIf(ObjDataHandler.DataValue_Out(ObjDataRow("RightBorderStyle"), Data.SqlDbType.Int) - 3 < 0,
    ...
    Private Function UpdateFieldsBorders(ByRef Report As ReportSti, ByVal FieldName As String, ByVal ObjDataRow As Data.DataRow) As Boolean
        Dim ObjFiled As FieldSti
        Dim ObjLine As New FieldSti
        Dim ObjDataHandler As New Venus.Shared.DataHandler
        Dim StringHandler As New Venus.Shared.StringHandler
    ...
    Private Function CreateFieldsHeadBorders(ByRef Report As ReportSti, ByVal FieldName As String, ByVal ObjDataRow As Data.DataRow) As Boolean
        Dim ObjFiled As FieldSti
        Dim ObjLine As New FieldSti
        Dim ObjDataHandler As New Venus.Shared.DataHandler
        ...
        ObjLine.BorderColor = IIf(ObjDataHandler.DataValue_Out(ObjDataRow("ColHeaderBorderStyleTop"), Data.SqlDbType.Int) - 3 < 0,
        ...
        ObjLine.BorderColor = IIf(ObjDataHandler.DataValue_Out(ObjDataRow("ColHeaderBorderStyleBottom"), Data.SqlDbType.Int) - 3 < 0,
        ...
        ObjLine.BorderColor = IIf(ObjDataHandler.DataValue_Out(ObjDataRow("ColheaderBorderStyleLeft"), Data.SqlDbType.Int) - 3 < 0,
        ...
        ObjLine.BorderColor = IIf(ObjDataHandler.DataValue_Out(ObjDataRow("ColHeaderBorderStyleRight"), Data.SqlDbType.Int) - 3 < 0,
    ...
    Private Function UpdateFieldsHeadBorders(ByRef Report As ReportSti, ByVal FieldName As String, ByVal ObjDataRow As Data.DataRow) As Boolean
        Dim ObjFiled As FieldSti
        Dim ObjLine As New FieldSti
        Dim ObjDataHandler As New Venus.Shared.DataHandler
        Dim StringHandler As New Venus.Shared.StringHandler
    ...
    Private Function CreateFieldsFooterBorders(ByRef Report As ReportSti, ByVal FieldName As String, ByVal ObjDataRow As Data.DataRow) As Boolean
        Dim ObjFiled As FieldSti
        Dim ObjLine As New FieldSti
        Dim ObjDataHandler As New Venus.Shared.DataHandler
    ...
    Private Function UpdateFieldsFooterBorders(ByRef Report As ReportSti, ByVal FieldName As String, ByVal ObjDataRow As Data.DataRow) As Boolean
        Dim ObjFiled As FieldSti
        Dim ObjLine As New FieldSti
        Dim ObjDataHandler As New Venus.Shared.DataHandler
        Dim StringHandler As New Venus.Shared.StringHandler
    ...
    Private Function CreateBoxHead(ByRef Report As ReportSti) As Boolean
        Dim ObjLine As New FieldSti
        Try
    ...
    Private Function CreateBoxTitle(ByRef Report As ReportSti) As Boolean
        Dim ObjLine As New FieldSti
        Try
    ...
    Private Function CreateBoxObject(ByRef Report As ReportSti) As Boolean
        Dim ObjLine As New FieldSti
        Try
    ...
    Private Function CreateDateTimeFields(ByRef Report As ReportSti,
    ByVal ReportsProperties As ClsRpw_ReportsProperties)
        Dim IntCurrentLeftEnglish As Integer = Report.Layout.MarginLeft + 105
        Dim IntCurrentRightArabic As Integer = Report.Layout.Width - Report.Layout.MarginRight - 2145
        Dim ObjLine As New FieldSti
        Dim ObjField As New FieldSti
        With ObjField
            .Name = "HdrDateCapE"
            .Section = 1
            .Text = "Print Date"
    ...
    Private Function UpdateBoxObject(ByRef Report As ReportSti) As Boolean
        Dim ObjLine As New FieldSti
        Dim StringHandler As New Venus.Shared.StringHandler
    ...
    Private Function GetStringPart(ByVal InputString As String, ByVal Sector As Integer, Optional ByVal Identifier As Char = "/") As String
        ...
        End Try
    End Function
    Private Function SetVisibilityAccordingToDesign(ByRef report As ReportSti) As Boolean
        Dim ObjField As New FieldSti
        Dim StringHandler As New Venus.Shared.StringHandler
        Dim IntLanguage As Integer = mLangauge
        Dim IntCounter As Integer
        ...
        End Try
    End Function
    Private Function SetLanguagePosition(ByRef report As ReportSti, ByVal language As Lang) As Boolean
        Dim ObjField As New FieldSti
        Dim StringHandler As New Venus.Shared.StringHandler
        Dim IntLanguage As Integer = mLangauge
        Dim IntCounter As Integer
        ...
        Try
            For Each ObjRow In DTCriteria.Rows
                ...
                Select Case StrDataType
                    Case "String", "VarChar", "string" ' VarChar 
    ...
    Private Function CreateSentParameters(ByVal DTCriteria As Data.DataTable, ByRef report As ReportSti) As String
        Dim ObjField As New FieldSti
        Dim IntCounter As Integer
        Dim ObjRow As Data.DataRow
        Try
    ...
    Public Sub ClearAllBorders(ByRef Report As ReportSti)
        Dim StringHandler As New Venus.Shared.StringHandler
...
End Class
Public Class ReportHelperSti
    Public Function AssignReport(ByVal Report As ReportSti, ByVal Dr As DataRow) As ReportSti

    End Function

    Public Function AssignLayout(ByVal layout As LayoutSti, ByVal Dr As DataRow) As LayoutSti

    End Function

    Public Function AssignDataSource(ByVal DataSource As DataSourceSti, ByVal Dr As DataRow) As DataSourceSti

    End Function

    Public Function AssignSection(ByVal Section As SectionSti, ByVal Dr As DataRow) As SectionSti

    End Function

    Public Function AssignGroup(ByVal Group As GroupSti, ByVal Dr As DataRow) As GroupSti

    End Function

    Public Function AssignField(ByVal Field As FieldSti, ByVal Dr As DataRow) As FieldSti

    End Function

    Public Function AssignFont(ByVal Font As FontSti, ByVal Dr As DataRow) As FontSti

    End Function

    Public Function AssignPicture(ByVal Picture As PictureSti, ByVal Dr As DataRow) As PictureSti

    End Function
End Class

<Xml.Serialization.XmlRoot(ElementName:="Reports")>
Public Class ReportsSti

    Private mObjReportSti() As ReportSti
    Private mIntNoofReports As Integer = 0

    <Xml.Serialization.XmlElement(ElementName:="Report")>
    <ComponentModel.Category("Reports")>
    Public Property Report() As ReportSti()
        Get
            Return mObjReportSti
        End Get
        Set(ByVal value As ReportSti())
            mObjReportSti = value
        End Set
    End Property

    Public Function GetReportByName(ByVal Name As String) As ReportSti
        Dim ObjReport As New ReportSti
        Try
            For Each ObjReport In mObjReportSti
    ...
    Public Function GetReportByIndex(ByVal Index As Integer) As ReportSti
        Try
            Return mObjReportSti(Index)
        Catch ex As Exception
            Return Nothing
        End Try
    End Function

    Public Function AddReport(ByVal Report As ReportSti) As Integer
        Try
            ReDim Preserve mObjReportSti(mIntNoofReports)
            mObjReportSti(mIntNoofReports) = Report
            mIntNoofReports += 1
...
<Xml.Serialization.XmlRoot(ElementName:="Report")>
Public Class ReportSti
    Private mName As String
    Private mReportInfo As String
    Private mDataSource As New DataSourceSti
    Private mLayout As New LayoutSti
    Private mFont As New FontSti
    Private mGroups As New GroupsSti
    Private mSections As New SectionsSti
    Private mFields As New FieldsSti
    Private mStrTag As String

    <Xml.Serialization.XmlElement(ElementName:="Name")>
    <ComponentModel.Category("Report")>
    ...
    <Xml.Serialization.XmlElement(ElementName:="ReportInfo")>
    <ComponentModel.Category("Report")>
    ...
    <Xml.Serialization.XmlElement(ElementName:="DataSource")>
    <ComponentModel.Category("Report")>
    Public Property DataSource() As DataSourceSti
        Get
            Return mDataSource
        End Get
        Set(ByVal value As DataSourceSti)
            mDataSource = value
        End Set
    End Property

    <Xml.Serialization.XmlElement(ElementName:="Layout")>
    <ComponentModel.Category("Report")>
    Public Property Layout() As LayoutSti
        Get
            Return mLayout
        End Get
        Set(ByVal value As LayoutSti)
            mLayout = value
        End Set
    End Property

    <Xml.Serialization.XmlElement(ElementName:="Font")>
    <ComponentModel.Category("Report")>
    Public Property Font() As FontSti
        Get
            Return mFont
        End Get
        Set(ByVal value As FontSti)
            mFont = value
        End Set
    End Property

    <Xml.Serialization.XmlElement(ElementName:="Groups")>
    <ComponentModel.Category("Report")>
    Public Property Groups() As GroupsSti
        Get
            Return mGroups
        End Get
        Set(ByVal value As GroupsSti)
            mGroups = value
        End Set
    End Property

    <Xml.Serialization.XmlElement(ElementName:="Sections")>
    <ComponentModel.Category("Report")>
    Public Property Sections() As SectionsSti
        Get
            Return mSections
        End Get
        Set(ByVal value As SectionsSti)
            mSections = value
        End Set
    End Property

    <Xml.Serialization.XmlElement(ElementName:="Fields")>
    <ComponentModel.Category("Report")>
    Public Property Fields() As FieldsSti
        Get
            Return mFields
        End Get
        Set(ByVal value As FieldsSti)
            mFields = value
        End Set
    End Property

    <Xml.Serialization.XmlElement(ElementName:="Tag")>
...
<Xml.Serialization.XmlRoot(ElementName:="DataSource")>
Public Class DataSourceSti

    Private mStrConnectionString As String = String.Empty
    Private mStrRecordSource As String = "Report_1"

    <Xml.Serialization.XmlElement(ElementName:="ConnectionString")>
    <ComponentModel.Category("DataSource")>
    ...
    <Xml.Serialization.XmlElement(ElementName:="RecordSource")>
    <ComponentModel.Category("DataSource")>
...
<Xml.Serialization.XmlRoot(ElementName:="Layout")>
Public Class LayoutSti
    ...
    <Xml.Serialization.XmlElement(ElementName:="Width")>
    <ComponentModel.Category("Margin")>
    ...
    <Xml.Serialization.XmlElement(ElementName:="MarginLeft")>
    <ComponentModel.Category("Margin")>
    ...
    <Xml.Serialization.XmlElement(ElementName:="MarginTop")>
    <ComponentModel.Category("Margin")>
    ...
    <Xml.Serialization.XmlElement(ElementName:="MarginRight")>
    <ComponentModel.Category("Margin")>
    ...
    <Xml.Serialization.XmlElement(ElementName:="MarginBottom")>
    <ComponentModel.Category("Margin")>
    ...
    <Xml.Serialization.XmlElement(ElementName:="PaperSize")>
    <ComponentModel.Category("Margin")>
    ...
    <Xml.Serialization.XmlElement(ElementName:="PageHeader")>
    <ComponentModel.Category("Margin")>
    ...
    <Xml.Serialization.XmlElement(ElementName:="PageFooter")>
    <ComponentModel.Category("Margin")>
    ...
    <Xml.Serialization.XmlElement(ElementName:="Columns")>
    <ComponentModel.Category("Margin")>
    ...
    <Xml.Serialization.XmlElement(ElementName:="ColumnLayout")>
    <ComponentModel.Category("Margin")>
    ...
    <Xml.Serialization.XmlElement(ElementName:="Orientation")>
    <ComponentModel.Category("Orientation")>
...
<Xml.Serialization.XmlRoot(ElementName:="Font")>
Public Class FontSti
    ...
    <Xml.Serialization.XmlElement(ElementName:="Size")>
    <ComponentModel.Category("Font")>
    ...
    <Xml.Serialization.XmlElement(ElementName:="Bold")>
    <ComponentModel.Category("Font")>
    ...
    <Xml.Serialization.XmlElement(ElementName:="Italic")>
    <ComponentModel.Category("Font")>
...
<Xml.Serialization.XmlRoot(ElementName:="Groups")>
Public Class GroupsSti

    Private mObjGroupSti() As GroupSti
    Private mIntNoofGroups As Integer = 0

    <Xml.Serialization.XmlElement(ElementName:="Group")>
    <ComponentModel.Category("Groups")>
    Public Property Group() As GroupSti()
        Get
            Return mObjGroupSti
        End Get
        Set(ByVal value As GroupSti())
            mObjGroupSti = value
        End Set
    End Property

    Public Function GetGroupByName(ByVal Name As String) As GroupSti
        Dim ObjGroup As New GroupSti
        Try
            For Each ObjGroup In mObjGroupSti
    ...
    Public Function GetGroupByIndex(ByVal Index As Integer) As GroupSti
        Try
            Return mObjGroupSti(Index)
        Catch ex As Exception
            Return Nothing
        End Try
    End Function

    Public Function AddGroup(ByVal Group As GroupSti) As Integer
        Try
            ReDim Preserve mObjGroupSti(mIntNoofGroups)
            mObjGroupSti(mIntNoofGroups) = Group
            mIntNoofGroups += 1
...
<Xml.Serialization.XmlRoot(ElementName:="Group")>
Public Class GroupSti
    ...
    <Xml.Serialization.XmlElement(ElementName:="GroupBy")>
    <ComponentModel.Category("Group")>
    ...
    <Xml.Serialization.XmlElement(ElementName:="Sort")>
    <ComponentModel.Category("Group")>
    ...
    <Xml.Serialization.XmlElement(ElementName:="KeepTogether")>
    <ComponentModel.Category("Group")>
...
<Xml.Serialization.XmlRoot(ElementName:="Sections")>
Public Class SectionsSti

    Private mObjSectionSti() As SectionSti
    Private mIntNoofSections As Integer = 0

    <Xml.Serialization.XmlElement(ElementName:="Section")>
    <ComponentModel.Category("Sections")>
    Public Property Section() As SectionSti()
        Get
            Return mObjSectionSti
        End Get
        Set(ByVal value As SectionSti())
            mObjSectionSti = value
        End Set
    End Property

    Public Function GetSectionByName(ByVal Name As String) As SectionSti
        Dim ObjSection As New SectionSti
        Try
            For Each ObjSection In mObjSectionSti
    ...
    Public Function GetSectionByIndex(ByVal Index As Integer) As SectionSti
        Try
            Return mObjSectionSti(Index)
        Catch ex As Exception
            Return Nothing
        End Try
    End Function

    Public Function AddSection(ByVal Section As SectionSti) As Integer
        Try
            ReDim Preserve mObjSectionSti(mIntNoofSections)
            mObjSectionSti(mIntNoofSections) = Section
            mIntNoofSections += 1
...
<Xml.Serialization.XmlRoot(ElementName:="Section")>
Public Class SectionSti
    Private mStrName As String = String.Empty
    ...
    <Xml.Serialization.XmlElement(ElementName:="BackColor")>
    ...
    <Xml.Serialization.XmlElement(ElementName:="Name")>
    <ComponentModel.Category("Design")>
    Public Property Name() As String
        Get
            Return mStrName
        End Get
    ...
    <Xml.Serialization.XmlElement(ElementName:="Visible")>
    <ComponentModel.Category("Design")>
    ...
    <ComponentModel.Category("Section")>
    ...
    <Xml.Serialization.XmlElement(ElementName:="Height")>
    <ComponentModel.Category("Section")>
    ...
    <Xml.Serialization.XmlElement(ElementName:="Repeat")>
    <ComponentModel.Category("Section")>
    ...
    <Xml.Serialization.XmlElement(ElementName:="ForcePageBreak")>
    <ComponentModel.Category("Section")>
    ...
    <Xml.Serialization.XmlElement(ElementName:="OnPrint")>
    <ComponentModel.Category("Section")>
    ...
    <Xml.Serialization.XmlElement(ElementName:="OnFormat")>
    <ComponentModel.Category("Section")>
...
<Xml.Serialization.XmlRoot(ElementName:="Fields")>
Public Class FieldsSti

    Private mObjFieldSti() As FieldSti
    Private mIntNoofFields As Integer = 0

    <Xml.Serialization.XmlElement(ElementName:="Field")>
    <ComponentModel.Category("Fields")>
    Public Property Field() As FieldSti()
        Get
            Return mObjFieldSti
        End Get
        Set(ByVal value As FieldSti())
            mObjFieldSti = value
        End Set
    End Property

    Public Function GetFieldByName(ByVal Name As String) As FieldSti
        Dim ObjField As New FieldSti
        Try
            For Each ObjField In mObjFieldSti
                If Not ObjField Is Nothing Then
    ...
    Public Function GetFieldByName_Language(ByVal Name As String, ByVal language As Integer) As FieldSti
        Dim ObjField As New FieldSti
        Dim StringHandler As New Venus.Shared.StringHandler
        Try
            For Each ObjField In mObjFieldSti
    ...
    Public Function GetFieldByIndex(ByVal Index As Integer) As FieldSti
        Try
            Return mObjFieldSti(Index)
        Catch ex As Exception
            Return Nothing
        End Try
    End Function

    Public Function AddField(ByVal Field As FieldSti) As Integer
        Try
            mIntNoofFields = Count()
            ReDim Preserve mObjFieldSti(mIntNoofFields)
            mObjFieldSti(mIntNoofFields) = Field
            mIntNoofFields += 1
    ...
    Public Function Count() As Integer
        Try
            If mObjFieldSti Is Nothing Then
                Return 0
            Else
                Return mObjFieldSti.Length
            End If
            Return mObjFieldSti.Length
        Catch ex As Exception
            Return 0
...
<Xml.Serialization.XmlRoot(ElementName:="Field")>
Public Class FieldSti
    Private mStrName As String = String.Empty
    ...
    Private mObjFont As New FontSti
    ...
    Private mObjPicture As New PictureSti

    <Xml.Serialization.XmlElement(ElementName:="Name")>
    <ComponentModel.Category("Field")>
    Public Property Name() As String
        Get
            Return mStrName
        End Get
    ...
    <Xml.Serialization.XmlElement(ElementName:="Text")>
    <ComponentModel.Category("Field")>
    ...
    <Xml.Serialization.XmlElement(ElementName:="Calculated")>
    <ComponentModel.Category("Field")>
    ...
    <Xml.Serialization.XmlElement(ElementName:="Top")>
    <ComponentModel.Category("Field")>
    ...
    <Xml.Serialization.XmlElement(ElementName:="Left")>
    <ComponentModel.Category("Field")>
    ...
    <Xml.Serialization.XmlElement(ElementName:="BorderStyle")>
    <ComponentModel.Category("Field")>
    ...
    <Xml.Serialization.XmlElement(ElementName:="LineSlant")>
    <ComponentModel.Category("Field")>
    ...
    <Xml.Serialization.XmlElement(ElementName:="BorderColor")>
    <ComponentModel.Category("Field")>
    ...
    <Xml.Serialization.XmlElement(ElementName:="LineWidth")>
    <ComponentModel.Category("Field")>
    ...
    <Xml.Serialization.XmlElement(ElementName:="Align")>
    <ComponentModel.Category("Field")>
    ...
    <Xml.Serialization.XmlElement(ElementName:="ForeColor")>
    <ComponentModel.Category("Field")>
    ...
    <Xml.Serialization.XmlElement(ElementName:="BackStyle")>
    <ComponentModel.Category("Field")>
    ...
    <Xml.Serialization.XmlElement(ElementName:="CanGrow")>
    <ComponentModel.Category("Field")>
    ...
    <Xml.Serialization.XmlElement(ElementName:="WordWrap")>
    <ComponentModel.Category("Field")>
    ...
    <Xml.Serialization.XmlElement(ElementName:="Format")>
    <ComponentModel.Category("Field")>
    ...
    <Xml.Serialization.XmlElement(ElementName:="ZOrder")>
    <ComponentModel.Category("Field")>
    ...
    '      End Set
    '  End Property
    <Xml.Serialization.XmlElement(ElementName:="Picture")>
    <ComponentModel.Category("Field")>
    ...
    <Xml.Serialization.XmlElement(ElementName:="PictureAlign")>
    <ComponentModel.Category("Field")>
    ...
    <Xml.Serialization.XmlElement(ElementName:="PictureScale")>
    <ComponentModel.Category("Field")>
...
<Xml.Serialization.XmlRoot(ElementName:="Picture")>
Public Class PictureSti
    Private mStmPicture As Drawing.Bitmap
    Private mStrEncoding As String = "base64"

    <Xml.Serialization.XmlAttribute(AttributeName:="encoding")>
    Public Property engcoding() As String
        Get
            Return mStrEncoding
        End Get
