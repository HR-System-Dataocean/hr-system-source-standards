...
'Developer         : [0257]
'Description       : 1-Implement Data Acess Layer of sys_FiscalYearsPeriodsModules table with fields FiscalYearPeriodID,ModuleID,
...
'                       records
'==========================================================================================================
Public Class Clssys_FiscalYearsPeriodsModules
...
#Region "Class Constructors"
    ...
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " sys_FiscalYearsPeriodsModules "
        mInsertParameter = " FiscalYearPeriodID,ModuleID,OpenDate,CloseDate,Remarks,RegUserID,RegComputerID"
        mInsertParameterValues = " @FiscalYearPeriodID,@ModuleID,@OpenDate,@CloseDate,@Remarks,@RegUserID,@RegComputerID "
        mUpdateParameter = " FiscalYearPeriodID=@FiscalYearPeriodID,ModuleID=@ModuleID,OpenDate=@OpenDate,CloseDate=@CloseDate,Remarks=@Remarks,RegUserID=@RegUserID,RegComputerID=@RegComputerID"
        'mSelectCommand = " Select * From  " & mTable
        mSelectCommand = " Select sys_FiscalYearsPeriodsModules.ID,sys_FiscalYearsPeriodsModules.FiscalYearPeriodID,sys_FiscalYearsPeriodsModules.ModuleID,sys_FiscalYearsPeriodsModules.OpenDate,sys_FiscalYearsPeriodsModules.CloseDate,sys_FiscalYearsPeriodsModules.Remarks,sys_FiscalYearsPeriodsModules.RegUserID,sys_FiscalYearsPeriodsModules.RegDate,sys_FiscalYearsPeriodsModules.RegComputerID,sys_FiscalYearsPeriodsModules.CancelDate From  " & mTable & "INNER JOIN sys_FiscalYearsPeriods ON sys_FiscalYearsPeriodsModules.FiscalYearPeriodID=sys_FiscalYearsPeriods.ID INNER JOIN sys_Modules ON sys_FiscalYearsPeriodsModules.ModuleID= sys_Modules.ID"
...
#Region "Private Members"
    ...
    Private mOpenDate As Object
    Private mCloseDate As Object
...
#Region "Public property"
    ...
    Public Property ModuleID() As Integer
        ...
        End Set
    End Property
    Public Property OpenDate() As Object
        Get
            Return mOpenDate
        End Get
        Set(ByVal Value As Object)
        ...
        End Set
    End Property
    Public Property CloseDate() As Object
        Get
            Return mCloseDate
        End Get
        Set(ByVal Value As Object)
...
#Region "Public Function"
    ...
    'Calls          :
    'From           :
    '               :(frmFiscalYearsPeriodsModules.aspx.vb)SavePart()
    '               :(frmFiscalYearsPeriodsModules.aspx.vb)InitializeDG()
    'To             :GetParameter()
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
    ...
    Public Function Find(ByVal Filter As String) As Boolean
        ...
        Try
            StrSelectCommand = mSelectCommand & IIf(Len(Filter) > 0, " Where IsNull(sys_FiscalYearsPeriodsModules.CancelDate,'')='' And IsNull(dbo.hrs_GetRecordViewStatus(sys_FiscalYearsPeriodsModules.ID,'" & Me.mTable & "'," & Me.mDataBaseUserRelatedID & "," & Me.GroupID & "),0) <> 1 And " & Filter, "  Where IsNull(sys_FiscalYearsPeriodsModules.CancelDate,'')='' And IsNull(dbo.hrs_GetRecordViewStatus(sys_FiscalYearsPeriodsModules.ID,'" & Me.mTable & "'," & Me.mDataBaseUserRelatedID & "," & Me.GroupID & "),0) <> 1 ")
    ...
    Public Function SaveUpdate(ByVal Filter As String) As Boolean
        ...
        Try
            strSQL = "Select ID From sys_FiscalYearsPeriodsModules Where " & Filter
    ...
    'Modifacations  : 
    'Calls          :
    'From           :(frmFiscalYearsPeriodsModules.aspx.vb)SavePart()
    'To             :SetParameter()
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mOpenDate = mDataHandler.DataValue_Out(.Item("OpenDate"), SqlDbType.DateTime)
                mCloseDate = mDataHandler.DataValue_Out(.Item("CloseDate"), SqlDbType.DateTime)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@OpenDate", SqlDbType.DateTime)).Value = mDataHandler.DataValue_In(mOpenDate, SqlDbType.DateTime)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@CloseDate", SqlDbType.DateTime)).Value = mDataHandler.DataValue_In(mCloseDate, SqlDbType.DateTime)
