...
'Date : 21/10/2024
'                   Class: SendEmailSettingFixedEmails
'                   Table: sys_SendEmailSettingFixedEmails
'                   Relations:
'                               sys_SendEmailSettingFixedEmails.SendEmailSettingId ->> sys_SendEmailSetting.ID
...
Public Class Clssys_SendEmailSettingFixedEmails
    Inherits ClsDataAcessLayer

#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " sys_SendEmailSettingFixedEmails "
        mInsertParameter = " SendEmailSettingId,FixedEmail,RegUserID,RegComputerID "
        mInsertParameterValues = " @SendEmailSettingId,@FixedEmail,@RegUserID,@RegComputerID "
        mUpdateParameter = " SendEmailSettingId=@SendEmailSettingId,FixedEmail=@FixedEmail "
...
#Region "Private Members"
    ...
    Private mSendEmailSettingId As Object
    Private mFixedEmail As String
...
#Region "Public property"
    ...
    Public Property EndOfServiceTypeId() As Object
        Get
            Return mSendEmailSettingId
        End Get
        Set(ByVal Value As Object)
            mSendEmailSettingId = Value
        End Set
    End Property

    Public Property FixedEmail() As String
        Get
            Return mFixedEmail
        End Get
...
#Region "Public Function"
    ...
    Public Function SaveUpdate(ByVal Filter As String) As Boolean
        ...
        Try
            strSQL = "Select ID From sys_SendEmailSettingFixedEmails Where " & Filter
    ...
    Public Function Clear() As Boolean
        Try
            mId = 0
            mSendEmailSettingId = 0

            mFixedEmail = String.Empty
            mRegUserID = 0
            mRegComputerID = 0
            mRegDate = Nothing
            mCancelDate = Nothing
    ...
    Public Function GetEndOfServicesRules(ByVal SendEmailSettingId As Integer, ByRef ObjDs As DataSet) As Boolean
        Dim StrSelectCommand As String = String.Empty
        Try
            ObjDs = Microsoft.ApplicationBlocks.Data.SqlHelper.ExecuteDataset(ConnectionString, "hrs_GetEnfOfServiceRules", SendEmailSettingId)
...
#Region "Class Private Function"
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mSendEmailSettingId = mDataHandler.DataValue_Out(.Item("SendEmailSettingId"), SqlDbType.Int, True)

                mFixedEmail = mDataHandler.DataValue_Out(.Item("FixedEmail"), SqlDbType.VarChar)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand) As Boolean
        Try
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@EndOfServiceTypeId", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mSendEmailSettingId, SqlDbType.Int, True)

            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@FixedEmail", SqlDbType.VarChar)).Value = mDataHandler.DataValue_In(mFixedEmail, SqlDbType.VarChar)
