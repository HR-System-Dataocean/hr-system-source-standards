Public Class Clssys_CountriesBase
    Inherits ClsDataAcessLayer
    '==================================================================
'Created by : [0258]
    'Date : 10/07/2007

    'Description: This Class for Regions form 
    'Have Relation : Yes
    'Class Relation : Regions 
    'Relation Type : One to many
    'Decript Relation : One Country can placed with more than Regions
...
#Region "Class Constructors"
    ...
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " sys_Countries "
        mInsertParameter = " Code,EngName,ArbName,ArbName4S,CurrencyID,NationalityID,PhoneKey,IsMainCountries,Remarks,RegUserID,RegComputerID "
        mInsertParameterValues = " @Code,@EngName,@ArbName,@ArbName4S,@CurrencyID,@NationalityID,@PhoneKey,@IsMainCountries,@Remarks,@RegUserID,@RegComputerID "
        mUpdateParameter = " Code=@Code,EngName=@EngName,ArbName=@ArbName,ArbName4S=@ArbName4S,CurrencyID=@CurrencyID,NationalityID=@NationalityID,PhoneKey=@PhoneKey,IsMainCountries=@IsMainCountries,Remarks=@Remarks "
...
#Region "Private Members"
    ...
    Private mIsMainCountries As Boolean
...
#Region "Public property"
    ...
    Public Property PhoneKey() As String
        ...
        End Set
    End Property
    Public Property IsMainCountries() As Boolean
        Get
            Return mIsMainCountries
        End Get
        Set(ByVal Value As Boolean)
            mIsMainCountries = Value
        End Set
    End Property
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mIsMainCountries = mDataHandler.DataValue_Out(.Item("IsMainCountries"), SqlDbType.Bit)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal ptrOperationType As OperationType) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@IsMainCountries", SqlDbType.Bit)).Value = mDataHandler.DataValue_In(mIsMainCountries, SqlDbType.Bit)
...
Public Class Clssys_Countries
    Inherits Clssys_CountriesBase
