...
'                   Table: Dwf_DocumentTypesGroup
'                   Relations:
'=========================================================================
Imports System.Web.UI.WebControls

Public Class Clssys_DocumentTypesGroup
...
#Region "Class Constructors"
    ...
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " sys_DocumentTypesGroup "
        mInsertParameter = " Code,EngName,ArbName,Remarks,RegUserID "
        mInsertParameterValues = " @Code,@EngName,@ArbName,@Remarks,@RegUserID "
        mUpdateParameter = " Code=@Code,EngName=@EngName,ArbName=@ArbName,Remarks=@Remarks "
...
#Region "Class Private Function"
    ...
    Public Function GetDropDownList(ByVal DdlValues As Global.System.Web.UI.WebControls.DropDownList, ByVal NullNode As Boolean, Optional ByVal Filter As String = "") As Boolean
        ...
        Try
            ...
            StrSelectCommand = mSelectCommand & IIf(Len(Filter) > 0, " Where  IsNull(dbo.hrs_GetRecordViewStatus(ID,'" & Me.mTable & "'," & Me.mDataBaseUserRelatedID & "," & Me.GroupID & "),0) <> 1 And " & Filter & " Order By Code ", "  Where  IsNull(dbo.hrs_GetRecordViewStatus(ID,'" & Me.mTable & "'," & Me.mDataBaseUserRelatedID & "," & Me.GroupID & "),0) <> 1 " & " Order By CONVERT(nvarchar, Code ) ")
