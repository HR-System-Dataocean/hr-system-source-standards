Imports Venus
Public Class Clshrs_GeneralSetting
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " hrs_GeneralSetting "
        mInsertParameter = "" &
                "Code," &
                "EngName," &
                "ArbName," &
        ...
        mUpdateParameter = "" &
                ...
                "ArbName4S=@ArbName4S," &
                "IsHigry=@IsHigry," &
                "AttendPrepareDay=@AttendPrepareDay," &
...
#Region "Private Members"
    ...
    Private mAttendPrepareDay As Integer
...
#Region "Public property"
    ...
    Public Property IsHigry() As Boolean
        ...
        End Set
    End Property
    Public Property AttendPrepareDay() As Integer
        Get
            Return mAttendPrepareDay
        End Get
        Set(ByVal Value As Integer)
            mAttendPrepareDay = Value
        End Set
    End Property
...
#Region "Public Function"
    ...
    'Developer      :  DataOcean   
    'Date Created   :17/02/2016 1:02:17 PM
    'Modifacations  :
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mIsHigry = [Shared].DataHandler.DataValue_Out(.Item("IsHigry"), SqlDbType.Bit)
                mAttendPrepareDay = [Shared].DataHandler.DataValue_Out(.Item("AttendPrepareDay"), SqlDbType.Int, True)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@IsHigry", SqlDbType.Bit)).Value = [Shared].DataHandler.DataValue_In(mIsHigry, SqlDbType.Bit)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@AttendPrepareDay", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mAttendPrepareDay, SqlDbType.Int)
