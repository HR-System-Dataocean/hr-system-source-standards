...
'                   Table: sys_Locations
'                   Relations:
'                               sys_Locations.BranchID ->> sys_Branches.ID
'                               sys_Locations.CityId ->> sys_Cities.ID
'=========================================================================

Public Class Clssys_Locations
...
#Region "Class Constructors"
    ...
    Public Sub New(ByVal Page As Web.UI.Page)
        ...
        MyBase.New(Page)
        mTable = " sys_Locations "
        mInsertParameter = " Code,EngName,ArbName,ArbName4S,CityID,BranchID,Remarks,RegUserID,RegComputerID,CompanyID,DepartmentID,CostCenterCode1,CostCenterCode2,CostCenterCode3,CostCenterCode4 "
        mInsertParameterValues = " @Code,@EngName,@ArbName,@ArbName4S,@CityID,@BranchID,@Remarks,@RegUserID,@RegComputerID," & MainCompanyID & ",@DepartmentID,@CostCenterCode1,@CostCenterCode2,@CostCenterCode3,@CostCenterCode4 "
        mUpdateParameter = " Code=@Code,EngName=@EngName,ArbName=@ArbName,ArbName4S=@ArbName4S,CityID=@CityID,BranchID=@BranchID,Remarks=@Remarks,DepartmentID=@DepartmentID,CostCenterCode1=@CostCenterCode1,CostCenterCode2=@CostCenterCode2,CostCenterCode3=@CostCenterCode3,CostCenterCode4=@CostCenterCode4"
...
#Region "Public property"
    ...
    Public Property CityID() As Object
        Get
            Return mCityID
        End Get
        Set(ByVal value As Object)
...
#Region "Public Function"
    ...
    '
    'Description: Find all columns from Clssys_Locations table where filter and canceldate = null 
    '=====================================================================
    ...
    'Steps: 
    '       1-Execute sql statment to get ID from Clssys_Locations where filter 
    '       2-Check if ID > 0 this mean that row is already exist in Clssys_Locations  table 
    '       the make Update to this row
    '           IF ID =0 this mean that row is new row Then Insert the row in Clssys_Locations  table
    '=====================================================================
    ...
    Public Function SaveUpdate(ByVal Filter As String) As Boolean
        ...
        Try
            strSQL = "Select ID From sys_Locations Where " & Filter
    ...
    'Description: Save New Row in Clssys_Locations  table
    'Steps: 
    '       1-execute sqlstatment to insert new row in Clssys_Locations  table
    ...
    'Description: Update existing Row in Clssys_Locations  table where filter
    'Steps: 
    '       1-execute sqlstatment to Update existing row in Clssys_Locations  table
    ...
    'Date : 10/07/2007
    'Inptu : Filter as string (ex.ID=2)
    'Description: Delete existing Row in Clssys_Locations  table where filter
    'Steps: 
    '       1-execute sqlstatment to Delete existing row in Clssys_Locations  table
    ...
    'Steps: 
    '       1-execute sqlstatment to find first row in Clssys_Locations  table
    ...
    'Created by : DataOcean
    'Date : 10/07/2007
    'Description:  find Last row in Clssys_Locations  table
    'Steps: 
    '       1-execute sqlstatment to find last row in Clssys_Locations  table
    '       2-Fill dataset with result of sqlstatment
    '       3-call Getparameter function to insert the result of dataset into private members of the class
    '=====================================================================
    ...
    'Created by : DataOcean
    'Date : 10/07/2007
    'Description:  find Next row in Clssys_Locations  table
    'Steps: 
    '       1-execute sqlstatment to find Next row in Clssys_Locations  table
    '       2-Fill dataset with result of sqlstatment
    '       3-call Getparameter function to insert the result of dataset into private members of the class
    '=====================================================================
    ...
    'Date : 10/07/2007
    'Steps: 
    '               - Execute proc sqlstatment to find previous row in Clssys_Locations  table
    ...
    'Description:   Find previous row in Clssys_Locations  table
    '=====================================================================
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mCityID = mDataHandler.DataValue_Out(.Item("CityID"), SqlDbType.Int, True)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal OperationType As OperationType) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@CityID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mCityID, SqlDbType.Int, True)
