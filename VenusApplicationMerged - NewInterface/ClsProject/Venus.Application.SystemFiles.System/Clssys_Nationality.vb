Public Class Clssys_Nationality
...
#Region "Private Members"
    ...
    Private mIsMainNationality As Boolean
    Private mTravelRoute As Integer
    Private mTravelClass As Integer
    ...
    Private mTicketAmount As Double
...
#Region "Public property"
    ...
    Public Property ArbName4S() As String
        ...
        End Set
    End Property
    Public Property IsMainNationality() As Boolean
        Get
            Return mIsMainNationality
        End Get
        Set(ByVal Value As Boolean)
            mIsMainNationality = Value
        End Set
    End Property
    Public Property TravelRoute() As Integer
        Get
            Return mTravelRoute
        End Get
        Set(ByVal Value As Integer)
        ...
        End Set
    End Property
    Public Property TravelClass() As Integer
        Get
            Return mTravelClass
        End Get
        Set(ByVal Value As Integer)
    ...
    Public Property TicketAmount() As Integer
        Get
            Return mTicketAmount
        End Get
        Set(ByVal Value As Integer)
            mTicketAmount = Value
        End Set
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mIsMainNationality = [Shared].DataHandler.DataValue_Out(.Item("IsMainNationality"), SqlDbType.Bit)
                mTravelRoute = [Shared].DataHandler.DataValue_Out(.Item("TravelRoute"), SqlDbType.Int, True)
                mTravelClass = [Shared].DataHandler.DataValue_Out(.Item("TravelClass"), SqlDbType.Int, True)
                ...
                mTicketAmount = [Shared].DataHandler.DataValue_Out(.Item("TicketAmount"), SqlDbType.Float)
            End With
            Return True
        Catch ex As Exception
            mPage.Session.Add("ErrorValue", ex)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal ptrOperationType As OperationType) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@IsMainNationality", SqlDbType.Bit)).Value = [Shared].DataHandler.DataValue_In(mIsMainNationality, SqlDbType.Bit)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@TravelRoute", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mTravelRoute, SqlDbType.Int, True)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@TravelClass", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mTravelClass, SqlDbType.Int, True)
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@TicketAmount", SqlDbType.Float)).Value = [Shared].DataHandler.DataValue_In(mTicketAmount, SqlDbType.Float)
