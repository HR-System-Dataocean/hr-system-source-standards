...
#Region "Class Constructors"
    ...
    Public Sub New(ByVal Page As Web.UI.Page)
        ...
        MyBase.New(Page)
        Me.Table = "sys_Announces"
        Me.mInsertParameter = " Code,EngName,ArbName,ArbName4S,IsActive,Remarks,RegUserID,RegComputerID "
        Me.mInsertParameterValues = " @Code,@EngName,@ArbName,@ArbName4S,@IsActive,@Remarks,@RegUserID,@RegComputerID "
        Me.mUpdateParameter = " Code=@Code,EngName=@EngName,ArbName=@ArbName,ArbName4S=@ArbName4S,IsActive=@IsActive,Remarks=@Remarks "
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mIsActive = mDataHandler.DataValue_Out(.Item("IsActive"), SqlDbType.Bit)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal ptrOperationType As OperationType) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@IsActive", SqlDbType.Bit)).Value = mDataHandler.DataValue_In(Me.mIsActive, SqlDbType.Bit)
