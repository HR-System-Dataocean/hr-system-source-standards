Public Class Clssys_ReportsParameters
...
#Region "Class Constructors"
    ...
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " sys_ReportsParameters "
        mInsertParameter = " ReportID,FieldName,FieldTypeID,EngDescription,ArbDescription,DefaultEngText,DefaultArbText,SectionID,TextLength,SearchID "
        mInsertParameterValues = " @ReportID,@FieldName,@FieldTypeID,@EngDescription,@ArbDescription,@DefaultEngText,@DefaultArbText,@SectionID,@TextLength,@SearchID "
        mUpdateParameter = " ReportID=@ReportID,FieldName=@FieldName,FieldTypeID=@FieldTypeID,EngDescription=@EngDescription,ArbDescription=@ArbDescription,DefaultEngText=@DefaultEngText,DefaultArbText=@DefaultArbText,SectionID=@SectionID,TextLength=@TextLength,SearchID=@SearchID "
...
#Region "Private Members"
    ...
    Private mFieldTypeID As Object
    Private mEngDescription As String
    Private mArbDescription As String
    Private mDefaultEngText As String
    Private mDefaultArbText As String
    Private mSectionID As Object
    Private mTextLength As Integer
...
#Region "Public property"
    ...
    Public Property FieldTypeID() As Object
        Get
            Return mFieldTypeID
        End Get
        Set(ByVal value As Object)
    ...
    Public Property ArbDescription() As String
        ...
        End Set
    End Property
    Public Property DefaultEngText() As String
        Get
            Return mDefaultEngText
        End Get
        Set(ByVal value As String)
            mDefaultEngText = value
        End Set
    End Property
    Public Property DefaultArbText() As String
        Get
            Return mDefaultArbText
        End Get
        Set(ByVal value As String)
            mDefaultArbText = value
        End Set
    End Property
...
#Region "Public Function"
    ...
    Public Function Clear() As Boolean
        Try
            ...
            mDefaultEngText = String.Empty
            mDefaultArbText = String.Empty
            mSectionID = 0
            mTextLength = 0
            mSearchID = 0
    ...
    Public Function FillDefualts(ByRef PtrDdl As Global.System.Web.UI.WebControls.DropDownList, ByVal defualts As String)
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mFieldTypeID = mDataHandler.DataValue_Out(.Item("FieldTypeID"), SqlDbType.Int)
                ...
                mDefaultEngText = mDataHandler.DataValue_Out(.Item("DefaultEngText"), SqlDbType.VarChar)
                mDefaultArbText = mDataHandler.DataValue_Out(.Item("DefaultArbText"), SqlDbType.VarChar)
                mSectionID = mDataHandler.DataValue_Out(.Item("SectionID"), SqlDbType.Int)
                mTextLength = mDataHandler.DataValue_Out(.Item("TextLength"), SqlDbType.Int)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal operationtype As OperationType) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@FieldTypeID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mFieldTypeID, SqlDbType.Int)
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@DefaultEngText", SqlDbType.VarChar)).Value = mDataHandler.DataValue_In(mDefaultEngText, SqlDbType.VarChar)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@DefaultArbText", SqlDbType.VarChar)).Value = mDataHandler.DataValue_In(mDefaultArbText, SqlDbType.VarChar)

            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@SectionID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mSectionID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@TextLength", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mTextLength, SqlDbType.Int)
