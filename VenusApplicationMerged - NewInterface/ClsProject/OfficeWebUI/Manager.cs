...
namespace OfficeWebUI
{
    ...
    public class Manager_Designer : CompositeControlDesigner
    {
        public override string GetDesignTimeHtml()
        {
            ...
            return "<div style='background:#B0B8C0; display:inline-block; padding:5px; border:1px solid #777; font-family:tahoma; font-size:8pt; color:#fff;'><b>OfficeWebUI:Manager</b> [" + lControl.UITheme + "]</div>";
        }
