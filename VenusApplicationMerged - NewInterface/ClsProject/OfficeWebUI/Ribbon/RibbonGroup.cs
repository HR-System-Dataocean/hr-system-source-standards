...
namespace OfficeWebUI.Ribbon
{
    ...
    public class RibbonGroup : ControlAncestor, INamingContainer
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            if (_appMenuDirection == DocumentDirection.LTR) _GroupCollapsedContainer.CssClass = "RibbonGroupCollapsedContainer";
            else _GroupCollapsedContainer.CssClass = "RibbonGroupCollapsedContainerRtl";
            ...
            if (_appMenuDirection == DocumentDirection.LTR) lTableCollapse.Attributes["dir"] = "ltr";
            else lTableCollapse.Attributes["dir"] = "rtl";
            ...
            if (_appMenuDirection == DocumentDirection.LTR) _GroupContent.CssClass = "RibbonGroupContent";
            else _GroupContent.CssClass = "RibbonGroupContentRtl";
            ...
            if (this._showExpander)
            {
                ...
                if (_appMenuDirection == DocumentDirection.LTR) lExpandPanel.CssClass = "GroupExpandPanel";
                else lExpandPanel.CssClass = "GroupExpandPanelRtl";
