...
namespace OfficeWebUI.Button
{
    internal class Button_Designer : CompositeControlDesigner
    {
        public override string GetDesignTimeHtml()
        {
            ...
            return "<div style='width:80px; height:90px; display:inline-block; padding:5px; border:1px solid #777; font-family:tahoma; font-size:8pt; color:#444;'><b>Button</b><br>" + lControl.Text + "</div>";
        }
