...
namespace OfficeWebUI
{
    ...
    public class OfficeMessageBox : ControlAncestor, INamingContainer
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            if (Manager.DirectionMode == DocumentDirection.RTL) _closeLabel.CssClass = "PopupTitleSpanRTL";
            else _closeLabel.CssClass = "PopupTitleSpan";
            _closeLabel.Text = Text;
            _panelTitle.Controls.Add(_closeLabel);

            _panelClose = new Panel();
            if (Manager.DirectionMode == DocumentDirection.RTL) _panelClose.CssClass = "OfficeWebUI_PopupClosePanelRTL";
            else _panelClose.CssClass = "OfficeWebUI_PopupClosePanel";
            ...
            if (Manager.DirectionMode == DocumentDirection.RTL) _panelFooter.CssClass = "OfficeWebUI_PopupFooterPanelRTL";
            else _panelFooter.CssClass = "OfficeWebUI_PopupFooterPanel";
        ...
        public void Show(MessageBoxType Type, string Message, string Title)
        {
            Manager Manager = (Manager)HttpContext.Current.Items["OfficeWebUI_ManagerObj"];
            Table lTable = new Table();
            if (Manager.DirectionMode == DocumentDirection.RTL) lTable.Attributes["dir"] = "rtl";
            else lTable.Attributes["dir"] = "ltr";
