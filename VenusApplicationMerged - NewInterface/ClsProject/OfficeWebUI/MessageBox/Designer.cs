...
namespace OfficeWebUI.MessageBox
{
    internal class MessageBox_Designer : CompositeControlDesigner
    {
        public override string GetDesignTimeHtml()
        {
            ...
            return "<div style='width:250px; height:100px; display:inline-block; padding:5px; border:1px solid #777; font-family:tahoma; font-size:8pt; color:#444;'><b>MessageBox</b><br>" + lControl.Text + "<br/>" + lStringButtons + "</div>";
        }
