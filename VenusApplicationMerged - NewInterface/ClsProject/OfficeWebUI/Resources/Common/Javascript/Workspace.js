...
OfficeWebUI.Workspace = {
    ...
    LPanelHide: function () {
        $(".OfficeWebUI_WorkspaceLeftPanel").css("width", 0);
        $(".OfficeWebUI_WorkspaceAreaContainer").css("width", 0);
        $(".OfficeWebUI_WorkspaceNavContainer").css("width", 0);
    },
    LPanelShow: function () {
        $(".OfficeWebUI_WorkspaceLeftPanel").css("width", 250);
        $(".OfficeWebUI_WorkspaceAreaContainer").css("width", 250);
        $(".OfficeWebUI_WorkspaceNavContainer").css("width", 250);
    },
