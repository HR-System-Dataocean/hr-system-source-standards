...
namespace OfficeWebUI.Popup
{
    internal class OfficePopup_Designer : CompositeControlDesigner
    {
        ...
        public override string GetDesignTimeHtml(DesignerRegionCollection regions)
        {
            ...
            //return "<div style='height:200px; padding:5px; border:1px solid #C0C0C0; font-family:tahoma; font-size:8pt;'><b>OfficeWebUI:Workspace</b> [" + _Control.ID + "]</div>";
        }
        ...
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("<div style='height:" + _Control.Height + "; width:" + _Control.Width + "; border:1px solid #C0C0C0; font-family:tahoma; font-size:8pt;'>");
