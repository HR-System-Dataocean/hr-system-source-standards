...
Public Class Clshrs_ProjectLocationShifts
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " hrs_ProjectLocationShifts "
        mInsertParameter = "" & _
          "LocationDetailID," & _
...
#Region "Class Private Function"
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@LocationDetailID", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mLocationDetailID, SqlDbType.Int)
