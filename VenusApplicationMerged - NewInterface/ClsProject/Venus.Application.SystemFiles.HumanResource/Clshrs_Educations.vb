...
Public Class Clshrs_Educations
...
#Region "Class Constructors"
    ...
    Public Sub New(ByVal Page As Web.UI.Page, ByVal TableName As String)
        ...
        With Me
            .Table = TableName
            .mInsertParameter = " Code,EngName,ArbName,ArbName4S,RequiredYears,Level,Remarks,RegUserID,RegComputerID,CompanyID "
            .mInsertParameterValues = " @Code,@EngName,@ArbName,@ArbName4S,@RequiredYears,@Level,@Remarks,@RegUserID,@RegComputerID,@CompanyID "
            .mUpdateParameter = " Code=@Code,EngName=@EngName,ArbName=@ArbName,ArbName4S=@ArbName4S,RequiredYears=@RequiredYears,Level=@Level,Remarks=@Remarks "
...
#Region "Private Members"
    ...
    Private mRequiredYears As Double
...
#Region "Public property"
    ...
    Public Property RequiredYears() As Double
        Get
...
#Region "Public Function"
    ...
    'Project        :  Venus V.
    'Description    :  Fill DropDownList with English name column from hrs_EductionTypes table
    ...
    'Description: Find all columns from hrs_Educationss table where filter and canceldate = null  
    'Steps: 
    ...
    'Steps: 
    '       1-Execute sql statment to get ID from hrs_Educationss where filter 
    '       2-Check if ID > 0 this mean that row is already exist in hrs_Educationss  table 
    '       the make Update to this row
    '           IF ID =0 this mean that row is new row Then Insert the row in hrs_Educationss  table
    '==================================================================
    ...
    'Description: Save New Row in hrs_Educationss  table
    'Steps: 
    '       1-execute sqlstatment to insert new row in hrs_Educationss  table
    ...
    'Description: Update existing Row in hrs_Educationss  table where filter
    'Steps: 
    '       1-execute sqlstatment to Update existing row in hrs_Educationss  table
    ...
    'Date : 24/6/2007
    'Inptu : Filter as string (ex.ID=2)
    'Description: Delete existing Row in hrs_Educationss  table where filter
    'Steps: 
    '       1-execute sqlstatment to Delete existing row in hrs_Educationss  table
    ...
    'Steps: 
    '       1-execute sqlstatment to find first row in hrs_Educationss  table
    ...
    'Created by : [0258]
    'Date : 24/6/2007
    'Description:  find Last row in hrs_Educationss  table
    'Steps: 
    '       1-execute sqlstatment to find last row in hrs_Educationss  table
    '       2-Fill dataset with result of sqlstatment
    '       3-call Getparameter function to insert the result of dataset into private members of the class
    '==================================================================
    ...
    'Created by : [0258]
    'Date : 24/6/2007
    'Description:  find Next row in hrs_Educationss  table
    'Steps: 
    '       1-execute sqlstatment to find Next row in hrs_Educationss  table
    '       2-Fill dataset with result of sqlstatment
    '       3-call Getparameter function to insert the result of dataset into private members of the class
    '==================================================================
    ...
    'Created by : [0258]
    'Date : 24/6/2007
    'Description:  find previous row in hrs_Educationss  table
    'Steps: 
    '       1-execute sqlstatment to find previous row in hrs_Educationss  table
    '       2-Fill dataset with result of sqlstatment
    '       3-call Getparameter function to insert the result of dataset into private members of the class
    '==================================================================
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mRequiredYears = mDataHandler.DataValue_Out(.Item("RequiredYears"), SqlDbType.Real)
