...
Public Class ClsDwf_DocumentStagePeoples
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " Dwf_DocumentStagePeoples "
        mInsertParameter = "" & _
          "DocumentID," & _
          "StageCode," & _
          "PeopleType," & _
...
#Region "Private Members"
    ...
    Private mPeopleType As Integer
...
#Region "Public property"
    ...
    Public Property StageCode() As String
        ...
        End Set
    End Property
    Public Property PeopleType() As Integer
        Get
            Return mPeopleType
        End Get
        Set(ByVal Value As Integer)
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mPeopleType = [Shared].DataHandler.DataValue_Out(.Item("PeopleType"), SqlDbType.Int, True)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@PeopleType", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mPeopleType, SqlDbType.Int)
