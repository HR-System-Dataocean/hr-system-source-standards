...
#Region "Class Constructors"
    ...
    Public Sub New(ByVal Page As Web.UI.Page)
        ...
        MyBase.New(Page)
        mTable = " hrs_Exams "
        mInsertParameter = " Code,EngName,ArbName,ArbName4S,EmployeeCost,TopScore,PassingScore,Remarks,RegUserID,RegComputerID "
        mInsertParameterValues = " @Code,@EngName,@ArbName,@ArbName4S,@EmployeeCost,@TopScore,@PassingScore,@Remarks,@RegUserID,@RegComputerID "
        mUpdateParameter = " Code=@Code,EngName=@EngName,ArbName=@ArbName,ArbName4S=@ArbName4S,EmployeeCost=@EmployeeCost,TopScore=@TopScore,PassingScore=@PassingScore,Remarks=@Remarks "
...
#Region "Private Members"
    ...
    Private mTopScore As Object
    Private mPassingScore As Object
...
#Region "Public property"
    ...
    Public Property ArbName4S() As String
        ...
        End Set
    End Property
    Public Property EmployeeCost() As Integer
        Get
    ...
    Public Property TopScore() As Integer
        ...
        End Set
    End Property
    Public Property PassingScore() As Integer
        Get
            Return mPassingScore
        End Get
        Set(ByVal value As Integer)
            mPassingScore = value
        End Set
...
#Region "Public Function"
    ...
    '               :(frmDependenceType.aspx.vb)TlbMainNavigation_ButtonClicked()
    '               :(frmDependenceType.aspx.vb)GetValues()
    '               :(frmDependenceType.aspx.vb)SavePart()
    '               :(frmDependenceType.aspx.vb)SetToolbarSetting()
    '               :(frmDependenceType.aspx.vb)Setsetting()
    '               :(frmDependenceType.aspx.vb)CheckCode()
    'To             :GetParameter()
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
    ...
    Public Function SaveUpdate(ByVal Filter As String) As Boolean
        ...
        Try
            strSQL = "Select ID From hrs_Exams Where " & Filter
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mTopScore = mDataHandler.DataValue_Out(.Item("TopScore"), SqlDbType.Real)
                mPassingScore = mDataHandler.DataValue_Out(.Item("PassingScore"), SqlDbType.Real)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@EmployeeCost", SqlDbType.Money)).Value = mDataHandler.DataValue_In(mEmployeeCost, SqlDbType.Money)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@TopScore", SqlDbType.Real)).Value = mDataHandler.DataValue_In(mTopScore, SqlDbType.Real)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@PassingScore", SqlDbType.Real)).Value = mDataHandler.DataValue_In(mPassingScore, SqlDbType.Real)
