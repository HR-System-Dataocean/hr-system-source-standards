...
Public Class Clshrs_Att_AttendAppointment
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " Att_AttendAppointment "
        mInsertParameter = "" &
                "Code," &
                "FromDate," &
                "ToDate," &
        ...
        mUpdateParameter = "" &
                ...
                "FromDate=@FromDate," &
                "ToDate=@ToDate," &
                "AttendaceShiftID=@AttendaceShiftID," &
                "Remarks=@Remarks"
...
#Region "Private Members"
    ...
    Private mAttendaceShiftID As Integer
...
#Region "Public property"
    ...
    Public Property ToDate() As DateTime
        ...
        End Set
    End Property
    Public Property AttendaceShiftID() As Integer
        Get
            Return mAttendaceShiftID
        End Get
        Set(ByVal Value As Integer)
            mAttendaceShiftID = Value
        End Set
    End Property
...
#Region "Public Function"
    ...
    'Developer      :  DataOcean   
    'Date Created   :17/02/2016 6:09:02 AM
    'Modifacations  :
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mAttendaceShiftID = [Shared].DataHandler.DataValue_Out(.Item("AttendaceShiftID"), SqlDbType.Int, True)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@AttendaceShiftID", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mAttendaceShiftID, SqlDbType.Int)
