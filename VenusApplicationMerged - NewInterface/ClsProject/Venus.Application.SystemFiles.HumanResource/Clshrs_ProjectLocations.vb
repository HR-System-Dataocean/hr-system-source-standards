...
Public Class Clshrs_ProjectLocations
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " hrs_ProjectLocations "
        mInsertParameter = "" & _
          "ProjectChangeID," & _
          "MainLocationID," & _
        ...
        mUpdateParameter = "" & _
          ...
          "MainLocationID=@MainLocationID," & _
          "LocationDescription=@LocationDescription," & _
          "LocationAddress=@LocationAddress," & _
          "Required=@Required," & _
...
#Region "Private Members"
    ...
    Private mMainLocationID As Integer
    Private mLocationDescription As String
    Private mLocationAddress As String
    Private mRequired As Integer
    Private mSupervisor As Integer
...
#Region "Public property"
    ...
    Public Property MainLocationID() As Integer
        Get
            Return mMainLocationID
        End Get
        Set(ByVal Value As Integer)
            mMainLocationID = Value
        End Set
    End Property
...
#Region "Public Function"
    ...
    Public Function GetList(ByRef DdlValues As Infragistics.WebUI.UltraWebGrid.ValueList, ByVal NullNode As Boolean, Optional ByVal Filter As String = "") As Boolean
        ...
        Try
            ...
            For Each ObjDataRow In ObjDataset.Tables(0).Rows
                Item = New Infragistics.WebUI.UltraWebGrid.ValueListItem
                Item.DisplayText = mDataHandler.DataValue(ObjDataRow(ObjNavigationHandler.SetLanguage(mPage, "LocationDescription/LocationDescription")), SqlDbType.VarChar)
    ...
    Public Function GetDropDownList(ByVal DdlValues As Global.System.Web.UI.WebControls.DropDownList, ByVal NullNode As Boolean, Optional ByVal Filter As String = "") As Boolean
        ...
        Dim ObjNavigationHandler As New Venus.Shared.Web.NavigationHandler(mConnectionString)
        Try
            StrSelectCommand = mSelectCommand & IIf(Len(Filter) > 0, " Where IsNull(CancelDate,'')='' And IsNull(dbo.hrs_GetRecordViewStatus(ID,'" & Me.mTable & "'," & Me.mDataBaseUserRelatedID & "," & Me.GroupID & "),0) <> 1 And " & Filter & " Order By ID", "  Where IsNull(CancelDate,'')='' And IsNull(dbo.hrs_GetRecordViewStatus(ID,'" & Me.mTable & "'," & Me.mDataBaseUserRelatedID & "," & Me.GroupID & "),0) <> 1 Order By ID ")
            ...
            For Each ObjDataRow In ObjDataset.Tables(0).Rows
                Item = New Global.System.Web.UI.WebControls.ListItem
                Item.Text = mDataHandler.DataValue(ObjDataRow(ObjNavigationHandler.SetLanguage(mPage, "LocationDescription/LocationDescription")), SqlDbType.VarChar)
    ...
    Public Function Clear() As Boolean
        Try
            ...
            mProjectChangeID = 0
            mMainLocationID = 0
            mLocationDescription = String.Empty
            mLocationAddress = String.Empty
            mRequired = 0
            mSupervisor = 0
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mMainLocationID = [Shared].DataHandler.DataValue_Out(.Item("MainLocationID"), SqlDbType.Int, True)
                mLocationDescription = [Shared].DataHandler.DataValue_Out(.Item("LocationDescription"), SqlDbType.VarChar)
                mLocationAddress = [Shared].DataHandler.DataValue_Out(.Item("LocationAddress"), SqlDbType.VarChar)
                mRequired = [Shared].DataHandler.DataValue_Out(.Item("Required"), SqlDbType.Int, True)
                mSupervisor = [Shared].DataHandler.DataValue_Out(.Item("Supervisor"), SqlDbType.Int, True)
    ...
    '                  and return true if operation done otherwise report errors in ErrorPage
    'Developer      :  DataOcean   
    'Date Created   : 15/10/2015 12:33:25
    'Modifacations  :
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@MainLocationID", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mMainLocationID, SqlDbType.Int, True)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@LocationDescription", SqlDbType.VarChar)).Value = [Shared].DataHandler.DataValue_In(mLocationDescription, SqlDbType.VarChar)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@LocationAddress", SqlDbType.VarChar)).Value = [Shared].DataHandler.DataValue_In(mLocationAddress, SqlDbType.VarChar)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Required", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mRequired, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Supervisor", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mSupervisor, SqlDbType.Int)
