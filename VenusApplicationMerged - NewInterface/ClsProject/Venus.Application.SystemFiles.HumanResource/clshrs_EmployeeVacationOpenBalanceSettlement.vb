...
Public Class Clshrs_EmployeeVacationOpenBalanceSettlement
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " hrs_EmployeeVacationOpenBalanceSettlement "
        mInsertParameter = "" &
                "OpenBalanceID," &
...
#Region "Private Members"
    ...
    Private mOpenBalanceID As Integer
...
#Region "Public property"
    Public Property ID() As Integer
        ...
        End Set
    End Property
    Public Property OpenBalanceID() As Integer
        Get
            Return mOpenBalanceID
        End Get
        Set(ByVal Value As Integer)
            mOpenBalanceID = Value
        End Set
    End Property
    ...
    Public Property Canceldate() As DateTime
        ...
        End Set
    End Property
    Public Property PaidDays() As Object
        Get
            Return mPaidDays
        End Get
...
#Region "Public Function"
    ...
    'Developer      :  DataOcean   
    'Date Created   :12/10/2020 10:12:07 AM
    'Modifacations  :
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mOpenBalanceID = [Shared].DataHandler.DataValue_Out(.Item("OpenBalanceID"), SqlDbType.Int, True)
                ...
                mPaidDays = [Shared].DataHandler.DataValue_Out(.Item("PaidDays"), SqlDbType.Real)
                mDate = [Shared].DataHandler.DataValue_Out(.Item("Date"), SqlDbType.DateTime)
            End With
            Return True
        Catch ex As Exception
            mPage.Session.Add("ErrorValue", ex)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@OpenBalanceID", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mOpenBalanceID, SqlDbType.Int)
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@PaidDays", SqlDbType.Real)).Value = [Shared].DataHandler.DataValue_In(mPaidDays, SqlDbType.Real)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Date", SqlDbType.DateTime)).Value = [Shared].DataHandler.DataValue_In(mDate, SqlDbType.DateTime)
