...
Public Class ClsAtt_AttendWorkPlanMembers
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " Att_AttendWorkPlanMembers "
        mInsertParameter = "" & _
          "AttendWorkPlanID," & _
          "LocationID," & _
          "EmployeeID," & _
        ...
        mInsertParameterValues = "" & _
          ...
          " @RegComputerID"
        mUpdateParameter = "" & _
          "AttendWorkPlanID=@AttendWorkPlanID," & _
...
#Region "Private Members"
    ...
    Private mAttendWorkPlanID As Integer
...
#Region "Public property"
    Public Property ID() As Integer
        ...
        End Set
    End Property
    Public Property AttendWorkPlanID() As Integer
        Get
            Return mAttendWorkPlanID
        End Get
        Set(ByVal Value As Integer)
            mAttendWorkPlanID = Value
        End Set
    End Property
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mAttendWorkPlanID = [Shared].DataHandler.DataValue_Out(.Item("AttendWorkPlanID"), SqlDbType.Int, True)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@AttendWorkPlanID", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mAttendWorkPlanID, SqlDbType.Int)
