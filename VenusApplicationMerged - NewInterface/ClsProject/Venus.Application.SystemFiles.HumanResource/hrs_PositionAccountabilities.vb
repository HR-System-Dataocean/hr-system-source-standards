...
Public Class Clshrs_PositionAccountabilities
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " hrs_PositionAccountabilities "
        mInsertParameter = "" &
                "PositionID," &
                "CriteriaGroupID," &
                "CriteriaID," &
...
#Region "Private Members"
    ...
    Private mCriteriaGroupID As Integer
    Private mCriteriaID As Integer
    Private mMinimumScore As Integer
    Private mMaximumScore As Integer
...
#Region "Public property"
    ...
    Public Property PositionID() As Integer
        ...
        End Set
    End Property
    Public Property CriteriaGroupID() As Integer
        Get
            Return mCriteriaGroupID
        End Get
        Set(ByVal Value As Integer)
            mCriteriaGroupID = Value
        End Set
    End Property
    Public Property CriteriaID() As Integer
        ...
        End Set
    End Property
    Public Property MaximumScore() As Integer
        Get
...
#Region "Public Function"
    ...
    'Developer      :  DataOcean   
    'Date Created   :6/13/2013 11:42:44 ص
    'Modifacations  :
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mCriteriaGroupID = mDataHandler.DataValue_Out(.Item("CriteriaGroupID"), SqlDbType.Int, True)
                mCriteriaID = mDataHandler.DataValue_Out(.Item("CriteriaID"), SqlDbType.Int, True)
                mMinimumScore = mDataHandler.DataValue_Out(.Item("MinimumScore"), SqlDbType.Int, True)
                mMaximumScore = mDataHandler.DataValue_Out(.Item("MaximumScore"), SqlDbType.Int, True)
                mWeight = mDataHandler.DataValue_Out(.Item("Weight"), SqlDbType.Int, True)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@PositionID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mPositionID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@CriteriaGroupID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mCriteriaGroupID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@CriteriaID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mCriteriaID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@MinimumScore", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mMinimumScore, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@MaximumScore", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mMaximumScore, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Weight", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mWeight, SqlDbType.Int)
