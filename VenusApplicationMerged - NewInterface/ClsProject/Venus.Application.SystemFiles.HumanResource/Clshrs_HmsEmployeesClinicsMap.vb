...
Public Class Clshrs_HmsEmployeesClinicsMap
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " hrs_HmsEmployeesClinicsMap "
        mInsertParameter = "" &
        ...
        mInsertParameterValues = "" &
                                                                                ...
                                                                                " @RegUserID"
        mUpdateParameter = "" &
                                                                                "CommissionCategoriesID=@CommissionCategoriesID," &
                                                                                "DoctoreCode=@DoctoreCode," &
                                                                                "EmpCode=@EmpCode," &
...
#Region "Private Members"
    ...
    Private mCommissionCategoriesID As Integer
    Private mDoctoreCode As String
    Private mEmpCode As String
    Private mCommissionPc As Object
    Private mCommissionService As String
...
#Region "Public property"
    Public Property ID() As Integer
        ...
        End Set
    End Property
    Public Property CommissionCategoriesID() As Integer
        Get
            Return mCommissionCategoriesID
        End Get
        Set(ByVal Value As Integer)
            mCommissionCategoriesID = Value
        End Set
    End Property
    Public Property DoctoreCode() As String
        Get
            Return mDoctoreCode
        End Get
    ...
    Public Property CommissionPc() As Object
        ...
        End Set
    End Property
    Public Property CommissionService() As String
        Get
            Return mCommissionService
        End Get
        Set(ByVal Value As String)
            mCommissionService = Value
        End Set
    End Property
...
#Region "Public Function"
    ...
    'Developer      :  DataOcean   
    'Date Created   :24/10/2019 01:48:37 م
    'Modifacations  :
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
    ...
    Public Function Clear() As Boolean
        Try
            mID = 0
            mCommissionCategoriesID = 0
            mDoctoreCode = String.Empty
            mEmpCode = String.Empty
            mCommissionPc = Nothing
            mCommissionService = String.Empty
            mRegUserID = 0
            mRegDate = Nothing
            mCancelDate = Nothing
        Catch ex As Exception
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mCommissionCategoriesID = [Shared].DataHandler.DataValue_Out(.Item("CommissionCategoriesID"), SqlDbType.Int, True)
                mDoctoreCode = [Shared].DataHandler.DataValue_Out(.Item("DoctoreCode"), SqlDbType.VarChar)
                mEmpCode = [Shared].DataHandler.DataValue_Out(.Item("EmpCode"), SqlDbType.VarChar)
                mCommissionPc = [Shared].DataHandler.DataValue_Out(.Item("CommissionPc"), SqlDbType.Float)
                mCommissionService = [Shared].DataHandler.DataValue_Out(.Item("CommissionService"), SqlDbType.VarChar)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@CommissionCategoriesID", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mCommissionCategoriesID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@DoctoreCode", SqlDbType.VarChar)).Value = [Shared].DataHandler.DataValue_In(mDoctoreCode, SqlDbType.VarChar)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@EmpCode", SqlDbType.VarChar)).Value = [Shared].DataHandler.DataValue_In(mEmpCode, SqlDbType.VarChar)
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@CommissionService", SqlDbType.VarChar)).Value = [Shared].DataHandler.DataValue_In(mCommissionService, SqlDbType.VarChar)
