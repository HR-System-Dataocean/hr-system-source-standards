...
Public Class ClsEval_Questions
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " Eval_Questions "
        mInsertParameter = "" & _
          "Code," & _
          "EngName," & _
          "ArbName," & _
        ...
        mUpdateParameter = "" & _
          ...
          "EngName=@EngName," & _
          "ArbName=@ArbName," & _
          "Question_Eng=@Question_Eng," & _
          "Question_Arb=@Question_Arb," & _
          "QPower=@QPower," & _
...
#Region "Private Members"
    ...
    Private mQuestion_Eng As String
    Private mQuestion_Arb As String
    Private mQPower As Integer
    Private mAnswerType As Integer
...
#Region "Public property"
    ...
    Public Property ArbName() As String
        ...
        End Set
    End Property
    Public Property Question_Eng() As String
        Get
            Return mQuestion_Eng
        End Get
        Set(ByVal Value As String)
            mQuestion_Eng = Value
        End Set
    End Property
    Public Property Question_Arb() As String
        Get
            Return mQuestion_Arb
        End Get
        Set(ByVal Value As String)
            mQuestion_Arb = Value
        End Set
    End Property
    Public Property QPower() As Integer
        Get
            Return mQPower
        End Get
        Set(ByVal Value As Integer)
        ...
        End Set
    End Property
    Public Property AnswerType() As Integer
        Get
            Return mAnswerType
        End Get
        Set(ByVal Value As Integer)
...
#Region "Public Function"
    ...
    'Developer      :  DataOcean   
    'Date Created   :14/04/2011 10:07:42
    'Modifacations  :
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
    ...
    Public Function Clear() As Boolean
        Try
            ...
            mQuestion_Eng = String.Empty
            mQuestion_Arb = String.Empty
            mQPower = 0
            mAnswerType = 0
            mStatus = False
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mQuestion_Eng = mDataHandler.DataValue_Out(.Item("Question_Eng"), SqlDbType.VarChar)
                mQuestion_Arb = mDataHandler.DataValue_Out(.Item("Question_Arb"), SqlDbType.VarChar)
                mQPower = mDataHandler.DataValue_Out(.Item("QPower"), SqlDbType.Int, True)
                mAnswerType = mDataHandler.DataValue_Out(.Item("AnswerType"), SqlDbType.Int, True)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Question_Eng", SqlDbType.VarChar)).Value = mDataHandler.DataValue_In(mQuestion_Eng, SqlDbType.VarChar)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Question_Arb", SqlDbType.VarChar)).Value = mDataHandler.DataValue_In(mQuestion_Arb, SqlDbType.VarChar)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@QPower", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mQPower, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@AnswerType", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mAnswerType, SqlDbType.Int)
