...
'Developer         : [0257]
'Description       : 1-Implement Data Acess Layer of hrs_DependantsTypes table with fields code,English name,
'                       Arabic name
'                    2-Allow searching
...
Public Class Clshrs_DependantsTypes
...
#Region "Class Constructors"
    ...
    Public Sub New(ByVal Page As Web.UI.Page)
        ...
        mUpdateParameter = " Code=@Code,EngName=@EngName,ArbName=@ArbName,ArbName4S=@SearchArbName,Remarks=@Remarks,CompanyID=@CompanyID,RegUserID=@RegUserID,RegComputerID=@RegComputerID "
...
#Region "Public Function"
    ...
    Public Function Find(ByVal Filter As String) As Boolean
        ...
        Try
            ...
            End If
            StrSelectCommand = mSelectCommand & IIf(Len(Filter) > 0, " Where IsNull(dbo.hrs_GetRecordViewStatus(ID,'" & Me.mTable & "'," & Me.mDataBaseUserRelatedID & "," & Me.GroupID & "),0) <> 1  And " & Filter, "  And IsNull(dbo.hrs_GetRecordViewStatus(ID,'" & Me.mTable & "'," & Me.mDataBaseUserRelatedID & "," & Me.GroupID & "),0) <> 1 ") 'And CompanyID= " & Me.MainCompanyID)
    ...
    Public Function SaveUpdate(ByVal Filter As String) As Boolean
        ...
        Try
            strSQL = "Select ID From hrs_ContractTypes Where " & Filter
