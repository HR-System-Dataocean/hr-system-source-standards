...
Public Class ClsAtt_AttendShifts
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " Att_AttendShifts "
        mInsertParameter = "" & _
          "Code," & _
          "EngName," & _
          "ArbName," & _
          "Remarks," & _
          "FirstShiftTimeInFingerprintStart," & _
          "FirstShiftEntryTimeInClose," & _
          "FirstShiftTimeOutFingerprintClose," & _
          "SecondShiftTimeInFingerprintStart," & _
          "SecondShiftEntryTimeInClose," & _
          "SecondShiftTimeOutFingerprintClose," & _
          "RegUserID," & _
          "RegComputerID"
        ...
        mUpdateParameter = "" & _
          ...
          "EngName=@EngName," & _
          "ArbName=@ArbName," & _
          "FirstShiftTimeInFingerprintStart=@FirstShiftTimeInFingerprintStart," & _
          "FirstShiftEntryTimeInClose=@FirstShiftEntryTimeInClose," & _
          "FirstShiftTimeOutFingerprintClose=@FirstShiftTimeOutFingerprintClose," & _
          "SecondShiftTimeInFingerprintStart=@SecondShiftTimeInFingerprintStart," & _
          "SecondShiftEntryTimeInClose=@SecondShiftEntryTimeInClose," & _
          "SecondShiftTimeOutFingerprintClose=@SecondShiftTimeOutFingerprintClose," & _
          "Remarks=@Remarks"
...
#Region "Public Function"
    ...
    Public Function GetDropDownList(ByVal DdlValues As Global.System.Web.UI.WebControls.DropDownList, ByVal NullNode As Boolean, Optional ByVal Filter As String = "") As Boolean
        ...
        Try
            ...
            For Each ObjDataRow In ObjDataset.Tables(0).Rows
                Item = New Global.System.Web.UI.WebControls.ListItem
                Item.Text = mDataHandler.DataValue(ObjDataRow("Code"), SqlDbType.VarChar) + " - " + mDataHandler.DataValue(ObjDataRow(ObjNavigationHandler.SetLanguage(mPage, "EngName/ArbName")), SqlDbType.VarChar)
                If (Item.Text.Trim = "") Then
                    Item.Text = mDataHandler.DataValue(ObjDataRow("Code"), SqlDbType.VarChar) + " - " + mDataHandler.DataValue(ObjDataRow(ObjNavigationHandler.SetLanguage(mPage, "ArbName/EngName")), SqlDbType.VarChar)
                End If
    ...
    Public Function Clear() As Boolean
        Try
            ...
            mFirstShiftTimeInFingerprintStart = String.Empty
            mFirstShiftEntryTimeInClose = String.Empty
            mFirstShiftTimeOutFingerprintClose = String.Empty
            mSecondShiftTimeInFingerprintStart = String.Empty
            mSecondShiftEntryTimeInClose = String.Empty
            mSecondShiftTimeOutFingerprintClose = String.Empty
            mRegUserID = 0
            mRegComputerID = 0
            mRegDate = Nothing
            mCancelDate = Nothing
