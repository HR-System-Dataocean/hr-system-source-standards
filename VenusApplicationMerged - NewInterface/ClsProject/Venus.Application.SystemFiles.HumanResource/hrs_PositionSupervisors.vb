...
Public Class Clshrs_PositionSupervisors
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " hrs_PositionSupervisors "
        mInsertParameter = "" & _
                "PositionID," & _
                "SuperVisorID," & _
                "Remarks," & _
...
#Region "Private Members"
    ...
    Private mSuperVisorID As Integer
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mSuperVisorID = mDataHandler.DataValue_Out(.Item("SuperVisorID"), SqlDbType.Int, True)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@SuperVisorID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mSuperVisorID, SqlDbType.Int)
