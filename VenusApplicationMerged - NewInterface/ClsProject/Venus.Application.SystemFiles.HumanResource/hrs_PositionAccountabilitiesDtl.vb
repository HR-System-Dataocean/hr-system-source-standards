...
Public Class Clshrs_PositionAccountabilitiesDtl
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " hrs_PositionAccountabilitiesDtl "
        mInsertParameter = "" & _
                "PosAccountabilityID," & _
                "EngName," & _
                "ArbName," & _
                "Remarks," & _
                "RegUserID," & _
        ...
        mInsertParameterValues = "" & _
                ...
                " @RegComputerID"
        mUpdateParameter = "" & _
                "PosAccountabilityID=@PosAccountabilityID," & _
                "EngName=@EngName," & _
                "ArbName=@ArbName," & _
                "Remarks=@Remarks"
...
#Region "Private Members"
    ...
    Private mPosAccountabilityID As Integer
...
#Region "Public property"
    Public Property ID() As Integer
        ...
        End Set
    End Property
    Public Property PosAccountabilityID() As Integer
        Get
            Return mPosAccountabilityID
        End Get
        Set(ByVal Value As Integer)
            mPosAccountabilityID = Value
        End Set
    End Property
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mPosAccountabilityID = mDataHandler.DataValue_Out(.Item("PosAccountabilityID"), SqlDbType.Int, True)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@PosAccountabilityID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mPosAccountabilityID, SqlDbType.Int)
