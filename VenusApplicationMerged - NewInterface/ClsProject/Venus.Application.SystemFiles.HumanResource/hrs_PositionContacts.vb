...
Public Class Clshrs_PositionContacts
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " hrs_PositionContacts "
        mInsertParameter = "" & _
                "PositionID," & _
                "EngName," & _
                "ArbName," & _
...
#Region "Public Function"
    ...
    'Developer      :  DataOcean   
    'Date Created   :6/13/2013 11:42:45 ص
    'Modifacations  :
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mIsExternal = mDataHandler.DataValue_Out(.Item("IsExternal"), SqlDbType.Bit)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@IsExternal", SqlDbType.Bit)).Value = mDataHandler.DataValue_In(mIsExternal, SqlDbType.Bit)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@IntervalID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mIntervalID, SqlDbType.Int)
