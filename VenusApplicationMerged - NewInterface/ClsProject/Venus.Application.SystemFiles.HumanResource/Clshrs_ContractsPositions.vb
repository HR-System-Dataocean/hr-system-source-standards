...
Public Class Clshrs_ContractsPositions
    Inherits ClsDataAcessLayer

#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " hrs_ContractsArticlesPositionHistory "
        mInsertParameter = " ContractID,PositionID,EffectDate,Remarks,RegUserID,RegComputerID,CompanyId "
        mInsertParameterValues = " @ContractID,@PositionID,@EffectDate,@Remarks,@RegUserID,@RegComputerID,@CompanyId "
        mUpdateParameter = " ContractID=@ContractID,PositionID=@PositionID,EffectDate=@EffectDate,Remarks=@Remarks,RegUserID=@RegUserID,RegComputerID=@RegComputerID,CompanyId=@CompanyId "
...
#Region "Public Function"
    ...
    Public Function SaveUpdate(ByVal Filter As String) As Boolean
        ...
        Try
            strSQL = "Select ID From hrs_ContractsArticlesPositionHistory Where " & Filter
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        ...
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mPositionID = mDataHandler.DataValue_Out(.Item("PositionID"), SqlDbType.Int)
