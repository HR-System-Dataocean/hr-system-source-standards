...
Public Class Clshrs_EmployeeVacationOpenBalance
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " hrs_EmployeeVacationOpenBalance "
        mInsertParameter = "" & _
          "EmployeeID," & _
          "VacationTypeID," & _
          "GBalanceDate," & _
        ...
        mUpdateParameter = "" & _
          ...
          "VacationTypeID=@VacationTypeID," & _
          "GBalanceDate=@GBalanceDate," & _
          "HBalanceDate=@HBalanceDate," & _
          "Days=@Days," & _
          "OverDue=@OverDue," & _
          "VacationBalance=@VacationBalance," & _
...
#Region "Private Members"
    ...
    Private mVacationTypeID As Integer
    Private mGBalanceDate As DateTime
    Private mHBalanceDate As String
    Private mDays As Decimal
    Private mOverDue As Integer
    Private mVacationBalance As Decimal
...
#Region "Public property"
    ...
    Public Property VacationTypeID() As Integer
        ...
        End Set
    End Property
    Public Property GBalanceDate() As DateTime
        Get
            Return mGBalanceDate
        End Get
        Set(ByVal Value As DateTime)
            mGBalanceDate = Value
        End Set
    End Property
    Public Property HBalanceDate() As String
        Get
            Return mHBalanceDate
        End Get
    ...
    Public Property OverDue() As Integer
        ...
        End Set
    End Property
    Public Property VacationBalance() As Decimal
        Get
            Return mVacationBalance
        End Get
        Set(ByVal Value As Decimal)
            mVacationBalance = Value
        End Set
    End Property
...
#Region "Public Function"
    ...
    'Developer      :  DataOcean   
    'Date Created   :26/02/2012 11:24:44
    'Modifacations  :
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
    ...
    Public Function Clear() As Boolean
        Try
            ...
            mEmployeeID = 0
            mVacationTypeID = 0
            mGBalanceDate = Nothing
            mHBalanceDate = String.Empty
            mDays = 0
            mOverDue = 0
            mVacationBalance = 0
            mRegUserID = 0
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mGBalanceDate = mDataHandler.DataValue_Out(.Item("GBalanceDate"), SqlDbType.DateTime)
                mHBalanceDate = mDataHandler.DataValue_Out(.Item("HBalanceDate"), SqlDbType.VarChar)
                mDays = mDataHandler.DataValue_Out(.Item("Days"), SqlDbType.Decimal, True)
                mOverDue = mDataHandler.DataValue_Out(.Item("OverDue"), SqlDbType.Int, True)
                mVacationBalance = mDataHandler.DataValue_Out(.Item("VacationBalance"), SqlDbType.Float)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@VacationTypeID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mVacationTypeID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@GBalanceDate", SqlDbType.DateTime)).Value = mDataHandler.DataValue_In(mGBalanceDate, SqlDbType.DateTime)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@HBalanceDate", SqlDbType.VarChar)).Value = mDataHandler.DataValue_In(mHBalanceDate, SqlDbType.VarChar)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Days", SqlDbType.Decimal)).Value = mDataHandler.DataValue_In(mDays, SqlDbType.Decimal)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@OverDue", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mOverDue, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@VacationBalance", SqlDbType.Float)).Value = mDataHandler.DataValue_In(mVacationBalance, SqlDbType.Float)
            ...
            ElseIf (strMode.Trim.ToUpper = "UPDATE") Then
                Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@RegComputerID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mRegComputerID, SqlDbType.Int)
            End If
        Catch ex As Exception
            mPage.Session.Add("ErrorValue", ex)
...
#Region "Navigation Functions"
    ...
    Public Function NextRecord(Optional ByVal Filter As String = "") As Boolean
        Dim StrSelectCommand As String
        Try
            StrSelectCommand = "SELECT TOP 1 * FROM " & mTable & " WHERE Code >'" & mID & "' And  IsNull(dbo.hrs_GetRecordViewStatus(ID,'" & Me.mTable & "'," & Me.mDataBaseUserRelatedID & "," & Me.GroupID & "),0) <> 1 " & IIf(Filter.Trim = "", " ", " AND " & Filter & " ") & " ORDER BY Code ASC"
            mSqlDataAdapter = New SqlClient.SqlDataAdapter(StrSelectCommand, mConnectionString)
            mDataSet = New DataSet
            mSqlDataAdapter.Fill(mDataSet)
            If mDataHandler.CheckValidDataObject(mDataSet) Then
    ...
    Public Function previousRecord(Optional ByVal Filter As String = "") As Boolean
        Dim StrSelectCommand As String
        Try
            StrSelectCommand = "SELECT TOP 1 * FROM " & mTable & " WHERE Code <'" & mID & "' And  IsNull(dbo.hrs_GetRecordViewStatus(ID,'" & Me.mTable & "'," & Me.mDataBaseUserRelatedID & "," & Me.GroupID & "),0) <> 1 " & IIf(Filter.Trim = "", " ", " AND " & Filter & " ") & " ORDER BY Code DESC"
            mSqlDataAdapter = New SqlClient.SqlDataAdapter(StrSelectCommand, mConnectionString)
            mDataSet = New DataSet
            mSqlDataAdapter.Fill(mDataSet)
            If mDataHandler.CheckValidDataObject(mDataSet) Then
