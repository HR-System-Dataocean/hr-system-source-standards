...
Public Class ClsRec_ApplicantsFilter
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " Rec_ApplicantsFilter "
        mInsertParameter = "" & _
          "Code," & _
          "EngName," & _
          "ArbName," & _
        ...
        mUpdateParameter = "" & _
          ...
          "ExpPowerPCT=@ExpPowerPCT," & _
          "SalaryPowerPCT=@SalaryPowerPCT," & _
          "EvaluationPowerPCT=@EvaluationPowerPCT," & _
          "Remarks=@Remarks"
...
#Region "Private Members"
    ...
    Private mExpPowerPCT As Integer
    Private mSalaryPowerPCT As Integer
    Private mEvaluationPowerPCT As Integer
...
#Region "Public property"
    ...
    Public Property ArbName4S() As String
        ...
        End Set
    End Property
    Public Property ExpPowerPCT() As Integer
        Get
            Return mExpPowerPCT
        End Get
        Set(ByVal Value As Integer)
        ...
        End Set
    End Property
    Public Property SalaryPowerPCT() As Integer
        Get
            Return mSalaryPowerPCT
        End Get
        Set(ByVal Value As Integer)
            mSalaryPowerPCT = Value
        End Set
    End Property
    Public Property EvaluationPowerPCT() As Integer
        Get
            Return mEvaluationPowerPCT
        End Get
        Set(ByVal Value As Integer)
            mEvaluationPowerPCT = Value
        End Set
    End Property
...
#Region "Public Function"
    ...
    'Developer      :  DataOcean   
    'Date Created   :06/07/1432 12:09:03
    'Modifacations  :
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mExpPowerPCT = mDataHandler.DataValue_Out(.Item("ExpPowerPCT"), SqlDbType.Int, True)
                mSalaryPowerPCT = mDataHandler.DataValue_Out(.Item("SalaryPowerPCT"), SqlDbType.Int, True)
                mEvaluationPowerPCT = mDataHandler.DataValue_Out(.Item("EvaluationPowerPCT"), SqlDbType.Int, True)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@ExpPowerPCT", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mExpPowerPCT, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@SalaryPowerPCT", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mSalaryPowerPCT, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@EvaluationPowerPCT", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mEvaluationPowerPCT, SqlDbType.Int)
