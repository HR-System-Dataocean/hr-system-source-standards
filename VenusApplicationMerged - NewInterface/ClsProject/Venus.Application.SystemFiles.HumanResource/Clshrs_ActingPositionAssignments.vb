...
Public Class Clshrs_ActingPositionAssignments
    ...
    Public Sub New(ByVal Page As Web.UI.Page)
        ...
        mInsertCommand = CONFIG_DATEFORMAT & " INSERT INTO " & mTable &
            " (Code, OriginalPositionID, ActingEmployeeID, EffectiveFrom, EffectiveTo, Reason, Remarks, RegUserID, RegDate)" &
            " VALUES (@Code,@OriginalPositionID,@ActingEmployeeID,@EffectiveFrom,@EffectiveTo,@Reason,@Remarks,@RegUserID,GETDATE())"
