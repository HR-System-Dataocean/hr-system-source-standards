...
Public Class Clshrs_PositionCompetences
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " hrs_PositionCompetences "
        mInsertParameter = "" &
                "PositionID," &
                "EngName," &
                "ArbName," &
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mcriteriaGroupID = mDataHandler.DataValue_Out(.Item("criteriaGroupID"), SqlDbType.Int)
                mCriteriaID = mDataHandler.DataValue_Out(.Item("CriteriaID"), SqlDbType.Int)
                mMinimumScore = mDataHandler.DataValue_Out(.Item("MinimumScore"), SqlDbType.Int)
                mMaximumScore = mDataHandler.DataValue_Out(.Item("MaximumScore"), SqlDbType.Int)
                mWeight = mDataHandler.DataValue_Out(.Item("Weight"), SqlDbType.Int)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@criteriaGroupID", SqlDbType.VarChar)).Value = mDataHandler.DataValue_In(mcriteriaGroupID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@CriteriaID", SqlDbType.VarChar)).Value = mDataHandler.DataValue_In(mCriteriaID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@MinimumScore", SqlDbType.VarChar)).Value = mDataHandler.DataValue_In(mMinimumScore, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@MaximumScore", SqlDbType.VarChar)).Value = mDataHandler.DataValue_In(mMaximumScore, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Weight", SqlDbType.VarChar)).Value = mDataHandler.DataValue_In(mWeight, SqlDbType.Int)
