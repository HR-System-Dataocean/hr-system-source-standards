...
Public Class Clshrs_LevelTypes
    Inherits ClsDataAcessLayer

#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " hrs_LevelTypes "
        mInsertParameter = " Code,EngName,ArbName,SearchArbName,Value,Remarks,RegUserID,RegComputerID,CompanyID "
        mInsertParameterValues = " @Code,@EngName,@ArbName,@SearchArbName,@Value,@Remarks,@RegUserID,@RegComputerID,@CompanyID "
        mUpdateParameter = " EngName=@EngName,ArbName=@ArbName,SearchArbName=@SearchArbName,Value=@Value,Remarks=@Remarks,RegUserID=@RegUserID,RegComputerID=@RegComputerID,CompanyID=@CompanyID "
...
#Region "Public Function"
    ...
    Public Function Find(ByVal Filter As String) As Boolean
        ...
        Try
            ...
            End If
            StrSelectCommand = mSelectCommand & IIf(Len(Filter) > 0, " Where IsNull(CancelDate,'')='' And IsNull(dbo.hrs_GetRecordViewStatus(ID,'" & Me.mTable & "'," & Me.mDataBaseUserRelatedID & "," & Me.GroupID & "),0) <> 1 And CompanyID = " & Me.MainCompanyID & " And " & Filter, "  Where IsNull(CancelDate,'')='' And IsNull(dbo.hrs_GetRecordViewStatus(ID,'" & Me.mTable & "'," & Me.mDataBaseUserRelatedID & "," & Me.GroupID & "),0) <> 1 and CompanyID =" & Me.MainCompanyID)
    ...
    Public Function SaveUpdate(ByVal Filter As String) As Boolean
        ...
        Try
            strSQL = "Select ID From hrs_LevelTypes Where " & Filter
    ...
    Public Function GetLevels(ByVal DdlGroups As Global.System.Web.UI.WebControls.DropDownList) As Boolean
        ...
        Try
            ...
            StrCommandString = "Select * From hrs_LevelTypes Where IsNull(CancelDate,'')='' And IsNull(dbo.hrs_GetRecordViewStatus(ID,'" & Me.mTable & "'," & Me.mDataBaseUserRelatedID & "," & Me.GroupID & "),0) <> 1 And CompanyID=" & Me.MainCompanyID
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mValue = mDataHandler.DataValue_Out(.Item("Value"), SqlDbType.Int)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Value", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mValue, SqlDbType.Int)
