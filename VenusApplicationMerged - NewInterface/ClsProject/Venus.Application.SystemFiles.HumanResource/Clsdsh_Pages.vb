...
#Region "Public property"
    ...
    Public Property Col() As Integer
        ...
        End Set
    End Property
    Public Property Rws() As Integer
        Get
            Return mRws
        End Get
        Set(ByVal Value As Integer)
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mCol = [Shared].DataHandler.DataValue_Out(.Item("Col"), SqlDbType.Int, True)
                mRws = [Shared].DataHandler.DataValue_Out(.Item("Rws"), SqlDbType.Int, True)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Col", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mCol, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Rws", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mRws, SqlDbType.Int)
