...
'Date Created      : 11-7-07
'Developer         : DataOcean
'Description       : 1-Implement Data Acess Layer of hrs_timeIntervals table with fields code,English name,
...
Public Class Clshrs_TimeIntervalsTypesBases
...
#Region "Class Constructors"
    ...
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " hrs_TimeIntervalsTypes "
        'mInsertParameter = " Code,EngName,ArbName,SearchArbName,IsYear,IsMonth,IsDay,IsHour,Period,Remarks,RegUserID,RegComputerID,CompanyId "
        mInsertParameter = " Code,EngName,ArbName,SearchArbName,IsYear,IsMonth,IsDay,IsHour,Period,Remarks,RegUserID,RegComputerID "
        'mInsertParameterValues = " @Code,@EngName,@ArbName,@SearchArbName,@IsYear,@IsMonth,@IsDay,@IsHour,@Period,@Remarks,@RegUserID,@RegComputerID,@CompanyId "
        mInsertParameterValues = " @Code,@EngName,@ArbName,@SearchArbName,@IsYear,@IsMonth,@IsDay,@IsHour,@Period,@Remarks,@RegUserID,@RegComputerID"
        'mUpdateParameter = " Code=@Code,EngName=@EngName,ArbName=@ArbName,SearchArbName=@SearchArbName,IsYear=@IsYear,IsMonth=@IsMonth,IsDay=@IsDay,IsHour=@IsHour,Period=@Period,Remarks=@Remarks,RegUserID=@RegUserID,RegComputerID=@RegComputerID,CompanyId=@CompanyId "
        mUpdateParameter = " Code=@Code,EngName=@EngName,ArbName=@ArbName,SearchArbName=@SearchArbName,IsYear=@IsYear,IsMonth=@IsMonth,IsDay=@IsDay,IsHour=@IsHour,Period=@Period,Remarks=@Remarks,RegUserID=@RegUserID,RegComputerID=@RegComputerID "
...
#Region "Private Members"
    ...
    Private mIsYear As Boolean
    Private mIsMonth As Boolean
    Private mIsDay As Boolean
    Private mIsHour As Boolean
    Private mPeriod As Double
...
#Region "Public property"
    ...
    Public Property SearchArbName() As String
        ...
        End Set
    End Property
    Public Property IsYear() As Boolean
        Get
            Return mIsYear
        End Get
    ...
    Public Property IsDay() As Boolean
        ...
        End Set
    End Property
    Public Property IsHour() As Boolean
        Get
            Return mIsHour
        End Get
        Set(ByVal Value As Boolean)
...
#Region "Public Function"
    ...
    'Module         :  Hrs (Human Resource Module)
    'Project        :  Venus V.
    'Description    :  Find all rows in hrs_TimeIntervalsTypes that match criteria or filter and canceldate = null
    '               Steps:
    ...
    'Module         :  Hrs (Human Resource Module)
    'Project        :  Venus V.
    'Description    :  Save Or Update Row that match with critera in hrs_TimeIntervalsTypes table 
    ...
    'Module         :  Hrs (Human Resource Module)
    'Project        :  Venus V.
    'Description    :  Save new row into hrs_TimeIntervalsTypes table
    '                  and return true if operation done otherwise report errors in ErrorPage
    'Developer      :  
    'Date Created   :  
    'Modifacations  : 
    ...
    'Module         :  Hrs (Human Resource Module)
    'Project        :  Venus V.
    'Description    :  update row that match with critera into hrs_TimeIntervalsTypes table
    '                  and return true if operation done otherwise report errors in ErrorPage
    'Developer      :  
    'Date Created   :  
    'Modifacations  : 
    ...
    'Module         :  Hrs (Human Resource Module)
    'Project        :  Venus V.
    'Description    :  Delete new row that match critera into hrs_TimeIntervalsTypes table
    '                  and return true if operation done otherwise report errors in ErrorPage                    
    'Developer      :  
    'Date Created   :  
    'Modifacations  : 
    ...
    'Module         :  Hrs (Human Resource Module)
    'Project        :  Venus V.
    'Description    :  Get first record in hrs_TimeIntervalsTypes table
    '                  and return true if operation done otherwise report errors in ErrorPage
    'Developer      :  
    'Date Created   :  
    'Modifacations  : 
    ...
    'Module         :  Hrs (Human Resource Module)
    'Project        :  Venus V.
    'Description    :  Get last record in hrs_TimeIntervalsTypes table
    '                  and return true if operation done otherwise report errors in ErrorPage
    'Developer      :  
    'Date Created   :  
    'Modifacations  : 
    ...
    'Module         :  Hrs (Human Resource Module)
    'Project        :  Venus V.
    'Description    :  Get next record  from hrs_TimeIntervalsTypes table
    '                  and return true if operation done otherwise report errors in ErrorPage
    'Developer      :  
    'Date Created   :  
    'Modifacations  : 
    ...
    'Module         :  Hrs (Human Resource Module)
    'Project        :  Venus V.
    'Description    :  Get previous record from hrs_TimeIntervalsTypes table
    '                  and return true if operation done otherwise report errors in ErrorPage
    'Developer      :  
    'Date Created   :  
    'Modifacations  : 
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mIsYear = mDataHandler.DataValue_Out(.Item("IsYear"), SqlDbType.Bit)
                mIsMonth = mDataHandler.DataValue_Out(.Item("IsMonth"), SqlDbType.Bit)
                mIsDay = mDataHandler.DataValue_Out(.Item("IsDay"), SqlDbType.Bit)
                mIsHour = mDataHandler.DataValue_Out(.Item("IsHour"), SqlDbType.Bit)
                mPeriod = mDataHandler.DataValue_Out(.Item("Period"), SqlDbType.Float)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@IsYear", SqlDbType.Bit)).Value = mDataHandler.DataValue_In(mIsYear, SqlDbType.Bit)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@IsMonth", SqlDbType.Bit)).Value = mDataHandler.DataValue_In(mIsMonth, SqlDbType.Bit)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@IsDay", SqlDbType.Bit)).Value = mDataHandler.DataValue_In(mIsDay, SqlDbType.Bit)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@IsHour", SqlDbType.Bit)).Value = mDataHandler.DataValue_In(mIsHour, SqlDbType.Bit)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Period", SqlDbType.Float)).Value = mDataHandler.DataValue_In(mPeriod, SqlDbType.Float)
...
Public Class Clshrs_TimeIntervalsTypes
    Inherits Clshrs_TimeIntervalsTypesBases
    ...
    'Module         :  Hrs (Human Resource Module)
    'Project        :  Venus V.
    'Description    :  Fill DropDownList with English name column from hrs_TimeIntervals table
    '                  and return true if operation done otherwise report errors in ErrorPage
    'Developer      :  
    'Date Created   :  
    'Modifacations  : [0257] [11-07-2007]
