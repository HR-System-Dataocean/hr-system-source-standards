...
#Region "Private Members"
    ...
    Private mPolicyNo As String
    Private mFromDate As DateTime
    Private mToDate As DateTime
    Private mHICompanyID As Integer
...
#Region "Public property"
    ...
    Public Property ToDate() As DateTime
        ...
        End Set
    End Property
    Public Property HICompanyID() As Integer
        Get
            Return mHICompanyID
        End Get
        Set(ByVal Value As Integer)
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mPolicyNo = mDataHandler.DataValue_Out(.Item("PolicyNo"), SqlDbType.VarChar)
                ...
                mHICompanyID = mDataHandler.DataValue_Out(.Item("HICompanyID"), SqlDbType.Int, True)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@PolicyNo", SqlDbType.VarChar)).Value = mDataHandler.DataValue_In(mPolicyNo, SqlDbType.VarChar)
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@HICompanyID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mHICompanyID, SqlDbType.Int)
