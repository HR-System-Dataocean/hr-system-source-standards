...
Public Class Clshrs_EmployeesClassesDelay
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " hrs_EmployeesClassesDelay "
        mInsertParameter = "" & _
          "ClassID," & _
          "FromMin," & _
          "ToMin," & _
...
#Region "Private Members"
    ...
    Private mFromMin As Integer
    Private mToMin As Integer
    Private mPunishPCT As Integer
...
#Region "Public property"
    ...
    Public Property ClassID() As Integer
        ...
        End Set
    End Property
    Public Property FromMin() As Integer
        Get
            Return mFromMin
        End Get
        Set(ByVal Value As Integer)
        ...
        End Set
    End Property
    Public Property ToMin() As Integer
        Get
            Return mToMin
        End Get
        Set(ByVal Value As Integer)
        ...
        End Set
    End Property
    Public Property PunishPCT() As Integer
        Get
            Return mPunishPCT
        End Get
        Set(ByVal Value As Integer)
...
#Region "Public Function"
    ...
    'Developer      :  DataOcean   
    'Date Created   :20/04/2011 12:26:21
    'Modifacations  :
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mClassID = mDataHandler.DataValue_Out(.Item("ClassID"), SqlDbType.Int, True)
                mFromMin = mDataHandler.DataValue_Out(.Item("FromMin"), SqlDbType.Int, True)
                mToMin = mDataHandler.DataValue_Out(.Item("ToMin"), SqlDbType.Int, True)
                mPunishPCT = mDataHandler.DataValue_Out(.Item("PunishPCT"), SqlDbType.Int, True)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@ClassID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mClassID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@FromMin", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mFromMin, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@ToMin", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mToMin, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@PunishPCT", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mPunishPCT, SqlDbType.Int)
