...
#Region "Public Function"
    ...
    End Function
    Public Function GetEmployeeVacationUptoCurrentMonth(PeriodYear As Integer, EmployeeId As Integer, VacationTypeId As Integer, CurrentMont As Integer) As Integer
        Dim strcommand As String = "SELECT sum(consumdays) FROM hrs_EmployeesVacations WHERE EmployeeID = " & EmployeeId & " AND VacationTypeID = " & VacationTypeId &
