...
Public Class ClsEval_EvaluationCompaign
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " Eval_EvaluationCompaign "
        mInsertParameter = "" & _
          "Code," & _
          "EngName," & _
          "ArbName," & _
        ...
        mUpdateParameter = "" & _
          ...
          "EngName=@EngName," & _
          "ArbName=@ArbName," & _
          "CompaignType_ID=@CompaignType_ID," & _
          "DefaultEvalType=@DefaultEvalType," & _
          "SendEvaluator=@SendEvaluator," & _
          "SendEvaluated=@SendEvaluated," & _
          "CountType=@CountType," & _
          "IsOpen=@IsOpen," & _
          "Remarks=@Remarks"
...
#Region "Private Members"
    ...
    Private mCompaignType_ID As Integer
    Private mDefaultEvalType As Integer
    Private mSendEvaluator As Boolean
    Private mSendEvaluated As Boolean
    Private mCountType As String
...
#Region "Public property"
    ...
    Public Property ArbName() As String
        ...
        End Set
    End Property
    Public Property CompaignType_ID() As Integer
        Get
            Return mCompaignType_ID
        End Get
        Set(ByVal Value As Integer)
            mCompaignType_ID = Value
        End Set
    End Property
    Public Property DefaultEvalType() As Integer
        Get
            Return mDefaultEvalType
        End Get
        Set(ByVal Value As Integer)
            mDefaultEvalType = Value
        End Set
    End Property
    Public Property SendEvaluator() As Boolean
        Get
            Return mSendEvaluator
        End Get
        Set(ByVal Value As Boolean)
            mSendEvaluator = Value
        End Set
    End Property
    Public Property SendEvaluated() As Boolean
        Get
            Return mSendEvaluated
        End Get
        Set(ByVal Value As Boolean)
            mSendEvaluated = Value
        End Set
    End Property
...
#Region "Public Function"
    ...
    'Developer      :  DataOcean   
    'Date Created   :21/06/2011 16:20:53
    'Modifacations  :
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
    ...
    Public Function Clear() As Boolean
        Try
            ...
            mCompaignType_ID = 0
            mDefaultEvalType = 0
            mSendEvaluator = False
            mSendEvaluated = False
            mCountType = "Acu"
            mIsOpen = False
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mCompaignType_ID = mDataHandler.DataValue_Out(.Item("CompaignType_ID"), SqlDbType.Int, True)
                mDefaultEvalType = mDataHandler.DataValue_Out(.Item("DefaultEvalType"), SqlDbType.Int, True)
                mSendEvaluator = mDataHandler.DataValue_Out(.Item("SendEvaluator"), SqlDbType.Bit)
                mSendEvaluated = mDataHandler.DataValue_Out(.Item("SendEvaluated"), SqlDbType.Bit)
                mCountType = mDataHandler.DataValue_Out(.Item("CountType"), SqlDbType.VarChar)
                mIsOpen = mDataHandler.DataValue_Out(.Item("IsOpen"), SqlDbType.Bit)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@CompaignType_ID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mCompaignType_ID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@DefaultEvalType", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mDefaultEvalType, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@SendEvaluator", SqlDbType.Bit)).Value = mDataHandler.DataValue_In(mSendEvaluator, SqlDbType.Bit)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@SendEvaluated", SqlDbType.Bit)).Value = mDataHandler.DataValue_In(mSendEvaluated, SqlDbType.Bit)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@CountType", SqlDbType.VarChar)).Value = mDataHandler.DataValue_In(mCountType, SqlDbType.VarChar)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@IsOpen", SqlDbType.Bit)).Value = mDataHandler.DataValue_In(mIsOpen, SqlDbType.Bit)
