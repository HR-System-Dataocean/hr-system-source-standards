...
Public Class Clshrs_ProjectEmployeePenalities
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " hrs_ProjectEmployeePenalities "
        mInsertParameter = "" & _
          "TrnsDate," & _
          "EmployeeID," & _
          "PenalityID," & _
...
#Region "Private Members"
    ...
    Private mPenalityID As Integer
...
#Region "Public property"
    ...
    Public Property EmployeeID() As Integer
        ...
        End Set
    End Property
    Public Property PenalityID() As Integer
        Get
            Return mPenalityID
        End Get
        Set(ByVal Value As Integer)
...
#Region "Public Function"
    ...
    'Developer      :  DataOcean   
    'Date Created   :28/03/2015 12:29:18
    'Modifacations  :
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mPenalityID = [Shared].DataHandler.DataValue_Out(.Item("PenalityID"), SqlDbType.Int, True)
                mSwitch = [Shared].DataHandler.DataValue_Out(.Item("Switch"), SqlDbType.Int, True)
                mAmount = [Shared].DataHandler.DataValue_Out(.Item("Amount"), SqlDbType.Real)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@PenalityID", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mPenalityID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Switch", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mSwitch, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Amount", SqlDbType.Real)).Value = [Shared].DataHandler.DataValue_In(mAmount, SqlDbType.Real)
