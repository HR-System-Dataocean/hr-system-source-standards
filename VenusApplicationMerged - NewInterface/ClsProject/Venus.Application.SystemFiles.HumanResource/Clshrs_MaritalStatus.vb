...
'Developer         : [0257]
'Description       : 1-Implement Data Acess Layer of hrs_MaritalStatus table with fields code,English name,
'                       Arabic name
'                    2-Allow searching
...
Public Class Clshrs_MaritalStatus
...
#Region "Class Constructors"
    ...
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " hrs_MaritalStatus "
        mInsertParameter = " Code,EngName,ArbName,ArbName4S,Remarks,RegUserID,RegComputerID "
        mInsertParameterValues = " @Code,@EngName,@ArbName,@SearchArbName,@Remarks,@RegUserID,@RegComputerID "
        mUpdateParameter = " Code=@Code,EngName=@EngName,ArbName=@ArbName,ArbName4S=@SearchArbName,Remarks=@Remarks,RegUserID=@RegUserID,RegComputerID=@RegComputerID "
...
#Region "Public Function"
    ...
    'Modifacations  :
    'Calls          :
    'From           :(frmMaritalStatus.aspx.vb)TlbMainToolbar_ButtonClicked()
    '               :(frmMaritalStatus.aspx.vb)TlbMainNavigation_ButtonClicked()
    '               :(frmMaritalStatus.aspx.vb)GetValues()
    '               :(frmMaritalStatus.aspx.vb)SavePart()
    '               :(frmMaritalStatus.aspx.vb)SetToolbarSetting()
    '               :(frmMaritalStatus.aspx.vb)Setsetting()
    '               :(frmMaritalStatus.aspx.vb)CheckCode()
    'To             :GetParameter()
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
    ...
    Public Function SaveUpdate(ByVal Filter As String) As Boolean
        ...
        Try
            strSQL = "Select ID From hrs_MaritalStatus Where " & Filter
    ...
    'Modifacations  : 
    'Calls          :
    'From           :(frmMaritalStatus.aspx.vb)SavePart()
    'To             :SetParameter()
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
...
#Region "Navigation Functions"
    ...
    'Modifacations  : 
    'Calls          :
    'From           :(frmMaritalStatus.aspx.vb)TlbMainNavigation_ButtonClicked()
    'To             :GetParameter()
    '               :Clear()
    'fn. Arguments  :
    '---------------------------------------------------------
