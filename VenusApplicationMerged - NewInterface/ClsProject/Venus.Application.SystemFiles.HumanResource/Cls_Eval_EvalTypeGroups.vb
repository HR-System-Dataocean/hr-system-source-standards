...
Public Class ClsEval_EvalTypeGroups
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " Eval_EvalTypeGroups "
        mInsertParameter = "" & _
          "EvaltypeID," & _
          "Group_ID," & _
          "GPower," & _
...
#Region "Public property"
    ...
    Public Property Group_ID() As Integer
        ...
        End Set
    End Property
    Public Property GPower() As Integer
        Get
            Return mGPower
        End Get
        Set(ByVal Value As Integer)
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mGPower = mDataHandler.DataValue_Out(.Item("GPower"), SqlDbType.Int, True)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@GPower", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mGPower, SqlDbType.Int)
