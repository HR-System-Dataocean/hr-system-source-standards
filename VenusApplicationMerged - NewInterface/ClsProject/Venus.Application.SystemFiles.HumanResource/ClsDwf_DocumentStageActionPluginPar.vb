...
Public Class ClsDwf_DocumentStageActionPluginPar
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " Dwf_DocumentStageActionPluginPar "
        mInsertParameter = "" & _
          "ActionPluginID," & _
          "DocumentID," & _
          "StageCode," & _
        ...
        mInsertParameterValues = "" & _
          ...
          " @RegComputerID"
        mUpdateParameter = "" & _
          "ActionPluginID=@ActionPluginID," & _
          "DocumentID=@DocumentID," & _
          "StageCode=@StageCode," & _
          "ActionID=@ActionID," & _
          "EventPluginID=@EventPluginID," & _
          "EventPluginParameterID=@EventPluginParameterID," & _
          "ElementCode=@ElementCode," & _
          "Remarks=@Remarks"
...
#Region "Private Members"
    ...
    Private mActionPluginID As Integer
    Private mDocumentID As Integer
    Private mStageCode As String
    Private mActionID As Integer
    Private mEventPluginID As Integer
    Private mEventPluginParameterID As Integer
    Private mElementCode As String
...
#Region "Public property"
    Public Property ID() As Integer
        ...
        End Set
    End Property
    Public Property ActionPluginID() As Integer
        Get
            Return mActionPluginID
        End Get
        Set(ByVal Value As Integer)
            mActionPluginID = Value
        End Set
    End Property
    ...
    Public Property ActionID() As Integer
        ...
        End Set
    End Property
    Public Property EventPluginID() As Integer
        Get
            Return mEventPluginID
        End Get
        Set(ByVal Value As Integer)
            mEventPluginID = Value
        End Set
    End Property
    Public Property EventPluginParameterID() As Integer
        Get
            Return mEventPluginParameterID
        End Get
        Set(ByVal Value As Integer)
            mEventPluginParameterID = Value
        End Set
    End Property
...
#Region "Public Function"
    ...
    Public Function Clear() As Boolean
        Try
            ...
            mActionPluginID = 0
            mDocumentID = 0
            mStageCode = String.Empty
            mActionID = 0
            mEventPluginID = 0
            mEventPluginParameterID = 0
            mElementCode = String.Empty
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mActionPluginID = [Shared].DataHandler.DataValue_Out(.Item("ActionPluginID"), SqlDbType.Int, True)
                mDocumentID = [Shared].DataHandler.DataValue_Out(.Item("DocumentID"), SqlDbType.Int, True)
                mStageCode = [Shared].DataHandler.DataValue_Out(.Item("StageCode"), SqlDbType.VarChar)
                mActionID = [Shared].DataHandler.DataValue_Out(.Item("ActionID"), SqlDbType.Int, True)
                mEventPluginID = [Shared].DataHandler.DataValue_Out(.Item("EventPluginID"), SqlDbType.Int, True)
                mEventPluginParameterID = [Shared].DataHandler.DataValue_Out(.Item("EventPluginParameterID"), SqlDbType.Int, True)
                mElementCode = [Shared].DataHandler.DataValue_Out(.Item("ElementCode"), SqlDbType.VarChar)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@ActionPluginID", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mActionPluginID, SqlDbType.Int)
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@StageCode", SqlDbType.VarChar)).Value = [Shared].DataHandler.DataValue_In(mStageCode, SqlDbType.VarChar)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@ActionID", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mActionID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@EventPluginID", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mEventPluginID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@EventPluginParameterID", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mEventPluginParameterID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@ElementCode", SqlDbType.VarChar)).Value = [Shared].DataHandler.DataValue_In(mElementCode, SqlDbType.VarChar)
