...
Public Class Clshrs_SchEmpAddtionalInfo
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " hrs_SchEmpAddtionalInfo "
        mInsertParameter = "" &
                                                                                "EmployeeID," &
                                                                                "EducationalStageID," &
                                                                                "SpecializtionID," &
        ...
        mUpdateParameter = "" &
                                                                                ...
                                                                                "SpecializtionID=@SpecializtionID," &
                                                                                "EmpSubjectsID=@EmpSubjectsID," &
                                                                                "ClassesCount=@ClassesCount," &
                                                                                "AddtionalTasks=@AddtionalTasks," &
                                                                                "HomePhone=@HomePhone," &
                                                                                "Remarks=@Remarks"
...
#Region "Private Members"
    ...
    Private mEducationalStageID As Integer
    Private mSpecializtionID As Integer
    Private mEmpSubjectsID As Integer
    Private mClassesCount As Integer
    Private mAddtionalTasks As String
...
#Region "Public property"
    ...
    Public Property EmployeeID() As Integer
        ...
        End Set
    End Property
    Public Property EducationalStageID() As Integer
        Get
            Return mEducationalStageID
        End Get
        Set(ByVal Value As Integer)
            mEducationalStageID = Value
        End Set
    End Property
    Public Property SpecializtionID() As Integer
        Get
            Return mSpecializtionID
        End Get
        Set(ByVal Value As Integer)
            mSpecializtionID = Value
        End Set
    End Property
    Public Property EmpSubjectsID() As Integer
        Get
            Return mEmpSubjectsID
        End Get
        Set(ByVal Value As Integer)
            mEmpSubjectsID = Value
        End Set
    End Property
    Public Property ClassesCount() As Integer
        Get
        ...
        End Set
    End Property
    Public Property AddtionalTasks() As String
        Get
            Return mAddtionalTasks
        End Get
        Set(ByVal Value As String)
            mAddtionalTasks = Value
        End Set
    End Property
...
#Region "Public Function"
    ...
    Public Function Clear() As Boolean
        Try
            mID = 0
            mEmployeeID = 0
            mEducationalStageID = 0
            mSpecializtionID = 0
            mEmpSubjectsID = 0
            mClassesCount = 0
            mAddtionalTasks = String.Empty
            mHomePhone = String.Empty
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mEducationalStageID = [Shared].DataHandler.DataValue_Out(.Item("EducationalStageID"), SqlDbType.Int, True)
                mSpecializtionID = [Shared].DataHandler.DataValue_Out(.Item("SpecializtionID"), SqlDbType.Int, True)
                mEmpSubjectsID = [Shared].DataHandler.DataValue_Out(.Item("EmpSubjectsID"), SqlDbType.Int, True)
                mClassesCount = [Shared].DataHandler.DataValue_Out(.Item("ClassesCount"), SqlDbType.Int, True)
                mAddtionalTasks = [Shared].DataHandler.DataValue_Out(.Item("AddtionalTasks"), SqlDbType.VarChar)
                mHomePhone = [Shared].DataHandler.DataValue_Out(.Item("HomePhone"), SqlDbType.VarChar)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@EducationalStageID", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mEducationalStageID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@SpecializtionID", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mSpecializtionID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@EmpSubjectsID", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mEmpSubjectsID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@ClassesCount", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mClassesCount, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@AddtionalTasks", SqlDbType.VarChar)).Value = [Shared].DataHandler.DataValue_In(mAddtionalTasks, SqlDbType.VarChar)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@HomePhone", SqlDbType.VarChar)).Value = [Shared].DataHandler.DataValue_In(mHomePhone, SqlDbType.VarChar)
