...
Public Class ClsEval_EvalScales
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " Eval_EvalScales "
        mInsertParameter = "" & _
          "Code," & _
          "EvalTypeID," & _
          "EngName," & _
...
#Region "Private Members"
    ...
    Private mDFrom As Integer
    Private mDTo As Integer
...
#Region "Public property"
    ...
    Public Property ArbName() As String
        ...
        End Set
    End Property
    Public Property DFrom() As Integer
        Get
            Return mDFrom
        End Get
        Set(ByVal Value As Integer)
        ...
        End Set
    End Property
    Public Property DTo() As Integer
        Get
            Return mDTo
        End Get
        Set(ByVal Value As Integer)
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mDFrom = mDataHandler.DataValue_Out(.Item("DFrom"), SqlDbType.Int, True)
                mDTo = mDataHandler.DataValue_Out(.Item("DTo"), SqlDbType.Int, True)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@DFrom", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mDFrom, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@DTo", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mDTo, SqlDbType.Int)
