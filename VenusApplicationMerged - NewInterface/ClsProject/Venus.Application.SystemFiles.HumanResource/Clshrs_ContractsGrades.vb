...
Public Class Clshrs_ContractsGrades
    Inherits ClsDataAcessLayer

#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " hrs_ContractsArticlesGradeHistory "
        mInsertParameter = " ContractID,GradeStepID,EffectDate,Remarks,RegUserID,RegComputerID,CompanyID "
        mInsertParameterValues = " @ContractID,@GradeStepID,@EffectDate,@Remarks,@RegUserID,@RegComputerID,@CompanyID "
        mUpdateParameter = " ContractID=@ContractID,GradeStepID=@GradeStepID,EffectDate=@EffectDate,Remarks=@Remarks,RegUserID=@RegUserID,RegComputerID=@RegComputerID,CompanyID=@CompanyID "
...
#Region "Public Function"
    ...
    Public Function SaveUpdate(ByVal Filter As String) As Boolean
        ...
        Try
            strSQL = "Select ID From hrs_ContractsArticlesGradeHistory Where " & Filter
...
#Region "Class Private Function"
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        ...
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mGradeStepID = mDataHandler.DataValue_Out(.Item("GradeStepID"), SqlDbType.Int)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand) As Boolean
        ...
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@GradeStepID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mGradeStepID, SqlDbType.Int)
