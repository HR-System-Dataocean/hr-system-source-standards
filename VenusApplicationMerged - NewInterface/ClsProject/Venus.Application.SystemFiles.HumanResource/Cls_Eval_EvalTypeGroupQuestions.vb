...
Public Class ClsEval_EvalTypeGroupQuestions
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " Eval_EvalTypeGroupQuestions "
        mInsertParameter = "" & _
          "EvaltypeID," & _
          "Group_ID," & _
          "QuestionID," & _
...
#Region "Private Members"
    ...
    Private mEvaltypeID As Integer
...
#Region "Public property"
    Public Property ID() As Integer
        ...
        End Set
    End Property
    Public Property EvaltypeID() As Integer
        Get
            Return mEvaltypeID
        End Get
        Set(ByVal Value As Integer)
...
#Region "Public Function"
    ...
    'Developer      :  DataOcean   
    'Date Created   :01/05/2011 16:43:41
    'Modifacations  :
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mEvaltypeID = mDataHandler.DataValue_Out(.Item("EvaltypeID"), SqlDbType.Int, True)
                mGroup_ID = mDataHandler.DataValue_Out(.Item("Group_ID"), SqlDbType.Int, True)
                mQuestionID = mDataHandler.DataValue_Out(.Item("QuestionID"), SqlDbType.Int, True)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@EvaltypeID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mEvaltypeID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Group_ID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mGroup_ID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@QuestionID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mQuestionID, SqlDbType.Int)
