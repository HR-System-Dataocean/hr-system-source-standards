...
Public Class ClsRec_InterviewsDetail1
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " Rec_InterviewsDetail1 "
        mInsertParameter = "" & _
          "InterView_ID," & _
          "Applicant_ID," & _
          "GStartDate," & _
        ...
        mInsertParameterValues = "" & _
          ...
          " @RegComputerID"
        mUpdateParameter = "" & _
          "InterView_ID=@InterView_ID," & _
          "Applicant_ID=@Applicant_ID," & _
...
#Region "Private Members"
    ...
    Private mInterView_ID As Integer
    Private mApplicant_ID As Integer
    Private mGStartDate As DateTime
    Private mHStartDate As String
    Private mHoure As String
...
#Region "Public property"
    ...
    Public Property InterView_ID() As Integer
        Get
            Return mInterView_ID
        End Get
        Set(ByVal Value As Integer)
            mInterView_ID = Value
        End Set
    End Property
    Public Property Applicant_ID() As Integer
        Get
            Return mApplicant_ID
        End Get
        Set(ByVal Value As Integer)
            mApplicant_ID = Value
        End Set
    ...
    Public Property HStartDate() As String
        ...
        End Set
    End Property
    Public Property Houre() As String
        Get
            Return mHoure
        End Get
        Set(ByVal Value As String)
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mInterView_ID = mDataHandler.DataValue_Out(.Item("InterView_ID"), SqlDbType.Int, True)
                mApplicant_ID = mDataHandler.DataValue_Out(.Item("Applicant_ID"), SqlDbType.Int, True)
                ...
                mHoure = mDataHandler.DataValue_Out(.Item("Houre"), SqlDbType.VarChar)
                mIsSelected = mDataHandler.DataValue_Out(.Item("IsSelected"), SqlDbType.Bit)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@InterView_ID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mInterView_ID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Applicant_ID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mApplicant_ID, SqlDbType.Int)
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Houre", SqlDbType.VarChar)).Value = mDataHandler.DataValue_In(mHoure, SqlDbType.VarChar)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@IsSelected", SqlDbType.Bit)).Value = mDataHandler.DataValue_In(mIsSelected, SqlDbType.Bit)
