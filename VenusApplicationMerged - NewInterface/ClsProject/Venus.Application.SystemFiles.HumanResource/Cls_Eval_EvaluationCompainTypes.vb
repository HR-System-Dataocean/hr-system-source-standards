...
Public Class ClsEval_EvaluationCompainTypes
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " Eval_EvaluationCompainTypes "
        mInsertParameter = "" & _
          "Code," & _
          "EngName," & _
          "ArbName," & _
        ...
        mUpdateParameter = "" & _
          ...
          "EngName=@EngName," & _
          "ArbName=@ArbName," & _
          "DownLevel=@DownLevel," & _
          "UpLevel=@UpLevel," & _
          "SameLevel=@SameLevel," & _
          "IsRondome=@IsRondome," & _
          "IsOutSide=@IsOutSide," & _
          "Remarks=@Remarks"
...
#Region "Private Members"
    ...
    Private mDownLevel As Boolean
    Private mUpLevel As Boolean
    Private mSameLevel As Boolean
    Private mIsRondome As Boolean
    Private mIsOutSide As Boolean
...
#Region "Public property"
    ...
    Public Property ArbName() As String
        ...
        End Set
    End Property
    Public Property DownLevel() As Boolean
        Get
            Return mDownLevel
        End Get
        ...
        End Set
    End Property
    Public Property UpLevel() As Boolean
        Get
            Return mUpLevel
        End Get
        Set(ByVal Value As Boolean)
        ...
        End Set
    End Property
    Public Property SameLevel() As Boolean
        Get
            Return mSameLevel
        End Get
        Set(ByVal Value As Boolean)
        ...
        End Set
    End Property
    Public Property IsRondome() As Boolean
        Get
            Return mIsRondome
        End Get
        Set(ByVal Value As Boolean)
...
#Region "Public Function"
    ...
    'Developer      :  DataOcean   
    'Date Created   :15/07/1432 10:48:43 ص
    'Modifacations  :
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mDownLevel = mDataHandler.DataValue_Out(.Item("DownLevel"), SqlDbType.Bit)
                mUpLevel = mDataHandler.DataValue_Out(.Item("UpLevel"), SqlDbType.Bit)
                mSameLevel = mDataHandler.DataValue_Out(.Item("SameLevel"), SqlDbType.Bit)
                mIsRondome = mDataHandler.DataValue_Out(.Item("IsRondome"), SqlDbType.Bit)
                mIsOutSide = mDataHandler.DataValue_Out(.Item("IsOutSide"), SqlDbType.Bit)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@DownLevel", SqlDbType.Bit)).Value = mDataHandler.DataValue_In(mDownLevel, SqlDbType.Bit)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@UpLevel", SqlDbType.Bit)).Value = mDataHandler.DataValue_In(mUpLevel, SqlDbType.Bit)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@SameLevel", SqlDbType.Bit)).Value = mDataHandler.DataValue_In(mSameLevel, SqlDbType.Bit)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@IsRondome", SqlDbType.Bit)).Value = mDataHandler.DataValue_In(mIsRondome, SqlDbType.Bit)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@IsOutSide", SqlDbType.Bit)).Value = mDataHandler.DataValue_In(mIsOutSide, SqlDbType.Bit)
