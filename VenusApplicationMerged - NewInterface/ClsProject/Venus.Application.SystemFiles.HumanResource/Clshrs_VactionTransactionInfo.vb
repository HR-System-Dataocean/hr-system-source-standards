...
Public Class Clshrs_VactionTransactionInfo
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " hrs_VactionTransactionInfo "
        mInsertParameter = "" &
                                                                                "VacTrnsID," &
                                                                                "RequiredWorkingDays," &
                                                                                "Duration," &
...
#Region "Private Members"
    ...
    Private mVacTrnsID As Integer
    Private mRequiredWorkingDays As Integer
    Private mDuration As Integer
    Private mFromDate As Object
    Private mToDate As Object
    Private mTotalDays As Integer
    Private mDeductionDays As Integer
    Private mNetDays As Integer
    Private mVactionBalance As Decimal
...
#Region "Public property"
    Public Property ID() As Integer
        ...
        End Set
    End Property
    Public Property VacTrnsID() As Integer
        Get
            Return mVacTrnsID
        End Get
        Set(ByVal Value As Integer)
        ...
        End Set
    End Property
    Public Property RequiredWorkingDays() As Integer
        Get
            Return mRequiredWorkingDays
        End Get
        Set(ByVal Value As Integer)
            mRequiredWorkingDays = Value
        End Set
    End Property
    ...
    Public Property TotalDays() As Integer
        ...
        End Set
    End Property
    Public Property DeductionDays() As Integer
        Get
            Return mDeductionDays
        End Get
        Set(ByVal Value As Integer)
            mDeductionDays = Value
        End Set
    End Property
    Public Property NetDays() As Integer
        Get
            Return mNetDays
        End Get
        Set(ByVal Value As Integer)
        ...
        End Set
    End Property
    Public Property VactionBalance() As Decimal
        Get
            Return mVactionBalance
        End Get
        Set(ByVal Value As Decimal)
            mVactionBalance = Value
        End Set
    End Property
...
#Region "Public Function"
    ...
    'Developer      :  DataOcean   
    'Date Created   :16/03/2020 3:19:46 PM
    'Modifacations  :
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mVacTrnsID = [Shared].DataHandler.DataValue_Out(.Item("VacTrnsID"), SqlDbType.Int, True)
                mRequiredWorkingDays = [Shared].DataHandler.DataValue_Out(.Item("RequiredWorkingDays"), SqlDbType.Int, True)
                mDuration = [Shared].DataHandler.DataValue_Out(.Item("Duration"), SqlDbType.Int, True)
                mFromDate = [Shared].DataHandler.DataValue_Out(.Item("FromDate"), SqlDbType.DateTime, True)
                mToDate = [Shared].DataHandler.DataValue_Out(.Item("ToDate"), SqlDbType.DateTime, True)
                mTotalDays = [Shared].DataHandler.DataValue_Out(.Item("TotalDays"), SqlDbType.Int, True)
                mDeductionDays = [Shared].DataHandler.DataValue_Out(.Item("DeductionDays"), SqlDbType.Int, True)
                mNetDays = [Shared].DataHandler.DataValue_Out(.Item("NetDays"), SqlDbType.Int, True)
                mVactionBalance = [Shared].DataHandler.DataValue_Out(.Item("VactionBalance"), SqlDbType.Decimal)
                mAmount = [Shared].DataHandler.DataValue_Out(.Item("Amount"), SqlDbType.Decimal)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@VacTrnsID", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mVacTrnsID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@RequiredWorkingDays", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mRequiredWorkingDays, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Duration", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mDuration, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@FromDate", SqlDbType.DateTime)).Value = [Shared].DataHandler.DataValue_In(mFromDate, SqlDbType.DateTime)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@ToDate", SqlDbType.DateTime)).Value = [Shared].DataHandler.DataValue_In(mToDate, SqlDbType.DateTime)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@TotalDays", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mTotalDays, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@DeductionDays", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mDeductionDays, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@NetDays", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mNetDays, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@VactionBalance", SqlDbType.Decimal)).Value = [Shared].DataHandler.DataValue_In(mVactionBalance, SqlDbType.Decimal)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Amount", SqlDbType.Decimal)).Value = [Shared].DataHandler.DataValue_In(mAmount, SqlDbType.Decimal)
