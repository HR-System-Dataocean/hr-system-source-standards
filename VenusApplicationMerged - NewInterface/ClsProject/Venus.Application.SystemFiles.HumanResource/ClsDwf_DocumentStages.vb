...
Public Class ClsDwf_DocumentStages
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " Dwf_DocumentStages "
        mInsertParameter = "" & _
          "Code," & _
          "DocumentID," & _
          "ElementType," & _
        ...
        mUpdateParameter = "" & _
          ...
          "Loc_Left=@Loc_Left," & _
          "Rank=@Rank," & _
          "ArComment=@ArComment," & _
          "EnComment=@EnComment," & _
          "ConnectorIn=@ConnectorIn," & _
          "ConnectorOut=@ConnectorOut," & _
          "EscalationTime=@EscalationTime," & _
          "WaitForAll=@WaitForAll," & _
          "Remarks=@Remarks," & _
          "Comment=@Comment"
...
#Region "Private Members"
    ...
    Private mArComment As String
    Private mEnComment As String
    Private mConnectorIn As String
    Private mConnectorOut As String
    Private mEscalationTime As Integer
    Private mWaitForAll As Boolean
...
#Region "Public property"
    ...
    Public Property ArComment() As String
        ...
        End Set
    End Property
    Public Property EnComment() As String
        Get
            Return mEnComment
        End Get
        Set(ByVal Value As String)
        ...
        End Set
    End Property
    Public Property ConnectorIn() As String
        Get
            Return mConnectorIn
        End Get
        Set(ByVal Value As String)
        ...
        End Set
    End Property
    Public Property ConnectorOut() As String
        Get
            Return mConnectorOut
        End Get
        Set(ByVal Value As String)
            mConnectorOut = Value
        End Set
    End Property
    Public Property EscalationTime() As Integer
        Get
            Return mEscalationTime
        End Get
        Set(ByVal Value As Integer)
            mEscalationTime = Value
        End Set
    End Property
    Public Property WaitForAll() As Boolean
        Get
            Return mWaitForAll
        End Get
...
#Region "Public Function"
    ...
    Public Function Clear() As Boolean
        Try
            ...
            mRank = String.Empty
            mArComment = String.Empty
            mEnComment = String.Empty
            mConnectorIn = String.Empty
            mConnectorOut = String.Empty
            mEscalationTime = 0
            mWaitForAll = False
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mRank = [Shared].DataHandler.DataValue_Out(.Item("Rank"), SqlDbType.VarChar)
                mArComment = [Shared].DataHandler.DataValue_Out(.Item("ArComment"), SqlDbType.VarChar)
                mEnComment = [Shared].DataHandler.DataValue_Out(.Item("EnComment"), SqlDbType.VarChar)
                mConnectorIn = [Shared].DataHandler.DataValue_Out(.Item("ConnectorIn"), SqlDbType.VarChar)
                mConnectorOut = [Shared].DataHandler.DataValue_Out(.Item("ConnectorOut"), SqlDbType.VarChar)
                mEscalationTime = [Shared].DataHandler.DataValue_Out(.Item("EscalationTime"), SqlDbType.Int, True)
                mWaitForAll = [Shared].DataHandler.DataValue_Out(.Item("WaitForAll"), SqlDbType.Bit)
                ...
                mComment = [Shared].DataHandler.DataValue_Out(.Item("Comment"), SqlDbType.VarChar)
            End With
            Return True
        Catch ex As Exception
            mPage.Session.Add("ErrorValue", ex)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Rank", SqlDbType.VarChar)).Value = [Shared].DataHandler.DataValue_In(mRank, SqlDbType.VarChar)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@ArComment", SqlDbType.VarChar)).Value = [Shared].DataHandler.DataValue_In(mArComment, SqlDbType.VarChar)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@EnComment", SqlDbType.VarChar)).Value = [Shared].DataHandler.DataValue_In(mEnComment, SqlDbType.VarChar)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@ConnectorIn", SqlDbType.VarChar)).Value = [Shared].DataHandler.DataValue_In(mConnectorIn, SqlDbType.VarChar)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@ConnectorOut", SqlDbType.VarChar)).Value = [Shared].DataHandler.DataValue_In(mConnectorOut, SqlDbType.VarChar)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@EscalationTime", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mEscalationTime, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@WaitForAll", SqlDbType.Bit)).Value = [Shared].DataHandler.DataValue_In(mWaitForAll, SqlDbType.Bit)
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Comment", SqlDbType.VarChar)).Value = [Shared].DataHandler.DataValue_In(mComment, SqlDbType.VarChar)
