...
Public Class Clshrs_BranchStatus
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " hrs_BranchStatus "
        mInsertParameter = "" & _
          "FiscalYearID," & _
          "BranchID," & _
          "IsAttendancePrepared," & _
          "IsAttConfirmed," & _
          "IsBenfitsDeductionsPrepared," & _
          "IsBDConfirmed," & _
          "Remarks," & _
          "RegUserID," & _
          "RegComputerID"
        ...
        mUpdateParameter = "" & _
          ...
          "BranchID=@BranchID," & _
          "IsAttendancePrepared=@IsAttendancePrepared," & _
          "IsAttConfirmed=@IsAttConfirmed," & _
          "IsBenfitsDeductionsPrepared=@IsBenfitsDeductionsPrepared," & _
          "IsBDConfirmed=@IsBDConfirmed," & _
          "Remarks=@Remarks"
...
#Region "Private Members"
    ...
    Private mIsAttendancePrepared As Boolean
    Private mIsAttConfirmed As Boolean
    Private mIsBenfitsDeductionsPrepared As Boolean
    Private mIsBDConfirmed As Boolean
...
#Region "Public property"
    ...
    Public Property BranchID() As Integer
        ...
        End Set
    End Property
    Public Property IsAttendancePrepared() As Boolean
        Get
            Return mIsAttendancePrepared
        End Get
        Set(ByVal Value As Boolean)
            mIsAttendancePrepared = Value
        End Set
    End Property
    Public Property IsAttConfirmed() As Boolean
        Get
            Return mIsAttConfirmed
        End Get
        Set(ByVal Value As Boolean)
            mIsAttConfirmed = Value
        End Set
    End Property
    Public Property IsBenfitsDeductionsPrepared() As Boolean
        Get
            Return mIsBenfitsDeductionsPrepared
        End Get
        Set(ByVal Value As Boolean)
            mIsBenfitsDeductionsPrepared = Value
        End Set
    End Property
    Public Property IsBDConfirmed() As Boolean
        Get
            Return mIsBDConfirmed
        End Get
        Set(ByVal Value As Boolean)
            mIsBDConfirmed = Value
        End Set
    End Property
...
#Region "Public Function"
    ...
    'Developer      :  DataOcean   
    'Date Created   :4/18/2012 10:08:43 AM
    'Modifacations  :
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
    ...
    Public Function Clear() As Boolean
        Try
            ...
            mFiscalYearID = 0
            mBranchID = 0
            mIsAttendancePrepared = False
            mIsAttConfirmed = False
            mIsBenfitsDeductionsPrepared = False
            mIsBDConfirmed = False
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mIsAttendancePrepared = mDataHandler.DataValue_Out(.Item("IsAttendancePrepared"), SqlDbType.Bit)
                mIsAttConfirmed = mDataHandler.DataValue_Out(.Item("IsAttConfirmed"), SqlDbType.Bit)
                mIsBenfitsDeductionsPrepared = mDataHandler.DataValue_Out(.Item("IsBenfitsDeductionsPrepared"), SqlDbType.Bit)
                mIsBDConfirmed = mDataHandler.DataValue_Out(.Item("IsBDConfirmed"), SqlDbType.Bit)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@BranchID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mBranchID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@IsAttendancePrepared", SqlDbType.Bit)).Value = mDataHandler.DataValue_In(mIsAttendancePrepared, SqlDbType.Bit)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@IsAttConfirmed", SqlDbType.Bit)).Value = mDataHandler.DataValue_In(mIsAttConfirmed, SqlDbType.Bit)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@IsBenfitsDeductionsPrepared", SqlDbType.Bit)).Value = mDataHandler.DataValue_In(mIsBenfitsDeductionsPrepared, SqlDbType.Bit)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@IsBDConfirmed", SqlDbType.Bit)).Value = mDataHandler.DataValue_In(mIsBDConfirmed, SqlDbType.Bit)
