...
Public Class Clshrs_Att_AttendAppointmentMembers
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " Att_AttendAppointmentMembers "
        mInsertParameter = "" & _
                "AppointID," & _
                "EmployeeID," & _
                "Remarks," & _
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mAppointID = [Shared].DataHandler.DataValue_Out(.Item("AppointID"), SqlDbType.Int, True)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@AppointID", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mAppointID, SqlDbType.Int)
