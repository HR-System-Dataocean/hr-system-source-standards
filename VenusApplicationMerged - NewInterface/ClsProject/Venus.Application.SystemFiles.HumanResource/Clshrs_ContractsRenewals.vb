...
Public Class Clshrs_ContractsRenewals
    Inherits ClsDataAcessLayer

#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " hrs_ContractsRenewals "
        mInsertParameter = " ContractID,StartDate,EndDate,Remarks,RegUserID,RegComputerID,CompanyId "
        mInsertParameterValues = " @ContractID,@StartDate,@EndDate,@Remarks,@RegUserID,@RegComputerID,@CompanyId "
        mUpdateParameter = " ContractID=@ContractID,StartDate=@StartDate,EndDate=@EndDate,Remarks=@Remarks,RegUserID=@RegUserID,RegComputerID=@RegComputerID,CompanyId=@CompanyId "
...
#Region "Public Function"
    ...
    Public Function SaveUpdate(ByVal Filter As String) As Boolean
        ...
        Try
            strSQL = "Select ID From hrs_ContractsRenewals Where " & Filter
...
#Region "Class Private Function"
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        ...
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mContractID = mDataHandler.DataValue_Out(.Item("ContractID"), SqlDbType.Int)
                ...
                If clsCompanies.IsHigry Then
                    mStartDate = mDataHandler.DataValue_Out(ClsGHCalender.GetRelativeDate(.Item("StartDate"), Clssys_GHCalendar.DateType.Hijri, Clssys_GHCalendar.Directions.Output), SqlDbType.DateTime)
                    mEndDate = mDataHandler.DataValue_Out(ClsGHCalender.GetRelativeDate(.Item("EndDate"), Clssys_GHCalendar.DateType.Hijri, Clssys_GHCalendar.Directions.Output), SqlDbType.DateTime)
                Else
                    mStartDate = mDataHandler.DataValue_Out(ClsGHCalender.GetRelativeDate(.Item("StartDate"), Clssys_GHCalendar.DateType.Gregorian, Clssys_GHCalendar.Directions.Output), SqlDbType.DateTime)
                    mEndDate = mDataHandler.DataValue_Out(ClsGHCalender.GetRelativeDate(.Item("EndDate"), Clssys_GHCalendar.DateType.Gregorian, Clssys_GHCalendar.Directions.Output), SqlDbType.DateTime)
                End If
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand) As Boolean
        ...
        Dim ClsGHCalender As New Clssys_GHCalendar(mPage)
        Try
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@ContractID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mContractID, SqlDbType.Int)
            ...
            If clsCompanies.IsHigry Then
                Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@StartDate", SqlDbType.DateTime)).Value = mDataHandler.DataValue_In(ClsGHCalender.GetRelativeDate(mStartDate, Clssys_GHCalendar.DateType.Hijri, Clssys_GHCalendar.Directions.Input), SqlDbType.DateTime)
                Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@EndDate", SqlDbType.DateTime)).Value = mDataHandler.DataValue_In(ClsGHCalender.GetRelativeDate(mEndDate, Clssys_GHCalendar.DateType.Hijri, Clssys_GHCalendar.Directions.Input), SqlDbType.DateTime)
            Else
                Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@StartDate", SqlDbType.DateTime)).Value = mDataHandler.DataValue_In(ClsGHCalender.GetRelativeDate(mStartDate, Clssys_GHCalendar.DateType.Gregorian, Clssys_GHCalendar.Directions.Input), SqlDbType.DateTime)
                Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@EndDate", SqlDbType.DateTime)).Value = mDataHandler.DataValue_In(ClsGHCalender.GetRelativeDate(mEndDate, Clssys_GHCalendar.DateType.Gregorian, Clssys_GHCalendar.Directions.Input), SqlDbType.DateTime)
            End If
