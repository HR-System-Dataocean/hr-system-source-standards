...
Public Class ClsEval_EvaluationCompaignDetail2
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " Eval_EvaluationCompaignDetail2 "
        mInsertParameter = "" & _
          "EvalCompaign_ID," & _
          "Evaluator_ID," & _
          "CompaignType," & _
        ...
        mInsertParameterValues = "" & _
          ...
          " @RegComputerID"
        mUpdateParameter = "" & _
          "EvalCompaign_ID=@EvalCompaign_ID," & _
          "Evaluator_ID=@Evaluator_ID," & _
          "CompaignType=@CompaignType," & _
          "Evaluated_ID=@Evaluated_ID," & _
          "EngName=@EngName," & _
          "ArbName=@ArbName," & _
          "E_Mail=@E_Mail," & _
          "Garde=@Garde," & _
...
#Region "Private Members"
    ...
    Private mEvalCompaign_ID As Integer
    Private mEvaluator_ID As Integer
    Private mCompaignType As Integer
    Private mEvaluated_ID As Integer
    Private mEngName As String
    Private mArbName As String
    Private mE_Mail As String
    Private mGarde As Integer
    Private mEvaluation As Integer
...
#Region "Public property"
    Public Property ID() As Integer
        ...
        End Set
    End Property
    Public Property EvalCompaign_ID() As Integer
        Get
            Return mEvalCompaign_ID
        End Get
        Set(ByVal Value As Integer)
            mEvalCompaign_ID = Value
        End Set
    End Property
    Public Property Evaluator_ID() As Integer
        Get
            Return mEvaluator_ID
        End Get
        Set(ByVal Value As Integer)
            mEvaluator_ID = Value
        End Set
    End Property
    Public Property CompaignType() As Integer
        Get
        ...
        End Set
    End Property
    Public Property Evaluated_ID() As Integer
        Get
            Return mEvaluated_ID
        End Get
        Set(ByVal Value As Integer)
            mEvaluated_ID = Value
        End Set
    ...
    Public Property E_Mail() As String
        ...
        End Set
    End Property
    Public Property Garde() As Integer
        Get
            Return mGarde
        End Get
        Set(ByVal Value As Integer)
...
#Region "Public Function"
    ...
    'Developer      :  DataOcean   
    'Date Created   :22/06/2011 15:22:22
    'Modifacations  :
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mEvalCompaign_ID = mDataHandler.DataValue_Out(.Item("EvalCompaign_ID"), SqlDbType.Int, True)
                mEvaluator_ID = mDataHandler.DataValue_Out(.Item("Evaluator_ID"), SqlDbType.Int, True)
                mCompaignType = mDataHandler.DataValue_Out(.Item("CompaignType"), SqlDbType.Int, True)
                mEvaluated_ID = mDataHandler.DataValue_Out(.Item("Evaluated_ID"), SqlDbType.Int, True)
                ...
                mGarde = mDataHandler.DataValue_Out(.Item("Garde"), SqlDbType.Int, True)
                mEvaluation = mDataHandler.DataValue_Out(.Item("Evaluation"), SqlDbType.Int, True)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@EvalCompaign_ID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mEvalCompaign_ID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Evaluator_ID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mEvaluator_ID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@CompaignType", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mCompaignType, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Evaluated_ID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mEvaluated_ID, SqlDbType.Int)
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Garde", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mGarde, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Evaluation", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mEvaluation, SqlDbType.Int)
