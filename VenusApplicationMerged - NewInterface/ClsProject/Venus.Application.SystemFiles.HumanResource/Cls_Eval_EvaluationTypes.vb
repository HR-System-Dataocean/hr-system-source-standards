...
Public Class ClsEval_EvaluationTypes
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " Eval_EvaluationTypes "
        mInsertParameter = "" & _
          "Code," & _
          "EngName," & _
          "ArbName," & _
...
#Region "Private Members"
    ...
    Private mEPower As Integer
    Private mHasSlider As Boolean
...
#Region "Public property"
    ...
    Public Property ArbName() As String
        ...
        End Set
    End Property
    Public Property EPower() As Integer
        Get
            Return mEPower
        End Get
        Set(ByVal Value As Integer)
        ...
        End Set
    End Property
    Public Property HasSlider() As Boolean
        Get
            Return mHasSlider
        End Get
...
#Region "Public Function"
    ...
    'Developer      :  DataOcean   
    'Date Created   :06/06/2011 17:16:46
    'Modifacations  :
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mEPower = mDataHandler.DataValue_Out(.Item("EPower"), SqlDbType.Int, True)
                mHasSlider = mDataHandler.DataValue_Out(.Item("HasSlider"), SqlDbType.Bit)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@EPower", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mEPower, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@HasSlider", SqlDbType.Bit)).Value = mDataHandler.DataValue_In(mHasSlider, SqlDbType.Bit)
