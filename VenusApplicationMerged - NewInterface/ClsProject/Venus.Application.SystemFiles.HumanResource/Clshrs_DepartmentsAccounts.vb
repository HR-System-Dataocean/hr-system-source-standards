...
Public Class Clshrs_DepartmentsAccounts
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " hrs_DepartmentsAccounts "
        mInsertParameter = "" & _
        ...
        mUpdateParameter = "" & _
          ...
          "DepartmentCode=@DepartmentCode," & _
...
#Region "Public Function"
    ...
    Public Function Find(ByVal Filter As String) As Boolean
        ...
        Try
            ...
            mSelectCommand = "SELECT     ID, TransactionTypeCode, DepartmentCode AS Code , DebitAccount, CreditAccount, DebitCost, CreditCost, VchDesc, Descreption, AmountPercentage, ToAccountD, ToAccountC, ToCostCenter, DisPercentage FROM hrs_DepartmentsAccounts "
    ...
    Public Function FindBySP() As Boolean
        Dim StrSelectCommand As String
        Try
            StrSelectCommand = "exec hrs_GetDepartmentAccounts"
            mSqlDataAdapter = New SqlClient.SqlDataAdapter(StrSelectCommand, mConnectionString)
            mDataSet = New DataSet
            mSqlDataAdapter.Fill(mDataSet)
            If mDataHandler.CheckValidDataObject(mDataSet) Then
    ...
    Public Function Delete(ByVal Filter As String) As Boolean
        ...
        Try
            mDeleteCommand = "Delete from hrs_DepartmentsAccounts "
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mDepartmentCode = mDataHandler.DataValue_Out(.Item("Code"), SqlDbType.VarChar)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@DepartmentCode", SqlDbType.VarChar)).Value = mDataHandler.DataValue_In(mDepartmentCode, SqlDbType.VarChar)
