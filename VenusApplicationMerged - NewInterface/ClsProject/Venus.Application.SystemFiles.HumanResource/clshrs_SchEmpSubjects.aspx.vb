...
Public Class Clshrs_SchEmpSubjects
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " hrs_SchEmpSubjects "
        mInsertParameter = "" &
                                                                                "EmpID," &
                                                                                "SubjectsID," &
                                                                                "Remarks," &
...
#Region "Private Members"
    ...
    Private mSubjectsID As Integer
...
#Region "Public Function"
    ...
    'Developer      :  DataOcean   
    'Date Created   :20/11/2019 10:10:15 م
    'Modifacations  :
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mEmpID = [Shared].DataHandler.DataValue_Out(.Item("EmpID"), SqlDbType.Int, True)
                mSubjectsID = [Shared].DataHandler.DataValue_Out(.Item("SubjectsID"), SqlDbType.Int, True)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@EmpID", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mEmpID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@SubjectsID", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mSubjectsID, SqlDbType.Int)
