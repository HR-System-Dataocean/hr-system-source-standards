...
Public Class Clshrs_EvalutionDegreeBalance
...
#Region "Class Constructors"
    ...
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " hrs_EvalutionDegreeBalance "
        mInsertParameter = "  Code, EngName, ArbName, ArbName4S, DegreeFrom, DegreeTo,IsAbsolute, Remarks, RegUserID, RegComputerID"
        mInsertParameterValues = " @Code, @EngName, @ArbName, @ArbName4S, @DegreeFrom, @DegreeTo,@IsAbsolute, @Remarks, @RegUserID, @RegComputerID"
        mUpdateParameter = "Code=@Code,EngName=@EngName,ArbName=@ArbName,ArbName4S=@ArbName4S,DegreeFrom=@DegreeFrom,DegreeTo=@DegreeTo,IsAbsolute=@IsAbsolute,Remarks=@Remarks"
...
#Region "Private Members"
    ...
    Private mDegreeFrom As Integer
    Private mDegreeTo As Integer
...
#Region "Public property"
    ...
    Public Property ArbName4S() As String
        ...
        End Set
    End Property
    Public Property DegreeFrom() As Integer
        Get
            Return mDegreeFrom
        End Get
        Set(ByVal Value As Integer)
    ...
    Public Property IsAbsolute() As Boolean
        ...
        End Set
    End Property
    Public Property DegreeTo() As Integer
        Get
            Return mDegreeTo
        End Get
        Set(ByVal Value As Integer)
...
#Region "Public Function"
    ...
    'Developer      :  DataOcean   
    'Date Created   :2/17/2009 11:10:38 AM
    'Modifacations  :
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mDegreeFrom = mDataHandler.DataValue_Out(.Item("DegreeFrom"), SqlDbType.Int, True)
                mDegreeTo = mDataHandler.DataValue_Out(.Item("DegreeTo"), SqlDbType.Int, True)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@DegreeFrom", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mDegreeFrom, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@DegreeTo", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mDegreeTo, SqlDbType.Int)
