...
Public Class Clshrs_ProjectEmployeeTransfeer
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " hrs_ProjectEmployeeTransfeer "
        mInsertParameter = "" & _
          "TrnsDate," & _
          "RefNo," & _
          "ProjectID," & _
        ...
        mUpdateParameter = "" & _
          ...
          "NewProjectID=@NewProjectID," & _
          "NewLocationID=@NewLocationID," & _
          "NewAttendanceTableShiftsID=@NewAttendanceTableShiftsID," & _
...
#Region "Private Members"
    ...
    Private mNewProjectID As Integer
    Private mNewLocationID As Integer
    Private mNewAttendanceTableShiftsID As Integer
...
#Region "Public property"
    ...
    Public Property LocationID() As Integer
        ...
        End Set
    End Property
    Public Property NewProjectID() As Integer
        Get
            Return mNewProjectID
        End Get
        Set(ByVal Value As Integer)
            mNewProjectID = Value
        End Set
    ...
    Public Property NewLocationID() As Integer
        Get
            Return mNewLocationID
        End Get
        Set(ByVal Value As Integer)
            mNewLocationID = Value
        End Set
    End Property
    Public Property NewAttendanceTableShiftsID() As Integer
        Get
            Return mNewAttendanceTableShiftsID
        End Get
        Set(ByVal Value As Integer)
            mNewAttendanceTableShiftsID = Value
        End Set
    End Property
...
#Region "Public Function"
    ...
    'Developer      :  DataOcean   
    'Date Created   :08/01/2015 14:47:59
    'Modifacations  :
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mNewProjectID = [Shared].DataHandler.DataValue_Out(.Item("NewProjectID"), SqlDbType.Int, True)
                mNewLocationID = [Shared].DataHandler.DataValue_Out(.Item("NewLocationID"), SqlDbType.Int, True)
                mNewAttendanceTableShiftsID = [Shared].DataHandler.DataValue_Out(.Item("NewAttendanceTableShiftsID"), SqlDbType.Int, True)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@NewProjectID", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mNewProjectID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@NewLocationID", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mNewLocationID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@NewAttendanceTableShiftsID", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mNewAttendanceTableShiftsID, SqlDbType.Int)
