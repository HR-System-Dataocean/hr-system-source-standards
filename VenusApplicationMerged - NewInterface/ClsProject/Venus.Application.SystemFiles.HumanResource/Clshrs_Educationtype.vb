...
Public Class Clshrs_Educationtype
...
#Region "Class Constructors"
    ...
    Public Sub New(ByVal Page As Web.UI.Page, ByVal TableName As String)
        ...
        With Me
            .Table = TableName
            .mInsertParameter = " Code,EngName,ArbName,ArbName4S,Level,RequiredYears,Remarks,RegUserID,RegComputerID,CompanyID "
            .mInsertParameterValues = " @Code,@EngName,@ArbName,@ArbName4S,@Level,@RequiredYears,@Remarks,@RegUserID,@RegComputerID,@CompanyID "
            .mUpdateParameter = " Code=@Code,EngName=@EngName,ArbName=@ArbName,ArbName4S=@ArbName4S,Level=@Level,RequiredYears=@RequiredYears,Remarks=@Remarks "
...
#Region "Private Members"
    ...
    Private mRequiredYears As String
...
#Region "Public property"
    ...
    Public Property Level() As String
        ...
        End Set
    End Property
    Public Property RequiredYears() As String
        Get
            Return mRequiredYears
        End Get
        Set(ByVal value As String)
            mRequiredYears = value
        End Set
    End Property
...
#Region "Public Function"
    ...
    'Description: Find all columns from hrs_Educationtypes table where filter and canceldate = null  
    'Steps: 
    ...
    'Steps: 
    '       1-Execute sql statment to get ID from hrs_Educationtypes where filter 
    '       2-Check if ID > 0 this mean that row is already exist in hrs_Educationtypes  table 
    '       the make Update to this row
    '           IF ID =0 this mean that row is new row Then Insert the row in hrs_Educationtypes  table
    '==================================================================
    ...
    'Description: Save New Row in hrs_Educationtypes  table
    'Steps: 
    '       1-execute sqlstatment to insert new row in hrs_Educationtypes  table
    ...
    'Description: Update existing Row in hrs_Educationtypes  table where filter
    'Steps: 
    '       1-execute sqlstatment to Update existing row in hrs_Educationtypes  table
    ...
    'Date : 24/6/2007
    'Inptu : Filter as string (ex.ID=2)
    'Description: Delete existing Row in hrs_Educationtypes  table where filter
    'Steps: 
    '       1-execute sqlstatment to Delete existing row in hrs_Educationtypes  table
    ...
    'Steps: 
    '       1-execute sqlstatment to find first row in hrs_Educationtypes  table
    ...
    'Created by : [0258]
    'Date : 24/6/2007
    'Description:  find Last row in hrs_Educationtypes  table
    'Steps: 
    '       1-execute sqlstatment to find last row in hrs_Educationtypes  table
    '       2-Fill dataset with result of sqlstatment
    '       3-call Getparameter function to insert the result of dataset into private members of the class
    '==================================================================
    ...
    'Created by : [0258]
    'Date : 24/6/2007
    'Description:  find Next row in hrs_Educationtypes  table
    'Steps: 
    '       1-execute sqlstatment to find Next row in hrs_Educationtypes  table
    '       2-Fill dataset with result of sqlstatment
    '       3-call Getparameter function to insert the result of dataset into private members of the class
    '==================================================================
    ...
    'Created by : [0258]
    'Date : 24/6/2007
    'Description:  find previous row in hrs_Educationtypes  table
    'Steps: 
    '       1-execute sqlstatment to find previous row in hrs_Educationtypes  table
    '       2-Fill dataset with result of sqlstatment
    '       3-call Getparameter function to insert the result of dataset into private members of the class
    '==================================================================
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mLevel = mDataHandler.DataValue_Out(.Item("Level"), SqlDbType.Int)
                mRequiredYears = mDataHandler.DataValue_Out(.Item("RequiredYears"), SqlDbType.VarChar)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal ptrOperationType As OperationType) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Level", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mLevel, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@RequiredYears", SqlDbType.Real)).Value = mDataHandler.DataValue_In(mRequiredYears, SqlDbType.Real)
