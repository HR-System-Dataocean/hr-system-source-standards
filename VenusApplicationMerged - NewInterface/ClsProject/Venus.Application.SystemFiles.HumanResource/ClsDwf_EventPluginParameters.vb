...
Public Class ClsDwf_EventPluginParameters
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " Dwf_EventPluginParameters "
        mInsertParameter = "" & _
          "PluginID," & _
          "Code," & _
          "EngName," & _
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mPluginID = [Shared].DataHandler.DataValue_Out(.Item("PluginID"), SqlDbType.Int, True)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@PluginID", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mPluginID, SqlDbType.Int)
