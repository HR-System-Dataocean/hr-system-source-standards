...
Public Class Clshrs_AppraisalTypes
    Inherits ClsDataAcessLayer

    Public Sub New(page As Web.UI.Page)
        MyBase.New(page)
        mTable = " App_AppraisalTypes "
        mInsertParameter = " Code,EngName,ArbName,IsOneTimeOnly,OneTimePeriod,AppraisalFrequency,NotificationPeriod,escalationMail,escalationPeriod,MinimumImprovementPerc,KPIsWeight,AppraisalTypeGroupID,RegUserID,RegDate"
        mInsertParameterValues = " @Code,@EngName,@ArbName,@IsOneTimeOnly,@OneTimePeriod,@AppraisalFrequency,@NotificationPeriod,@escalationMail,@escalationPeriod,@MinimumImprovementPerc,@KPIsWeight,@AppraisalTypeGroupID,@RegUserID,@RegDate"
        mUpdateParameter = " Code=@Code,EngName=@EngName,ArbName=@ArbName,IsOneTimeOnly=@IsOneTimeOnly,OneTimePeriod=@OneTimePeriod,AppraisalFrequency=@AppraisalFrequency,NotificationPeriod=@NotificationPeriod,escalationMail=@escalationMail,escalationPeriod=@escalationPeriod,MinimumImprovementPerc=@MinimumImprovementPerc,KPIsWeigh=@KPIsWeight,AppraisalTypeGroupID=@AppraisalTypeGroupID"
...
#Region "Private Members"
    ...
    Private mIsOneTimeOnly As Boolean
    Private mOneTimePeriod As String
    Private mAppraisalFrequency As String
    Private mNotificationPeriod As String
    Private mEscalationMail As String
    Private mEscalationPeriod As String
    Private mMinimumImprovementPerc As String
    Private mKPIsWeight As String
    Private mAppraisalTypeGroupID As String
...
#Region "Public property"
    ...
    Public Property ArbName() As String
        ...
        End Set
    End Property
    Public Property IsOneTimeOnly() As Boolean
        Get
            Return mIsOneTimeOnly
        End Get
        Set(ByVal Value As Boolean)
            mIsOneTimeOnly = Value
        End Set
    End Property

    Public Property OneTimePeriod() As String
        Get
            Return mOneTimePeriod
        End Get
        Set(ByVal Value As String)
            mOneTimePeriod = Value
        End Set
    End Property
    Public Property AppraisalFrequency() As String
        Get
            Return mAppraisalFrequency
        End Get
        Set(ByVal Value As String)
            mAppraisalFrequency = Value
        End Set
    End Property
    Public Property NotificationPeriod() As String
        Get
            Return mNotificationPeriod
        End Get
        Set(ByVal Value As String)
            mNotificationPeriod = Value
        End Set
    End Property
    Public Property EscalationMail() As String
        Get
            Return mEscalationMail
        End Get
        Set(ByVal Value As String)
            mEscalationMail = Value
        End Set
    End Property
    Public Property EscalationPeriod() As String
        Get
            Return mEscalationPeriod
        End Get
        Set(ByVal Value As String)
            mEscalationPeriod = Value
        End Set
    End Property

    Public Property MinimumImprovementPerc() As String
        Get
            Return mMinimumImprovementPerc
        End Get
        Set(ByVal Value As String)
            mMinimumImprovementPerc = Value
        End Set
    End Property
    Public Property KPIsWeight() As String
        Get
            Return mKPIsWeight
        End Get
        Set(ByVal Value As String)
        ...
        End Set
    End Property
    Public Property AppraisalTypeGroupID() As String
        Get
...
#Region "Public Function"
    ...
    'Modifacations  :
    'Calls          :
    'From           :(frmProfession.aspx.vb)TlbMainToolbar_ButtonClicked()
    '               :(frmProfession.aspx.vb)TlbMainNavigation_ButtonClicked()
    '               :(frmProfession.aspx.vb)GetValues()
    '               :(frmProfession.aspx.vb)SavePart()
    '               :(frmProfession.aspx.vb)SetToolbarSetting()
    '               :(frmProfession.aspx.vb)Setsetting()
    '               :(frmProfession.aspx.vb)CheckCode()
    'To             :GetParameter()
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
    ...
    Public Function SaveUpdate(ByVal Filter As String) As Boolean
        ...
        Try
            strSQL = "Select ID From App_AppraisalTypes Where " & Filter
    ...
    'Modifacations  : 
    'Calls          :
    'From           :(frmProfession.aspx.vb)SavePart()
    'To             :SetParameter()
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
    ...
    Public Function Clear() As Boolean
        Try
            ...
            mIsOneTimeOnly = False
            mOneTimePeriod = String.Empty
            mAppraisalFrequency = String.Empty
            mNotificationPeriod = String.Empty
            mEscalationMail = String.Empty
            mEscalationPeriod = String.Empty
            mMinimumImprovementPerc = String.Empty
            mKPIsWeight = String.Empty
            mAppraisalTypeGroupID = String.Empty
...
#Region "Navigation Functions"
    ...
    'Modifacations  : 
    'Calls          :
    'From           :(frmProfession.aspx.vb)TlbMainNavigation_ButtonClicked()
    'To             :GetParameter()
    '               :Clear()
    'fn. Arguments  :
    '---------------------------------------------------------
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mIsOneTimeOnly = mDataHandler.DataValue_Out(.Item("IsOneTimeOnly"), SqlDbType.Bit)
                mOneTimePeriod = mDataHandler.DataValue_Out(.Item("OneTimePeriod"), SqlDbType.VarChar)
                mAppraisalFrequency = mDataHandler.DataValue_Out(.Item("AppraisalFrequency"), SqlDbType.VarChar)
                mNotificationPeriod = mDataHandler.DataValue_Out(.Item("NotificationPeriod"), SqlDbType.VarChar)
                mEscalationMail = mDataHandler.DataValue_Out(.Item("escalationMail"), SqlDbType.VarChar)
                mEscalationPeriod = mDataHandler.DataValue_Out(.Item("escalationPeriod"), SqlDbType.VarChar)
                mMinimumImprovementPerc = mDataHandler.DataValue_Out(.Item("MinimumImprovementPerc"), SqlDbType.VarChar)
                mKPIsWeight = mDataHandler.DataValue_Out(.Item("KPIsWeight"), SqlDbType.VarChar)
                mAppraisalTypeGroupID = mDataHandler.DataValue_Out(.Item("AppraisalTypeGroupID"), SqlDbType.VarChar)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@IsOneTimeOnly", SqlDbType.Bit)).Value = mDataHandler.DataValue_In(mIsOneTimeOnly, SqlDbType.Bit)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@OneTimePeriod", SqlDbType.VarChar)).Value = mDataHandler.DataValue_In(mOneTimePeriod, SqlDbType.VarChar)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@AppraisalFrequency", SqlDbType.VarChar)).Value = mDataHandler.DataValue_In(mAppraisalFrequency, SqlDbType.VarChar)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@NotificationPeriod", SqlDbType.VarChar)).Value = mDataHandler.DataValue_In(mNotificationPeriod, SqlDbType.VarChar)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@escalationMail", SqlDbType.VarChar)).Value = mDataHandler.DataValue_In(mEscalationMail, SqlDbType.VarChar)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@escalationPeriod", SqlDbType.VarChar)).Value = mDataHandler.DataValue_In(mEscalationPeriod, SqlDbType.VarChar)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@MinimumImprovementPerc", SqlDbType.VarChar)).Value = mDataHandler.DataValue_In(mMinimumImprovementPerc, SqlDbType.VarChar)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@KPIsWeight", SqlDbType.VarChar)).Value = mDataHandler.DataValue_In(mKPIsWeight, SqlDbType.VarChar)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@AppraisalTypeGroupID", SqlDbType.VarChar)).Value = mDataHandler.DataValue_In(mAppraisalTypeGroupID, SqlDbType.VarChar)
