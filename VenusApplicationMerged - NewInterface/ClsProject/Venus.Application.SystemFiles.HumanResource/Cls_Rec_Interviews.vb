...
Public Class ClsRec_Interviews
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " Rec_Interviews "
        mInsertParameter = "" & _
          "Code," & _
          "EngName," & _
          "ArbName," & _
        ...
        mUpdateParameter = "" & _
          ...
          "EngName=@EngName," & _
          "ArbName=@ArbName," & _
          "OpenVacancy_ID=@OpenVacancy_ID," & _
          "DefaultEvalType=@DefaultEvalType," & _
          "SendInterviwer=@SendInterviwer," & _
          "SendApplicant=@SendApplicant," & _
          "IsOpen=@IsOpen," & _
          "Remarks=@Remarks"
...
#Region "Private Members"
    ...
    Private mOpenVacancy_ID As Integer?
    Private mDefaultEvalType As Integer?
    Private mSendInterviwer As Boolean
    Private mSendApplicant As Boolean
...
#Region "Public property"
    ...
    Public Property ArbName() As String
        ...
        End Set
    End Property
    Public Property OpenVacancy_ID() As Integer?
        Get
            Return mOpenVacancy_ID
        End Get
        Set(ByVal Value As Integer?)
            mOpenVacancy_ID = Value
        End Set
    End Property
    Public Property DefaultEvalType() As Integer?
        ...
        End Set
    End Property
    Public Property SendInterviwer() As Boolean
        Get
            Return mSendInterviwer
        End Get
        Set(ByVal Value As Boolean)
            mSendInterviwer = Value
        End Set
    End Property
    Public Property SendApplicant() As Boolean
        Get
            Return mSendApplicant
        End Get
        Set(ByVal Value As Boolean)
            mSendApplicant = Value
        End Set
    End Property
...
#Region "Public Function"
    ...
    Public Function Clear() As Boolean
        Try
            ...
            mOpenVacancy_ID = 0
            mDefaultEvalType = 0
            mSendInterviwer = False
            mSendApplicant = False
            mIsOpen = False
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mOpenVacancy_ID = mDataHandler.DataValue_Out(.Item("OpenVacancy_ID"), SqlDbType.Int, True)
                mDefaultEvalType = mDataHandler.DataValue_Out(.Item("DefaultEvalType"), SqlDbType.Int, True)
                mSendInterviwer = mDataHandler.DataValue_Out(.Item("SendInterviwer"), SqlDbType.Bit)
                mSendApplicant = mDataHandler.DataValue_Out(.Item("SendApplicant"), SqlDbType.Bit)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@OpenVacancy_ID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mOpenVacancy_ID, SqlDbType.Int)
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@SendInterviwer", SqlDbType.Bit)).Value = mDataHandler.DataValue_In(mSendInterviwer, SqlDbType.Bit)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@SendApplicant", SqlDbType.Bit)).Value = mDataHandler.DataValue_In(mSendApplicant, SqlDbType.Bit)
