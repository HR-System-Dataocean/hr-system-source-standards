...
Public Class ClsDwf_ListItems
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " Dwf_ListItems "
        mInsertParameter = "" & _
          "Code," & _
          "EngName," & _
          "ArbName," & _
        ...
        mUpdateParameter = "" & _
          ...
          "ValueMember=@ValueMember," & _
          "Ar_DisplayMember=@Ar_DisplayMember," & _
          "En_DisplayMember=@En_DisplayMember," & _
          "Remarks=@Remarks"
...
#Region "Private Members"
    ...
    Private mAr_DisplayMember As String
    Private mEn_DisplayMember As String
...
#Region "Public property"
    ...
    Public Property ValueMember() As String
        ...
        End Set
    End Property
    Public Property Ar_DisplayMember() As String
        Get
            Return mAr_DisplayMember
        End Get
        Set(ByVal Value As String)
            mAr_DisplayMember = Value
        End Set
    End Property
    Public Property En_DisplayMember() As String
        Get
            Return mEn_DisplayMember
        End Get
        Set(ByVal Value As String)
            mEn_DisplayMember = Value
        End Set
    End Property
...
#Region "Public Function"
    ...
    Public Function Clear() As Boolean
        Try
            ...
            mValueMember = String.Empty
            mAr_DisplayMember = String.Empty
            mEn_DisplayMember = String.Empty
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mValueMember = [Shared].DataHandler.DataValue_Out(.Item("ValueMember"), SqlDbType.VarChar)
                mAr_DisplayMember = [Shared].DataHandler.DataValue_Out(.Item("Ar_DisplayMember"), SqlDbType.VarChar)
                mEn_DisplayMember = [Shared].DataHandler.DataValue_Out(.Item("En_DisplayMember"), SqlDbType.VarChar)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@DataSource", SqlDbType.VarChar)).Value = [Shared].DataHandler.DataValue_In(mDataSource, SqlDbType.VarChar)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@ValueMember", SqlDbType.VarChar)).Value = [Shared].DataHandler.DataValue_In(mValueMember, SqlDbType.VarChar)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Ar_DisplayMember", SqlDbType.VarChar)).Value = [Shared].DataHandler.DataValue_In(mAr_DisplayMember, SqlDbType.VarChar)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@En_DisplayMember", SqlDbType.VarChar)).Value = [Shared].DataHandler.DataValue_In(mEn_DisplayMember, SqlDbType.VarChar)
