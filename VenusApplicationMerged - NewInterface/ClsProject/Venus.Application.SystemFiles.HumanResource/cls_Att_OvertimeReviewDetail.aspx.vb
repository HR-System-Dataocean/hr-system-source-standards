...
Public Class ClsAtt_OvertimeReviewDetail
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " Att_OvertimeReviewDetail "
        mInsertParameter = "" & _
          "OvertimeReviewID," & _
          "EmployeeID," & _
          "TransDate," & _
        ...
        mInsertParameterValues = "" & _
          ...
          " @RegComputerID"
        mUpdateParameter = "" & _
          "OvertimeReviewID=@OvertimeReviewID," & _
          "EmployeeID=@EmployeeID," & _
          "TransDate=@TransDate," & _
          "TransToDate=@TransToDate," & _
          "Overtime=@Overtime," & _
          "Remarks=@Remarks"
...
#Region "Private Members"
    ...
    Private mOvertimeReviewID As Integer
    Private mEmployeeID As Integer
    Private mTransDate As DateTime
    Private mTransToDate As DateTime
...
#Region "Public property"
    Public Property ID() As Integer
        ...
        End Set
    End Property
    Public Property OvertimeReviewID() As Integer
        Get
            Return mOvertimeReviewID
        End Get
        Set(ByVal Value As Integer)
            mOvertimeReviewID = Value
        End Set
    End Property
    ...
    Public Property TransDate() As DateTime
        ...
        End Set
    End Property
    Public Property TransToDate() As DateTime
        Get
            Return mTransToDate
        End Get
        Set(ByVal Value As DateTime)
...
#Region "Public Function"
    ...
    'Developer      :  DataOcean   
    'Date Created   :08/08/2016 12:53:33 PM
    'Modifacations  :
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mOvertimeReviewID = [Shared].DataHandler.DataValue_Out(.Item("OvertimeReviewID"), SqlDbType.Int, True)
                mEmployeeID = [Shared].DataHandler.DataValue_Out(.Item("EmployeeID"), SqlDbType.Int, True)
                mTransDate = [Shared].DataHandler.DataValue_Out(.Item("TransDate"), SqlDbType.DateTime)
                mTransToDate = [Shared].DataHandler.DataValue_Out(.Item("TransToDate"), SqlDbType.DateTime)
                mOvertime = [Shared].DataHandler.DataValue_Out(.Item("Overtime"), SqlDbType.Money)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@OvertimeReviewID", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mOvertimeReviewID, SqlDbType.Int)
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@TransDate", SqlDbType.DateTime)).Value = [Shared].DataHandler.DataValue_In(mTransDate, SqlDbType.DateTime)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@TransToDate", SqlDbType.DateTime)).Value = [Shared].DataHandler.DataValue_In(mTransToDate, SqlDbType.DateTime)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Overtime", SqlDbType.Money)).Value = [Shared].DataHandler.DataValue_In(mOvertime, SqlDbType.Money)
