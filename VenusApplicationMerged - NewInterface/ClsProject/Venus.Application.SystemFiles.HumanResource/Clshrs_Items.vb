...
'Developer         : [0257]
'Description       : 1-Implement Data Acess Layer of hrs_Items table with fields code,English name,
'                       Arabic name,Purchase date,Purchase price,Expiry date and License number
'                    2-Allow searching
...
#Region "Class Constructors"
    ...
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " hrs_Items "
        mInsertParameter = " Code,EngName,ArbName,ArbName4S,PurchaseDate,PurchasePrice,ExpiryDate,LicenseNumber,Remarks,RegUserID,RegComputerID,CompanyId,IsFromAssets "
        mInsertParameterValues = " @Code,@EngName,@ArbName,@SearchArbName,@PurchaseDate,@PurchasePrice,@ExpiryDate,@LicenseNumber,@Remarks,@RegUserID,@RegComputerID,@CompanyId,@IsFromAssets "
        mUpdateParameter = " Code=@Code,EngName=@EngName,ArbName=@ArbName,ArbName4S=@SearchArbName,PurchaseDate=@PurchaseDate,PurchasePrice=@PurchasePrice,ExpiryDate=@ExpiryDate,LicenseNumber=@LicenseNumber,Remarks=@Remarks,RegUserID=@RegUserID,RegComputerID=@RegComputerID,CompanyId=@CompanyId,IsFromAssets=@IsFromAssets "
...
#Region "Private Members"
    ...
    Private mPurchaseDate As Object
    Private mPurchasePrice As Object
    Private mExpiryDate As Object
    Private mLicenseNumber As String
...
#Region "Public property"
    ...
    Public Property SearchArbName() As String
        ...
        End Set
    End Property
    Public Property PurchaseDate() As Object
        Get
        ...
        End Set
    End Property
    Public Property PurchasePrice() As Object
        Get
            Return mPurchasePrice
        End Get
        Set(ByVal Value As Object)
            mPurchasePrice = Value
        End Set
    End Property
...
#Region "Public Function"
    ...
    'Modifacations  :
    'Calls          :
    'From           :(frmItems.aspx.vb)TlbMainToolbar_ButtonClicked()
    '               :(frmItems.aspx.vb)TlbMainNavigation_ButtonClicked()
    '               :(frmItems.aspx.vb)GetValues()
    '               :(frmItems.aspx.vb)SavePart()
    '               :(frmItems.aspx.vb)SetToolbarSetting()
    '               :(frmItems.aspx.vb)Setsetting()
    '               :(frmItems.aspx.vb)CheckCode()
    'To             :GetParameter()
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
    ...
    Public Function SaveUpdate(ByVal Filter As String) As Boolean
        ...
        Try
            strSQL = "Select ID From hrs_Items Where " & Filter
    ...
    'Modifacations  : 
    'Calls          :
    'From           :(frmItems.aspx.vb)SavePart()
    'To             :SetParameter()
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
...
#Region "Navigation Functions"
    ...
    'Modifacations  : 
    'Calls          :
    'From           :(frmItems.aspx.vb)TlbMainNavigation_ButtonClicked()
    'To             :GetParameter()
    '               :Clear()
    'fn. Arguments  :
    '---------------------------------------------------------
...
#End Region
    ...
    Public Function Clear() As Boolean
        Try
            ...
            mPurchaseDate = Nothing
            mPurchasePrice = 0.0
            mExpiryDate = Nothing
            mIsFromAssets = False
            mLicenseNumber = String.Empty
    ...
    Public Function GetListItemCode(ByRef DdlValues As Infragistics.WebUI.UltraWebGrid.ValueList) As Boolean
        ...
        Try
            ...
            For Each ObjDataRow In ObjDataset.Tables(0).Rows
                Item = New Infragistics.WebUI.UltraWebGrid.ValueListItem
                Item.DisplayText = mDataHandler.DataValue(ObjDataRow("Code"), SqlDbType.VarChar)
                Item.DataValue = ObjDataRow("ID")
                DdlValues.ValueListItems.Add(Item)
            Next
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        ...
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mPurchaseDate = mDataHandler.DataValue_Out(.Item("PurchaseDate"), SqlDbType.DateTime)
                mPurchasePrice = mDataHandler.DataValue_Out(.Item("PurchasePrice"), SqlDbType.Real)
                mExpiryDate = mDataHandler.DataValue_Out(.Item("ExpiryDate"), SqlDbType.DateTime)
                mLicenseNumber = mDataHandler.DataValue_Out(.Item("LicenseNumber"), SqlDbType.VarChar)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@PurchaseDate", SqlDbType.DateTime)).Value = mDataHandler.DataValue_In(mPurchaseDate, SqlDbType.DateTime)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@PurchasePrice", SqlDbType.Real)).Value = mDataHandler.DataValue_In(mPurchasePrice, SqlDbType.Real)
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@LicenseNumber", SqlDbType.VarChar)).Value = mDataHandler.DataValue_In(mLicenseNumber, SqlDbType.VarChar)
