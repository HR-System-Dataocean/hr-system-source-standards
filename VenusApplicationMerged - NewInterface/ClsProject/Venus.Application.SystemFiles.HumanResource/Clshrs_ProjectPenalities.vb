...
Public Class Clshrs_ProjectPenalities
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " hrs_ProjectPenalities "
        mInsertParameter = "" & _
          "ProjectChangeID," & _
          "PenaltyID," & _
          "Occurance," & _
        ...
        mUpdateParameter = "" & _
          ...
          "PenaltyID=@PenaltyID," & _
          "Occurance=@Occurance," & _
          "ExternalValue=@ExternalValue," & _
          "ExternalFactor=@ExternalFactor," & _
          "InternalValue=@InternalValue," & _
          "InternalFactor=@InternalFactor," & _
          "Remarks=@Remarks"
...
#Region "Private Members"
    ...
    Private mPenaltyID As Integer
    Private mOccurance As Integer
    Private mExternalValue As Decimal
    Private mExternalFactor As Integer
    Private mInternalValue As Decimal
    Private mInternalFactor As Integer
...
#Region "Public property"
    ...
    Public Property Occurance() As Integer
        ...
        End Set
    End Property
    Public Property ExternalValue() As Decimal
        Get
        ...
        End Set
    End Property
    Public Property ExternalFactor() As Integer
        Get
            Return mExternalFactor
        End Get
        Set(ByVal Value As Integer)
            mExternalFactor = Value
        End Set
    End Property
    Public Property InternalValue() As Decimal
        Get
        ...
        End Set
    End Property
    Public Property InternalFactor() As Integer
        Get
            Return mInternalFactor
        End Get
        Set(ByVal Value As Integer)
            mInternalFactor = Value
        End Set
    End Property
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mPenaltyID = [Shared].DataHandler.DataValue_Out(.Item("PenaltyID"), SqlDbType.Int, True)
                mOccurance = [Shared].DataHandler.DataValue_Out(.Item("Occurance"), SqlDbType.Int, True)
                mExternalValue = [Shared].DataHandler.DataValue_Out(.Item("ExternalValue"), SqlDbType.Decimal)
                mExternalFactor = [Shared].DataHandler.DataValue_Out(.Item("ExternalFactor"), SqlDbType.Int, True)
                mInternalValue = [Shared].DataHandler.DataValue_Out(.Item("InternalValue"), SqlDbType.Decimal)
                mInternalFactor = [Shared].DataHandler.DataValue_Out(.Item("InternalFactor"), SqlDbType.Int, True)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@PenaltyID", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mPenaltyID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Occurance", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mOccurance, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@ExternalValue", SqlDbType.Decimal)).Value = [Shared].DataHandler.DataValue_In(mExternalValue, SqlDbType.Decimal)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@ExternalFactor", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mExternalFactor, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@InternalValue", SqlDbType.Decimal)).Value = [Shared].DataHandler.DataValue_In(mInternalValue, SqlDbType.Decimal)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@InternalFactor", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mInternalFactor, SqlDbType.Int)
