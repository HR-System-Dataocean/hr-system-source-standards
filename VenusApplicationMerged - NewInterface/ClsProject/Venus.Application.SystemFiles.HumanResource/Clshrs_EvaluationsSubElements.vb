...
'Description       : 1-Implement Data Acess Layer of  Evaluation Types Elements  (hrs_EvaluationsSubElements table) 
...
Public Class Clshrs_EvaluationsSubElementsBases
...
#Region "Class Constructors"
    ...
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " hrs_EvaluationsSubElements "
        mInsertParameter = " Code,EngName,ArbName,ArbName4S,EvaluationTypeID,Remarks,RegUserID,RegComputerID "
        mInsertParameterValues = " @Code,@EngName,@ArbName,@ArbName4S,@EvaluationTypeID,@Remarks,@RegUserID,@RegComputerID"
        mUpdateParameter = " Code=@Code,EngName=@EngName,ArbName=@ArbName,ArbName4S=@ArbName4S,EvaluationTypeID=@EvaluationTypeID,Remarks=@Remarks,RegUserID=@RegUserID,RegComputerID=@RegComputerID "
        mSelectCommand = " Select * From  " & mTable
        mInsertCommand = " insert into " & mTable & "( " & mInsertParameter & ")Values(" & mInsertParameterValues & ")"
        mUpdateCommand = " Update " & mTable & " Set " & mUpdateParameter
        mDeleteCommand = " Update " & mTable & " Set CancelDate=GetDate()"

        'mSelectCommand = " select hrs_EvaluationsSubElements.id ,hrs_EvaluationsSubElements.code ,hrs_EvaluationsSubElements.engname,hrs_EvaluationsSubElements.MeasureValue From hrs_EvaluationsSubElements "
    End Sub
#End Region
...
#Region "Private Members"
    ...
    Private mEvaluationTypeID As Int32
...
#Region "Public property"
    ...
    Public Property EvaluationTypeID() As Int32
        Get
...
#Region "Public Function"
    ...
    'Module         :  Hrs (Human Resource Module)
    'Project        :  Venus V.
    'Description    :  1-Used to update record if found(by checking its ID in hrs_EvaluationsSubElements table) 
    ...
    Public Function SaveUpdate(ByVal Filter As String) As Boolean
        ...
        Try
            strSQL = "Select ID From hrs_EvaluationsSubElements Where " & Filter
    ...
    'Module         :  Hrs (Human Resource Module)
    'Project        :  Venus V.
    'Description    :  1-Used to insert new record in hrs_EvaluationsSubElements table
    '                  2-return true if operation done
    'Developer      :  [MAE]Mah Abdel-aziz
    'Date Created   :  [19-07-2007]
    'Modifacations  : 
    ...
    'Module         :  Hrs (Human Resource Module)
    'Project        :  Venus V.
    'Description    :  1-Used to update record if found(by checking its ID in hrs_EvaluationsSubElements) 
    '                   otherwise insert it as new record
    '                  2-return true if operation done
    'Developer      :  [MAE]Mah Abdel-aziz
    'Date Created   :  [19-07-2007]
    ...
    'Module         :  Hrs (Human Resource Module)
    'Project        :  Venus V.
    'Description    :  1-Used to delete record that match criteria from hrs_EvaluationsSubElements table 
    '                  2-return true if operation done
    'Developer      :  [MAE]Mah Abdel-aziz
    'Date Created   :  [19-07-2007]
    'Modifacations  : 
...
Public Class Clshrs_EvaluationsSubElements
    Inherits Clshrs_EvaluationsSubElementsBases
    ...
    'Module         :  Hrs (Human Resource Module)
    'Project        :  Venus V.
    'Description    :  Fill Datagrid Value List with English name column from hrs_EvaluationsSubElements table
    '                  and return true if operation done otherwise report errors in ErrorPage
    'Developer      :  [MAE]Mah Abdel-aziz
    'Date Created   :  [19-07-2007]
    'Modifacations  : 
    ...
    'Parmeter Name      : Data Type : Description
    '---------------------------------------------------------
    'DdlValues             :ValueList     :used to fill it with English name column from hrs_EvaluationsSubElements table
    '========================================================================
    ...
    'Module         :  Hrs (Human Resource Module)
    'Project        :  Venus V.
    'Description    :  Fill DropDownList with English name column from hrs_EvaluationsSubElements table
    '                  and return true if operation done otherwise report errors in ErrorPage
    'Developer      :  [MAE]Mah Abdel-aziz
    'Date Created   :  [19-07-2007]
    'Modifacations  :
    ...
    'Parmeter Name      : Data Type : Description
    '---------------------------------------------------------
    'DdlValues             :DropDownList     :used to fill it with English name column from hrs_EvaluationsSubElements table
    '========================================================================
