...
Public Class Clshrs_ProjectEmployeeReserve
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " hrs_ProjectEmployeeReserve "
        mInsertParameter = "" & _
          "TrnsDate," & _
          "RefNo," & _
          "ProjectID," & _
...
#Region "Public Function"
    ...
    'Developer      :  DataOcean   
    'Date Created   :23/02/2015 14:32:05
    'Modifacations  :
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
...
#Region "Class Private Function"
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@AttendanceTableShiftID", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mAttendanceTableShiftID, SqlDbType.Int)
