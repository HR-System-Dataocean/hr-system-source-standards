...
Public Class ClsRec_Positions
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " Rec_Positions "
        mInsertParameter = "" & _
          "Code," & _
          "Branch_ID," & _
          "Department_ID," & _
        ...
        mUpdateParameter = "" & _
          ...
          "Positions_ID=@Positions_ID," & _
          "RefCode=@RefCode," & _
          "EngName=@EngName," & _
          "ArbName=@ArbName," & _
          "ArbName4S=@ArbName4S," & _
          "GStartDate=@GStartDate," & _
          "HStartDate=@HStartDate," & _
          "PositionQTY=@PositionQTY," & _
          "Status=@Status," & _
          "Remarks=@Remarks"
...
#Region "Private Members"
    ...
    Private mBranch_ID As Integer
    Private mDepartment_ID As Integer
    Private mPositions_ID As Integer
    Private mRefCode As String
    Private mEngName As String
    Private mArbName As String
    Private mArbName4S As String
    Private mGStartDate As DateTime
    Private mHStartDate As String
    Private mPositionQTY As Integer
...
#Region "Public property"
    ...
    Public Property Department_ID() As Integer
        Get
            Return mDepartment_ID
        End Get
        Set(ByVal Value As Integer)
            mDepartment_ID = Value
        End Set
    End Property
    Public Property Positions_ID() As Integer
        Get
            Return mPositions_ID
        End Get
        Set(ByVal Value As Integer)
            mPositions_ID = Value
        End Set
    ...
    Public Property ArbName4S() As String
        ...
        End Set
    End Property
    Public Property GStartDate() As DateTime
        Get
            Return mGStartDate
        End Get
        ...
        End Set
    End Property
    Public Property HStartDate() As String
        Get
            Return mHStartDate
        End Get
        Set(ByVal Value As String)
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mBranch_ID = mDataHandler.DataValue_Out(.Item("Branch_ID"), SqlDbType.Int, True)
                mDepartment_ID = mDataHandler.DataValue_Out(.Item("Department_ID"), SqlDbType.Int, True)
                mPositions_ID = mDataHandler.DataValue_Out(.Item("Positions_ID"), SqlDbType.Int, True)
                mRefCode = mDataHandler.DataValue_Out(.Item("RefCode"), SqlDbType.VarChar)
                ...
                mGStartDate = mDataHandler.DataValue_Out(.Item("GStartDate"), SqlDbType.DateTime)
                mHStartDate = mDataHandler.DataValue_Out(.Item("HStartDate"), SqlDbType.VarChar)
                mPositionQTY = mDataHandler.DataValue_Out(.Item("PositionQTY"), SqlDbType.Int, True)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Branch_ID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mBranch_ID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Department_ID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mDepartment_ID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Positions_ID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mPositions_ID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@RefCode", SqlDbType.VarChar)).Value = mDataHandler.DataValue_In(mRefCode, SqlDbType.VarChar)
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@GStartDate", SqlDbType.DateTime)).Value = mDataHandler.DataValue_In(mGStartDate, SqlDbType.DateTime)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@HStartDate", SqlDbType.VarChar)).Value = mDataHandler.DataValue_In(mHStartDate, SqlDbType.VarChar)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@PositionQTY", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mPositionQTY, SqlDbType.Int)
