...
Public Class Clsdsh_WidgetsPermissions
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " dsh_WidgetsPermissions "
        mInsertParameter = "" & _
          "WidgetsID," & _
          "UserID," & _
          "CanView," & _
...
#Region "Public property"
    Public Property ID() As Integer
        ...
        End Set
    End Property
    Public Property WidgetsID() As Integer
        Get
            Return mWidgetsID
        End Get
        Set(ByVal Value As Integer)
...
#Region "Public Function"
    ...
    'Developer      :  DataOcean   
    'Date Created   :10/11/2015 12:04:52
    'Modifacations  :
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mWidgetsID = [Shared].DataHandler.DataValue_Out(.Item("WidgetsID"), SqlDbType.Int, True)
                mUserID = [Shared].DataHandler.DataValue_Out(.Item("UserID"), SqlDbType.Int, True)
                mCanView = [Shared].DataHandler.DataValue_Out(.Item("CanView"), SqlDbType.Bit)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@WidgetsID", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mWidgetsID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@UserID", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mUserID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@CanView", SqlDbType.Bit)).Value = [Shared].DataHandler.DataValue_In(mCanView, SqlDbType.Bit)
