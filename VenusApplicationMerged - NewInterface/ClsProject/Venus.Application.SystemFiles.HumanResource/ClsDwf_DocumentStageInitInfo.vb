...
Public Class ClsDwf_DocumentStageInitInfo
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " Dwf_DocumentStageInitInfo "
        mInsertParameter = "" & _
          "DocumentID," & _
          "StageCode," & _
          "ElementCode," & _
...
#Region "Public property"
    ...
    Public Property ElementCode() As String
        ...
        End Set
    End Property
    Public Property RelColumn() As String
        Get
            Return mRelColumn
        End Get
        Set(ByVal Value As String)
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mRelColumn = [Shared].DataHandler.DataValue_Out(.Item("RelColumn"), SqlDbType.VarChar)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@RelColumn", SqlDbType.VarChar)).Value = [Shared].DataHandler.DataValue_In(mRelColumn, SqlDbType.VarChar)
