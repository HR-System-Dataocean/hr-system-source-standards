...
Public Class Clshrs_DocumentTypesNationalities
    Inherits ClsDataAcessLayer

#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " hrs_DocumentTypesNationalities "
        mInsertParameter = " DocumentTypeID,NationalityID,SpeciallyFor,ExceptFrom,Remarks,RegUserID,RegComputerID,CompanyID "
        mInsertParameterValues = " @DocumentTypeID,@NationalityID,@SpeciallyFor,@ExceptFrom,@Remarks,@RegUserID,@RegComputerID,@CompanyID "
        mUpdateParameter = " DocumentTypeID=@DocumentTypeID,NationalityID=@NationalityID,SpeciallyFor=@SpeciallyFor,ExceptFrom=@ExceptFrom,Remarks=@Remarks,RegUserID=@RegUserID,RegComputerID=@RegComputerID,CompanyID=@CompanyID "
...
#Region "Private Members"
    ...
    Private mExceptFrom As Boolean
...
#Region "Public property"
    ...
    Public Property SpeciallyFor() As Boolean
        ...
        End Set
    End Property
    Public Property ExceptFrom() As Boolean
        Get
            Return mExceptFrom
        End Get
        Set(ByVal Value As Boolean)
...
#Region "Public Function"
    ...
    Public Function SaveUpdate(ByVal Filter As String) As Boolean
        ...
        Try
            strSQL = "Select ID From hrs_DocumentTypesNationalities Where " & Filter
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mExceptFrom = mDataHandler.DataValue_Out(.Item("ExceptFrom"), SqlDbType.Bit)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@ExceptFrom", SqlDbType.Bit)).Value = mDataHandler.DataValue_In(mExceptFrom, SqlDbType.Bit)
