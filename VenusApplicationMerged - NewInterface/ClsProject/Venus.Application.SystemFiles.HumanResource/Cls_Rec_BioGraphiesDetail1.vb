...
Public Class ClsRec_BioGraphiesDetail1
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " Rec_BioGraphiesDetail1 "
        mInsertParameter = "" & _
          "BioGraphy_ID," & _
          "EngName," & _
          "ArbName," & _
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mFax = mDataHandler.DataValue_Out(.Item("Fax"), SqlDbType.VarChar)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Fax", SqlDbType.VarChar)).Value = mDataHandler.DataValue_In(mFax, SqlDbType.VarChar)
