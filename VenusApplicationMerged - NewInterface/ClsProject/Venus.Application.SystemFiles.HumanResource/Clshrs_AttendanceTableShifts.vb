...
Public Class Clshrs_AttendanceTableShifts
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " hrs_AttendanceTableShifts "
        mInsertParameter = "" & _
          "AttendanceTableID," & _
          "EngName," & _
          "ArbName," & _
        ...
        mInsertParameterValues = "" & _
          ...
          " @RegComputerID"
        mUpdateParameter = "" & _
          "AttendanceTableID=@AttendanceTableID," & _
          "EngName=@EngName," & _
          "ArbName=@ArbName," & _
          ...
          "TimeOut=@TimeOut," & _
          "Remarks=@Remarks"
        mSelectCommand = CONFIG_DATEFORMAT & " Select distinct * From  " & mTable
...
#Region "Private Members"
    ...
    Private mAttendanceTableID As Integer
...
#Region "Public property"
    Public Property ID() As Integer
        ...
        End Set
    End Property
    Public Property AttendanceTableID() As Integer
        Get
            Return mAttendanceTableID
        End Get
        Set(ByVal Value As Integer)
            mAttendanceTableID = Value
        End Set
    End Property
...
#Region "Public Function"
    ...
    'Developer      :  DataOcean   
    'Date Created   :27/10/2014 13:51:58
    'Modifacations  :
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mAttendanceTableID = [Shared].DataHandler.DataValue_Out(.Item("AttendanceTableID"), SqlDbType.Int, True)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@AttendanceTableID", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mAttendanceTableID, SqlDbType.Int)
