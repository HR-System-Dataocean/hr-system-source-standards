...
Public Class ClsEval_Evaluation
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " Eval_Evaluation "
        mInsertParameter = "" & _
          "EvalTypeID," & _
          "Dest_EmployeeID," & _
          "Target_EmployeeID," & _
        ...
        mUpdateParameter = "" & _
          ...
          "Dest_EmployeeID=@Dest_EmployeeID," & _
          "Target_EmployeeID=@Target_EmployeeID," & _
          "EngNotes=@EngNotes," & _
          "ArbNotes=@ArbNotes," & _
          "OverAllResult=@OverAllResult," & _
...
#Region "Private Members"
    ...
    Private mDest_EmployeeID As Integer
    Private mTarget_EmployeeID As Integer
    Private mEngNotes As String
    Private mArbNotes As String
    Private mOverAllResult As Integer
...
#Region "Public property"
    ...
    Public Property EvalTypeID() As Integer
        ...
        End Set
    End Property
    Public Property Dest_EmployeeID() As Integer
        Get
            Return mDest_EmployeeID
        End Get
        Set(ByVal Value As Integer)
            mDest_EmployeeID = Value
        End Set
    End Property
    Public Property Target_EmployeeID() As Integer
        Get
            Return mTarget_EmployeeID
        End Get
        Set(ByVal Value As Integer)
            mTarget_EmployeeID = Value
        End Set
    End Property
    Public Property EngNotes() As String
        Get
            Return mEngNotes
        End Get
        ...
        End Set
    End Property
    Public Property ArbNotes() As String
        Get
            Return mArbNotes
        End Get
        Set(ByVal Value As String)
        ...
        End Set
    End Property
    Public Property OverAllResult() As Integer
        Get
            Return mOverAllResult
        End Get
        Set(ByVal Value As Integer)
            mOverAllResult = Value
        End Set
    End Property
...
#Region "Public Function"
    ...
    'Developer      :  DataOcean   
    'Date Created   :27/06/1432 17:10:47
    'Modifacations  :
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
    ...
    Public Function Clear() As Boolean
        Try
            ...
            mEvalTypeID = 0
            mDest_EmployeeID = 0
            mTarget_EmployeeID = 0
            mEngNotes = String.Empty
            mArbNotes = String.Empty
            mOverAllResult = 0
            mGStartDate = Nothing
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mDest_EmployeeID = mDataHandler.DataValue_Out(.Item("Dest_EmployeeID"), SqlDbType.Int, True)
                mTarget_EmployeeID = mDataHandler.DataValue_Out(.Item("Target_EmployeeID"), SqlDbType.Int, True)
                mEngNotes = mDataHandler.DataValue_Out(.Item("EngNotes"), SqlDbType.VarChar)
                mArbNotes = mDataHandler.DataValue_Out(.Item("ArbNotes"), SqlDbType.VarChar)
                mOverAllResult = mDataHandler.DataValue_Out(.Item("OverAllResult"), SqlDbType.Int, True)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Dest_EmployeeID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mDest_EmployeeID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Target_EmployeeID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mTarget_EmployeeID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@EngNotes", SqlDbType.VarChar)).Value = mDataHandler.DataValue_In(mEngNotes, SqlDbType.VarChar)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@ArbNotes", SqlDbType.VarChar)).Value = mDataHandler.DataValue_In(mArbNotes, SqlDbType.VarChar)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@OverAllResult", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mOverAllResult, SqlDbType.Int)
