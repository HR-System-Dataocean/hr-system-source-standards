...
Public Class ClsEval_QuestionsDetail1
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " Eval_QuestionsDetail1 "
        mInsertParameter = "" & _
          "QuestionID," & _
          "Answer_Eng," & _
          "Answer_Arb," & _
        ...
        mUpdateParameter = "" & _
          ...
          "Answer_Eng=@Answer_Eng," & _
          "Answer_Arb=@Answer_Arb," & _
          "APower=@APower," & _
          "Remarks=@Remarks"
...
#Region "Private Members"
    ...
    Private mAnswer_Eng As String
    Private mAnswer_Arb As String
    Private mAPower As Integer
...
#Region "Public property"
    ...
    Public Property QuestionID() As Integer
        ...
        End Set
    End Property
    Public Property Answer_Eng() As String
        Get
            Return mAnswer_Eng
        End Get
        ...
        End Set
    End Property
    Public Property Answer_Arb() As String
        Get
            Return mAnswer_Arb
        End Get
        Set(ByVal Value As String)
        ...
        End Set
    End Property
    Public Property APower() As Integer
        Get
            Return mAPower
        End Get
        Set(ByVal Value As Integer)
...
#Region "Public Function"
    ...
    Public Function Clear() As Boolean
        Try
            mID = 0
            mQuestionID = 0
            mAnswer_Eng = String.Empty
            mAnswer_Arb = String.Empty
            mAPower = 0
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mAnswer_Eng = mDataHandler.DataValue_Out(.Item("Answer_Eng"), SqlDbType.VarChar)
                mAnswer_Arb = mDataHandler.DataValue_Out(.Item("Answer_Arb"), SqlDbType.VarChar)
                mAPower = mDataHandler.DataValue_Out(.Item("APower"), SqlDbType.Int, True)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Answer_Eng", SqlDbType.VarChar)).Value = mDataHandler.DataValue_In(mAnswer_Eng, SqlDbType.VarChar)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Answer_Arb", SqlDbType.VarChar)).Value = mDataHandler.DataValue_In(mAnswer_Arb, SqlDbType.VarChar)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@APower", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mAPower, SqlDbType.Int)
