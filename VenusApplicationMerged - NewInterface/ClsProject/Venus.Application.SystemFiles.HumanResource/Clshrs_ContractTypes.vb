...
Public Class Clshrs_ContractTypesBase
...
#Region "Class Constructors"
    ...
    Public Sub New(ByVal Page As Web.UI.Page)
        ...
        MyBase.New(Page)
        mTable = " hrs_ContractsTypes "
        mInsertParameter = " Code,EngName,ArbName,ArbName4S,CompanyID,Remarks,RegUserId,RegComputerID "
        mInsertParameterValues = " @Code,@EngName,@ArbName,@ArbName4S,@CompanyID,@Remarks,@RegUserId,@RegComputerID "
        mUpdateParameter = " EngName=@EngName,ArbName=@ArbName,ArbName4S=@ArbName4S,Remarks=@Remarks "
...
Public Class Clshrs_ContractTypes
    Inherits Clshrs_ContractTypesBase
    ...
    'Date           : 05-12-2007
    'Description    : Update method to match with Language
    Public Function GetList(ByRef DdlValues As Global.System.Web.UI.WebControls.DropDownList) As Boolean
        Dim ObjDataRow As DataRow
        Dim StrCommandString As String
        Dim ObjDataset As New DataSet
