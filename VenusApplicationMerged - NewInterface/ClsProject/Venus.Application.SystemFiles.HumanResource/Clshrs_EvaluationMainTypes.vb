...
'Description    : 1-Implement class of Data Acess Layer of evaluation main types (hrs_EvaluationMainElements table)
...
'                       records
'Modification   : Convert data type of PercentFromTotalElement (field in hrs_EvaluationMainElements) from mony to real 
'
'==========================================================================
Imports Venus.Application.SystemFiles.System
Public Class Clshrs_EvaluationMainTypesBases
...
#Region "Class Constructors"
    ...
    Public Sub New(ByVal Page As Web.UI.Page)
        ...
        mInsertParameter = " Code,EngName,ArbName,SearchArbName,PercentFromTotalElements,EvaluationTypeID,Remarks,RegUserID,RegComputerID "
        mInsertParameterValues = " @Code,@EngName,@ArbName,@SearchArbName,@PercentFromTotalElements,@EvaluationTypeID,@Remarks,@RegUserID,@RegComputerID"
        mUpdateParameter = " Code=@Code,EngName=@EngName,ArbName=@ArbName,SearchArbName=@SearchArbName,PercentFromTotalElements=@PercentFromTotalElements,EvaluationTypeID=@EvaluationTypeID,Remarks=@Remarks,RegUserID=@RegUserID,RegComputerID=@RegComputerID "
...
#Region "Public Function"
    ...
    'Module         :  Hrs (Human Resource Module)
    'Project        :  Venus V.
    'Description    :  update percent field into hrs_EvaluationMainElements table
    '                  and return true if operation done otherwise report errors in ErrorPage
    'Developer      :  [MAE] 
...
Public Class Clshrs_EvaluationMainTypes
    Inherits Clshrs_EvaluationMainTypesBases
