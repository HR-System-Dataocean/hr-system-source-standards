...
Public Class ClsDwf_DocumentStageElements
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " Dwf_DocumentStageElements "
        mInsertParameter = "" & _
          "DocumentID," & _
          "StageCode," & _
          "ElementCode," & _
        ...
        mUpdateParameter = "" & _
          ...
          "Remarks=@Remarks"
        mSelectCommand = CONFIG_DATEFORMAT & " Select max(ID) ID,[DocumentID],[StageCode],[ElementCode],max([IsHide]) IsHide,max([IsDisabled]) IsDisabled,max([Remarks]) Remarks,max([RegUserID]) RegUserID,max([RegComputerID]) RegComputerID,max([RegDate]) RegDate,max([CancelDate]) CancelDate From " & mTable
...
#Region "Private Members"
    ...
    Private mIsHide As Integer
    Private mIsDisabled As Integer
...
#Region "Public property"
    ...
    Public Property ElementCode() As String
        ...
        End Set
    End Property
    Public Property IsHide() As Integer
        Get
            Return mIsHide
        End Get
        Set(ByVal Value As Integer)
...
#Region "Public Function"
    ...
    Public Function Find(ByVal Filter As String) As Boolean
        ...
        Try
            ...
            mSqlDataAdapter = New SqlClient.SqlDataAdapter(StrSelectCommand & " group by [DocumentID],[StageCode],[ElementCode] order by [DocumentID],[StageCode],[ElementCode]", mConnectionString)
    ...
    'Developer      :  DataOcean   
    'Date Created   :15/11/2015 11:49:39
    'Modifacations  :
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mIsHide = [Shared].DataHandler.DataValue_Out(.Item("IsHide"), SqlDbType.Int, True)
                mIsDisabled = [Shared].DataHandler.DataValue_Out(.Item("IsDisabled"), SqlDbType.Int, True)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@IsHide", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mIsHide, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@IsDisabled", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mIsDisabled, SqlDbType.Int)
