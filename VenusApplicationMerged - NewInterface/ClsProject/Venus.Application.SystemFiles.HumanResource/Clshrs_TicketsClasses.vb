...
'Developer         : [0257]
'Description       : 1-Implement Data Acess Layer of hrs_TicketsClasses table with fields code,English name,
'                       Arabic name
'                    2-Allow searching
...
Public Class Clshrs_TicketsClasses
...
#Region "Public Function"
    ...
    Public Function SaveUpdate(ByVal Filter As String) As Boolean
        ...
        Try
            strSQL = "Select ID From hrs_TicketsClasses Where " & Filter
