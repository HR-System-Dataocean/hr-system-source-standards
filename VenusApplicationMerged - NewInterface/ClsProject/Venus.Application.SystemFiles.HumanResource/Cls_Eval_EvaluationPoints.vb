...
Public Class ClsEval_EvaluationPoints
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " Eval_EvaluationPoints "
        mInsertParameter = "" & _
          "EvalID," & _
          "PointsArabic," & _
          "PointsEnglish," & _
        ...
        mUpdateParameter = "" & _
          "EvalID=@EvalID," & _
          "PointsArabic=@PointsArabic," & _
          "PointsEnglish=@PointsEnglish," & _
          "Type=@Type," & _
          "Remarks=@Remarks"
...
#Region "Private Members"
    ...
    Private mEvalID As Integer
    Private mPointsArabic As String
    Private mPointsEnglish As String
...
#Region "Public property"
    ...
    Public Property EvalID() As Integer
        ...
        End Set
    End Property
    Public Property PointsArabic() As String
        Get
            Return mPointsArabic
        End Get
        Set(ByVal Value As String)
            mPointsArabic = Value
        End Set
    End Property
    Public Property PointsEnglish() As String
        Get
            Return mPointsEnglish
        End Get
        Set(ByVal Value As String)
            mPointsEnglish = Value
        End Set
    End Property
...
#Region "Public Function"
    ...
    'Developer      :  DataOcean   
    'Date Created   :18/04/2011 12:28:00
    'Modifacations  :
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
    ...
    Public Function Clear() As Boolean
        Try
            mID = 0
            mEvalID = 0
            mPointsArabic = String.Empty
            mPointsEnglish = String.Empty
            mType = 0
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mEvalID = mDataHandler.DataValue_Out(.Item("EvalID"), SqlDbType.Int, True)
                mPointsArabic = mDataHandler.DataValue_Out(.Item("PointsArabic"), SqlDbType.VarChar)
                mPointsEnglish = mDataHandler.DataValue_Out(.Item("PointsEnglish"), SqlDbType.VarChar)
                mType = mDataHandler.DataValue_Out(.Item("Type"), SqlDbType.Int, True)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@EvalID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mEvalID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@PointsArabic", SqlDbType.VarChar)).Value = mDataHandler.DataValue_In(mPointsArabic, SqlDbType.VarChar)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@PointsEnglish", SqlDbType.VarChar)).Value = mDataHandler.DataValue_In(mPointsEnglish, SqlDbType.VarChar)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Type", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mType, SqlDbType.Int)
