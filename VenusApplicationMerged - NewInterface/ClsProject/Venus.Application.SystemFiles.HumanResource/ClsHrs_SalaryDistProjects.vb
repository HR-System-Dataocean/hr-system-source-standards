...
Public Class ClsHrs_SalaryDistProjects
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " hrs_SalaryDistProjects "
        mInsertParameter = "" &
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mSalaryDistributionID = [Shared].DataHandler.DataValue_Out(.Item("SalaryDistributionID"), SqlDbType.Int)
                mProjectID = [Shared].DataHandler.DataValue_Out(.Item("ProjectID"), SqlDbType.Int)
                mPercentage = [Shared].DataHandler.DataValue_Out(.Item("Percentage"), SqlDbType.Decimal)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@ProjectID", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(ProjectID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Percentage", SqlDbType.Decimal)).Value = [Shared].DataHandler.DataValue_In(mPercentage, SqlDbType.Decimal)
