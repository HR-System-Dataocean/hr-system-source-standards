...
Public Class Clshrs_HmsCommissionCategories
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " hrs_HmsCommissionCategories "
        mInsertParameter = "" &
                                                                                "Code," &
                                                                                "Arbname," &
                                                                                "Engname," &
        ...
        mUpdateParameter = "" &
                                                                                ...
                                                                                "Arbname=@Arbname," &
                                                                                "Engname=@Engname," &
                                                                                "IsLineCommission=@IsLineCommission," &
                                                                                "TotalCommision=@TotalCommision," &
                                                                                "DedcutionPc=@DedcutionPc," &
...
#Region "Private Members"
    ...
    Private mIsLineCommission As Boolean
    Private mTotalCommision As Object

    Private mDedcutionPc As Object
    Private mSalaryTransactionID As Integer
...
#Region "Public property"
    ...
    Public Property Engname() As String
        ...
        End Set
    End Property
    Public Property IsLineCommission() As Boolean
        Get
            Return mIsLineCommission
        End Get
        Set(ByVal Value As Boolean)
            mIsLineCommission = Value
        End Set
    End Property
    Public Property TotalCommision() As Object
        Get
            Return mTotalCommision
        End Get
        Set(ByVal Value As Object)
            mTotalCommision = Value
        End Set
    End Property
    Public Property DedcutionPc() As Object
        Get
            Return mDedcutionPc
        End Get
        Set(ByVal Value As Object)
        ...
        End Set
    End Property
    Public Property SalaryTransactionID() As Integer
        Get
            Return mSalaryTransactionID
        End Get
        Set(ByVal Value As Integer)
            mSalaryTransactionID = Value
        End Set
    End Property
...
#Region "Public Function"
    ...
    'Developer      :  DataOcean   
    'Date Created   :21/10/2019 11:04:03 ص
    'Modifacations  :
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
    ...
    Public Function Clear() As Boolean
        Try
            ...
            mIsLineCommission = False
            mTotalCommision = Nothing
            mDedcutionPc = Nothing
            mSalaryTransactionID = 0
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mIsLineCommission = [Shared].DataHandler.DataValue_Out(.Item("IsLineCommission"), SqlDbType.Bit)
                mTotalCommision = [Shared].DataHandler.DataValue_Out(.Item("TotalCommision"), SqlDbType.Float)
                mDedcutionPc = [Shared].DataHandler.DataValue_Out(.Item("DedcutionPc"), SqlDbType.Float)
                mSalaryTransactionID = [Shared].DataHandler.DataValue_Out(.Item("SalaryTransactionID"), SqlDbType.Int, True)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@IsLineCommission", SqlDbType.Bit)).Value = [Shared].DataHandler.DataValue_In(mIsLineCommission, SqlDbType.Bit)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@TotalCommision", SqlDbType.Float)).Value = [Shared].DataHandler.DataValue_In(mTotalCommision, SqlDbType.Float)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@DedcutionPc", SqlDbType.Float)).Value = [Shared].DataHandler.DataValue_In(mDedcutionPc, SqlDbType.Float)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@SalaryTransactionID", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mSalaryTransactionID, SqlDbType.Int)
