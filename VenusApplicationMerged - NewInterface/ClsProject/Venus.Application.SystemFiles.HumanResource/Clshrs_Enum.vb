...
#Region "Public Function"
    ...
    Public Function GetList(ByRef DdlValues As Infragistics.WebUI.UltraWebGrid.ValueList, ByVal NullNode As Boolean, Optional ByVal Filter As String = "") As Boolean
        ...
        Try
            StrCommandString = "Select ID,Cast(Code as Int) AS Code,EngName,ArbName From " & Me.mTable & " Where IsNull(CancelDate,'')='' And IsNull(dbo.hrs_GetRecordViewStatus(ID,'" & Me.mTable & "'," & Me.mDataBaseUserRelatedID & "," & Me.GroupID & "),0) <> 1 and " & Filter
            ...
            For Each ObjDataRow In ObjDataset.Tables(0).Rows
                ...
                End If
                Item.DataValue = ObjDataRow("Code")
                DdlValues.ValueListItems.Add(Item)
            Next
    ...
    'Developer      :  DataOcean   
    'Date Created   :17/10/2014 16:55:43
    'Modifacations  :
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mFlag = [Shared].DataHandler.DataValue_Out(.Item("Flag"), SqlDbType.Int, True)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Flag", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mFlag, SqlDbType.Int)
