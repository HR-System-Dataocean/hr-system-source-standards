...
Public Class Clshrs_ProjectEmployeeOvertime
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " hrs_ProjectEmployeeOvertime "
        mInsertParameter = "" & _
          "TrnsDate," & _
          "RefNo," & _
          "ProjectID," & _
...
#Region "Private Members"
    ...
    Private mREmployeeID As Integer
...
#Region "Public property"
    Public Property ID() As Integer
        ...
        End Set
    End Property
    Public Property TrnsDate() As DateTime
        Get
            Return mTrnsDate
        End Get
    ...
    Public Property Flag() As String
        ...
        End Set
    End Property
    Public Property REmployeeID() As Integer
        Get
            Return mREmployeeID
        End Get
        Set(ByVal Value As Integer)
...
#Region "Public Function"
    ...
    'Developer      :  DataOcean   
    'Date Created   :22/02/2015 17:01:53
    'Modifacations  :
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mTrnsDate = [Shared].DataHandler.DataValue_Out(.Item("TrnsDate"), SqlDbType.DateTime)
                mRefNo = [Shared].DataHandler.DataValue_Out(.Item("RefNo"), SqlDbType.VarChar)
                ...
                mFlag = [Shared].DataHandler.DataValue_Out(.Item("Flag"), SqlDbType.VarChar)
                mREmployeeID = [Shared].DataHandler.DataValue_Out(.Item("REmployeeID"), SqlDbType.Int, True)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@TrnsDate", SqlDbType.DateTime)).Value = [Shared].DataHandler.DataValue_In(mTrnsDate, SqlDbType.DateTime)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@RefNo", SqlDbType.VarChar)).Value = [Shared].DataHandler.DataValue_In(mRefNo, SqlDbType.VarChar)
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Flag", SqlDbType.VarChar)).Value = [Shared].DataHandler.DataValue_In(mFlag, SqlDbType.VarChar)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@REmployeeID", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mREmployeeID, SqlDbType.Int)
