...
Public Class Clshrs_ViolationTypes
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " hrs_ViolationTypes "
        mInsertParameter = "" &
                "Code," &
                "EngName," &
                "ArbName," &
        ...
        mUpdateParameter = "" &
                ...
                "VFrom=@Vfrom," &
                "To=@To," &
                "IsObstructionOther=@IsObstructionOther," &
                "Remarks=@Remarks"
...
#Region "Private Members"
    ...
    Private mViolationCategoryID As Integer
    Private mBranchID As Integer
    Private mVfrom As Double
    Private mVto As Double
    Private mIsObstructionOther As Boolean
...
#Region "Public property"
    ...
    Public Property ArbName4s() As String
        ...
        End Set
    End Property
    Public Property ViolationCategoryID() As Integer
        Get
            Return mViolationCategoryID
        End Get
        Set(ByVal Value As Integer)
            mViolationCategoryID = Value
        End Set
    End Property
    Public Property BranchID() As Integer
        ...
        End Set
    End Property
    Public Property Vfrom() As Double
        Get
            Return mVfrom
        End Get
    ...
    Public Property Vto() As Double
        ...
        End Set
    End Property
    Public Property IsObstructionOther() As Boolean
        Get
            Return mIsObstructionOther
        End Get
        Set(ByVal Value As Boolean)
            mIsObstructionOther = Value
        End Set
    End Property
...
#Region "Public Function"
    ...
    'Developer      :  DataOcean   
    'Date Created   :25/08/2020 2:24:46 PM
    'Modifacations  :
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
    ...
    Public Function Clear() As Boolean
        Try
            ...
            mViolationCategoryID = 0
            mBranchID = 0
            mVfrom = 0
            mVto = 0
            mIsObstructionOther = False
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mViolationCategoryID = [Shared].DataHandler.DataValue_Out(.Item("ViolationCategoryID"), SqlDbType.Int, True)
                mBranchID = [Shared].DataHandler.DataValue_Out(.Item("BranchID"), SqlDbType.Int, True)
                mVfrom = [Shared].DataHandler.DataValue_Out(.Item("Vfrom"), SqlDbType.Float)
                mVto = [Shared].DataHandler.DataValue_Out(.Item("Vto"), SqlDbType.Float)
                mIsObstructionOther = [Shared].DataHandler.DataValue_Out(.Item("IsObstructionOther"), SqlDbType.Bit)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@ViolationCategoryID", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mViolationCategoryID, SqlDbType.Int)
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@From", SqlDbType.Float)).Value = [Shared].DataHandler.DataValue_In(mVfrom, SqlDbType.Float)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@To", SqlDbType.Float)).Value = [Shared].DataHandler.DataValue_In(mVto, SqlDbType.Float)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@IsObstructionOther", SqlDbType.Bit)).Value = [Shared].DataHandler.DataValue_In(mIsObstructionOther, SqlDbType.Bit)
