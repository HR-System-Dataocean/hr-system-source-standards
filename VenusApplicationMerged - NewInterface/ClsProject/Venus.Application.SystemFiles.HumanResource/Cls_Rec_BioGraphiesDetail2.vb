...
Public Class ClsRec_BioGraphiesDetail2
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " Rec_BioGraphiesDetail2 "
        mInsertParameter = "" & _
          "BioGraphy_ID," & _
          "Language_ID," & _
          "SLevel_ID," & _
        ...
        mUpdateParameter = "" & _
          ...
          "Language_ID=@Language_ID," & _
          "SLevel_ID=@SLevel_ID," & _
          "WLevel_ID=@WLevel_ID," & _
          "Remarks=@Remarks"
...
#Region "Private Members"
    ...
    Private mLanguage_ID As Integer
    Private mSLevel_ID As Integer
    Private mWLevel_ID As Integer
...
#Region "Public property"
    ...
    Public Property Language_ID() As Integer
        ...
        End Set
    End Property
    Public Property SLevel_ID() As Integer
        Get
            Return mSLevel_ID
        End Get
        Set(ByVal Value As Integer)
        ...
        End Set
    End Property
    Public Property WLevel_ID() As Integer
        Get
            Return mWLevel_ID
        End Get
        Set(ByVal Value As Integer)
...
#Region "Public Function"
    ...
    'Developer      :  DataOcean   
    'Date Created   :14/05/2011 14:44:48
    'Modifacations  :
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mLanguage_ID = mDataHandler.DataValue_Out(.Item("Language_ID"), SqlDbType.Int, True)
                mSLevel_ID = mDataHandler.DataValue_Out(.Item("SLevel_ID"), SqlDbType.Int)
                mWLevel_ID = mDataHandler.DataValue_Out(.Item("WLevel_ID"), SqlDbType.Int)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Language_ID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mLanguage_ID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@SLevel_ID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mSLevel_ID, SqlDbType.VarChar)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@WLevel_ID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mWLevel_ID, SqlDbType.VarChar)
