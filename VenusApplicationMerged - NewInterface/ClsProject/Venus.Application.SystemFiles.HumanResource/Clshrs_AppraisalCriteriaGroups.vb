...
Public Class Clshrs_AppraisalCriteriaGroups
    Inherits ClsDataAcessLayer

    Public Sub New(page As Web.UI.Page)
        MyBase.New(page)
        mTable = " App_CriteriaGroups"
        mInsertParameter = " Code,EngName,ArbName,CriteriaGroupTypeID,RegUserID,RegDate"
        mInsertParameterValues = " @Code,@EngName,@ArbName,@CriteriaGroupTypeID,@RegUserID,@RegDate"
        mUpdateParameter = " Code=@Code,EngName=@EngName,ArbName=@ArbName,CriteriaGroupTypeID=@CriteriaGroupTypeID"
...
#Region "Private Members"
    ...
    Private mCriteriaGroupTypeID As Object
...
#Region "Public property"
    ...
    Public Property ArbName() As String
        ...
        End Set
    End Property
    Public Property CriteriaGroupTypeID() As Object
        Get
            Return mCriteriaGroupTypeID
        End Get
        Set(ByVal Value As Object)
            mCriteriaGroupTypeID = Value
        End Set
    End Property
...
#Region "Public Function"
    ...
    Public Function GetDropDownList(ByVal DdlValues As Global.System.Web.UI.WebControls.DropDownList, ByVal NullNode As Boolean, Optional ByVal Filter As String = "") As Boolean
        ...
        Try
            ...
            For Each ObjDataRow In ObjDataset.Tables(0).Rows
                Item = New Global.System.Web.UI.WebControls.ListItem
                'Item.Text = mDataHandler.DataValue(ObjDataRow("EngName"), SqlDbType.VarChar)
                Item.Text = mDataHandler.DataValue(ObjDataRow("Code") & "-" & ObjDataRow(ObjNavigationHandler.SetLanguage(mPage, "EngName/ArbName")), SqlDbType.VarChar)
                If (Item.Text.Trim = "") Then
                    Item.Text = mDataHandler.DataValue(ObjDataRow("code") & "-" & ObjDataRow(ObjNavigationHandler.SetLanguage(mPage, "ArbName/EngName")), SqlDbType.VarChar)
                End If
                Item.Value = ObjDataRow("ID")
                DdlValues.Items.Add(Item)
            Next
    ...
    Public Function SaveUpdate(ByVal Filter As String) As Boolean
        ...
        Try
            strSQL = "Select ID From App_CriteriaGroups Where " & Filter
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mCriteriaGroupTypeID = mDataHandler.DataValue_Out(.Item("CriteriaGroupTypeID"), SqlDbType.Int, True)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@CriteriaGroupTypeID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mCriteriaGroupTypeID, SqlDbType.Int, True)
