...
Public Class Clshrs_ProjectRewards
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " hrs_ProjectRewards "
        mInsertParameter = "" & _
          "ProjectChangeID," & _
          "RewardID," & _
          "Occurance," & _
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mRewardID = [Shared].DataHandler.DataValue_Out(.Item("RewardID"), SqlDbType.Int, True)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@RewardID", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mRewardID, SqlDbType.Int)
