...
Public Class Clshrs_DocumentTypesProfessions
    Inherits ClsDataAcessLayer

#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " hrs_DocumentTypesProfessions "
        mInsertParameter = " DocumentTypeID,ProfessionID,SpeciallyFor,ExceptFrom,Remarks,RegUserID,RegComputerID,CompanyID "
        mInsertParameterValues = " @DocumentTypeID,@ProfessionID,@SpeciallyFor,@ExceptFrom,@Remarks,@RegUserID,@RegComputerID,@CompanyID "
        mUpdateParameter = " DocumentTypeID=@DocumentTypeID,ProfessionID=@ProfessionID,SpeciallyFor=@SpeciallyFor,ExceptFrom=@ExceptFrom,Remarks=@Remarks,RegUserID=@RegUserID,RegComputerID=@RegComputerID,CompanyID=@CompanyID "
...
#Region "Private Members"
    ...
    Private mDocumentTypeID As Object
    Private mProfessionID As Object
    Private mSpeciallyFor As Boolean
    Private mExceptFrom As String
...
#Region "Public property"
    ...
    Public Property ProfessionID() As Object
        ...
        End Set
    End Property
    Public Property SpeciallyFor() As Boolean
        Get
            Return mSpeciallyFor
        End Get
        Set(ByVal Value As Boolean)
            mSpeciallyFor = Value
        End Set
    End Property
    Public Property ExceptFrom() As String
        Get
            Return mExceptFrom
        End Get
...
#Region "Public Function"
    ...
    Public Function SaveUpdate(ByVal Filter As String) As Boolean
        ...
        Try
            strSQL = "Select ID From hrs_DocumentTypesProfessions Where " & Filter
...
#Region "Class Private Function"
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mDocumentTypeID = mDataHandler.DataValue_Out(.Item("DocumentTypeID"), SqlDbType.Int, True)
                mProfessionID = mDataHandler.DataValue_Out(.Item("ProfessionID"), SqlDbType.Int, True)
                mSpeciallyFor = mDataHandler.DataValue_Out(.Item("SpeciallyFor"), SqlDbType.Bit)
                mExceptFrom = mDataHandler.DataValue_Out(.Item("ExceptFrom"), SqlDbType.VarChar)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand) As Boolean
        Try
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@DocumentTypeID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mDocumentTypeID, SqlDbType.Int, True)
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@SpeciallyFor", SqlDbType.Bit)).Value = mDataHandler.DataValue_In(mSpeciallyFor, SqlDbType.Bit)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@ExceptFrom", SqlDbType.VarChar)).Value = mDataHandler.DataValue_In(mExceptFrom, SqlDbType.VarChar)
