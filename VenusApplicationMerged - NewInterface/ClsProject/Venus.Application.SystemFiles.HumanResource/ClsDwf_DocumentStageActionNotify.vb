...
Public Class ClsDwf_DocumentStageActionNotify
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " Dwf_DocumentStageActionNotify "
        mInsertParameter = "" & _
          "DocumentID," & _
          "StageCode," & _
          "ActionID," & _
        ...
        mUpdateParameter = "" & _
          ...
          "ActionID=@ActionID," & _
          "NotifStage=@NotifStage," & _
          "NotifyPosition=@NotifyPosition," & _
...
#Region "Private Members"
    ...
    Private mNotifStage As String
    Private mNotifyPosition As Integer
    Private mNotifyEmployee As Integer
    Private mNotification As Integer
...
#Region "Public property"
    ...
    Public Property ActionID() As Integer
        ...
        End Set
    End Property
    Public Property NotifStage() As String
        Get
            Return mNotifStage
        End Get
        Set(ByVal Value As String)
        ...
        End Set
    End Property
    Public Property NotifyPosition() As Integer
        Get
            Return mNotifyPosition
        End Get
        Set(ByVal Value As Integer)
            mNotifyPosition = Value
        End Set
    End Property
    Public Property NotifyEmployee() As Integer
        Get
            Return mNotifyEmployee
        End Get
        Set(ByVal Value As Integer)
            mNotifyEmployee = Value
        End Set
    End Property
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mNotifStage = [Shared].DataHandler.DataValue_Out(.Item("NotifStage"), SqlDbType.VarChar)
                mNotifyPosition = [Shared].DataHandler.DataValue_Out(.Item("NotifyPosition"), SqlDbType.Int, True)
                mNotifyEmployee = [Shared].DataHandler.DataValue_Out(.Item("NotifyEmployee"), SqlDbType.Int, True)
                mNotification = [Shared].DataHandler.DataValue_Out(.Item("Notification"), SqlDbType.Int, True)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@NotifStage", SqlDbType.VarChar)).Value = [Shared].DataHandler.DataValue_In(mNotifStage, SqlDbType.VarChar)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@NotifyPosition", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mNotifyPosition, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@NotifyEmployee", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mNotifyEmployee, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Notification", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mNotification, SqlDbType.Int)
