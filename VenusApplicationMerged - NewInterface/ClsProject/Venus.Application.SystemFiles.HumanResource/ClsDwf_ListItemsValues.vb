...
Public Class ClsDwf_ListItemsValues
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " Dwf_ListItemsValues "
        mInsertParameter = "" & _
          "Code," & _
          "EngName," & _
          "ArbName," & _
...
#Region "Private Members"
    ...
    Private mListItemID As Integer
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mListItemID = [Shared].DataHandler.DataValue_Out(.Item("ListItemID"), SqlDbType.Int, True)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@ListItemID", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mListItemID, SqlDbType.Int)
