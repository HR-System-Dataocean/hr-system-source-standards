...
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        ...
        mUpdateParameter = "" & _
          ...
          "PageID=@PageID," & _
          "AlocationRw=@AlocationRw," & _
          "AlocationCol=@AlocationCol," & _
          "Src=@Src," & _
          "ViewType=@ViewType," & _
          "Remarks=@Remarks"
...
#Region "Private Members"
    ...
    Private mAlocationRw As Integer
    Private mAlocationCol As Integer
...
#Region "Public property"
    ...
    Public Property PageID() As Integer
        ...
        End Set
    End Property
    Public Property AlocationRw() As Integer
        Get
            Return mAlocationRw
        End Get
        Set(ByVal Value As Integer)
        ...
        End Set
    End Property
    Public Property AlocationCol() As Integer
        Get
            Return mAlocationCol
        End Get
        Set(ByVal Value As Integer)
            mAlocationCol = Value
        End Set
...
#Region "Public Function"
    ...
    '========================================================================
    Public Function FindUsersWidgetsPermission(ByVal UserID As Integer, ByVal Code As String, ByVal EngName As String, ByVal ArbName As String, ByRef Ds As DataSet) As Boolean
        Dim StrSelectCommand As String = String.Empty
        Try
            Ds = Microsoft.ApplicationBlocks.Data.SqlHelper.ExecuteDataset(Me.ConnectionString, "hrs_GetUsersWidgetsPermissions", UserID, Code, EngName, ArbName)
            Return True
    ...
    'Developer      :  DataOcean   
    'Date Created   :15/04/2015 22:20:20
    'Modifacations  :
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mPageID = [Shared].DataHandler.DataValue_Out(.Item("PageID"), SqlDbType.Int, True)
                mAlocationRw = [Shared].DataHandler.DataValue_Out(.Item("AlocationRw"), SqlDbType.Int, True)
                mAlocationCol = [Shared].DataHandler.DataValue_Out(.Item("AlocationCol"), SqlDbType.Int, True)
                mSrc = [Shared].DataHandler.DataValue_Out(.Item("Src"), SqlDbType.VarChar)
                mViewType = [Shared].DataHandler.DataValue_Out(.Item("ViewType"), SqlDbType.Int, True)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@PageID", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mPageID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@AlocationRw", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mAlocationRw, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@AlocationCol", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mAlocationCol, SqlDbType.Int)
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@ViewType", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mViewType, SqlDbType.Int)
