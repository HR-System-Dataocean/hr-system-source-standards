...
Public Class ClsEval_EvalQuestions
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " Eval_EvalQuestions "
        mInsertParameter = "" & _
          "GroupID," & _
          "QuestionID," & _
          "EvalID," & _
...
#Region "Public Function"
    ...
    'Developer      :  DataOcean   
    'Date Created   :05/05/2011 12:04:00
    'Modifacations  :
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mAnswerID = mDataHandler.DataValue_Out(.Item("AnswerID"), SqlDbType.Int, True)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@GroupID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mGroupID, SqlDbType.Int)
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@AnswerID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mAnswerID, SqlDbType.Int)
