...
Public Class ClsDwf_Documents
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " Dwf_Documents "
        mInsertParameter = "" & _
          "Code," & _
          "EngName," & _
          "ArbName," & _
        ...
        mUpdateParameter = "" & _
          ...
          "EngName=@EngName," & _
          "ArbName=@ArbName," & _
          "DocTypeID=@DocTypeID," & _
          "ReportID=@ReportID," & _
          "ApplyWorkFlow=@ApplyWorkFlow," & _
          "Remarks=@Remarks"
...
#Region "Private Members"
    ...
    Private mApplyWorkFlow As Boolean
...
#Region "Public property"
    ...
    Public Property ReportID() As Integer
        ...
        End Set
    End Property
    Public Property ApplyWorkFlow() As Boolean
        Get
            Return mApplyWorkFlow
        End Get
        Set(ByVal Value As Boolean)
            mApplyWorkFlow = Value
        End Set
    End Property
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mDocTypeID = [Shared].DataHandler.DataValue_Out(.Item("DocTypeID"), SqlDbType.Int, True)
                mReportID = [Shared].DataHandler.DataValue_Out(.Item("ReportID"), SqlDbType.Int, True)
                mApplyWorkFlow = [Shared].DataHandler.DataValue_Out(.Item("ApplyWorkFlow"), SqlDbType.Bit)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@DocTypeID", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mDocTypeID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@ReportID", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mReportID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@ApplyWorkFlow", SqlDbType.Bit)).Value = [Shared].DataHandler.DataValue_In(mApplyWorkFlow, SqlDbType.Bit)
