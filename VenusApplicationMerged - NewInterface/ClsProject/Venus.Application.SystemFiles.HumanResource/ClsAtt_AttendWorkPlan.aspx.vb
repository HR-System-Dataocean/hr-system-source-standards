...
Public Class ClsAtt_AttendWorkPlan
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " Att_AttendWorkPlan "
        mInsertParameter = "" & _
          "Code," & _
          "EngName," & _
          "ArbName," & _
        ...
        mUpdateParameter = "" & _
          ...
          "FromDate=@FromDate," & _
          "ToDate=@ToDate," & _
          "AttendTemplateID=@AttendTemplateID," & _
...
#Region "Private Members"
    ...
    Private mAttendTemplateID As Integer
    Private mDistribution As String
...
#Region "Public property"
    ...
    Public Property ToDate() As DateTime
        ...
        End Set
    End Property
    Public Property AttendTemplateID() As Integer
        Get
            Return mAttendTemplateID
        End Get
        Set(ByVal Value As Integer)
            mAttendTemplateID = Value
        End Set
    End Property
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mAttendTemplateID = [Shared].DataHandler.DataValue_Out(.Item("AttendTemplateID"), SqlDbType.Int, True)
                mDistribution = [Shared].DataHandler.DataValue_Out(.Item("Distribution"), SqlDbType.VarChar)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@AttendTemplateID", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mAttendTemplateID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Distribution", SqlDbType.VarChar)).Value = [Shared].DataHandler.DataValue_In(mDistribution, SqlDbType.VarChar)
