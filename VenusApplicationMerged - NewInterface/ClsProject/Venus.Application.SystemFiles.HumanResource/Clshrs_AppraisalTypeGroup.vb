...
Public Class Clshrs_AppraisalTypeGroup
    Inherits ClsDataAcessLayer

    Public Sub New(page As Web.UI.Page)
        MyBase.New(page)
        mTable = " App_AppraisalTypeGroup"
        mInsertParameter = " Code,EngName,ArbName,RegUserID,RegDate"
        mInsertParameterValues = " @Code,@EngName,@ArbName,@RegUserID,@RegDate"
...
#Region "Public Function"
    ...
    Public Function SaveUpdate(ByVal Filter As String) As Boolean
        ...
        Try
            strSQL = "Select ID From App_AppraisalTypeGroup Where " & Filter
