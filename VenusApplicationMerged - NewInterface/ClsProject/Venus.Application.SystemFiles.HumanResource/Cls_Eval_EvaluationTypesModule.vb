...
Public Class ClsEval_EvaluationTypesModule
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " Eval_EvaluationTypesModule "
        mInsertParameter = "" & _
          "EvalType_ID," & _
          "Module_ID," & _
          "Remarks," & _
...
#Region "Private Members"
    ...
    Private mEvalType_ID As Integer
    Private mModule_ID As Integer
...
#Region "Public property"
    Public Property ID() As Integer
        ...
        End Set
    End Property
    Public Property EvalType_ID() As Integer
        Get
            Return mEvalType_ID
        End Get
        Set(ByVal Value As Integer)
...
#Region "Public Function"
    ...
    'Developer      :  DataOcean   
    'Date Created   :06/06/2011 17:23:47
    'Modifacations  :
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mEvalType_ID = mDataHandler.DataValue_Out(.Item("EvalType_ID"), SqlDbType.Int, True)
                mModule_ID = mDataHandler.DataValue_Out(.Item("Module_ID"), SqlDbType.Int, True)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@EvalType_ID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mEvalType_ID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Module_ID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mModule_ID, SqlDbType.Int)
