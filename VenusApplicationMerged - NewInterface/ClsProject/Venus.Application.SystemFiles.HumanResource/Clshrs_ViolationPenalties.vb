...
Public Class Clshrs_ViolationPenalties
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " hrs_ViolationPenalties "
        mInsertParameter = "" &
                "EngName," &
                "ArbName," &
                "ArbName4S," &
...
#Region "Private Members"
    ...
    Private mViolationTypeId As Integer
    Private mNumberOfTimes As Integer
    Private mDeductionPercentage As Decimal
...
#Region "Public property"
    ...
    Public Property ArbName4S() As String
        ...
        End Set
    End Property
    Public Property ViolationTypeId() As Integer
        Get
            Return mViolationTypeId
        End Get
        Set(ByVal Value As Integer)
            mViolationTypeId = Value
        End Set
    End Property
    Public Property NumberOfTimes() As Integer
        Get
            Return mNumberOfTimes
        End Get
        Set(ByVal Value As Integer)
            mNumberOfTimes = Value
        End Set
    End Property
    Public Property DeductionPercentage() As Decimal
        Get
            Return mDeductionPercentage
        End Get
        Set(ByVal Value As Decimal)
            mDeductionPercentage = Value
        End Set
    End Property
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mViolationTypeId = [Shared].DataHandler.DataValue_Out(.Item("ViolationTypeId"), SqlDbType.Int, True)
                mNumberOfTimes = [Shared].DataHandler.DataValue_Out(.Item("NumberOfTimes"), SqlDbType.Int, True)
                mDeductionPercentage = [Shared].DataHandler.DataValue_Out(.Item("DeductionPercentage"), SqlDbType.Decimal)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@ViolationTypeId", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mViolationTypeId, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@NumberOfTimes", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mNumberOfTimes, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@DeductionPercentage", SqlDbType.Decimal)).Value = [Shared].DataHandler.DataValue_In(mDeductionPercentage, SqlDbType.Decimal)
