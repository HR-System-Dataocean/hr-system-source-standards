...
'                   Table: hrs_Religions
'                   Relations:
'                               hrs_Religions.ID ->> hrs_Employees.ReligionID
'=========================================================================
Imports Venus.Application.SystemFiles.System
Public Class Clshrs_Religions
...
#Region "Class Constructors"
    ...
    Public Sub New(ByVal Page As Web.UI.Page, ByVal TableName As String)
        ...
        With Me
            .Table = TableName
            .mInsertParameter = " Code,EngName,ArbName,ArbName4S,Remarks,RegUserID,RegComputerID"
            .mInsertParameterValues = " @Code,@EngName,@ArbName,@ArbName4S,@Remarks,@RegUserID,@RegComputerID"
...
#Region "Public Function"
    ...
    '
    'Description: Find all columns from Clshrs_Religions table where filter and canceldate = null 
    '=====================================================================
    ...
    'Steps: 
    '       1-Execute sql statment to get ID from Clshrs_Religions where filter 
    '       2-Check if ID > 0 this mean that row is already exist in Clshrs_Religions  table 
    '       the make Update to this row
    '           IF ID =0 this mean that row is new row Then Insert the row in Clshrs_Religions  table
    '=====================================================================
    ...
    Public Function SaveUpdate(ByVal Filter As String) As Boolean
        Try
            ...
            StrSqlCommand = "Select ID From hrs_Religions Where " & Filter
    ...
    'Description: Save New Row in Clshrs_Religions  table
    'Steps: 
    '       1-execute sqlstatment to insert new row in Clshrs_Religions  table
    ...
    'Description: Update existing Row in Clshrs_Religions  table where filter
    'Steps: 
    '       1-execute sqlstatment to Update existing row in Clshrs_Religions  table
    ...
    'Date : 05/08/2007
    'Inptu : Filter as string (ex.ID=2)
    'Description: Delete existing Row in Clshrs_Religions  table where filter
    'Steps: 
    '       1-execute sqlstatment to Delete existing row in Clshrs_Religions  table
    ...
    'Steps: 
    '       1-execute sqlstatment to find first row in Clshrs_Religions  table
    ...
    'Created by : DataOcean
    'Date : 05/08/2007
    'Description:  find Last row in Clshrs_Religions  table
    'Steps: 
    '       1-execute sqlstatment to find last row in Clshrs_Religions  table
    '       2-Fill dataset with result of sqlstatment
    '       3-call Getparameter function to insert the result of dataset into private members of the class
    '=====================================================================
    ...
    'Created by : DataOcean
    'Date : 05/08/2007
    'Description:  find Next row in Clshrs_Religions  table
    'Steps: 
    '       1-execute sqlstatment to find Next row in Clshrs_Religions  table
    '       2-Fill dataset with result of sqlstatment
    '       3-call Getparameter function to insert the result of dataset into private members of the class
    '=====================================================================
    ...
    'Date : 05/08/2007
    'Steps: 
    '               - Execute proc sqlstatment to find previous row in Clshrs_Religions  table
    ...
    'Description:   Find previous row in Clshrs_Religions  table
    '=====================================================================
