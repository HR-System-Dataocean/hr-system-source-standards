...
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        ...
        mInsertParameter = " EndOfServiceId,FromWorkingMonths,ToWorkingMonths,AmountPercent,Formula,ExtraDedFormula,Remarks,RegUserID,RegComputerID "
        mInsertParameterValues = " @EndOfServiceId,@FromWorkingMonths,@ToWorkingMonths,@AmountPercent,@Formula,@ExtraDedFormula,@Remarks,@RegUserID,@RegComputerID "
        mUpdateParameter = " EndOfServiceId=@EndOfServiceId,FromWorkingMonths=@FromWorkingMonths,ToWorkingMonths=@ToWorkingMonths,AmountPercent=@AmountPercent,Formula=@Formula,ExtraDedFormula=@ExtraDedFormula,Remarks=@Remarks "
...
#Region "Private Members"
    ...
    Private mExtraDedFormula As String
...
#Region "Public property"
    ...
    Public Property Formula() As String
        ...
        End Set
    End Property
    Public Property ExtraDedFormula() As String
        Get
            Return mExtraDedFormula
        End Get
        Set(ByVal Value As String)
            mExtraDedFormula = Value
        End Set
    End Property
...
#Region "Class Private Function"
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mExtraDedFormula = mDataHandler.DataValue_Out(.Item("ExtraDedFormula"), SqlDbType.VarChar)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@ExtraDedFormula", SqlDbType.VarChar)).Value = mDataHandler.DataValue_In(mExtraDedFormula, SqlDbType.VarChar)
