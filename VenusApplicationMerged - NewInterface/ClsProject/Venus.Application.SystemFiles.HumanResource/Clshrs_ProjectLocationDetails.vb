...
Public Class Clshrs_ProjectLocationDetails
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " hrs_ProjectLocationDetails "
        mInsertParameter = "" & _
          "LocationID," & _
          "PositionID," & _
          "Qty," & _
        ...
        mUpdateParameter = "" & _
          ...
          "Qty=@Qty," & _
          "ExternalAmt=@ExternalAmt," & _
          "InternalAmt=@InternalAmt," & _
          "WeekDays=@WeekDays," & _
          "IsAlternative=@IsAlternative," & _
          "IsInvoiced=@IsInvoiced," & _
          "Remarks=@Remarks"
...
#Region "Private Members"
    ...
    Private mExternalAmt As Decimal
    Private mInternalAmt As Decimal
    Private mWeekDays As Integer
    Private mIsAlternative As Boolean
    Private mIsInvoiced As Boolean
...
#Region "Public property"
    ...
    Public Property Qty() As Integer
        ...
        End Set
    End Property
    Public Property ExternalAmt() As Decimal
        Get
            Return mExternalAmt
        End Get
        ...
        End Set
    End Property
    Public Property InternalAmt() As Decimal
        Get
            Return mInternalAmt
        End Get
        Set(ByVal Value As Decimal)
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mPositionID = [Shared].DataHandler.DataValue_Out(.Item("PositionID"), SqlDbType.Int, True)
                mQty = [Shared].DataHandler.DataValue_Out(.Item("Qty"), SqlDbType.Int, True)
                mExternalAmt = [Shared].DataHandler.DataValue_Out(.Item("ExternalAmt"), SqlDbType.Decimal)
                mInternalAmt = [Shared].DataHandler.DataValue_Out(.Item("InternalAmt"), SqlDbType.Decimal)
                mWeekDays = [Shared].DataHandler.DataValue_Out(.Item("WeekDays"), SqlDbType.Int, True)
                mIsAlternative = [Shared].DataHandler.DataValue_Out(.Item("IsAlternative"), SqlDbType.Bit)
                mIsInvoiced = [Shared].DataHandler.DataValue_Out(.Item("IsInvoiced"), SqlDbType.Bit)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@PositionID", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mPositionID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Qty", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mQty, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@ExternalAmt", SqlDbType.Decimal)).Value = [Shared].DataHandler.DataValue_In(mExternalAmt, SqlDbType.Decimal)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@InternalAmt", SqlDbType.Decimal)).Value = [Shared].DataHandler.DataValue_In(mInternalAmt, SqlDbType.Decimal)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@WeekDays", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mWeekDays, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@IsAlternative", SqlDbType.Bit)).Value = [Shared].DataHandler.DataValue_In(mIsAlternative, SqlDbType.Bit)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@IsInvoiced", SqlDbType.Bit)).Value = [Shared].DataHandler.DataValue_In(mIsInvoiced, SqlDbType.Bit)
