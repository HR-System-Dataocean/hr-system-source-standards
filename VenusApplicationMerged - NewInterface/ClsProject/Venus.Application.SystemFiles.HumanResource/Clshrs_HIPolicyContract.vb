...
Public Class Clshrs_HIPolicyContract
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " hrs_HIPolicyContract "
        mInsertParameter = "" & _
          "ContractID," & _
          "PolicyID," & _
          "HICompanyClasses," & _
        ...
        mUpdateParameter = "" & _
          ...
          "PolicyID=@PolicyID," & _
          "HICompanyClasses=@HICompanyClasses," & _
          "CompanyAmt=@CompanyAmt," & _
          "EmployeeAmt=@EmployeeAmt," & _
...
#Region "Private Members"
    ...
    Private mPolicyID As Integer
    Private mHICompanyClasses As Integer
    Private mCompanyAmt As Decimal
    Private mEmployeeAmt As Decimal
...
#Region "Public property"
    ...
    Public Property PolicyID() As Integer
        ...
        End Set
    End Property
    Public Property HICompanyClasses() As Integer
        Get
            Return mHICompanyClasses
        End Get
        Set(ByVal Value As Integer)
            mHICompanyClasses = Value
        End Set
    End Property
    Public Property CompanyAmt() As Decimal
        Get
            Return mCompanyAmt
        End Get
        ...
        End Set
    End Property
    Public Property EmployeeAmt() As Decimal
        Get
            Return mEmployeeAmt
        End Get
        Set(ByVal Value As Decimal)
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mPolicyID = mDataHandler.DataValue_Out(.Item("PolicyID"), SqlDbType.Int, True)
                mHICompanyClasses = mDataHandler.DataValue_Out(.Item("HICompanyClasses"), SqlDbType.Int, True)
                mCompanyAmt = mDataHandler.DataValue_Out(.Item("CompanyAmt"), SqlDbType.Money)
                mEmployeeAmt = mDataHandler.DataValue_Out(.Item("EmployeeAmt"), SqlDbType.Money)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@PolicyID", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mPolicyID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@HICompanyClasses", SqlDbType.Int)).Value = mDataHandler.DataValue_In(mHICompanyClasses, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@CompanyAmt", SqlDbType.Money)).Value = mDataHandler.DataValue_In(mCompanyAmt, SqlDbType.Money)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@EmployeeAmt", SqlDbType.Money)).Value = mDataHandler.DataValue_In(mEmployeeAmt, SqlDbType.Money)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@ActiveDate", SqlDbType.DateTime)).Value = mDataHandler.DataValue_In(mActiveDate, SqlDbType.DateTime)
