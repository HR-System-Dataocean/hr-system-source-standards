...
'Date : 16/07/2007
'                   Class: Positions Levels
'                   Table: hrs_PositionsLevels
'                   Relations:
'                               hrs_PositionsLevels.ID ->> hrs_Positions.PositionLevelID
'=========================================================================
Imports Venus.Application.SystemFiles.System
Public Class Clshrs_PositionsLevels
    Inherits ClsDataAcessLayer

#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " hrs_PositionsLevels "
        mInsertParameter = " Code,EngName,ArbName,ArbName4S,Value,Remarks,RegUserID,RegComputerID,CompanyID "
        mInsertParameterValues = " @Code,@EngName,@ArbName,@ArbName4S,@Value,@Remarks,@RegUserID,@RegComputerID,@CompanyID "
        mUpdateParameter = " EngName=@EngName,ArbName=@ArbName,ArbName4S=@ArbName4S,Value=@Value,Remarks=@Remarks,RegUserID=@RegUserID,RegComputerID=@RegComputerID,CompanyID=@CompanyID "
...
#Region "Public Function"
    ...
    Public Function GetLevels(ByVal DdlGroups As Global.System.Web.UI.WebControls.DropDownList) As Boolean
        ...
        Try
            ...
            StrCommandString = "Select * From hrs_PositionsLevels Where IsNull(CancelDate,'')='' And IsNull(dbo.hrs_GetRecordViewStatus(ID,'" & Me.mTable & "'," & Me.mDataBaseUserRelatedID & "," & Me.GroupID & "),0) <> 1 And CompanyID=" & Me.MainCompanyID
