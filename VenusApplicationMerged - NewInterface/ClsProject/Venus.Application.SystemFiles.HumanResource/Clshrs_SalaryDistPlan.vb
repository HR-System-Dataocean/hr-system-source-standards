...
Public Class Clshrs_SalaryDistPlan
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " hrs_SalaryDistPlan "
        mInsertParameter = "" &
          "Code," &
        ...
        mUpdateParameter = "" &
          "Code=@Code," &
          "SalaryDistributionID=@SalaryDistributionID," &
          "PeriodIDs=@PeriodIDs," &
          "Remarks=@Remarks"
...
#Region "Private Members"
    ...
    Private mSalaryDistributionID As Integer
    Private mPeriodIDs As String
...
#Region "Public property"
    ...
    Public Property Code() As String
        ...
        End Set
    End Property
    Public Property SalaryDistributionID() As Integer
        Get
            Return mSalaryDistributionID
        End Get
        Set(ByVal Value As Integer)
            mSalaryDistributionID = Value
        End Set
    End Property
    Public Property PeriodIDs() As String
        Get
            Return mPeriodIDs
        End Get
        Set(ByVal Value As String)
...
#Region "Public Function"
    ...
    Public Function Clear() As Boolean
        Try
            mID = 0
            mCode = String.Empty
            mSalaryDistributionID = 0
            mPeriodIDs = String.Empty
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mSalaryDistributionID = [Shared].DataHandler.DataValue_Out(.Item("SalaryDistributionID"), SqlDbType.Int, True)
                mPeriodIDs = [Shared].DataHandler.DataValue_Out(.Item("PeriodIDs"), SqlDbType.NVarChar)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@SalaryDistributionID", SqlDbType.Int)).Value = [Shared].DataHandler.DataValue_In(mSalaryDistributionID, SqlDbType.Int)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@PeriodIDs", SqlDbType.NVarChar)).Value = [Shared].DataHandler.DataValue_In(mPeriodIDs, SqlDbType.NVarChar)
