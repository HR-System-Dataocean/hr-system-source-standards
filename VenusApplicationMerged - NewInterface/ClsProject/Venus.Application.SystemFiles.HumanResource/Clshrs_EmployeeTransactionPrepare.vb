...
Public Class Clshrs_EmployeeTransactionPrepare
    Inherits ClsDataAcessLayer
#Region "Class Constructors"
    Public Sub New(ByVal Page As Web.UI.Page)
        MyBase.New(Page)
        mTable = " hrs_EmployeeTransactionPrepare "
        mInsertParameter = "" & _
          "EmployeeID," & _
          "FiscalYearID," & _
          "TransactiontypeID," & _
...
#Region "Private Members"
    ...
    Private mIsPrepared As Boolean
...
#Region "Public Function"
    ...
    'Developer      :  DataOcean   
    'Date Created   :4/7/2012 3:47:18 PM
    'Modifacations  :
    'fn. Arguments  :
    '---------------------------------------------------------
    'Parmeter Name      : Data Type : Description
...
#Region "Class Private Function"
    ...
    Private Function GetParameter(ByVal Ds As DataSet) As Boolean
        Try
            With Ds.Tables(0).Rows(0)
                ...
                mAmount = mDataHandler.DataValue_Out(.Item("Amount"), SqlDbType.Decimal)
                mIsPrepared = mDataHandler.DataValue_Out(.Item("IsPrepared"), SqlDbType.Bit)
    ...
    Private Function SetParameter(ByRef Sqlcommand As SqlClient.SqlCommand, ByVal strMode As String) As Boolean
        Try
            ...
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@Amount", SqlDbType.Decimal)).Value = mDataHandler.DataValue_In(mAmount, SqlDbType.Decimal)
            Sqlcommand.Parameters.Add(New SqlClient.SqlParameter("@IsPrepared", SqlDbType.Bit)).Value = mDataHandler.DataValue_In(mIsPrepared, SqlDbType.Bit)
